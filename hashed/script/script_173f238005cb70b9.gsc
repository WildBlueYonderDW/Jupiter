...
function function_c07bd2e42ba41bc0() {
    ...
    wave = 0;
    var_ea76738101a63a0 = getdvarint(@"hash_44f7a86af84d092c", 0);
    if (var_ea76738101a63a0 != 0) {
        wave = var_ea76738101a63a0;
    }
    level.var_ae12ed8fc05422d2 = wave;
    ...
    while (true) {
        wave++;
        var_ea76738101a63a0 = getdvarint(@"hash_20fdd1881ec96495", 0);
        if (var_ea76738101a63a0 != 0) {
            wave = var_ea76738101a63a0;
        }
        level.var_ae12ed8fc05422d2 = wave;
        level notify("incursion_wave_increase", level.var_ae12ed8fc05422d2);
        if (level.var_ae12ed8fc05422d2 > 1) {
            function_b077e4a328bb9808(30);
        }
        setomnvar("cp_wave_number", wave);
        foreach (player in level.players) {
            player thread scripts\cp\cp_hud_message::showsplash("cp_wave_started", level.var_ae12ed8fc05422d2, undefined);
        }
        function_577d509cdf72f199(wave);
        wait 2;
        foreach (player in level.players) {
            player thread scripts\cp\cp_hud_message::showsplash("cp_wave_ended", level.var_ae12ed8fc05422d2, undefined);
        }
...
// Size: 0x9e
function function_b077e4a328bb9808(wait_time) {
    level endon("game_ended");
    level notify("timeout_wave");
    level endon("timeout_wave");
    self endon("death");
    setomnvar("cp_countdown_color", 0);
    var_e84e755251284ec2 = gettime() + wait_time * 1000;
...
function function_912c529627d743d1() {
    ...
    if (level.var_ae12ed8fc05422d2 >= 15) {
        return "black_ops";
    } else if (level.var_ae12ed8fc05422d2 >= 10) {
        return "commando";
    } else if (level.var_ae12ed8fc05422d2 >= 5) {
        return "heavy";
    } else {
        return undefined;
    }
...
function function_1c225fe307735a4e() {
    level.var_ae12ed8fc05422d2 += 1;
    foreach (player in level.players) {
        player thread scripts\cp\cp_hud_message::showsplash("cp_wave_started", level.var_ae12ed8fc05422d2, undefined);
    }
    wait 1;
    setomnvar("cp_wave_number", level.var_ae12ed8fc05422d2);
    wait 2;
    function_577d509cdf72f199(level.var_ae12ed8fc05422d2);
    function_520db2326be2924e(level.var_ae12ed8fc05422d2);
}
...
function function_a8029b288749d0d5(wave_type, goalradius, var_4aa0f44c1a6b235f) {
    ...
    var_d7b44cb498fdacdb = spawnstruct();
    var_d7b44cb498fdacdb.origin = position;
    var_d7b44cb498fdacdb.angles = (0, 0, 0);
    var_fa8a3a54164a0b8a = namespace_6d1c9cb20efeb350::function_de96b8a387dbe2a(wave_type);
    if (isdefined(var_4aa0f44c1a6b235f)) {
        var_fa8a3a54164a0b8a = var_4aa0f44c1a6b235f;
    }
    var_fc9ac45209f959bb = [];
    spawnpoint = namespace_7adb1ffcf7f14c91::function_9581045871f15252(var_d7b44cb498fdacdb, 5000, 2000);
    enemies = undefined;
    if (wave_type == "riot") {
        enemies = function_3470ae2ea5d473db(spawnpoint);
    } else {
        enemies = function_a9b9234c0760c45e(spawnpoint, var_fa8a3a54164a0b8a, goalradius);
    }
    return enemies;
}
...
function function_3470ae2ea5d473db(spawnpoint) {
    var_45c5d4d61773b0b9 = namespace_d9d93e01b62de24a::function_43825e7633150be3("actor_enemy_cp_rus_riotshield", spawnpoint, 0, 128);
    guy1 = namespace_d9d93e01b62de24a::function_43825e7633150be3("actor_enemy_cp_rus_desert_smg", spawnpoint, 1, 128);
    guy2 = namespace_d9d93e01b62de24a::function_43825e7633150be3("actor_enemy_cp_rus_desert_smg", spawnpoint, 1, 128);
...
function function_e6d574e5d6613546(var_da87f68719e2b303) {
    ...
    key = level.var_ae12ed8fc05422d2;
...
function function_b23e29727caf4c44() {
    self waittill("death");
    foreach (key, var_9bde88429952ec6f in level.var_603f2855fc89966) {
        new_array = undefined;
        removed = undefined;
        foreach (var_547487a5cd081071 in var_9bde88429952ec6f) {
            if (self == var_547487a5cd081071) {
                removed = 1;
                if (isdefined(new_array)) {
                    new_array = array_remove(new_array, self);
                    continue;
                }
                new_array = array_remove(var_9bde88429952ec6f, self);
            }
        }
...
// Size: 0x191
function function_9c1525e5e9da73f2(module_name, spawner_name, var_7905cc64684e4944, var_93b3f32629d2ec3e, var_8f5df84bde498f90) {
    max_dist = 4000;
    if (isdefined(var_93b3f32629d2ec3e)) {
        max_dist = var_93b3f32629d2ec3e;
    }
    min_dist = 2500;
    if (isdefined(var_7905cc64684e4944)) {
        min_dist = var_7905cc64684e4944;
    }
    var_6a3cc2111e30d71d = min_dist * min_dist;
    spawners = [];
    num = 5;
    if (isdefined(var_8f5df84bde498f90)) {
        num = var_8f5df84bde498f90;
    }
    if (!isdefined(spawner_name)) {
        spawner_name = "wave_spawn_heli";
    }
    var_8daa7ef0c0f67dc1 = getstructarray(spawner_name, "targetname");
    org = function_524c83c2668954ea();
    var_eeca462ce9f2a320 = sortbydistancecullbyradius(var_8daa7ef0c0f67dc1, org, max_dist);
    if (!isdefined(var_eeca462ce9f2a320) || var_eeca462ce9f2a320.size == 0) {
        var_eeca462ce9f2a320 = sortbydistance(var_8daa7ef0c0f67dc1, org);
...
// Size: 0xa1
function function_fd5721a770f0b9c9(type_array, var_8a970a4fdd525614, var_1dbea318de624f2e) {
    foreach (spawner in var_8a970a4fdd525614) {
...
function timeout_wave(timer) {
    ...
    if (isdefined(level.var_603f2855fc89966[level.var_ae12ed8fc05422d2])) {
        foreach (guy in level.var_603f2855fc89966[level.var_ae12ed8fc05422d2]) {
...
function function_577d509cdf72f199(wave_num) {
    ...
    if (!isdefined(level.var_603f2855fc89966[level.var_ae12ed8fc05422d2])) {
        level.var_603f2855fc89966[level.var_ae12ed8fc05422d2] = [];
    }
    var_4318643cda66a61a = ["ground", "paratrooper", "lbravo", "mindia"];
    var_2c5831beac142a62 = ["smg", "ar", "lmg"];
    level.total_spawns = 12;
    level.var_c09a05e4443a256f = 0;
    ...
    case 4: 
        ...
        break;
    case 5: 
        if (level.var_ae12ed8fc05422d2 < 10) {
            var_4318643cda66a61a = ["mindia_jugg_boss"];
    ...
    while (level.var_bae0ff6d10c1e7d8 < level.total_spawns) {
        level.var_c09a05e4443a256f = 0;
        if (isdefined(level.var_603f2855fc89966[level.var_ae12ed8fc05422d2])) {
            level.var_c09a05e4443a256f = level.var_603f2855fc89966[level.var_ae12ed8fc05422d2].size;
        }
        var_bbbc0b66aa0597bc = level.total_spawns - level.var_c09a05e4443a256f - level.var_bae0ff6d10c1e7d8;
        var_55136654a2e10edd = var_1a811cf4b557c3c9 - level.var_c09a05e4443a256f;
        var_64488aa81d0aac39 = min(var_bbbc0b66aa0597bc, var_55136654a2e10edd);
        if (var_64488aa81d0aac39 > 0) {
            if (var_64488aa81d0aac39 < 12) {
                if (array_contains(var_4318643cda66a61a, "mindia")) {
                    var_4318643cda66a61a = array_remove(var_4318643cda66a61a, "mindia");
                }
                if (var_4318643cda66a61a.size == 0) {
                    var_4318643cda66a61a[0] = "lbravo";
                }
            }
            var_2daebd1592ef4e3c = random(var_4318643cda66a61a);
            spawn_request = 3;
            if (level.var_f09a19ac00f88108.size > 0) {
                var_2daebd1592ef4e3c = "ground";
                spawn_request = level.var_f09a19ac00f88108.size;
            } else {
                switch (var_2daebd1592ef4e3c) {
                ...
                case #"hash_8d96201d150187de": 
                    spawn_request = min(var_64488aa81d0aac39, 3);
                    break;
            ...
            if (var_64488aa81d0aac39 < spawn_request) {
            } else {
                switch (var_2daebd1592ef4e3c) {
                case #"hash_8d96201d150187de": 
...
function function_6d2bbb090901ad4b(var_2c5831beac142a62, var_4aa0f44c1a6b235f, var_94a1f19adc274198) {
    ...
    var_9ed4b6b42fd80c8e = function_ac3679951b7689c3(spawners, type_array, num_to_spawn);
    return var_9ed4b6b42fd80c8e;
}
...
function function_fa504167aded72b7(var_2c5831beac142a62, var_4aa0f44c1a6b235f) {
    ...
    var_3c6bec636ac35df8 = [-100, 0, 100];
    for (i = 0; i < 3; i++) {
        for (j = 0; j < 3; j++) {
...
function function_5c3ba13998974994(var_2c5831beac142a62) {
    ...
    heli = function_c7b33824109d7c39(veh_spawner);
    if (isdefined(heli)) {
        num_to_spawn = 12;
        var_9ed4b6b42fd80c8e = heli function_d0e3fc0f5e612280(veh_spawner, type_array, num_to_spawn);
        return var_9ed4b6b42fd80c8e;
    }
    return 0;
}
...
// Size: 0x2e
function function_c7b33824109d7c39(veh_spawner) {
...
// Size: 0x79
function function_ac3679951b7689c3(var_2353898e4d6f348f, type_array, num_to_spawn) {
    type_array = strtok(type_array, " ");
    var_fa8a3a54164a0b8a = [];
    for (i = 0; i < num_to_spawn; i++) {
        index = i % type_array.size;
        var_fa8a3a54164a0b8a[var_fa8a3a54164a0b8a.size] = type_array[index];
    }
    var_9ed4b6b42fd80c8e = spawn_ai_group(num_to_spawn, var_fa8a3a54164a0b8a, var_2353898e4d6f348f);
    return var_9ed4b6b42fd80c8e;
}
...
function function_d0e3fc0f5e612280(spawnpoint, type_array, num_to_spawn) {
    type_array = strtok(type_array, " ");
    var_6398f42a6d3e046c = 2;
    var_fa8a3a54164a0b8a = ["smg", "smg"];
    for (i = 0; i < num_to_spawn; i++) {
        index = i % type_array.size;
        var_fa8a3a54164a0b8a[var_fa8a3a54164a0b8a.size] = type_array[index];
    }
    num_to_spawn += var_6398f42a6d3e046c;
    var_2353898e4d6f348f = [spawnpoint];
    var_9ed4b6b42fd80c8e = spawn_ai_group(num_to_spawn, var_fa8a3a54164a0b8a, var_2353898e4d6f348f);
    if (var_9ed4b6b42fd80c8e > var_6398f42a6d3e046c) {
        return (var_9ed4b6b42fd80c8e - var_6398f42a6d3e046c);
    }
    return 0;
}
...
// Size: 0x10c
function spawn_ai_group(num_to_spawn, var_fa8a3a54164a0b8a, var_2353898e4d6f348f) {
    spawned = [];
    for (i = 0; i < num_to_spawn; i++) {
        var_2b3fe0e3fb0cd248 = function_faa64720475b9142(var_fa8a3a54164a0b8a, i);
        var_a56471a195bc47ad = i % var_2353898e4d6f348f.size;
        spawnpoint = var_2353898e4d6f348f[var_a56471a195bc47ad];
        soldier = spawnpoint namespace_5729d24318b60bcd::spawn_ai(undefined, undefined, var_2b3fe0e3fb0cd248);
        if (isdefined(soldier)) {
            soldier.dontkilloff = 1;
            soldier.aitype = var_fa8a3a54164a0b8a[i];
...
function function_9742a64af2d2ea49(spawnpoint) {
    ...
    thread namespace_5729d24318b60bcd::function_5d96b05a065564e();
...
// Size: 0x6d
function function_faa64720475b9142(var_fa8a3a54164a0b8a, index) {
    type = var_fa8a3a54164a0b8a[index];
    if (level.var_ae12ed8fc05422d2 > 5) {
        switch (type) {
...
function spawn_dog(spawnpoint) {
    ...
    ai = namespace_d9d93e01b62de24a::function_43825e7633150be3(aitype, spawnpoint, 0);
    if (isdefined(ai)) {
...
// Size: 0x136
function function_a9b9234c0760c45e(spawnpoint, var_fa8a3a54164a0b8a, goalradius) {
    spawned = [];
    for (i = 0; i < var_fa8a3a54164a0b8a.size; i++) {
        type = var_fa8a3a54164a0b8a[i];
...
function function_596d07facb536bbc() {
    ...
    self.goalradius = 32;
    self.var_676f66fec9e74526 = "get_closer";
    while (true) {
        ...
        if (self.var_676f66fec9e74526 == "get_closer_fast") {
            self.goalradius = 32;
        ...
        } else if (self.var_676f66fec9e74526 == "get_closer") {
            self.goalradius = 32;
            self.scripted_mode = 1;
            ...
            if (distancesquared(self.origin, enemy.origin) > dist_sq) {
                ...
                self.var_676f66fec9e74526 = "close_enough";
                self setgoalpos(self.origin);
            }
        } else {
            self.goalradius = 1500;
            self.scripted_mode = 0;
            var_34fa6c6b9e4ff7b7 = distancesquared(self.origin, enemy.origin);
            if (var_34fa6c6b9e4ff7b7 > var_45fafae5d6358b8a) {
                self.var_676f66fec9e74526 = "get_closer_fast";
            } else if (var_34fa6c6b9e4ff7b7 > far_dist_sq) {
                self.var_676f66fec9e74526 = "get_closer";
            }
        }
        wait 1;
...
// Size: 0x8e
function function_5775b1927fd651c4(var_fa8a3a54164a0b8a, thresh, var_6bc06a9511457a26, wait_for_killed) {
    position = function_91e608317eb58eb2();
    spawnpoint = namespace_7adb1ffcf7f14c91::function_9581045871f15252(position, 5000, 3000);
    if (!isdefined(var_fa8a3a54164a0b8a)) {
        var_fa8a3a54164a0b8a = namespace_6d1c9cb20efeb350::function_de96b8a387dbe2a("ar_smg");
    }
    enemies = function_a9b9234c0760c45e(spawnpoint, var_fa8a3a54164a0b8a, 800);
    if (!isdefined(thresh)) {
        thresh = 1;
    }
