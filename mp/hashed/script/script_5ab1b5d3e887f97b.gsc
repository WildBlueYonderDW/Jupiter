...
#namespace namespace_7ff0bdbbe7256248;

// Namespace namespace_7ff0bdbbe7256248 / namespace_98791d45ebbb91
// Params 0, eflags: 0x1
...
function postinitfunc() {
    ...
    level.var_fdb0f54eca98739d = spawnstruct();
    level.var_fdb0f54eca98739d.minstarttime = getdvarfloat(@"hash_f738aad5ca938723", 60);
    level.var_fdb0f54eca98739d.maxstarttime = getdvarfloat(@"hash_f75ba0d5cab9b8dd", 565);
    level.var_fdb0f54eca98739d.var_38c3775981fbc7ef = getdvarfloat(@"hash_a38f2ce7676edb19", 1800);
    level.var_fdb0f54eca98739d.var_88f734bb6033570 = getdvarfloat(@"hash_eeeb1f6afe3519ee", 0.05);
    level.var_fdb0f54eca98739d.var_ad4754cdffb212ee = getdvarfloat(@"hash_c80aab9d623eec4f", 525);
    level.var_fdb0f54eca98739d.var_49a91f803883d065 = getdvarfloat(@"hash_d6eab54faa5aafc7", 38);
    level.var_fdb0f54eca98739d.var_a7ff560156dd7340 = getdvarfloat(@"hash_7960ba20c43fef93", 3);
    level.var_fdb0f54eca98739d.var_5900c5a18edd28b8 = getdvarfloat(@"hash_43fe04b82f4f4", 4650);
    level.var_fdb0f54eca98739d.var_c25236f9a676187e = getdvarint(@"hash_2ea7541ddf02bd32", 2);
    level.var_fdb0f54eca98739d.var_444c60db3001d089 = getdvarfloat(@"hash_158f4b7e0b27abcf", 2);
    level.var_fdb0f54eca98739d.var_29d617346106c7ce = getdvarfloat(@"hash_78ddb2523cba6d0b", 1000);
    level.var_fdb0f54eca98739d.var_4ac907eaeb7ae36c = getdvarfloat(@"hash_592c14fd41fee008", 10);
    level.var_fdb0f54eca98739d.var_2a1281ec65f0ea7c = getdvarfloat(@"hash_88d54cc694aa46ab", 20);
    level.var_fdb0f54eca98739d.var_182601446ee9cb5f = getscriptbundle(hashcat(%"hash_684724f6313c6a6", "jup_publicevent_areadenial_data"));
    level.var_fdb0f54eca98739d.var_182601446ee9cb5f.var_1d427aef6070dab3 = function_70fec4c2d7c0974f(level.var_fdb0f54eca98739d.var_182601446ee9cb5f.var_1d427aef6070dab3, level.var_fdb0f54eca98739d.var_a7ff560156dd7340);
    level.var_fdb0f54eca98739d.var_4bfb10f83d4628af = [];
    ...
    if (var_877e12a935a24f12 != "") {
        ...
        if (var_7a3e24e5f2e6c89b.size > 0) {
            foreach (delayoverride in var_7a3e24e5f2e6c89b) {
                level.var_fdb0f54eca98739d.var_4bfb10f83d4628af[level.var_fdb0f54eca98739d.var_4bfb10f83d4628af.size] = float(delayoverride);
            }
        }
    }
    cylinderheight = scripts\cp_mp\parachute::getc130height();
    level.var_fdb0f54eca98739d.var_18d9a7d50c32c876 = getdvarint(@"hash_1c6acd7a92de6c21", cylinderheight);
    level.var_fdb0f54eca98739d.var_85324d63191386df = [];
    level.var_fdb0f54eca98739d.var_f376e6fd9d704520 = [];
    /#
...
function function_9d7adb0c85ad032c() {
    ...
    radius = level.var_fdb0f54eca98739d.var_38c3775981fbc7ef;
    height = level.var_fdb0f54eca98739d.var_18d9a7d50c32c876;
    var_41c592e0fde2cc32 = [];
    var_9b6910a128f07c81 = [];
    var_5432f286e9fd81eb = 0;
    var_db18d54fe0bfc2aa = level.var_fdb0f54eca98739d.var_c25236f9a676187e;
    ...
    var_927c9ccd0c6657f2 = var_db18d54fe0bfc2aa * level.var_fdb0f54eca98739d.var_4ac907eaeb7ae36c + var_db18d54fe0bfc2aa * level.var_fdb0f54eca98739d.var_49a91f803883d065 + var_5432f286e9fd81eb;
    thread starttimer(var_927c9ccd0c6657f2);
    sweepdirection = undefined;
    for (i = 0; i < level.var_fdb0f54eca98739d.var_c25236f9a676187e; i++) {
        ...
        var_c8248c2a5a713736 = level.var_fdb0f54eca98739d.var_49a91f803883d065 + maxdelay + level.var_fdb0f54eca98739d.var_4ac907eaeb7ae36c;
...
function function_c2d3b64efe3c0908(var_2ec15a7b9d6c1831, var_761bbb068c79f3f2, radius, sweepdirection, height, var_5034a2690f4a2717) {
    ...
    for (i = 0; i < level.var_fdb0f54eca98739d.var_a7ff560156dd7340; i++) {
        offsetmult = (i & 1) == 0 ? i / 2 : (i + 1) * -1 / 2;
        offsetmult *= level.var_fdb0f54eca98739d.var_5900c5a18edd28b8;
...
function function_cb80ba26086187c4(var_2ec15a7b9d6c1831, var_761bbb068c79f3f2, radius, direction, height, startdelay, originoffset) {
    ...
    speed = level.var_fdb0f54eca98739d.var_ad4754cdffb212ee;
    var_ef4da36c20aa6fb = level.var_fdb0f54eca98739d.var_49a91f803883d065;
    var_dc1ebadf636daf52 = (level.var_fdb0f54eca98739d.var_4ac907eaeb7ae36c + var_ef4da36c20aa6fb * 0.5) * speed;
    ...
    var_9249aa69a161712d = level.var_fdb0f54eca98739d.var_18d9a7d50c32c876 + level.var_fdb0f54eca98739d.var_29d617346106c7ce;
    ...
    var_a5cb914a9154c613.var_ef4da36c20aa6fb = var_ef4da36c20aa6fb;
    var_a5cb914a9154c613.sweepspeed = speed;
    var_a5cb914a9154c613.var_2ec15a7b9d6c1831 = var_2ec15a7b9d6c1831;
    var_a5cb914a9154c613.var_13aece9b7dc02671 = radius * 5.5;
    var_a5cb914a9154c613.var_1a4a3e72a8e64c38 = var_23cfad28045c532f + level.var_fdb0f54eca98739d.var_4ac907eaeb7ae36c * speed * direction;
    var_a5cb914a9154c613.var_fcbe88ac116375c7 = var_23cfad28045c532f + (level.var_fdb0f54eca98739d.var_4ac907eaeb7ae36c + level.var_fdb0f54eca98739d.var_49a91f803883d065) * speed * direction;
    var_a5cb914a9154c613.var_85324d63191386df = [];
    if (!isdefined(level.var_fdb0f54eca98739d.var_f376e6fd9d704520)) {
        level.var_fdb0f54eca98739d.var_f376e6fd9d704520 = [];
    }
    level.var_fdb0f54eca98739d.var_f376e6fd9d704520 = array_add(level.var_fdb0f54eca98739d.var_f376e6fd9d704520, var_a5cb914a9154c613);
    ...
    var_3241fb10d1a5e334 = direction * speed * var_ef4da36c20aa6fb * 0.5;
...
function function_1b86e63b88f95880() {
    ...
    while (true) {
        foreach (drone in level.var_fdb0f54eca98739d.var_f376e6fd9d704520) {
            if (istrue(drone.var_ce9d73218733c4ec)) {
                continue;
            }
            nearbyplayers = utility::playersincylinder(drone.origin, drone.var_13aece9b7dc02671, undefined, drone.height);
...
function function_710abf9f376821bd() {
    ...
    foreach (player in level.players) {
        if (!player scripts\mp\gametypes\br_public::isplayerinorgoingtogulag() && isreallyalive(player)) {
            level.var_fdb0f54eca98739d.var_da5faf6c293501f7 = function_6d6af8144a5131f1(level.var_fdb0f54eca98739d.var_da5faf6c293501f7, player);
            continue;
        }
...
function function_8ba6729fe64a5b69() {
    ...
    while (true) {
        ...
        #/
        wait level.var_fdb0f54eca98739d.var_88f734bb6033570;
    }
}
...
function function_aec9c54c8967fe89(durationseconds) {
    step = level.var_fdb0f54eca98739d.var_ad4754cdffb212ee * level.framedurationseconds;
    time = 0;
...
function function_4a6a9d022db5af8c() {
    function_aec9c54c8967fe89(level.var_fdb0f54eca98739d.var_4ac907eaeb7ae36c);
}
...
function function_84db74c613606304() {
    thread function_d4a1bf18d5ba7df1(self.var_ef4da36c20aa6fb);
    function_aec9c54c8967fe89(self.var_ef4da36c20aa6fb);
}
...
function function_b8f94321062a981b() {
    function_aec9c54c8967fe89(level.var_fdb0f54eca98739d.var_2a1281ec65f0ea7c);
}
...
function function_4d19d4aa5e8c6865() {
    ...
    level endon("cancel_public_event");
    level endon("area_denial_cancel");
    if (!isdefined(self.var_ef4da36c20aa6fb) || !isdefined(self.radius) || !isdefined(self.origin) || !isdefined(self.scriptable) || !isdefined(self.direction)) {
        return;
    }
    ...
    level.var_fdb0f54eca98739d.var_f376e6fd9d704520 = array_remove(level.var_fdb0f54eca98739d.var_f376e6fd9d704520, self);
...
function function_d3ce533932f11610(player) {
    ...
    level.var_fdb0f54eca98739d.var_1314799d6fcadf1 = function_6d6af8144a5131f1(level.var_fdb0f54eca98739d.var_1314799d6fcadf1, player);
    level.var_fdb0f54eca98739d.var_85324d63191386df = function_6d6af8144a5131f1(level.var_fdb0f54eca98739d.var_85324d63191386df, player);
...
function function_d788489e8b30bb51(player) {
    ...
    level.var_fdb0f54eca98739d.var_85324d63191386df = array_remove(level.var_fdb0f54eca98739d.var_85324d63191386df, player);
    player waittill_any_timeout_1(level.var_fdb0f54eca98739d.var_444c60db3001d089, "death");
...
function function_e99b445ad2890c72(var_761bbb068c79f3f2, var_a87e0ef0a96c75ad) {
    ...
    if (isdefined(var_a87e0ef0a96c75ad) && isvector(var_a87e0ef0a96c75ad)) {
        ...
        var_978fa2d885631e3b = function_eb7b779e8b1dec9f(var_761bbb068c79f3f2, level.var_fdb0f54eca98739d.var_5900c5a18edd28b8);
        if (isdefined(var_978fa2d885631e3b)) {
            ...
            var_88b83b0d7a43ea72 = acos(level.var_fdb0f54eca98739d.var_5900c5a18edd28b8 / var_903ecc55ae500012);
...
function function_885a34198bc9d718(var_761bbb068c79f3f2, sweepdirection) {
    ...
    var_6740c0173953f46a = level.var_fdb0f54eca98739d.var_ad4754cdffb212ee * level.var_fdb0f54eca98739d.var_49a91f803883d065 * 0.5;
    ...
    var_3e3904eab2e0b226 = distance2dsquared(var_819edacdacb810e4, var_cc4ac4ff5ee20fa6) > var_52d8b8e0cc5d1871;
    var_639d5d63419217ff = distance2dsquared(var_819edacdacb810e4, var_e22ae89a1cfb5aad) > var_52d8b8e0cc5d1871;
    if (!var_3e3904eab2e0b226 && !var_639d5d63419217ff) {
        return var_761bbb068c79f3f2;
    }
    var_bea75a5f70137d1c = var_819edacdacb810e4 - var_761bbb068c79f3f2;
...
function function_b26cda0ae84a23c9() {
    if (isdefined(level.var_fdb0f54eca98739d.var_4bfb10f83d4628af) && level.var_fdb0f54eca98739d.var_4bfb10f83d4628af.size > 0) {
        return level.var_fdb0f54eca98739d.var_4bfb10f83d4628af;
    }
    delays = [];
    if (!isdefined(level.var_fdb0f54eca98739d.var_182601446ee9cb5f) || !isdefined(level.var_fdb0f54eca98739d.var_182601446ee9cb5f.var_1d427aef6070dab3) || !isarray(level.var_fdb0f54eca98739d.var_182601446ee9cb5f.var_1d427aef6070dab3) || level.var_fdb0f54eca98739d.var_182601446ee9cb5f.var_1d427aef6070dab3.size <= 0) {
        return delays;
    }
    var_f9d74d26efa4b997 = function_a656c6dfb7dcb33a(level.var_fdb0f54eca98739d.var_182601446ee9cb5f.var_1d427aef6070dab3);
...
function calculateeventstarttime() {
    if (level.var_fdb0f54eca98739d.maxstarttime > level.var_fdb0f54eca98739d.minstarttime) {
        return randomfloatrange(level.var_fdb0f54eca98739d.minstarttime, level.var_fdb0f54eca98739d.maxstarttime);
    }
    return level.var_fdb0f54eca98739d.minstarttime;
}
...
function function_b7e920cec1a740f0() {
    level.var_fdb0f54eca98739d.dlogdata = [];
    level.var_fdb0f54eca98739d.dlogdata["circle_index"] = ter_op(isdefined(level.br_circle), level.br_circle.circleindex + 1, -1);
    level.var_fdb0f54eca98739d.dlogdata["affected_player_count_per_sweep"] = [];
    level.var_fdb0f54eca98739d.var_da5faf6c293501f7 = [];
    level.var_fdb0f54eca98739d.dlogdata["detected_player_count_per_sweep"] = [];
    level.var_fdb0f54eca98739d.var_1314799d6fcadf1 = [];
    level.var_fdb0f54eca98739d.dlogdata["killed_detected_player_count_per_sweep"] = [];
    level.var_fdb0f54eca98739d.var_4a1efd0a5ea942ae = [];
...
function function_e8b32e400a713124() {
    level.var_fdb0f54eca98739d.dlogdata["affected_player_count_per_sweep"] = array_add(level.var_fdb0f54eca98739d.dlogdata["affected_player_count_per_sweep"], level.var_fdb0f54eca98739d.var_da5faf6c293501f7.size);
    level.var_fdb0f54eca98739d.var_da5faf6c293501f7 = [];
    level.var_fdb0f54eca98739d.dlogdata["detected_player_count_per_sweep"] = array_add(level.var_fdb0f54eca98739d.dlogdata["detected_player_count_per_sweep"], level.var_fdb0f54eca98739d.var_1314799d6fcadf1.size);
    level.var_fdb0f54eca98739d.var_1314799d6fcadf1 = [];
    level.var_fdb0f54eca98739d.dlogdata["killed_detected_player_count_per_sweep"] = array_add(level.var_fdb0f54eca98739d.dlogdata["killed_detected_player_count_per_sweep"], level.var_fdb0f54eca98739d.var_4a1efd0a5ea942ae.size);
    level.var_fdb0f54eca98739d.var_4a1efd0a5ea942ae = [];
}
...
function function_f1155cc70db3c061() {
    dlog_recordevent("dlog_event_areadenial_match_event", ["circle_index", level.var_fdb0f54eca98739d.dlogdata["circle_index"], "affected_player_count_per_sweep", level.var_fdb0f54eca98739d.dlogdata["affected_player_count_per_sweep"], "detected_player_count_per_sweep", level.var_fdb0f54eca98739d.dlogdata["detected_player_count_per_sweep"], "killed_detected_player_count_per_sweep", level.var_fdb0f54eca98739d.dlogdata["killed_detected_player_count_per_sweep"]]);
...
function function_ed53542e4f0e5f9d(deathdata) {
    if (array_contains(level.var_fdb0f54eca98739d.var_1314799d6fcadf1, deathdata.victim)) {
        level.var_fdb0f54eca98739d.var_4a1efd0a5ea942ae = function_6d6af8144a5131f1(level.var_fdb0f54eca98739d.var_da5faf6c293501f7, deathdata.victim);
    }
}
