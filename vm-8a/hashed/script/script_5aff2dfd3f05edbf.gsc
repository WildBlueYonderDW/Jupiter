...
function private init_vars() {
    ...
    assertex(isdefined(bundle), "<dev string:x1c>" + "<dev string:x35>" + "<dev string:x4c>" + "<dev string:x5a>");
...
/#
    ...
    function function_db5c75f2a84ff03d() {
        scripts\common\devgui::function_6e7290c8ee4f558b("<dev string:x69>");
        scripts\common\devgui::function_a9a864379a098ad6("<dev string:x7e>", "<dev string:x8a>", &function_defff2269ca98e79);
    ...
    function function_defff2269ca98e79() {
        ...
        heli = sortbydistance(level.vehicle.instances["<dev string:xa4>"], v_pos)[0];
        if (heli == level.research_vessel.heli) {
            heli = sortbydistance(level.vehicle.instances["<dev string:xa4>"], v_pos)[1];
        }
        while (isalive(heli)) {
