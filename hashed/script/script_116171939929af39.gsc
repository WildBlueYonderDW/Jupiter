    ...
    if (channel == "jump_to_start") {
        ...
        if (isdefined(tokens[value - 1])) {
            if (isdefined(level.start_arrays) && isdefined(level.start_arrays[tokens[value - 1]])) {
                setdvar(@"hash_8cb00b8c1f5ff522", tokens[value - 1]);
...
function function_62e5612ad414abf() {
    return getdvar(@"hash_8588ca386dbff67") == "dedicated lan server" || getdvar(@"hash_8588ca386dbff67") == "dedicated internet server";
}
...
function demo_toggle_infiniteammo() {
    value = getdvarint(@"hash_a48570b2b90adb33", 0);
    if (value == 0) {
    ...
    setdvar(@"hash_a48570b2b90adb33", value);
}
...
function monitor_num_players() {
    ...
    var_4e272a6bb24a5e12 = getdvar(@"party_partyPlayerCountNum");
