...
function init_player_death() {
    ...
    /#
        ...
        setdvarifuninitialized(@"hash_d20570703776a47e", 0);
    #/
    thread main();
}
...
function main() {
    ...
    attacker, cause, objweapon, movingplatform, inflictor, test1, test2, test3, test4 = level.player waittill("death");
...
function pick_death(stance, running, cause, attacker) {
    ...
    /#
        if (getdvarint(@"hash_d20570703776a47e", 0) == 1) {
            if (deaths.size == 0) {
...
function setdeathangles(attacker, stance, var_71384d778a20d5c2, movingplatform) {
    ...
    /#
        if (getdvarint(@"hash_d20570703776a47e")) {
