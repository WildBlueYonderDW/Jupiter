...
#namespace jup_enemy_mp_lmg_tier2_pmc;

// Namespace jup_enemy_mp_lmg_tier2_pmc / namespace_aae49e999d5b492d
// Params 0, eflags: 0x0
// Checksum 0x0, Offset: 0x263
// Size: 0x1e0
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_mp_lmg_tier2_pmc" );
...
function precache()
{
    agent_type = "actor_jup_enemy_mp_lmg_tier2_pmc";
