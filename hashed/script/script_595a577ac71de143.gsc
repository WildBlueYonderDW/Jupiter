...
function private function_5cf9263cdde7f142() {
    /#
        ...
        scripts/common/devgui::function_b23a59dfb4ca49a1("<unknown string>", "<unknown string>" + "<unknown string>", &debug_visionset);
        scripts/common/devgui::function_b23a59dfb4ca49a1("<unknown string>", "<unknown string>" + "<unknown string>", &debug_visionset);
        scripts/common/devgui::function_b23a59dfb4ca49a1("<unknown string>", "<unknown string>" + "<unknown string>", &debug_visionset);
        scripts/common/devgui::function_b23a59dfb4ca49a1("<unknown string>", "<unknown string>", &function_97ec04fd36f9b911);
        scripts/common/devgui::function_b23a59dfb4ca49a1("<unknown string>", "<unknown string>", &function_46a1a0c6592edc27);
        scripts/common/devgui::function_b23a59dfb4ca49a1("<unknown string>", "<unknown string>", &function_34ec067faab1f472);
...
function private function_3388294e62fdd0bc(params) {
    ...
    /#
        ...
        if (isdefined(mood)) {
            iprintlnbold(mood.state.visionsetsuffix + "<unknown string>" + newdifficulty);
        }
    #/
...
function private function_1ad29958b0c16235() {
    /#
        scripts/common/devgui::function_6e7290c8ee4f558b("<unknown string>");
        scripts/common/devgui::function_b23a59dfb4ca49a1("<unknown string>", "<unknown string>", &function_37d964772b906469);
        scripts/common/devgui::function_fe953f000498048f();
        scripts/common/devgui::function_6e7290c8ee4f558b("<unknown string>");
        scripts/common/devgui::function_b23a59dfb4ca49a1("<unknown string>", "<unknown string>" + "<unknown string>" + "<unknown string>", &debug_mood);
        scripts/common/devgui::function_b23a59dfb4ca49a1("<unknown string>", "<unknown string>" + "<unknown string>" + "<unknown string>", &debug_mood);
        scripts/common/devgui::function_b23a59dfb4ca49a1("<unknown string>", "<unknown string>" + "<unknown string>" + "<unknown string>", &debug_mood);
        scripts/common/devgui::function_b23a59dfb4ca49a1("<unknown string>", "<unknown string>" + "<unknown string>", &function_8d0e7f7fe911132a);
        scripts/common/devgui::function_b23a59dfb4ca49a1("<unknown string>", "<unknown string>" + "<unknown string>", &function_943833c459d1100);
        scripts/common/devgui::function_fe953f000498048f();
        scripts/common/devgui::function_6e7290c8ee4f558b("<unknown string>");
        scripts/common/devgui::function_b23a59dfb4ca49a1("<unknown string>", "<unknown string>" + "<unknown string>", &debug_mood);
        scripts/common/devgui::function_b23a59dfb4ca49a1("<unknown string>", "<unknown string>" + "<unknown string>", &debug_mood);
        scripts/common/devgui::function_b23a59dfb4ca49a1("<unknown string>", "<unknown string>" + "<unknown string>", &debug_mood);
        scripts/common/devgui::function_b23a59dfb4ca49a1("<unknown string>", "<unknown string>", &function_8d0e7f7fe911132a);
        scripts/common/devgui::function_b23a59dfb4ca49a1("<unknown string>", "<unknown string>", &function_943833c459d1100);
        scripts/common/devgui::function_fe953f000498048f();
    #/
}
