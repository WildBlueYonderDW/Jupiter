...
function function_c75af84dd6eab876() {
    ...
    assertex(isdefined(self.s_center), "Can't find a valid struct for Mercenary Camp with targetname " + self.varianttag);
...
function function_50f6110631f4d234() {
    ...
    foreach (str_hazard in var_23890c9beb8de5ba) {
        ...
        case #"hash_a5c91c69bb471104": 
            ...
            break;
        default: 
            assert("Undefined merc camp hazard - " + str_hazard);
            break;
        }
        waitframe();
    }
...
function function_184f4af0ddd67790() {
    ...
    if (isdefined(self.loot_marker)) {
        ...
        /#
            if (!isdefined(self.var_c441245b5c737557) || "<dev string:x1c>" != self.var_c441245b5c737557 getscriptablepartstate("<dev string:x2a>")) {
                println("<dev string:x2f>" + self.var_c441245b5c737557.origin);
            }
        #/
...
function function_fdff165a3e012db6(requestid, activityinstance) {
    ...
    assert(function_73bd348a2ec322cf(activityinstance) == "ActiveState");
...
function function_de20787ef0f118bc() {
    ...
    while (true) {
        ...
        for (i = 0; i < self.variant_definition.var_6148f30571b073ba; i++) {
...
function function_efcf810b1e6f4e71(player, var_a917328b0b1b2a19) {
    if (!istrue(self.var_bdabae3e6bce45) || function_73bd348a2ec322cf(self) != "ActiveState") {
        /#
            ob_humans::function_dd0ceeddc603cb3e(player, self, "<dev string:x8c>");
        #/
        return;
    }
    ...
    if (istrue(var_a917328b0b1b2a19)) {
        /#
            ob_humans::function_dd0ceeddc603cb3e(player, self, "<dev string:xb6>");
        #/
        ...
        if (!array_contains(self.var_189ca75754491759, player)) {
            if (isdefined(var_aec21a5b011527dc) && isarray(var_aec21a5b011527dc) && var_aec21a5b011527dc.size == 1 && isdefined(player.guid) && istrue(var_aec21a5b011527dc[player.guid])) {
                if (!istrue(self.var_8b79601f5cca1fa9)) {
                    ...
                    /#
                        ob_humans::function_dd0ceeddc603cb3e(player, self, "<dev string:xd2>");
                    #/
                }
            } else {
                /#
                    ob_humans::function_dd0ceeddc603cb3e(player, self, "<dev string:x117>");
                #/
            }
        } else {
            /#
                ob_humans::function_dd0ceeddc603cb3e(player, self, "<dev string:x156>");
            #/
        }
        return;
    }
...
function function_8e4e1fc9ff81363c(players) {
    if (!isdefined(self) || !isdefined(players) || !isarray(players) || players.size == 0) {
        /#
            ob_humans::function_f7e877aa7e97d952(self, "<dev string:x191>");
        #/
        return;
    }
    self endon("activity_ended");
    ...
    if (!on_mission) {
        /#
            ...
            ob_humans::function_dd0ceeddc603cb3e(player, self, "<dev string:x1c3>" + self.var_fbe46459634710c1 + "<dev string:x1e1>");
        #/
    ...
    /#
        ob_humans::function_dd0ceeddc603cb3e(player, self, "<dev string:x1e3>");
    #/
}
...
function function_6216e8ce2640ec45(var_e501c18e04378d20) {
    ...
    /#
        ob_humans::function_dd0ceeddc603cb3e(var_e501c18e04378d20, self, "<dev string:x215>");
    #/
    if (namespace_838b439602b3acc7::function_5acc35fc66331385(var_e501c18e04378d20, 17078) || getdvarint(@"hash_7b8b09c504a0c9a0", 0)) {
        /#
            ob_humans::function_dd0ceeddc603cb3e(var_e501c18e04378d20, self, "<dev string:x233>");
        #/
        params = spawnstruct();
    ...
    /#
        ...
        ob_humans::function_dd0ceeddc603cb3e(var_e501c18e04378d20, self, "<dev string:x269>");
    #/
...
function function_299ddda5b65917c8(var_b381b0883bcd4847) {
    ...
    if (isdefined(self.var_c441245b5c737557) && self.var_c441245b5c737557 getscriptablepartstate("body") == "hidden") {
        println("<dev string:x280>" + self.var_c441245b5c737557.origin + "<dev string:x2b5>");
...
function private function_e4cb6ba98b816518() {
    ...
    while (isdefined(lootcache)) {
        lootid, player = lootcache waittill("cache_item_looted");
