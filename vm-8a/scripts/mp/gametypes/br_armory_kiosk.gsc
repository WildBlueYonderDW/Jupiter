...
function function_d84cdb7463425ba(var_9023cea8f03e72d2) {
    ...
    while (stationitem != "") {
        ...
        if (itemindex < 15) {
            ...
            println("<dev string:x1c>" + itemindex + 1 + "<dev string:x46>" + 15 + "<dev string:x4d>" + stationitem + "<dev string:x54>" + var_9023cea8f03e72d2);
        }
        itemindex++;
        var_ac75b489772f26ce = 4 * itemindex;
...
function private function_96e56767b949c013(stationstruct, var_3d329ebb0d03d6db, var_849e91c5e0d0e0df) {
    ...
    /#
        namespace_d1a9ca87d78d9813::function_9533653868e59fb6("<dev string:x7a>", "<dev string:x86>", undefined, "<dev string:x95>", undefined, undefined, stationstruct.poi, stationstruct.origin);
    #/
...
function private function_b8e0fea098fb260b(var_cb8ce683e2999310) {
    ...
    foreach (struct in var_459c7f8de067151) {
        if (isdefined(struct.script_noteworthy) && struct.script_noteworthy == "workbench") {
            ...
            /#
                namespace_d1a9ca87d78d9813::function_9533653868e59fb6("<dev string:xbd>", "<dev string:xc7>", undefined, "<dev string:xd4>", undefined, undefined, struct.poi, struct.origin);
            #/
            return;
        }
    }
...
function restartcircleelimination(origin) {
    ...
    /#
        if (level.script == "<dev string:xf9>") {
...
function playerredeploy(groundorigin, overrideheight, overrideyaw) {
    ...
    if (!player islinked()) {
        ...
        /#
            scripts\mp\utility\script::demoforcesre("<dev string:x109>" + player.name + "<dev string:x111>");
        #/
    }
    player unlink();
