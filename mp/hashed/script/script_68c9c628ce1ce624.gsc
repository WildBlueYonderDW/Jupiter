    ...
    for (i = 0; i < var_efa963805ba84047.size; i++) {
        ...
        if (vfx.type == "nade") {
            if (vfx.weaponname == "explosion") {
                ...
                radiusdamage(vfx.var_7e44076d428e631d, scripts\engine\utility::ter_op(vfx.startlocation[0] > 0, vfx.startlocation[0], 100), scripts\engine\utility::ter_op(vfx.startlocation[1] > 0, vfx.startlocation[1], 500), scripts\engine\utility::ter_op(vfx.startlocation[2] > 0, vfx.startlocation[2], 500), player, "MOD_EXPLOSIVE", "c4_mp");
            } else {
                player launchgrenade(vfx.weaponname, vfx.var_7e44076d428e631d, (0, 0, 0), 0.05);
            }
            continue;
        }
        if (vfx.type == "missile") {
            magicbullet(vfx.weaponname, vfx.startlocation, vfx.var_7e44076d428e631d);
        }
    }
}
...
// Size: 0x7e
function private function_8763c8d36e19655e(type, weaponname, startlocation, var_7e44076d428e631d, var_da3878c8f78d9c9c) {
    vfx_struct = spawnstruct();
    vfx_struct.var_7e44076d428e631d = var_7e44076d428e631d;
        ...
        for (;;) {
            ...
            foreach (vfx_array in level.var_4a94dc5bca439216) {
                foreach (index, vfx in vfx_array) {
                    ...
                    sphere(vfx.var_7e44076d428e631d, sphere_radius, (0, 1, 0), 0, 1);
                    sphere(vfx.var_7e44076d428e631d, var_5dcdab91d656aac8, (0, 1, 0), 0, 1);
                    print3d(vfx.var_7e44076d428e631d, scripts\engine\utility::string(index) + "<dev string:x40a>" + vfx.weaponname, (0, 1, 0), 1, 0.75, 1, 1);
                }
            }
            waitframe();
        }
