...
function function_b8e5141bbcda90e() {
    if (isdefined(level.var_376e6e8117393127)) {
        ...
        var_d31429e0a68259a4 namespace_14d36171baccf528::function_c37c4f9d687074ff("body_c_jup_sp_enemy_pmc_spforce_05", "head_c_jup_sp_enemy_pmc_spforce_04");
...
function function_c65a4e91afcf5b6b() {
    level endon("game_ended");
    level endon("disconnect");
    namespace_446fc987a980892f::playconversation("s2_outlast_complete", level.players);
}
...
function throw_grenade() {
    ...
    level.var_376e6e8117393127 namespace_14d36171baccf528::function_ae99616202575e39(level.gasfx.origin, "s2_aether_grenade_vial_ob");
...
function function_24a7b362c9c4595a() {
    ...
    level.var_376e6e8117393127 thread namespace_14d36171baccf528::function_ae99616202575e39(level.gasfx.origin, "gas_grenade_exgm_chemist_rift_offensive");
    level.gasfx setscriptablepartstate("formation_vfx", "active");
...
// Size: 0x11
function function_8ca3825e113a2579() {
