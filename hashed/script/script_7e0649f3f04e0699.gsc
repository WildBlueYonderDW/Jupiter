...
// Namespace decon_station / namespace_df060ba75a7e3127
// Params 0, eflags: 0x1
// Checksum 0x0, Offset: 0x758
// Size: 0xb
function autoexec main() {
    level thread namespace_df060ba75a7e3127::function_1842bad814634447();
}
...
function function_9748251d23375c78() {
    if (!isdefined(level.decon_station)) {
        ...
        level.decon_station.var_baa46b7703510b2c = [];
    }
    level.decon_station.var_500a0164b0cd5a9d = getdvarfloat(@"hash_dcc4c6adcb09a2bb", 15);
    level.decon_station.var_2396e4894114d1bf = getdvarfloat(@"hash_1a5d6dc2676025fa", 7.5);
    level.decon_station.lifetime = level.decon_station.var_500a0164b0cd5a9d;
    ...
    level.decon_station.var_692805d1a62a81a5 = getdvarfloat(@"hash_22132f9a26c58f74", 0.1);
    level.decon_station.infinite_ammo = getdvarint(@"hash_ca77644dc451154f", 0);
    level.decon_station.var_1de6dcea466ccf7c = getdvarint(@"hash_ec721cc3212bbddd", 1);
...
function function_1625d782aa1489fa() {
    ...
    level.decon_station.loot_id = namespace_38b993c4618e76cd::function_fae5e1d3de32d3f7("brloot_offhand_deconstation");
...
function function_a04b98235b2cc5d6() {
    ...
    var_7fa627fbfec76c55 = level.br_level.br_circleclosetimes.size;
    level.decon_station.var_a00b881d8f9acddd = var_7fa627fbfec76c55 - level.decon_station.var_c413cb4751d8814c;
    level.decon_station.var_7a6ea5da5bb808f8 = var_7fa627fbfec76c55 - level.decon_station.var_1001d9fdfbdb1927;
    ...
    for (;;) {
        ...
        var_f7882b5edc55accb = level.br_circle.circleindex + 1;
        t = clamp((var_f7882b5edc55accb - level.decon_station.var_a00b881d8f9acddd) / diff, 0, 1);
        level.decon_station.lifetime = math::lerp(level.decon_station.var_500a0164b0cd5a9d, level.decon_station.var_2396e4894114d1bf, t);
        level.decon_station.pct = int(level.decon_station.lifetime / level.decon_station.var_500a0164b0cd5a9d * 100);
        ...
        level.decon_station.var_baa46b7703510b2c = utility::array_removeundefined(level.decon_station.var_baa46b7703510b2c);
        foreach (loot in level.decon_station.var_baa46b7703510b2c) {
...
function function_e61a64964ffa423e() {
    level.decon_station.var_baa46b7703510b2c[level.decon_station.var_baa46b7703510b2c.size] = self;
...
function function_c06383227e374b98(instance) {
    ...
    instance.var_c01be46e4bbd0431 = [];
    instance.var_5de2c002fa6e74d9 = [];
    ...
    stuckto = instance waittill("missile_stuck");
...
function function_34f8be6e5619de8e() {
    ...
    self.var_240f097a821f6fcc = gettime();
    self.var_bdcf531a96c87295 = gettime() + level.decon_station.lifetime * 1000;
...
function function_a51acf6aec4e93f6(instance) {
    ...
    var_8dd275fb9eaf444f = "exit_decon_station_aura" + instance getentitynumber();
    self endon(var_8dd275fb9eaf444f);
...
function function_8e816db9a263e987(instance) {
    ...
    while (isalive(self)) {
        wait 1;
        instance.var_b5c753b9312f9313[index] = instance.var_b5c753b9312f9313[index] + 1;
...
function function_6b5fe5bb09eb8d12(instance) {
    var_4c48d1d9cfcb8a2c = "exit_decon_station_aura" + instance getentitynumber();
    self notify(var_4c48d1d9cfcb8a2c);
    function_fd28f2264da9d3c7();
    function_9f9a669cc625c8fd();
}
...
function function_128a4fee743da6b8() {
    ...
    while (true) {
        ...
        if (isdefined(instance.var_afc8a0438f536281[ent_id]) && istrue(ent.inairpocket)) {
            continue;
        }
        ...
        if (ent vehicle::isvehicle()) {
            ...
            foreach (occupant in occupants) {
                if (isplayer(occupant)) {
                    ...
                    if (isdefined(instance.var_afc8a0438f536281[occupant_id]) && istrue(occupant.inairpocket)) {
                        continue;
                    }
                    if (!instance function_8b9d56208d268672(occupant geteye())) {
                        continue;
                    }
                    instance.var_afc8a0438f536281[occupant_id] = occupant;
        ...
        instance.var_afc8a0438f536281[ent_id] = ent;
...
function function_702dc1894784f5d6(instance) {
    instance.var_afc8a0438f536281[self getentitynumber()] = undefined;
...
function function_24da645ff5f35063() {
    if (istrue(level.decon_station.var_1de6dcea466ccf7c)) {
...
function function_ee7db96b190a4b50() {
    if (isdefined(self.var_afc8a0438f536281)) {
        foreach (player in self.var_afc8a0438f536281) {
    ...
    if (isdefined(self.var_2dd97cfc671386db)) {
        foreach (kiosk in self.var_2dd97cfc671386db) {
...
function function_ce125b637ef3e995(attacker, wasdestroyed, delay) {
    ...
    var_9a6c1b85896a116e = {#kiosks_affected:self.var_5de2c002fa6e74d9.size, #players_affected:self.var_c01be46e4bbd0431.size, #was_destroyed:wasdestroyed, #total_lifetime:gettime() - self.deploytime};
...
// Size: 0x1d7
function function_f828f503fe8f1ac8(var_cbf7be4f62a0ddb2, wasdestroyed) {
    level endon("game_ended");
    self notify("disperse");
    self notify("death");
...
function function_4ab4129843b283fd() {
    foreach (kiosk in self.var_2dd97cfc671386db) {
        if (!function_8b9d56208d268672(kiosk)) {
            kiosk function_f32b8dc9b65a1bd();
            self.var_2dd97cfc671386db[kiosk.index] = undefined;
        }
    }
    self.var_2dd97cfc671386db = array_removeundefined(self.var_2dd97cfc671386db);
    foreach (kiosk in level.br_armory_kiosk.scriptables) {
        if (!isdefined(kiosk) || isdefined(self.var_2dd97cfc671386db[kiosk.index])) {
            continue;
        }
        if (function_8b9d56208d268672(kiosk)) {
            if (istrue(kiosk.disabled)) {
                self.var_5de2c002fa6e74d9[kiosk.index] = 1;
            }
            kiosk function_d5e3dcb372af63ff();
            self.var_2dd97cfc671386db[kiosk.index] = kiosk;
        }
    }
}
...
/#
    ...
    function function_c290f027b8bc76e1(command, args) {
        var_15a18dd2dd7ed5da = "<dev string:x13a>";
        switch (command) {
        ...
        iprintln("<dev string:x1c3>" + command + ter_op(var_15a18dd2dd7ed5da != "<dev string:x13a>", "<dev string:x1d7>", "<dev string:x13a>") + var_15a18dd2dd7ed5da);
    }
