...
function javelin_scanningstateupdate() {
    ...
    if (self attackbuttonpressed()) {
        ...
        /#
            if (getdvar(@"hash_b56d344ee60e317f") == "<dev string:x4a>" && isdefined(self.javelin.groundpoints)) {
...
function javelin_holdstateupdate() {
    ...
    #/
    /#
        if (getdvar(@"hash_b56d344ee60e317f") == "<dev string:x4a>") {
...
function javelin_hidenormalhud(enable) {
    ...
    if (enable) {
        ...
        /#
            if (getdvar(@"hash_22ff48dd25613942") == "<dev string:x4a>") {
