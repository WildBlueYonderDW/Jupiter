...
function init() {
    ...
    namespace_de6e6777b0937bd7::function_aacbbe63c26687ae("callback_on_player_award", &function_9670cc409126542a);
    namespace_de6e6777b0937bd7::function_aacbbe63c26687ae("callback_player_loadout_changed", &function_94bd96d6049d4686);
    namespace_de6e6777b0937bd7::function_aacbbe63c26687ae("callback_update_armor_ammo_stats", &function_a6e2722f66cb5b47);
...
function function_6447f24addc0137e(data) {
    ...
    if (level.teambased) {
        var_8cc713ff16b24041 = int(player namespace_5aac85eab99c40a::getteamrankxpmultiplier(player.team));
    } else {
    ...
    player namespace_6c67e93a4c487d83::set_player_xp(total_xp + var_219ef42301aeaac8);
...
function on_player_death(data) {
    ...
    if (weapon_string == "agent_cp") {
        ...
        attacker_weapon_attachments = namespace_a0628d6954815ef8::attachmentsfilterforstats(var_ba6f272fe15ef31b, weapon_string);
    }
    spawntime = 0;
    ...
    if (namespace_de6e6777b0937bd7::function_892570944f6b6a2(attacker) || function_f639982ff796a722(attacker)) {
        ...
        attacker_weapon_picked_up = attacker namespace_a0628d6954815ef8::ispickedupweapon(weapon_string);
        attacker_weapon_alt_mode = attacker isalternatemode(weapon_string);
        attacker_ads_value = 0;
        if (namespace_a0628d6954815ef8::iscacprimaryweapon(weapon_string) || namespace_a0628d6954815ef8::iscacsecondaryweapon(weapon_string)) {
    ...
    if (isdefined(victim.lastweaponused)) {
        ...
        victim_weapon_attachments = namespace_a0628d6954815ef8::attachmentsfilterforstats(var_fb475ef768b518c0, victimcurrentweapon);
        victim_weapon = getweaponbasename(victimcurrentweapon);
        victim_weapon_picked_up = victim namespace_a0628d6954815ef8::ispickedupweapon(victimcurrentweapon);
    ...
    if (namespace_de6e6777b0937bd7::function_892570944f6b6a2(attacker)) {
        ...
        if (isdefined(level.matchrecording_logevent)) {
            ...
            if (issubstr(tolower(means_of_death), "bullet") && isdefined(weapon_string) && !namespace_e0ee43ef2dddadaa::iskillstreakweapon(weapon_string)) {
...
// Size: 0x15d
function function_a6e2722f66cb5b47(data) {
    if (namespace_e0ee43ef2dddadaa::iskillstreakweapon(data.weaponname) || namespace_a0628d6954815ef8::isvehicleweapon(data.weaponname)) {
        return;
    }
    if (!namespace_de6e6777b0937bd7::function_892570944f6b6a2(data.player)) {
        return;
...
function function_ac6b649326f4b17e(data) {
    ...
    self dlog_recordplayerevent("dlog_event_cp_player_score_event", ["time_from_match_start_ms", var_ed6c4157feea476b, "score_event", scoreevent]);
}
...
function function_c72337759677531c(data) {
    ...
    dlog_recordevent("dlog_event_cp_game_event", ["event_player", eventplayer, "event_name", data.eventname, "time_from_match_start_ms", var_ed6c4157feea476b, "player_life_index", lifeindex, "pos_x", position[0], "pos_y", position[1], "pos_z", position[2]]);
...
// Size: 0x9f
function function_9670cc409126542a(data) {
    player = data.player;
