...
function hijackers_main() {
    ...
    if (isdefined(var_8bbc6c03a279cea2)) {
        ...
        level.cleanup_crew = array_add(level.cleanup_crew, var_8bbc6c03a279cea2);
    ...
    if (isdefined(var_8bbc6b03a279cc6f)) {
        ...
        level.cleanup_crew = array_add(level.cleanup_crew, var_8bbc6b03a279cc6f);
...
function hijackers_flashbang() {
    thread namespace_2f067fefb7259496::flashbang_explosion();
...
function function_e6aa5905388847cf(scale, duration, slow_scale) {
    ...
    thread function_d3339b96e5ff8408(scale, duration, slow_scale);
    wait duration;
...
function function_17dbdad7c58fcb60() {
    ...
    flag_set("flag_hijackers_started");
    wait 1;
    level.player thread scripts\sp\maps\sp_jup_hijack\sp_jup_hijack_lighting::function_5e308183ff6bb704();
