...
// Namespace door_barricade / namespace_35cf33c9c2941133
...
/#
    ...
    function function_f01315df3715c3b1() {
        self endon("<dev string:x156>");
        while (true) {
            waitframe();
            if (isdefined(self.damagetaken) && isdefined(self.maxhealth)) {
                print3d(self.origin, self.damagetaken + "<dev string:x15c>" + self.maxhealth, undefined, 0.5, 0.4, undefined, 1);
            }
        }
    }
