...
/#
    ...
    function function_7e5803a5e15369eb(sname) {
        ...
        assertex(!isdefined(level.var_e65f4101fd50a0e1[sname]), "<dev string:x1c>" + sname + "<dev string:x52>");
...
/#
    ...
    function private function_96be6291f27c1e20() {
        ...
        while (true) {
            var_bce73f6463c9b237 = function_1399ca755d810c38("<dev string:x1eb>", @"hash_a0c0a5bf060c7bf2", var_bce73f6463c9b237);
            var_b43d15be227caed0 = function_1399ca755d810c38("<dev string:x207>", @"hash_e5d7c5b83ec14d85", var_b43d15be227caed0);
            var_94c3e91284196d06 = function_1399ca755d810c38("<dev string:x223>", @"hash_6b3c6361f0f5fdb", var_94c3e91284196d06);
            var_4283931c53ed41b0 = function_1399ca755d810c38("<dev string:x23f>", @"hash_cf86c6012f506ac8", var_4283931c53ed41b0);
            movementstate = function_1399ca755d810c38("<dev string:x25c>", @"hash_beff73861be066d", movementstate);
            var_40631789cc951deb = function_1399ca755d810c38("<dev string:x26e>", @"hash_8d73f9a1e40b4f01", var_40631789cc951deb);
            var_683e84a7ba8a976f = function_1399ca755d810c38("<dev string:x283>", @"hash_e001a97b368816c9", var_683e84a7ba8a976f);
            function_4c07717228f2249b("<dev string:x2ac>", @"hash_4db0d2c2cd85d418");
            function_4c07717228f2249b("<dev string:x2ba>", @"hash_2391c05a8700227f");
            waitframe();
        }
    }
