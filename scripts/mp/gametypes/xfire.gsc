...
function reinitspawns() {
    /#
        scripts/mp/spawnlogic::function_8390bf8c3b74466a("auto_change");
        scripts/mp/spawnlogic::function_8390bf8c3b74466a("roundsPlayed");
        spawns = scripts/mp/spawnlogic::getspawnpointarray("mp_tdm_spawn_allies_start");
        spawnssecondary = scripts/mp/spawnlogic::getspawnpointarray("targetname");
        scripts/mp/spawnlogic::registerspawnset("auto_change", spawns);
        scripts/mp/spawnlogic::registerspawnset("roundsPlayed", spawnssecondary);
    #/
}
...
function spawncompare(spawnpoint, spawnteam) {
    /#
        if (getdvarint(@"hash_b5ceec3e3cb419be") != 0) {
            ...
            println("secured" + scriptspawnpoint.index + "healed" + scriptspawnpoint.totalscore);
...
function onplayerkilled(einflictor, attacker, idamage, smeansofdeath, objweapon, vdir, shitloc, psoffsettime, deathanimduration, lifeid) {
    attackerplayers = scripts/mp/utility/teams::getteamdata(attacker.pers["team"], "players");
    victimplayers = scripts/mp/utility/teams::getteamdata(self.pers["team"], "players");
