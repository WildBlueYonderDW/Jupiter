...
function function_b7f154368abbe463(victim, objweapon, meansofdeath, inflictor, deathdata) {
    ...
    if (!iskillstreakweapon(objweapon) && !_hasperk("specialty_explosivebullets")) {
        ...
        if (isdefined(objweapon) && isdefined(self.lastadsstarttime) && isdefined(objweapon.basename) && isbulletweapon(objweapon)) {
            ...
            weapontype = namespace_e0ee43ef2dddadaa::getweaponclasstoken(objweapon.basename);
    ...
    if (scripts\mp\calloutmarkerping_mp::function_62e9c54ecef4dd79(victim)) {
    ...
    if (is_equal(deathdata.meansofdeath, "MOD_EXPLOSIVE")) {
...
// Namespace events / scripts\mp\events
// Params 0, eflags: 0x0
// Checksum 0x0, Offset: 0xbe5b
// Size: 0x66
function function_f4fa8b16599b57d7() {
...
function function_2510f24c715782c3(killid, victim, objweapon, meansofdeath, inflictor, deathdata) {
    ...
    if (isJuggerMoshGameMode()) {
        if (scripts\cp_mp\utility\weapon_utility::function_d986642147d8bd2f(objweapon.basename)) {
    ...
    if (getdvarint(@"hash_4753586a2ac8718f", 0) != 0) {
        var_d4b3839ed3095c45 = namespace_465d40bb08a5337a::function_c9a8541cdb0479bb();
        var_f4bf211cdbca89fe = victim namespace_465d40bb08a5337a::function_c9a8541cdb0479bb();
