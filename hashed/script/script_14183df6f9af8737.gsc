...
function function_e6ca3c2ca24b16f() {
    ...
    for (i = 0; i < var_8e52126aeaaf8ab8.var_e3a4942cefb60974.size; i++) {
        level.brgametype.respawndelay["_solos"][i] = var_8e52126aeaaf8ab8.var_e3a4942cefb60974[i].var_a85640a8d2256218;
        level.brgametype.respawndelay["_duos"][i] = var_8e52126aeaaf8ab8.var_e3a4942cefb60974[i].var_88414606541a6379;
        level.brgametype.respawndelay["_trios"][i] = var_8e52126aeaaf8ab8.var_e3a4942cefb60974[i].var_d626a1e8c8874d8f;
        level.brgametype.respawndelay["_quads"][i] = var_8e52126aeaaf8ab8.var_e3a4942cefb60974[i].var_cbf8ca656557adc8;
    }
}
...
function function_77b9dedb0b66ca96(data) {
    ...
    if (isdefined(var_ad37e6684f9bfb21.event)) {
        eventid = scripts\mp\rank::function_1e00d01d19fde519(var_ad37e6684f9bfb21.event);
        if (!isdefined(eventid) || eventid < 0) {
            eventid = getscoreinfocategory(var_ad37e6684f9bfb21.event, #"hash_edd89bb2cc2d506");
        } else {
            var_a4e353fa34a0f7bd = 1;
        }
    }
    value = actionplayer + 1 + (var_a4e353fa34a0f7bd << 3) + (eventid << 4);
...
function function_366c394e9dc1e32d(player, delaymodifier, event) {
    ...
    var_3056bd5b2b8e47e5 = spawnstruct();
    var_3056bd5b2b8e47e5.delaymodifier = delaymodifier;
    if (scoreeventhastext(event)) {
        var_3056bd5b2b8e47e5.event = event;
    }
    scripts\mp\gametypes\br_gametypes::runbrgametypefunc("onResurgenceScoreworthyModifier", player, var_3056bd5b2b8e47e5);
    if (istrue(player.issolo)) {
...
function function_b398acc9ba21ecb5() {
    if (!isdefined(level.brgametype.var_f0f5747f8d5bed77)) {
        level.brgametype.var_f0f5747f8d5bed77 = function_ee26a62ef3d1372d(@"hash_5c872af62541d1d", 3, level.brgametype.var_8e52126aeaaf8ab8.var_2e618e1d6d46f6fb);
    }
...
function on_squad_wiped(params) {
    ...
    if (!var_388c4f7d6815a09f) {
        var_4306a44c5263e1a2 = "";
        if (isdefined(attackers)) {
            var_4306a44c5263e1a2 += "Attackers size " + attackers.size + "  Attackers: ";
            foreach (attacker in attackers) {
                var_4306a44c5263e1a2 += " ";
                var_4306a44c5263e1a2 += isdefined(attacker) ? attacker.name : "undefined";
            }
        } else {
            var_4306a44c5263e1a2 = "Undefined attackers list";
        }
        assertex(0, "<dev string:x394>" + "<dev string:x3be>" + var_4306a44c5263e1a2);
    }
