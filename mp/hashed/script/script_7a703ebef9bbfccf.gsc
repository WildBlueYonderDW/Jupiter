...
#namespace jup_enemy_mp_sniper_tier1_aq_gwtdm;

// Namespace jup_enemy_mp_sniper_tier1_aq_gwtdm / namespace_3753618df4ace33f
// Params 0
// Checksum 0x0, Offset: 0x253
// Size: 0x1de
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_mp_sniper_tier1_aq_gwtdm" );
...
{
    return namespace_7c8a840fec83f89::main();
}
...
function precache()
{
    agent_type = "actor_jup_enemy_mp_sniper_tier1_aq_gwtdm";
    ...
    if ( !isdefined( level.agent_definition[ agent_type ] ) )
    {
        ...
        namespace_7c8a840fec83f89::precache_cpmp();
    }
