...
function function_859b069af3e87322() {
    var_159643d05ffc2406 = getscriptbundle("ammomod:" + level.var_1a2b600a06ec21f4.var_4f59eded21c43059);
    level._effect["cryofreeze_impact"] = loadfx(var_159643d05ffc2406.var_b0096ccfd3465d13);
    ...
    var_746d800f9d085b2a = function_53c4c53197386572(level.var_f1240a9ac4f65616.var_e79139a1d8a6db93, 0.25);
    var_ad5528a4132dc97d = function_53c4c53197386572(level.var_f1240a9ac4f65616.var_aefab597e0d4ccaa, 0.1);
    var_fb5b2fb3fafc60c7 = function_53c4c53197386572(level.var_f1240a9ac4f65616.var_79586044f6dc1b7d, 0);
    var_bcbfc6de4213b6af = function_53c4c53197386572(level.var_f1240a9ac4f65616.var_51fca1cd08a8156d, 0);
    var_60cd3581dc64f213 = function_53c4c53197386572(level.var_f1240a9ac4f65616.var_d53f3286e9d3529, 1);
    var_f27a8d5708fd9c4d = function_53c4c53197386572(level.var_f1240a9ac4f65616.var_9a4c1c06b0d52447, 1);
    var_50b2d9031ce3da52 = function_53c4c53197386572(level.var_f1240a9ac4f65616.var_deb7e87f41e610cc, "");
    var_7cd0ba2c2358da52 = function_53c4c53197386572(level.var_f1240a9ac4f65616.var_37e6ce4fbc2055f8, "");
    element = function_53c4c53197386572(level.var_f1240a9ac4f65616.var_5ec51dc708c55f6d, "cold");
...
function function_d4bd7d34fea892df(death, attacker, mod, sweapon, vpoint, shitloc, modelindex) {
    ...
    var_2024d56fc08df992 = function_53c4c53197386572(level.var_f1240a9ac4f65616.var_2024d56fc08df992, 5);
    var_8630a9ddd5ccb60b = function_53c4c53197386572(level.var_f1240a9ac4f65616.var_8630a9ddd5ccb60b, 0.5);
...
function function_3713b5166b308321() {
    if (istrue(level.var_1b3072262db80fc1["cryofreeze"].immune_result_direct[self.basearchetype])) {
        return 0;
    }
...
function function_2fb9b4401941c475() {
    return function_c0111492d9bfc56d("cryofreeze");
}
...
function function_136a046f13726c77(idamage, eattacker, smeansofdeath, shitloc, sweapon) {
    var_4788909f64a3277d = function_53c4c53197386572(level.var_f1240a9ac4f65616.var_4788909f64a3277d, 1.25);
...
function private on_ai_killed(params) {
    if (function_2fb9b4401941c475() && isplayer(params.eattacker)) {
        ...
        var_1b903f780de3dc79.scoreevent = #"cryofreeze_kill";
        var_1b903f780de3dc79.reason = #"kill";
        params.eattacker callback::callback("zombie_score_event", var_1b903f780de3dc79);
    }
}
