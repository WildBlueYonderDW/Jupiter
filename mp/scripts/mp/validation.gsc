...
function function_18b8c4c4fa0f6d1c(weaponname, weaponcamo) {
    ...
    if (isdefined(category) && category == "camo_category_events") {
        ...
        if (isdefined(weaponclass) && weaponclass != "" && isdefined(level.var_305637ed4e3e8513[weaponclass]) && isdefined(level.var_305637ed4e3e8513[weaponclass][weaponcamo])) {
...
function validateloadout(loadout) {
    ...
    if (replaceweapon) {
        ...
        for (i = 0; i < loadout.loadoutprimaryattachments.size; i++) {
            ...
            if (attachment != "none") {
                ...
                if (attachmentisrestricted(attachment, loadout.loadoutprimary) || var_de6cf437be756ee1 && namespace_38b993c4618e76cd::function_8c610908c0e9c6e4(attachment)) {
    ...
    if (replaceweapon) {
        ...
        for (i = 0; i < loadout.loadoutsecondaryattachments.size; i++) {
            ...
            if (attachment != "none") {
                if (attachmentisrestricted(attachment, loadout.loadoutsecondary) || var_de6cf437be756ee1 && namespace_38b993c4618e76cd::function_8c610908c0e9c6e4(attachment)) {
                    attachmentscriptbundle = getscriptbundle(hashcat(%"hash_3c2c9813bb16552f", attachment));
                    if (isdefined(attachmentscriptbundle) && attachmentscriptbundle.var_f0e7c0926c0962e5) {
    ...
    foreach (idx, perk in loadout.loadoutperks) {
        var_35261d7cc198ab5 = var_de6cf437be756ee1 && namespace_38b993c4618e76cd::function_8c610908c0e9c6e4(perk);
        if (var_35261d7cc198ab5) {
            if (var_8b3060936146ce59) {
        ...
        foreach (var_d2c4eb6f370de4d in var_cfca7aa9f4fab29) {
            if (isdefined(level.perkbundles[var_d2c4eb6f370de4d])) {
                ...
                if (var_70774aeb81261100 == "vest") {
                    ...
                    var_cd11aa2ab4e50561 = namespace_38b993c4618e76cd::function_793e8a72cedb8ef3(getdvarint(@"hash_b3bbb60b1e889be1", 27383));
                    ...
                    var_3d608179cc46a728 = namespace_38b993c4618e76cd::function_793e8a72cedb8ef3(getdvarint(@"hash_53905541db28577e", 27380));
                    ...
                    var_2270803e1bea8673 = namespace_38b993c4618e76cd::function_793e8a72cedb8ef3(getdvarint(@"hash_4b76b53b637fdc12", 27396));
                    var_2270813e1bea88a6 = namespace_38b993c4618e76cd::function_793e8a72cedb8ef3(getdvarint(@"hash_526440cce2f5bb00", 27367));
    ...
    if (var_8b3060936146ce59) {
        if (level.perkbundles[vestperk].var_885724e5007453be.super == 0) {
            ...
            var_35261d7cc198ab5 = var_de6cf437be756ee1 && namespace_38b993c4618e76cd::function_8c610908c0e9c6e4(loadout.loadoutfieldupgrade1);
            if (var_35261d7cc198ab5) {
    ...
    if (!replacekillstreaks) {
        if (killstreakisrestricted(loadout.loadoutkillstreak1) || var_de6cf437be756ee1 && namespace_38b993c4618e76cd::function_8c610908c0e9c6e4(loadout.loadoutkillstreak1)) {
            loadout.loadoutkillstreak1 = fallbackloadout.fallbackkillstreaks[0];
            var_bc72f32b1575d517 = 1;
        }
        if (killstreakisrestricted(loadout.loadoutkillstreak2) || var_de6cf437be756ee1 && namespace_38b993c4618e76cd::function_8c610908c0e9c6e4(loadout.loadoutkillstreak2)) {
            loadout.loadoutkillstreak2 = fallbackloadout.fallbackkillstreaks[1];
            var_bc72f32b1575d517 = 1;
        }
        if (killstreakisrestricted(loadout.loadoutkillstreak3) || var_de6cf437be756ee1 && namespace_38b993c4618e76cd::function_8c610908c0e9c6e4(loadout.loadoutkillstreak3)) {
