...
function init() {
    /#
        ...
        function_a2fe753948998c89("<dev string:x32>", "<dev string:x3d>");
        function_b23a59dfb4ca49a1("<dev string:x5e>", "<dev string:x77>", &function_a3bc0cc17a8becc7);
        function_b23a59dfb4ca49a1("<dev string:x90>", "<dev string:xa9>", &function_a3bc0cc17a8becc7);
        function_b23a59dfb4ca49a1("<dev string:xc2>", "<dev string:xdb>", &function_a3bc0cc17a8becc7);
        function_b23a59dfb4ca49a1("<dev string:xf4>", "<dev string:x10d>", &function_a3bc0cc17a8becc7);
        function_b23a59dfb4ca49a1("<dev string:x126>", "<dev string:x13f>", &function_a3bc0cc17a8becc7);
        function_b23a59dfb4ca49a1("<dev string:x158>", "<dev string:x171>", &function_a3bc0cc17a8becc7);
...
function function_6e6915563d108662(eventstring, victim, sweapon) {
    ...
    if (isplayer(player)) {
        ...
        if (isdefined(s_super) && !istrue(s_super.isinuse)) {
            ...
            /#
                iprintlnbold("<dev string:x18a>" + s_super.basepoints + "<dev string:x1ab>" + s_super.staticdata.pointsneeded);
            #/
    ...
    function function_a3bc0cc17a8becc7(a_params) {
        foreach (player in level.players) {
            ...
            if (isdefined(s_super)) {
                ...
                iprintlnbold("<dev string:x1ad>" + s_super.staticdata.var_6344aa9df2107f06);
            }
        }
    }
