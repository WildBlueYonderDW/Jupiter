...
function private internal_circle(var_ce5c8b45f5bf97e8, var_31759f0a1036d495, var_4aed5403298a4d7f, var_25b8738ccc2f5e33, var_aaa98411bc77fb1f, var_eb17d5c958e3fcda, var_29c1049cdd91eb32, var_64459132907ac449, var_41976210805f0afe, var_3a036abee5c890ba, is_entity, isdrone) {
    ...
    while (!var_738caee3d4576e5c) {
        ...
        /#
            if (var_e3ef073dd9338298 == 1) {
                duration = 200;
                if (!var_738caee3d4576e5c) {
                    sphere(obstructiontrace["<dev string:x35>"], 325, (1, 0, 0), 0, duration);
                    line(self.origin, obstructiontrace["<dev string:x35>"], (1, 0, 0), 1, 0, duration);
    ...
    while (var_738caee3d4576e5c) {
        ...
        /#
            if (var_e3ef073dd9338298 == 1) {
                duration = 200;
                print3d(self.origin, "<dev string:x3e>" + self.current_angle, (1, 1, 1), 1, 1, duration, 1);
            }
        #/
        ...
        if (!istrue(ignoreblocks)) {
            ...
            if (isdefined(obstructiontrace)) {
                if (obstructiontrace["hittype"] != "hittype_none") {
                    ...
                    /#
                        if (var_e3ef073dd9338298) {
                            sphere(obstructiontrace["<dev string:x35>"], traceradius, (1, 0, 0), undefined, 100);
...
function private function_56ebd2471f52c901(start, end, radius, ignore, contentoverride, getsurfacetype, var_b00c60a54d663ca2) {
    /#
        ...
        println("<dev string:x3f>" + start + "<dev string:x5a>" + end + "<dev string:x61>" + radius + "<dev string:x6b>" + dist);
        if (getdvarint(@"hash_2c1d3a8768e5e585", 0) || getdvarint(@"hash_9aa835d8fcd3b58d", 0)) {
            ...
            iprintln("<dev string:x77>" + level.var_f40761825dce0d99 + "<dev string:x6b>" + dist);
        }
    #/
...
function private function_e3a3b10fbf64512d(circleorigin, circleradius, interval) {
    ...
    /#
        ...
        if (var_e3ef073dd9338298) {
            ...
            debugtext = "<dev string:x3e>";
            debugtext = ter_op(var_b419b1df445ce254 > 0, "<dev string:x92>", "<dev string:x98>");
            debugtext += ter_op(var_6eabde346129539a > 0, "<dev string:x9d>", "<dev string:xa3>");
            debugtext += ter_op(self.var_cee00573b191bdb9, "<dev string:xaa>", "<dev string:xae>");
...
/#
    ...
    function private function_4dc385ff6dceb535(newpos, color) {
        self notify("<dev string:xb3>");
        self endon("<dev string:xb3>");
        self endon("<dev string:xce>");
        self endon("<dev string:xd4>");
        self endon("<dev string:xdc>");
        self endon("<dev string:xe5>");
