...
// Namespace supply_sweep / namespace_75c4843d9c6998ee
// Params 0, eflags: 0x1
...
function init() {
    ...
    waitframe();
    scripts\mp\killstreaks\killstreaks::registerkillstreak("supply_sweep", &namespace_75c4843d9c6998ee::function_9770267c5fb4f3b3);
    initdialog();
...
function function_9770267c5fb4f3b3(streakinfo) {
    ...
    var_b1d9abe0ba55be9f = scripts\cp_mp\killstreaks\killstreakdeploy::streakdeploy_dogesturedeploy(streakinfo, makeweapon("ks_gesture_phone_mp"));
    if (!istrue(var_b1d9abe0ba55be9f)) {
        return false;
    }
...
// Size: 0x3c3
function function_cb5055ef9503457f(owner, streakinfo, var_79714abdf73d508a, var_e1d15925155200c8) {
    team = owner.team;
    ...
    if (!istrue(var_79714abdf73d508a)) {
    ...
    var_af0411e158eba42c = undefined;
    if (var_cd8090039a345a6e) {
        var_af0411e158eba42c = level.teamdata[team]["supplySweepEndTime"] + var_84b4dd2d6d918790 * 1000;
    } else {
        var_af0411e158eba42c = gettime() + var_84b4dd2d6d918790 * 1000;
    }
    level.teamdata[team]["activeSupplySweeps"] = array_add(level.teamdata[team]["activeSupplySweeps"], streakinfo);
    level.teamdata[team]["supplySweepEndTime"] = var_af0411e158eba42c;
    var_9a35e6082031f3d4 = getteamdata(team, "players");
    foreach (player in var_9a35e6082031f3d4) {
    ...
    var_e634d5144976b8ba = max((var_af0411e158eba42c - gettime()) / 1000, 0.1);
    waittill_any_timeout_1(var_e634d5144976b8ba, "game_ended");
    ...
    if (var_23d218ec402fc01c) {
        ...
        while (!var_23d218ec402fc01c && !level.gameended) {
            var_af0411e158eba42c = level.teamdata[team]["supplySweepEndTime"];
            var_e634d5144976b8ba = max((var_af0411e158eba42c - gettime()) / 1000, 0.1);
            waittill_any_timeout_1(var_e634d5144976b8ba, "game_ended");
            var_23d218ec402fc01c = level.teamdata[team]["activeSupplySweeps"].size == 0;
        }
