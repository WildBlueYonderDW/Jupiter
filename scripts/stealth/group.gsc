    ...
    /#
        ...
        while (true) {
            if (scripts/stealth/debug::debug_enabled()) {
                ...
                if (pod.state == 1) {
                    print3d(pod.origin + down, "<unknown string>" + guystr, (1, 1, 0), 1, 0.4, 1);
                } else if (pod.state == 2) {
                    print3d(pod.origin + down, "<unknown string>" + guystr, (1, 1, 0), 1, 0.4, 1);
                }
    ...
    if (isdefined(volume)) {
        if (!ispointinvolume(e.investigate_pos, volume)) {
            ...
            if (isdefined(otherguy)) {
                /#
                    scripts/stealth/debug::function_ec780a18fdfb4982(self, "<unknown string>");
                #/
                /#
                    scripts/stealth/debug::function_ec780a18fdfb4982(self, "<unknown string>");
                #/
                /#
                    scripts/stealth/debug::function_ec780a18fdfb4982(otherguy, "<unknown string>");
                #/
