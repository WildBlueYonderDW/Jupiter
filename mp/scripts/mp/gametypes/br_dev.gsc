...
/#
    ...
    function function_c96d7535862e245c(command, args) {
        ...
        case #"hash_87532133ab44aca2":
            ...
            if (!isdefined(args) || !isdefined(args[0]) || args[0] == "<dev string:xca1>") {
                lootid = namespace_38b993c4618e76cd::function_fae5e1d3de32d3f7("<dev string:x1059>" + platelevel);
            } else if (issubstr(args[0], "<dev string:x1072>")) {
                lootid = namespace_38b993c4618e76cd::function_fae5e1d3de32d3f7("<dev string:x1059>" + platelevel + "<dev string:x107b>");
            } else if (issubstr(args[0], "<dev string:x1085>")) {
                lootid = namespace_38b993c4618e76cd::function_fae5e1d3de32d3f7("<dev string:x1059>" + platelevel + "<dev string:x108e>");
            } else if (issubstr(args[0], "<dev string:x1098>")) {
                lootid = namespace_38b993c4618e76cd::function_fae5e1d3de32d3f7("<dev string:x1059>" + platelevel + "<dev string:x10a3>");
            } else if (issubstr(args[0], "<dev string:x10af>")) {
                lootid = namespace_38b993c4618e76cd::function_fae5e1d3de32d3f7("<dev string:x10bb>");
            } else if (issubstr(args[0], "<dev string:x10dc>")) {
                lootid = namespace_38b993c4618e76cd::function_fae5e1d3de32d3f7("<dev string:x10ed>");
            }
            if (!isdefined(lootid)) {
                break;
            }
        ...
        case #"hash_ad34b62d6259eff9":
            ...
            if (issubstr(args[0], "<dev string:x1128>")) {
                lootid = namespace_38b993c4618e76cd::function_fae5e1d3de32d3f7("<dev string:x1130>");
            } else if (issubstr(args[0], "<dev string:x1148>")) {
                lootid = namespace_38b993c4618e76cd::function_fae5e1d3de32d3f7("<dev string:x1152>");
            } else if (issubstr(args[0], "<dev string:x116c>")) {
                lootid = namespace_38b993c4618e76cd::function_fae5e1d3de32d3f7("<dev string:x1175>");
            } else if (issubstr(args[0], "<dev string:x118e>")) {
                lootid = namespace_38b993c4618e76cd::function_fae5e1d3de32d3f7("<dev string:x1198>");
            }
            if (!isdefined(lootid)) {
                break;
            }
        ...
        case #"hash_70f3163baf120876":
            ...
            firstplayer setclientomnvar("<dev string:x12dd>", var_5c9ddcf56d36f133);
            wait 5;
        ...
        case #"hash_8673ffe7cf06c3b1":
            ...
            guards = function_7eb04ca16d045775("<dev string:x1327>");
            firstguard = guards[0];
        ...
        case #"hash_8ffd6bd28ea1c5bc":
            if (args.size > 0) {
                equipref = args[0];
                var_c00e3162499a2e59 = function_94c116c69c037a47(equipref, ["<dev string:x14f6>", "<dev string:x1503>", "<dev string:x150c>", "<dev string:x151d>"]);
    ...
    function function_533bda33b99fab22(victim, var_742e3b452c9bb9b0) {
        level endon("<dev string:x1828>");
        victim namespace_f8d3520d3483c1::function_13caa305c839a278("<dev string:x1e54>", var_742e3b452c9bb9b0);
        waitframe();
        waitframe();
        waitframe();
        waitframe();
    ...
    function function_af939b4dfd7f0769(var_90ac04838df7e429, var_d1bec1cd8223b6e4, var_81abad5fa1e318d5) {
        ...
        while (true) {
            ...
            case 1:
                player namespace_f8d3520d3483c1::setArmorHealth(0, 1);
