...
function main()
{
    ...
    self function_6b0082dec4510b24( "c_jup_civilian_london_female_body_02_skintone_light", xmodelalias\c_jup_civilian_london_female_body_02_skintone_light::main() );
