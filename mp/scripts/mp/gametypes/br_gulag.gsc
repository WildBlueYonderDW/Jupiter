...
function spawnac130() {
    ...
    circleradius -= 100;
    var_eca35627d55ec341 = gettangentoncirclefrompoint(level.br_level.br_mapcenter, circleradius, startpt);
    var_5371d63ef1da1802 = var_eca35627d55ec341[1];
    endpt = var_eca35627d55ec341[0];
    dist = 0;
    time = 0;
...
function playergulagautowin(context, sponsor, tokenused, var_5806c4765695a2f4, var_74af5908127b6729, var_36f3c4e4a602e257, var_df631fdd92a76bb1, var_b6acf0c07c4311e6) {
    ...
    var_ecb05d27d56ce72b = player namespace_8bfdb6eb5a3df67a::playerhandlesponsor(sponsor, tokenused, var_74af5908127b6729, var_5806c4765695a2f4, var_36f3c4e4a602e257, context);
    var_df2fbb13c226be75 = var_ecb05d27d56ce72b[1];
    var_84e2123aaca9a965 = var_ecb05d27d56ce72b[0];
...
function getarenaomnvarbitpackinginfo(dataref, value) {
    ...
    case #"hash_f5d0ab7e55587e1d":
        var_ecabde27d567da07 = [0, 8, "ui_br_gulag_players_1"];
    ...
    case #"hash_f5d0aa7e55587c8a":
        var_ecabdf27d567dc3a = [8, 8, "ui_br_gulag_players_1"];
    ...
    case #"hash_622ca631d10c4370":
        var_ecabe027d567de6d = [16, 8, "ui_br_gulag_players_1"];
    ...
    case #"hash_622ca731d10c4503":
        var_ecabd127d567bd70 = [24, 8, "ui_br_gulag_players_1"];
    ...
    case #"hash_e89fe3aac33c10c9":
        var_ecabd227d567bfa3 = [0, 8, "ui_br_gulag_data"];
    ...
    case #"hash_848cf681a543f242":
        var_bfec5e27b42801e8 = [8, 8, "ui_br_gulag_data"];
    ...
    case #"hash_848cf781a543f3d5":
        var_bfec5f27b428041b = [16, 8, "ui_br_gulag_data"];
...
function setarenaomnvar(arena, dataref, value) {
    ...
    var_bfec6027b428064e = getarenaomnvarbitpackinginfo(dataref, value);
    value = var_bfec6027b428064e[3];
...
function playersetomnvargulag(arena, dataref, value) {
    ...
    assert(isdefined(dataref) && isstring(dataref));
    var_bfec5727b427f283 = getarenaomnvarbitpackinginfo(dataref, value);
    value = var_bfec5727b427f283[3];
    var_8e90fa6d5789ad63 = var_bfec5727b427f283[2];
    bitwidth = var_bfec5727b427f283[1];
    bitoffset = var_bfec5727b427f283[0];
    if (var_8e90fa6d5789ad63 == "") {
        return;
    }
