    ...
    function debugemp() {
        ...
        while (true) {
            if (getdvarint(@"hash_d39ba2fefaffd043") != 0) {
                ...
                secondplayer scripts\mp\utility\weapon::_launchgrenade("<dev string:xfb>", (0, 0, 0), (0, 0, 0), 0.05, 0);
            }
            waitframe();
        }
    }
    ...
    function debugempdrone() {
        ...
        while (true) {
            if (getdvarint(@"hash_a6ef3bcfa25b1aef") != 0) {
                ...
                streakinfo.streakname = "<dev string:x138>";
        ...
        while (true) {
            if (getdvarint(@"hash_196b4febb9f4dd1f") != 0) {
                ...
                foreach (killstreak in level.activekillstreaks) {
                    if (isdefined(killstreak.streakinfo) && killstreak.streakinfo.streakname == "<dev string:x138>") {
