...
/#
    ...
    function init_debug() {
        ...
        function_b23a59dfb4ca49a1("<dev string:x2c>", "<dev string:x4a>" + "<dev string:x5f>" + "<dev string:x6b>", &function_e2b8eeccc951133f);
        function_b23a59dfb4ca49a1("<dev string:x6e>", "<dev string:x4a>" + "<dev string:x5f>" + "<dev string:x8c>", &function_e2b8eeccc951133f);
