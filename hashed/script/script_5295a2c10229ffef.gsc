...
// Size: 0x6f
function function_841c25eb1c7438b(var_f03196013d5cd011, var_a350db35c646e0f9) {
    if (!isdefined(var_f03196013d5cd011.position) || !isdefined(var_f03196013d5cd011.angles)) {
        /#
            assertex(0, "InflatableDummyParams needs to include a valid position and angles!");
        #/
        return;
    }
    if (!isdefined(var_a350db35c646e0f9) || var_a350db35c646e0f9.size == 0) {
        return;
    }
    var_23551dada6d5703b = function_f62593b78a116dcd(var_f03196013d5cd011);
    thread function_65f85fe2042cabbc(var_23551dada6d5703b, var_a350db35c646e0f9);
}
...
// Size: 0xd2
function private function_65f85fe2042cabbc(var_23551dada6d5703b, var_a350db35c646e0f9) {
    level endon("game_ended");
    var_23551dada6d5703b endon("death");
    foreach (var_128edf2232d31c50 in var_a350db35c646e0f9) {
        thread function_6d4da2c34dcd635f(var_23551dada6d5703b, var_128edf2232d31c50);
    }
    var_f74f1f9c1f566746 = var_23551dada6d5703b waittill("spawnTriggered");
...
function private function_6d4da2c34dcd635f(var_23551dada6d5703b, trigger) {
    ...
    if (isdefined(trigger)) {
        var_f74f1f9c1f566746 = trigger waittill("trigger");
...
function private function_f62593b78a116dcd(var_f03196013d5cd011) {
    ...
    var_23551dada6d5703b.team = function_53c4c53197386572(var_f03196013d5cd011.team, "team_hundred_ninety");
    var_23551dada6d5703b.angles = var_f03196013d5cd011.angles;
    var_23551dada6d5703b.health = function_53c4c53197386572(var_f03196013d5cd011.health, 150);
    ...
    var_23551dada6d5703b.var_2f53a6b82c6bd61b = function_53c4c53197386572(var_f03196013d5cd011.var_2f53a6b82c6bd61b, 0.5);
    var_23551dada6d5703b.var_2f2f9cb82c434565 = function_53c4c53197386572(var_f03196013d5cd011.var_2f2f9cb82c434565, 3);
    var_23551dada6d5703b.lifetime = function_53c4c53197386572(var_f03196013d5cd011.lifetime, 0);
...
// Size: 0x165
function private function_a3ba34f65c02912a(var_3be1b771648e3c2d) {
    level endon("game_ended");
    self endon("death");
    self endon("damage");
    self endon("inflatable_destroyed");
    if (!isdefined(var_3be1b771648e3c2d)) {
        return;
    }
    self setscriptablepartstate("hitreact", "neutral", 0);
    waitframe();
    var_3be1b771648e3c2d = vectornormalize(var_3be1b771648e3c2d);
    ...
    if (vectordot(forwarddir, var_3be1b771648e3c2d) > 0.70711) {
    ...
    } else if (vectordot(forwarddir * -1, var_3be1b771648e3c2d) > 0.70711) {
    ...
    } else if (vectordot(rightdir, var_3be1b771648e3c2d) > 0.70711) {
    ...
    } else if (vectordot(rightdir * -1, var_3be1b771648e3c2d) > 0.70711) {
...
function private function_3b91f075feeb9315() {
    ...
    if (isdefined(self.activity) && isdefined(self.activity.var_4b7032d8632723e0)) {
        ...
        var_d99e3c6dcdfbbd2b = makeweapon("jup_flash_grenade_ob");
        waitframe();
        /#
            if (getdvarint(@"hash_a8862c6361d1024a", 0)) {
                thread namespace_f2ffc0540883e1ad::drawcylinder(var_211e69a014146049, 512, 100, 20, (0, 1, 0));
                thread namespace_f2ffc0540883e1ad::drawcylinder(var_211e69a014146049 - (0, 0, 100), 512, 100, 20, (0, 1, 0));
                thread namespace_d028276791d9cff6::drawsphere(var_211e69a014146049, 5, 10, (1, 0, 0));
            }
        #/
        inflictor = self.activity.var_4b7032d8632723e0;
        foreach (var_730d90f7a87647d9 in var_bcf224bf37277a85) {
            var_f1fd90e38f7bf8e4 = namespace_2a184fc4902783dc::ray_trace_passed(var_730d90f7a87647d9 geteye(), var_211e69a014146049, var_730d90f7a87647d9);
            if (var_f1fd90e38f7bf8e4) {
                var_730d90f7a87647d9 dodamage(1, var_211e69a014146049, inflictor, inflictor, "MOD_EXPLOSIVE", var_d99e3c6dcdfbbd2b);
            }
        }
