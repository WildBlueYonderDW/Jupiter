...
function function_e1fbc72dd102b947(asmname, statename, tostatename, params) {
    ...
    if (trace_hit) {
        ...
        /#
            ...
            bc_print("<unknown string>" + var_a2099f6f593803e2, trace["light_1s"]);
        #/
...
function function_4397b9eb5fee6a23(asmname, statename, tostatename, params) {
    ...
    /#
        bc_print("<unknown string>" + length(position_delta), self.origin + (0, 0, 90));
    #/
    if (speed_sq * squared(5) < var_325031e3bd475ad && var_325031e3bd475ad > squared(var_481af8e3ab10d8f1)) {
        /#
            bc_print("<unknown string>" + length(position_delta), self.origin + (0, 0, 30));
        #/
        return true;
    }
    min_speed = 0.1;
    if (speed_sq < squared(min_speed) && !var_62b0f3e6017d4cee) {
        /#
            bc_print("<unknown string>" + length(position_delta));
        #/
        return true;
    }
    if (vectordot(position_delta, default_to(self.var_a20667cd8eef2d30, (0, 0, 0))) < 0) {
        /#
            bc_print("<unknown string>" + vectordot(position_delta, default_to(self.var_a20667cd8eef2d30, (0, 0, 0))));
        #/
        return true;
    }
    ...
    if (istrue(self.var_197f81f41a21780c)) {
        ...
        if (!isdefined(var_7f04d54a502de2ef)) {
            ...
            /#
                bc_print("<unknown string>", var_7f04d54a502de2ef);
            #/
            ...
            if (isdefined(var_154288d91ba8cf1a)) {
                /#
                    bc_print("<unknown string>", var_154288d91ba8cf1a);
                #/
            }
    ...
    if (gettime() > self.var_326016aaef22eaa2) {
        interval_check = 3000;
        self.var_326016aaef22eaa2 = self.var_326016aaef22eaa2 + interval_check;
            ...
            foreach (player in players) {
                if (isalive(player) && player.team != self.team && !player ent_flag("abom_bull_charge_hit")) {
                    ...
                    if (var_7895e5c029da0b75) {
                        ...
                        hit_something = scripts/engine/trace::ray_trace_passed(damage_point, trace_point, self);
                        /#
                            if (function_34e269129d109e9d()) {
                        ...
                        if (hit_something) {
                            /#
                                bc_print("<unknown string>", player.origin);
                            #/
                            continue;
                        }
                        ...
                        /#
                            bc_print("<unknown string>", damage_point);
                        #/
                        continue;
                    }
...
function function_b03f7c7561b40e5d() {
    /#
        ...
        function_a9a864379a098ad6("<unknown string>", "<unknown string>", &force_roar);
...
function private function_754478a869ee8149() {
    /#
        ...
        abom = default_to(abom, function_6d1fbda4b8524ef2(level.players[0].origin, undefined, "<unknown string>"));
        if (!isdefined(abom)) {
            return;
        }
