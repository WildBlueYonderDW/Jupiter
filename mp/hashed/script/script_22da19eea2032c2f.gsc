...
// Namespace crossing_suv_infil / namespace_c5afaaed33608359
// Params 1, eflags: 0x0
// Checksum 0x0, Offset: 0x95c
// Size: 0x9d
function function_ff655c7837121a1f(subtype) {
    namespace_e688cd9db0404268::function_f1aed36ab4598ea("crossing_suv_infil");
...
function function_4ff143ea37fffb46(infil, spot_index) {
    ...
    linktoent = ter_op(spot_index >= 3, infil.var_52cb2624a2c0e0f5, infil.var_52cb2324a2c0da5c);
...
function vehiclethink(team, scene_node, scene_name, extra_crew) {
    var_52cb2324a2c0da5c = function_ea3e584a9e826a0d(scene_node, team, scene_name, "fbi::veh9_civ_lnd_suv_2020", "crossing_suv_front", "veh9_suv_1996_physics_mp");
    var_52cb2624a2c0e0f5 = function_ea3e584a9e826a0d(scene_node, team, scene_name, "fbi::veh9_civ_lnd_suv_2020", "crossing_suv_back", "veh9_suv_1996_physics_mp");
    var_52cb2324a2c0da5c vehicle_turnengineoff();
    var_52cb2624a2c0e0f5 vehicle_turnengineoff();
    self.var_52cb2324a2c0da5c = var_52cb2324a2c0da5c;
    self.var_52cb2624a2c0e0f5 = var_52cb2624a2c0e0f5;
    thread function_796536b99a772738(var_52cb2324a2c0da5c, var_52cb2624a2c0e0f5);
    level waittill("infil_started");
    var_52cb2624a2c0e0f5 thread function_f9f9146c527fbdd2("crossing_suv_horn_01", 1);
    thread anim_single_solo(var_52cb2324a2c0da5c, "crossing_suv_infil");
    thread anim_single_solo(var_52cb2624a2c0e0f5, "crossing_suv_infil");
    thread function_70a8a2aae30f4847(scene_node, var_52cb2324a2c0da5c, "crossing_suv_front", "crossing_suv_infil", "veh9_civ_lnd_suv_2020", 0);
    thread function_70a8a2aae30f4847(scene_node, var_52cb2624a2c0e0f5, "crossing_suv_back", "crossing_suv_infil", "veh9_civ_lnd_suv_2020", 1);
    level waittill("prematch_over");
}
...
function function_b2a12312c1552d1d() {
    level waittill("prematch_over");
    wait 51;
    namespace_e688cd9db0404268::function_f4e0ff5cb899686d("crossing_suv_infil");
}
...
// Size: 0xd8
function function_796536b99a772738(var_52cb2324a2c0da5c, var_52cb2624a2c0e0f5) {
    var_60e225c44aa37548 = spawn("script_model", var_52cb2324a2c0da5c.origin);
    var_60e228c44aa37be1 = spawn("script_model", var_52cb2624a2c0e0f5.origin);
    level waittill("infil_started");
    waitframe();
    var_60e225c44aa37548 linkto(var_52cb2324a2c0da5c, "tag_origin", (100, 0, 25), (0, 0, 0));
    var_60e228c44aa37be1 linkto(var_52cb2624a2c0e0f5, "tag_origin", (100, 0, 25), (0, 0, 0));
