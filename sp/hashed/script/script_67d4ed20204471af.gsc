...
#namespace jup_enemy_cp_lmg_tier1_rus_pmc;

// Namespace jup_enemy_cp_lmg_tier1_rus_pmc / namespace_704b2bfdf1a69873
// Params 0, eflags: 0x0
// Checksum 0x0, Offset: 0x2ea
// Size: 0x228
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_cp_lmg_tier1_rus_pmc" );
    ...
    {
        case 0:
            primaryweaponhash = "iw9_lm_rkilo_mp, [ none, none, none, none, none, none ], none, none";
            self.weapon = level.var_67b54180a55f70e1[ primaryweaponhash ];
            break;
        case 1:
            primaryweaponhash = "jup_jp06_lm_pkilop_mp, [ none, none, none, none, none, none ], none, none";
            self.weapon = level.var_67b54180a55f70e1[ primaryweaponhash ];
            break;
    }
...
function precache()
{
    agent_type = "actor_jup_enemy_cp_lmg_tier1_rus_pmc";
    ...
    if ( !isdefined( level.agent_definition[ agent_type ] ) )
    {
        ...
        character\c_jup_sp_enemy_pmc_support_01::precache_cpmp();
        character\c_jup_sp_enemy_pmc_support_02::precache_cpmp();
    }
...
function setup_weapons()
{
    ...
    var_5576d3be590a9a64 = "iw9_lm_rkilo_mp, [ none, none, none, none, none, none ], none, none";
    
    if ( !isdefined( level.var_67b54180a55f70e1[ var_5576d3be590a9a64 ] ) )
    {
        level.var_67b54180a55f70e1[ var_5576d3be590a9a64 ] = scripts\cp\cp_weapon::function_e83615f8a92e4378( "iw9_lm_rkilo_mp", [ "none", "none", "none", "none", "none", "none" ], "none", "none" );
    }
    
    var_5576d6be590aa0fd = "jup_jp06_lm_pkilop_mp, [ none, none, none, none, none, none ], none, none";
    
    if ( !isdefined( level.var_67b54180a55f70e1[ var_5576d6be590aa0fd ] ) )
    {
        level.var_67b54180a55f70e1[ var_5576d6be590aa0fd ] = scripts\cp\cp_weapon::function_e83615f8a92e4378( "jup_jp06_lm_pkilop_mp", [ "none", "none", "none", "none", "none", "none" ], "none", "none" );
    }
