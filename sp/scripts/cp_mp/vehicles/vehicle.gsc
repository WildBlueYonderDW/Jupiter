    ...
    foreach ( var_bafa22fcdefff511 in data.damageableparts )
    {
        ...
        switch ( var_bafa22fcdefff511.ref )
        {
            ...
            case #"hash_d582c3286e5c390f":
                assert( isdefined( data.interact.lights[ var_bafa22fcdefff511.scriptablepartname ] ), "vehicle_processData: Didn't find light data for the light " + var_bafa22fcdefff511.ref + " on vehicle " + vehicleref );
                break;
        }
