...
function gunship_queuecamerazoom(animlength, player) {
    self endon("death");
    player endon("disconnect");
    level.var_e76baaf9a076d84 = getdvarfloat(@"bg_cinematicAspectRatio");
...
function function_dc42720fab95d5b6() {
    ...
    if (isdefined(level.var_e76baaf9a076d84)) {
        setsaveddvar(@"bg_cinematicAspectRatio", level.var_e76baaf9a076d84);
    }
...
function function_e646a7a0af99030e(projectile, position, var_d0cfeb022e718777) {
    ...
    if (isdefined(projectile)) {
        ...
        position = projectile waittill("explode");
...
function stingtargstruct_getinlos() {
    ...
    /#
        if (getdvar(@"hash_b56d344ee60e317f") == "<dev string:xf2>") {
...
function function_fe1296fe813dc527(gunner) {
    while (true) {
        projectile, weapon = gunner waittill("missile_fire");
...
function function_c212a027758ef4cb(weapon_name) {
    /#
        if (getdvarint(@"hash_a48570b2b90adb33") == 1 && weapon_name == level.gunship.var_d6604f5e3d0ba5ea) {
            return false;
        }
    #/
...
function function_62b4daf15be3076a(gunner, weapon_name) {
    ...
    if (projectile.var_872e9fd8a2a204b0.currentammo > 0) {
        if (getdvarint(@"hash_a48570b2b90adb33") == 0) {
...
function function_1e214468bc811f40(var_ad90f5e0ecc3ae91, var_2d4c24da89b14e2e, player) {
    missile = undefined;
    if (!flag("hellfire_system_busy") || getdvarint(@"hash_a48570b2b90adb33") == 1) {
...
function gunship_watchdamage(gunner) {
    ...
    while (true) {
        damage, attacker, var_bb83db5c48c12604, var_bb83db5c48c12604, smeansofdeath, var_bb83db5c48c12604, var_bb83db5c48c12604, var_bb83db5c48c12604, var_bb83db5c48c12604, objweapon = self waittill("damage");
