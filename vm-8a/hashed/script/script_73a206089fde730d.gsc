...
/#
    ...
    function private function_5f76fcafb2d10aa2() {
        ...
        scripts\common\devgui::function_b2159fbbd7ac094e("<dev string:x39>", @"hash_e0bb32a9a7b2f71d");
        scripts\common\devgui::function_b2159fbbd7ac094e("<dev string:x47>", @"hash_4f2cd88d61f31a05");
        scripts\common\devgui::function_b2159fbbd7ac094e("<dev string:x52>", @"hash_7bba049efb029baa");
        scripts\common\devgui::function_b2159fbbd7ac094e("<dev string:x60>", @"hash_3ec6799528b8c3a3");
        scripts\common\devgui::function_b2159fbbd7ac094e("<dev string:x76>", @"hash_e80ff5758ab695aa");
        scripts\common\devgui::function_b2159fbbd7ac094e("<dev string:x88>", @"hash_ecc9f2ec79830d8");
        scripts\common\devgui::function_b2159fbbd7ac094e("<dev string:x93>", @"hash_3cf803c8fb8e7b16");
        scripts\common\devgui::function_b2159fbbd7ac094e("<dev string:xaa>", @"hash_95bcb70ae8cbe4cf");
        scripts\common\devgui::function_b2159fbbd7ac094e("<dev string:xc2>", @"hash_1902f346336c9d19");
    ...
    function function_bc558b6c272c65e4(safe, var_fd5a08e385a75f6c) {
        orientedbox(safe scriptablegetmidpoint(), 2 * function_abf76cc289cf03a3("<dev string:x1b5>"), safe.angles, (1, 1, 1), 0, var_fd5a08e385a75f6c);
    }
    ...
    function function_d5622642498f5a6f(player) {
        level thread function_58ab5bffacda35c3(self, "<dev string:x1e8>", "<dev string:x1ed>", player);
    }
