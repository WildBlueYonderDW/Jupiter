...
function function_38994bbe618abc1c() {
    ...
    self endon("death");
    reason = level waittill("truck_driver_stopped");
...
function drone_init() {
    ...
    wait 0.05;
    level.drone.fov = getdvarint(@"cg_targetBaseFov");
...
function function_b67c4f58da9fcced() {
    level endon("drone_exit");
    wait 0.1;
    damage, attacker, direction, damagelocation, meansofdeath, modelname, attachtagname, partname, dflags, objweapon, origin, angles, normal, inflictor, time = self waittill("damage");
