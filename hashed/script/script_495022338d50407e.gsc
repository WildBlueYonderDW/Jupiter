...
function function_80d68c9701e1aea5(data) {
    ...
    level.var_ac29bbe3a85fc5fa.var_29a79d378c70e0b = getdvarint(@"hash_8fd341ad9e996d3a", 150);
    ...
    foreach (var_2a438b0332b8a143 in var_ab2be8088c0a7c90) {
        ...
        if (!isdefined(fortress)) {
            validlocations[validlocations.size] = var_2a438b0332b8a143;
        }
    }
    namespace_17c25f0877bfb620::scriptable_addusedcallbackbypart("safe", &function_4071d82a4af35fc);
...
function function_42c897c05fdda094() {
    ...
    self.safe.task = self;
    self.capturetime = level.var_ac29bbe3a85fc5fa.capturetime;
    /#
    ...
    #/
    trigger = spawn("trigger_radius", self.node.origin, 0, int(level.var_ac29bbe3a85fc5fa.var_29a79d378c70e0b), int(level.var_ac29bbe3a85fc5fa.var_29a79d378c70e0b));
    trigger trigger_off();
    ...
    namespace_5a22b6f3a56f7e9b::update_objective_icon(self.objidnum, "ui_map_icon_obj_recover");
    ...
    namespace_5a22b6f3a56f7e9b::objective_set_play_outro(self.objidnum, 0);
    ...
    thread function_474e2e9b4a997564(trigger, level.var_ac29bbe3a85fc5fa.var_29a79d378c70e0b);
}
...
// Size: 0x29b
function function_4071d82a4af35fc(instance, part, state, player, var_a5b2c541413aa895, var_cc38472e36be1b61) {
    if (state == "usable") {
...
function private function_a17b754d1372f83e(var_6e6ee0d9f73a2999) {
    ...
    if (isdefined(agent)) {
        ...
        if (isagent(agent)) {
            agent namespace_2000a83505151e5b::function_304da84d9a815c01(origin, 64);
...
function private function_a765843f381ad171() {
    ...
    while (1) {
        if (isdefined(self.trigger) && !istrue(self.trigger.trigger_off)) {
            ...
            var_90fb369a18926018 = function_75a1596e8181156(self.nearbyplayers, var_90fb369a18926018);
            namespace_5a22b6f3a56f7e9b::objective_set_progress(self.objidnum, self.progress / self.capturetime);
            if (self.progress >= self.capturetime) {
                ...
                agents = namespace_bfef6903bca5845d::function_353fecd1549f5f42(self.node.origin, var_f7d8df490bd332c3, undefined, 3, undefined, 64, 128);
                if (isdefined(agents)) {
                ...
                if (!var_7cc37d084d5e863c && var_94947ef251bf06d8 == 1 && var_a81135442ee1a731 < 4) {
                    var_da117ca38efac51b = namespace_bfef6903bca5845d::function_77acc10c4823dd8a(5, self.node.origin, "high", "mission", "safeReinforcements", undefined, undefined, 1, self.node.poi, "Helicopter", 32, 64, [0:"shotgun"]);
...
// Size: 0xe9
function private function_75a1596e8181156(nearbyplayers, var_90fb369a18926018) {
