...
function function_3e6d63e335461d9f(var_7483491932b87344) {
    foreach (weaponscale in var_7483491932b87344.var_f0491c6bbae95176) {
        ...
        for (i = 1; i <= 55; i++) {
            if (i >= 1 && i <= 10) {
                bonus_damage = bonus_damage + var_8be978d92a5f491b;
            } else if (i >= 11 && i <= 16) {
                bonus_damage = bonus_damage + var_ab9b007b48d2a13c;
            } else if (i >= 17 && i <= 21) {
                bonus_damage = bonus_damage + var_4257d22db0d2de10;
            } else if (i >= 22 && i <= 26) {
                bonus_damage = bonus_damage + var_d4bc3723b43637ad;
            } else if (i >= 27 && i <= 31) {
                bonus_damage = bonus_damage + var_a097d99c46084bc6;
            } else if (i >= 32 && i <= 36) {
                bonus_damage = bonus_damage + var_4a3eefb757083721;
            } else if (i >= 37) {
                bonus_damage = bonus_damage + var_318fdf592e2fa508;
            }
...
function function_6f4c937aa843fac2(n_base_damage, roundnumber, var_49e6ef3edadd524e, aicategory, maxhealth, dmg_struct, packdamagescalar) {
    ...
    if (istrue(damagestruct.shouldscale)) {
        if (var_43ea7ee7224a5f65 > 1) {
            ...
            var_d11b5d9fd186a28 = var_d11b5d9fd186a28 + bonus_damage;
        }
