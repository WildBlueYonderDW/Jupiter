...
/#
    ...
    function function_41684af1362b3f50(boss) {
        boss endon("<dev string:x42>");
        while (true) {
            waitframe();
            if (isdefined(boss)) {
                debugstar(boss.origin + (0, 0, 60), (0, 1, 0), 1, "<dev string:x48>" + boss.helmethealth + "<dev string:x56>" + boss.var_cfc69e5588a5bed6, 0.3);
                debugstar(boss.origin + (0, 0, 40), (0, 1, 0), 1, "<dev string:x58>" + boss.armorhealth + "<dev string:x56>" + boss.maxarmorhealth, 0.3);
                debugstar(boss.origin + (0, 0, 20), (0, 1, 0), 1, "<dev string:x65>" + boss.health + "<dev string:x56>" + boss.maxhealth, 0.3);
            }
        }
    }
