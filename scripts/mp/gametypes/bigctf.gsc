    ...
    /#
        ...
        while (true) {
            if (getdvar(@"hash_6ce167f2cdc8ef7c", "vfx/iw8_mp/gamemode/vfx_snatch_ac130_clouds.vfx") != "vfx/iw8_mp/gamemode/vfx_snatch_ac130_clouds.vfx") {
                goallabel = getdvar(@"hash_6ce167f2cdc8ef7c", "vfx/iw8_mp/gamemode/vfx_snatch_ac130_clouds.vfx");
                if (goallabel == "vfx_snatch_ac130_clouds") {
                ...
                level.teamflags[team] scripts/mp/gameobjects::allowuse("ui_ctf_flag_axis_return");
                ...
                level.capzones[team] scripts/mp/gameobjects::allowuse("ui_ctf_flag_axis_return");
    ...
    /#
        ...
        while (true) {
            if (getdvar(@"hash_29d45d6822a1cf6d", "vfx/iw8_mp/gamemode/vfx_snatch_ac130_clouds.vfx") != "vfx/iw8_mp/gamemode/vfx_snatch_ac130_clouds.vfx") {
                goallabel = getdvar(@"hash_29d45d6822a1cf6d", "vfx/iw8_mp/gamemode/vfx_snatch_ac130_clouds.vfx");
                if (goallabel == "vfx_snatch_ac130_clouds") {
                    team = "vfx/iw8_br/gameplay/infil/vfx_br_infil_jump_smoke_01.vfx";
                } else {
                    team = "vfx_br_infil_omni_light";
                ...
                newteamflag scripts/mp/gameobjects::setteamusetext("script_model", "ctf_flag_axis_CS");
                newteamflag scripts/mp/gameobjects::setteamusetext("pickupTime", "locale_area_trigger");
                newteamflag scripts/mp/gameobjects::allowcarry("script_model");
                newteamflag scripts/mp/gameobjects::setvisibleteam("ui_ctf_flag_axis_return");
                ...
                newteamflag.baseeffectpos = trace["mount128"];
                ...
                if (team == "vfx/iw8_br/gameplay/infil/vfx_br_infil_jump_smoke_01.vfx") {
                    if (game["stealth_spotted"]) {
                        level.teamflags[game["OBJECTIVES/CAPTURE_FLAG"]] = newteamflag;
                    } else {
                        level.teamflags[game["gunship"]] = newteamflag;
                    }
                } else if (game["stealth_spotted"]) {
                    level.teamflags[game["gunship"]] = newteamflag;
                } else {
                ...
                capzone scripts/mp/gameobjects::allowuse("pickupTime");
                capzone scripts/mp/gameobjects::setvisibleteam("gw_fob_01");
                ...
                if (team == "vfx/iw8_br/gameplay/infil/vfx_br_infil_jump_smoke_01.vfx") {
                    if (game["stealth_spotted"]) {
                        level.capzones[game["OBJECTIVES/CAPTURE_FLAG"]] = capzone;
                    } else {
                        level.capzones[game["gunship"]] = capzone;
                    }
                } else if (game["stealth_spotted"]) {
                    level.capzones[game["gunship"]] = capzone;
                } else {
...
function nuke_triggermercywin(team) {
    ...
    if (isdefined(level.teamdata[team]["alivePlayers"][0])) {
        ...
        var_39e8f33513c716cd scripts/cp_mp/killstreaks/nuke::tryusenuke("nuke_multi");
        return;
    }
    ...
    /#
        ...
        while (true) {
            if (getdvar(@"hash_24d9f7f9324e9c61") != "gw_fob_05") {
                ...
                if (isdefined(level.tdmzones["vfx_snatch_ac130_clouds"])) {
                    foreach (objective in level.tdmzones["vfx_snatch_ac130_clouds"]) {
                        thread drawsphere(objective.origin, 20, 1, (1, 1, 1));
                    }
                }
                if (isdefined(level.tdmzones["gw_fob_07"])) {
                    foreach (objective in level.tdmzones["gw_fob_07"]) {
                        thread drawsphere(objective.origin, 20, 1, (1, 1, 1));
                    }
                }
                if (isdefined(level.tdmzones["gw_fob_axishq"])) {
                    foreach (objective in level.tdmzones["gw_fob_axishq"]) {
                        thread drawsphere(objective.origin, 20, 1, (1, 1, 1));
                    }
                }
            }
...
function function_e3a2a0c2e544728e(var_a4ab3e1ca5d220c4) {
    /#
        if (var_a4ab3e1ca5d220c4 <= 5) {
            ...
            safekey = "_incoming" + var_a4ab3e1ca5d220c4 + "MP_INGAME_ONLY/OBJ_DEFEND_CAPS";
            var_eb7299174b67818d = undefined;
            var_fd81d96696f0490a = undefined;
            if (isdefined(level.spawnselectionlocations[safekey]) && isdefined(level.spawnselectionlocations[safekey]["vfx_br_infil_omni_light"])) {
                var_eb7299174b67818d = level.spawnselectionlocations[safekey]["vfx_br_infil_omni_light"].spawnpoints;
            }
            if (isdefined(level.spawnselectionlocations[safekey]) && isdefined(level.spawnselectionlocations[safekey]["vfx/iw8_br/gameplay/infil/vfx_br_infil_jump_smoke_01.vfx"])) {
                var_fd81d96696f0490a = level.spawnselectionlocations[safekey]["vfx/iw8_br/gameplay/infil/vfx_br_infil_jump_smoke_01.vfx"].spawnpoints;
            }
