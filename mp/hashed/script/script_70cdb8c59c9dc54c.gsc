...
#namespace jup_enemy_mp_sniper_tier2_aq_gwtdm;

// Namespace jup_enemy_mp_sniper_tier2_aq_gwtdm / namespace_ea8de66af76111d4
// Params 0, eflags: 0x0
// Checksum 0x0, Offset: 0x253
// Size: 0x1e0
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_mp_sniper_tier2_aq_gwtdm" );
