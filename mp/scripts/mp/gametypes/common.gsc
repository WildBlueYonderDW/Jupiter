    ...
    switch ( itemref )
    {
        ...
        case #"hash_a7a7446a3194cb49":
            if ( isreallyalive( self ) )
            {
                ...
                {
                    scripts\cp_mp\armor::setarmorhealth( int( clamp( self.armorhealth + level.var_4b78859bacc88808, 0, self.maxarmorhealth ) ) );
                }
            }
            else
            {
