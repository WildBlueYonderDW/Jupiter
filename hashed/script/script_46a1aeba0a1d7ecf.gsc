...
#namespace namespace_a93d5dbc46fff27f;

// Namespace namespace_a93d5dbc46fff27f / namespace_fc5d6d533ff5dabf
// Params 0, eflags: 0x0
...
function function_28c6b362e045f5a() {
    ...
    add_start("cliff", &cliff_start, &function_53f02424578f97df, ["sp_jup_tundra_lumbermill_buildings_tr", "sp_jup_tundra_lumbermill_tr", "sp_jup_tundra_cliff_tr", "sp_jup_tundra_shipyard_tr", "sp_jup_tundra_lumbermill_view_tr"], &function_45ec82c0014d1b4c);
...
function setup_objectives() {
    level.var_bd0073f0d926bb38 = spawn_tag_origin();
