...
#namespace jup_enemy_cp_lmg_tier3_rus_pmc;

// Namespace jup_enemy_cp_lmg_tier3_rus_pmc / namespace_77eba255762fcf79
// Params 0, eflags: 0x0
// Checksum 0x0, Offset: 0x3d4
// Size: 0x228
function main() {
    self.aitypeid = function_2336488258354fbc(#"aitype", %"jup_enemy_cp_lmg_tier3_rus_pmc");
    ...
    case 0: 
        primaryweaponhash = "iw9_lm_rkilo_mp, [ reflex03_tall, drum_lm_p04, stock_ar_light_p04_rkilo ], none, none";
        self.weapon = level.var_67b54180a55f70e1[primaryweaponhash];
        break;
    case 1: 
        primaryweaponhash = "jup_jp06_lm_pkilop_mp, [ jup_jp06_lm_pkilop_bar_light, hybrid03, jup_jp06_lm_pkilop_belt_150_762n ], none, none";
        self.weapon = level.var_67b54180a55f70e1[primaryweaponhash];
        break;
    }
...
// Size: 0x106
function precache() {
    agent_type = "actor_jup_enemy_cp_lmg_tier3_rus_pmc";
...
function setup_weapons() {
    ...
    var_5576d3be590a9a64 = "iw9_lm_rkilo_mp, [ reflex03_tall, drum_lm_p04, stock_ar_light_p04_rkilo ], none, none";
    if (!isdefined(level.var_67b54180a55f70e1[var_5576d3be590a9a64])) {
        level.var_67b54180a55f70e1[var_5576d3be590a9a64] = scripts\cp\cp_weapon::function_e83615f8a92e4378("iw9_lm_rkilo_mp", ["reflex03_tall", "drum_lm_p04", "stock_ar_light_p04_rkilo"], "none", "none");
    }
    var_5576d6be590aa0fd = "jup_jp06_lm_pkilop_mp, [ jup_jp06_lm_pkilop_bar_light, hybrid03, jup_jp06_lm_pkilop_belt_150_762n ], none, none";
    if (!isdefined(level.var_67b54180a55f70e1[var_5576d6be590aa0fd])) {
        level.var_67b54180a55f70e1[var_5576d6be590aa0fd] = scripts\cp\cp_weapon::function_e83615f8a92e4378("jup_jp06_lm_pkilop_mp", ["jup_jp06_lm_pkilop_bar_light", "hybrid03", "jup_jp06_lm_pkilop_belt_150_762n"], "none", "none");
    }
    var_4f04b9c326eb7400 = "jup_cp24_pi_glima21_mp, [ none, none, none, none, none, none ], none, none";
