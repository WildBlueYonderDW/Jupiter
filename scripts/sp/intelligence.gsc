...
function upload_hold() {
    ...
    while (level.player.hold_count < 30 && isdefined(self)) {
        ...
        setdvar(@"hash_111335a236a9ff1f", "intel");
        setdvar(@"hash_f401b38cb54cf63", 0);
        thread progress_bar();
        hold_count_check();
    }
    self notify("hold_complete");
    self stoploopsound("intelligence_pickup_loop");
    setdvar(@"hash_f401b38cb54cf63", 1);
    setdvar(@"hash_111335a236a9ff1f", "");
}
...
function progress_bar() {
    ...
    for (i = 0; i < var_e10d2077ef53fe8a; i++) {
        setdvar(@"hash_f401b38cb54cf63", getdvarfloat(@"hash_f401b38cb54cf63") + 1 / var_e10d2077ef53fe8a);
        waitframe();
    }
}
