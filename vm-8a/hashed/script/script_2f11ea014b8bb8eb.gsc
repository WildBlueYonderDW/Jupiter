...
function on_player_spawn(params) {
    ...
    /#
        if (!istrue(self.var_69bf698c4fd8a446)) {
            ...
            function_6e7290c8ee4f558b("<dev string:x30>");
            function_b23a59dfb4ca49a1(self.name, "<dev string:x4f>" + self.name, &function_6cc14e0f7058fbf4);
...
function function_f3645fa4bfb45a97(player) {
    ...
    if (isalive(player) && isalive(player.dog_companion)) {
        return true;
    }
