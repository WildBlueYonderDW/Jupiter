...
#namespace jup_enemy_mp_ar_tier2_pmc;

// Namespace jup_enemy_mp_ar_tier2_pmc / namespace_f5ef6d458169df50
// Params 0
// Checksum 0x0, Offset: 0x260
// Size: 0x1e0
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_mp_ar_tier2_pmc" );
    ...
    primaryweaponhash = "jup_jp01_ar_golf36, [ none, none, none, none, none, none ], none, none";
...
function precache()
{
    agent_type = "actor_jup_enemy_mp_ar_tier2_pmc";
...
function setup_weapons()
{
    ...
    {
        level.var_67b54180a55f70e1[ primaryweaponhash ] = scripts\mp\class::function_e83615f8a92e4378( "jup_jp01_ar_golf36", [ "none", "none", "none", "none", "none", "none" ], "none", "none" );
    }
