            ...
            foreach (player in players) {
                if (!istrue(player.pers["streamSyncComplete"]) || player.model == "" || !player ispredictedstreamposready() || !player isadditionalstreamposready()) {
                    /#
                        ...
                        if (player.model == "<dev string:x2f>") {
...
function function_475b703f6d063a37() {
    ...
    /#
        if (isdefined(level.var_2feb1fee386da049)) {
            println("<dev string:x30>" + level.var_2feb1fee386da049);
        }
        if (isdefined(level.var_6cbb7e30776f280e)) {
            println("<dev string:x5d>" + level.var_6cbb7e30776f280e);
        }
    #/
    foreach (teamname, var_70643c8580524236 in level.squaddata) {
        foreach (squad in var_70643c8580524236) {
...
function function_2796212b16ece5a4(teamname, squadid, overridespawnpoint, overridewaittime) {
    ...
    /#
        foreach (player in players) {
            if (isdefined(player.var_e298a3ca3ed1a049)) {
                println("<dev string:x88>" + player.name + "<dev string:x90>" + player.var_e298a3ca3ed1a049);
            }
            if (isdefined(player.var_f12e6635eb2fe3b8)) {
                println("<dev string:x88>" + player.name + "<dev string:xa9>" + player.var_f12e6635eb2fe3b8);
            }
            if (isdefined(player.var_acb3470fd92a831)) {
                println("<dev string:x88>" + player.name + "<dev string:xc0>" + player.var_acb3470fd92a831);
            }
            if (isdefined(player.var_690843a63d7f6150)) {
                println("<dev string:x88>" + player.name + "<dev string:xda>" + player.var_690843a63d7f6150);
            }
            println("<dev string:x88>" + player.name + "<dev string:xf2>" + gettime());
        }
    #/
...
function function_74a7839b271cb87f(players, spawnpoint, scenename) {
    foreach (player in players) {
        ...
        println("<dev string:x103>" + player.name + "<dev string:x115>" + gettime());
    ...
    if (players.size) {
        ...
        println("<dev string:x12f>" + (isdefined(spawnpoint.script_noteworthy) ? spawnpoint.script_noteworthy : "<dev string:x2f>") + "<dev string:x171>" + spawnpoint.origin);
    ...
    foreach (player in players) {
        ...
        println("<dev string:x103>" + player.name + "<dev string:x17f>" + gettime());
...
/#
    ...
    function function_fff3d0f8a5f042ad() {
        ...
        devgui::function_6e7290c8ee4f558b("<dev string:x1bf>");
        devgui::function_a9a864379a098ad6("<dev string:x1da>", "<dev string:x1f8>", &function_926714d6eed28ff3, 1);
        foreach (var_44934ca35515c2c6, var_6f2d35eec7db0a3 in level.var_7a8e039103b51e0f) {
            foreach (n_spawn, var_a52af6b9e435b1cf in var_6f2d35eec7db0a3) {
                ...
                devgui::function_b23a59dfb4ca49a1("<dev string:x207>" + var_dce4f9020e3900b2 + "<dev string:x21f>" + n_spawn + "<dev string:x227>", "<dev string:x239>" + var_44934ca35515c2c6 + "<dev string:x248>" + n_spawn, &function_35ab01589cc4f6c6);
                devgui::function_b23a59dfb4ca49a1("<dev string:x207>" + var_dce4f9020e3900b2 + "<dev string:x21f>" + n_spawn + "<dev string:x24a>", "<dev string:x262>" + var_44934ca35515c2c6 + "<dev string:x248>" + n_spawn, &function_e7f0b651d2ebaf9d);
            }
        }
        if (istrue(level.var_46901be2468e1d90)) {
            var_9091c4080e2751f2 = spawnlogic::getspawnpointarray("<dev string:x272>");
            foreach (n_spawn, var_4ca1988ce7e52ba1 in var_9091c4080e2751f2) {
                var_dce4f9020e3900b2 = "<dev string:x28c>";
                var_44934ca35515c2c6 = "<dev string:x28c>";
                devgui::function_b23a59dfb4ca49a1("<dev string:x207>" + var_dce4f9020e3900b2 + "<dev string:x21f>" + n_spawn + "<dev string:x227>", "<dev string:x239>" + var_44934ca35515c2c6 + "<dev string:x248>" + n_spawn, &function_35ab01589cc4f6c6);
                devgui::function_b23a59dfb4ca49a1("<dev string:x207>" + var_dce4f9020e3900b2 + "<dev string:x21f>" + n_spawn + "<dev string:x24a>", "<dev string:x262>" + var_44934ca35515c2c6 + "<dev string:x248>" + n_spawn, &function_e7f0b651d2ebaf9d);
            }
        }
        ...
        while (true) {
            foreach (var_6f2d35eec7db0a3 in level.var_7a8e039103b51e0f) {
                foreach (n_spawn, var_a52af6b9e435b1cf in var_6f2d35eec7db0a3) {
                    ...
                    print3d(var_a52af6b9e435b1cf.origin, "<dev string:x29c>" + var_a52af6b9e435b1cf.classname, undefined, undefined, 0.25);
                    print3d(var_a52af6b9e435b1cf.origin + (0, 0, -5), "<dev string:x2a8>" + var_a52af6b9e435b1cf.script_noteworthy, undefined, undefined, 0.25);
                    print3d(var_a52af6b9e435b1cf.origin + (0, 0, -10), "<dev string:x2c1>" + n_spawn, undefined, undefined, 0.25);
