...
function function_f02d8dd1e58f235c(player, struct) {
    ...
    if (isdefined(operatorskin)) {
        ...
        if (isdefined(defaultkillstreak)) {
            assert(namespace_38b993c4618e76cd::function_282cf83c9eeda744(defaultkillstreak) == "killstreak");
...
function function_22c2d36f9a723c2f(player, index, loadoutslot) {
    ...
    assert(backpackindex < 12, "Attempting to set a backpack item at invalid index " + index);
...
function function_33366ade5697aa38(player) {
    ...
    println(player.name + "<dev string:x1c>");
    function_a839b9ad5740477d(player, 2, 0);
    ...
    println(player.name + "<dev string:x48>");
    for (backpackindex = 0; backpackindex < 11; backpackindex++) {
        lootid = player function_6196d9ea9a30e609(backpackindex);
        quantity = player function_897b29adb37f06a7(backpackindex);
        ref = namespace_38b993c4618e76cd::function_793e8a72cedb8ef3(lootid);
        /#
            println("<dev string:x57>" + backpackindex + "<dev string:x59>" + lootid + "<dev string:x60>" + ref + "<dev string:x63>" + lootid);
            println("<dev string:x57>" + backpackindex + "<dev string:x67>" + lootid + "<dev string:x60>" + ref + "<dev string:x63>" + quantity);
        #/
    }
}
...
/#
    ...
    function function_e64d9a42c66018c9(player) {
        ...
        primaryinstance = player function_644ed519cac9722b(1, 0);
        weaponstring = "<dev string:x74>";
        println(function_181f84b6e516d4e6(primaryinstance, weaponstring));
        secondaryinstance = player function_644ed519cac9722b(1, 1);
        weaponstring = "<dev string:x86>";
        println(function_181f84b6e516d4e6(secondaryinstance, weaponstring));
        var_6267a5ad12c5e4d4 = player function_644ed519cac9722b(2, 0);
        weaponstring = "<dev string:x98>";
        println(function_181f84b6e516d4e6(var_6267a5ad12c5e4d4, weaponstring));
        lethalinstance = player function_644ed519cac9722b(1, 2);
        println("<dev string:xa9>" + lethalinstance.lootid);
        tacticalinstance = player function_644ed519cac9722b(1, 3);
        println("<dev string:xc7>" + tacticalinstance.lootid);
        var_bed94c5e8ba6c57e = player function_644ed519cac9722b(1, 4);
        println("<dev string:xe7>" + var_bed94c5e8ba6c57e.lootid);
        killstreakinstance = player function_644ed519cac9722b(65535, 0);
        println("<dev string:x102>" + killstreakinstance.lootid);
        var_dc62a204e1921a99 = player function_644ed519cac9722b(65535, 4);
        println("<dev string:x11a>" + var_dc62a204e1921a99.lootid);
        backpackinstance = player function_644ed519cac9722b(65535, 1);
        println("<dev string:x130>" + backpackinstance.lootid);
        var_ea074533d9558d3d = player function_644ed519cac9722b(65535, 3);
        println("<dev string:x146>" + var_ea074533d9558d3d.lootid);
        var_50b1b73063d6e846 = player function_644ed519cac9722b(1, 12);
        println("<dev string:x15f>" + var_50b1b73063d6e846.lootid);
        var_c8bbed73f0438ec8 = player function_644ed519cac9722b(1, 13);
        println("<dev string:x17c>" + var_c8bbed73f0438ec8.lootid);
        var_9cdf915529700821 = player function_644ed519cac9722b(1, 14);
        println("<dev string:x198>" + var_9cdf915529700821.lootid);
        var_a4462a64012f11a5 = player function_644ed519cac9722b(1, 15);
        println("<dev string:x1b3>" + var_a4462a64012f11a5.lootid);
        var_78ae3551b1d877da = player function_644ed519cac9722b(1, 16);
        println("<dev string:x1d0>" + var_78ae3551b1d877da.lootid);
        for (backpackindex = 1; backpackindex <= 12; backpackindex++) {
            backpackinstance = player function_644ed519cac9722b(2, backpackindex);
            println("<dev string:x1ec>" + backpackindex + "<dev string:x1fb>" + backpackinstance.lootid);
        }
    }
...
function function_c563bbc48f1dd3d2(player) {
    ...
    while (true) {
        ...
        primaryinstance = player function_644ed519cac9722b(1, 0);
        /#
            player.var_6f7281f031b30320[0] setdevtext(function_181f84b6e516d4e6(primaryinstance, "<dev string:x74>"));
        #/
        player.var_6f7281f031b30320[0] setpoint("TOPLEFT", "TOPLEFT", 250, 30);
        player.var_6f7281f031b30320[0] clearalltextafterhudelem();
        secondaryinstance = player function_644ed519cac9722b(1, 1);
        /#
            player.var_6f7281f031b30320[1] setdevtext(function_181f84b6e516d4e6(secondaryinstance, "<dev string:x86>"));
        #/
        player.var_6f7281f031b30320[1] setpoint("TOPLEFT", "TOPLEFT", 250, 40);
        player.var_6f7281f031b30320[1] clearalltextafterhudelem();
        var_6267a5ad12c5e4d4 = player function_644ed519cac9722b(2, 0);
        /#
            player.var_6f7281f031b30320[2] setdevtext(function_181f84b6e516d4e6(var_6267a5ad12c5e4d4, "<dev string:x98>"));
        #/
        ...
        tacticalinstance = player function_644ed519cac9722b(1, 3);
        /#
            player.var_6f7281f031b30320[3] setdevtext(function_e29c498dd636939a(lethalinstance, "<dev string:xa9>") + "<dev string:x201>" + function_e29c498dd636939a(tacticalinstance, "<dev string:x203>"));
        #/
        ...
        killstreakinstance = player function_644ed519cac9722b(65535, 0);
        /#
            player.var_6f7281f031b30320[4] setdevtext(function_e29c498dd636939a(var_bed94c5e8ba6c57e, "<dev string:x224>") + "<dev string:x201>" + function_e29c498dd636939a(killstreakinstance, "<dev string:x249>"));
        #/
        ...
        var_ea074533d9558d3d = player function_644ed519cac9722b(65535, 3);
        /#
            player.var_6f7281f031b30320[5] setdevtext(function_e29c498dd636939a(var_dc62a204e1921a99, "<dev string:x11a>") + "<dev string:x201>" + function_e29c498dd636939a(backpackinstance, "<dev string:x263>") + "<dev string:x201>" + function_e29c498dd636939a(var_ea074533d9558d3d, "<dev string:x27a>") + "<dev string:x201>" + function_e29c498dd636939a(var_2ac478345313402, "<dev string:x294>"));
        #/
        ...
        var_78ae3551b1d877da = player function_644ed519cac9722b(1, 16);
        /#
            player.var_6f7281f031b30320[6] setdevtext(function_e29c498dd636939a(var_50b1b73063d6e846, "<dev string:x2b0>") + "<dev string:x201>" + function_e29c498dd636939a(var_c8bbed73f0438ec8, "<dev string:x2c7>") + "<dev string:x201>" + function_e29c498dd636939a(var_9cdf915529700821, "<dev string:x2de>") + "<dev string:x201>" + function_e29c498dd636939a(var_a4462a64012f11a5, "<dev string:x2f4>") + "<dev string:x201>" + function_e29c498dd636939a(var_78ae3551b1d877da, "<dev string:x30c>"));
        #/
...
/#
    ...
    function function_72fe945f29c8bce6(instance) {
        println("<dev string:x323>" + instance.instanceid);
        if (isdefined(instance.metadata)) {
            println("<dev string:x343>");
            foreach (data in instance.metadata) {
                println("<dev string:x354>" + data.key + "<dev string:x35a>" + data.value);
            }
        }
        if (isdefined(instance.var_d3c548c09bb62da2)) {
            println("<dev string:x364>");
            foreach (data in instance.var_d3c548c09bb62da2) {
                println("<dev string:x354>" + data.key + "<dev string:x35a>" + data.value);
            }
        }
