...
// Size: 0x1e9
function main() {
    self.var_9d26ac1e325367ce = function_2336488258354fbc(#"aitype", %"jup_spawner_zombie_mimic");
    ...
    self.var_570908460ede5c13 = "settings_zombie_mimic";
...
function precache() {
    ...
    params.var_570908460ede5c13 = "settings_zombie_mimic";
