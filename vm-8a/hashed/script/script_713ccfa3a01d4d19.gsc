...
function function_15ec8dc28147b1b7(dvar, var_dc26843157970ecf, var_69a1727953025cb0, dvardefault) {
    ...
    if (name == "") {
        /#
            iprintln("<dev string:x1c>" + function_3c8848a3a11b2553(dvar) + "<dev string:x3e>");
        #/
        return;
    }
    ...
    if (!isdefined(bundle)) {
        /#
            iprintln("<dev string:x4b>" + function_3c8848a3a11b2553(dvar) + "<dev string:x77>" + name + "<dev string:x7b>");
        #/
        return;
    }
