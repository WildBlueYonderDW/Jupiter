...
function function_ee51e20891506e33(struct_targetname, end_on, var_b2ca5107267bfd0) {
    ...
    actor = target_node waittill("trigger");
    if (isdefined(actor)) {
        if (isdefined(var_b2ca5107267bfd0)) {
...
function private function_a1cf2a622d1c69e4(guy) {
    ...
    while (true) {
        damage, attacker, direction_vec, point, type, modelname, tagname, partname, idflags, objweapon, origin, angles, normal, inflictor = guy waittill("damage");
