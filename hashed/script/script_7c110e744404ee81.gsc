...
function player_music_loop(music_state) {
    ...
    self endon("disconnect");
    if (self.var_bd670c1e0f4290da != "init" && music_state == "") {
        self setplayermusicstate("");
    }
    self.var_bd670c1e0f4290da = music_state;
...
function threat_sight_player_sight_audio(anycansee, maxthreat, var_67e8151f4dfc690b) {
    ...
    /#
        if (var_67e8151f4dfc690b) {
            printtoscreen2d(32, 492, "<unknown string>" + maxthreat + "<unknown string>" + anycansee + "<unknown string>", (1, 1, 1), 1.5);
        }
    #/
