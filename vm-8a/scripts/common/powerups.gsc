...
function function_3470b420d25e6256() {
    ...
    while (true) {
        ...
        foreach (player_sound in var_269d8af30921f43d) {
            player_sound playsoundevent("sndevent_powerup_" + self.str_powerup, player_sound);
        }
        ...
        /#
            if (isdefined(player.name)) {
                iprintlnbold(self.str_powerup + "<dev string:x1c>" + player.name);
            }
        #/
...
/#
    ...
    function function_e2b8eeccc951133f(a_params) {
        ...
        if (var_580aba0d7d779ed2) {
            offset = (0, 0, function_edeba0070ca0709e("<dev string:x33>"));
