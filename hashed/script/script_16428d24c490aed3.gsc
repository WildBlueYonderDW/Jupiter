...
function function_436b7bae8de567e7(params) {
    ...
    var_d6d1a339ac7dc7f9 = params.var_e91a6371e99e1350;
    var_8a3f982c1e947e5c = params.var_43b043539f9c3ccf;
    if (!isdefined(player)) {
        return;
    }
    if (isdefined(level.squaddata[player.team][var_8a3f982c1e947e5c]) && isdefined(level.squaddata[player.team][var_8a3f982c1e947e5c].players)) {
        foreach (var_c0c0df46978788e1 in level.squaddata[player.team][var_8a3f982c1e947e5c].players) {
            if (isdefined(var_c0c0df46978788e1.var_f9faff3d5230e3ce) && var_c0c0df46978788e1 != player) {
                if (isdefined(player.var_f9faff3d5230e3ce)) {
                    if (isdefined(var_d6d1a339ac7dc7f9)) {
                        var_dae01089c8c4a757 = level.squaddata[player.team][var_d6d1a339ac7dc7f9];
                    }
                    if (isdefined(var_dae01089c8c4a757)) {
                        var_92b01e8df6c4c1d7 = var_dae01089c8c4a757.players;
                    }
                    if (isdefined(var_92b01e8df6c4c1d7) && var_92b01e8df6c4c1d7.size > 0) {
                ...
                player.var_f9faff3d5230e3ce = var_c0c0df46978788e1.var_f9faff3d5230e3ce;
                foreach (interact in player.var_f9faff3d5230e3ce) {
                    if (isdefined(interact)) {
...
function on_item_drop(params) {
    if (isdefined(params.payload) && params.payload[1] == self getentitynumber() && issubstr(params.item.type, "ob_jup_scriptable_key_rift_gate_season1")) {
        var_9b0dd04874627a99 = namespace_ca7b90256548aa40::function_5a009fe17f688c92();
        if (var_9b0dd04874627a99.size > 1 && !isdefined(params.item.var_d1c37d94e5043730)) {
            level thread function_dc5d83d97e8f9e9c(params.item, params.var_fbe755f0978c0369, var_9b0dd04874627a99, self);
        }
        foreach (player in level.players) {
            if (!array_contains(var_9b0dd04874627a99, player)) {
...
// Size: 0x1d7
function function_dc5d83d97e8f9e9c(item, var_fbe755f0978c0369, var_9b0dd04874627a99, player) {
    ...
    str_model = getscriptbundle("itemspawnentry:" + var_fbe755f0978c0369).worldmodel;
    item.var_d1c37d94e5043730 setmodel(str_model);
    item.var_d1c37d94e5043730.angles = item.angles;
    item.var_d1c37d94e5043730 hide();
    if (issubstr(var_fbe755f0978c0369, "attuned") && namespace_36f464722d326bbe::getmapname() == "mp_jup_bigmap") {
        str_fx = function_da3e68f8f9f52e9b(var_fbe755f0978c0369);
    }
    foreach (var_2fe316433061a45f in level.players) {
        if (array_contains(var_9b0dd04874627a99, var_2fe316433061a45f)) {
            if (var_2fe316433061a45f != player) {
                item.var_d1c37d94e5043730 showtoplayer(var_2fe316433061a45f);
                if (isdefined(str_fx)) {
                    playfxontagforclients(level._effect["rift_gate_item_fx_" + str_fx], item.var_d1c37d94e5043730, "tag_origin", player);
                }
            }
        } else {
            item disablescriptableplayeruse(var_2fe316433061a45f);
        }
    }
}
...
// Size: 0x5c
function function_da3e68f8f9f52e9b(var_fbe755f0978c0369) {
    if (issubstr(var_fbe755f0978c0369, "toxic")) {
        return "toxic";
    }
    if (issubstr(var_fbe755f0978c0369, "ice")) {
        return "ice";
    }
    if (issubstr(var_fbe755f0978c0369, "fire")) {
        return "fire";
    }
    if (issubstr(var_fbe755f0978c0369, "electric")) {
        return "electric";
    }
}
...
function function_5defc56cf37dad61(params) {
    ...
    foreach (var_faedb78b180470ac in level.var_bddbfe8bee6d6dc5) {
        if (isdefined(var_faedb78b180470ac.var_39cfa415b2be8156)) {
            foreach (var_8f082407384af045 in var_faedb78b180470ac.var_39cfa415b2be8156) {
                var_8f082407384af045.var_76d4bd67b47250bf showtoplayer(self);
            }
        }
        if (istrue(function_8442cf03b10a3296(self))) {
            if (!isdefined(self.var_a20bb623ab5f6211)) {
                self.var_a20bb623ab5f6211 = namespace_4164bc931714b00b::spawn_script_model(var_faedb78b180470ac, "jup_zm_rift_gate", 1, 1);
                if (isdefined(self.var_a20bb623ab5f6211)) {
...
// Size: 0x481
function function_5155042c35a3fdd2(var_faedb78b180470ac) {
    v_offset = (0, 0, 0);
    /#
        if (level.mapname == "ob_rift_gate" || level.mapname == "jup_zm_rift_gate_vortex") {
            v_offset = (-8222, 12250, -1400);
        }
    #/
    var_faedb78b180470ac.origin = var_faedb78b180470ac.origin + v_offset;
    level.var_bddbfe8bee6d6dc5 = array_add(level.var_bddbfe8bee6d6dc5, var_faedb78b180470ac);
    function_606642b946a01237("rift_gate_ambient_blocker", var_faedb78b180470ac.origin, 1500, 1);
    var_faedb78b180470ac.var_4a3fdaa52712dd55 = namespace_4164bc931714b00b::spawn_script_model(var_faedb78b180470ac, "jup_zm_rift_gate_vortex", 0, 0);
    var_faedb78b180470ac.var_38b605adf8e926c8 = spawnscriptable("ob_jup_scriptable_rift_map_icon", var_faedb78b180470ac.origin, var_faedb78b180470ac.angles);
    var_faedb78b180470ac.var_39cfa415b2be8156 = [];
    var_39cfa415b2be8156 = getstructarray("ob_rift_gate_pedestal", "script_noteworthy");
    foreach (var_8f082407384af045 in var_39cfa415b2be8156) {
        if (var_8f082407384af045.target == var_faedb78b180470ac.targetname) {
            var_8f082407384af045.var_faedb78b180470ac = var_faedb78b180470ac;
            var_8f082407384af045.origin = var_8f082407384af045.origin + v_offset;
            if (var_8f082407384af045.targetname == "toxic") {
                var_18819ef03e6b0884 = "jup_zm_rift_pedestal";
            } else {
                var_18819ef03e6b0884 = var_8f082407384af045.targetname + "::" + "jup_zm_rift_pedestal";
            }
            var_93ef5ee002227bec = var_8f082407384af045.targetname + "_on::" + "jup_zm_rift_pedestal";
            var_8f082407384af045.var_76d4bd67b47250bf = namespace_4164bc931714b00b::spawn_script_model(var_8f082407384af045, var_18819ef03e6b0884, 1, 0);
            var_8f082407384af045.var_8844fd8bc5739789 = namespace_4164bc931714b00b::spawn_script_model(var_8f082407384af045, var_93ef5ee002227bec, 1, 0);
            var_8f082407384af045.var_76d4bd67b47250bf hide();
            var_8f082407384af045.var_8844fd8bc5739789 hide();
            var_faedb78b180470ac.var_39cfa415b2be8156 = array_add(var_faedb78b180470ac.var_39cfa415b2be8156, var_8f082407384af045);
        }
    }
    var_faedb78b180470ac.var_a489feecfa0a74 = [];
    var_a489feecfa0a74 = getstructarray("ob_rift_token_prompt", "script_noteworthy");
    foreach (var_a2e14ff9766e1b19 in var_a489feecfa0a74) {
        if (var_a2e14ff9766e1b19.target == var_faedb78b180470ac.targetname) {
            var_a2e14ff9766e1b19.origin = var_a2e14ff9766e1b19.origin + v_offset;
            var_faedb78b180470ac.var_a489feecfa0a74 = array_add(var_faedb78b180470ac.var_a489feecfa0a74, var_a2e14ff9766e1b19);
        }
    }
    var_42d86aac2c64a360 = getstructarray("ob_rift_encounter", "script_noteworthy");
    foreach (var_e10a98520809d260 in var_42d86aac2c64a360) {
        if (var_e10a98520809d260.target == var_faedb78b180470ac.targetname) {
            var_e10a98520809d260.origin = var_e10a98520809d260.origin + v_offset;
            var_faedb78b180470ac.var_e10a98520809d260 = var_e10a98520809d260;
            break;
        }
    }
    a_s_rewards = getstructarray("ob_rift_gate_reward", "script_noteworthy");
    foreach (s_reward in a_s_rewards) {
        if (s_reward.target == var_faedb78b180470ac.targetname) {
            s_reward.origin = s_reward.origin + v_offset;
            var_faedb78b180470ac.s_reward = s_reward;
            break;
        }
    }
}
...
function private function_922a434697a632e3(params) {
    ...
    var_9b0dd04874627a99 = params.player namespace_ca7b90256548aa40::function_5a009fe17f688c92();
    foreach (var_c0c0df46978788e1 in var_9b0dd04874627a99) {
        if (isdefined(var_c0c0df46978788e1.var_f9faff3d5230e3ce)) {
            var_78e49555d76726c1 = var_c0c0df46978788e1.var_f9faff3d5230e3ce;
            break;
        }
    }
    if (isdefined(var_78e49555d76726c1)) {
        ...
        level thread function_1383a22b72211d91(var_9b0dd04874627a99);
    }
}
...
// Size: 0x311
function private function_1383a22b72211d91(var_9b0dd04874627a99) {
    var_faedb78b180470ac = level.var_1fb16fc647c8b98b;
    if (!isdefined(var_faedb78b180470ac.var_39cfa415b2be8156)) {
        return;
    }
    ...
    level.var_baa6971238a67105 = function_53c4c53197386572(level.var_baa6971238a67105, 0);
    level.var_c75d3185077f2f0f = function_53c4c53197386572(level.var_c75d3185077f2f0f, 0);
    foreach (var_8f082407384af045 in var_faedb78b180470ac.var_39cfa415b2be8156) {
        var_a3a5c8e4541d079f = anglestoforward(var_8f082407384af045.angles) * -8;
        v_offset = anglestoup(var_8f082407384af045.angles) * (16 + level.var_c75d3185077f2f0f) + anglestoforward(var_8f082407384af045.angles) * level.var_baa6971238a67105;
        v_spawn = var_8f082407384af045.origin + v_offset + var_a3a5c8e4541d079f;
        interact = spawnscriptable("ob_jup_rift_gate_pedestal_container", v_spawn);
        interact.var_8f082407384af045 = var_8f082407384af045;
        interact.var_faedb78b180470ac = var_faedb78b180470ac;
        interact.var_febe9aacdd2e47b2 = 1;
        interact.var_532eac3c428e5b9b = 1;
        namespace_17c25f0877bfb620::scriptable_addusedcallbackbypart("rift_gate_pedestal_container", &function_cf1b1f86951a9209);
        ...
        interact.var_46a3a8565ac0c17c = 19;
        foreach (player in level.players) {
            interact disablescriptableplayeruse(player);
        }
...
// Size: 0x186
function function_ad319ef1312a4f2e(var_faedb78b180470ac) {
    level endon("game_ended");
    var_87a4ed8f49baa87f = [];
    var_70d983a2559807d6 = 0;
    while (1) {
        a_players = getplayersinradius(var_faedb78b180470ac.origin, 800, 800);
        foreach (player in a_players) {
            if (!istrue(function_8442cf03b10a3296(player))) {
                if (var_70d983a2559807d6 + 1 < gettime()) {
                    player earthquakeforplayer(0.15, 1, var_faedb78b180470ac.origin, 800);
        ...
        foreach (var_624ee73c0046cf6 in var_87a4ed8f49baa87f) {
            if (isdefined(var_624ee73c0046cf6) && !array_contains(a_players, var_624ee73c0046cf6)) {
                var_624ee73c0046cf6 namespace_6c72573a48881070::function_9a92ae402e209ecc("mp_jup_bigmap_storm", 1);
                player setmovespeedscale(1);
            }
        }
        var_87a4ed8f49baa87f = a_players;
        wait(0.5);
    }
}
...
// Size: 0x351
function function_9a8fd43ba8259335(var_faedb78b180470ac) {
    level endon("game_ended");
    var_3a9e259605bd2fd9 = namespace_4164bc931714b00b::spawn_script_model(var_faedb78b180470ac, "jup_zm_rift_gate_yellow", 0, 0);
    var_3a9e259605bd2fd9 hide();
    var_3a9e259605bd2fd9 notsolid();
    var_1446c6e912a6d70a = namespace_4164bc931714b00b::spawn_script_model(var_faedb78b180470ac, "jup_zm_rift_gate_red", 0, 0);
    var_1446c6e912a6d70a hide();
    var_1446c6e912a6d70a notsolid();
    var_87a4ed8f49baa87f = [];
    while (1) {
        level.var_4edc95894f8a7541 = getplayersinradius(var_faedb78b180470ac.origin, 1200, 1200);
        foreach (player in level.var_4edc95894f8a7541) {
            if (!array_contains(var_87a4ed8f49baa87f, player)) {
                var_3a9e259605bd2fd9 function_af96f7c8819ae854(player, 1200);
                var_1446c6e912a6d70a function_af96f7c8819ae854(player, 1200);
                if (istrue(function_8442cf03b10a3296(player))) {
                    player thread function_f6e92750f5fa5c30(var_faedb78b180470ac);
                } else if (isdefined(player.var_f9faff3d5230e3ce)) {
                ...
                } else if (function_4f2ca4a6d9d60f81(player)) {
                    params = spawnstruct();
        ...
        foreach (var_624ee73c0046cf6 in var_87a4ed8f49baa87f) {
            ...
            if (isdefined(var_624ee73c0046cf6) && !array_contains(level.var_4edc95894f8a7541, var_624ee73c0046cf6)) {
                var_624ee73c0046cf6 thread function_bcd7ba129ebfbfb0(var_faedb78b180470ac);
                player function_bab9acc2cf205a62();
                if (isdefined(player.var_f9faff3d5230e3ce)) {
                    var_9b0dd04874627a99 = player namespace_ca7b90256548aa40::function_5a009fe17f688c92();
                    foreach (var_c0c0df46978788e1 in var_9b0dd04874627a99) {
                        if (utility::array_contains(level.var_4edc95894f8a7541, var_c0c0df46978788e1)) {
        ...
        var_87a4ed8f49baa87f = level.var_4edc95894f8a7541;
        wait(0.5);
    }
}
...
// Size: 0xe2
function function_f6e92750f5fa5c30(var_faedb78b180470ac) {
    self endon("death_or_disconnect");
    while (istrue(self.var_ef36152f8d3d0f78)) {
        wait(0.2);
    }
    self.var_ef36152f8d3d0f78 = 1;
    var_faedb78b180470ac.var_4a3fdaa52712dd55 hidefromplayer(self);
    if (isdefined(self.var_a20bb623ab5f6211)) {
    ...
    if (isdefined(self.var_a20bb623ab5f6211)) {
        ...
        if (istrue(self.var_7c4a2519f7b89e16)) {
            function_46df852b6f79b0ee([0:self], 1, 1, 0);
        } else if (istrue(self.var_9b65365d9058829d)) {
            function_46df852b6f79b0ee([0:self], 0, 1, 0);
        }
    }
    wait(2);
    self.var_ef36152f8d3d0f78 = undefined;
...
// Size: 0x101
function function_bcd7ba129ebfbfb0(var_faedb78b180470ac) {
    self endon("death_or_disconnect");
    while (istrue(self.var_ef36152f8d3d0f78)) {
        wait(0.25);
    }
    self.var_ef36152f8d3d0f78 = 1;
    var_faedb78b180470ac.var_4a3fdaa52712dd55 showtoplayer(self);
    if (istrue(function_8442cf03b10a3296(self))) {
        if (isdefined(self.var_a20bb623ab5f6211)) {
    ...
    if (isdefined(self.var_a20bb623ab5f6211)) {
        self.var_a20bb623ab5f6211 setscriptablepartstate("reveal", "reveal_out");
        if (istrue(self.var_7c4a2519f7b89e16)) {
            function_46df852b6f79b0ee([0:self], 1, 0, 0);
            self.var_7c4a2519f7b89e16 = 1;
        } else if (istrue(self.var_9b65365d9058829d)) {
            function_46df852b6f79b0ee([0:self], 0, 0, 0);
...
// Size: 0x1ad
function function_e51836f1240c2b7a(var_faedb78b180470ac) {
    self endon("death_or_disconnect");
    self.var_ef36152f8d3d0f78 = 1;
    var_faedb78b180470ac.var_4a3fdaa52712dd55 hidefromplayer(self);
    ...
    foreach (var_8f082407384af045 in var_faedb78b180470ac.var_39cfa415b2be8156) {
        var_8f082407384af045.var_76d4bd67b47250bf showtoplayer(self);
        var_8f082407384af045.var_8844fd8bc5739789 hidefromplayer(self);
    }
    wait(0.5);
    if (!isdefined(self.var_a20bb623ab5f6211)) {
        self.var_a20bb623ab5f6211 = namespace_4164bc931714b00b::spawn_script_model(var_faedb78b180470ac, "jup_zm_rift_gate", 1, 1);
    ...
    if (isdefined(var_faedb78b180470ac.var_38b605adf8e926c8)) {
        var_faedb78b180470ac.var_38b605adf8e926c8 setscriptablepartstate("formation_vfx", "active");
    }
    wait(6.5);
    if (isdefined(self.var_a20bb623ab5f6211)) {
        self.var_a20bb623ab5f6211 showonlytoplayer(self);
    ...
    if (isdefined(var_faedb78b180470ac.var_38b605adf8e926c8)) {
        var_faedb78b180470ac.var_38b605adf8e926c8 setscriptablepartstate("formation_vfx", "off");
    }
...
// Size: 0x119
function function_1df61ac1719b72b8(var_faedb78b180470ac, var_6a6601f4d2fb4a0a) {
    foreach (var_a2e14ff9766e1b19 in var_faedb78b180470ac.var_a489feecfa0a74) {
        var_a2e14ff9766e1b19.interact = spawnscriptable("ob_jup_rift_gate_interact", var_a2e14ff9766e1b19.origin, var_a2e14ff9766e1b19.angles);
        var_a2e14ff9766e1b19.interact setscriptablepartstate("interact", "usable");
        namespace_5775ad2badedbcaa::function_32645103f7520635(var_a2e14ff9766e1b19.interact, var_6a6601f4d2fb4a0a);
        var_a2e14ff9766e1b19.interact.var_faedb78b180470ac = var_faedb78b180470ac;
        var_a2e14ff9766e1b19.interact.script_label = var_a2e14ff9766e1b19.script_label;
        var_a2e14ff9766e1b19.interact namespace_5775ad2badedbcaa::function_e6c63f16f2258b80(&function_19897beec827855e);
        var_faedb78b180470ac.var_d1e2ce25ea15c51d = [];
    }
}
...
function function_19897beec827855e(interact, player) {
    if (function_2d8949ba915fa2b7(interact, player)) {
        if (interact.var_faedb78b180470ac.var_d1e2ce25ea15c51d.size) {
            var_9b0dd04874627a99 = player namespace_ca7b90256548aa40::function_5a009fe17f688c92();
            foreach (info in interact.var_faedb78b180470ac.var_d1e2ce25ea15c51d) {
                if (array_contains(var_9b0dd04874627a99, info.player)) {
        ...
        var_65b695f0c0d909ed = player namespace_feea61bc660e9e0f::function_4776284a348ebb6a(lootid);
...
function function_2d8949ba915fa2b7(interact, player) {
    if (issubstr(interact.var_faedb78b180470ac.targetname, "s1") && function_8442cf03b10a3296(player) == 1) {
        return 1;
    }
    return 0;
}
...
function function_6932962f514cd776(player) {
    var_32a6f9b3d487152d = namespace_41957062447a88fe::function_553a690e1064cf0b(player);
    foreach (var_b2941d08f576eb6c in var_32a6f9b3d487152d) {
        var_6965880b974574a6 = var_b2941d08f576eb6c.var_fb5fdfafc29f4513;
        var_e6013eac45290cab = namespace_4faa6169000e657c::function_1f3e343912ae15c5(var_6965880b974574a6);
        var_c8992e431d7ba2c8 = namespace_4fda5d7358015a06::function_511be8bcaede8b52(var_e6013eac45290cab);
...
// Size: 0x528
function function_a7a66cb92f56ae54(var_faedb78b180470ac, var_9b0dd04874627a99, player) {
    e_sound = namespace_4164bc931714b00b::spawn_script_model(var_faedb78b180470ac, "tag_origin", 0, 0);
    ...
    foreach (var_8f082407384af045 in var_faedb78b180470ac.var_39cfa415b2be8156) {
        if (isdefined(var_8f082407384af045.var_8844fd8bc5739789)) {
            foreach (var_c0c0df46978788e1 in var_9b0dd04874627a99) {
                playfxontagforclients(level._effect["rift_pedestal_active_" + var_8f082407384af045.targetname], var_8f082407384af045.var_8844fd8bc5739789, "tag_origin", var_c0c0df46978788e1);
            }
        }
    }
    thread namespace_446fc987a980892f::function_d87d5deb069bf8e5("quest_s1_rift_gate_unlock_gate_formation", var_9b0dd04874627a99, 0.75);
    if (isdefined(e_sound)) {
        foreach (var_6a618adae1a18129 in var_9b0dd04874627a99) {
            var_6a618adae1a18129 playsoundtoplayer("evt_rr_gate_form_preamble", var_6a618adae1a18129, e_sound);
        }
    }
    wait(5);
    while (istrue(var_faedb78b180470ac.var_6188ee921621bc1)) {
        wait(0.25);
    }
    var_faedb78b180470ac.var_6188ee921621bc1 = 1;
    foreach (var_6a618adae1a18129 in var_9b0dd04874627a99) {
        if (isdefined(var_6a618adae1a18129) && isdefined(e_sound)) {
            var_6a618adae1a18129 playsoundtoplayer("evt_rr_gate_form_start", var_6a618adae1a18129, e_sound);
        }
    }
    foreach (var_c0c0df46978788e1 in var_9b0dd04874627a99) {
        if (isdefined(var_c0c0df46978788e1) && isalive(var_c0c0df46978788e1)) {
            var_c0c0df46978788e1.var_f9faff3d5230e3ce = undefined;
            var_c0c0df46978788e1 thread function_e51836f1240c2b7a(var_faedb78b180470ac);
        }
    }
    wait(8);
    foreach (var_c0c0df46978788e1 in var_9b0dd04874627a99) {
        if (isdefined(var_c0c0df46978788e1) && isalive(var_c0c0df46978788e1)) {
            var_c0c0df46978788e1 thread namespace_44abc05161e2e2cb::showsplash("ob_rift_portal_opened", undefined, undefined, undefined, 1, "splash_list_jup_ob");
        }
    }
    foreach (var_8f082407384af045 in var_faedb78b180470ac.var_39cfa415b2be8156) {
        if (isdefined(var_8f082407384af045.var_8844fd8bc5739789)) {
            foreach (var_c0c0df46978788e1 in var_9b0dd04874627a99) {
                if (isdefined(var_c0c0df46978788e1)) {
                    stopfxontagforclients(level._effect["rift_pedestal_active_" + var_8f082407384af045.targetname], var_8f082407384af045.var_8844fd8bc5739789, "tag_origin", var_c0c0df46978788e1);
                }
            }
        }
    }
    ...
    var_faedb78b180470ac.var_6188ee921621bc1 = undefined;
    if (issubstr(var_faedb78b180470ac.targetname, "s1")) {
        utility::flag_waitopen("s1_gate_battle_active");
        function_2256e0d4bc38c360(var_faedb78b180470ac, var_9b0dd04874627a99);
    }
}
...
// Size: 0x200
function function_b83ca58b862b27e9(var_9b0dd04874627a99, var_f0467a62f52ac9d6) {
    n_time_limit = 10;
    ...
    while (timer.var_84ceb983b1ef5f11 != 1) {
        ...
        foreach (var_c0c0df46978788e1 in var_9b0dd04874627a99) {
            if (isalive(var_c0c0df46978788e1)) {
    ...
    var_9b0dd04874627a99 = utility::array_removeundefined(var_9b0dd04874627a99);
    foreach (player in var_9b0dd04874627a99) {
    ...
    wait(5);
    var_9b0dd04874627a99 = utility::array_removeundefined(var_9b0dd04874627a99);
    namespace_cddd3ad399b210ff::function_e229d89e0c38206d(var_9b0dd04874627a99, playlistid);
    wait(5);
    function_46df852b6f79b0ee(var_9b0dd04874627a99, var_f0467a62f52ac9d6, 0);
    wait(5);
    var_9b0dd04874627a99 = utility::array_removeundefined(var_9b0dd04874627a99);
    foreach (player in var_9b0dd04874627a99) {
        level thread namespace_36f464722d326bbe::fadetoblackforplayer(player, 0, 0.1);
        player namespace_1cd9f6896754adb0::function_c9d0b43701bdba00("rift_gate_teleport");
    }
}
...
function function_9075c9a5985b8ac0(player) {
    ...
    } else if (getdvarint(@"hash_abc1d9ea495ec189", 0) == 1) {
...
function private function_4986d8866a8ff66f(params) {
    ...
    v_spawn = self.var_8f082407384af045.origin + anglestoup(self.var_8f082407384af045.angles) * 38;
    ...
    foreach (index, item in self.contents) {
        ...
        var_95ad7ae43ca54e24 = array_contains(self.var_faedb78b180470ac.var_3fa0ceb5fb31d6b, item.lootid);
        ...
        if (!isdefined(var_20cd5ad23d2171c0) && var_95ad7ae43ca54e24 && !istrue(var_a182c34120b242d6) && !istrue(var_561e6991ddb5c545)) {
            ...
            var_20cd5ad23d2171c0 = self.contents[index];
            var_5f598218fed720bd = var_fbe755f0978c0369;
        } else {
            itembundle = getscriptbundle("itemspawnentry:" + var_fbe755f0978c0369);
            itembundle.spawncount = item.quantity;
            var_bb1364c9d2f4a253 = namespace_2abc885019e1956::function_c465d27f3f6066b4(itembundle, v_spawn, self.var_8f082407384af045.angles, 0, 0, payload);
        }
    }
    self.contents = [];
    if (isdefined(var_20cd5ad23d2171c0)) {
        ...
        var_cb775ae4dc5e3a78 = spawnstruct();
        var_cb775ae4dc5e3a78.lootid = 0;
        var_cb775ae4dc5e3a78.quantity = 0;
        self.contents[0] = var_cb775ae4dc5e3a78;
    }
    if (isdefined(self.var_745e910fb84e7971) && !istrue(var_561e6991ddb5c545)) {
        ...
        foreach (var_c0c0df46978788e1 in var_9b0dd04874627a99) {
            self.var_8f082407384af045.var_76d4bd67b47250bf showtoplayer(var_c0c0df46978788e1);
            self.var_8f082407384af045.var_8844fd8bc5739789 hidefromplayer(var_c0c0df46978788e1);
        }
    }
    if (istrue(var_a182c34120b242d6) && isdefined(var_5f598218fed720bd)) {
        ...
        item = namespace_2abc885019e1956::function_c465d27f3f6066b4(itembundle, v_spawn, self.var_8f082407384af045.angles, 1, 1, payload);
        item.var_695427780354d0e5 = 1;
        item.var_8f082407384af045 = self.var_8f082407384af045;
        item.var_78c6788452f8744f = self;
        self.var_745e910fb84e7971 = item;
        var_f8431b01820e31a8 = function_69ce7040cf0dea2d(var_5f598218fed720bd, self.var_8f082407384af045.targetname);
        ...
        foreach (var_2fe316433061a45f in level.players) {
            ...
            if (array_contains(var_9b0dd04874627a99, var_2fe316433061a45f)) {
                if (!isdefined(item.var_d1c37d94e5043730)) {
                    ...
                    thread function_dc5d83d97e8f9e9c(item, var_5f598218fed720bd, var_9b0dd04874627a99, player);
                }
                if (istrue(var_f8431b01820e31a8)) {
                    self setscriptablepartstate("audio", "active_" + self.var_8f082407384af045.targetname);
                    self.var_8f082407384af045.var_8844fd8bc5739789 showtoplayer(var_2fe316433061a45f);
                    self.var_8f082407384af045.var_76d4bd67b47250bf hidefromplayer(var_2fe316433061a45f);
                }
            }
        }
        if (istrue(var_f8431b01820e31a8) && function_edbd89f85d943b54(self.var_faedb78b180470ac, var_9b0dd04874627a99, player)) {
            level thread function_a7a66cb92f56ae54(self.var_faedb78b180470ac, var_9b0dd04874627a99, player);
            foreach (var_c0c0df46978788e1 in var_9b0dd04874627a99) {
                if (isdefined(var_c0c0df46978788e1) && isalive(var_c0c0df46978788e1)) {
                    var_c0c0df46978788e1 namespace_9dcaa84266dc73e2::function_f10f600ac4ee4c09("s1_rift_gate_unlock", 2);
                    var_c0c0df46978788e1.var_f618a05d316a2fd6 = 1;
                    function_9075c9a5985b8ac0(var_c0c0df46978788e1);
                }
            }
        }
    }
...
function private function_69ce7040cf0dea2d(str_item_name, var_cfd12438a6b9f610) {
    var_705b48909b86734c = [0:"toxic_attuned", 1:"electric_attuned", 2:"fire_attuned", 3:"ice_attuned"];
    foreach (var_7c322e9f4dc91fab in var_705b48909b86734c) {
        if (issubstr(str_item_name, var_7c322e9f4dc91fab) && issubstr(var_7c322e9f4dc91fab, var_cfd12438a6b9f610)) {
            return 1;
        }
    }
    return 0;
...
// Size: 0xb3
function private function_edbd89f85d943b54(var_faedb78b180470ac, var_9b0dd04874627a99, player) {
    var_4c283a74215ab2a4 = 0;
    a_info = [];
    foreach (interact in player.var_f9faff3d5230e3ce) {
        if (isdefined(interact.var_8a88f9de72798219) && istrue(interact.var_8a88f9de72798219.var_f8431b01820e31a8)) {
            var_4c283a74215ab2a4++;
        }
    }
    return var_4c283a74215ab2a4 > 3;
}
...
// Size: 0xed
function private function_a0856378b9181a73(var_faedb78b180470ac, var_421f1da1a7cf188f) {
    var_faedb78b180470ac.var_3fa0ceb5fb31d6b = [];
    var_942a8a17d8a96a46 = getscriptbundle("itemspawnlist:" + var_421f1da1a7cf188f);
    foreach (var_74ddc601a0fcaaa2 in var_942a8a17d8a96a46.var_9fdd81c7fdbb8ed2) {
        ...
        if (isdefined(itembundle)) {
            ...
            if (isdefined(lootid)) {
                var_faedb78b180470ac.var_3fa0ceb5fb31d6b = array_add(var_faedb78b180470ac.var_3fa0ceb5fb31d6b, lootid);
            }
        }
    }
}
...
function private function_b77c1cb2bc83c76e(player, var_bb3bd4b73cb79c9b) {
    ...
    var_342175a1b9f9067e = player namespace_feea61bc660e9e0f::function_1b35b10884bd8d67();
    for (i = 0; i < var_342175a1b9f9067e; i++) {
        var_eeeae9defa0c1e95 = player namespace_feea61bc660e9e0f::function_d870b2c45335bd88(i);
        if (array_contains(var_bb3bd4b73cb79c9b, var_eeeae9defa0c1e95)) {
            var_f6898e71aa21712a = array_add(var_f6898e71aa21712a, var_eeeae9defa0c1e95);
        }
    }
...
function private function_977fba46aefad325(player) {
    var_62a64448ed74837b = player.var_9c6168187b815669;
    if (isdefined(var_62a64448ed74837b)) {
        thread function_e18193b66acde129(var_62a64448ed74837b, player);
    }
}
...
// Size: 0x3fc
function private function_e18193b66acde129(var_62a64448ed74837b, player) {
    player endon("death_or_disconnect");
    player forceplaygestureviewmodel("jup_ges_open_portal");
    player playsound("fly_player_activate_portal");
    var_88234437d3758ed8 = namespace_2abc885019e1956::function_fc925a153c7fd55c(var_62a64448ed74837b);
    var_f0467a62f52ac9d6 = issubstr(var_88234437d3758ed8, "low");
    var_9b0dd04874627a99 = player namespace_ca7b90256548aa40::function_5a009fe17f688c92();
    foreach (var_c0c0df46978788e1 in var_9b0dd04874627a99) {
        if (!isdefined(var_c0c0df46978788e1.var_a20bb623ab5f6211)) {
            var_e075f39c1003cdcb = namespace_4164bc931714b00b::spawn_script_model(self.var_faedb78b180470ac, "jup_zm_rift_gate", 1, 1);
            break;
        }
    }
    if (isdefined(var_e075f39c1003cdcb)) {
        ...
        foreach (var_c0c0df46978788e1 in var_9b0dd04874627a99) {
            var_e075f39c1003cdcb function_af96f7c8819ae854(var_c0c0df46978788e1, 2000);
        }
    }
    wait(0.5);
    /#
        if (getdvarint(@"hash_ab8c82aa304547b", 0)) {
            function_2256e0d4bc38c360(self.var_faedb78b180470ac, var_9b0dd04874627a99);
            return;
        }
    #/
    var_1a92db52accd1108 = {player:player};
    self.var_faedb78b180470ac.var_d1e2ce25ea15c51d = array_add(self.var_faedb78b180470ac.var_d1e2ce25ea15c51d, var_1a92db52accd1108);
    if (isdefined(player.var_a20bb623ab5f6211)) {
    ...
    if (isdefined(var_e075f39c1003cdcb)) {
        foreach (var_c0c0df46978788e1 in var_9b0dd04874627a99) {
            if (!isdefined(var_c0c0df46978788e1.var_a20bb623ab5f6211)) {
                self.var_faedb78b180470ac.var_4a3fdaa52712dd55 hidefromplayer(var_c0c0df46978788e1);
                var_e075f39c1003cdcb showtoplayer(var_c0c0df46978788e1);
            }
        }
        var_e075f39c1003cdcb setscriptablepartstate("reveal", "reveal_in");
    }
    function_46df852b6f79b0ee(var_9b0dd04874627a99, var_f0467a62f52ac9d6, 1, 1, var_e075f39c1003cdcb);
    b_success = namespace_6c57c664b4288f88::function_93c8f90c3bd798c6(player, 30);
    self.var_faedb78b180470ac.var_d1e2ce25ea15c51d = array_remove(self.var_faedb78b180470ac.var_d1e2ce25ea15c51d, var_1a92db52accd1108);
    if (b_success == 1) {
        b_valid = player namespace_feea61bc660e9e0f::function_181a584e4a68d5d6(var_62a64448ed74837b);
        player.var_9c6168187b815669 = undefined;
        if (b_valid) {
            level thread function_b83ca58b862b27e9(var_9b0dd04874627a99, var_f0467a62f52ac9d6);
        ...
        function_46df852b6f79b0ee(var_9b0dd04874627a99, var_f0467a62f52ac9d6, 0, 1, var_e075f39c1003cdcb);
        if (isdefined(var_e075f39c1003cdcb)) {
            var_e075f39c1003cdcb setscriptablepartstate("reveal", "reveal_out");
            foreach (var_c0c0df46978788e1 in var_9b0dd04874627a99) {
                if (isdefined(var_c0c0df46978788e1) && !isdefined(var_c0c0df46978788e1.var_a20bb623ab5f6211)) {
                    self.var_faedb78b180470ac.var_4a3fdaa52712dd55 showtoplayer(var_c0c0df46978788e1);
                }
            }
        }
        wait(5);
...
// Size: 0x1f9
function private function_2256e0d4bc38c360(var_faedb78b180470ac, var_9b0dd04874627a99) {
    utility::flag_set("s1_gate_battle_active");
    wait(2.5);
    function_46df852b6f79b0ee(var_9b0dd04874627a99, 1);
    v_spawn = getclosestpointonnavmesh(var_faedb78b180470ac.var_e10a98520809d260.origin);
    wait(6);
    var_31109020393ed11b = namespace_53fc9ddbb516e6e1::function_19bdf2273a632cd1("zombie_abom_mega_hvt")[0];
    var_683f14b23771a4ff = namespace_53fc9ddbb516e6e1::function_e35ca5d86a181d6a(var_31109020393ed11b, v_spawn, var_faedb78b180470ac.var_e10a98520809d260.angles, "team_two_hundred");
    var_683f14b23771a4ff thread function_35e8a48dc2442eb2(var_9b0dd04874627a99, var_faedb78b180470ac.s_reward.origin);
    thread namespace_446fc987a980892f::function_d87d5deb069bf8e5("quest_s1_rift_gate_unlock_megabom_spawn", var_9b0dd04874627a99, 1);
    wait(2.5);
    encounterid = namespace_614554f86e52695c::function_54da428ad4a96f2e("ai_flood_fill_encounter:enc_ob_rift_gate_flood", var_faedb78b180470ac.var_e10a98520809d260.origin, 350, 1, 1, 0);
    level thread function_7da3c5c759a69cf3();
    var_683f14b23771a4ff thread function_4c7d81204b9467a8(var_faedb78b180470ac);
    ...
    function_46df852b6f79b0ee(var_9b0dd04874627a99, 1, 0);
    wait(1);
    var_2c06da1b550fc8fb = [];
    foreach (player in var_9b0dd04874627a99) {
        var_2c06da1b550fc8fb[var_2c06da1b550fc8fb.size] = [0:player];
    }
    thread namespace_446fc987a980892f::function_d87d5deb069bf8e5("quest_s1_rift_gate_unlock_megabom_kill", var_9b0dd04874627a99, 2.5);
    namespace_e8853d3344e33cf6::function_863be9e39e19fe2f(var_2c06da1b550fc8fb, var_faedb78b180470ac.s_reward, &function_90db22df3aa5cf66);
}
...
// Size: 0x45
function private function_4c7d81204b9467a8(var_faedb78b180470ac) {
    self endon("death");
    while (distancesquared(self.origin, var_faedb78b180470ac.origin) < squared(2000)) {
        wait(1);
    }
    self kill();
}
...
// Size: 0xd6
function private function_35e8a48dc2442eb2(a_players, var_aa5beec3bd7182ce) {
    self endon("death");
    namespace_1cd9f6896754adb0::set("rift_gate_battle", "ignoreall", 1);
    wait(1.5);
    self setgoalpos(var_aa5beec3bd7182ce, 32);
    wait(1.5);
    utility::ent_flag_clear("can_bull_charge_off_ledge");
    namespace_1cd9f6896754adb0::reset("rift_gate_battle", "ignoreall");
...
function private function_90db22df3aa5cf66(params) {
    var_96ff2e206655a1d3 = spawnstruct();
    var_96ff2e206655a1d3.lootid = namespace_2abc885019e1956::function_2c836ad05e5f634c("jup_rift_gate_key_token_low");
    var_96ff2e206655a1d3.quantity = 1;
    return [0:var_96ff2e206655a1d3];
}
