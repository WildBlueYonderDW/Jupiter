...
function init(config) {
    ...
    eventinfo.var_b9b56551e1acfee2 = namespace_c711384b1335919::function_8be9bae8228a91f7("auavscan");
    scripts/mp/gametypes/br_publicevents::function_5b7d8ca93f8705f1(eventinfo, "auavscan");
    scripts/mp/gametypes/br_publicevents::registerpublicevent(9, eventinfo);
...
function debug_init() {
    /#
        scripts/common/devgui::function_6e7290c8ee4f558b("ui_publicevent_timer_type");
        scripts/common/devgui::function_a9a864379a098ad6("death", "<unknown string>", &function_db70bae7732f5204);
...
function function_db70bae7732f5204() {
    /#
        level thread scripts/mp/gametypes/br_publicevents::function_e37ee072d95a7c98(9);
    #/
}
