    ...
    while (true) {
        ...
        if (isdefined(trace["entity"]) && trace["hittype"] == "hittype_entity") {
            if (isplayer(trace["entity"]) && isdefined(trace["entity"].guid)) {
                ...
                /#
                    printtoscreen2d(50, 50, "<dev string:x39f>", (1, 0, 0));
                #/
                currenttime = gettime();
    ...
    while (true) {
        ...
        if (distance <= 200) {
            ...
            if (!info.size || !isdefined(info[0]["hittype"])) {
                ...
                /#
                    sphere(info[0]["<dev string:x3ad>"], 10);
                #/
            }
    ...
    function function_7b91bc1947716bcf() {
        ...
        while (true) {
            ...
            if (getdvarint(@"hash_7b8ff4311d323400", 0)) {
                ...
                function_a9f8fa06a358585b(level.players[0].team, "<dev string:x3c1>", 0, "<dev string:x3c9>", 0);
            }
            if (getdvarint(@"hash_20b0905187d34da1", 0)) {
                setdvar(@"hash_20b0905187d34da1", 0);
                function_a9f8fa06a358585b(level.players[0].team, "<dev string:x3c1>", 1, "<dev string:x3c9>", 0);
            }
            debugstring = getdvar(@"hash_a1eb1e43fb0a9af1", "<dev string:x3d4>");
            switch (debugstring) {
            ...
            case #"hash_af2000093a54848e": 
                ...
                foreach (player in level.players) {
                    radio = spawnscriptable("<dev string:x403>", player.origin);
                    radio.origin = drop_to_ground(radio.origin);
                }
            default: 
                break;
            }
            setdvar(@"hash_a1eb1e43fb0a9af1", "<dev string:x3d4>");
            wait 1;
        }
    }
