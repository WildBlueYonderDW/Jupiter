    ...
    while (opener activatekeypressed() && isContainerOpen(opener) && currentindex < 11 && isreallyalive(opener) && !isContainerEmpty(container, opener)) {
        if (isvalidslot(opener, container, currentindex)) {
            ...
            if (scripts\mp\gametypes\br_pickups::function_b989edd9af4f42c7(scriptablename) || scripts\mp\gametypes\br_pickups::function_d7c5786a0c42ef6c(scriptablename)) {
                ...
                var_ccc0df5641a7616b = namespace_aead94004cf4c147::getPlayerBackpackSize(opener);
...
function closeLootableContainer(container, opener) {
    ...
    if (isContainerEmpty(container, opener)) {
        ...
        if (isreallyalive(opener) && istrue(container.loadoutcontainer) && isdefined(container.contents) && container.contents.size > 0) {
            ...
            if (!(container.itemtype == 6 && istrue(self.var_ca27f3fd3dad0c1f))) {
                ...
                namespace_8beea18646ea4c36::resetGasMaskRemovalDelay();
            }
...
function function_f0617ad70b7e7792(containerslot, backpackslot, container) {
    ...
    if (istrue(self.var_ca27f3fd3dad0c1f) && container.itemtype == 6) {
        fakepickup.count = namespace_8beea18646ea4c36::function_5109f3947b0c7dfb("gas_mask", self);
    }
    ...
    if (var_ab2190c9f802c652) {
        ...
        if (isdefined(container.perks)) {
            var_c017366249a45806 = scripts\mp\gametypes\br_pickups::function_b29b252cdfa9a7d6(container.perks);
            var_99d72c999b9a85fa = var_c017366249a45806[1];
            quantity = var_c017366249a45806[0];
        }
        ...
        var_c017376249a45a39 = namespace_85cd45b4fe0d86fb::getDogTagVictimAndKiller(containerquantity);
        _ = var_c017376249a45a39[1];
        victimindex = var_c017376249a45a39[0];
        dogtagowner = level.dogTagInfo[victimindex].player;
        if (isdefined(dogtagowner)) {
...
function function_e183b2e94298bb75(loadoutindex, player, container, itemtype) {
    ...
    var_c01bc46249a98627 = function_775a7fc396485a9a(player, container);
    _ = var_c01bc46249a98627[6];
    _ = var_c01bc46249a98627[5];
    quantity = var_c01bc46249a98627[4];
    metadata = var_c01bc46249a98627[3];
    pastteam = var_c01bc46249a98627[2];
    weaponslotobj = var_c01bc46249a98627[1];
    lootid = var_c01bc46249a98627[0];
    if (!isdefined(weaponslotobj)) {
        return;
    }
...
function function_68ca06034b8aaccd(opener, container) {
    var_c01bc36249a983f4 = function_438749eb7a7b738(container.contents, opener, container);
    lastvalidindex = var_c01bc36249a983f4[1];
    items = var_c01bc36249a983f4[0];
    container.contents = items;
