...
function function_60a8777312cc62d7(player) {
    ...
    if (!isdefined(focusedactivity)) {
        println("<dev string:x1c>" + "<dev string:x79>" + "<dev string:xcc>");
        return;
    }
...
/#
    ...
    function private function_26b72cfbd71e82f(activityinstance, player) {
        ...
        println("<dev string:x205>" + "<dev string:x227>" + function_de53ed8e35d0ed7a(activityinstance) + "<dev string:x23c>" + function_a4748b32a824c79c(activityinstance) + "<dev string:x249>" + var_45a14dd1749cb60c + "<dev string:x256>" + squadmates.size + "<dev string:x264>");
    }
    ...
    function private function_fc57b4e33ab348a4(activityinstance, player) {
        println("<dev string:x273>" + "<dev string:x227>" + function_de53ed8e35d0ed7a(activityinstance) + "<dev string:x23c>" + function_a4748b32a824c79c(activityinstance) + "<dev string:x29b>" + player.sessionsquadid + "<dev string:x2a4>");
    }
    ...
    function private function_a03ac72779102a0d(activityinstance, player) {
        squadmates = function_37ffb7a5350616ca(player);
        var_45a14dd1749cb60c = function_287b76a301747f8b(activityinstance, player);
        println("<dev string:x2c0>" + "<dev string:x227>" + function_de53ed8e35d0ed7a(activityinstance) + "<dev string:x23c>" + function_a4748b32a824c79c(activityinstance) + "<dev string:x249>" + var_45a14dd1749cb60c + "<dev string:x256>" + squadmates.size + "<dev string:x264>");
    }
    ...
    function private function_3408f40ca8f1c14d(activityinstance, player) {
        squadmates = function_37ffb7a5350616ca(player);
        var_45a14dd1749cb60c = function_287b76a301747f8b(activityinstance, player);
        println("<dev string:x2f9>" + "<dev string:x227>" + function_de53ed8e35d0ed7a(activityinstance) + "<dev string:x23c>" + function_a4748b32a824c79c(activityinstance) + "<dev string:x249>" + var_45a14dd1749cb60c + "<dev string:x256>" + squadmates.size + "<dev string:x264>");
    }
    ...
    function function_781d567ca3db5852() {
        function_6e7290c8ee4f558b("<dev string:x330>");
        function_a9a864379a098ad6("<dev string:x353>", "<dev string:x374>", &function_5f5e9bf7fe8e6eaf);
        function_a9a864379a098ad6("<dev string:x396>", "<dev string:x3be>", &function_6017dcd09f997b8);
        function_fe953f000498048f();
        function_6e7290c8ee4f558b("<dev string:x3e3>");
        function_a9a864379a098ad6("<dev string:x41b>", "<dev string:x431>", &function_d822738c9392a3a4);
        function_a9a864379a098ad6("<dev string:x445>", "<dev string:x374>", &function_5f5e9bf7fe8e6eaf);
        function_a9a864379a098ad6("<dev string:x46d>", "<dev string:x49f>", &function_20715510ce25c247);
        function_a9a864379a098ad6("<dev string:x4ce>", "<dev string:x500>", &function_20715610ce25c47a);
        function_a9a864379a098ad6("<dev string:x52f>", "<dev string:x561>", &function_20715710ce25c6ad);
        function_a9a864379a098ad6("<dev string:x590>", "<dev string:x5b2>", &function_3f8bf4c34fe29837);
        function_a9a864379a098ad6("<dev string:x5c9>", "<dev string:x5eb>", &function_3f8bf5c34fe29a6a);
        function_a9a864379a098ad6("<dev string:x602>", "<dev string:x624>", &function_3f8bf6c34fe29c9d);
        function_a9a864379a098ad6("<dev string:x63b>", "<dev string:x662>", &function_602310868171d271);
        function_a9a864379a098ad6("<dev string:x677>", "<dev string:x69f>", &function_e30f9ce33ee435dc);
        function_fe953f000498048f();
        function_6e7290c8ee4f558b("<dev string:x6b5>");
        function_a9a864379a098ad6("<dev string:x6ec>", "<dev string:x71e>", &_info);
        function_a9a864379a098ad6("<dev string:x445>", "<dev string:x374>", &function_5f5e9bf7fe8e6eaf);
        function_a9a864379a098ad6("<dev string:x724>", "<dev string:x74d>", &function_da02cb35301e149c);
        function_a9a864379a098ad6("<dev string:x777>", "<dev string:x7a0>", &function_da02ce35301e1b35);
        function_a9a864379a098ad6("<dev string:x7ca>", "<dev string:x7f3>", &function_da02cd35301e1902);
        function_fe953f000498048f();
    }
    ...
    function private function_d822738c9392a3a4() {
        ...
        iprintlnbold("<dev string:x854>" + var_15aaab03bcacac6b + "<dev string:x85b>");
    }
