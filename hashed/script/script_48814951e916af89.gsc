...
function ai_mp_requestspawnagent(agenttype, groundspawnorigin, spawnangles, priority, category, subcategory, groupname, team, destination, poiname, skipstealth, var_5a6a87fa3f95753f, var_5f0c541b305bf851, var_80f4bde7090a4773, forcedormant, subarea, threatbiasgroup) {
    ...
    /#
        if (isdefined(poiname) && scripts/mp/poi::function_47d356083884f913()) {
            /#
                assert(scripts/mp/poi::poi_ispoiactive(poiname), "patrolPath_Fortress" + poiname + "poiName");
            #/
        }
    #/
    ...
    /#
        ...
        namespace_d1a9ca87d78d9813::function_9533653868e59fb6("priority_getAllWithPriority: Can only be called on valid priorities, not: ", "minVehicleSpawns" + priority, category + "loop_sounds" + subcategory, undefined, undefined, undefined, poiname, groundspawnorigin);
...
function function_ed108ff3eb578327(var_fcdc7f62624c71ff, tier) {
    ...
    if (isdefined(level.var_3b54adcd8ed5b8c0[var_fcdc7f62624c71ff])) {
        ...
        foreach (index, itemtickets in var_50f2ee11200531a9) {
            totaltickets = totaltickets + itemtickets;
        }
        roll = randomint(totaltickets);
        chancetotal = 0;
        foreach (index, itemtickets in var_50f2ee11200531a9) {
            chancetotal = chancetotal + itemtickets;
            if (roll <= chancetotal) {
                return index;
            }
        }
...
function function_28b90eb2b591003f() {
    /#
        namespace_d1a9ca87d78d9813::function_9533653868e59fb6("<unknown string>", "minVehicleSpawns" + priority_get(self), self.category + "loop_sounds" + self.subcategory, undefined, undefined, undefined, agentpers_getagentpersdata(self, "<unknown string>"), self.origin);
        if (getdvarint(@"hash_bcbe3309344bb6d2", 0) == 1) {
            ...
            print3d(self.origin + (0, 0, 90), "tier3_closet" + priority_get(self), (1, 0, 0), 1, 0.4, 6000);
            ...
            iprintlnbold("<unknown string>" + priority_get(self) + "generic" + self.category + "brloot_offhand_concussion" + self.subcategory);
        }
    #/
...
function function_ae8293438b86ca23() {
    ...
    foreach (spawnpackagemainnode in var_c034726a93bbff6e) {
        ...
        if (!isdefined(subarea)) {
            /#
                if (isdefined(spawnpackagemainnode.poi)) {
                    println("<unknown string>" + spawnpackagemainnode.poi + "<unknown string>");
                    return;
                }
                println("<unknown string>");
            #/
...
function function_359f24553bdcca92(number, priority) {
    ...
    foreach (testpriority in level.var_41670c1c65f3d3cf.var_1d7de2571d2c82a7) {
        ...
        var_944b7bc21500684a = var_944b7bc21500684a + function_44c0059e33f55f00(testpriority).size;
    }
            ...
            if (getdvarint(@"hash_9e9be127028294d2", 0) == 1) {
                ...
                foreach (agent in agents) {
                    if (isdefined(agent) && isagent(agent) && isalive(agent)) {
                        ...
                        print3d(agent.origin + (0, 0, 90), "tier3_closet" + priority_get(agent), (1, 0, 1), 1, 0.4);
...
function function_18076fc4f3fbc0d4() {
    foreach (poiname, poi in level.poi) {
        ...
        foreach (pathstruct in level.poi[poiname]["patrolPaths"]) {
            ...
            if (isdefined(agents)) {
                numtospawn = numtospawn - agents.size;
            }
            if (numtospawn <= 0) {
                break;
            }
...
function function_376608277aa1067c(spawnPackage, var_84ecaeab58167d39, var_9e82f18de5c8c18b, priorityoverride, poiname, subarea) {
    ...
    foreach (pathstruct in spawnPackage.pathstructs) {
        ...
        if (isdefined(agents)) {
            spawnednum = spawnednum + agents.size;
...
function function_9b23664358b0ecc2(reinforcementoptions, var_206197e10a7a9e87) {
    ...
    foreach (index, reinforcementtype in reinforcementoptions) {
        ticketschecked = ticketschecked + var_206197e10a7a9e87[index];
...
function function_e332d48077f00441(poiname) {
    ...
    while (level.var_41670c1c65f3d3cf.poi[poiname].var_9d2f71782a11c15c) {
        ...
        foreach (delaypackage in var_70bcbf0ad5028219) {
            if (istrue(level.var_ba36989c7e24e4ff)) {
                /#
                    println("<unknown string>" + poiname + "<unknown string>" + delaypackage.delaytime);
                #/
            }
...
function function_82ed67ae79913551(agent, agenttype, groupname) {
    ...
    if (!scripts/mp/loot::isContainerEmpty(agent) && var_a31a0baedb971fe5) {
        dropstruct.dropidx = dropstruct.dropidx + 2;
...
function private function_305b1ba9c9b7f7b4(droponground, lootstruct, agent, dropstruct) {
    ...
    droponground = droponground | (level.var_7c24540cb1744ad9 && istrue(lootstruct.var_b30d9f22e554e6ee));
    droponground = droponground | getdvarint(@"hash_142657a7943b806a", 0);
...
function function_4a618b49270cfd25(owner, origin, radius) {
    ...
    for (j = 0; j < var_a3f9130b1d11dffb; j++) {
        var_fa378e997a33a137 = owner scripts/cp_mp/killstreaks/toma_strike::findunobstructedfiringinfo(origin, 1024, var_d77253c873d2b420, ownerforward, ownerright);
        owner thread scripts/cp_mp/killstreaks/toma_strike::tomastrike_firestrike(striketype, var_fa378e997a33a137, streakinfo);
...
function function_bd78689b17ee5ca5(textx, texty, poiname, enabledcolor) {
    /#
        ...
        printtoscreen2d(textx, texty + 20, "<unknown string>", enabledcolor, 1);
        printtoscreen2d(textx, texty + 40, "<unknown string>" + function_abbd4595d76ccc5e(poiname, "<unknown string>"), (0, 0, 1), 1);
        printtoscreen2d(textx, texty + 60, "<unknown string>" + function_abbd4595d76ccc5e(poiname, "<unknown string>"), (0, 1, 1), 1);
        printtoscreen2d(textx, texty + 80, "<unknown string>" + function_abbd4595d76ccc5e(poiname, "<unknown string>"), (1, 0.5, 0), 1);
        printtoscreen2d(textx, texty + 100, "<unknown string>" + function_abbd4595d76ccc5e(poiname, "<unknown string>"), (1, 0, 0), 1);
        printtoscreen2d(textx, texty + 120, "<unknown string>" + function_abbd4595d76ccc5e(poiname, "<unknown string>"), (1, 0, 0), 1);
        printtoscreen2d(textx, texty + 140, "<unknown string>" + function_abbd4595d76ccc5e(poiname, "<unknown string>"), (0, 1, 0), 1);
        printtoscreen2d(textx, texty + 160, "<unknown string>" + function_abbd4595d76ccc5e(poiname, "<unknown string>"), (1, 1, 1), 1);
        printtoscreen2d(textx, texty + 180, "<unknown string>" + function_abbd4595d76ccc5e(poiname, "<unknown string>"), (1, 1, 1), 1);
        printtoscreen2d(textx, texty + 200, "<unknown string>" + function_abbd4595d76ccc5e(poiname, "<unknown string>"), (0, 0, 1), 1);
    #/
}
...
function function_7b85b68e72867306(poiinfo) {
    /#
        ...
        foreach (poiname in level.poi_names) {
            dvarstring = hashcat(@"hash_831b14ba4dbdd316", poiname, "<unknown string>");
            if (getdvarint(dvarstring, 0) == 1 || getdvarint(@"hash_6e6e9391065dc426", 0)) {
                ...
                if (isdefined(level.var_41670c1c65f3d3cf.poi[poiname])) {
                    if (!poiinfo.var_6ad2d5385a612cd5[poiname].outlined) {
                        ...
                        foreach (agent in function_7e3f22e620f3f71e(poiname, "<unknown string>")) {
                            if (isalive(agent)) {
                                ...
                                id = scripts/mp/utility/outline::outlineenableforall(agent, var_4430b08d5a2d47bf, "<unknown string>");
                    ...
                    } else if (poiinfo.var_6ad2d5385a612cd5[poiname].numagents != function_abbd4595d76ccc5e(poiname, "<unknown string>")) {
                        if (poiinfo.var_6ad2d5385a612cd5[poiname].numagents < function_abbd4595d76ccc5e(poiname, "<unknown string>")) {
                            foreach (agent in function_7e3f22e620f3f71e(poiname, "<unknown string>")) {
                        ...
                        poiinfo.var_6ad2d5385a612cd5[poiname].numagents = function_abbd4595d76ccc5e(poiname, "<unknown string>");
                    }
                }
        ...
        if (!aiinfo.disabledoutlines) {
            ...
            foreach (agent in level.agentarray) {
                if (isalive(agent)) {
                    ...
                    id = scripts/mp/utility/outline::outlineenableforall(agent, "<unknown string>", "<unknown string>");
...
function function_8366a665eecd13aa() {
    /#
        ...
        foreach (poiname in level.poi_names) {
            ...
            poiinfo.var_6ad2d5385a612cd5[poiname].numagents = function_abbd4595d76ccc5e(poiname, "<unknown string>");
            setdvarifuninitialized(hashcat(@"hash_831b14ba4dbdd316", poiname, "<unknown string>"), 0);
            wait(0.1);
            command = "<unknown string>" + poiname + "<unknown string>" + poiname + "<unknown string>";
            adddebugcommand(command);
            wait(0.1);
    ...
    /#
        ...
        while (true) {
            if (getdvarint(@"hash_7e32df0ad3c385c1", 0) == 1) {
                ...
                foreach (poiname, poi in level.poi) {
                    setdevdvar(hashcat(@"hash_831b14ba4dbdd316", poiname, "<unknown string>"), 0);
                }
            }
            ...
            if (var_5a77a5f00881f00c == 1) {
                if (!istrue(level.var_289df80e1ded586f)) {
                    ...
                    topxpos = 50;
                    printtoscreen2d(topxpos, 54, "<unknown string>" + function_e884d14c5b07b811(), (0, 0, 1), 2.5);
                    topxpos = topxpos + 250;
                    printtoscreen2d(topxpos, 50, "<unknown string>" + function_e8c0ac958d093ec2() + "<unknown string>" + level.var_41670c1c65f3d3cf.maxagents, (0, 0, 1), 1.5);
                    topxpos = topxpos + 250;
                    printtoscreen2d(topxpos, 50, "<unknown string>" + function_1c0a768a2d940491(), (0, 0, 1), 1.5);
                    topxpos = topxpos + 200;
                    printtoscreen2d(topxpos, 50, "<unknown string>" + function_9368fb9261e4cd0a("priority_set: Can't be called on undefined agents"), (0, 0, 1), 1.5);
                    topxpos = topxpos + 200;
                    printtoscreen2d(topxpos, 50, "<unknown string>" + function_9368fb9261e4cd0a("<unknown string>"), (0, 0, 1), 1.5);
                    topxpos = topxpos + 200;
                    printtoscreen2d(topxpos, 50, "<unknown string>" + level.var_41670c1c65f3d3cf.agentdeaths, (0, 0, 1), 1.5);
                    if (function_47d356083884f913()) {
                        printtoscreen2d(topxpos + 300, 50, "<unknown string>" + level.poi_names.size, (0, 0, 1), 1.5);
                        numlines = 0;
                        x = 50;
                        y = 90;
                        foreach (poiname, poi in level.poi) {
            ...
            if (var_5a77a5f00881f00c == 2) {
                ...
                printtoscreen2d(1050, 50, "<unknown string>" + level.var_41670c1c65f3d3cf.agentdeaths, (0, 0, 1), 1.5);
                if (function_47d356083884f913()) {
                    printtoscreen2d(1300, 50, "<unknown string>" + level.poi_names.size, (0, 0, 1), 1.5);
                    x = 50;
                    y = 90;
                    foreach (poiname, poi in level.poi) {
                        if (array_contains(level.var_ab20b3a256911579, poiname)) {
                ...
                if (!istrue(level.var_289df80e1ded586f)) {
                    ...
                    if (function_47d356083884f913()) {
                        ...
                        foreach (poiname, poi in level.poi) {
                            ...
                            printtoscreen2d(x, pos, "<unknown string>" + level.startracker[poiname].starlevel, color, 1.5);
                            pos = pos + 12;
                            printtoscreen2d(x, pos, "<unknown string>", (0, 0, 1), 1);
                            pos = pos + 16;
                            printtoscreen2d(x, pos, "<unknown string>" + level.startracker[poiname].starmeter, (0, 0, 1), 1);
                            pos = pos + 20;
                            printtoscreen2d(x, pos, "<unknown string>" + level.startracker[poiname].var_924d5d49fde54cdd, (0, 0, 1), 1);
                            pos = pos + 20;
                            printtoscreen2d(x, pos, "<unknown string>", (0, 0, 1), 1);
                            pos = pos + 20;
                            printtoscreen2d(x, pos, "<unknown string>" + level.startracker[poiname].var_19d6896c9e881cc4, (0, 0, 1), 1);
                            pos = pos + 20;
                            ...
                            printtoscreen2d(x, pos, "<unknown string>" + requirements, (0, 0, 1), 1);
                            pos = pos + 20;
                            printtoscreen2d(x, pos, "<unknown string>", (0, 0, 1), 1);
                            pos = pos + 20;
                            printtoscreen2d(x, pos, "<unknown string>" + level.startracker[poiname].var_38951249a8cf8968, (0, 0, 1), 1);
                            pos = pos + 20;
                            printtoscreen2d(x, pos, "<unknown string>" + level.startracker[poiname].var_fe385543116077b5, (0, 0, 1), 1);
                            pos = pos + 20;
                            printtoscreen2d(x, pos, "<unknown string>" + level.startracker[poiname].var_55cf9e4f74d2f4c2, (0, 0, 1), 1);
                            pos = pos + 20;
                            printtoscreen2d(x, pos, "<unknown string>" + level.startracker[poiname].var_356bde2b53efa8cf, (0, 0, 1), 1);
                            x = x + 250;
                            if (x > 1750) {
                                x = startx;
                                starty = starty + 325;
                        ...
                        printtoscreen2d(400, 50, "<unknown string>" + level.startracker.starlevel, (1, 1, 1), 1);
                        printtoscreen2d(400, 70, "<unknown string>" + level.startracker.starmeter, (1, 1, 1), 1);
                        printtoscreen2d(400, 90, "<unknown string>" + level.startracker.var_924d5d49fde54cdd, (1, 1, 1), 1);
                        printtoscreen2d(400, 110, "<unknown string>", (1, 1, 1), 1);
                        printtoscreen2d(400, 130, "<unknown string>" + level.startracker.var_19d6896c9e881cc4, (1, 1, 1), 1);
                        printtoscreen2d(400, 150, "<unknown string>" + level.var_1a6233bc0d61faf.reqreinforcements[level.startracker.starlevel] - level.startracker.var_a93671354b676c18, (1, 1, 1), 1);
                        printtoscreen2d(400, 170, "<unknown string>", (0, 0, 1), 1);
                        printtoscreen2d(400, 190, "<unknown string>" + level.startracker.var_38951249a8cf8968, (0, 0, 1), 1);
                        printtoscreen2d(400, 210, "<unknown string>" + level.startracker.var_fe385543116077b5, (0, 0, 1), 1);
                        printtoscreen2d(400, 230, "<unknown string>" + level.startracker.var_55cf9e4f74d2f4c2, (0, 0, 1), 1);
                        printtoscreen2d(400, 250, "<unknown string>" + level.startracker.var_356bde2b53efa8cf, (0, 0, 1), 1);
                    }
                } else {
                    printtoscreen2d(750, 100, "<unknown string>", (0, 0, 1), 2.5);
                }
            ...
            if (getdvarint(@"hash_959247ebc7eac6b5", 0) == 1) {
                ...
                if (!function_47d356083884f913()) {
                    ...
                    println("<unknown string>" + function_9a83377c98bce82a("<unknown string>") + "<unknown string>" + civmax);
                }
                println("<unknown string>");
                println("<unknown string>");
                println("<unknown string>");
                ...
                if (function_47d356083884f913()) {
                    ...
                    foreach (poiname, poi in level.poi) {
                        ...
                        if (isdefined(level.var_41670c1c65f3d3cf.poi[poiname].var_8bcd79921ba8147e) && isdefined(level.var_41670c1c65f3d3cf.poi[poiname].agentdeaths)) {
                            printtoscreen2d(x, pos, "<unknown string>" + level.var_41670c1c65f3d3cf.poi[poiname].var_8bcd79921ba8147e - level.var_41670c1c65f3d3cf.poi[poiname].agentdeaths, (0, 0, 1), 1.2);
                        } else {
                        ...
                        printtoscreen2d(x, pos, "<unknown string>", (0, 0, 1), 1);
                        pos = pos + 20;
                        reinforcementstring = "<unknown string>";
                        if (!isdefined(level.var_41670c1c65f3d3cf.poi[poiname].reinforcementqueue) || level.var_41670c1c65f3d3cf.poi[poiname].reinforcementqueue.size == 0) {
                            ...
                            foreach (numagents in level.var_41670c1c65f3d3cf.poi[poiname].reinforcementqueue) {
                                reinforcementstring = reinforcementstring + "<unknown string>" + numagents;
                            }
                        }
...
function function_491f405f5622af52(poiname, x, y) {
    /#
        ...
        pos = pos + 10;
        printtoscreen2d(x, pos, "<unknown string>", colorbody, 1);
        pos = pos + 12;
        ...
        foreach (key in function_d7df76a9938f5871(poiname)) {
            if (key != "<unknown string>") {
                ...
                thirdstring = "<unknown string>" + function_abbd4595d76ccc5e(poiname, key);
                printtoscreen2d(x, pos, firststring, (0, 0, 1), 1);
                tempx = x + 150;
                printtoscreen2d(tempx, pos, secondstring, (0, 1, 0), 1);
                tempx = tempx + "<unknown string>" + secondstring.size * 10;
                printtoscreen2d(tempx, pos, thirdstring, (0, 0, 1), 1);
                pos = pos + 20;
                numlines++;
            }
        ...
        pos = pos + 10;
        printtoscreen2d(x, pos, "<unknown string>" + level.var_41670c1c65f3d3cf.poi[poiname].agentdeaths, colorbody, 1);
        pos = pos + 12;
        printtoscreen2d(x, pos, "<unknown string>", colorbody, 1);
        pos = pos + 12;
        printtoscreen2d(x, pos, "<unknown string>" + function_abbd4595d76ccc5e(poiname, "<unknown string>"), colorbody, 1);
        pos = pos + 12;
        printtoscreen2d(x, pos, "<unknown string>", colorbody, 1);
        numlines = numlines + 4;
        return numlines;
...
function function_6fb8f59559dfa4a7(poiname, x, y) {
    /#
        ...
        foreach (subarea in poi["<unknown string>"]) {
            color = colorbody;
            extratext = "<unknown string>";
            if (istrue(subarea.isshutdown)) {
                color = (1, 0, 0);
                extratext = "<unknown string>";
            }
            printtoscreen2d(x, pos, subarea.var_71ad22c5d093d90b + "<unknown string>" + subarea.var_3ebb6024e3f220ca.size + "<unknown string>" + extratext, colorbody, 1);
            pos = pos + 20;
        }
        pos = pos + 12;
        printtoscreen2d(x, pos, "<unknown string>" + function_abbd4595d76ccc5e(poiname, "<unknown string>"), colorbody, 1);
            ...
            if (getdvarint(@"hash_2450e77b0430661c", 0) > 0) {
                if (istrue(level.var_289df80e1ded586f)) {
                    ...
                    if (scripts/cp_mp/utility/game_utility::function_42e2dcfd4571b89b()) {
                        ...
                        team = scripts/mp/utility/teams::getenemyteams(player.team)[0];
                    }
                    if (isdefined(player)) {
                        ...
                        foreach (pathstruct in level.poi[poiname]["<unknown string>"]) {
                            ...
                            for (i = 0; i < pathstruct.path.size; i++) {
                                ...
                                if (isdefined(node01.target)) {
                                    var_4ff83bffc51fbd1b = getstruct(node01.target, "<unknown string>");
                                }
...
function function_b510c28e573d0be6() {
    /#
        ...
        while (true) {
            foreach (player in level.players) {
                player setclientomnvar("<unknown string>", function_5cc0c507e92f7b47(player.closestpoi));
            }
            wait(1);
        }
    #/
...
function function_8b97c47b557d1c58() {
    /#
        ...
        while (true) {
            foreach (poiname, poi in level.poi) {
                if (getdvarint(hashcat(@"hash_831b14ba4dbdd316", poiname, "<unknown string>"), 0) == 1) {
                    foreach (subarea in poi["<unknown string>"]) {
                        if (subarea.var_71ad22c5d093d90b != "<unknown string>") {
                            foreach (spawnPackage in subarea.var_d276b08c96430bfc) {
                                function_87edf0678d74d59a(spawnPackage, "<unknown string>", poiname, subarea.var_71ad22c5d093d90b);
