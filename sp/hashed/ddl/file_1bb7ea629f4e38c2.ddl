...
struct root {
    ...
    // offset: 0x16e0, bitSize: 0x8(0x1B)
    Team victor;
    // offset: 0x16e8, bitSize: 0x300(0x60B)
    int32 alliesRoundScore[24];
    // offset: 0x19e8, bitSize: 0x300(0x60B)
    int32 axisRoundScore[24];
    // offset: 0x1ce8, bitSize: 0x20(0x4B)
    int32 serverScriptCalcTimeTotal;
    // offset: 0x1d08, bitSize: 0x8(0x1B)
    byte globalPlayerXpModifier;
    // offset: 0x1d10, bitSize: 0x10(0x2B)
    short lifeCount;
    // offset: 0x1d20, bitSize: 0x10(0x2B)
    short gameEventCount;
    // offset: 0x1d30, bitSize: 0x20(0x4B)
