    ...
    if (level.deployablekiosks.drawdebug) {
        /#
            if (getdvarint(@"hash_d7987b5db214b981", 0)) {
                debug::debug_sphere(drone, 25, (1, 0, 0), undefined, "<dev string:x25>", "<dev string:x4d>");
                debug::draw_angles(drone, undefined, 150, undefined, "<dev string:x25>", "<dev string:x4d>");
            }
        #/
    }
    goto = spawnstruct();
...
function function_6d9358d777958a1b(var_daad7d20d7a17c02, var_ceb89b7c7c66002a) {
    ...
    /#
        utility::function_2bf8ec790b5a10f8(@"hash_d7987b5db214b981", [&debug::debug_line, self, var_daad7d20d7a17c02.origin, (1, 0, 0), undefined, "<dev string:x25>", "<dev string:x7a>"]);
    #/
    intervaltime = 0.05;
