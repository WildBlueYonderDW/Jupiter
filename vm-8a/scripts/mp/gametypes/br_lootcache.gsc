...
function function_163d360c111caa16(contents, var_8bd50c7e994c7434, var_42be80ba01341305) {
    ...
    for (totalsurplus = var_8bd50c7e994c7434; totalsurplus > 0; totalsurplus -= value) {
...
/#
    ...
    function function_6975415e57cd5a29(items, player) {
        lootname = getdvar(@"hash_4b9f1b5e62c2ac88", "<dev string:x1c>");
    ...
    function spawnlootcache(origin, angles, type) {
        switch (type) {
        case 2: 
            scriptable = spawnscriptable("<dev string:x1d>", origin, angles);
            break;
        case 3: 
            scriptable = spawnscriptable("<dev string:x30>", origin, angles);
            break;
        case 4: 
            scriptable = spawnscriptable("<dev string:x47>", origin, angles);
            break;
        default: 
            scriptable = spawnscriptable("<dev string:x65>", origin, angles);
            break;
        }
        scriptable setscriptablepartstate("<dev string:x73>", "<dev string:x78>");
    }
