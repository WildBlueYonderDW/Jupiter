...
function note_track_trace_to_efx(notetrack, canceltrack, tagname, effect_path, var_56aef90205769a90, delete_depth) {
    ...
    if (notetrack != "start" && !animhasnotetrack(scenedata getanim(scenedata.anim_sequence), notetrack)) {
        /#
            println("<unknown string>" + scenedata.anim_sequence + "<unknown string>" + notetrack);
        #/
        return;
    }
    add_fx(effect_path, effect_path);
    ...
    /#
        ...
        if (guy.loops > 1) {
            ...
            for (i = 0; i < guy.loopanims.size; i++) {
                println("<unknown string>" + guy.loopanims[i]);
            }
            /#
    ...
    foreach (i, animation in level.scr_anim[animname][anime]) {
        ...
        /#
            if (getdvarint(@"hash_4140c00f3efa94c6", 0)) {
                ...
                print3d(neworg, "<unknown string>", (1, 1, 1), 1, 0.2, 1000, 1);
            }
        #/
...
// Size: 0x206
function function_d0fafbacba98a40f(playerpos, animstartpos, blendspeed, blendIntoTime, var_ec165a067af34f8f, var_8831fc7320076829, var_e123fee5ae019570) {
    ...
    /#
        if (getdvarint(@"hash_398da46238160a6", 0)) {
            iprintln("<unknown string>" + blendtimecalc);
        }
    #/
    if (blendIntoTime > 0) {
...
// Size: 0x228
function function_309bb9de5db13227(playerpos, animstartpos, blendspeed, blendIntoTime, var_ec165a067af34f8f, var_8831fc7320076829, var_e123fee5ae019570) {
    var_ec165a067af34f8f = ter_op(isdefined(var_ec165a067af34f8f), var_ec165a067af34f8f, 1);
    var_8831fc7320076829 = ter_op(isdefined(var_8831fc7320076829), var_8831fc7320076829, 0);
    var_e123fee5ae019570 = ter_op(isdefined(var_e123fee5ae019570), var_e123fee5ae019570, 0);
...
function function_1d134c1e220fb6d7(animation, var_ec165a067af34f8f, var_8831fc7320076829, var_e123fee5ae019570) {
    ...
    blendtime = function_d0fafbacba98a40f(level.player.origin, animpos, blendspeed, blendIntoTime, var_ec165a067af34f8f, var_8831fc7320076829, var_e123fee5ae019570);
    ...
    /#
        if (getdvarint(@"hash_398da46238160a6", 0)) {
            ...
            iprintln("<unknown string>" + level.blendinfo["<unknown string>"]);
            iprintln("<unknown string>" + level.blendinfo["<unknown string>"][0] + "<unknown string>" + level.blendinfo["<unknown string>"][1]);
        }
    #/
}
...
function function_52351c3338da63f4(animcategory, animindex) {
    /#
        /#
            assertex(isdefined(animcategory) && isdefined(animindex), "<unknown string>");
        #/
    #/
    animlength = 0;
...
function function_9dbe1a78b03782f2(var_54e516bef4218c8f, start_func, end_func, arrival_type) {
    ...
    debugstartpos = 0;
    /#
        debugstartpos = getdvar(@"hash_34dab4f8f3a04f4a") == "<unknown string>";
    #/
    threads = 0;
    guys = [];
            ...
            /#
                if (getdvarint(@"hash_d3e33f1288718b9e")) {
                    ...
                    if (isdefined(guy.reachspeed)) {
                        print3d(guy.origin + (0, 0, 20), "Xcams shouldn't be used in looping animations." + int(guy.reachspeed.var_e2b417b32dbed0f7), (0, 1, 1), 1, 0.3, 1, 1);
                    }
...
function anim_reach_speed_control_avg(var_ad86b98c8c9def3d, var_4bc185af207d5706) {
    ...
    while (true) {
        ...
        if (isdefined(reachspeed.speed_samples[index])) {
            reachspeed.speed_total = reachspeed.speed_total - reachspeed.speed_samples[index];
        }
