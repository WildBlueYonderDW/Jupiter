        ...
        foreach (vehicle in leveldata.debuginstances) {
            if (isdefined(vehicle)) {
                ...
                if (getdvarint(@"hash_5a20dfa97c106e84", 0) != 0) {
                    ...
                    front = var_e2818ad39a3341b4.exitextents["<dev string:x1c>"];
                    back = var_e2818ad39a3341b4.exitextents["<dev string:x22>"];
                    left = var_e2818ad39a3341b4.exitextents["<dev string:x27>"];
                    right = var_e2818ad39a3341b4.exitextents["<dev string:x2c>"];
                    top = var_e2818ad39a3341b4.exitextents["<dev string:x32>"];
                    bottom = var_e2818ad39a3341b4.exitextents["<dev string:x36>"];
                }
                tfl = vehicle.origin;
                tfl += anglestoup(vehicle.angles) * top;
                tfl += anglestoforward(vehicle.angles) * front;
