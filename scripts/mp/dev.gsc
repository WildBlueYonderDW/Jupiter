...
/#
    ...
    function init() {
        ...
        setdevdvarifuninitialized(@"hash_3e1fd62284a08637", "<dev string:xc5>");
        ...
        setdevdvarifuninitialized(@"hash_43c2493829737f81", "<dev string:xca>");
        ...
        setdevdvar(@"hash_1ce2eb225cc3a6da", "<dev string:xca>");
        ...
        setdevdvar(@"hash_4b1b03fef51c8ebd", "<dev string:xca>");
        ...
        setdevdvar(@"hash_476322a29c647506", "<dev string:xca>");
        setdevdvar(@"hash_4260f3bad6a1dfc4", "<dev string:xca>");
        ...
        while (true) {
            ...
            if (getdvarint(@"hash_2814505e96048f69", 0) == 1) {
                if (isdefined(level.zone)) {
                    ...
                    cylinder(level.zone.curorigin, level.zone.curorigin + (0, 0, 1), var_dd41202d89e84055, (1, 0, 0));
    ...
    function updatedevsettings() {
        ...
        if (getdvar(@"hash_476322a29c647506") != "<dev string:xca>") {
        ...
        if (getdvar(@"hash_4260f3bad6a1dfc4") != "<dev string:xca>") {
        ...
        if (getdvar(@"hash_96ed508dc1bb2193") != "<dev string:xca>") {
            nametokens = strtok(getdvar(@"hash_96ed508dc1bb2193"), "<dev string:x31a>");
            if (nametokens.size > 1) {
                thread xkillsy(nametokens[0], nametokens[1]);
            }
            setdevdvar(@"hash_96ed508dc1bb2193", "<dev string:xca>");
        }
        ...
        if (getdvar(@"hash_4d54618a8e9f8cb7") != "<dev string:xca>") {
            ents = getentarray();
            level.entarray = [];
            level.entcounts = [];
            level.entgroups = [];
        ...
        if (getdvarint(@"hash_1d72f4f6602796e9") > 0) {
            ...
            if (setscore) {
                setdevdvar(hashcat(@"hash_d98c82b5a26dc973", getgametype(), "<dev string:x7b2>"), 0);
            }
        ...
        vehicleref = getdvar(@"hash_36aaf7d3b773c77a", "<dev string:xca>");
        if (vehicleref != "<dev string:xca>") {
            ...
            setdevdvar(@"hash_36aaf7d3b773c77a", "<dev string:xca>");
        }
        ...
        if (getdvar(@"hash_43c2493829737f81", "<dev string:xca>") != "<dev string:xca>") {
            equipmentref = getdvar(@"hash_43c2493829737f81", "<dev string:xca>");
            ...
            setdevdvar(@"hash_43c2493829737f81", "<dev string:xca>");
        }
    ...
    function function_b7e6fc2c99a2fa66() {
        ...
        while (true) {
            player = level waittill("<dev string:xdc4>");
            if (isbot(player)) {
                player giveperk("<dev string:x147c>");
                player thread function_95c542c3d23e8ed5();
            }
    ...
    // Namespace dev / scripts\mp\dev
    // Params 0, eflags: 0x0
    // Checksum 0x0, Offset: 0xd13e
    // Size: 0x21
    function function_26f66601b72597e0() {
        setdvar(@"hash_a48570b2b90adb33", "<dev string:xc5>");
        level notify("<dev string:x14f9>");
    }
    ...
    function function_17cdeb7626afb432() {
        for (;;) {
            ...
            } else if (getdvar(@"hash_1ce2eb225cc3a6da") != "<dev string:xca>") {
            ...
            } else if (getdvar(@"hash_4b1b03fef51c8ebd") != "<dev string:xca>") {
    ...
    function dbgbullets() {
        ...
        if (getdvar(@"hash_1543bf20a8b825f4") == val) {
            ...
            setdevdvar(@"hash_1543bf20a8b825f4", "<dev string:xa31>");
        } else {
    ...
    function function_1da70102eeb10c0b() {
        ...
        newweapon = namespace_e0ee43ef2dddadaa::buildweapon(getweaponrootname(newweapon), attachments, undefined, "<dev string:xf0>", undefined, var_7809ad191e44fe6a, undefined, undefined, undefined);
        newweapon = newweapon withattachment(attachmentname, modelindex);
        ...
        if (var_1cbb266d488421af == 3) {
            ...
            case 2: 
                ...
                if (level.players.size > 1) {
                    ...
                    targetplayer = level waittill("<dev string:xdc4>");
    ...
    function gui_dropweapon() {
        ...
        weaponobj = namespace_e0ee43ef2dddadaa::buildweapon(getweaponrootname(weaponbasename), attachlist, "<dev string:xf0>", "<dev string:xf0>", -1);
        foreach (player in level.players) {
    ...
    function private function_2384873117c9fee0() {
        ...
        gamemode = hashcat(@"hash_d98c82b5a26dc973", getgametype(), "<dev string:x226c>");
...
/#
    ...
    // Namespace dev / scripts\mp\dev
    // Params 0, eflags: 0x0
    // Checksum 0x0, Offset: 0x18aeb
    // Size: 0x170
    function function_9321ed5022d179fc() {
        self endon("<dev string:x27a2>");
        while (true) {
            victim, inflictor, damage, idflags, smeansofdeath, objweapon, vpoint, vdir, shitloc = self waittill("<dev string:x2828>");
    ...
    // Namespace dev / scripts\mp\dev
    // Params 0, eflags: 0x0
    // Checksum 0x0, Offset: 0x18c63
    // Size: 0x6e
    function function_6f68d17492fbeb7b() {
        self endon("<dev string:x27a2>");
        while (true) {
            victim, inflictor = self waittill("<dev string:x2859>");
            if (!isdefined(victim.var_4c6da5bcea4fd1ce)) {
                var_4c6da5bcea4fd1ce = spawnstruct();
                var_4c6da5bcea4fd1ce.time = gettime();
                victim.var_4c6da5bcea4fd1ce = var_4c6da5bcea4fd1ce;
    ...
    // Namespace dev / scripts\mp\dev
    // Params 0, eflags: 0x0
    // Checksum 0x0, Offset: 0x19139
    // Size: 0x45
    function function_6e116b48adc0bbe() {
        self endon("<dev string:x2882>");
        while (true) {
            victim, inflictor, damage = self waittill("<dev string:x2859>");
            function_5c3b4e1eb3b441e3(victim, damage);
        }
    }
    ...
    function watchgunsmithdebugui() {
        ...
        while (true) {
            player = level waittill("<dev string:x348a>");
    ...
    // Namespace dev / scripts\mp\dev
    // Params 0, eflags: 0x0
    // Checksum 0x0, Offset: 0x1af31
    // Size: 0x56
    function watchplayergunsmithdebugui() {
        self endon("<dev string:x273>");
        while (true) {
            message, lootid = self waittill("<dev string:xe4b>");
    ...
    function function_991360818ecedb4b() {
        ...
        setdevdvar(@"hash_2853a457a04cedd", 0);
        setdevdvar(@"hash_2d5236cbe9894aff", 1);
        bot = level waittill("<dev string:xdc4>");
        host = devfindhost();
    ...
    function function_4d6e7ec55fd3917d() {
        ...
        if (vehicleref != "<dev string:xca>") {
            ...
            spawndata.spawntype = "<dev string:x975>";
            var_17835127f48f3956 = scripts\cp_mp\vehicles\vehicle::function_84033ce50b8afce2(vehicleref, spawndata);
            seatid = var_17835127f48f3956[1];
            vehicle = var_17835127f48f3956[0];
    ...
    function function_eab2f1dc0cb5d29a() {
        while (true) {
            ...
            if (var_3461c8e7aa64d24d) {
                ...
                var_e7cd53fcb3b3e346 = player getcurrentweapon().attachments;
                weapname = player getcurrentweapon().basename;
                weap = makeweapon(weapname, var_e7cd53fcb3b3e346);
                startpos = player.origin;
                dir = anglestoforward(player.angles);
                offset = 50;
                voffset = (0, 0, 45);
    ...
    function function_1e7522498073119f(player) {
        ...
        aitype = namespace_bfef6903bca5845d::function_7f1a2e2ebe0c1693("<dev string:x12e0>", 1);
        agent = namespace_bfef6903bca5845d::ai_mp_requestspawnagent(aitype, deploypos, player.angles, "<dev string:x3e96>", "<dev string:x3ea2>");
        if (!isdefined(agent)) {
            return;
        }
    ...
    function function_19068dd111569111() {
        ...
        if (isdefined(targetbot)) {
            ...
            if (isdefined(var_387ea36d35dcafbd)) {
                ...
                targetbot botpressbutton("<dev string:x426b>", 3);
            }
        }
    }
    ...
    function function_59012b384deffea6() {
        ...
        foreach (player in array_randomize(level.players)) {
            ...
            player dodamage(player.maxhealth + 1, player.origin, player, player, "<dev string:x4274>", undefined, "<dev string:x14a3>");
            break;
        }
    }
    ...
    function function_bbe2150913f65c2a() {
        ...
        while (true) {
            if (!playing && getdvar(@"hash_8ad8ec07fa623e0e", "<dev string:xca>") != "<dev string:xca>") {
                level.players[0] setplayermusicstate("<dev string:x4286>", [getdvar(@"hash_8ad8ec07fa623e0e", "<dev string:xca>")]);
                playing = 1;
            } else if (playing && getdvar(@"hash_8ad8ec07fa623e0e", "<dev string:xca>") == "<dev string:xca>") {
                level.players[0] stopplayermusicstate("<dev string:x4286>");
                playing = 0;
            }
            wait 1;
        }
    ...
    function splashesdevgui() {
        ...
        if (getsubgametype() == "<dev string:x736>" || getsubgametype() == "<dev string:x4293>") {
            scripts\mp\gametypes\br_gametype_dmz::showdmzsplash(var_af386172f63848bd, level.players, "<dev string:x429b>");
        } else {
    ...
    function function_9c32d0bcea4c4746() {
        ...
        while (true) {
            ...
            if (radius > 0) {
                ...
                circleobjective scripts\cp_mp\utility\game_utility::function_6b6b6273f8180522("<dev string:x42a3>", origin, radius, host);
            ...
            if (clearcircles) {
                ...
                foreach (circleobjective in level.var_8739ee0d5a9db983) {
                    circleobjective notify("<dev string:x42b1>");
    ...
    // Namespace dev / scripts\mp\dev
    // Params 0, eflags: 0x0
    // Checksum 0x0, Offset: 0x2210a
    // Size: 0x9f
    function function_ee24307f577b6886() {
        bookmarkstart = "<dev string:x42c2>";
        bookmarkend = "<dev string:x433f>";
    ...
    // Namespace dev / scripts\mp\dev
    // Params 0, eflags: 0x0
    // Checksum 0x0, Offset: 0x225b0
    // Size: 0x151
    function function_3bbc64340510aeab() {
        dvarstring = getdvar(@"hash_6a93ed78e507e165");
        filepath = "<dev string:x43bc>" + dvarstring;
        fileid = openfile(filepath, "<dev string:x43cb>");
