...
function function_988c6c7c7776406c() {
    ...
    #/
    var_380081ed3d43c6aa = getdvarint(@"hash_939ffa702b7da068", 10000);
    function_63abc2408f9ef4ba("ForLoopRef");
    for (i = 0; i < var_380081ed3d43c6aa; i++) {
    }
...
// Size: 0x117
function function_176ecc9d5b3767f0() {
    /#
        println("0");
    #/
    var_380081ed3d43c6aa = getdvarint(@"hash_939ffa702b7da068", 10000);
...
// Size: 0xe0
function function_d887bc54ef7149b3() {
    /#
        println("<unknown string>");
    #/
    var_380081ed3d43c6aa = getdvarint(@"hash_939ffa702b7da068", 10000);
...
// Size: 0xff
function function_5c2e9dba74d2864c() {
    /#
        println("<unknown string>");
    #/
    var_380081ed3d43c6aa = getdvarint(@"hash_939ffa702b7da068", 10000);
...
// Size: 0x29a
function function_8373207c6b8fe2c3() {
    /#
        println("<unknown string>");
    #/
    var_380081ed3d43c6aa = getdvarint(@"hash_939ffa702b7da068", 10000);
    ...
    for (i = 0; i < var_380081ed3d43c6aa; i++) {
        ...
        s.foo = 0;
        s.bar = 1;
        s.var_be66de030b25508c = s.foo + s.bar;
        s.foo = "hi";
        s.msg = s.foo + s.bar;
        s.foo = undefined;
        s.bar = undefined;
        ...
        level.foo = 0;
        level.bar = 1;
        level.var_be66de030b25508c = level.foo + level.bar;
        level.foo = "hi";
        ...
        level.s.foo = 0;
        level.s.bar = 1;
        level.s.var_be66de030b25508c = level.s.foo + level.s.bar;
        level.s.foo = "hi";
...
function function_e9372cb2b92b01e7(waittime, var_8942d67f3b4bb0f) {
    ...
    while (1) {
        ...
        var_ce2d7178f580aabf = 0;
        f1 = 1;
        even = 0;
        for (i = 0; i < var_8942d67f3b4bb0f; i++) {
            f = var_ce2d7178f580aabf + f1;
            var_ce2d7178f580aabf = f1;
            f1 = f;
            if (f % 2 == 0) {
                val = 1;
            } else {
...
// Size: 0xaa
function function_399c9c5744905103() {
    /#
        println("<unknown string>");
    #/
    var_ffaea134a9ba7ebb = 100;
    function_63abc2408f9ef4ba("Threads");
    waittime = 0.01;
    for (i = 0; i < var_ffaea134a9ba7ebb; i++) {
...
// Size: 0x2ba
function benchmark() {
    var_ac669a8c41355734 = [];
    if (getdvarint(@"hash_44e9f4a106f9b4a1", 0) > 0) {
        var_d468f1d46482f846 = getdvarint(@"hash_44e9f4a106f9b4a1", 0);
        for (i = 0; i < var_d468f1d46482f846; i++) {
            var_ac669a8c41355734[i] = i;
        }
    }
    function_8193a06614f54e87();
    if (function_63d722f2c9e256a4("0")) {
        function_988c6c7c7776406c();
        wait(0.05);
    }
    if (function_63d722f2c9e256a4("I")) {
        function_723ebfcdaa798c34();
        wait(0.05);
    }
    if (function_63d722f2c9e256a4("1")) {
        function_e4e266c2c4ebf49e();
        wait(0.05);
    }
    if (function_63d722f2c9e256a4("J")) {
        function_18cb5fb798c607cd();
        wait(0.05);
    }
    if (function_63d722f2c9e256a4("2")) {
        function_176ecc9d5b3767f0();
        wait(0.05);
    }
    if (function_63d722f2c9e256a4("3")) {
        function_10f6d810677cee84();
        wait(0.05);
    }
    if (function_63d722f2c9e256a4("K")) {
        function_9628bf5282b8bafc();
        wait(0.05);
    }
    if (function_63d722f2c9e256a4("4")) {
        function_dff6885d265db0fd();
        wait(0.05);
    }
    if (function_63d722f2c9e256a4("5")) {
        function_2308f139d0ffbc41();
        wait(0.05);
    }
    if (function_63d722f2c9e256a4("6")) {
        function_76d6d0feedd3126b();
        wait(0.05);
    }
    if (function_63d722f2c9e256a4("7")) {
        function_589fd6b13ca60155();
        wait(0.05);
    }
    if (function_63d722f2c9e256a4("8")) {
        function_cae58617e7945254();
        wait(0.05);
    }
    if (function_63d722f2c9e256a4("9")) {
        function_d887bc54ef7149b3();
        wait(0.05);
    }
    if (function_63d722f2c9e256a4("A")) {
        function_add278ceb4188914();
        wait(0.05);
    }
    if (function_63d722f2c9e256a4("B")) {
        function_8373207c6b8fe2c3();
        wait(0.05);
    }
    if (function_63d722f2c9e256a4("C")) {
        function_713ed9ae70c22b36();
        wait(0.05);
    }
    if (function_63d722f2c9e256a4("D")) {
        function_c0c13c7d2f02753b();
        wait(0.05);
    }
    if (function_63d722f2c9e256a4("E")) {
        function_56f6defb83c08190();
        wait(0.05);
    }
    if (function_63d722f2c9e256a4("F")) {
        function_399c9c5744905103();
        wait(0.05);
    }
    if (function_63d722f2c9e256a4("G")) {
        function_1cb0315d0cdacba4();
        wait(0.05);
    }
    if (function_63d722f2c9e256a4("H")) {
        function_d5bce87878a08018();
        wait(0.05);
    }
    if (function_63d722f2c9e256a4("L")) {
        function_5c2e9dba74d2864c();
        wait(0.05);
    }
...
// Size: 0x32
function function_63d722f2c9e256a4(a) {
...
// Size: 0x3d
function function_3f799a2b0456480a() {
    a = spawnstruct();
    b = spawnstruct();
    a.next = b;
    b.next = a;
