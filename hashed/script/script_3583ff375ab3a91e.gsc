...
// Size: 0x8d
function function_da46de174875958a(var_1c32cf705599120d, var_5a6598d5c3959784, var_3877fe450cf4fd9, var_65f75e5efd53fa1e) {
    player = self;
    ...
    if (isplayer(player) && !player namespace_d3d40f75bb4e4c32::isplayerinorgoingtogulag()) {
        return;
    }
    if (!isdefined(var_5a6598d5c3959784)) {
        var_5a6598d5c3959784 = "outline_nodepth_orange";
    }
    var_1c32cf705599120d hudoutlineenableforclient(player, var_5a6598d5c3959784);
...
function function_36c9dc5a1d1bb023(arena) {
    if (isdefined(arena.var_801cdcfadc4d465c)) {
        foreach (p in arena.var_801cdcfadc4d465c) {
            ...
            if (isdefined(arena.var_af5243fbba0720c2)) {
                foreach (var_90461be4437c102d in arena.var_af5243fbba0720c2) {
                    p thread function_da46de174875958a(var_90461be4437c102d, "outline_nodepth_red", 10);
                }
            }
        }
    }
    if (isdefined(arena.var_af5243fbba0720c2)) {
        foreach (p in arena.var_af5243fbba0720c2) {
            ...
            foreach (var_90461be4437c102d in arena.var_801cdcfadc4d465c) {
                p thread function_da46de174875958a(var_90461be4437c102d, "outline_nodepth_red", 10);
            }
        }
    }
...
// Size: 0xa4
function function_51b0f4b8cbce83ad(var_3ccb8742d21b61d7) {
    level endon("game_ended");
    var_3ccb8742d21b61d7.var_15fee21b382bfd2e setscriptablepartstate("second_chance_door_dom_gulag", "door_move_down", 0);
    var_3ccb8742d21b61d7.var_9a86491b9a098194 setscriptablepartstate("second_chance_door_dom_gulag", "door_move_down", 0);
    wait(level.var_43307855f189eb31.var_61b7b664d529876d);
    var_3ccb8742d21b61d7.var_15fee21b382bfd2e setscriptablepartstate("second_chance_door_dom_gulag", "door_standing_still", 0);
    var_3ccb8742d21b61d7.var_9a86491b9a098194 setscriptablepartstate("second_chance_door_dom_gulag", "door_standing_still_unusable", 0);
    var_3ccb8742d21b61d7.dooropen = 0;
}
...
// Size: 0x41
function function_6ce94cf4eee9eab7(var_3ccb8742d21b61d7) {
    player = self;
    if (!isdefined(player)) {
        return;
    }
...
// Size: 0x56
function function_4cba46d26023c1db(headicon, var_b37aef355ba7b694) {
...
function function_6f05f895a3054ff0(arena) {
    foreach (var_3ccb8742d21b61d7 in arena.var_cefc1bf41237bbac) {
        ...
        if (objid != -1) {
            doorcenter = (var_3ccb8742d21b61d7.var_15fee21b382bfd2e.origin + var_3ccb8742d21b61d7.var_9a86491b9a098194.origin) / 2;
            offset = (doorcenter - var_3ccb8742d21b61d7.origin) * 0.9;
            namespace_5a22b6f3a56f7e9b::objective_add_objective(objid, "current", var_3ccb8742d21b61d7.origin + (offset[0], offset[1], 60), "ui_mp_br_icon_gulag_exit_objective");
...
function function_c84e254980c7c8ed() {
    player = self;
    if (istrue(level.usegulag) && isdefined(level.var_43307855f189eb31) && !istrue(level.var_43307855f189eb31.var_186b191e239abc1c) && isdefined(player) && isplayer(player) && player namespace_d3d40f75bb4e4c32::isplayeringulag()) {
        return 0;
    }
    return 1;
}
...
function function_a65df5d97ee38203(arena) {
    ...
    var_83d2e74282cd7dd5 = var_c00a326249963ab5[5];
    ...
    player function_a8e64bd30c96ecfb(player.var_32484cd3b17f16c8, var_728eb76c27b59bf0, var_b2f307125dff1489);
    var_eb9bc703b343267f = 0;
    if (totalscore > arena.bestscore) {
        var_eb9bc703b343267f = 1;
        arena.bestscore = totalscore;
    }
    player function_dc8ce3434bd7703d(var_eb9bc703b343267f, var_83d2e74282cd7dd5, totalscore);
    player thread namespace_48a08c5037514e04::doScoreEvent(#"hash_51a16f5123111dbe", undefined, int(totalscore / 450) * 10);
}
...
function function_2f009f7eaad038cc(var_728eb76c27b59bf0) {
    ...
    if (isdefined(player.var_32484cd3b17f16c8) && isdefined(level.var_43307855f189eb31.var_f61587ba0e14efb3) && level.var_43307855f189eb31.var_f61587ba0e14efb3 != "") {
        var_e9c56b253dd633cb = strtok(level.var_43307855f189eb31.var_f61587ba0e14efb3, " ");
        i = 0;
        while (i < var_e9c56b253dd633cb.size) {
            if (int(var_e9c56b253dd633cb[i]) <= player.var_32484cd3b17f16c8) {
    ...
    var_72bb89e60d3674df = var_d68490486b12f2f1 + var_a12d637dfb1ff12f + var_20e6d5414d4c7ade + var_34d1d564db76a821 + var_d8fe1c1dd6ddb7c5;
    var_83d2e74282cd7dd5 = 0;
    if (isdefined(level.var_43307855f189eb31.var_d1562ade1a147c53) && level.var_43307855f189eb31.var_d1562ade1a147c53 != "") {
        ...
        while (i < var_1dbbd8627f3848eb.size) {
            if (int(var_1dbbd8627f3848eb[i]) > var_72bb89e60d3674df) {
                if (isdefined(var_1dbbd8627f3848eb[i - 1])) {
                    var_83d2e74282cd7dd5 = int(var_1dbbd8627f3848eb[i - 1]);
                } else {
                    var_83d2e74282cd7dd5 = int(var_1dbbd8627f3848eb[i + 1]);
                }
                break;
    ...
    player.var_938604a8b5dd849 = var_72bb89e60d3674df;
    player.var_e1ed3a7677ef1776 = var_83d2e74282cd7dd5;
    return [0:var_72bb89e60d3674df, 1:var_a12d637dfb1ff12f, 2:var_20e6d5414d4c7ade, 3:var_88af353046e1f521, 4:var_d8fe1c1dd6ddb7c5, 5:var_83d2e74282cd7dd5];
}
...
function function_8e6f76b7c8c0eaf0(playerkills, playertime, var_b2f307125dff1489) {
    ...
    #/
    var_c8a5261a0fca66d4 = int(playerkills) & playerkillsmax;
    var_c8a5261a0fca66d4 = var_c8a5261a0fca66d4 + ((int(playertime) & var_e6ae9427c9926ae1) << 5);
    var_c8a5261a0fca66d4 = var_c8a5261a0fca66d4 + ((int(var_b2f307125dff1489) & var_1c43c0d900e63a9d) << 15);
    return var_c8a5261a0fca66d4;
}
...
// Size: 0x4f
function function_dc8ce3434bd7703d(var_eb9bc703b343267f, var_c8e058e41ed64535, playerscore) {
    player = self;
    if (!isdefined(player)) {
        return;
    }
    var_5c9ddcf56d36f133 = function_97d23abeb51a7e62(var_eb9bc703b343267f, var_c8e058e41ed64535, playerscore);
...
// Size: 0xbd
function function_97d23abeb51a7e62(var_eb9bc703b343267f, var_c8e058e41ed64535, playerscore) {
    var_9683861002fa7757 = 2 - 1;
    var_ba6af4f96dc4a9c9 = 8 - 1;
    var_3e289c2968541ef8 = 268435456 - 1;
    /#
        assert(var_eb9bc703b343267f >= 0 && var_eb9bc703b343267f <= var_9683861002fa7757);
    #/
    /#
        assert(var_c8e058e41ed64535 >= 0 && var_c8e058e41ed64535 <= var_ba6af4f96dc4a9c9);
    #/
    /#
        assert(playerscore >= 0 && playerscore <= var_3e289c2968541ef8);
    #/
    var_c8a5261a0fca66d4 = int(var_eb9bc703b343267f) & var_9683861002fa7757;
    var_c8a5261a0fca66d4 = var_c8a5261a0fca66d4 + ((int(var_c8e058e41ed64535) & var_ba6af4f96dc4a9c9) << 1);
    var_c8a5261a0fca66d4 = var_c8a5261a0fca66d4 + ((int(playerscore) & var_3e289c2968541ef8) << 4);
    return var_c8a5261a0fca66d4;
}
...
function function_17f3636354648f38(var_8e0908c9ad75d350) {
    ...
    #/
    var_c8a5261a0fca66d4 = int(var_8e0908c9ad75d350) & var_6891a0702de9917e;
    return var_c8a5261a0fca66d4;
}
...
function function_da0a5d9a9fc8abc2(arena) {
    objid = namespace_5a22b6f3a56f7e9b::requestobjectiveid(99);
    if (objid != -1) {
        namespace_5a22b6f3a56f7e9b::objective_add_objective(objid, "current", arena.center + (0, 0, -60), "hud_icon_objective_skeleton_key");
        namespace_5a22b6f3a56f7e9b::update_objective_setbackground(objid, 1);
        namespace_5a22b6f3a56f7e9b::objective_playermask_hidefromall(objid);
        namespace_5a22b6f3a56f7e9b::objective_set_play_intro(objid, 0);
    } else {
...
function function_ba5dbc7633c84a(arena) {
    ...
    foreach (p in arena.arenaplayers) {
        ...
        namespace_5a22b6f3a56f7e9b::objective_playermask_hidefrom(arena.var_a9350ed31bec6aef, p);
    }
}
...
// Size: 0x433
function function_d095c23873d8efed(overrideArenas, var_66287f24ebdf0100) {
    arenas = ter_op(istrue(var_66287f24ebdf0100), overrideArenas, level.gulag.arenas);
    ...
    if (!istrue(level.gulag.multiarena)) {
        return namespace_47fd1e79a44628cd::function_bee59f29dedc0fd6(overrideArenas);
    }
    ...
    if (var_f8e38f0423a1a9c5) {
        return namespace_47fd1e79a44628cd::function_ba2be3e8cd3fb169(overrideArenas);
    }
    var_5dd209c141f918fa = undefined;
    var_318a1dbf1a07dcb0 = -1;
    var_8364436b57c5e611 = 0;
    foreach (arena in arenas) {
        if (!namespace_47fd1e79a44628cd::isArenaEnabled(arena, self)) {
            continue;
        }
        foreach (match in arena.matches) {
            if (match.size < 2 && var_318a1dbf1a07dcb0 < 2) {
                foreach (player in match) {
                    var_de841985a7f29953 = namespace_47fd1e79a44628cd::function_6a7526f387d26776(match);
                    if (match.size < 2) {
                    ...
                    } else if (!var_8364436b57c5e611 || istrue(arena.fightover)) {
                        var_318a1dbf1a07dcb0 = match.size;
                        var_5dd209c141f918fa = arena;
                        var_8364436b57c5e611 = istrue(arena.fightover);
                    }
    ...
    namespace_9c840bb9f2ecbf00::demoforcesre("[GULAG] gulag_playerGetNextArena : could not find a proper gulag arena. Returning a random arena");
...
function function_b57f39d9e91ebf95(arena) {
    var_2d19e82b56a9c455 = arena.center;
    lootcaches = getlootscriptablearray("br_loot_cache_gulag");
    foreach (cache in lootcaches) {
        if (distance(cache.origin, var_2d19e82b56a9c455) < 8000) {
...
function function_2f4344abdc200e43(player) {
    if (isdefined(level.gulag) && isdefined(level.gulag.arenas)) {
        for (i = 0; i < level.gulag.arenas.size; i++) {
            ...
            foreach (var_31210ce93279d451 in var_f40e6deec30ee209.arenaplayers) {
...
function function_15997d969114692d(arena) {
    foreach (var_3ccb8742d21b61d7 in arena.var_cefc1bf41237bbac) {
        var_3ccb8742d21b61d7.var_15fee21b382bfd2e setscriptablepartstate("second_chance_door_dom_gulag", "door_standing_still", 0);
        var_3ccb8742d21b61d7.var_15fee21b382bfd2e.origin = var_3ccb8742d21b61d7.var_15fee21b382bfd2e.var_f590d44509c2e578;
        var_3ccb8742d21b61d7.var_9a86491b9a098194 setscriptablepartstate("second_chance_door_dom_gulag", "door_standing_still", 0);
        var_3ccb8742d21b61d7.var_9a86491b9a098194.origin = var_3ccb8742d21b61d7.var_9a86491b9a098194.var_f590d44509c2e578;
    }
}
...
function function_63cef9bb6769f404(arena) {
    ...
    if (istrue(var_67654372c5d5b194)) {
        player thread namespace_44abc05161e2e2cb::showsplash("br_twotwo_one_v_one_gulag_match_intro");
    } else {
        player thread namespace_44abc05161e2e2cb::showsplash("br_twotwo_gulag_match_intro");
    }
    wait(2.2);
...
function function_85b349978cd4de4f(arena) {
    ...
    if (isdefined(primaryweaponobj) && primaryweaponobj.classname == "pistol") {
        animationname = animationname + "_pistol";
    }
    ...
    player function_33010a90bcf48db4(xcam, 0, player.origin, player.angles);
    player playanimscriptsceneevent("scripted_scene", animationname);
    var_8355076d4ed3fc96 = function_4358b309fdcc6d44(xcam);
    wait(var_8355076d4ed3fc96 - 0.75);
    if (!isdefined(player)) {
        return;
    }
    ...
    if (level.var_43307855f189eb31.var_592faf90ea5616f5) {
        player namespace_df5cfdbe6e2d3812::function_f1e9d0c09f38006b(0);
...
function function_608e28250c9d63a9(arena) {
    ...
    player thread function_696f54da8fcb6bbe("gulag_jailer_intro", arena);
    var_13e3fc231bb8d6b9 = player namespace_8bfdb6eb5a3df67a::playeriscinematiclayeron();
...
function function_e14e13143d59c4b2(arena) {
    ...
    if (level.var_43307855f189eb31.var_f336dfcef737a30c >= 0) {
        loadout = namespace_6ea7652ec407cc80::function_91b7c321b7e78443(level.var_43307855f189eb31.var_f336dfcef737a30c);
    }
    /#
        assert(isdefined(loadout));
    #/
    if (!isdefined(loadout)) {
        loadout = namespace_6ea7652ec407cc80::function_91b7c321b7e78443(level.var_43307855f189eb31.var_f336dfcef737a30c[0]);
    }
    var_f055075301c996b0 = loadout["loadoutPrimary"];
    primaryweaponobj = player getcurrentweapon();
    while (primaryweaponobj.basename != var_f055075301c996b0) {
        wait(0.1);
        if (!isdefined(player)) {
            return;
        }
...
function function_696f54da8fcb6bbe(dialog, arena) {
    ...
    var_cb3339ece72dbdeb = tolower("dx_br_brgj_" + game["dialog"][dialog]);
    var_1bb86493e750c91f = undefined;
    if (isdefined(arena.var_6f46a87c5570deab) && istrue(level.var_43307855f189eb31.var_1a56fc9a83d19e68)) {
        var_1bb86493e750c91f = arena.var_6f46a87c5570deab.origin;
    } else {
        var_1bb86493e750c91f = player.origin;
    }
    if (soundexists(var_cb3339ece72dbdeb)) {
        if (isent(arena.var_5c21e504cdf8c47)) {
            player playsoundtoplayer(var_cb3339ece72dbdeb, player, arena.var_5c21e504cdf8c47);
        } else {
            var_1499e7c2d69e0074 = lookupsoundlength(var_cb3339ece72dbdeb, 1) / 1000;
            player queuedialogforplayer(var_cb3339ece72dbdeb, dialog, var_1499e7c2d69e0074, undefined, undefined, var_1bb86493e750c91f, var_1499e7c2d69e0074);
        }
    } else {
        namespace_9c840bb9f2ecbf00::demoforcesre("missing VO " + var_cb3339ece72dbdeb);
    }
}
...
function function_dcead2b56fdbf3e(var_6b7cded46e0d4030) {
    ...
    var_ad6498e5d4b1ae34 = function_aa018b2f697301f3();
    eventparams[eventparams.size] = var_ad6498e5d4b1ae34;
    eventparams[eventparams.size] = "gulag_duration";
    var_902cf2fb782c194f = function_26945642f76b4740();
    eventparams[eventparams.size] = var_902cf2fb782c194f;
    ...
    var_9ed070b5404740d0 = function_733138b15e0833ff();
    eventparams[eventparams.size] = var_9ed070b5404740d0;
...
function function_aa018b2f697301f3() {
    player = self;
    if (!isdefined(player.var_ad6498e5d4b1ae34)) {
        return -1;
    }
    duration = player.var_ad6498e5d4b1ae34;
    return duration;
}
...
function function_26945642f76b4740() {
    player = self;
    if (!isdefined(player.var_f42099a4e4fa8bc9)) {
        return -1;
    }
    duration = gettime() - player.var_f42099a4e4fa8bc9;
    return duration;
}
...
function function_b48cef39dba5574c() {
    player = self;
    if (!isdefined(player.var_f73178c689f257ae)) {
        return -1;
    }
    return player.var_f73178c689f257ae;
}
...
function function_73c92ed8b56292a5() {
    player = self;
    if (!isdefined(player.var_f8a7b6f177e2f466)) {
        return -1;
    }
    return player.var_f8a7b6f177e2f466;
}
...
function function_733138b15e0833ff(var_6b7cded46e0d4030) {
    player = self;
    var_9ed070b5404740d0 = 0;
    if (isdefined(player.var_3a7c9a3e9aa20358) && player.var_3a7c9a3e9aa20358 > 0) {
        var_9ed070b5404740d0 = player.var_3a7c9a3e9aa20358;
    }
    return var_9ed070b5404740d0;
}
...
function function_3f18739ae34d9958() {
    player = self;
    player.var_f42099a4e4fa8bc9 = undefined;
    player.var_d919d1c70719e664 = undefined;
    player.var_6d34bf5491ad7588 = undefined;
    player.var_32484cd3b17f16c8 = undefined;
    player.var_f73178c689f257ae = undefined;
    ...
    player.var_f8a7b6f177e2f466 = undefined;
    ...
    player.var_ad6498e5d4b1ae34 = undefined;
...
// Size: 0x1ae
function function_573dfd8cb86d79f(label, value, point, relativepoint, xoffset, yoffset, color, var_a8ee906b22fcdb1e) {
    player = self;
    fontscale = 1.5;
    fontelem = newclienthudelem(player);
    if (istrue(var_a8ee906b22fcdb1e)) {
