...
function function_7903ab5a9ef7f51e(mimic, trap_prop, var_86ca8e1c112dc232, var_c2bab6b4faeb4e0d) {
    assert(array_contains(var_86ca8e1c112dc232, trap_prop), "trap prop must be in mimic prop array");
...
/#
    ...
    function function_f40e9354c7ef87f2() {
        function_6e7290c8ee4f558b("<dev string:x56>");
        function_a9a864379a098ad6("<dev string:x72>", "<dev string:x82>", &function_4b9ff448d5a356bb, 1);
        function_a9a864379a098ad6("<dev string:x92>", "<dev string:xa5>", &function_9d27ad32448f646e, 1);
        function_a9a864379a098ad6("<dev string:xb8>", "<dev string:xd0>", &function_62ce6d2d2ec84db1, 1);
        function_a9a864379a098ad6("<dev string:xe8>", "<dev string:x104>", &function_e4a73e61d489e88b, 1);
        function_a9a864379a098ad6("<dev string:x123>", "<dev string:x134>", &function_bcf7a4f5c74762af);
        function_a9a864379a098ad6("<dev string:x145>", "<dev string:x166>", &function_7b9ff72e64814cf1);
        function_a9a864379a098ad6("<dev string:x181>", "<dev string:x19c>", &function_88698d5c32de5b3c, 1);
        function_a9a864379a098ad6("<dev string:x1b0>", "<dev string:x1ca>", &function_343c21a6fb381025, 1);
        function_a9a864379a098ad6("<dev string:x1dd>", "<dev string:x204>", &function_eaceefb9f66950f9);
        function_a9a864379a098ad6("<dev string:x226>", "<dev string:x238>", &function_a5ebbdcfeec725ff);
        function_a9a864379a098ad6("<dev string:x24b>", "<dev string:x25e>", &function_eb1dd015e483d450);
        function_a9a864379a098ad6("<dev string:x271>", "<dev string:x286>", &function_2570f796cde55c74);
        function_a9a864379a098ad6("<dev string:x29b>", "<dev string:x2b8>", &function_8cca940d666433ca);
        function_a9a864379a098ad6("<dev string:x2ca>", "<dev string:x2dc>", &function_852ebf03a4be71c);
        function_b23a59dfb4ca49a1("<dev string:x2ee>", "<dev string:x30c>", &function_69ebd21eee2b20cf);
        function_b23a59dfb4ca49a1("<dev string:x331>", "<dev string:x34c>", &function_69ebd21eee2b20cf);
    ...
    function function_d94c9b7be6d072e6() {
        ...
        function_6e7290c8ee4f558b("<dev string:x383>");
        foreach (name in scriptbundlenames) {
            function_b23a59dfb4ca49a1(name, "<dev string:x3a9>" + name, &function_a5acf46239ebdd51);
        }
        function_fe953f000498048f();
    }
    ...
    function function_69ebd21eee2b20cf(params) {
        dvar_name = hashcat(@"hash_d98c82b5a26dc973", params[0]);
        ...
        while (true) {
            foreach (trap_prop in level.var_c333aca3fe5f8c29) {
                ...
                if (istrue(trap_prop.pause_trap)) {
                    print3d(trap_prop.origin + (0, 0, 48), "<dev string:x3be>", color);
                }
            }
            waitframe();
        }
    ...
    function function_88698d5c32de5b3c() {
        spawn_points = getstructarray("<dev string:x3c5>", "<dev string:x3d9>");
        var_4b1319b2faba3d7 = [];
    ...
    function function_a5ebbdcfeec725ff() {
        mimic = function_6d1fbda4b8524ef2(level.players[0].origin, undefined, "<dev string:x3eb>");
        if (!isdefined(mimic)) {
            mimic = function_6d1fbda4b8524ef2(level.players[0].origin, undefined, "<dev string:x3f8>");
        }
        if (isdefined(mimic)) {
            mimic function_3e89eb3d8e3f1811("<dev string:x409>", 1);
        }
    }
    ...
    function function_852ebf03a4be71c() {
        ...
        if (isdefined(mimic)) {
            mimic function_3e89eb3d8e3f1811("<dev string:x415>", 1);
        }
    }
    ...
    function private function_cb384ef3ead500b8(point) {
        if (isdefined(point.lure_prop_type)) {
            ...
            case 0: 
                ...
                break;
            case 1: 
                if (isdefined(point.targetname) && point.targetname == "<dev string:x424>") {
                    point = point.machine;
                }
                break;
            default: 
