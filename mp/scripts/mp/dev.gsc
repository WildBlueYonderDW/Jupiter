...
/#
    ...
    function function_4d6e7ec55fd3917d() {
        ...
        if (vehicleref != "<dev string:xca>") {
            ...
            spawndata.spawntype = "<dev string:x975>";
            var_17995927f4a77e21 = scripts\cp_mp\vehicles\vehicle::function_84033ce50b8afce2(vehicleref, spawndata);
            seatid = var_17995927f4a77e21[1];
            vehicle = var_17995927f4a77e21[0];
    ...
    function function_1e7522498073119f(player) {
        ...
        agent = namespace_bfef6903bca5845d::ai_mp_requestspawnagent(aitype, deploypos, player.angles, "<dev string:x3e6c>", "<dev string:x3e78>");
        if (!isdefined(agent)) {
            return;
        }
