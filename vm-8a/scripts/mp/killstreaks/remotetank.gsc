...
/#
    ...
    function function_257b6f1cf0249339(entityhitpos, tank) {
        self endon("<dev string:x73>");
        tank endon("<dev string:x73>");
        ...
        line(tank.mgturret gettagorigin("<dev string:x79>"), var_2d7a2733c414e4df, (1, 0, 0), 1, 0, var_7de35540c250a948);
        anglesforward = vectornormalize(var_2d7a2733c414e4df - tank.mgturret gettagorigin("<dev string:x79>"));
        for (framecounter = 0; framecounter < var_7de35540c250a948; framecounter += 1) {
            print3d(tankorigin + anglesforward * 200, "<dev string:x83>" + var_2d7a2733c414e4df, (1, 0, 0));
            print3d(tankorigin + anglesforward * 200 - (0, 0, 20), "<dev string:x92>" + distance2d(var_2d7a2733c414e4df, entityhitpos));
            waitframe();
        }
    }
