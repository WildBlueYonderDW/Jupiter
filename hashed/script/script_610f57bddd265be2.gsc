...
function function_6d9358d777958a1b(var_daad7d20d7a17c02) {
    ...
    /#
        utility::function_2bf8ec790b5a10f8(@"hash_d7987b5db214b981", &debug::debug_line, [self, var_daad7d20d7a17c02.origin, (1, 0, 0), undefined, "veh9_mil_air_drone_redeploy_relocate", "<unknown string>"]);
    #/
...
function function_db5c75f2a84ff03d() {
    /#
        ...
        scripts/common/devgui::function_a9a864379a098ad6("<unknown string>", "<unknown string>", &function_16a89c1bb0d4c2b1);
