...
function function_98bf9c6c9952d67d(tank) {
    ...
    for (i = 0; i < var_8a4ba882c5016a38.size; i++) {
        ...
        for (j = 0; j < var_8a4ba882c5016a38[i].spawnnodes.size; j++) {
            var_a25049f295c6098b = namespace_bfef6903bca5845d::ai_mp_requestspawnagent(var_54784d468c8dd24c, getclosestpointonnavmesh(var_8a4ba882c5016a38[i].spawnnodes[j].origin), var_8a4ba882c5016a38[i].spawnnodes[j].angles, "absolute", "show", "rpg", undefined, team, undefined, undefined, 1, undefined, 0, undefined);
            ...
            var_a25049f295c6098b namespace_14d36171baccf528::agentpers_setagentpersdata(var_a25049f295c6098b, "team", team);
            var_a25049f295c6098b namespace_14d36171baccf528::function_c37c4f9d687074ff(undefined, undefined, undefined, undefined, undefined, 0, 0);
...
function function_2deb8d093f97cc1b() {
    ...
    level airstrike_playflyfx(plane, var_e4d26f59db05025a, var_6d29e82378e59e76, anglestoforward(var_7789cda8c1e3128e), var_3a20f9101e50025f, var_3a020e101e2ddead, var_7c39d972e849c204, var_4c4796c182975686);
    ...
    owner = attackers[0];
    level thread scripts\cp_mp\killstreaks\airstrike::callstrike_precisionbulleteffect(plane, var_fafbda0eba9c0aab, var_4c4796c182975686, targetsite, owner, streakinfo);
...
function function_f49914c65896f7ed(context, scale, duration, radius, var_9ac90fc02f01d464) {
    ...
    var_ada33822cf257bec = getscriptablearray("silo_door_" + context, "script_noteworthy");
    var_853bcd6b23aeeced = var_ada33822cf257bec[0];
...
function function_8141c7ee58e8ad59(var_bb5fa24f4a5c3b42) {
    ...
    var_81d84bb5b65f498e.var_7d1a90814c8500ff = var_81d84bb5b65f498e namespace_3121700695454c9::spawn_anim_model("rope_l", "origin_animate_jnt", "equipment_fast_rope_wm_01_infil_heli_l");
    var_81d84bb5b65f498e.var_7d1aa6814c853161 = var_81d84bb5b65f498e namespace_3121700695454c9::spawn_anim_model("rope_r", "origin_animate_jnt", "equipment_fast_rope_wm_01_infil_heli_l");
    var_81d84bb5b65f498e waittill("reached_dynamic_path_end");
    var_81d84bb5b65f498e.actors = [];
    var_81d84bb5b65f498e.actors[var_81d84bb5b65f498e.actors.size] = var_81d84bb5b65f498e namespace_3121700695454c9::spawn_anim_model("crew1", "body_animate_jnt", "fullbody_sp_ally_helicopter_crew_chief");
    var_81d84bb5b65f498e.actors[var_81d84bb5b65f498e.actors.size] = var_81d84bb5b65f498e namespace_3121700695454c9::spawn_anim_model("crew2", "body_animate_jnt", "fullbody_sp_ally_helicopter_crew_chief");
    ...
    namespace_f70554b797fd58c2::function_71cf043af949590c();
    if (flag("zone1_enableSamsite")) {
...
function function_5413c7d723606928(tank) {
    ...
    if (getdvarint(@"hash_d9d29efba6cd803e") != 1) {
        ...
        while (true) {
            player = var_431dac06e73b164 waittill("trigger");
...
function function_2ee1875b4cc4d668() {
    ...
    foreach (trigger in triggers) {
        ...
        bombzone = scripts\mp\gameobjects::createuseobject(game["defenders"], trigger, visuals, (0, 0, 64), var_3c2389ba69e5822b, 1);
...
function function_cd32a1014592af53(player) {
    ...
    self.visuals[0].angles = self.visuals[0].angles + (0, player.angles[1] - 90, 0);
...
function function_54cf80955c067c99() {
    ...
    while (true) {
        ...
        /#
            function_61501f938d933fe1(var_1b10420643377d2b);
        #/
        waitframe();
    }
}
...
function function_3cd75d5bf0fc9989(spawndata, weaponname, modelname, aitype, team) {
    ...
    if (isdefined(spawndata.script_label)) {
        ...
        if (!isdefined(var_99fe65bbdb024783)) {
            ...
            while (true) {
                player = var_99fe65bbdb024783 waittill("trigger");
                if (!is_equal(player.pers["team"], game["attackers"])) {
                    continue;
                }
                break;
...
function function_3e1d0330ae83c995() {
    ...
    foreach (var_46dcf41326948afe in var_6c77531dd8acb417) {
        ...
        var_96180425b7a1c7d1[var_96180425b7a1c7d1.size] = veh;
        veh notsolid();
    ...
    foreach (var_d2d8f892e65d8aa5 in var_10b581109fb854a2) {
        ...
        pickups = sortbydistance(var_96180425b7a1c7d1, tank.origin);
        pickup = pickups[0];
        pickup thread scripts\common\anim::anim_single_solo(pickup, "crash");
        playsoundatpos(pickup.origin + (0, 0, 15), "dst_vehicle_crush_wm");
        tank.var_6decdc73003db8d0 = 1;
        animendpos = tank namespace_f87a4b6569ce73b2::getanimendpos(level.scr_anim["veh_jup_cougar_mg"]["crash"]);
        /#
            sphere(animendpos, 10, (1, 0, 0), 0, 10000);
        #/
        nodes = sortbydistance(tank.pathnodes, animendpos);
        nextnode = nodes[0];
...
function function_685f21e11f3ea9a0(scale, duration, size) {
    level endon("game_ended");
    var_700fba7bab669f26 = getscriptablearray("silo_door_" + "zone_1", "script_noteworthy");
    var_db5de25308b03fa5 = var_700fba7bab669f26[0];
    radius = 30000;
