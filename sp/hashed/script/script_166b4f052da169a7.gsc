...
function try_to_play_vo_on_team(alias, team, is_nag, nag_cooldown, var_e2ce4e21e9100cb9) {
    ...
    foreach (player in players) {
        player thread namespace_49f64a73fb8b35eb::add_to_nag_vo(alias, "cp_comment_vo", delay_between, delay_before, 6, 1);
    }
}
...
function play_cp_comment_vo(alias_string, vo_type, priority, timeout, interrupt, pause_time, only_local) {
    ...
    foreach (player in player_array) {
        ...
        #/
        var_2ef8438b8626c369 = namespace_49f64a73fb8b35eb::create_vo_data(alias_string, timeout, pause_time, only_local);
        player thread namespace_49f64a73fb8b35eb::play_vo_system(var_2ef8438b8626c369);
    }
    wait namespace_49f64a73fb8b35eb::get_sound_length(alias_string);
    foreach (player in player_array) {
