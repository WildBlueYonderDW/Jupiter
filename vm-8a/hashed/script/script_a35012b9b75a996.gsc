...
function function_f47ab824a48fe570() {
    ...
    while (ticks < tickcount) {
        ...
        /#
            print("<dev string:x3e>" + ents.size);
        #/
        foreach (ent in ents) {
            if (!isdefined(ent)) {
                /#
                    print("<dev string:x57>" + ent getentitynumber() + "<dev string:x60>");
                #/
                continue;
            }
            if (ent == self) {
                /#
                    print("<dev string:x57>" + ent getentitynumber() + "<dev string:x6e>");
                #/
                continue;
            }
            ...
            if (!ent shockstick_canbehaywire(self)) {
                /#
                    print("<dev string:x57>" + ent getentitynumber() + "<dev string:x81>");
                #/
                continue;
            }
            /#
                print("<dev string:x57>" + ent getentitynumber() + "<dev string:x8f>");
            #/
            ...
            /#
                print("<dev string:x57>" + ent getentitynumber() + "<dev string:x9f>");
            #/
...
function function_5e15cf3721cdcaab(shockstick) {
    ...
    /#
        print("<dev string:x57>" + self getentitynumber() + "<dev string:xda>");
    #/
    if (!shouldstowweapon) {
        /#
            print("<dev string:x57>" + self getentitynumber() + "<dev string:xfb>");
        #/
