...
function private function_b2081e55f0ba302d() {
    ...
    var_afb7e0639adce453 = namespace_feea61bc660e9e0f::function_4776284a348ebb6a(50203);
...
function private function_ac531909f44e822e() {
    ...
    if (isdefined(var_a75eb3d256ae8165)) {
        level.var_a913297a5f21573e = namespace_5775ad2badedbcaa::register_interact(level.var_e286d6df718d73b4.origin + (0, 0, 100), 500, &function_2a5c422870861dd9);
        level.var_a913297a5f21573e namespace_5775ad2badedbcaa::function_e6c63f16f2258b80(&function_3710286101f0ad65);
...
function private function_da51dfe0d3ba963a() {
    var_a75eb3d256ae8165 = getstruct("grave_mirror", "targetname");
    if (isdefined(var_a75eb3d256ae8165)) {
        level.var_e286d6df718d73b4 = spawnscriptable("jup_ob_relic_mirror_grave", var_a75eb3d256ae8165.origin, var_a75eb3d256ae8165.angles);
    }
}
...
function private function_7d26705653b0f392() {
    ...
    if (numplayers == 0 || numplayers == 4) {
        var_f1dedcca27836ad7 = scripts\mp\mp_agent::spawnnewagentaitype("jup_spawner_zombie_base_armored_light", level.var_e286d6df718d73b4.origin + (100, 0, 100), (0, 0, 0), "team_two_hundred");
    ...
    if (numplayers == 1 || numplayers == 5) {
        var_f1dedcca27836ad7 = scripts\mp\mp_agent::spawnnewagentaitype("jup_spawner_zombie_base_armored_light", level.var_e286d6df718d73b4.origin + (100, 0, 0), (0, 0, 0), "team_two_hundred");
        ...
        var_f1dedcca27836ad7.var_1b74dbfbf5e984dc = &function_55dafced1c7f2392;
        var_f1dedcca27836ad7.var_51618a5cd18d54b = &function_57128172ecf78387;
        var_f1dedcca27836ad7 scripts\asm\shared\mp\utility::function_577d8abff6067c23("spawn_hop", "spawn_end", var_f1dedcca27836ad7.origin, var_f1dedcca27836ad7.angles);
        level.mirrorzombies[level.mirrorzombies.size] = var_f1dedcca27836ad7;
        return;
    }
...
function private function_14d9017001c6253c(player) {
    ...
    thread namespace_446fc987a980892f::playevent("s2_rq_mirror_start", a_squad);
    ...
    if (isdefined(killer) && isplayer(killer)) {
        ...
        if (level.var_5de02aa75c0e072 / var_d6640120b13ffd60 == 1) {
            if (isdefined(level.var_edba22ff451189cf)) {
                a_squad = level.var_edba22ff451189cf namespace_ca7b90256548aa40::getsquadmembers();
                thread namespace_446fc987a980892f::playevent("s2_rq_get_attuned_mirror_rvnv", a_squad);
...
function private function_e95070831c80ae51(player, var_f877158dac9d9e99) {
    ...
    item = namespace_2abc885019e1956::function_c465d27f3f6066b4(itembundle, level.var_edba22ff451189cf.origin, undefined, 0, 1, payload);
...
function private on_item_pickup(params) {
    if (isdefined(params.itembundlename) && params.itembundlename == "ob_jup_item_key_rift_gate_season2_mirror_attuned") {
        if (!istrue(self.var_c8e1b4654071581f)) {
            thread namespace_446fc987a980892f::playconversation("s2_rq_get_attuned_mirror_ent", [self]);
...
function private function_c183907e5f0b9d23() {
    ...
    var_3856824a46e27384 = namespace_5775ad2badedbcaa::register_interact(var_79621307dd8839f2.origin, 100, &function_3698ca59b6cea149);
...
function private function_21a7d56b7ecb4370() {
    ...
    var_c85b5636f572c6d5 = namespace_5775ad2badedbcaa::register_interact(var_125af19c369529f.origin, 100, &function_c86175c92df1ca46);
...
function private function_ce56fb2e795cd388() {
    ...
    var_efa1466b68876819 = namespace_5775ad2badedbcaa::register_interact(var_c72118276c956983.origin, 100, &function_6e0aecd9b78368fe);
...
function private function_61707196a47fd340() {
    ...
    var_6e32ce6747857b27 = namespace_5775ad2badedbcaa::register_interact(var_eda9caeee98a8fbd.origin, 100, &function_3dcc79a1e03c4ed6);
