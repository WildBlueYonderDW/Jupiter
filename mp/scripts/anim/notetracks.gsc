...
{
    [ model, tag, var_ee3807ab9a6a9c73, var_1584e0068f21668e, var_4cfe7205fd162f00 ] = function_6b6fe2ba8bff11cd( attachinfo );
    ...
    if ( model != "none" && model != "" )
    {
        ...
        spawned linkto( self, tagactual, var_1584e0068f21668e, var_4cfe7205fd162f00 );
