    ...
    while (true) {
        ...
        if (isdefined(self.var_621cfca900e38646)) {
            ...
            if (function_2789dbcb483fa601(self).size <= 1) {
                ...
                var_ad96739640faa9ff = var_ad96739640faa9ff + additional_cooldown;
            }
        ...
        if (function_fea7ee078814bf2d()) {
            ...
            if (open_all || close_all) {
                ...
                if (var_34b3ff78ac54c85b >= 1000) {
                    ...
                    /#
                        heads_print("<unknown string>" + 1000 - var_34b3ff78ac54c85b);
                    #/
                }
            }
...
function private function_4cf62c20536220fc(entity, head_index, state) {
    ...
    /#
        heads_print("<unknown string>" + var_85301775392a5e3 + "<unknown string>" + state, self.origin + (0, 0, 100 + 20 * head_index));
    #/
