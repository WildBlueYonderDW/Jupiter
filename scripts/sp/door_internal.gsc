...
function init_window() {
    ...
    var_9a01505c5f6b5e0c = getentarray(self.target, "targetname");
    foreach (var_cbd4159edb5695b7 in var_9a01505c5f6b5e0c) {
        if (!isdefined(var_cbd4159edb5695b7.script_linkto)) {
            continue;
        }
        clip = var_cbd4159edb5695b7 get_linked_ent();
        clip linkto(var_cbd4159edb5695b7);
    }
    ...
    foreach (var_cbd4159edb5695b7 in var_9a01505c5f6b5e0c) {
        if (is_equal(var_cbd4159edb5695b7.script_noteworthy, "delete_on_open")) {
            var_cbd4159edb5695b7 delete();
            continue;
        }
        originalangles = var_cbd4159edb5695b7.angles;
        vector = var_cbd4159edb5695b7.origin - level.player.origin;
        ...
        var_cbd4159edb5695b7 rotateto(goalangles, opentime, opentime * 0.8, opentime * 0.2);
        var_cbd4159edb5695b7 playsound(sound);
        if (event == "melee_pressed") {
            ...
            var_cbd4159edb5695b7 delaycall(opentime, &rotateto, var_d8bd7d9a61d3c70a, randomfloatrange(0.75, 1.25));
            var_cbd4159edb5695b7 delaycall(opentime, &playsound, "door_open_stop");
            self notify("trigger");
        }
    }
    foreach (node in linked_nodes) {
...
// Size: 0x7d
function window_melee_valid(var_d32d18dd175f9e43) {
    if (distancesquared(level.player geteye(), var_d32d18dd175f9e43) > 2025) {
        return false;
    }
    if (!within_fov(level.player.origin + anglestoforward(level.player.angles) * -50, level.player.angles, var_d32d18dd175f9e43, 0.731353)) {
        return false;
    }
    return true;
}
...
function init_door_internal(reset) {
    ...
    var_ffa56999eca9e0ba = strtok(structs[0].script_linkname, "_")[0];
    createinitialnavmodifier(var_ffa56999eca9e0ba);
...
function function_a320f9f9dda13f8f() {
    ...
    var_d2377e1fa2e404a0 = undefined;
    while (isdefined(self.cursor_hint_ent)) {
        ...
        if (isdefined(self.door.lockpick) && isdefined(self.door.lockpick.var_6a6a7087aa17ffdd)) {
            ...
            if (!is_equal(hintstring, var_d2377e1fa2e404a0)) {
                self.cursor_hint_ent sethintstring(hintstring);
            }
            var_d2377e1fa2e404a0 = hintstring;
        }
        waitframe();
    }
}
...
// Size: 0xc8
function player_door_gesture(var_846cd8d00b0ce200) {
    self notify("player_door_gesture");
    self endon("player_door_gesture");
    if (isdefined(var_846cd8d00b0ce200) && var_846cd8d00b0ce200) {
...
function pushlogic(timefactor) {
    ...
    dist = length(vec);
    var_f040b14f2844eb5f = math::normalize_value(20, 50, dist);
    var_8974dde492050a44 = math::factor_value(5, 11, var_f040b14f2844eb5f);
    dir = vectornormalize(vec);
    force = timefactor * var_8974dde492050a44;
...
function should_bash_open() {
    ...
    if (door_bashable_by_player()) {
        ...
        if (getdvarint(@"hash_fb93587642c681f")) {
        ...
        var_dadef0255a662758 = vectordot(vec, anglestoforward(scripts\sp\door::get_door_angles()));
        if (abs(var_dadef0255a662758) > 0.4) {
            return false;
        }
...
function push_door_player_effects() {
    ...
    while (true) {
        var_d7fb0ea745804aa9 = door_get_pushspot();
        var_3cb06b55e15364aa = (var_d7fb0ea745804aa9[0], var_d7fb0ea745804aa9[1], level.player.origin[2]) - level.player.origin;
        var_1a291042071ca88b = vectornormalize(var_3cb06b55e15364aa);
        var_52a4afa1649778ee = anglestoforward(level.player.angles);
        cross = vectorcross(var_52a4afa1649778ee, var_1a291042071ca88b);
        dot = vectordot(var_52a4afa1649778ee, var_1a291042071ca88b);
        var_271c6b91e677e543 = length(var_3cb06b55e15364aa);
        var_36d594eb592f4121 = level.player getnormalizedmovement();
        var_36d594eb592f4121 = (var_36d594eb592f4121[0], -1 * var_36d594eb592f4121[1], 0);
        var_e08e0aa827953208 = rotatevector(var_36d594eb592f4121, level.player.angles);
        var_e2df997a605bdbf = vectornormalize(var_e08e0aa827953208);
        var_e24f397a5fb91df = vectordot(var_e2df997a605bdbf, var_1a291042071ca88b);
        var_a870f5975b6135e7 = clamp(length(var_e08e0aa827953208), 0, 1);
        if (cross[2] > 0) {
        ...
        if (level.player isfiring()) {
            var_af52285632455309 = 0.5;
        } else {
            var_af52285632455309 = 1;
        }
        var_969f06899b0abb5c = 1;
        var_969f06899b0abb5c *= var_e36d7712ecd4be90;
        var_969f06899b0abb5c *= var_f84a6367da0e58c8;
        var_969f06899b0abb5c *= var_7646a46abc647f06;
        var_969f06899b0abb5c *= var_af52285632455309;
        ...
        var_8ec01bfdcafb22f1 = 1;
        var_e36d7712ecd4be90 = math::normalize_value(0, 1, var_e24f397a5fb91df);
        var_f84a6367da0e58c8 = math::normalize_value(0, 0.01, var_a870f5975b6135e7);
        var_7646a46abc647f06 = 1 - math::normalize_value(25, 70, var_271c6b91e677e543);
        var_8ec01bfdcafb22f1 *= var_e36d7712ecd4be90;
        var_8ec01bfdcafb22f1 *= var_f84a6367da0e58c8;
        var_8ec01bfdcafb22f1 *= var_7646a46abc647f06;
        speedscale = math::factor_value(1, 0.2, var_8ec01bfdcafb22f1);
        lerp = 0.3;
...
function door_get_pushspot() {
    ...
    var_88da70b42bdb91d4 = level.player.origin + anglestoforward(level.player.angles) * var_93271fe51551b254;
    endpoint = interact_door_get_endpoint();
    startpoint = self.origin + self.forward * 5;
    var_d7fb0ea745804aa9 = pointonsegmentnearesttopoint(startpoint, endpoint, var_88da70b42bdb91d4);
...
function initlinkednodes() {
    ...
    if (nodes.size > 0) {
        ...
        var_6538798bede76402 = undefined;
        if (isdefined(self.pivots["open_left"])) {
            var_6538798bede76402 = self.pivots["open_left"].origin;
        } else if (isdefined(self.pivots["open_right"])) {
            var_6538798bede76402 = self.pivots["open_right"].origin;
        } else {
            assertmsg("door node setup - door has neither pivot left nor right");
        }
        var_73752db085aa0240 = var_6538798bede76402 - BottomCenter;
...
function updatenodelookpeek() {
    var_ab6786247c63acc0 = angleclamp180(scripts\sp\door::get_door_angles()[1]);
    var_920ef7bdd718653c = abs(angleclamp180(var_ab6786247c63acc0 - self.true_start_angles[1]));
    if (isdefined(self.linkednodes_hinge)) {
        doorforward = anglestoforward((0, var_ab6786247c63acc0, 0));
        foreach (node in self.linkednodes_hinge) {
            if (var_920ef7bdd718653c > 90) {
                node function_e7ec030a6ad3e5f8(1);
            } else {
                node function_e7ec030a6ad3e5f8(0);
            }
            if (var_920ef7bdd718653c > 80) {
...
// Size: 0xaf
function createinitialnavmodifier(var_ffa56999eca9e0ba) {
    if (!isdefined(self.navmodifier)) {
        linkname = var_ffa56999eca9e0ba + "_nav_modifier";
...
function double_doors_waittill_bashed() {
    ...
    self endon("open_completely");
    while (true) {
        opener = self waittill("attempt_bash");
...
function double_doors_waittill_open_completely() {
    ...
    opener = self waittill("opened_completely");
