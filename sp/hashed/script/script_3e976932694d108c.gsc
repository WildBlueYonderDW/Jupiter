...
#namespace jup_enemy_cp_smg_tier3_rus_pmc;

// Namespace jup_enemy_cp_smg_tier3_rus_pmc / namespace_31b42351a8a9ee0c
// Params 0, eflags: 0x0
// Checksum 0x0, Offset: 0x584
// Size: 0x27c
function main() {
    self.aitypeid = function_2336488258354fbc(#"aitype", %"jup_enemy_cp_smg_tier3_rus_pmc");
...
// Size: 0x106
function precache() {
    agent_type = "actor_jup_enemy_cp_smg_tier3_rus_pmc";
