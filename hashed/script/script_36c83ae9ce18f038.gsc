...
function init(config) {
    ...
    eventinfo.validatefunc = &function_3e0ab74e4391f51;
    ...
    eventinfo.var_b9b56551e1acfee2 = namespace_c711384b1335919::function_8be9bae8228a91f7("doublexp_crate");
    scripts/mp/gametypes/br_publicevents::function_5b7d8ca93f8705f1(eventinfo, "doublexp_crate");
    scripts/mp/gametypes/br_publicevents::registerpublicevent(19, eventinfo);
    initdialog();
    /#
...
function postinitfunc() {
    ...
    /#
        assertex(level.var_849fbfb162366139.xpmultiplier >= 1, "XP Multiplier can not be strictly lower than 1.0.");
    #/
}
...
function function_daa510e2d1ce6f2f() {
    ...
    if (level.var_849fbfb162366139.var_1e5a000c9dd647d9) {
        teamplayers = array_removeundefined(scripts/mp/utility/teams::getteamdata(player.team, "players"));
...
function debug_init() {
    /#
        scripts/common/devgui::function_6e7290c8ee4f558b("brloot_super_deployablekiosk");
        scripts/common/devgui::function_a9a864379a098ad6("dlog_event_doublexp_crate_participation", "<unknown string>", &function_db70bae7732f5204);
...
function function_db70bae7732f5204() {
    /#
        level thread scripts/mp/gametypes/br_publicevents::function_e37ee072d95a7c98(19);
    #/
}
