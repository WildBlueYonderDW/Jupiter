...
function function_1be9145b47c4b31d() {
    ...
    setsaveddvar(@"sm_roundRobinPrioritySpotShadows", 12);
    ...
    setsaveddvar(@"sm_spotUpdateLimitDynLight", 7);
    if (isplatformpc()) {
        setsaveddvar(@"sm_spotUpdateLimit", 12);
    }
...
function function_fe37660adcbfb21d() {
    ...
    setsaveddvar(@"r_mbVelocityScale", 1.5);
