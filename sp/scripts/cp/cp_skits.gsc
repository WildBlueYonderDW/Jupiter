...
// Namespace namespace_ad492105b76fa6f9 / scripts\cp\cp_skits
// Params 0, eflags: 0x0
...
function death_fight2(victim) {
    ...
    namespace_223959d3e5206cfb::placeweaponon(self.og_weapon, "right");
    namespace_223959d3e5206cfb::placeweaponon(self.sidearm, "none");
    reset_guy(self);
}
...
function end_game_cheer() {
    self endon("death");
    self endon("alerted");
    namespace_5729d24318b60bcd::set_demeanor_from_unittype("patrol");
    namespace_5729d24318b60bcd::set_goal_radius(4);
    namespace_5729d24318b60bcd::set_goal_pos(self.origin);
    self.ignoreall = 1;
    self.ignoreme = 1;
    self takeallweapons();
    fists = namespace_e0ee43ef2dddadaa::buildweapon("iw9_me_fists_mp", [], "none", "none", -1);
    self giveweapon(fists);
    namespace_223959d3e5206cfb::forceuseweapon(fists, "primary");
    wait 0.5;
