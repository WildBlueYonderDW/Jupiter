...
/#
    ...
    function function_d1d70c73f09a1540() {
        function_6e7290c8ee4f558b("<dev string:x7a>");
        devgui::function_b23a59dfb4ca49a1("<dev string:x8f>", "<dev string:xa0>", &namespace_2abc885019e1956::function_f8162124bbb6ece3);
        devgui::function_b23a59dfb4ca49a1("<dev string:xc5>", "<dev string:xe0>", &namespace_2abc885019e1956::function_f8162124bbb6ece3);
        devgui::function_b23a59dfb4ca49a1("<dev string:x11a>", "<dev string:x136>", &namespace_2abc885019e1956::function_f8162124bbb6ece3);
        devgui::function_b23a59dfb4ca49a1("<dev string:x177>", "<dev string:x194>", &function_7c7d7717c1af82bf);
