...
// Size: 0x220
function main() {
    self.var_9d26ac1e325367ce = function_2336488258354fbc(#"aitype", %"jup_ob_enemy_specialist_sniper");
    ...
    case 0:
        var_fea750d6814b803d = "iw9_sn_mromeo, [ stock_sn_tactical_p21, comp_dm_05 ], none, none";
        self.weapon = level.var_67b54180a55f70e1[var_fea750d6814b803d];
        break;
    case 1:
        var_fea750d6814b803d = "iw9_dm_xmike2010, [ bar_sn_heavy_p20_xmike2010, comp_dm_01 ], none, none";
        self.weapon = level.var_67b54180a55f70e1[var_fea750d6814b803d];
        break;
    }
...
function function_e8cf870298e36bdc() {
    ...
    if (!isdefined(level.var_67b54180a55f70e1[var_5576d3be590a9a64])) {
        level.var_67b54180a55f70e1[var_5576d3be590a9a64] = namespace_d19129e4fa5d176::function_e83615f8a92e4378("iw9_sn_mromeo", [0:"stock_sn_tactical_p21", 1:"comp_dm_05"], "none", "none");
    }
    ...
    if (!isdefined(level.var_67b54180a55f70e1[var_5576d6be590aa0fd])) {
        level.var_67b54180a55f70e1[var_5576d6be590aa0fd] = namespace_d19129e4fa5d176::function_e83615f8a92e4378("iw9_dm_xmike2010", [0:"bar_sn_heavy_p20_xmike2010", 1:"comp_dm_01"], "none", "none");
    }
    var_4f04b9c326eb7400 = "iw9_pi_swhiskey, [ none, none, none, none, none, none ], none, none";
