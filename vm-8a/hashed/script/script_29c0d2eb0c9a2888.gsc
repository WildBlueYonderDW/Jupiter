    ...
    foreach (flag in objectives) {
        ...
        /#
            if (flag.nodes.size < var_c9d880ac3d2f2d31) {
                ...
                wait wait_time;
                assertmsg("<dev string:x2b>" + flag.objectivekey + "<dev string:x3d>" + flag.trigger.origin + "<dev string:x4c>");
            }
        #/
    }
...
function function_39e20401248b86ab() {
    /#
        if (getdvar(@"hash_f19136a5e98370dc") == "<dev string:x7a>") {
            return true;
        }
    #/
    return false;
...
function function_4646fcbe22380b06() {
    /#
        if (getdvar(@"hash_7788693976c0a271") == "<dev string:x7a>") {
            return true;
        }
    #/
    return false;
