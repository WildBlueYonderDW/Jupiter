...
function private getstartspawnpoint(player) {
    ...
    if (!isdefined(spawnpoint) && level.var_7a8e039103b51e0f.size) {
        ...
        if (isdefined(spawnpoint)) {
            println("<dev string:x2cff>" + player.sessionsquadid + "<dev string:x2d43>" + player.var_3f78c6a0862f9e25 + "<dev string:x2d57>");
...
function private obgetspawnpoint() {
    ...
    assertex(isdefined(spawnpoint), "<dev string:x2dff>" + self.sessionsquadid + "<dev string:x2e26>" + self.var_3f78c6a0862f9e25);
    return spawnpoint;
}
...
function private function_db15e0482a87b0a8() {
    if (isdefined(self)) {
        return (istrue(self.var_28c033c3c5b37f1f) || istrue(self.hasgoldenammo) || isdefined(self.var_c5668dcaf32afbc3) || istrue(self.var_8a13c2b607afaae7) || istrue(self.var_7724569d0029dd40) || istrue(self.var_737ac766fe3a46e0) || istrue(self.var_194cdb94551bc049) || istrue(self.var_209d25b535dfbcf));
    }
    return false;
}
