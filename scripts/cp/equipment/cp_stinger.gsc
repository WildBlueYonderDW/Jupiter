...
function stingerusage() {
    ...
    if (self.stingerstage == 0) {
        ...
        self.stingertarget = var_1fe8eeb95943f79f.target;
    ...
    if (self.stingerstage == 1) {
        ...
        var_1fe8eeb95943f79f = stingtargstruct_create(self, self.stingertarget);
        var_1fe8eeb95943f79f stingtargstruct_getoffsets();
        var_1fe8eeb95943f79f stingtargstruct_getorigins();
        var_1fe8eeb95943f79f stingtargstruct_getinreticle();
        if (!var_1fe8eeb95943f79f stingtargstruct_isinreticle()) {
        ...
        offset = undefined;
        stinger_finalizelock(var_1fe8eeb95943f79f);
...
function lockonlaunchers_gettargetarray(addcharacters) {
    ...
    if (level.teambased) {
        ...
        var_dddc24ba34981c53 = scripts\cp_mp\vehicles\vehicle_tracking::vehicle_tracking_getgameinstances("light_tank");
...
// Size: 0x73
function stinger_finalizelock(var_1fe8eeb95943f79f) {
    offset = undefined;
...
function stingtargstruct_getinlos() {
    ...
    trace = ray_trace(caststart, self.origins[0], var_7c44f2c83cc7cf1e, contents, 0);
    if (trace["fraction"] == 1) {
        self.inlosid = 0;
        return;
    }
...
/#
    ...
    function function_ea032d8f50d4fef2(target) {
        if (getdvar(@"hash_b56d344ee60e317f") != "<dev string:x22>") {
            return;
        }
        if (!isdefined(target)) {
            return;
