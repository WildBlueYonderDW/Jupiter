...
#using character\character_al_qatala_desert_ar.gsc;
#using scripts\cp_mp\agents\agent_init.gsc;
#using scripts\aitypes\assets.gsc;
#using scripts\mp\class.gsc;

#namespace namespace_4034b28d6ce80723;

// Namespace namespace_4034b28d6ce80723 / namespace_4f4b790ed0cfffd8
// Params 0, eflags: 0x0
// Checksum 0x0, Offset: 0x226
// Size: 0x1e0
function main() {
    self.aitypeid = function_2336488258354fbc(#"aitype", %"hash_2fdb943e3aa03616");
...
function precache() {
    ...
    if (!isdefined(level.agent_definition[agent_type])) {
        ...
        level.agent_definition[agent_type]["subclass"] = getscriptbundle(%"hash_13c77521a3707349");
        character\character_al_qatala_desert_ar::function_8168fbf6282d398b();
    }
