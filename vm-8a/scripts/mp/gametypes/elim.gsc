...
/#
    ...
    function function_811292df738947aa() {
        ...
        scripts\common\devgui::function_a9a864379a098ad6("<dev string:x43>", "<dev string:x59>", &function_9e2eca1aedfb8e4);
        scripts\common\devgui::function_a9a864379a098ad6("<dev string:x74>", "<dev string:x8d>", &function_a2e6be25493acaed);
        scripts\common\devgui::function_a9a864379a098ad6("<dev string:xab>", "<dev string:xbc>", &function_53da610a95ce4073);
        scripts\common\devgui::function_a9a864379a098ad6("<dev string:xca>", "<dev string:xdd>", &function_bb509befa79c026);
    ...
    function function_9e2eca1aedfb8e4() {
        foreach (player in level.players) {
            player scripts\mp\hud_message::function_51614e8fce37b07f("<dev string:xed>", level.gametypebundle.var_3b841d10cb84cb06);
        }
    }
    ...
    function function_a2e6be25493acaed() {
        foreach (player in level.players) {
            player scripts\mp\hud_message::function_51614e8fce37b07f("<dev string:x102>", level.gametypebundle.var_3b841d10cb84cb06);
        }
    }
    ...
    function function_ca18c921f35b6ef() {
        ...
        while (true) {
            if (getdvarint(@"hash_ca96aac073a2fff9", 0)) {
                ...
                team = host.team;
                teamcount = getteamdata(team, "<dev string:x125>");
                while (level.teamdata[team]["<dev string:x12f>"] > teamcount) {
    ...
    function function_c9cb37cdd0caa2f4() {
        ...
        while (true) {
            if (getdvarint(@"hash_46a6b424af6acbc2") != 0) {
                scripts\mp\gamescore::giveteamscoreforobjective("<dev string:x140>", getdvarint(@"hash_46a6b424af6acbc2"), 0);
                break;
            } else if (getdvarint(@"hash_86e14326e43c0115") != 0) {
                scripts\mp\gamescore::giveteamscoreforobjective("<dev string:x147>", getdvarint(@"hash_86e14326e43c0115"), 0);
                break;
            }
            wait 1;
        }
