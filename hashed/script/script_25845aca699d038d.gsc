...
// Namespace damage / namespace_1b51be0488919ce5
...
function callback_playerdamage(einflictor, eattacker, idamage, idflags, smeansofdeath, fdistance, objweapon, vpoint, vdir, shitloc, timeoffset, modelindex, partname, var_b0fc59ff15058522, var_be4285b26ed99ab1) {
    ...
    if (vehicle::function_e4768bd722e98562(einflictor, victim, smeansofdeath)) {
        return;
    }
    ...
    if (var_b219c83cbe91cb08) {
        if (eattacker == self) {
            ...
            if (isplayer(victim) && isplayer(eattacker) && function_2d0fd85607e87a4(objweapon)) {
                level thread namespace_8b0201354228db72::trysaylocalsound(victim, #"hash_2a23c8694884293e");
            }
        }
    ...
    var_81846c5d601875ef = self getcurrentprimaryweapon();
    if (var_81846c5d601875ef.type == "melee") {
        idamage = int(idamage * self.perk_data["carrying_melee_damage_scalar"]);
    }
    if (var_81846c5d601875ef.basename == "iw9_me_riotshield_mp") {
    ...
    if (objweapon.basename == "claymore_radial_mp") {
        ...
        if (!isdefined(einflictor) && var_b219c83cbe91cb08) {
            idamage = namespace_bd9fbcae69e50ecf::claymore_modifieddamage(victim, objweapon, eattacker, smeansofdeath, idamage);
        }
    }
    ...
    if (var_b219c83cbe91cb08 && idamage > 0) {
        ...
        if (isai(eattacker) || isplayer(eattacker) && eattacker != self) {
            namespace_70e2acbe1967ad9e::addattacker(self, eattacker, einflictor, objweapon, idamage, vpoint, vdir, shitloc, timeoffset, smeansofdeath);
        ...
        if (armor::hasarmor() && armor::armor_resistance_to_type(smeansofdeath, objweapon, einflictor, eattacker)) {
            if (!function_d366c45977d13d86() && isdefined(shitloc) && shitloc != "shield") {
                if (isdefined(self.jugg_health)) {
                    ...
                    idamage = 0;
                    var_57accdc40b2f50e = armor::function_90ce8eb3ddaa4943(eattacker, einflictor, victim, idamage, objweapon, smeansofdeath, shitloc, idflags, var_be4285b26ed99ab1, unmodifieddamage);
                    var_1da1a66b5c6a06a7 = var_57accdc40b2f50e[1];
                    idamage = var_57accdc40b2f50e[0];
                } else {
                    var_57acddc40b2f741 = armor::function_90ce8eb3ddaa4943(eattacker, einflictor, victim, idamage, objweapon, smeansofdeath, shitloc, idflags, var_be4285b26ed99ab1, unmodifieddamage);
    ...
    namespace_47908dddf85b62d::update_personal_encounter_performance("personal", "damage_taken", idamage);
    if (idamage != 0) {
        thread namespace_d2d25ee15dd5f89d::player_damage_blood();
    }
    if (var_b219c83cbe91cb08) {
    ...
    if (utility::isbulletdamage(smeansofdeath)) {
        victim thread namespace_8b0201354228db72::adddamagetaken(eattacker, objweapon, idamage);
        if (isdefined(victim) && victim player_utility::_isalive() && victim.health < 30) {
            victim thread namespace_8b0201354228db72::hurtbadlywait();
        }
    }
    if (isdefined(eattacker) && isagent(eattacker) && eattacker player_utility::_isalive() && eattacker != victim) {
        victim thread namespace_8b0201354228db72::addrecentattacker(eattacker);
        if (utility::isbulletdamage(smeansofdeath)) {
            function_216c67ab6749137a(eattacker, undefined, "shot_at_target", "target_wounded");
        }
    }
    if (isdefined(victim) && victim.health <= 1) {
        victim namespace_8b0201354228db72::onplayerkilled(einflictor, eattacker, idamage, smeansofdeath, objweapon);
    }
}
...
function isexplosivedamage(type) {
    ...
    return utility::array_contains(var_708e6b05c3ee97e1, type);
}
...
function modifyfalldamage(victim, idamage, idflags, smeansofdeath) {
    ...
    if (isdefined(smeansofdeath) && smeansofdeath == "MOD_FALLING") {
        if (istrue(self.isjuggernaut) && !istrue(self.var_ca56839b2e00edce)) {
            modifieddamage = victim namespace_d0e14122d860dddb::jugg_modifyfalldamage();
...
function check_for_explosive_shotgun_damage(alien, idamage, eattacker, sweapon, smeansofdeath) {
    ...
    if (sweapon.classname == "weapon_shotgun") {
        ...
        var_326616b4920fd3da = idamage * 8;
        scaled_damage = var_326616b4920fd3da * scale;
        if (dist > max_dist) {
            return idamage;
        }
...
// Size: 0x263
function function_8aaf577e3d797e05(current_origin, enemy, idamage, smeansofdeath, var_fa0d4cca2b2ec6bb, shockmelee, var_c74157caaaf53945) {
    ...
    shocked = 0;
    var_3b79136f23c59276 = 0;
    var_41cc5fab7e69635e = 4;
    if (!isdefined(var_fa0d4cca2b2ec6bb)) {
        var_fa0d4cca2b2ec6bb = 256;
    }
    enemies = namespace_3ecbde0d8fbeff2::getaliveagentsofteam("axis");
    var_a4a7cbaacb7cc0cd = utility::get_array_of_closest(enemy.origin, enemies, undefined, var_41cc5fab7e69635e, var_fa0d4cca2b2ec6bb, 1);
    if (utility::array_contains(var_a4a7cbaacb7cc0cd, enemy)) {
        var_a4a7cbaacb7cc0cd = utility::array_remove(var_a4a7cbaacb7cc0cd, enemy);
    }
    if (var_a4a7cbaacb7cc0cd.size >= 1) {
        if (!isdefined(self.stun_struct)) {
        ...
        foreach (guy in var_a4a7cbaacb7cc0cd) {
            if (isdefined(guy) && guy != enemy && isalive(guy) && !istrue(guy.stunned)) {
                ...
                var_3b79136f23c59276++;
                if (var_3b79136f23c59276 >= var_41cc5fab7e69635e) {
                    break;
                }
            }
        }
...
// Size: 0x123
function function_25ecc1ec5bb26160(player, idamage, smeansofdeath, var_e98cad4362274441) {
    self endon("death");
    waitframe();
    var_9239d8be6122bdc5 = undefined;
    if (!isdefined(self) || !isalive(self)) {
        return;
    }
    origins = ["j_crotch", "j_hip_le", "j_hip_ri", "j_shoulder_le", "j_shoulder_ri", "j_chest"];
    var_9239d8be6122bdc5 = self gettagorigin(utility::random(origins));
    if (isdefined(var_9239d8be6122bdc5)) {
        playfxbetweenpoints(level._effect["blue_ark_beam"], var_e98cad4362274441, vectortoangles(var_e98cad4362274441 - var_9239d8be6122bdc5), var_9239d8be6122bdc5);
        wait 0.05;
        ...
        fx::playfxnophase(level._effect["stun_shock"], var_9239d8be6122bdc5);
        if (isdefined(self)) {
...
function disabledamageinvulnerability() {
    ...
    namespace_8fe9ad1b5888debe::update_player_attacker_accuracy();
}
...
function getTakeCoverWarnings() {
    ...
    if (function_3cb5da19764baa3() == "JUP") {
        takecoverwarnings = self function_f811dfc822b6f33a("spData", "takeCoverWarnings");
...
function setTakeCoverWarnings(count) {
    if (function_3cb5da19764baa3() == "JUP") {
        self function_2bd9c79b322a6eae("spData", "takeCoverWarnings", count);
        return;
    }
...
function oldhealthregen(hurttime, healthratio) {
    ...
    var_7714b89c368a249e = spawnstruct();
    utility::getregendata(var_7714b89c368a249e);
    wait var_7714b89c368a249e.activatetime;
    time = gettime();
    while (true) {
        ...
        if (self.health < int(healthcap)) {
            newhealth = int(self.health + var_7714b89c368a249e.regenamount);
        ...
        utility::waittill_any_timeout_1(var_7714b89c368a249e.waittimebetweenregen, "force_regeneration");
    }
    self notify("healed");
    /#
    #/
...
function getmodifiedantikillstreakdamage(attacker, objweapon, meansofdeath, amount, maxhealth, var_cb15fa5174e71840, var_be7c04516c5d9ccd, var_ca960a517459fe15, var_8aceb016baaf67af, explodeoverride) {
    ...
    if (isdefined(objweapon)) {
        var_c8db68af3cdd6da3 = objweapon.isalternatemode;
    }
    ...
    if (isdefined(var_f1563935aeeb5199) && isdefined(meansofdeath) && (meansofdeath == "MOD_EXPLOSIVE" || meansofdeath == "MOD_EXPLOSIVE_BULLET" || meansofdeath == "MOD_FIRE" || meansofdeath == "MOD_PROJECTILE" || meansofdeath == "MOD_PROJECTILE_SPLASH" || meansofdeath == "MOD_GRENADE" || meansofdeath == "MOD_GRENADE_SPLASH" || meansofdeath == "MOD_MELEE")) {
...
function playerkilled_sharedlogic_early(deathdata) {
    ...
    namespace_d5ba12e50c252acd::clearoob(victim, 1);
    victim namespace_c71daea9de43cc5::molotov_clear_fx();
    ...
    if (meansofdeath == "MOD_EXECUTION") {
        ...
        level thread namespace_8b0201354228db72::trysaylocalsound(attacker, "flavor_execution", undefined, 1);
    }
    ...
    if (istrue(level.var_2dce4d6dcb6c3fb9)) {
        ...
        victim equipment::function_7c70dc615da72c51();
    }
    ...
    victim namespace_8b0201354228db72::onplayerkilled(inflictor, attacker, damage, meansofdeath, objweapon, deathdata.direction_vec, deathdata.hitloc, deathdata.psoffsettime, deathdata.deathanimduration, deathdata.lifeid);
...
function handlenormaldeath(lifeid, attacker, einflictor, objweapon, smeansofdeath, victim, iskillstreakweapon, deathdata, var_c7944407e05a6f77) {
    if (smeansofdeath == "MOD_GRENADE" && einflictor == attacker) {
        namespace_70e2acbe1967ad9e::addattacker(victim, attacker, einflictor, objweapon, deathdata.damage, (0, 0, 0), deathdata.direction_vec, deathdata.hitloc, deathdata.psoffsettime, smeansofdeath);
    }
    deathdata.dokillcam = 0;
    ...
    if (isdefined(var_d2db6cb7f6d5d36d.pers) && !istrue(var_d2db6cb7f6d5d36d.pers["ignoreWeaponMatchBonus"]) && (weapon::iscacprimaryweapon(objweapon) || weapon::iscacsecondaryweapon(objweapon))) {
        ...
        if (!function_ccf98e6391dd38b9()) {
            if (var_d2db6cb7f6d5d36d.pers["weaponMatchBonusKills"] > namespace_f125e4a25d33be15::getgametypekillspermatchmaximum()) {
    ...
    if (!attacker utility::isusingremote()) {
        ...
        if (wassniper) {
            level thread namespace_8b0201354228db72::trysaylocalsound(attacker, #"hash_2ee580bbe139941a", undefined, 0.75);
        } else {
            level thread namespace_8b0201354228db72::trysaylocalsound(attacker, #"hash_29c83d721f765ab4", undefined, 0.75);
        }
    }
    vocallout = undefined;
    if (isdefined(vocallout)) {
        level thread namespace_8b0201354228db72::saytoself(attacker, vocallout, "plr_killfirm_generic", 0.75);
    }
}
...
function handlenormaldeath_sounds(attacker, victim, smeansofdeath, einflictor) {
    ...
    if (isplayer(victim)) {
        ...
        victim namespace_4887422e77f3514e::function_a2b4e6088394bade();
        victim.deathsdoor = 0;
    }
}
...
function gamehasstarted() {
    ...
    foreach (team in level.teamnamelist) {
        if (namespace_1d2f0cc78b0ded34::getteamdata(team, "hasSpawned")) {
            return 1;
        }
    }
    return 0;
...
function timeuntilspawn(includeteamkilldelay) {
    ...
    if (self.hasspawned) {
        if (isdefined(level.onrespawndelay)) {
            ...
            if (isdefined(result)) {
                ...
                respawndelay = getdvarfloat(hashcat(@"hash_d98c82b5a26dc973", utility::getgametype(), "_playerrespawndelay"));
            }
        } else {
            respawndelay = getdvarfloat(hashcat(@"hash_d98c82b5a26dc973", utility::getgametype(), "_playerrespawndelay"));
        }
        if (isdefined(self.suicidespawndelay)) {
            respawndelay += getdvarfloat(hashcat(@"hash_d98c82b5a26dc973", utility::getgametype(), "_suicidespawndelay"));
        }
    ...
    wavebased = getdvarint(hashcat(@"hash_d98c82b5a26dc973", utility::getgametype(), "_waverespawndelay")) > 0;
    if (level.ingraceperiod && !self.hasspawned || level.gameended) {
        respawndelay = 0;
