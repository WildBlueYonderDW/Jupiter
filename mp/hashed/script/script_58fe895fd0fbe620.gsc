...
function function_4cadbb00ef649ee1(instance, part, state, player, var_a5b2c541413aa895, usestring) {
    ...
    if (state == "defusable") {
        ...
        while (buttontime < level.demoprops.defusetime) {
            if (node.cancel || !scripts\mp\utility\player::isAliveAndNotInLastStand(player) || istrue(task.failure) || isdefined(player.var_2ca0dac193d83c1) && player.var_2ca0dac193d83c1) {
                node.defusing = 0;
                function_db896f4486ca187(player, bomb);
