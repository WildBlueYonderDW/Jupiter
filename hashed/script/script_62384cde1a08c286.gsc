...
function function_44bc02179cd2ed83(player) {
    ...
    ent usetriggerrequirelookat(1);
    ent thread function_17763afd915cc73c();
    newbuildable thread function_a0f277273d13196a("zone_2");
}
...
function function_714ca74c07bcc71c() {
    ...
    foreach (ent in ents) {
        ...
        buildable.halfclip.origin = buildable.halfclip.origin - (0, 0, 400);
        buildable.fullclip.origin = buildable.fullclip.origin - (0, 0, 400);
...
function function_60897351370d2636() {
    ...
    foreach (ent in ents) {
        ...
        var_3e61289b681334e5 = getentitylessscriptablearray(c4struct.target + "_panel", "script_noteworthy");
        controlpanel = var_3e61289b681334e5[0];
...
function function_d75c2c4738e6ea9c(player, buildable) {
    ...
    level thread namespace_66ade5cda10fe3aa::function_2cc59ea2a67bd2f4(buildable.triggerent.c4struct, buildable.triggerent.c4struct.turrets, "jup_skydiving_laser_trap_c4");
    buildable.triggerent.c4struct.turrets[0] setupdirection();
...
function function_adc7327a592cc4a1() {
    ...
    foreach (ent in var_f3f22330151d410a) {
        if (isdefined(ent.equipmentref) && ent.equipmentref == "equip_tac_cover") {
            ent scripts/mp/equipment/tactical_cover::tac_cover_destroy(undefined, 0);
        }
    }
}
