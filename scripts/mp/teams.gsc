...
// Namespace teams / scripts/mp/teams
...
function updateplayertimes() {
    ...
    while (true) {
        ...
        for (startplayer = 0; startplayer < playercount; startplayer = startplayer + 20) {
...
function function_19300abfbb10928b() {
    ...
    if (scripts/cp_mp/utility/game_utility::isbrstylegametype()) {
        timeplayed = timeplayed - default_to(self.timeplayed["gulag"], 0);
        timeplayed = timeplayed - default_to(self.timeplayed["resurgenceRespawn"], 0);
        timeplayed = timeplayed - default_to(self.timeplayed["infil"], 0);
    }
    ...
    while (true) {
        if (isdefined(level.teamdata)) {
            ...
            foreach (team in level.teamnamelist) {
                linecount = 1;
                /#
                    printtoscreen2d(startx, starty + stepy * linecount, "<unknown string>" + team, (1, 1, 1), 1);
                #/
                linecount++;
