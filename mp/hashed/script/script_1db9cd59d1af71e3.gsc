...
#namespace jup_enemy_mp_ar_tier1_pmc;

// Namespace jup_enemy_mp_ar_tier1_pmc / namespace_10285ffa0601ea05
// Params 0
// Checksum 0x0, Offset: 0x263
// Size: 0x1de
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_mp_ar_tier1_pmc" );
...
function precache()
{
    agent_type = "actor_jup_enemy_mp_ar_tier1_pmc";
