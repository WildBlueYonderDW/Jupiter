...
/#
    ...
    function function_b2a63c397eb5ccdf(player, buildfunc) {
        ...
        while (true) {
            function_9384c9ed097bf7b9(player, "<dev string:x1c>", "<dev string:x27>");
            ...
            function_9384c9ed097bf7b9(player, "<dev string:x29>", "<dev string:x33>");
    ...
    function function_710d2b779609907d(player, animstruct) {
        animstruct endon("<dev string:x35>");
        while (true) {
            level.var_ca629cf434263639 = 0;
    ...
    function function_b51365f787d44355(player, animstruct) {
        ...
        startangles = player getplayerangles();
        while (true) {
            while (!player buttonpressed("<dev string:x3f>")) {
                waitframe();
            }
            player playershow();
            player function_985b0973f29da4f8("<dev string:x47>");
            player cameraunlink();
            player disablephysicaldepthoffieldscripting();
            if (isdefined(animstruct.activepack)) {
            ...
            player playerhide();
            player scripts\cp_mp\utility\player_utility::function_379bb555405c16bb("<dev string:x47>");
            player enablephysicaldepthoffieldscripting();
            while (player buttonpressed("<dev string:x3f>")) {
                waitframe();
            }
    ...
    function endanimsequence(player, animstruct) {
        animstruct notify("<dev string:x35>");
