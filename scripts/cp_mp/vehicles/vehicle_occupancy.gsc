...
function vehicle_occupancy_getexitposition(vehicle, player, exitid, exitinfo, allowairexit) {
    ...
    case #"hash_4b8799075d3a89b8":
        ...
        if (castingdown) {
            downoffset = downoffset + abs(sin(var_566b4a8c9324219)) * (data.exitextents["front"] + 16);
            var_3e656678779cc7e9 = data.exitextents["front"] + abs(var_33c8684fb7c8588d) * data.exitextents["top"];
            tiltoffset = tiltoffset + abs(cos(var_566b4a8c9324219) * var_3e656678779cc7e9);
            exitoffset = (max(exitoffset[0], tiltoffset), exitoffset[1], exitoffset[2]);
        } else {
            tiltoffset = tiltoffset + min(abs(var_33c8684fb7c8588d), 1) * (data.exitextents["bottom"] + 10);
    ...
    case #"hash_5163a22eb8c03302":
        ...
        castingdown = var_33c8684fb7c8588d < 0;
        if (castingdown) {
            downoffset = downoffset + abs(sin(var_566b4a8c9324219)) * (data.exitextents["back"] + 16);
    ...
    case #"hash_c9b3133a17a3b2d0":
        ...
        castingdown = var_33c8684fb7c8588d < 0;
        if (castingdown) {
            downoffset = downoffset + abs(sin(var_566b4a8c9324219)) * (data.exitextents["left"] + 16);
    ...
    case #"hash_96815ce4f2a3dbc5":
        ...
        castingdown = var_33c8684fb7c8588d > 0;
        if (castingdown) {
            downoffset = downoffset + abs(sin(var_566b4a8c9324219)) * (data.exitextents["right"] + 16);
    ...
    if (isdefined(var_145d0dc29d9bde7) && (istrue(var_145d0dc29d9bde7[1]) || isdefined(var_145d0dc29d9bde7[0]) && isdefined(var_145d0dc29d9bde7[0][0]) && isdefined(var_145d0dc29d9bde7[0][0]["position"]))) {
        /#
            ...
            if (isdefined(var_145d0dc29d9bde7[0]) && isdefined(var_145d0dc29d9bde7[0][0]) && isdefined(var_145d0dc29d9bde7[0][0]["<unknown string>"])) {
                finalposition = var_145d0dc29d9bde7[0][0]["<unknown string>"];
            }
...
function private function_fe33f8f45b65696e(player, caststart, castend, ignorelist, allowairexit, exitdirection) {
    ...
    /#
        if (istrue(level.var_8962097bbd2afcb4)) {
            ...
            if (castfailed && isdefined(castresults[0][0]) && isdefined(castresults[0][0]["<unknown string>"])) {
                level thread function_2127168686332a93(castresults[0][0]["<unknown string>"], 2, 60, (1, 0, 0));
            }
        }
    #/
    if (castfailed) {
    ...
    if (isdefined(vehicle.exitboundinginfo) && vehicle.exitboundinginfo.timestamp == gettime()) {
        ...
        if (isdefined(var_e2818ad39a3341b4) && isdefined(var_e2818ad39a3341b4.exitextents)) {
            ...
            /#
                ...
                topleftfront = rotatevector((var_e2818ad39a3341b4.exitextents["<unknown string>"], var_e2818ad39a3341b4.exitextents["<unknown string>"] * -1, var_e2818ad39a3341b4.exitextents["<unknown string>"]), angles);
                toprightfront = rotatevector((var_e2818ad39a3341b4.exitextents["<unknown string>"], var_e2818ad39a3341b4.exitextents["<unknown string>"], var_e2818ad39a3341b4.exitextents["<unknown string>"]), angles);
                topleftback = rotatevector((var_e2818ad39a3341b4.exitextents["<unknown string>"] * -1, var_e2818ad39a3341b4.exitextents["<unknown string>"] * -1, var_e2818ad39a3341b4.exitextents["<unknown string>"]), angles);
                toprightback = rotatevector((var_e2818ad39a3341b4.exitextents["<unknown string>"] * -1, var_e2818ad39a3341b4.exitextents["<unknown string>"], var_e2818ad39a3341b4.exitextents["<unknown string>"]), angles);
                bottomleftfront = rotatevector((var_e2818ad39a3341b4.exitextents["<unknown string>"], var_e2818ad39a3341b4.exitextents["<unknown string>"] * -1, var_e2818ad39a3341b4.exitextents["<unknown string>"] * -1), angles);
                bottomrightfront = rotatevector((var_e2818ad39a3341b4.exitextents["<unknown string>"], var_e2818ad39a3341b4.exitextents["<unknown string>"], var_e2818ad39a3341b4.exitextents["<unknown string>"] * -1), angles);
                ...
                exitboundinginfo.orientedboxpoints["<unknown string>"] = vehicle.origin + topleftfront;
                exitboundinginfo.orientedboxpoints["<unknown string>"] = vehicle.origin + toprightfront;
                exitboundinginfo.orientedboxpoints["<unknown string>"] = vehicle.origin + topleftback;
                exitboundinginfo.orientedboxpoints["<unknown string>"] = vehicle.origin + toprightback;
                exitboundinginfo.orientedboxpoints["<unknown string>"] = vehicle.origin + bottomleftfront;
                exitboundinginfo.orientedboxpoints["<unknown string>"] = vehicle.origin + bottomrightfront;
                ...
                exitboundinginfo.unorientedboxpoints["<unknown string>"] = vehicle.origin + rotatevector((bestfront, bestleft, besttop), var_74e1fbef334a1e72);
                exitboundinginfo.unorientedboxpoints["<unknown string>"] = vehicle.origin + rotatevector((bestfront, bestright, besttop), var_74e1fbef334a1e72);
                exitboundinginfo.unorientedboxpoints["<unknown string>"] = vehicle.origin + rotatevector((bestback, bestleft, besttop), var_74e1fbef334a1e72);
                exitboundinginfo.unorientedboxpoints["<unknown string>"] = vehicle.origin + rotatevector((bestback, bestright, besttop), var_74e1fbef334a1e72);
                exitboundinginfo.unorientedboxpoints["<unknown string>"] = vehicle.origin + rotatevector((bestfront, bestleft, bestbot), var_74e1fbef334a1e72);
                exitboundinginfo.unorientedboxpoints["<unknown string>"] = vehicle.origin + rotatevector((bestfront, bestright, bestbot), var_74e1fbef334a1e72);
                exitboundinginfo.unorientedboxpoints["<unknown string>"] = vehicle.origin + rotatevector((bestback, bestleft, bestbot), var_74e1fbef334a1e72);
                exitboundinginfo.unorientedboxpoints["<unknown string>"] = vehicle.origin + rotatevector((bestback, bestright, bestbot), var_74e1fbef334a1e72);
            #/
    ...
    if (!ignorelos) {
        ...
        if (isdefined(castresults) && castresults.size > 0) {
            ...
            if (viewblocked) {
                ...
                viewdirection = viewdirection - canceldirection * vectordot(viewdirection, canceldirection);
            }
        }
    }
...
function function_bd0403ba33ab8b6c(startingposition, angles) {
    /#
        ...
        while (true) {
            iprintlnbold("<unknown string>" + rotatevector(self.origin - startingposition, angles) - (0, 0, 18));
            waitframe();
        }
    #/
}
...
function function_7c81e0d41cbbce7f() {
    ...
    self.enginedisabled = self.enginedisabled - 1;
...
function function_6bdf9766fe9e319(var_67154c851970b6f1) {
    /#
        thread scripts/cp_mp/utility/debug_utility::drawboxfrompoints(var_67154c851970b6f1.orientedboxpoints["<unknown string>"], var_67154c851970b6f1.orientedboxpoints["<unknown string>"], var_67154c851970b6f1.orientedboxpoints["<unknown string>"], var_67154c851970b6f1.orientedboxpoints["<unknown string>"], var_67154c851970b6f1.orientedboxpoints["<unknown string>"], var_67154c851970b6f1.orientedboxpoints["<unknown string>"], var_67154c851970b6f1.orientedboxpoints["<unknown string>"], var_67154c851970b6f1.orientedboxpoints["<unknown string>"], 0.05, (1, 1, 1));
        thread scripts/cp_mp/utility/debug_utility::drawboxfrompoints(var_67154c851970b6f1.unorientedboxpoints["<unknown string>"], var_67154c851970b6f1.unorientedboxpoints["<unknown string>"], var_67154c851970b6f1.unorientedboxpoints["<unknown string>"], var_67154c851970b6f1.unorientedboxpoints["<unknown string>"], var_67154c851970b6f1.unorientedboxpoints["<unknown string>"], var_67154c851970b6f1.unorientedboxpoints["<unknown string>"], var_67154c851970b6f1.unorientedboxpoints["<unknown string>"], var_67154c851970b6f1.unorientedboxpoints["<unknown string>"], 0.05, (1, 1, 0));
    #/
}
