...
/#
    ...
    function function_a07f7c4c0c4ef8e3() {
        return getstructarray("<dev string:x1c>", "<dev string:x31>");
    }
...
function function_ab806e73f41ed0a2() {
    ...
    foreach (index, node in self.nodes) {
        ...
        /#
            namespace_d1a9ca87d78d9813::function_9533653868e59fb6("<dev string:x43>", self.activity.name, undefined, "<dev string:x1c>", undefined, undefined, self.activity.poi, node.origin);
        #/
    ...
    if (getdvarint(@"hash_e3673b8854e11b40", 0)) {
        ...
        while (true) {
            ...
            if (getdvarint(@"hash_be93c6177feb6077", 0)) {
                ...
                if (!isdefined(node)) {
                    /#
                        printtoscreen2d(50, 50, "<dev string:x54>");
                    #/
                    index = 0;
                    continue;
                }
