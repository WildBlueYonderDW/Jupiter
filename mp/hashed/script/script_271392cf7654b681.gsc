...
#namespace jup_ob_enemy_basic_specialforce_all_for_one_bodyguard;

// Namespace jup_ob_enemy_basic_specialforce_all_for_one_bodyguard / namespace_ea18feff5284336f
// Params 0
// Checksum 0x0, Offset: 0x234
// Size: 0x1c9
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_ob_enemy_basic_specialforce_all_for_one_bodyguard" );
    ...
    primaryweaponhash = "iw9_sm_mpapax, [ drum_sm_p08, grip_angled12 ], none, none";
...
function setup_weapons()
{
    ...
    {
        level.var_67b54180a55f70e1[ primaryweaponhash ] = scripts\mp\class::function_e83615f8a92e4378( "iw9_sm_mpapax", [ "drum_sm_p08", "grip_angled12" ], "none", "none" );
    }
