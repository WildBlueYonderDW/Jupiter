...
function function_5ce5c9510bd3966f(playerteamname) {
    ...
    foreach (reinforcementtype in var_246027a1b24dd32f) {
        agentrequests[agentrequests.size] = namespace_bfef6903bca5845d::function_de59d7cb310c1aff(reinforcementtype, 3);
    }
    var_ec862c2c00c7ab5d = namespace_bfef6903bca5845d::function_b9d78fce07834c95(agentrequests);
    team = level.var_4b195d3dd0024b9c;
    agents = namespace_bfef6903bca5845d::function_2f3b04fc531b4115(level.huntsquads.var_5f8899c94cc60197, var_9b71757c091ff3a8.origin, "absolute", "huntSquad", undefined, undefined, team, undefined, undefined, "closet", undefined, undefined, var_ec862c2c00c7ab5d);
    if (!isdefined(agents) || agents.size == 0) {
        agents = namespace_bfef6903bca5845d::function_2f3b04fc531b4115(level.huntsquads.var_5f8899c94cc60197, var_9b71757c091ff3a8.origin, "absolute", "huntSquad", undefined, undefined, team, undefined, undefined, "heli", undefined, undefined, var_ec862c2c00c7ab5d);
    }
    if (!isdefined(agents) || agents.size == 0) {
        return [];
    }
...
function function_2678f4f9c8f29e17(var_36aab17d28116d3f) {
    squadorigin = function_58daeffda334806b(var_36aab17d28116d3f.agents);
    fortress = namespace_bfef6903bca5845d::function_9c5a68ca1385322e(squadorigin, undefined, undefined, 8000, undefined, 1);
    foreach (agent in var_36aab17d28116d3f.agents) {
        origin = undefined;
...
function hSquad_overrideAgent(agent) {
    ...
    agent namespace_14d36171baccf528::function_c37c4f9d687074ff(body, head, undefined, undefined, undefined, level.huntsquads.var_22d3a45413cea3ac, helmet, 1);
