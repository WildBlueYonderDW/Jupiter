...
// Namespace mp_jup_hydro_ob / namespace_7b853fc16496a9b1
// Params 0, eflags: 0x1
...
function main() {
    ...
    thread namespace_134533a365964268::main();
    ...
    if (getdvarint(@"hash_ad8d5450e8812fde", 0)) {
        ...
        level callback::add("outlast_phase_crystals_destroyed", &namespace_134533a365964268::function_bfd6485208f4b621);
