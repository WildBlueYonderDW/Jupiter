...
/#
    ...
    function function_3153056f9a15760f(params) {
        ...
        scripts\common\devgui::function_b23a59dfb4ca49a1("<dev string:x48>", "<dev string:x58>", &function_de07a0000b48b33, 1);
        scripts\common\devgui::function_fe953f000498048f();
        scripts\common\devgui::function_6e7290c8ee4f558b("<dev string:x1c>");
        scripts\common\devgui::function_b23a59dfb4ca49a1("<dev string:x73>", "<dev string:x86>", &function_de07a0000b48b33, 1);
        scripts\common\devgui::function_fe953f000498048f();
        scripts\common\devgui::function_6e7290c8ee4f558b("<dev string:x1c>");
        scripts\common\devgui::function_b23a59dfb4ca49a1("<dev string:xa4>", "<dev string:xb7>", &function_de07a0000b48b33, 1);
        scripts\common\devgui::function_fe953f000498048f();
        scripts\common\devgui::function_6e7290c8ee4f558b("<dev string:x1c>");
        scripts\common\devgui::function_b23a59dfb4ca49a1("<dev string:xd5>", "<dev string:xec>", &function_de07a0000b48b33, 1);
        scripts\common\devgui::function_fe953f000498048f();
        scripts\common\devgui::function_6e7290c8ee4f558b("<dev string:x1c>");
        scripts\common\devgui::function_b23a59dfb4ca49a1("<dev string:x10e>", "<dev string:x124>", &function_de07a0000b48b33, 1);
        scripts\common\devgui::function_fe953f000498048f();
        scripts\common\devgui::function_6e7290c8ee4f558b("<dev string:x1c>");
        scripts\common\devgui::function_b23a59dfb4ca49a1("<dev string:x145>", "<dev string:x15a>", &function_de07a0000b48b33, 1);
        scripts\common\devgui::function_fe953f000498048f();
        scripts\common\devgui::function_6e7290c8ee4f558b("<dev string:x1c>");
        scripts\common\devgui::function_b23a59dfb4ca49a1("<dev string:x17a>", "<dev string:x197>", &function_6565310170d18089);
        scripts\common\devgui::function_fe953f000498048f();
    }
    ...
    function function_de07a0000b48b33(params) {
        if (!isdefined(params[0]) || is_equal(params[0], "<dev string:x1ba>")) {
            return;
        }
        switch (params[0]) {
        case #"hash_588b588d16332e1d": 
            function_38e113a4c30f6c0d("<dev string:x1c1>", level.players[0].origin);
            return;
        case #"hash_afaaf053b2461f8a": 
            function_38e113a4c30f6c0d("<dev string:x1ee>", level.players[0].origin);
            return;
        case #"hash_41d942d30dd3f804": 
            function_38e113a4c30f6c0d("<dev string:x228>", level.players[0].origin);
            return;
        case #"hash_4f5cd54aaf7f106": 
            function_38e113a4c30f6c0d("<dev string:x265>", level.players[0].origin);
            return;
        case #"hash_fe0fd5228eda0f07": 
            function_38e113a4c30f6c0d("<dev string:x2a0>", level.players[0].origin);
            return;
        case #"hash_853faa00a9ff1020": 
            function_38e113a4c30f6c0d("<dev string:x2d8>", level.players[0].origin);
            return;
        }
    ...
    function function_6565310170d18089(a_params) {
        ...
        function_936a5eebf22b23e1("<dev string:x305>", ground_pos, player.angles);
    }
