...
function playconversation(conversationname, players, var_7b76e64b846c00d, var_8b6798cc35c82e07, location, group) {
    ...
    if (isdefined(s_conversation)) {
        ...
        foreach (soundevent in s_conversation.soundevents) {
            var_7999d4cf9ced773e = var_7999d4cf9ced773e + (isdefined(soundevent.priority) ? soundevent.priority : 75);
        }
        ...
        foreach (var_84e41716d3779c0e in s_conversation.soundevents) {
            if (isdefined(var_84e41716d3779c0e.delaybefore)) {
                var_d685948acd304ff2 = var_d685948acd304ff2 + var_84e41716d3779c0e.delaybefore;
            }
            if (isdefined(var_84e41716d3779c0e.alias)) {
                eventref = var_84e41716d3779c0e.alias;
                if (!isdefined(level.overlord.events[eventref])) {
            ...
            if (isdefined(var_84e41716d3779c0e.delayafter)) {
                var_d685948acd304ff2 = var_d685948acd304ff2 + var_84e41716d3779c0e.delayafter;
            }
        }
        foreach (player in players) {
            if (isdefined(player)) {
...
function function_b0c21eabffce3fd4() {
    ...
    proximitydistancesq = proximitydistancesq * proximitydistancesq;
            ...
            foreach (testplayer in playerarray) {
                ...
                if (var_ba24b605d8b9c100) {
                    if (isdefined(level.var_38ae0db9542b127c)) {
                        [[ level.var_38ae0db9542b127c ]](player, testplayer);
                    } else {
