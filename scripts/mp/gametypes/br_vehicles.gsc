        ...
        if (getdvarint(@"hash_be81410131fa95bf", 0)) {
            ...
            foreach (vol in level.brvehspawnvols) {
                ...
                if (numspawnpoints > 0 || minreq > 0) {
                    println("<unknown string>" + numspawnpoints + "<unknown string>" + minreq);
                }
                totalspawnpoints = totalspawnpoints + numspawnpoints;
                var_9ee3f0d2d796f396 = var_9ee3f0d2d796f396 + minreq;
            }
            println("<unknown string>" + totalspawnpoints);
...
function tryspawnavehicle(refname, locstruct, volname, faildata) {
    ...
    if (vehicle_spawn_canspawnvehicle(refname)) {
        ...
        if (isdefined(newvehicle)) {
            /#
                println("<unknown string>" + refname + "<unknown string>" + volname + "<unknown string>" + locstruct.origin + "<unknown string>");
            #/
            return newvehicle;
        }
    }
        ...
        if (isdefined(newvehicle)) {
            ...
            /#
                if (getdvarint(@"hash_be81410131fa95bf", 0)) {
                    ...
                    println("<unknown string>" + refname + "<unknown string>" + newvehicle.origin);
                }
            #/
        ...
        if (getdvarint(@"hash_be81410131fa95bf", 0)) {
            foreach (vol in level.brvehspawnvols) {
                ...
                if (minreq > 0 && minreq > vol.vehiclesspawned) {
                    ...
                    println("<unknown string>" + unfilled + "<unknown string>");
                    var_f2eab7e1ddeedf9a = var_f2eab7e1ddeedf9a + unfilled;
                }
            }
    ...
    /#
        ...
        while (true) {
            ...
            if (note == "<unknown string>") {
                ...
                var_5e43fe5ed10e5799 = openfile(filepath, "<unknown string>");
                ...
                foreach (entry in var_a25d74cbd44ff62) {
                    ...
                    fprintln(var_5e43fe5ed10e5799, "<unknown string>" + "<unknown string>" + entry.script_classname + "<unknown string>");
                ...
                iprintlnbold("<unknown string>" + var_a25d74cbd44ff62.size + "<unknown string>" + filepath);
                continue;
            }
            start = player getvieworigin();
            angles = player getplayerangles();
            ...
            if (endpos != end) {
                ...
                case #"hash_5b97d59c5aa200ba":
                    entry.script_classname = "<unknown string>";
