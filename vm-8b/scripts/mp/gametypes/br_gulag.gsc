...
function gettimetogulagclosed(var_8d0d4a9ad8524507) {
    ...
    if (isdefined(level.br_level) && isdefined(level.br_level.br_circlecenters)) {
        var_db3353ae94adec9d = ter_op(isdefined(var_8d0d4a9ad8524507), var_8d0d4a9ad8524507, getgulagclosedcircleindex());
...
function gulagvictory(arena, winner, var_5b9a9b8346074883, var_5a5a690371917543, var_df2fbb13c226be75, var_fb551788da0fc531, sponsor, var_bf7470006675932e, freezeplayercontrols, var_565c98bdccd583fb) {
    ...
    if (var_5b9a9b8346074883) {
        ...
        var_28895e67d6c24102 = "gulag_win";
        if (function_175e22055ae274a3("getWinnerDialogOverride")) {
            var_4d497c680119802d = function_d4b0eef0a0924094("getWinnerDialogOverride", arena);
            var_28895e67d6c24102 = default_to(var_4d497c680119802d, var_28895e67d6c24102);
        }
        scripts\mp\gametypes\br_public::brleaderdialogplayer(var_28895e67d6c24102, winner, 0, undefined, undefined, undefined, "dx_br_jpbm_");
    }
...
function gulagPostRespawn(optparams) {
    ...
    if (getdvarint(@"hash_9d10ec32552bd102", 0)) {
    ...
    } else if (brgametype == "dmz" || brgametype == "exgm" || brgametype == "plunder" || brgametype == "kingslayer" || brgametype == "risk" || brgametype == "rumble_mgl" || istrue(brgametype == "truckwar") && !istrue(optparams.var_bf7470006675932e)) {
        ...
        var_1f0a356715870574 = undefined;
    } else if ((istrue(optparams.var_fb551788da0fc531) || istrue(optparams.var_bf7470006675932e)) && !istrue(optparams.var_ae82e43c0d208739) && isdefined(optparams.sponsor)) {
...
function gulagwinnerloadout(var_fb551788da0fc531) {
    ...
    if (istrue(var_ac6e6c05c9957900)) {
        ...
        self.var_90bf28c4caa7a49a = self.arena.var_d6721f44f0896029.var_d9a7cab7c1ad0c67;
        self.var_ee9b454ef95fd32a = self.arena.var_d6721f44f0896029.var_785531df5b5308d2;
        return;
    }
...
function gulagwinnerremembergunandammo() {
    ...
    foreach (weaponobj in allprimaries) {
        ...
        if (getsubstr(weaponname, 0, 4) == "alt_" || scripts\mp\class::function_da27e3343b019fde() && namespace_e0ee43ef2dddadaa::function_72ce982d9fc26f1c(weaponobj)) {
            continue;
        }
...
// Namespace br_gulag / scripts\mp\gametypes\br_gulag
// Params 1, eflags: 0x0
// Checksum 0x0, Offset: 0xe2b7
// Size: 0x300
function updatematchqueuepositions(arena) {
    for (matchsize = level.gulag.matchsize; matchsize <= level.gulag.maxplayers; matchsize += level.gulag.matchsize) {
        matches = [];
        foreach (player in arena.jailedplayers) {
            if (!isdefined(player)) {
                continue;
...
function spawnac130() {
    ...
    circleradius -= 100;
    var_ecb05e27d56ce95e = gettangentoncirclefrompoint(level.br_level.br_mapcenter, circleradius, startpt);
    var_5371d63ef1da1802 = var_ecb05e27d56ce95e[1];
    endpt = var_ecb05e27d56ce95e[0];
    dist = 0;
    time = 0;
...
function playergulagautowin(context, sponsor, tokenused, var_5806c4765695a2f4, var_74af5908127b6729, var_36f3c4e4a602e257, var_df631fdd92a76bb1, var_b6acf0c07c4311e6) {
    ...
    var_ecb06327d56cf45d = player namespace_8bfdb6eb5a3df67a::playerhandlesponsor(sponsor, tokenused, var_74af5908127b6729, var_5806c4765695a2f4, var_36f3c4e4a602e257, context);
    var_df2fbb13c226be75 = var_ecb06327d56cf45d[1];
    var_84e2123aaca9a965 = var_ecb06327d56cf45d[0];
...
function getarenaomnvarbitpackinginfo(dataref, value) {
    ...
    case #"hash_f5d0ab7e55587e1d": 
        var_ecabe027d567de6d = [0, 8, "ui_br_gulag_players_1"];
    ...
    case #"hash_f5d0aa7e55587c8a": 
        var_ecabd127d567bd70 = [8, 8, "ui_br_gulag_players_1"];
    ...
    case #"hash_622ca631d10c4370": 
        var_ecabd227d567bfa3 = [16, 8, "ui_br_gulag_players_1"];
    ...
    case #"hash_622ca731d10c4503": 
        var_bfec5e27b42801e8 = [24, 8, "ui_br_gulag_players_1"];
    ...
    case #"hash_e89fe3aac33c10c9": 
        var_bfec5f27b428041b = [0, 8, "ui_br_gulag_data"];
        var_8e90fa6d5789ad63 = var_bfec5f27b428041b[2];
        bitwidth = var_bfec5f27b428041b[1];
        bitoffset = var_bfec5f27b428041b[0];
        value += 1;
        break;
    case #"hash_848cf681a543f242": 
        var_bfec6027b428064e = [8, 8, "ui_br_gulag_data"];
        var_8e90fa6d5789ad63 = var_bfec6027b428064e[2];
        bitwidth = var_bfec6027b428064e[1];
        bitoffset = var_bfec6027b428064e[0];
        break;
    case #"hash_848cf781a543f3d5": 
        var_bfec6127b4280881 = [16, 8, "ui_br_gulag_data"];
        var_8e90fa6d5789ad63 = var_bfec6127b4280881[2];
        bitwidth = var_bfec6127b4280881[1];
        bitoffset = var_bfec6127b4280881[0];
        break;
    default: 
        if (!function_1980065ce4dc067b()) {
...
// Namespace br_gulag / scripts\mp\gametypes\br_gulag
// Params 3, eflags: 0x0
// Checksum 0x0, Offset: 0x13098
// Size: 0x8c
function setarenaomnvar(arena, dataref, value) {
    assert(isdefined(dataref) && isstring(dataref));
    var_bfec6227b4280ab4 = getarenaomnvarbitpackinginfo(dataref, value);
    value = var_bfec6227b4280ab4[3];
    var_8e90fa6d5789ad63 = var_bfec6227b4280ab4[2];
    bitwidth = var_bfec6227b4280ab4[1];
    bitoffset = var_bfec6227b4280ab4[0];
...
// Namespace br_gulag / scripts\mp\gametypes\br_gulag
// Params 3, eflags: 0x0
// Checksum 0x0, Offset: 0x13597
// Size: 0x9b
function playersetomnvargulag(arena, dataref, value) {
    assert(isplayer(self));
    assert(isdefined(dataref) && isstring(dataref));
    var_bff06327b42c02be = getarenaomnvarbitpackinginfo(dataref, value);
    value = var_bff06327b42c02be[3];
    var_8e90fa6d5789ad63 = var_bff06327b42c02be[2];
    bitwidth = var_bff06327b42c02be[1];
    bitoffset = var_bff06327b42c02be[0];
    if (var_8e90fa6d5789ad63 == "") {
        return;
    }
