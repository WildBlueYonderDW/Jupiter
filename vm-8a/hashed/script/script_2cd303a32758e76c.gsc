...
function function_8a47414d4d7859df() {
    /#
        if (getdvarint(@"hash_20d28f147758431b", 0) && level.mapname == "<dev string:x2a>") {
            return;
        }
    #/
    level endon("game_ended");
...
function redeploy_drone_relocate() {
    ...
    foreach (scriptable in level.var_fc4bb27a820f54dd.var_5715be6ca445d02e) {
        ...
        if (isdefined(level.aether_storm.radiation) && level.aether_storm.radiation namespace_6d781a0248843409::function_1b4f63fa623de69a(scriptable.origin)) {
            continue;
        }
...
/#
    ...
    function function_db5c75f2a84ff03d() {
        scripts\common\devgui::function_6e7290c8ee4f558b("<dev string:x49>");
        scripts\common\devgui::function_a9a864379a098ad6("<dev string:x5c>", "<dev string:x62>", &function_b1ad7f49e2d9a2c1);
        scripts\common\devgui::function_a9a864379a098ad6("<dev string:x78>", "<dev string:x8e>", &function_bb29c4b9f489b197);
        scripts\common\devgui::function_a9a864379a098ad6("<dev string:xb4>", "<dev string:xcf>", &function_79db3fe8077d4858);
        scripts\common\devgui::function_a9a864379a098ad6("<dev string:xfa>", "<dev string:x10a>", &function_6f727cad8b163563);
        scripts\common\devgui::function_a9a864379a098ad6("<dev string:x12a>", "<dev string:x139>", &function_a093df9d6f259949);
        scripts\common\devgui::function_a9a864379a098ad6("<dev string:x150>", "<dev string:x160>", &function_185952854ebaec16);
    ...
    function function_29896330c83a80fa(v_position, i_radius) {
        level endon("<dev string:x207>");
        level endon("<dev string:x212>");
    ...
    function function_3b88aadd61acb2f7() {
        if (level.mapname != "<dev string:x2a>") {
            return;
        }
        level notify("<dev string:x44d>");
        level endon("<dev string:x44d>");
        scr_static = spawnscriptable("<dev string:x474>", (0, 0, 2740));
        var_730315a2d2560fad = spawnscriptable("<dev string:x474>", (0, 0, 0));
        var_730312a2d2560914 = spawnscriptable("<dev string:x474>", (0, 0, 0));
        ...
        scr_static setscriptablepartstate("<dev string:x486>", "<dev string:x499>");
        scr_static setscriptablepartstate("<dev string:x4a9>", "<dev string:x4bc>");
        var_730315a2d2560fad function_f5c0566b1aa605fb();
        var_730312a2d2560914 function_ca6ea48c877cd367();
        var_730312a2d2560914 setscriptablepartstate("<dev string:x486>", "<dev string:x499>");
        var_730312a2d2560914 setscriptablepartstate("<dev string:x4a9>", "<dev string:x4bc>");
        while (true) {
            ...
            var_730312a2d2560914 setscriptablepartstate("<dev string:x486>", "<dev string:x4c4>");
            scr_static thread redeploy_drone_relocate();
            wait 6;
            ...
            var_730315a2d2560fad.origin = scr_static.origin + 5500 * anglestoforward((0, var_730315a2d2560fad.i_random, 0));
            var_730315a2d2560fad function_f5c0566b1aa605fb();
            var_730315a2d2560fad setscriptablepartstate("<dev string:x486>", "<dev string:x4c4>");
        }
    }
    ...
    function function_f5c0566b1aa605fb() {
        self setscriptablepartstate("<dev string:x4cd>", "<dev string:x4dc>");
        self setscriptablepartstate("<dev string:x4e8>", "<dev string:x4c4>");
        self setscriptablepartstate("<dev string:x501>", "<dev string:x4c4>");
        self.b_occupied = 0;
        function_20998d024463786f();
    }
