...
function function_ef5eba565dd3356d() {
    namespace_49e179ec476603d6::function_900f562c61c6a5d6("generic", &function_305c6fc0fc454238, &function_387d47abb2c993f4, &function_bd0abf833bce4547, &function_1fb722119725a2fb);
    namespace_49e179ec476603d6::function_900f562c61c6a5d6("schematic", &function_305c6fc0fc454238, &function_387d47abb2c993f4, &function_bd0abf833bce4547, &function_1fb722119725a2fb);
}
...
// Size: 0x9f
function function_305c6fc0fc454238(itembundle, item, var_11648d9cb3869a36) {
    var_ecc179e5e9b62e99 = item.count;
    if (isdefined(itembundle.subtype)) {
        switch (itembundle.subtype) {
        case #"hash_d42d44f53610ee5":
            var_ecc179e5e9b62e99 = function_83497abd7c9780c6(itembundle, item);
            break;
        case #"hash_9bbb9bc426bb5e34":
            function_dac0c3ec1375e14(itembundle, item);
            break;
        case #"hash_7eee054ac1766fba":
            var_ecc179e5e9b62e99 = function_3b5ce4bc5dac6b1a(itembundle, item);
            break;
        }
    }
    return var_ecc179e5e9b62e99;
}
...
// Size: 0x25
function function_387d47abb2c993f4(itembundle, item, var_b2635db617b09abd, var_8bd8fa2792aa0511) {
    return 0;
}
...
// Size: 0x94
function function_bd0abf833bce4547(itembundle, item, var_b2635db617b09abd, var_8bd8fa2792aa0511) {
    if (isdefined(itembundle.subtype)) {
        switch (itembundle.subtype) {
        case #"hash_9bbb9bc426bb5e34":
...
function function_83497abd7c9780c6(itembundle, item) {
    ...
    if (isdefined(var_9f32b69efec89f19) && isdefined(var_9f32b69efec89f19.scriptable)) {
        ...
        if (isweapon(var_270fb50737e1cc01.weaponobj)) {
            var_270fb50737e1cc01.count = namespace_49e179ec476603d6::function_7209c8cd4b2e3afd(weaponmaxammo(var_270fb50737e1cc01.weaponobj));
        } else {
            var_270fb50737e1cc01.count = 1;
        }
        var_84ab4c28dc11052d = namespace_49e179ec476603d6::function_de489fa2ffdb7f2d(var_270fb50737e1cc01, 0);
...
function function_dac0c3ec1375e14(itembundle, item) {
    var_b8957cd52d1efa30 = "";
    var_b4767d974dc05275 = "";
    vehicletype = "";
    switch (itembundle.ref) {
    case #"hash_eabeae1c849c14ce":
        var_b8957cd52d1efa30 = "veh_jup_motocycle_blood_burner";
        var_b4767d974dc05275 = "motorcycle_blood_burner_spawn";
    ...
    self.var_c3a143513a389265 = spawnvehicle(var_b8957cd52d1efa30, var_b4767d974dc05275, vehicletype, var_317e5132733169cb, self.angles);
    self playsoundtoplayer("uin_ob_pickup_weaponcase_used", self);
}
