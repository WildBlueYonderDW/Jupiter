...
function function_c1ab3afb487441e9() {
    /#
        ...
        cba callback_trigger(1);
        /#
            assertex(teststruct.num == 0, "<unknown string>");
        #/
...
function function_9523fb0936127d3b() {
    /#
        testent = spawn("<unknown string>", (0, 0, 0));
