...
function function_fe7bbb1bfcd13664() {
    ...
    var_8234aea40e5ab7c = scripts\sp\door::get_all_interactive_doors();
    var_175138d237722678 = function_e31087776398ea53(self.origin, self.origin, 256, scripts\engine\trace::create_item_contents(), var_8234aea40e5ab7c, "physicsquery_all");
    foreach (var_c6c9d254f2e977db in var_175138d237722678) {
        door = var_c6c9d254f2e977db["entity"];
        opener = spawnstruct();
...
function c4nodetonatorfiremain(c4) {
    ...
    stuckto = c4 waittill("missile_stuck");
