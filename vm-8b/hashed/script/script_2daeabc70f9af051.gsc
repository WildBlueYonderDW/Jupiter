...
// Namespace mp_jup_sira_ob / namespace_d3d00566a256daf
// Params 0, eflags: 0x1
...
function main() {
    ...
    thread namespace_1720479eedf969aa::main();
    ...
    if (getdvarint(@"hash_c385fef4df4638cb", 0)) {
        ...
        level callback::add("outlast_phase_crystals_destroyed", &namespace_1720479eedf969aa::function_bfd6485208f4b621);
...
function function_f3e573baf0974858() {
    ...
    foreach (spawnpoint in var_f407b42a960afd35) {
        var_e2fd60828b19a637 = spawnscriptable("jup_season2_5_ob_meteorite_ee", spawnpoint.origin);
