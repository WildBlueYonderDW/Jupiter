...
function use_currency(itembundle, item, auto_use) {
    ...
    if (!isdefined(currencytype) || currencytype == "" || currencytype != "essence") {
        ...
        assertmsg("<dev string:x1c>" + itembundlename + "<dev string:x52>");
...
// Size: 0x167
function drop_currency(itembundle, count, droporigin, dropangles) {
    ...
    item = common_item::function_d59d110ccf0f5b8b(itembundle, count, droporigin, dropangles, 0, 0, payload);
