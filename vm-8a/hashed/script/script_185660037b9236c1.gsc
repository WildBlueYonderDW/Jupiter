...
function function_67f4d8928c638abb(activitytype, varianttag, originpoint, var_9334fa52c33d9f6e) {
    if (!function_34d878874ef424(varianttag)) {
        ...
        if (!function_34d878874ef424(varianttag)) {
            assertmsg("No Activity definitions have been registered with this variant tag: " + varianttag);
            return;
        }
    }
...
function function_8988a4c89289d7f4(activityinstance) {
    assertex(function_1c67ae607a61c6bb(activityinstance), "This function requires that an Activity Instance struct is passed in as an argument");
