...
function on_init() {
    ...
    set_callbacks();
    if (namespace_a6fd08b4fff3efc9::get_setting("teleport_enabled")) {
...
// Size: 0x66
function set_dvars() {
    namespace_a6fd08b4fff3efc9::add_setting("kills_to_complete", 5);
    namespace_a6fd08b4fff3efc9::add_setting("reset_on_drop", 0);
    namespace_a6fd08b4fff3efc9::add_setting("teleport_enabled", 1);
    namespace_a6fd08b4fff3efc9::add_setting("teleport_each_pickup", 1);
    namespace_a6fd08b4fff3efc9::add_setting("drop_ww", 1);
    namespace_a6fd08b4fff3efc9::add_setting("mark_cursed_player", 1);
    namespace_a6fd08b4fff3efc9::add_setting("ww_name", "jup_pi_raygun_mp");
}
...
function function_3b1a4e5d006d826e(loc) {
    instance = {#quest:self, #rewards:[], #complete:0, #first_pickup:0, #var_4305c9c81a417ff:0, #var_b5c2bc759e130860:namespace_a6fd08b4fff3efc9::get_setting("kills_to_complete"), #item_loc:loc};
    return instance;
}
...
function function_20b222942020715() {
    ...
    if (self.quest namespace_a6fd08b4fff3efc9::get_setting("drop_ww")) {
        rewards[rewards.size] = scripts\cp_mp\utility\weapon_utility::function_eeaa22f0cd1ff845(self.quest namespace_a6fd08b4fff3efc9::get_setting("ww_name"));
    }
    return rewards;
}
...
function function_eab7b539afd6dd11() {
    ...
    if (self.quest namespace_a6fd08b4fff3efc9::get_setting("mark_cursed_player")) {
...
function on_player_killed(death_data) {
    quest = namespace_a6fd08b4fff3efc9::get_quest("cursed");
    foreach (quest_instance in quest.quest_instances) {
        if (istrue(quest_instance.var_4305c9c81a417ff) && isdefined(quest_instance.var_e8ab9a0402079035)) {
            ...
            if (isdefined(death_data.victim) && quest_instance.var_e8ab9a0402079035 == death_data.victim) {
                ...
                if (quest namespace_a6fd08b4fff3efc9::get_setting("reset_on_drop")) {
                    quest_instance.var_b5c2bc759e130860 = quest namespace_a6fd08b4fff3efc9::get_setting("kills_to_complete");
                }
            }
        }
    }
...
function function_1f7f65169228bd71(item, player) {
    ...
    if (quest_instance.quest namespace_a6fd08b4fff3efc9::get_setting("teleport_enabled")) {
        if (!istrue(quest_instance.first_pickup)) {
            quest_instance.first_pickup = 1;
            player teleport_player();
        } else if (quest_instance.quest namespace_a6fd08b4fff3efc9::get_setting("teleport_each_pickup")) {
            player teleport_player();
        }
    }
...
/#
    ...
    function function_8ceab4fddfa5e5ea() {
        quest = namespace_a6fd08b4fff3efc9::get_quest("<dev string:x26d>");
