...
function autoexec function_6f185a47e9e89d31() {
    namespace_3c37cb17ade254d::registersharedfunc("battlerage", "suspendVisionSets", &function_67a8dd7e70c037cc);
    namespace_3c37cb17ade254d::registersharedfunc("battlerage", "resumeVisionSets", &function_b2cbb30462cc3a75);
}
...
function function_905b7bada6fd91cb(var_fd778fc5467d97b2, var_67d84be6232392d2) {
    ...
    var_fd778fc5467d97b2 = function_53c4c53197386572(var_fd778fc5467d97b2, 0);
...
function function_d04e75b8e793111f(equipmentref, slot, objweapon) {
    ...
    if (var_b863fc5b39ccf66d) {
        var_b5693f28e16a455e = getdvarfloat(@"hash_30001650209bd887", 6) * 1000;
        self.var_64190ac6a5aa31d5 = gettime() + var_b5693f28e16a455e;
    } else {
...
// Size: 0x5b
function private function_2e7548a311865111(var_de0c04c7f580d2f7) {
    if (var_de0c04c7f580d2f7) {
...
function battleRage_beginSuper(var_fd778fc5467d97b2, var_67d84be6232392d2) {
    ...
    self.var_2f53b677680890b1 = 0;
    namespace_a850435086c88de3::function_693d12aa2c1c02c5(1, "battleRageUsed");
    ...
    var_c9d3262a60835c51 = getdvarfloat(@"hash_f7ec6896361f0e48", 0);
    namespace_54a2eae43eaa8bf5::function_5457f0107a845374("battleRage_beginSuper", var_c9d3262a60835c51);
    namespace_aad14af462a74d08::function_d997435895422ecc("super_battlerage", function_e2ff8f4b4e94f723(#"hash_83a2d67994d7e295", #"use"));
...
function private function_14b332b353d098d5() {
    ...
    self.var_3876c573b9e66b57 = undefined;
    namespace_a850435086c88de3::function_693d12aa2c1c02c5(0, "battleRageUsed");
    if (getdvarint(@"hash_5ecbc2e485434bb5", 0)) {
        self notify("force_regeneration");
    }
    namespace_d576b6dc7cef9c62::sethasdonecombat(self, 1);
...
function function_fe088cdea420c6d6(attacker, victim) {
    ...
    self.var_2f53b677680890b1++;
    if (getdvarint(@"hash_fa795fa5ac66dd8c", 1)) {
        self notify("force_regeneration");
    }
    if (istrue(self.var_808d06ddfc93a4e4)) {
        thread namespace_48a08c5037514e04::doScoreEvent(#"hash_2ea2e76452c29f97");
    }
}
...
// Size: 0x88
function private function_2bb6d8cd4a2eee43(var_c41a94d2c602f763) {
    var_41b22745125ab990 = namespace_775507ba36294dfb::gettweakablevalue("player", "maxhealth");
    var_2efb8e4e26a9a29d = getdvarfloat(@"hash_e2b1912f2da8b4b5", 0.2);
    var_79d8cbca2aa1639e = var_41b22745125ab990 + var_41b22745125ab990 * var_2efb8e4e26a9a29d;
    if (self.health + var_c41a94d2c602f763 > var_41b22745125ab990) {
        self.maxhealth = var_79d8cbca2aa1639e;
    }
    function_e434212c54afd8e4(var_c41a94d2c602f763);
...
// Size: 0x44
function private function_e434212c54afd8e4(var_c41a94d2c602f763) {
    self.health = int(min(self.maxhealth, self.health + var_c41a94d2c602f763));
...
function private function_49d89d9d6340ae00() {
    var_41b22745125ab990 = namespace_775507ba36294dfb::gettweakablevalue("player", "maxhealth");
    return self.maxhealth > var_41b22745125ab990;
}
...
function function_739a5f064c7debdf(var_fd778fc5467d97b2, var_67d84be6232392d2, var_84ad7d139c3431dc) {
    ...
    self.var_fd778fc5467d97b2 = undefined;
    self.var_3876c573b9e66b57 = undefined;
    self.var_2f53b677680890b1 = undefined;
    function_feb90bb1ccdc8a59();
    var_26a8a7973ea6de8b = getdvarint(@"hash_55316648a7be13d", 0);
    var_f40baf4e34be03b9 = getdvarint(@"hash_cf91c5d3c93671ad", 0);
    if (isdefined(self.var_59317c0cd98c577)) {
        namespace_aad14af462a74d08::function_d997435895422ecc("super_battlerage", function_e2ff8f4b4e94f723(#"hash_83a2d67994d7e295", #"end"), int(round(self.var_59317c0cd98c577)));
    }
    if (!istrue(var_84ad7d139c3431dc) && !istrue(level.gameended) && namespace_7e17181d03156026::function_ad443bbcdcf37b85(self)) {
...
// Size: 0x8b
function private function_a47db0cce0bd80f4(var_3b080dda61799f72, var_6d7f1bcb37532496) {
    if (var_3b080dda61799f72) {
        var_430870f09b5449e4 = self.maxhealth * 0.2;
        if (self.health > var_430870f09b5449e4) {
            var_45dfead668cc412a = self.health - var_430870f09b5449e4;
            self dodamage(var_45dfead668cc412a, self.origin, self, self, "MOD_TRIGGER_HURT", undefined, "torso_upper");
        }
    }
    if (isreallyalive(self) && var_6d7f1bcb37532496) {
...
function private function_1be90fa9fc4f75d4() {
    ...
    val::function_c9d0b43701bdba00("battleRage");
}
...
function private function_79e60a54c8ed1ce8() {
    ...
    var_dfd57a70a834560b = 0;
    while (1) {
        var_559a0810819cf4f0 = clamp(self.health / self.maxhealth, 0.22, 1);
        self setmovespeedscale(var_559a0810819cf4f0);
        if (var_559a0810819cf4f0 <= 0.3 && !istrue(var_dfd57a70a834560b)) {
            self notify("battleRage_lowHealth");
            var_dfd57a70a834560b = 1;
        }
        waitframe();
    }
}
...
function private function_feb90bb1ccdc8a59() {
    var_d704ca6c9899b649 = namespace_775507ba36294dfb::gettweakablevalue("player", "maxhealth");
...
function private function_6458a8552104dc8b() {
    ...
    if (getdvarint(@"hash_18cd69f9e0e0c0f9", 0) || namespace_36f464722d326bbe::isBRStyleGameType()) {
...
// Size: 0x9e
function private battleRage_visionSetsPainSurge(var_a274ff78f6be5be1, var_3bcd7e754ee4931d) {
    self notify("battleRage_visionSetsPainSurge");
    self endon("battleRage_visionSetsPainSurge");
    self endon("death_or_disconnect");
    self endon("battleRageEnd");
    self earthquakeforplayer(0.3, var_a274ff78f6be5be1, self.origin, 50);
    if (!istrue(self.var_5cd1342d8fd3dd61)) {
        self visionsetnakedforplayer("battlerage-low-health", var_a274ff78f6be5be1);
    }
...
function function_63172f4acc7e60e7() {
    ...
    level endon("game_ended");
    var_b5693f28e16a455e = getdvarfloat(@"hash_30001650209bd887", 6) * 1000;
    self.var_64190ac6a5aa31d5 = int(gettime() + var_b5693f28e16a455e);
...
function function_f53fab1c650c0081() {
    ...
    while (secondselapsed < var_176d1bc49ea13a43) {
        ...
        if (!namespace_7e17181d03156026::function_ad443bbcdcf37b85(self) && secondselapsed > 0) {
            break;
        }
        waitframe();
