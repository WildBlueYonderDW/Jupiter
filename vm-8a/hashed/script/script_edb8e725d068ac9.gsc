...
function function_5d3698def4754183(var_6f8af5eb76deac21) {
    ...
    assertex(isdefined(reward_structs[0]), "Unable to spawn Reward Rift. No Reward struct location found.");
...
function private function_4c7fb6ad4120d921() {
    assertex(!self.warlordenabled, "Trying to enable a warlord encounter that has already been marked as enabled!");
...
function function_e5ea18b76842725f(sparams) {
    if (issubstr(self.agent_type, "actor_jup_ob_warlord_")) {
        ...
        sparams.einflictor callback::callback("warlord_killed", params);
    }
}
...
function private function_dbfc831a765bed05(doornode, canopen) {
    ...
    var_98fa2809e21ff34f = namespace_9e69d66f68c38a10::function_ad1b6accbaab404e(doornode, var_98fa2809e21ff34f, var_d1c7613187e69022.var_9a002d7b10d97a7d, istrue(canopen), 1, self.mapdoors);
    ...
    foreach (var_aaa3e5affa4753c9 in var_98fa2809e21ff34f) {
        ...
        if (isdefined(var_aaa3e5affa4753c9.connecteddoor)) {
            ...
            if (isdefined(currentdoor)) {
                ...
                println("<dev string:x74>" + var_aaa3e5affa4753c9.origin);
            }
            ...
            if (isdefined(currentdoor)) {
                if (isdefined(var_aaa3e5affa4753c9.var_d0b5210a732916e4)) {
                    ...
                    println("<dev string:x108>" + var_aaa3e5affa4753c9.origin);
                }
                function_8aa310a1da096b43(currentdoor, var_aaa3e5affa4753c9);
...
function private function_9f628b12214ded36() {
    ...
    foreach (player in level.players) {
        if (isdefined(patrolcenter) && isdefined(player)) {
            if (distancesquared(player.origin, patrolcenter.origin) < patrolcenter.radius * patrolcenter.radius) {
                return player;
            }
            wait 0.1;
        }
...
function private function_ad3c2d380193c0d6(player_in_range) {
    ...
    assertex(isdefined(helipathstart), "There is a helicopter enabled for the warlord activity but it has no valid path!");
    ...
    heli thread namespace_c908de38bcdbd93d::behavior_combat(player_in_range, &function_900c6f46dec4a691, 1);
    return heli;
}
...
function function_6997cf73d6a2c9a4() {
    ...
    foreach (mine in self.minestructs) {
        badplace_id = "bp_" + self.centerstruct.script_noteworthy + "_mine" + self.mines.size;
        mine_spawn = namespace_17b45e55cf344cda::function_908ec13fb4d6cede(mine.origin, badplace_id, self.agents[0], undefined, mine.angles, 1);
        mine.allowfriendlyfire = 1;
        self.mines = utility::array_add(self.mines, mine);
        mine thread function_a8d2fedc12c85f16(self);
        activity_participation::function_f0675d4a690011d6(mine);
...
// Size: 0x105
function function_a8d2fedc12c85f16(activityinstance) {
    self endon("death");
    activityinstance endon("activity_ended");
    ...
    if (ents.size > 0) {
        ...
        if (utility::array_contains(level.players, ents[0])) {
            if (!utility::array_contains(activityinstance.var_6c29f2fdb0054bbe, ents[0])) {
                activity_participation::function_bbdcd857d0c2a65e(activityinstance, ents[0], "PlayerJoinedDamage");
            }
...
/#
    ...
    function private function_c638fba4eade0ac3() {
        devgui::function_6e7290c8ee4f558b("<dev string:x1b3>");
        devgui::function_b2159fbbd7ac094e("<dev string:x1cb>", @"hash_465e351e0dbf9dc");
        devgui::function_fe953f000498048f();
        devgui::function_6e7290c8ee4f558b("<dev string:x1db>");
        devgui::function_b23a59dfb4ca49a1("<dev string:x205>", "<dev string:x211>", &function_7e9147a046f3c383);
        devgui::function_b23a59dfb4ca49a1("<dev string:x237>", "<dev string:x23f>", &function_7e9147a046f3c383);
        devgui::function_b23a59dfb4ca49a1("<dev string:x261>", "<dev string:x269>", &function_7e9147a046f3c383);
        devgui::function_b23a59dfb4ca49a1("<dev string:x28b>", "<dev string:x295>", &function_7e9147a046f3c383);
        devgui::function_fe953f000498048f();
    }
    ...
    function private function_7e9147a046f3c383(params) {
        ...
        if (!isdefined(activitydefinition)) {
            assertmsg("<dev string:x2df>" + params[0]);
            return;
        }
