...
{
    if ( self isthrowinggrenade() || self ismeleeing() || self isdiving() || self function_9cc921a57ff4deb5() || self isonladder() || self [[ scripts\engine\utility::getsharedfunc( "player", "isPlayerADS" ) ]]() )
    {
        return false;
    }
