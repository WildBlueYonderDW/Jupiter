...
// Size: 0x337
function spawn_reinforcements(location, var_dd4f509b9c56c76f, var_461b8c89eb0f0715, params) {
    /#
        /#
    ...
    foreach (type in var_461b8c89eb0f0715) {
        if (issubstr(type, "heli") && istrue(level.var_425df8e23aaef18c)) {
            ...
            var_51900af8e34c7d04 = namespace_7ae25d9e5d5a28ef::function_3779deb97b61a65(var_dd4f509b9c56c76f.size, var_2984a3a7b3c051a7, var_6adbaf8d10937e14, ai_category, var_49e3c22608848bd6, group_name, "team_hundred_ninety_five", var_15d6c88336debdf4, var_f96e9372bf4d85eb, 256, 512, var_9a5a0701386ac693, 1, 0);
            ...
            var_9a5a0701386ac693 = namespace_bfef6903bca5845d::function_b9d78fce07834c95(var_dd4f509b9c56c76f);
            var_63f6f0241fc2a71e = namespace_885300a47c2b51e6::function_55ab9c6da96226e7(var_dd4f509b9c56c76f.size, var_2984a3a7b3c051a7, var_8fb0afec6ee6a75, var_9a5a0701386ac693, var_6adbaf8d10937e14, ai_category, var_49e3c22608848bd6, "team_hundred_ninety_five", var_15d6c88336debdf4, var_f96e9372bf4d85eb, undefined, undefined, 1, 1, 1, 256);
            if (isdefined(var_63f6f0241fc2a71e)) {
                agents = var_63f6f0241fc2a71e;
            }
        } else if (issubstr(type, "closet")) {
            var_9a5a0701386ac693 = namespace_bfef6903bca5845d::function_b9d78fce07834c95(var_dd4f509b9c56c76f);
            var_586efc1d3caf3644 = namespace_bfef6903bca5845d::function_9ea6eddb437eaca5(var_dd4f509b9c56c76f.size, var_2984a3a7b3c051a7, var_6adbaf8d10937e14, ai_category, var_49e3c22608848bd6, group_name, "team_hundred_ninety_five", var_15d6c88336debdf4, var_f96e9372bf4d85eb, undefined, undefined, 256);
...
function function_3c4b94287bc8e5f9(location, var_dd4f509b9c56c76f, var_f96e9372bf4d85eb, group_name, params) {
    ...
    foreach (index, request in var_dd4f509b9c56c76f) {
        ...
        agent = namespace_bfef6903bca5845d::ai_mp_requestspawnagent(ai_type, var_d7ac817d738940da[index], (0, 0, 0), params.var_6adbaf8d10937e14, params.ai_category, undefined, group_name, "team_hundred_ninety_five", undefined, var_f96e9372bf4d85eb, 1, 0, 0, undefined, 0);
        if (isdefined(agent)) {
...
// Size: 0x151
function function_f94be34470ee3bad(location, spawn_count, var_2459ccc8942d8b86, var_139b059f5ddea817, squad_size) {
    var_d7ac817d738940da = [];
    ...
    for (i = 0; i < 15; i++) {
        ...
        spawnpoints = getrandomnavpoints(getclosestpointonnavmesh(var_aedd7371f20a2b9), var_139b059f5ddea817, squad_size);
