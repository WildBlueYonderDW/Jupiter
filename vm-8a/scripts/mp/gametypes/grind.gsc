    ...
    function function_cd969857178097d0() {
        ...
        while (true) {
            if (getdvarint(@"hash_ec6d489d470bc2ad") != 0) {
                foreach (player in level.players) {
                    if (player.team == "<dev string:x27>") {
                        player.tagscarried += getdvarint(@"hash_ec6d489d470bc2ad");
                        player setclientomnvar("<dev string:x2e>", player.tagscarried);
                    }
                }
                break;
            } else if (getdvarint(@"hash_6f6849bde2dd82a2") != 0) {
                foreach (player in level.players) {
                    if (player.team == "<dev string:x3c>") {
    ...
    function function_d859ebf3629052fb() {
        ...
        while (true) {
            if (getdvarint(@"hash_46a6b424af6acbc2") != 0) {
                scripts\mp\gamescore::giveteamscoreforobjective("<dev string:x27>", getdvarint(@"hash_46a6b424af6acbc2"), 0);
                break;
            } else if (getdvarint(@"hash_86e14326e43c0115") != 0) {
                scripts\mp\gamescore::giveteamscoreforobjective("<dev string:x3c>", getdvarint(@"hash_86e14326e43c0115"), 0);
                break;
            }
            wait 1;
        }
