...
function init() {
    ...
    if (level.br_armory_kiosk_enabled) {
        ...
        scripts/mp/gametypes/br_circle::function_eca79fa0f341ee08(4, &dangercircletick, &function_1a1709943670772a, &function_d9a3848f71c7c63a, &disableallarmorykiosks);
...
function function_b38f5ffe645943c3(stationref) {
    ...
    level.var_e7cee4fbb5b46ef2 = namespace_38b993c4618e76cd::function_54b046aa3ba2678a(stationref);
...
function function_b88d64cd67bbe60f(kiosk) {
    ...
    foreach (var_e5b48212891e8513 in var_4a7f6ec38e1f5220) {
        if (isdefined(var_e5b48212891e8513)) {
            ...
            #/
            var_89ffab3d9d3c9cdd = var_89ffab3d9d3c9cdd | var_e5b48212891e8513 << 2 * itemspacked;
            itemspacked++;
        }
    }
...
function function_d84cdb7463425ba(var_9023cea8f03e72d2) {
    ...
    while (stationitem != "") {
        ...
        if (!itemfiltered) {
            /#
                assertex(!isdefined(var_eb7139726cc569b5["items"][stationitem]), "Duplicate buy station item found in: " + var_9023cea8f03e72d2 + " for " + stationitem);
            #/
        ...
        if (itemindex < 15) {
            ...
            /#
                println("mp/buyStation/attachmentPriceList.csv" + itemindex + 1 + "opening" + 15 + "crouch" + stationitem + "ui_barter_list_index" + var_9023cea8f03e72d2);
            #/
        }
        itemindex++;
        var_ac75b489772f26ce = 4 * itemindex;
...
function function_3cc8b2630d4f56e7(weaponref, attachmentrefs) {
    ...
    foreach (attachmentref in attachmentrefs) {
        if (attachmentref != "none") {
            ...
            var_d92fa0cdae417729 = var_d92fa0cdae417729 + attachmentcost;
        }
    }
...
function _getactualcost(player, itemdata) {
    ...
    var_32a4b97aaf1048c3 = getdvar(hashcat(@"hash_d98c82b5a26dc973", itemdata.ref, "_cost_override"), "");
    if (var_32a4b97aaf1048c3 != "") {
        var_708c98cf00cfdb10 = strtok(var_32a4b97aaf1048c3, ",");
        var_781ca8aede77fa50 = scripts/mp/utility/teams::getteamcount(player.team) - 1;
...
function dangercircletick(var_819edacdacb810e4, dangercircleradius, thresholdradius) {
    ...
    foreach (armorykiosk in level.br_armory_kiosk.scriptables) {
        var_e4e4ae4481958d2e = !isdefined(armorykiosk.deconeffectcount) && exclusion_zones::function_de57b9616f575a63(armorykiosk.origin) == -1 && distance2dsquared(armorykiosk.origin, var_819edacdacb810e4) + level.var_53c0fa66001cff52 > var_c434624ff361bba2;
...
function function_1a1709943670772a() {
    ...
    hiddenkiosks = [];
    foreach (armorykiosk in level.br_armory_kiosk.scriptables) {
        var_e4e4ae4481958d2e = !isdefined(armorykiosk.deconeffectcount) && exclusion_zones::function_de57b9616f575a63(armorykiosk.origin) == -1 && !namespace_bbc79db4c3949a5c::function_ee854fdd1e77efc4(armorykiosk.origin, level.var_53c0fa66001cff52);
        if (istrue(armorykiosk.visible)) {
            if (var_e4e4ae4481958d2e) {
...
function private function_96e56767b949c013(stationstruct, var_3d329ebb0d03d6db, var_849e91c5e0d0e0df) {
    ...
    if (!isdefined(stationstruct.var_4041cda36a5951ff)) {
        stationstruct.var_4041cda36a5951ff = "br_plunder_box";
    }
    if (isdefined(stationstruct.hightier)) {
        stationstruct.var_4041cda36a5951ff = "br_plunder_box_high_tier";
    }
    buystation = spawnscriptable(stationstruct.var_4041cda36a5951ff, stationstruct.origin, stationstruct.angles);
    ...
    /#
        namespace_d1a9ca87d78d9813::function_9533653868e59fb6("Unexpected killstreak purchase type: ", "trophy_refill", undefined, "brloot_offhand_advancedvehicledrop", undefined, undefined, stationstruct.poi, stationstruct.origin);
    #/
...
function function_c471a0358a06a7f0() {
    ...
    foreach (p in level.teamdata[player.team]["players"]) {
        ...
        logstring("[ WHY_NO_BUYBACK TEST] : " + p.name + ", " + eliminated + ", " + gulagjail + ", " + gulagarena + ", " + var_43fb259f4877f32c + ", " + var_c3ff2e180fe8a431 + ", " + var_bc61b790659a94dc + ", " + var_5507b0bf5d504e84 + ", " + var_9a5b643e836607ef + ", " + var_80668ba94093c0c7 + ", " + playerarena + ", " + isplayeralive + ", " + playersessionstate + ", " + isplayerspectating + ", " + var_3f78c6a0862f9e25);
    }
}
...
function getkioskyawoffsetoverride() {
    if (isdefined(level.var_d03e6ba38b56b4ab) && istrue(level.var_d03e6ba38b56b4ab)) {
        ...
        if (level.randomanglemax > 0) {
            finaloffset = finaloffset + randomfloatrange(level.randomanglemax * -1, level.randomanglemax);
        }
        return finaloffset;
    }
...
function _runpurchasemenu(kiosk) {
    ...
    if (istrue(player.br_kiosk.var_a84a6acb3c2edcae)) {
        ...
        if (istrue(player.br_kiosk.var_746c06c00cd6bdc5)) {
            openvalue = openvalue + 16;
        } else {
            openvalue = openvalue + 2;
        }
        if (isfiresale) {
            openvalue = openvalue + 4;
        }
        if (istrue(kiosk.var_114e759371623080)) {
            openvalue = openvalue + 32;
        }
...
function _validateitempurchase(kiosk, itemdata, var_6dc0e605ecd21eee, var_7c3865dee4abed6, var_d260df4653b74cef) {
    ...
    if (itemdata.type == "killstreak") {
        ...
        if (!istrue(var_6dc0e605ecd21eee)) {
            var_75630a54ff140ec2 = player scripts/mp/supers::getcurrentsuperref();
        ...
        case #"hash_4808e1f340e11163":
            ...
            var_6a8b46e184e181cc = spawnstruct();
            var_6a8b46e184e181cc.scriptablename = scripts/cp_mp/gasmask::function_d855f39e2b239317(itemdata.ref);
            /#
...
function function_90b0e9eb26e38443(itemdata, var_7dddac09987d559e, var_452130d9d126e506, var_db943473454f6ea6) {
    ...
    var_c012b762499f4ae2 = scripts/mp/gametypes/br_gametype_dmz::getDefaultWeaponAmmo(level.br_lootiteminfo[scriptablename].fullweaponobj);
    var_35ead47ed0d7507e = var_c012b762499f4ae2[2];
    ammoleft = var_c012b762499f4ae2[1];
...
function _handlespecialpurchase(itemdata, var_7dddac09987d559e, var_452130d9d126e506, kiosk, var_682e4b53880a6720, var_db943473454f6ea6) {
    ...
    case #"hash_488cf778b792ae68":
        ...
        if (purchasesuccess) {
            players = scripts/mp/utility/teams::getteamdata(player.team, "players");
    ...
    case #"hash_d01e387e6d238502":
        ...
        itemdata.lootid = namespace_38b993c4618e76cd::function_fae5e1d3de32d3f7(itemdata.entryref);
        break;
    case #"hash_a500f53d3e52d6e":
    ...
    case #"hash_c31089e2e50b5079":
        ...
        break;
    case #"hash_a7a7446a3194cb49":
        purchasesuccess = namespace_f8d3520d3483c1::function_92fec40b905c5112();
        break;
    ...
    default:
        ...
        if (scripts/mp/gametypes/br_gametypes::isbrgametypefuncdefined("kioskHandleSpecialPurchase")) {
            var_c012b362499f4216 = player scripts/mp/gametypes/br_gametypes::function_d72af9ccedfc923b("kioskHandleSpecialPurchase", itemdata, var_7dddac09987d559e, var_452130d9d126e506, kiosk, purchasesuccess, var_b517df938986556f, quantity);
            quantity = var_c012b362499f4216[3];
            var_b517df938986556f = var_c012b362499f4216[2];
            purchasesuccess = var_c012b362499f4216[1];
            supported = var_c012b362499f4216[0];
        }
        if (!supported) {
            /#
...
function _handlevehiclepurchase(itemdata, var_7dddac09987d559e, var_5c529b214774f72d) {
    ...
    isontrain = scripts/cp_mp/utility/train_utility::player_standing_on_train();
...
function onarmorykioskpurchase(channel, purchaseindex) {
    ...
    if (channel == "br_team_revive") {
        ...
        foreach (squadmate in squad) {
            ...
            if (isdefined(squadmate.var_3f78c6a0862f9e25) && squadmate.var_3f78c6a0862f9e25 == var_bf5d82befbb59efe) {
                if (getdvarint(@"hash_ece0c71aa9d5c939", 0)) {
                    logstring("[ WHY_NO_BUYBACK TEST] buyback player - " + squadmate.name + ", sessionuimemberindex = " + squadmate.var_3f78c6a0862f9e25);
                }
    ...
    if (channel == "insure_slot") {
        ...
        itemdata = spawnstruct();
        itemdata.lootid = namespace_38b993c4618e76cd::getlootidfromref(itemref);
    ...
    if (channel == "br_biometric_scan_keycard_exchange") {
        ...
        if (isdefined(itemdata) && itemdata.exchangesuccess) {
...
function function_2d04108c0a0ed7a5(player, targetweapon) {
    ...
    if (getdvarint(@"hash_ac8187887a7808aa", 0)) {
        dropstruct.dropidx = dropstruct.dropidx + 9;
    }
...
function function_a573b91325f9ea32(player, itemdata, itemtyperef, splashref, quantity) {
    ...
    if (!isdefined(lootid) || lootid == 0) {
        lootid = namespace_38b993c4618e76cd::getlootidfromref(itemdata.ref);
        if (!isdefined(lootid) || lootid == 0) {
    ...
    if (scripts/mp/utility/game::getsubgametype() == "dmz") {
        namespace_8361bad7391de074::function_7184abfe5941a710(player, cashspent);
    }
    ...
    player scripts/cp_mp/challenges::onkioskpurchaseitem(itemtyperef, itemdata.ref, lootid, quantity, cashspent);
...
function restartcircleelimination(origin) {
    ...
    if (scripts/mp/gametypes/br_gametypes::isfeaturedisabled("oneLife")) {
        ...
        setdynamicdvar(hashcat(@"hash_d98c82b5a26dc973", scripts/mp/utility/game::getgametype(), "_numLives"), 1);
    }
}
...
function playerredeploy(groundorigin, overrideheight, overrideyaw) {
    ...
    if (!player islinked()) {
        ...
        /#
            scripts/mp/utility/script::demoforcesre("<unknown string>" + player.name + "<unknown string>");
        #/
    }
    player unlink();
