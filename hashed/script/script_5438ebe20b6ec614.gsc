...
function init(moodlist) {
    ...
    for (k = 0; k < moodlist.size; k++) {
        ...
        totalweight = totalweight + moodlist[k].weight;
    }
...
function devgui_init() {
    /#
        ...
        scripts/common/devgui::function_a9a864379a098ad6("<unknown string>", "<unknown string>", &function_40c5de300f64bca5);
        scripts/common/devgui::function_fe953f000498048f();
        for (i = 0; i < level.moods.size; i++) {
            scripts/common/devgui::function_6e7290c8ee4f558b("<unknown string>" + i);
            scripts/common/devgui::function_fe953f000498048f();
            scripts/common/devgui::function_6e7290c8ee4f558b("<unknown string>" + i + "<unknown string>");
            scripts/common/devgui::function_b23a59dfb4ca49a1("<unknown string>", "<unknown string>" + i, &function_9fb263cc4b9c7d63);
            scripts/common/devgui::function_fe953f000498048f();
            scripts/common/devgui::function_6e7290c8ee4f558b("<unknown string>" + i + "<unknown string>");
            scripts/common/devgui::function_b23a59dfb4ca49a1("<unknown string>", "<unknown string>" + i, &function_557893706e808ca5);
            scripts/common/devgui::function_fe953f000498048f();
        }
    #/
}
...
function function_aaadc13812c2ef4b() {
    /#
        replacevisionset(0, "<unknown string>");
        if (isdefined(level.currentmood)) {
