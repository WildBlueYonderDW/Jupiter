...
#using character\character_hero_hadir_prisoner.gsc;
#using scripts\aitypes\assets.gsc;

#namespace namespace_abe33de9b5c622;

// Namespace namespace_abe33de9b5c622 / namespace_dc2221453e53748b
// Params 0, eflags: 0x0
// Checksum 0x0, Offset: 0x16b
// Size: 0x178
function main() {
    self.aitypeid = function_2336488258354fbc(#"aitype", %"hash_5a7b3664e85d3f2d");
