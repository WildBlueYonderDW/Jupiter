...
function function_fc71506c553cc896() {
    dmg, attacker, dir, point, mod, modelname, tagname, full_partname, idflags, weapobj = self waittill("damage");
...
function function_af5278d2e267676c(var_5285599f4b507cad, enemy, civ) {
    dmg, attacker, dir, point, mod, modelname, tagname, full_partname, idflags, weapobj = enemy waittill("damage");
