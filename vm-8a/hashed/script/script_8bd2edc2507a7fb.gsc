...
/#
    ...
    function function_3b2ca0163dee88a4() {
        foreach (player in level.players) {
            ...
            player iprintlnbold("<dev string:x29>");
        }
    }
    ...
    function function_d2a179c33526b945() {
        function_6e7290c8ee4f558b("<dev string:x44>");
        function_a9a864379a098ad6("<dev string:x52>", "<dev string:x65>", &function_3b2ca0163dee88a4, 0);
