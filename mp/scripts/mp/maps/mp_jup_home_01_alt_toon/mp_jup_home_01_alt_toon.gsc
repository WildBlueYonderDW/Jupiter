...
#using scripts\mp\maps\mp_jup_home_01_alt_toon\gen\mp_jup_home_01_alt_toon_art;
...
function main()
{
    scripts\mp\maps\mp_jup_home_01_alt_toon\gen\mp_jup_home_01_alt_toon_art::main();
