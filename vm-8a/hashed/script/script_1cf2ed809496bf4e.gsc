        ...
        if (isdefined(castresults) && castresults["hittype"] != "hittype_none") {
            ...
            /#
                if (istrue(0)) {
                    ...
                    print3d(self.origin + (0, 0, 24), "<dev string:x25>" + self.stuckwaterdepth, (0, 255, 0), 1, printscale, printduration, 1);
...
/#
    ...
    function private function_fa6a545da2197663() {
        ...
        self endon("<dev string:x7b>");
        self endon("<dev string:x8a>");
        while (true) {
            if (!isdefined(self)) {
                return;
            }
    ...
    function private function_46bfca70cc1648f8(data) {
        if (false) {
            ...
            var_dd4fec1f7555332c = vectordot(forward, direction);
            var_8bbcf51ff5504b0d = vectordot(right, direction);
            hitstring = default_to(function_5d2ce17e3de0719b(data), "<dev string:x90>");
            ...
            if (isdefined(data)) {
                ...
                print3d(var_bce79209c754c068 + (0, 0, 24), "<dev string:x95>" + angledelta, colorgreen, 1, printscale, printduration, 1);
                print3d(var_bce79209c754c068 + (0, 0, 18), "<dev string:x9d>" + var_dd4fec1f7555332c, colorgreen, 1, printscale, printduration, 1);
                print3d(var_bce79209c754c068 + (0, 0, 12), "<dev string:xa8>" + var_8bbcf51ff5504b0d, colorgreen, 1, printscale, printduration, 1);
                print3d(var_bce79209c754c068 + (0, 0, 6), "<dev string:xb3>" + hitstring, colorgreen, 1, printscale, printduration, 1);
            }
        }
    }
