...
function function_7828c1afe3365dd2() {
    ...
    level.scr_anim["upload_station_player"]["upload_station_exit_cancel"] = script_model%iw9_dmz_uploadstation_exit_cancel_sdr;
    ...
    level.scr_anim["upload_station_harddrive"]["upload_station_exit_cancel"] = script_model%iw9_dmz_uploadstation_exit_cancel_hdd;
