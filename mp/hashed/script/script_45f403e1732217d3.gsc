...
function private function_968a17536a9b61d3(origin, angles) {
    var_c00a316249963882 = namespace_7349d2dcd492da87::function_45d01d27e99f49d7();
    round_num = var_c00a316249963882[5];
    playlist_name = var_c00a316249963882[4];
    playlist_id = var_c00a316249963882[3];
    sub_game_type = var_c00a316249963882[2];
    game_type = var_c00a316249963882[1];
    map_name = var_c00a316249963882[0];
    if (!isdefined(origin)) {
        origin[0] = -1;
        origin[1] = -1;
        origin[2] = -1;
...
function private function_234528691f62628b(data) {
    var_c00a346249963f1b = namespace_7349d2dcd492da87::function_45d01d27e99f49d7();
    round_num = var_c00a346249963f1b[5];
    playlist_name = var_c00a346249963f1b[4];
    playlist_id = var_c00a346249963f1b[3];
    sub_game_type = var_c00a346249963f1b[2];
...
function function_83e5e7d28c56eef1(data) {
    ...
    var_bffcbb624987207b = namespace_7349d2dcd492da87::function_45d01d27e99f49d7();
    round_num = var_bffcbb624987207b[5];
    playlist_name = var_bffcbb624987207b[4];
    playlist_id = var_bffcbb624987207b[3];
    sub_game_type = var_bffcbb624987207b[2];
    game_type = var_bffcbb624987207b[1];
    map_name = var_bffcbb624987207b[0];
...
function private function_b06acd6b01e90383(round_start_time_ms, round_end_time_ms) {
    var_bffcbc62498722ae = namespace_7349d2dcd492da87::function_45d01d27e99f49d7();
    round_num = var_bffcbc62498722ae[5];
    playlist_name = var_bffcbc62498722ae[4];
    playlist_id = var_bffcbc62498722ae[3];
    sub_game_type = var_bffcbc62498722ae[2];
    game_type = var_bffcbc62498722ae[1];
    map_name = var_bffcbc62498722ae[0];
