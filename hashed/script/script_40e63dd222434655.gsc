...
function function_f7453e13040e1140() {
    ...
    while (true) {
        /#
            if (getdvarint(@"bot_DisableAllAI") || self.sessionstate == "<dev string:x20b>") {
                wait 0.05;
                continue;
            }
        #/
