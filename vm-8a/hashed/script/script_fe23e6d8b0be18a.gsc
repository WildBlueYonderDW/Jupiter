...
/#
    ...
    function private function_67ce357c2e2478d7() {
        ...
        function_a9a864379a098ad6("<dev string:x29>", "<dev string:x3d>", &function_6a0e53758c9edf, 1);
        function_a9a864379a098ad6("<dev string:x51>", "<dev string:x63>", &function_a7ca20ea38e7dd83);
    ...
    function private function_6a0e53758c9edf() {
        ...
        while (true) {
            foreach (s_doorbuy in level.var_4de493999935f442) {
                ...
                var_d8b783bf56b63a71 = "<dev string:x75>";
                ...
                } else if (s_doorbuy.interact tagexists("<dev string:x80>")) {
                    v_position = s_doorbuy.interact gettagorigin("<dev string:x80>", 1);
                    var_d8b783bf56b63a71 = "<dev string:x80>";
                } else {
                ...
                print3d(v_position, "<dev string:x89>" + s_doorbuy.script_currency, (0, 1, 0), 1, var_e33953429ed350f);
                print3d(v_position - var_39239d1f90650b, "<dev string:x99>" + s_doorbuy.script_cost, (0, 1, 0), 1, var_e33953429ed350f);
                var_3c6719c8aa252447 = "<dev string:xa0>";
                var_f884de9f009c09b4 = "<dev string:xa0>";
                if (isdefined(s_doorbuy.script_flag_set)) {
                    var_b9249169199027bb = strtok(s_doorbuy.script_flag_set, "<dev string:xa1>");
                    foreach (str_flag in var_b9249169199027bb) {
                        var_3c6719c8aa252447 = var_3c6719c8aa252447 + str_flag + "<dev string:xa1>";
                    }
                                    ...
                                    if (isarray(var_5b7050cf7b40f6de.flags)) {
                                        foreach (str_flag in var_5b7050cf7b40f6de.flags) {
                                            if (utility::array_contains(var_b9249169199027bb, str_flag)) {
                                                var_f884de9f009c09b4 = var_f884de9f009c09b4 + str_zone + "<dev string:xa1>";
                                                break;
                                            }
                                        }
                                    }
                ...
                print3d(v_position - var_39239d1f90650b * 2, "<dev string:xa3>" + var_3c6719c8aa252447, (0, 1, 0), 1, 0.25);
                print3d(v_position - var_39239d1f90650b * 3, "<dev string:xb0>" + var_f884de9f009c09b4, (0, 1, 0), 1, 0.25);
                print3d(v_position - var_39239d1f90650b * 4, "<dev string:xc1>" + utility::default_to(s_doorbuy.script_power, "<dev string:xa0>"), (0, 1, 0), 1, 0.25);
                if (istrue(s_doorbuy.interact.b_is_trigger)) {
                    var_ab9799ccaf563cab = "<dev string:xce>";
                    var_d8b783bf56b63a71 = "<dev string:xa0>";
                } else {
                    var_ab9799ccaf563cab = "<dev string:xd6>";
                    var_d8b783bf56b63a71 = "<dev string:xdd>" + var_d8b783bf56b63a71 + "<dev string:xe4>";
                }
                print3d(v_position - var_39239d1f90650b * 5, "<dev string:xe6>" + var_ab9799ccaf563cab + var_d8b783bf56b63a71, (0, 1, 0), 1, 0.25);
                if (isarray(s_doorbuy.interact.doors)) {
                    ...
                    foreach (door in s_doorbuy.interact.doors) {
                        ...
                        if (door isscriptable()) {
                            print3d(door.origin, "<dev string:xf8>", (0, 1, 0), 1, 0.25);
                            continue;
                        }
                        print3d(door.origin, "<dev string:x10e>", (0, 1, 0), 1, 0.25);
                    }
                }
            }
            waitframe();
