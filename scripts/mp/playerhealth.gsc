...
function init() {
    ...
    scripts/mp/tweakables::settweakablevalue("player", "healthregentime", healthregendelay);
    scripts/mp/tweakables::settweakablelastvalue("player", "healthregentime", healthregendelay);
    level.healthregendelay = scripts/mp/tweakables::gettweakablevalue("player", "healthregentime");
    level.healthregendisabled = level.healthregendelay <= 0;
    level.playerhealth_regularregendelay = level.healthregendelay;
    level.var_562530bdb8e83b66 = scripts/mp/utility/dvars::getoverridedvarfloatexceptmatchrulesvalues(hashcat(@"hash_d98c82b5a26dc973", getgametype(), "_deathsDoorEnterPct"), @"hash_e4f93d764d11874d");
    level.var_fdd1af3c4c6cbe86 = scripts/mp/utility/dvars::getoverridedvarfloatexceptmatchrulesvalues(hashcat(@"hash_d98c82b5a26dc973", getgametype(), "_deathsDoorExitPct"), @"hash_b84edc242cc61abf");
