...
// Namespace toma_strike / scripts/cp_mp/killstreaks/toma_strike
...
function tomastrike_getownerlookat(owner) {
    ...
    trace = scripts/engine/trace::ray_trace(starttrace, endtrace, ignoreents, contentoverride);
    endpos = undefined;
...
function function_44ffb652b0e5c138(tomaid) {
    ...
    while (isdefined(self)) {
        recentkillcount, var_366b0ecc2f28aead = self waittill("update_rapid_kill_buffered");
...
function function_9b8a16f9169ac8b2(tomaid) {
    level endon("toma_strike_finished_" + tomaid);
    while (isdefined(self)) {
        recentkillcount, var_366b0ecc2f28aead = self waittill("update_rapid_agent_kill_buffered");
        if (isdefined(var_366b0ecc2f28aead) && var_366b0ecc2f28aead == level.var_d2a6e2899c72649b) {
            self.var_effda3765a5caf17++;
        }
    }
...
function function_e744d4edafed7523(tomaid, striketype, target) {
    ...
    if (explosiontype == 1) {
        ...
        for (i = 0; i < var_4cb267f38b5de2f2; i++) {
            ...
            for (j = 0; j < var_c1ca10e800f3bb3b; j++) {
                ...
                level.toma_strikes[tomaid].totaltimesec = level.toma_strikes[tomaid].totaltimesec + timetowait;
    ...
    var_57acadc40b2f0a8 = function_19051844ba5d9143(striketype);
    radius = var_57acadc40b2f0a8[1];
    numstrikes = var_57acadc40b2f0a8[0];
...
function tomastrike_getrandombombingpoint(var_27c77d35f1de2019, var_a0edd3f59d938fb1, var_a78cd67f5364240c) {
    ...
    trace = scripts/engine/trace::ray_trace(point + (0, 0, traceheightoffset), point - (0, 0, traceheightoffset), undefined, contents);
...
function function_6153b8a392d10771(groundexplodepos, var_63d5339e498e6f77, stuckto, owner, starttime, streakinfo) {
    ...
    if (istrue(self.waterimpact)) {
        explodepart = explodepart + "_water";
    }
...
function toma_strike_watch_stuck(explosiontype, var_6951cf1f43bc8ebe, var_8011cffb839e8243, launchvelocity) {
    ...
    if (isdefined(stuckto) && isplayer(stuckto)) {
        toma_strike_stuck_player(explosiontype, self, stuckto, var_6951cf1f43bc8ebe, impactvelocity);
    } else {
        toma_strike_stuck(explosiontype, stuckto, var_6951cf1f43bc8ebe, impactvelocity);
    }
...
// Size: 0x10d
function toma_strike_stuck(explosiontype, stuckto, var_6951cf1f43bc8ebe, impactvelocity) {
    angles = undefined;
...
// Size: 0x1fa
function toma_strike_stuck_player(explosiontype, grenade, stuckto, var_6951cf1f43bc8ebe, impactvelocity) {
    impactvelocity = impactvelocity * (0, 0, 1);
    ...
    if (isdefined(castresults) && castresults.size > 0) {
        ...
        thread toma_strike_launch_cluster(grenade, castend, var_4b65413211af7033, casthitent, gettime() + t * 1000);
    }
}
...
// Size: 0x335
function toma_strike_launch_cluster(grenade, impactorigin, var_4b65413211af7033, impactent, impacttime) {
    owner = grenade.owner;
    ...
    branch = toma_strike_create_branch(shareddata, castdata, undefined, borigin, var_4b65413211af7033, impactent, 0, undefined, undefined);
        ...
        case 0:
            if (istrue(casthit)) {
                ...
                if (isdefined(self.castdata.firstforwarddist)) {
                    ...
                    self.castdata.firstforwarddist = self.castdata.firstforwarddist - castdist;
...
function tomastrike_findoptimallaunchpos(markerorigin, var_d77253c873d2b420, ownerforward, ownerright) {
    contents = scripts/engine/trace::create_default_contents(1);
    trace = scripts/engine/trace::ray_trace(markerorigin - var_d77253c873d2b420 * 30, markerorigin + var_d77253c873d2b420 * 1000, undefined, contents);
    ...
    foreach (dirpos in var_f74f18c717b149e2) {
        ...
        traceresult = scripts/engine/trace::ray_trace_passed(starttracepos, endtracepos, undefined, contents);
