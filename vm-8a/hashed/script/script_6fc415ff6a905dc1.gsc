...
function function_f09e47b124561928() {
    ...
    println(self.name + "<dev string:x38>");
...
function function_5332e1c0f06b0245(var_3064fa24dbbd5bbf) {
    ...
    println(self.name + "<dev string:x5c>");
    ...
    println(self.name + "<dev string:x82>");
}
    ...
    foreach (item in inventory) {
        ...
        if (isdefined(index)) {
            ...
            /#
                ...
                println("<dev string:xc3>" + index + "<dev string:xc5>" + item.lootid + "<dev string:xcb>" + ref + "<dev string:xce>" + currentquantity);
            #/
...
function function_e249cffd8b8f7a9(index, lootid, quantity, cooldown) {
    ...
    /#
        println(self.name + "<dev string:xd2>" + index + "<dev string:xed>" + lootid + "<dev string:xed>" + quantity + "<dev string:xf0>");
        println("<dev string:xc3>" + index + "<dev string:xc5>" + lootid + "<dev string:xcb>" + ref + "<dev string:xce>" + quantity);
    #/
...
function function_bac731e0fdaa0ccb(lootid) {
    println(self.name + "<dev string:xf3>" + "<dev string:x111>" + lootid);
    if (!isdefined(lootid)) {
        return;
    }
...
function function_2d55e66e05614871() {
    println(self.name + "<dev string:x114>");
    for (i = 0; i < 11; i++) {
        ...
        ref = namespace_38b993c4618e76cd::function_793e8a72cedb8ef3(lootid);
        /#
            println("<dev string:xc3>" + i + "<dev string:x137>" + lootid + "<dev string:xcb>" + ref + "<dev string:xce>" + lootid);
            println("<dev string:xc3>" + i + "<dev string:x13e>" + lootid + "<dev string:xcb>" + ref + "<dev string:xce>" + quantity);
        #/
    ...
    println(self.name + "<dev string:x14b>");
    for (i = 0; i < 11; i++) {
        lootid = self getplayerdata(level.var_5d69837cf4db0407, "dmzBackpackFE", i, "lootID");
        quantity = self getplayerdata(level.var_5d69837cf4db0407, "dmzBackpackFE", i, "quantity");
        ref = namespace_38b993c4618e76cd::function_793e8a72cedb8ef3(lootid);
    ...
    println(self.name + "<dev string:x15c>");
    for (i = 0; i < 11; i++) {
