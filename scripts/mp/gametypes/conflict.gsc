    ...
    /#
        ...
        while (true) {
            if (getdvar(@"hash_24d9f7f9324e9c61") != "secured_b") {
                ...
                if (isdefined(level.tdmzones["secured_c"])) {
                    foreach (objective in level.tdmzones["secured_c"]) {
                        thread drawsphere(objective.origin, 20, 1, (1, 1, 1));
                    }
                }
                if (isdefined(level.tdmzones["iw9_mdom_mode_uktl_dcpe"])) {
                    foreach (objective in level.tdmzones["iw9_mdom_mode_uktl_dcpe"]) {
                        thread drawsphere(objective.origin, 20, 1, (1, 1, 1));
                    }
                }
                if (isdefined(level.tdmzones["losing_a"])) {
                    foreach (objective in level.tdmzones["losing_a"]) {
                        thread drawsphere(objective.origin, 20, 1, (1, 1, 1));
                    }
                }
            }
...
function function_e3a2a0c2e544728e(var_a4ab3e1ca5d220c4) {
    /#
        if (var_a4ab3e1ca5d220c4 <= 5) {
            ...
            safekey = "iw9_mdom_mode_uktl_dlsc" + var_a4ab3e1ca5d220c4 + "vfx_smk_signal_gr";
            var_eb7299174b67818d = undefined;
            var_fd81d96696f0490a = undefined;
            if (isdefined(level.spawnselectionlocations[safekey]) && isdefined(level.spawnselectionlocations[safekey]["lost_b"])) {
                var_eb7299174b67818d = level.spawnselectionlocations[safekey]["lost_b"].spawnpoints;
            }
            if (isdefined(level.spawnselectionlocations[safekey]) && isdefined(level.spawnselectionlocations[safekey]["iw9_mdom_mode_uktl_dloe"])) {
                var_fd81d96696f0490a = level.spawnselectionlocations[safekey]["iw9_mdom_mode_uktl_dloe"].spawnpoints;
            }
