...
function onsupportboxusedbyplayer(player, dropstruct) {
    ...
    foreach (weap in var_509d86412c9d7426) {
        ...
        if (isaxeweapon(weap) || weap.isalternate && namespace_e0ee43ef2dddadaa::function_de04e13ab01e1a10(weap.underbarrel)) {
...
// Size: 0x47
function function_c0792be717c334d0(var_5c9ddcf56d36f133) {
    switch (var_5c9ddcf56d36f133) {
    case 1:
