...
// Namespace common_kiosk / namespace_f6aa44081e6af0a8
...
function _runpurchasemenu(kiosk) {
    ...
    openvalue = 0;
    if (istrue(player.common_kiosk.var_746c06c00cd6bdc5)) {
...
function onarmorykioskpurchase(channel, purchaseindex) {
    ...
    if (channel == "br_item_purchase") {
        ...
        cost = cost * default_to(level.gametypebundle.var_dc7ab0a22b829f8b, 10);
        ...
        if (player function_bcc79745d547a99c(var_fbe1c496c49a42bc, cost)) {
            ...
            if (itemtype == "fieldupgrade") {
                ...
                itemtype = "armor";
                itemcallbacks = player namespace_2abc885019e1956::function_cca8bbe88a39ad41(itemtype);
                if ([[ itemcallbacks.var_381daafc5fc31b7f ]]()) {
                    ...
                    var_fbe1c496c49a42bc = default_to(function_98aedb8cf660c612(itemdata.entryref), "essence");
                    player namespace_7dfc6454a70f3f39::function_a06aa3b8c98e131e(var_fbe1c496c49a42bc, cost, #"buystation", itemdata.entryref);
            ...
            itembundlename = namespace_2abc885019e1956::function_61d960957fcf3ca0(var_3719061529ddd848);
            /#
                assertex(isdefined(itembundlename), "An ItemSpawnEntry Bundle with ref " + var_3719061529ddd848 + " not found in global item list!");
            #/
            ...
            var_84ab4c28dc11052d = player namespace_2abc885019e1956::function_576728d3d4486bd6(fakeitem, 0, 1);
    ...
    if (channel == "sell_item") {
        itemindex = namespace_feea61bc660e9e0f::function_4953ec8e37aa67b8(purchaseindex);
...
function function_8e857ffadd6d1af2(player, itemslotindex, sellall) {
    ...
    if (isdefined(itemref) && isdefined(var_b1f734ded9a2721a) && isdefined(var_b1f734ded9a2721a.var_af40863a32d7792b)) {
        ...
        currencybundle = namespace_7dfc6454a70f3f39::function_7714028270738890(var_b1f734ded9a2721a.var_38d055f24fe64e71);
        if (isdefined(currencybundle)) {
            player namespace_7dfc6454a70f3f39::function_3036cef61495210f(currencybundle.currencyname, cashvalue, #"sold");
        }
