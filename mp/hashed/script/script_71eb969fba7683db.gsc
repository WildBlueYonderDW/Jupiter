...
#namespace jup_enemy_mp_pistol_tier1_pmc;

// Namespace jup_enemy_mp_pistol_tier1_pmc / namespace_af08502cfc32d3b1
// Params 0, eflags: 0x0
// Checksum 0x0, Offset: 0x1f9
// Size: 0x1bb
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_mp_pistol_tier1_pmc" );
    ...
    primaryweaponhash = "iw9_pi_papa220, [ none, none, none, none, none, none ], none, none";
...
function precache()
{
    agent_type = "actor_jup_enemy_mp_pistol_tier1_pmc";
...
function setup_weapons()
{
    ...
    {
        level.var_67b54180a55f70e1[ primaryweaponhash ] = scripts\mp\class::function_e83615f8a92e4378( "iw9_pi_papa220", [ "none", "none", "none", "none", "none", "none" ], "none", "none" );
    }
