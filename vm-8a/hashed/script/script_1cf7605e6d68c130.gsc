...
function init_magicbox(var_ab2f2c696f2e969d) {
    ...
    namespace_4164bc931714b00b::register_script("magicbox", &function_5432ff3fb5bd59c9);
    ...
    assertex(isdefined(level.gamemodebundle.magicboxbundle), "Create a magicbox bundle asset to use in this gamemode and add to gamemodebundle");
}
...
/#
    ...
    function function_9433af8de8931e12() {
        ...
        function_a9a864379a098ad6("<dev string:x43>", "<dev string:x59>", &function_7b5090b85561b747, 1);
        function_a9a864379a098ad6("<dev string:x6e>", "<dev string:x8a>", &function_4dd640fcb2a0c79e);
        function_a9a864379a098ad6("<dev string:x98>", "<dev string:xb4>", &function_49b1a3d1fe2ab11f);
        function_a9a864379a098ad6("<dev string:xc8>", "<dev string:xda>", &function_8d554b62a88524e7);
        function_b23a59dfb4ca49a1("<dev string:xeb>", "<dev string:x108>", &function_d5899f2536209f81);
        function_b23a59dfb4ca49a1("<dev string:x11e>", "<dev string:x13c>", &function_d5899f2536209f81);
        function_b23a59dfb4ca49a1("<dev string:x153>", "<dev string:x171>", &function_d5899f2536209f81);
        function_b23a59dfb4ca49a1("<dev string:x189>", "<dev string:x1b6>", &function_d5899f2536209f81);
        function_b23a59dfb4ca49a1("<dev string:x1cc>", "<dev string:x1f3>", &function_a611dfe6a478e045);
        var_bbdcc30a274b0882 = getscriptbundle("<dev string:x20f>" + level.str_magicbox_weapon_itemspawnlist);
        function_69e55cbe67712bf1(var_bbdcc30a274b0882);
        var_d69c2e9355968734 = getscriptbundle("<dev string:x20f>" + level.var_ed8526d7d2e56787);
        function_69e55cbe67712bf1(var_d69c2e9355968734);
        var_f03c09452a67a2f1 = getscriptbundle("<dev string:x20f>" + level.var_2b71131620c6b678);
    ...
    function function_d5899f2536209f81(params) {
        ...
        if (n_time_passed >= 0) {
            ...
            iprintlnbold("<dev string:x21e>" + minutes + "<dev string:x23e>" + seconds + "<dev string:x240>");
            return;
        }
        iprintlnbold("<dev string:x242>");
    }
    ...
    function function_69e55cbe67712bf1(s_bundle) {
        if (isarray(s_bundle.itementries)) {
            foreach (var_4e2011e509e7f90 in s_bundle.itementries) {
                function_b23a59dfb4ca49a1("<dev string:x268>" + var_4e2011e509e7f90.itemspawnentry, "<dev string:x279>" + var_4e2011e509e7f90.itemspawnentry, &function_a611dfe6a478e045);
            }
        }
        if (isarray(s_bundle.itemlistentries)) {
            foreach (var_62afdcece0cc5168 in s_bundle.itemlistentries) {
                var_3ecd2db331134b8c = getscriptbundle("<dev string:x20f>" + var_62afdcece0cc5168.itemspawnlist);
    ...
    function function_a611dfe6a478e045(params) {
        if (params[0] == "<dev string:x290>") {
            setdvar(@"hash_5bf38da5a2eda0c8", "<dev string:x296>");
            iprintlnbold("<dev string:x297>");
            return;
        }
        setdvar(@"hash_5bf38da5a2eda0c8", params[0]);
        iprintlnbold("<dev string:x2b2>" + params[0]);
    }
    ...
    function function_49b1a3d1fe2ab11f() {
        ...
        foreach (s_magicbox in level.var_eb895aaca65f1d6f) {
            if (!s_magicbox.var_75e032c5035207fe) {
                iprintlnbold("<dev string:x2fd>" + function_6743ce9942654f5c() - s_magicbox.var_fec5078e78eb7217 + "<dev string:x319>");
                continue;
            }
            iprintlnbold("<dev string:x320>" + function_d26b24de82eb5022() - s_magicbox.var_fec5078e78eb7217 + "<dev string:x319>");
        }
    }
...
function function_8eda83df58e1a162(params) {
    ...
    if (level.var_eb895aaca65f1d6f.size) {
        ...
        assertex(isdefined(var_d43c12b812bbdd6c), "Create a magicbox scaling bundle to use in " + level.gamemodebundle.magicboxbundle);
...
function function_5cc90fd8a70217c7() {
    ...
    if (!isdefined(self.mdl_magicbox)) {
        if (isdefined(s_bundle.model) && !isdefined(self.var_c46b8c78447b3491)) {
            self.mdl_magicbox = namespace_4164bc931714b00b::spawn_script_model(self, s_bundle.model, 1, 1);
        } else {
    ...
    if (!isdefined(self.mdl_magicbox.interact)) {
        self.mdl_magicbox.interact = namespace_5775ad2badedbcaa::register_interact(self.mdl_magicbox, self.radius, &function_93b6d9d9170876bd);
        self.mdl_magicbox.interact namespace_5775ad2badedbcaa::function_e6c63f16f2258b80(&function_6d88ee94fd62afcb);
        self.mdl_magicbox.interact namespace_5775ad2badedbcaa::function_9a0883b5a0999dac();
...
function private function_6d88ee94fd62afcb(usable, player) {
    if (isdefined(player) && isdefined(usable)) {
        ...
        if (isdefined(usable.interact) && isdefined(usable.interact.s_magicbox)) {
            ...
            if (player namespace_7dfc6454a70f3f39::function_bcc79745d547a99c(magicbox.script_currency, magicbox.script_cost)) {
                return {#params:[magicbox.script_cost], #string:magicbox.var_3d8b82bffbc735ca, #type:"HINT_BUTTON"};
            } else {
                return {#params:[magicbox.script_cost], #string:magicbox.var_981915a1de2060a9, #type:"HINT_BUTTON"};
            }
        }
    }
    return {#string:%, #type:"HINT_NOICON"};
...
function function_93b6d9d9170876bd(player) {
    ...
    if (isdefined(player) && isdefined(self.s_magicbox.script_currency) && isdefined(self.s_magicbox.script_cost)) {
        if (!player namespace_7dfc6454a70f3f39::attempt_purchase(self.s_magicbox.script_currency, self.s_magicbox.script_cost, undefined, undefined, #"magicbox")) {
            return;
        }
    }
...
function function_d97bbdb67211e6ba() {
    ...
    /#
        if (isdefined(self.var_79c38a575c9cdcbe)) {
            println("<dev string:x368>" + self.var_79c38a575c9cdcbe);
        }
    #/
}
    ...
    if (isdefined(var_bb0b21ef996dd5cd) && isdefined(self.primaryweapons)) {
        foreach (weapon in self.primaryweapons) {
            if (weapon.basename == var_bb0b21ef996dd5cd) {
                println(self.name + "<dev string:x387>" + var_bb0b21ef996dd5cd + "<dev string:x395>");
                return true;
            }
        }
    }
    ...
    if (isdefined(self.streakdata) && isdefined(self.streakdata.streaks) && isdefined(var_edf725d742241f31)) {
        foreach (s_streak in self.streakdata.streaks) {
            if (s_streak.streakname == var_edf725d742241f31 && s_streak.available > 0) {
                println(self.name + "<dev string:x387>" + var_edf725d742241f31 + "<dev string:x395>");
                return true;
            }
        }
    }
...
function function_e4f1c5e85e0d69a() {
    ...
    if (!shouldmovemagicbox) {
        ...
        if (var_fcf1dc7f731dcc73) {
            ...
            weaponobj = namespace_e0ee43ef2dddadaa::buildweapon(baseweaponname, var_4f74f0aef2b2a8bf.attachments);
    ...
    if (shouldmovemagicbox) {
        ...
        if (isplayer(self.var_c80acd5b1945a70f)) {
            self.var_c80acd5b1945a70f namespace_7dfc6454a70f3f39::function_3036cef61495210f(self.script_currency, self.script_cost);
        }
    ...
    self.var_8a0892269455a613.interact = namespace_5775ad2badedbcaa::register_interact(self.var_8a0892269455a613.origin, 64, &function_c6bcc8af70c669d6);
        ...
        while (true) {
            foreach (s_magicbox in level.var_eb895aaca65f1d6f) {
                ...
                if (!isdefined(s_magicbox.s_destination)) {
                    s_magicbox.s_destination = getstruct(s_magicbox.str_destination, "<dev string:x3c6>");
                }
                var_d8b783bf56b63a71 = "<dev string:x3d1>";
                if (s_magicbox.mdl_magicbox.interact tagexists("<dev string:x3dc>")) {
                    v_position = s_magicbox.mdl_magicbox.interact gettagorigin("<dev string:x3dc>");
                    var_d8b783bf56b63a71 = "<dev string:x3dc>";
                } else {
                ...
                print3d(v_position, "<dev string:x3e5>" + s_magicbox.script_currency, (0, 1, 0), 1, var_e33953429ed350f);
                print3d(v_position - var_39239d1f90650b * 1, "<dev string:x3f5>" + ter_op(istrue(s_magicbox.var_c0a492297cea3070), "<dev string:x401>", "<dev string:x405>"), (0, 1, 0), 1, 0.25);
                print3d(v_position - var_39239d1f90650b * 2, "<dev string:x408>" + s_magicbox.str_destination, (0, 1, 0), 1, 0.25);
                if (istrue(s_magicbox.mdl_magicbox.interact.b_is_trigger)) {
                    var_ab9799ccaf563cab = "<dev string:x41d>";
                    var_d8b783bf56b63a71 = "<dev string:x296>";
                } else {
                    var_ab9799ccaf563cab = "<dev string:x425>";
                    var_d8b783bf56b63a71 = "<dev string:x42c>" + var_d8b783bf56b63a71 + "<dev string:x433>";
                }
                print3d(v_position - var_39239d1f90650b * 3, "<dev string:x435>" + var_ab9799ccaf563cab + var_d8b783bf56b63a71, (0, 1, 0), 1, 0.25);
            }
            waitframe();
        }
    }
