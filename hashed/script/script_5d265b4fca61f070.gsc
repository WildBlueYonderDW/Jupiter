...
function function_139ccec48e7e3539(reason) {
    /#
        ...
        iprintlnbold("UNDEFINED SEGMENT" + reason + "proceed" + default_to(self.name, "script_origin"));
    #/
}
    ...
    /#
        ...
        for (;;) {
            ...
            for (i = 0; i < sequence.size; i++) {
                ...
                segment = sequence[i];
                if (isstring(segment)) {
                    display_ln = "<unknown string>" + segment;
                } else if (isnumber(segment)) {
                ...
                if (isdefined(display_ln)) {
                    ...
                    if (isdefined(self.name)) {
                        event_info = "<unknown string>" + self.speaker getentitynumber() + "<unknown string>" + self.name + "<unknown string>";
...
function function_866a3b95a50aa7c2(height, endy, lineheight, var_7794fdd4649e6d7f) {
    ...
    if (isdefined(self.row)) {
        self.y = self.y + self.row * lineheight + var_7794fdd4649e6d7f;
    }
