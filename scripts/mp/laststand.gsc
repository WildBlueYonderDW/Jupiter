...
function init() {
    ...
    if (namespace_76a219af07c28c13::function_6934349b7823d888()) {
        namespace_76a219af07c28c13::registerteamassimilatecallback(&scripts/mp/teamrevive::function_df4a3cff3137d441);
    }
    /#
...
function laststandthink() {
    ...
    /#
        if (false) {
            resstring = ter_op(isdefined(result), result, "specialty_shroud");
            println("vehicle_exit" + resstring);
        }
    #/
    switch (result) {
...
function onenter() {
    ...
    /#
        if (!isusingmatchrulesdata()) {
            healthvalue = getwatcheddvar("offhand_1h_wm_stim_v0");
            if (!isdefined(healthvalue)) {
                healthvalue = getdvarint(@"hash_984461a4d8ff9473", 50);
            }
            if (healthvalue > scripts/mp/tweakables::gettweakablevalue("afk_tracking_resume", "postgame")) {
                healthvalue = scripts/mp/tweakables::gettweakablevalue("afk_tracking_resume", "postgame");
            }
        }
    #/
...
function dodamagewhiledown() {
    ...
    /#
        if (!isusingmatchrulesdata()) {
            ...
            if (basehealth > scripts/mp/tweakables::gettweakablevalue("afk_tracking_resume", "postgame")) {
                basehealth = scripts/mp/tweakables::gettweakablevalue("afk_tracking_resume", "postgame");
            }
    ...
    while (isreallyalive(downedplayer) && (selfrevivebuttonpressed(downedplayer) || downedplayer function_77799f0211be1728()) && triggerent.curprogress < triggerent.usetime) {
        ...
        if (triggerent.curprogress >= triggerent.usetime) {
            ...
            if (istrue(downedplayer.var_b24e609023ce8208)) {
                downedplayer thread namespace_833bd5cc623ca701::function_31afe9d7b373900f();
                return;
            }
        ...
        /#
            if (istrue(downedplayer.var_4ab61a57453e2816)) {
                ...
                downedplayer.revivetimems = downedplayer.revivetimems + level.frameduration;
            }
        #/
        waitframe();
    }
...
function onrevive(var_4920bf02df960be9, var_d07b7dcc79b24490) {
    ...
    if (function_311066dfee085643(self)) {
        ...
        /#
            if (!isusingmatchrulesdata()) {
                healthvalue = getwatcheddvar("outlinefill_nodepth_orange");
                if (!isdefined(healthvalue)) {
                    healthvalue = getdvarint(@"hash_984461a4d8ff9473", 50);
                }
                if (healthvalue > scripts/mp/tweakables::gettweakablevalue("afk_tracking_resume", "postgame")) {
...
function revivetriggerthink(team) {
    ...
    for (;;) {
        ...
        if (onmover && !scripts/engine/trace::ray_trace_detail_passed(reviver geteye(), self.origin + (0, 0, 20), [reviver, self.owner], scripts/engine/trace::create_contents(1, 0, 0, 0, 0, 1))) {
        ...
        if (!self.owner namespace_833bd5cc623ca701::function_f0d1c9c39359efff()) {
            reviver thread scripts/mp/teamrevive::function_c86cf00d5859ce10(self.owner.origin);
        }
        revived = 0;
...
function function_56e47961499ca06c(team) {
    ...
    for (;;) {
        ...
        var_5bebd3013b0f041f = var_5bebd2013b0f01ec function_70f1dbc7125939b8(notif, interrogator, self.owner.team);
    ...
    if (!istrue(reviver.revivingteammate) && !istrue(reviver.var_93018d510a589832)) {
        /#
            if (false) {
                ...
                println("meat_shield" + breviving + "interrogate_frontleft_knife_start" + var_6c0402dbf33cc28a);
            }
        #/
        return;
    }
    ...
    if (var_e6df16e26edacea != 0) {
        ...
        if (var_e6df16e26edacea == 2 || var_e6df16e26edacea == 3) {
            if (isdefined(var_5bebd2013b0f01ec.plundercount) && var_5bebd2013b0f01ec.plundercount > 0) {
                ...
                var_257077ad57a19a9b = var_257077ad57a19a9b + int(var_fb2196e070a5d84e * rewardpercent);
...
function function_f671d7efef879a1(attacker, victim) {
    ...
    offsetorigindefender = var_c0014262498c3f37[2];
    ...
    if (!attacker scripts/engine/trace::player_trace_passed(attacker.origin + (0, 0, 10), attackerpos + (0, 0, 10), var_67d8ddf901f65b1d, ignoreents)) {
        return 0;
    }
    return 5;
}
...
function useholdthinkcleanup(reviver, revivespot, interrogation) {
    ...
    /#
        if (getdvarint(@"hash_8961da4992114762", 0) != 0 && interrogation && notif == "<unknown string>") {
            notif = "<unknown string>";
        }
    #/
    ...
    revivespot delete();
    if (isdefined(reviver)) {
        reviver scripts/mp/teamrevive::function_a3ffe1d08888c2();
    ...
    while (useholdthinkisvalid(reviver, revivee, mintime, shouldstay)) {
        ...
        /#
            if (istrue(revivee.var_4ab61a57453e2816)) {
                ...
                revivee.revivetimems = revivee.revivetimems + level.frameduration;
            }
            debugkillcounter = debugkillcounter + level.framedurationseconds;
...
function addoverheadicon() {
    ...
    showonminimap = 0;
    image = scripts/cp_mp/entityheadicons::setheadicon_singleimage(showto, image, offset, var_e0e11f3b4551be11, var_c5409ca7522182b3, naturaldist, delaytime, var_fa4cf28a58192889, var_b3ea37733a1577e5, overrideorigin, showonminimap);
...
function function_25bb5b0a542a335c(dir, attacker, defender, playtime) {
    ...
    for (timeleft = playtime; timeleft > 0; timeleft = timeleft - waittime) {
        if (!isdefined(self)) {
            break;
        }
...
function function_4aa5cc0d5aaf5e13(dir, attacker, defender) {
    ...
    offsetorigindefender = var_c01bc36249a983f4[2];
...
function function_96f2172e98188560(target) {
    ...
    var_88f59c89f67e4385 thread scripts/mp/teamrevive::function_7f0aebb7ad935939(self);
    ...
    if (isdefined(mover)) {
        ...
        thread scripts/mp/teamrevive::function_34fd10b9791b7bb2(mover);
    } else {
        thread scripts/mp/teamrevive::function_d75bbd43c2e29f0c();
    }
...
function function_5911caad56f963ea(team, changeval) {
    if (team == "axis") {
        level.var_a04b495bbccdf0bf = level.var_a04b495bbccdf0bf + changeval;
        setomnvar("ui_cutthroat_num_reviving_team_1", level.var_a04b495bbccdf0bf);
        return;
    }
    if (team == "allies") {
        level.var_eb919e162d131112 = level.var_eb919e162d131112 + changeval;
        setomnvar("ui_cutthroat_num_reviving_team_2", level.var_eb919e162d131112);
        return;
    }
    if (team == "team_three") {
        level.var_62973ff88470b851 = level.var_62973ff88470b851 + changeval;
...
function function_e6ccdf90ba898cdc(team, changeval) {
    if (team == "axis") {
        level.var_2d9a769507f8c794 = level.var_2d9a769507f8c794 + changeval;
        setomnvar("ui_cutthroat_num_downed_team_1", level.var_2d9a769507f8c794);
        return;
    }
    if (team == "allies") {
        level.var_419bc98b5f722331 = level.var_419bc98b5f722331 + changeval;
        setomnvar("ui_cutthroat_num_downed_team_2", level.var_419bc98b5f722331);
        return;
    }
    if (team == "team_three") {
        level.var_9663d50652fde8c2 = level.var_9663d50652fde8c2 + changeval;
