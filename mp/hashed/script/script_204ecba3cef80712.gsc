...
// Size: 0x1e0
function main() {
    self.aitypeid = function_2336488258354fbc(#"aitype", %"hash_be7fdd9bfbaf722");
    self.var_534e788bc498be9f = getscriptbundle(%"hash_13c77521a3707349");
    self.subclass = self.var_534e788bc498be9f.name;
    self.health = 300;
    self.maxhealth = 300;
    self.behaviortreeasset = "soldier_agent_benchmark";
...
// Size: 0xcf
function precache() {
    agent_type = "actor_enemy_mp_benchmark_base";
