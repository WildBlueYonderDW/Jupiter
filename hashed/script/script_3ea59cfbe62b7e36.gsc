...
// Namespace namespace_2a1d03171168c53c / namespace_412bca0dc34669f4
// Params 0, eflags: 0x0
...
function function_625db34652815f74() {
    ...
    setsaveddvar(@"dynEnt_spatialMaxOccluderEnts", 600);
    setsaveddvar(@"dynEnt_spatialMaxEntsHighPrio", 600);
    setsaveddvar(@"dynEnt_spatialMaxEntsLowPrio", 600);
