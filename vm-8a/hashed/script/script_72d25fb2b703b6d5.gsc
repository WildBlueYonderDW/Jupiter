...
function function_ffa68c72485da6cc(var_cbfc3ba10cefc8ce) {
    ...
    if (!getdvarint(@"hash_19a406e3c51ce52f")) {
        ...
        assert(!istrue(level.arrow.dvars.var_c86c4de4e54401e1) || istrue(level.arrow.var_528c4735877d507c));
        if (istrue(level.arrow.dvars.var_c86c4de4e54401e1) && !istrue(level.arrow.var_528c4735877d507c)) {
...
function private function_93b66df7957f429() {
    ...
    /#
        shot = getdvar(@"hash_6e6b30dcd38ed28f", "<dev string:x31>");
        if (shot != "<dev string:x31>") {
            variation = "<dev string:x32>" + shot;
        }
    #/
