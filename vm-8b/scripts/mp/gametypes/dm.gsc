...
function main() {
    ...
    if (function_5be859df8ee33a38()) {
        level thread namespace_af92f63c4264f983::init();
        level.onplayerconnect = &namespace_af92f63c4264f983::onplayerconnect;
        level.modeonspawnplayer = &namespace_af92f63c4264f983::onspawnplayer;
        level.getspawnpoint = &namespace_af92f63c4264f983::getspawnpoint;
        level.onplayerscore = &namespace_af92f63c4264f983::onplayerscore;
    }
...
function onstartgametype() {
    ...
    if (scripts\mp\spawnlogic::function_b17bf43316b9fb08(spawnkey)) {
        ...
        namespace_af92f63c4264f983::init_spawns();
    } else {
    ...
    if (function_5be859df8ee33a38()) {
        level thread namespace_af92f63c4264f983::onstartgametype();
    }
}
