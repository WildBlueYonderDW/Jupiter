...
function function_db4d7ba0fea6d09(guy) {
    ...
    blocker delete();
    level.var_30a959d3248e68af.door moveto(level.var_30a959d3248e68af.struct.origin, 1.2);
    level.var_30a959d3248e68af.door playsound("scn_jup_lower_base_security_door_open");
    namespace_223959d3e5206cfb::placeweaponon(level.partner.primaryweapon, "right");
