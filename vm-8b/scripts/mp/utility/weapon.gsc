...
// Namespace weapon / scripts\mp\utility\weapon
// Params 1, eflags: 0x0
// Checksum 0x0, Offset: 0x444c
// Size: 0x7a
function isthrowingknife(weapon) {
    if (!isdefined(weapon)) {
        assertmsg("<dev string:x7a8>");
        return false;
    }
    weapname = undefined;
    if (isweapon(weapon)) {
...
// Namespace weapon / scripts\mp\utility\weapon
// Params 1, eflags: 0x0
// Checksum 0x0, Offset: 0x45c6
// Size: 0x6b
function function_6acbd7091f4b88ea(weapon) {
    if (!isdefined(weapon)) {
        assertmsg("<dev string:x86e>");
        return 0;
    }
    weapname = undefined;
    if (isweapon(weapon)) {
