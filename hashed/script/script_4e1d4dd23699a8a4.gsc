...
// Namespace namespace_a5407b03b3e5f39f/namespace_dd3a5c61bf082e18
// Params 3, eflags: 0x0
...
function function_11bc1c4cee238a68(asmname, statename, params) {
    ...
    var_5e1f4c1face5c6a6 = self function_e430df0f7376ec66();
    targetangles = self.angles;
    if (isdefined(var_5e1f4c1face5c6a6)) {
        targetpos = var_5e1f4c1face5c6a6.origin;
        var_d5be0521e83df112 = vectornormalize(targetpos - self.origin);
...
function function_64d568ec73ec23f9(asmname, statename, params) {
    self.var_9b3e65eeb1124e61 = gettime();
    self.var_7afd86c1af40885b = "curious";
...
// Size: 0x1bf
function function_286c69ed2c750e6c(asmname, var_cbbdf6bcf5ab31be) {
    self endon("death");
    player = namespace_2b520709cc9e7442::function_47c84e03dcbc5aa7(var_cbbdf6bcf5ab31be.origin);
    if (!isdefined(player)) {
        return;
    }
    var_d5be0521e83df112 = vectornormalize(var_cbbdf6bcf5ab31be.origin - player.origin);
    var_6342bb081f0d1fa8 = var_cbbdf6bcf5ab31be.origin;
    wait(0.5);
    foreach (var_90cf8bda0648d361 in level.var_f62b6e59c0e00d48.civs) {
        if (!isalive(var_90cf8bda0648d361) || var_90cf8bda0648d361 == var_cbbdf6bcf5ab31be) {
            continue;
        }
        if (isdefined(var_90cf8bda0648d361.var_34df90223221b7a6) && isdefined(var_cbbdf6bcf5ab31be.var_a2c8b8008309aae2)) {
            jumpiffalse(level.var_6961d0344027496f[var_90cf8bda0648d361.var_a2c8b8008309aae2] == level.var_6961d0344027496f[var_cbbdf6bcf5ab31be.var_34df90223221b7a6]) LOC_00000158;
        } else {
        LOC_00000158:
            var_81d4d535a858f508 = var_90cf8bda0648d361.origin - var_6342bb081f0d1fa8;
            ...
            dot = vectordot(var_332ea4b12d924c65, var_d5be0521e83df112);
            if (dot > 0.96) {
                var_90cf8bda0648d361 asm_fireevent(asmname, "player_pushed");
            }
        }
    }
}
...
function function_c72398c24fe24b5b(asmname, statename, params) {
    ...
    self.var_9b3e65eeb1124e61 = gettime();
    self.var_7afd86c1af40885b = "angered";
    function_59308d53cabcdfdb(asmname, statename, params);
}
...
function function_f16999f33ef5381d(statename) {
    ...
    xanim = animsetgetanimfromindex(self.var_ae3ea15396b65c1f, statename, self.var_44c80d2697dce15b);
    var_b2a409abcee9f3a1 = getoriginforanimtime(self.origin, self.angles, xanim, 1);
    animlength = getanimlength(xanim);
    starttime = gettime();
    if (ispointonnavmesh(var_b2a409abcee9f3a1)) {
        self notify("lerp_arrive_finished");
        return;
    }
...
// Size: 0x14d
function function_fb8afeabd23a5ef5(asmname, statename, params, var_2c8936d08f85c5c1) {
    ...
    if (isai(self)) {
        ...
        self setflaggedanimknoballrestart(statename, xanim, var_a0917315f76ab3f2, 1, 0.2, 1);
        self setanim(var_a0917315f76ab3f2, 1, 0.2);
        if (statename == "relaxed" || statename == "single_loop" || statename == "group_loop") {
            ...
            var_d0eb396831a484ad = params[1];
            if (var_d0eb396831a484ad) {
    ...
    function_49835f1c23c89361(asmname, statename);
}
...
function function_38adb9f7ae99df6a(statename, xanim, animtime) {
    if (isdefined(self.var_1836cd6bc75a5ce3) && array_contains(self.var_1836cd6bc75a5ce3, statename)) {
        return;
    }
    ...
    angles = function_53c4c53197386572(scriptednode.angles, (0, 0, 0));
...
function function_7d6e619c3450bef3(statename, xanim) {
    if (!isdefined(self.var_f457c1616037ea52) || !array_contains_key(self.var_f457c1616037ea52, statename)) {
        return;
    }
    ...
    var_45402dbfeb5643f = var_dcf5e86549620338.var_f457c1616037ea52[statename];
    /#
        assert(isdefined(var_45402dbfeb5643f), "cap_tryResumeState: Cannot resume state " + statename + " on an ent with no .resumeStateTime");
    #/
    function_38adb9f7ae99df6a(statename, xanim, var_45402dbfeb5643f);
    self setanimtime(xanim, var_45402dbfeb5643f);
...
function function_c886dae06eba7d4a(statename, xanim) {
    self endon(statename + "_finished");
    while (1) {
        self.var_f457c1616037ea52[statename] = self getanimtime(xanim);
        waitframe();
    }
}
...
function function_f498a27eb642642c() {
    while (1) {
        ...
        var_706fe99ce1efa2b7 = [0:[0:300, 1:180], 1:[0:0, 1:10]];
        ...
        var_8af36cbe43b2d885 = abs(anglediff) > var_3ada4c6e49483364;
        if (var_8af36cbe43b2d885) {
            var_1ef5d9558a86bd8e = 25;
            duration = abs(anglediff) / var_1ef5d9558a86bd8e * 1000;
            var_c3ddcd0c37a60c5 = int(ceil(duration / level.frameduration));
            while (var_c3ddcd0c37a60c5 > 0) {
                ...
                var_b1cbdf386b2c0dea = anglediff;
...
function function_46602711ed8e40d6() {
    var_1ef5d9558a86bd8e = 70;
    while (1) {
        origin = self.var_8f0bd1e175f2cf51 + anglestoforward(self.var_394377b94edabddf) * 50;
        if (isalive(self._blackboard.var_610cb18ecc1af719)) {
            enemy = self._blackboard.var_610cb18ecc1af719;
        }
...
// Size: 0x14
function function_2944e6470a84b96d(xanim, var_9622b10ea4acbc01) {
...
// Size: 0x14
function function_f9d6133768491200(xanim, var_9622b10ea4acbc01) {
...
// Size: 0x5d
function function_49835f1c23c89361(asmname, statename) {
    var_3931ff7e891d898f = asm_getnotehandler(asmname, statename);
    endnote = undefined;
    while (!isdefined(endnote) || !isstring(endnote) || endnote != "end") {
        endnote = asm_donotetracks(asmname, statename, var_3931ff7e891d898f);
    }
    return endnote;
}
...
// Size: 0x15
function function_6acac145244155a5(notetrack) {
    namespace_a4081f3d58d76916::notetrack_prefix_handler(notetrack);
    return undefined;
}
...
function function_a0dfeea159aa7f64(asmname, statename, params) {
    if (!isdefined(params)) {
        ...
        if (isdefined(var_457feb6671add6f0)) {
            var_b6648a33085e43a = function_976d6ccb0a2807f3(statename, var_457feb6671add6f0);
...
function function_b6050fd3b28e7aef(asmname, statename, params) {
    var_d586bee14a644246 = 450;
    var_cba2d21a29a6d238 = var_d586bee14a644246 * var_d586bee14a644246;
    player = namespace_2b520709cc9e7442::function_47c84e03dcbc5aa7(self.origin);
    if (!isdefined(player)) {
    ...
    if (distsqr < var_cba2d21a29a6d238) {
        contents = namespace_2a184fc4902783dc::create_contents(1, 0, 0, 0, 0, 0, 0);
        excludelist = [0:player, 1:self];
        origin = self.origin + (0, 0, 30);
        end = player.origin + (0, 0, 30);
        if (isai(self)) {
            var_26ffde339bc75ef = physics_charactercast(origin, end, self, 30, self.angles, contents, excludelist, "physicsquery_closest");
            if (var_26ffde339bc75ef.size) {
                var_2b2b7a463c0a7f7a = "far";
            } else {
...
function function_18e6c36c02a94dbd(statename, alias) {
    ...
    /#
        assertex(isdefined(var_eabf81b5be8ddb5), "Unable to find alias " + alias + " in archetype " + var_38548703ea2bdadc + " state " + statename + " for " + self.classname);
    #/
...
function function_658df657ca37f542(statename, alias) {
    ...
    var_774b89735f430ec9 = animsetgetallanimindicesforalias(var_38548703ea2bdadc, statename, alias);
    var_eabf81b5be8ddb5 = var_774b89735f430ec9[self.var_30452ad282afcd76[statename][alias]];
    self.var_30452ad282afcd76[statename][alias]++;
    if (self.var_30452ad282afcd76[statename][alias] >= var_774b89735f430ec9.size) {
        self.var_30452ad282afcd76[statename][alias] = 0;
    }
    return var_eabf81b5be8ddb5;
}
...
// Size: 0x18d
function function_976d6ccb0a2807f3(statename, var_7b0f2a3348ab051, var_d0d422e79c49095c) {
    ...
    if (!isdefined(aliases)) {
        /#
            if (!istrue(var_d0d422e79c49095c)) {
                ...
                if (isdefined(var_7b0f2a3348ab051)) {
                    msg = msg + "cigarette_smoke" + var_7b0f2a3348ab051;
                }
                /#
                    assertmsg(msg);
                #/
...
// Size: 0x25
function cap_event(asmname, statename, var_f2b19b25d457c2a6, params) {
    return 0;
}
...
// Size: 0x25
function function_2d6b1385ffc3f5ca(asmname, statename, var_f2b19b25d457c2a6, params) {
    return 0;
}
...
// Size: 0x35
function function_85eca0a1310a70c(asmname, statename, var_f2b19b25d457c2a6, params) {
    if (isai(self)) {
...
function function_c779dc23caccb19c(asmname, statename, params) {
    if (!isdefined(self.var_32bea72aad5da872)) {
        return;
    }
    foreach (prop in self.var_32bea72aad5da872) {
        if (isdefined(params)) {
            aliasname = params;
        } else {
            aliasname = undefined;
            var_390fc8687ad84751 = archetypegetaliases(prop.var_ae3ea15396b65c1f, statename);
            if (isdefined(var_390fc8687ad84751)) {
                aliasname = random(var_390fc8687ad84751);
            }
        }
        if (!isdefined(aliasname)) {
            continue;
        }
        alias = archetypegetalias(prop.var_ae3ea15396b65c1f, statename, aliasname, 0);
        if (!isdefined(alias)) {
            continue;
        }
        var_10bfc25635723b51 = alias.anims;
        if (isarray(var_10bfc25635723b51)) {
            var_10bfc25635723b51 = random(var_10bfc25635723b51);
        }
        scriptednode = function_76b0413f0e5d4dd2();
        /#
        ...
        origin = scriptednode.origin;
        angles = function_53c4c53197386572(scriptednode.angles, (0, 0, 0));
        prop animscripted(aliasname, origin, angles, var_10bfc25635723b51);
    }
}
...
// Size: 0x2d
function function_b6af4ade50626e90(asmname, statename, params) {
    if (!isalive(self)) {
        return;
    }
...
// Size: 0x1c
function function_14909159c05a576e(asmname, statename, params) {
...
// Size: 0x32
function function_8d10c93f4b4244a2(asmname, var_8f4ef4fdb5e7800a, var_93279c66a2e49a45, params) {
    self.var_7afd86c1af40885b = "relaxed";
}
...
// Size: 0x52
function function_ebd0a826ac49da1e(asmname, var_8f4ef4fdb5e7800a, var_93279c66a2e49a45, params) {
    /#
        assert(isdefined(params) && !isarray(params));
    #/
    return isdefined(self.var_7afd86c1af40885b) && self.var_7afd86c1af40885b == params;
}
...
// Size: 0x33
function function_c0d2bfb8b27b8c96(asmname, statename, var_f2b19b25d457c2a6, params) {
    return self.var_7afd86c1af40885b != "relaxed";
}
...
// Size: 0x52
function function_e44a6892e1d2ec(asmname, statename, var_f2b19b25d457c2a6, params) {
    switch (self.var_7afd86c1af40885b) {
...
// Size: 0x5e
function function_11df7068a03bb818(asmname, statename, var_f2b19b25d457c2a6, params) {
    switch (self.var_7afd86c1af40885b) {
...
// Size: 0x5e
function function_9cfcf25e2674ea46(asmname, statename, var_f2b19b25d457c2a6, params) {
    switch (self.var_7afd86c1af40885b) {
...
// Size: 0x47
function function_fbaf3f50df29a0ca(asmname, statename, var_f2b19b25d457c2a6, params) {
    /#
...
// Size: 0xaf
function function_84e2d261814f426(asmname, statename, var_f2b19b25d457c2a6, params) {
    /#
...
// Size: 0x2d
function function_d87741ac656cc282(asmname, statename, var_f2b19b25d457c2a6, params) {
...
// Size: 0x2c
function function_cd7b18478f9925a2(asmname, statename, var_f2b19b25d457c2a6, params) {
...
// Size: 0x107
function private function_9f458b5f165cfd34(params, var_d5cf0e54165d319a) {
    if (isai(self)) {
        var_b22687643226c3c1 = self geteye();
    } else {
        var_b22687643226c3c1 = self.origin;
    }
    if (isdefined(params)) {
        if (abs(params) > 1) {
            fov = cos(params);
    ...
    foreach (player in level.players) {
        ...
        if (within_fov(playerorigin, playerangles, var_b22687643226c3c1, fov)) {
            if (!var_d5cf0e54165d319a || sighttracepassed(playerorigin, var_b22687643226c3c1, 0, self)) {
                return 1;
            }
        }
    }
...
// Size: 0x3f
function function_eef8d65ad14bc7d(asmname, statename, var_f2b19b25d457c2a6, params) {
...
// Size: 0x3f
function function_2c8145ed8b6c8504(asmname, statename, var_f2b19b25d457c2a6, params) {
    if (!isdefined(self.stealth)) {
        return 0;
    }
...
// Size: 0x3f
function function_9bfddb0e0134923b(asmname, statename, var_f2b19b25d457c2a6, params) {
    if (!isdefined(self.stealth)) {
        return 0;
    }
...
// Size: 0x40
function function_df51607ee78d1190(asmname, statename, var_f2b19b25d457c2a6, params) {
    if (!isdefined(self.stealth)) {
        return 1;
    }
...
// Size: 0x41
function function_276b2832ae7c7cf7(asmname, statename, var_f2b19b25d457c2a6, params) {
    /#
...
// Size: 0xa5
function function_8439b78c94685919(asmname, statename, var_f2b19b25d457c2a6, params) {
...
function function_245f3c9cf9fb2ed4(note, statename) {
    switch (self.var_ae3ea15396b65c1f) {
...
function function_c2c313a844d139b9() {
    ...
    while (isdefined(self) && self islinked() && !istrue(ai.var_a97ac004f00c5df9) && !istrue(ai.in_melee_death) && isalive(ai)) {
        waitframe();
    }
    if (isdefined(ai)) {
        ...
        if (!istrue(level.var_e908c9dbefd1f3e6)) {
            ai function_b56d50ec10f7df53(self);
            thread function_f47109a0a608624e();
            return;
        }
    }
    self delete();
...
function function_591bd29f12b13862(note) {
    var_b5f792378ad37e44 = "tag_accessory_right";
    hand = getsubstr(note, 7);
    if (isdefined(hand) && (hand == "left" || hand == "l")) {
        var_b5f792378ad37e44 = "tag_accessory_left";
    }
    return var_b5f792378ad37e44;
}
...
function function_c1cbf486f2593c18(note, statename) {
    self endon(statename + "_finished");
    var_b5f792378ad37e44 = function_591bd29f12b13862(note);
    if (isstartstr(note, "attach")) {
        if (isdefined(self.idle_prop)) {
            return;
        }
        self.idle_prop = namespace_bc4a4b9456315863::anim_link_tag_model(function_640494db1d9ed4a4(), var_b5f792378ad37e44);
...
function function_f0a5a6335f173f80(note, statename) {
    ...
    if (isstartstr(note, "attach")) {
        ...
        self.idle_prop = namespace_bc4a4b9456315863::anim_link_tag_model(function_4c8b20626e0c2f54(), var_b5f792378ad37e44);
        self.idle_prop thread function_c2c313a844d139b9();
    } else if (isstartstr(note, "detach")) {
        if (isdefined(self.idle_prop)) {
            self.idle_prop delete();
...
function function_2e7191a29c3331b3(note, statename) {
    ...
    if (isstartstr(note, "attach")) {
        ...
        self.idle_prop = namespace_bc4a4b9456315863::anim_link_tag_model(function_cc9b64be81cb46ef(), var_b5f792378ad37e44);
        self.idle_prop thread function_c2c313a844d139b9();
    } else if (isstartstr(note, "detach")) {
        if (isdefined(self.idle_prop)) {
            self.idle_prop delete();
...
function function_fb2c788fbeb2ed0e(note, statename) {
    ...
    var_b5f792378ad37e44 = function_591bd29f12b13862(note);
    if (isstartstr(note, "attach")) {
        self.idle_prop = namespace_bc4a4b9456315863::anim_link_tag_model("food_bread_slice", var_b5f792378ad37e44);
        self.idle_prop thread function_c2c313a844d139b9();
    } else if (isstartstr(note, "detach")) {
        if (isdefined(self.idle_prop)) {
            self.idle_prop delete();
...
function function_2059f541bb4ec92b(note, statename) {
    ...
    var_b5f792378ad37e44 = function_591bd29f12b13862(note);
    if (isstartstr(note, "attach")) {
        self.idle_prop = namespace_bc4a4b9456315863::anim_link_tag_model("food_trash_bag_chips_01", var_b5f792378ad37e44);
        self.idle_prop thread function_c2c313a844d139b9();
    } else if (isstartstr(note, "detach")) {
        if (isdefined(self.idle_prop)) {
            self.idle_prop delete();
...
function function_8248dd35588eba2a(note, statename) {
    ...
    if (isstartstr(note, "attach")) {
        ...
        self.idle_prop = namespace_bc4a4b9456315863::anim_link_tag_model(function_f7b213561a5c3b4c(), var_b5f792378ad37e44);
        self.idle_prop thread function_c2c313a844d139b9();
        self.idle_fx = level.g_effect["cigarette_unlit"];
        playfxontag(self.idle_fx, self, var_b5f792378ad37e44);
        self.idle_prop.var_b5f792378ad37e44 = var_b5f792378ad37e44;
    } else if (isstartstr(note, "light")) {
        if (isdefined(self.idle_prop.var_b5f792378ad37e44)) {
            var_b5f792378ad37e44 = self.idle_prop.var_b5f792378ad37e44;
        }
        self.idle_fx = level.g_effect["cigarette_lit"];
        playfxontag(self.idle_fx, self, var_b5f792378ad37e44);
        stopfxontag(level.g_effect["cigarette_unlit"], self, var_b5f792378ad37e44);
        playfx(level.g_effect["lighter_glow"], self gettagorigin(var_b5f792378ad37e44));
        thread function_e5dddf915cecd10f(statename);
    } else if (isstartstr(note, "detach") || isstartstr(note, "toss")) {
        if (isdefined(self.idle_prop)) {
            self.idle_prop delete();
            self.idle_prop = undefined;
        }
        stopfxontag(level.g_effect["cigarette_lit"], self, var_b5f792378ad37e44);
        self.idle_fx = undefined;
        if (isstartstr(note, "toss")) {
            playfx(level.g_effect["cigarette_lit_toss"], self gettagorigin(var_b5f792378ad37e44), anglestoforward(self gettagangles(var_b5f792378ad37e44)));
        }
    }
}
...
// Size: 0x81
function function_e5dddf915cecd10f(statename) {
...
// Size: 0x95
function function_6f19361f519d4a3e(asmname, statename, params) {
    ...
    function_4a72e2a3e57c82d4(asmname, statename, params);
}
...
function function_78fc852578a2d6a9(note, statename) {
    ...
    case #"hash_2d1403e602f082a4":
        ...
        self.var_cdb39b13b6524b5b = namespace_bc4a4b9456315863::anim_link_tag_model(function_34554aaf056d23d(), var_b5f792378ad37e44);
...
function function_65bcde73638156e(note, statename) {
    ...
    if (isstartstr(note, "attach")) {
        ...
        self.idle_prop = namespace_bc4a4b9456315863::anim_link_tag_model(function_b1decda825eadd7e(), var_b5f792378ad37e44);
        self.idle_prop thread function_c2c313a844d139b9();
...
// Size: 0x46
function function_b1decda825eadd7e() {
...
function function_103f712f2029bde6(note, statename) {
    ...
    if (isstartstr(note, "attach")) {
        ...
        self.idle_prop = namespace_bc4a4b9456315863::anim_link_tag_model(function_6d9a6be03f41b2c(), var_b5f792378ad37e44);
        self.idle_prop thread function_c2c313a844d139b9();
    } else if (isstartstr(note, "detach")) {
        if (isdefined(self.idle_prop)) {
            self.idle_prop delete();
...
function function_75ab18574236de38(note, statename) {
    ...
    if (isstartstr(note, "attach")) {
        ...
        self.idle_prop = namespace_bc4a4b9456315863::anim_link_tag_model(function_ccfa6fb9cdc07744(), var_b5f792378ad37e44);
        self.idle_prop thread function_c2c313a844d139b9();
    } else if (isstartstr(note, "detach")) {
        if (isdefined(self.idle_prop)) {
            self.idle_prop delete();
...
function function_9e1b3a33e6a8c117(note, statename) {
    ...
    if (isdefined(self function_92435c7a6ae85c3c())) {
        ...
        if (!isdefined(self.idle_table)) {
            var_ef123c9e92df3668 = anglestoforward(self.angles) * 18 + (0, 0, -2);
            self.idle_table = utility::spawn_model(function_fe4813e6b6140728(), self.origin + var_ef123c9e92df3668, self.angles);
        }
...
function function_8b7e11da82242584(note, statename) {
    ...
    if (isdefined(self function_92435c7a6ae85c3c())) {
        function_1c3ececccab5a9b1();
        if (!isdefined(self.idle_table)) {
            var_ef123c9e92df3668 = anglestoforward(self.angles) * 22 + (0, 0, -2);
            self.idle_table = utility::spawn_model(function_fe4813e6b6140728(), self.origin + var_ef123c9e92df3668, self.angles);
        }
...
function function_18f4224c27507c56(note, statename) {
    ...
    if (isdefined(self function_92435c7a6ae85c3c())) {
        if (!isdefined(self.idle_bag)) {
            var_cce0ecb52cc93601 = level.scr_anim["idle_bag"]["wait"];
            ...
            self.idle_bag animrelative("wait", self._blackboard.var_ad5eda311c73f5d7 + offset, self._blackboard.var_66c82b7660f29059, var_cce0ecb52cc93601);
    ...
    if (statename == "group_loop" && !istrue(self.idle_bag.isidle)) {
        ...
        var_cce0ecb52cc93601 = level.scr_anim["idle_bag"]["idle"];
        self.idle_bag animrelative("idle", self._blackboard.var_ad5eda311c73f5d7 + offset, self._blackboard.var_66c82b7660f29059, var_cce0ecb52cc93601);
...
function function_ad40b641674a572d(note, statename) {
    ...
    if (!isdefined(self.idle_chair)) {
        ...
        var_cda855d9d2fe2cb7 = getscriptablearray("interactable_chair", "script_noteworthy");
        maxdist = 16;
        self.idle_chair = getclosest(origin, var_cda855d9d2fe2cb7, maxdist);
        return;
    }
    ...
    if (isdefined(self.idle_chair.key)) {
        var_cce0ecb52cc93601 = level.scr_anim["idle_bag"][self.idle_chair.key];
        self.idle_chair animrelative("idle", self._blackboard.var_ad5eda311c73f5d7, self._blackboard.var_66c82b7660f29059, var_cce0ecb52cc93601);
...
// Size: 0x87
function function_1c3ececccab5a9b1() {
...
// Size: 0x30
function function_da3d5e34eb93790a(asmname, statename, params) {
    function_6f19361f519d4a3e(asmname, statename, params);
    function_bf3d5ae7e2eeda40(asmname, statename, params);
}
...
// Size: 0xdd
function function_bf3d5ae7e2eeda40(asmname, statename, params) {
    props = [];
    if (isdefined(self.idle_prop)) {
    ...
    foreach (prop in props) {
        if (!istrue(level.var_e908c9dbefd1f3e6)) {
            function_b56d50ec10f7df53(prop);
        }
        prop thread function_f47109a0a608624e();
    }
}
...
// Size: 0xb6
function function_b56d50ec10f7df53(prop) {
    if (!isdefined(prop) || !isent(prop) || !isdefined(prop.model) || prop.model == "") {
        return;
    }
    var_363cd698ce6c69c1 = anglestoforward(self.angles);
    var_363cd698ce6c69c1 = var_363cd698ce6c69c1 * randomfloatrange(10, 20);
    var_d43803be5b18ddd8 = var_363cd698ce6c69c1[0];
    var_d43804be5b18e00b = var_363cd698ce6c69c1[1];
    var_d43805be5b18e23e = randomfloatrange(1, 10);
    prop unlink();
    prop physicslaunchserver(prop.origin, (var_d43803be5b18ddd8, var_d43804be5b18e00b, var_d43805be5b18e23e));
}
...
// Size: 0xa2
function function_f47109a0a608624e() {
    interval = 10000;
    starttime = gettime();
...
// Size: 0x5f
function function_4a72e2a3e57c82d4(asmname, statename, params) {
...
// Size: 0x23
function function_97e1b8adaea35a52(asmname, statename, params) {
...
// Size: 0x39
function function_33952ea1dbd64d62(asmname, statename, params) {
...
// Size: 0x38
function function_741a8c95a0ba229a(asmname, statename, var_f2b19b25d457c2a6, params) {
    return istrue(self._blackboard.var_d1535661edb4405);
}
...
function function_85c5a3c3c6f345c4(asmname, statename, params) {
    var_935ce979bb3ef270 = vectortoyaw(self.var_bb58345571d24a8f.origin - self.origin);
    ...
    if (isdefined(params) && params == "cardinal") {
        ...
        animalias = var_3fbfa3ab7b1fb0f2[animindex];
...
// Size: 0x2e
function function_b98734875ecb0d81(asmname, statename, var_f2b19b25d457c2a6, params) {
    return isdefined(self.var_bb58345571d24a8f);
}
