    ...
    while (!time_has_passed(timestart, var_198913d9a9fa1276)) {
        ...
        if (event == "idle_convo") {
            if (distance2dsquared(guys[0].origin, guys[1].origin) >= level.var_27a93e38d913ff2f) {
                ...
                /#
                    if (getdvarint(@"hash_864d3ab12f741516")) {
                        function_51c8ea07cf76cbd7("c_stat_areyougoodbrother" + scripts/common/debug::function_600b37e8cf3f2de9(guys[0]) + "c_enws_theyhaveamachinegunn" + scripts/common/debug::function_600b37e8cf3f2de9(guys[1]));
                    }
                #/
                return;
            }
        ...
        if (event == "idle_solo") {
            ...
            if (var_542b15e7d1da2adb > 1) {
                ...
                /#
                    if (getdvarint(@"hash_864d3ab12f741516")) {
                        function_51c8ea07cf76cbd7("c_enws_oneofthemhasashotgun" + scripts/common/debug::function_600b37e8cf3f2de9(guys[0]));
                    }
                #/
                return;
            }
...
function private huntvalidate(current_guy) {
    /#
        foreach (guy in getaiarray(current_guy.team)) {
            /#
                assert(guy == current_guy || !guy function_fc52f6275d262cdb(), "s_idir_thoughtiheardsomethi" + guy getentitynumber());
            #/
        }
    #/
}
