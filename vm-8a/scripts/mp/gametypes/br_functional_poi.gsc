...
/#
    ...
    function initdebug() {
        ...
        devgui::function_a9a864379a098ad6("<dev string:x33>", "<dev string:x41>", &rerollkiosks);
...
function _getlocationscircleinfluencedwithnoise(var_1eb07a39ff244cd5, maxinstancecount, var_395f0c06f7abdcc1) {
    ...
    instancessorted = utility::array_sort_with_func(var_1eb07a39ff244cd5, &comparescore);
...
/#
    ...
    function rerollkiosks() {
        foreach (armorykiosk in level.br_armory_kiosk.scriptables) {
            armorykiosk setscriptablepartstate("<dev string:x5f>", "<dev string:x6e>");
        ...
        foreach (armorykiosk in level.br_armory_kiosk.scriptables) {
            armorykiosk setscriptablepartstate("<dev string:x5f>", "<dev string:x75>");
