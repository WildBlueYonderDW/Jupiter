...
#namespace jup_ob_schematic_soldier_buddy_4;

// Namespace jup_ob_schematic_soldier_buddy_4 / namespace_e8bb647e7ce6bbc2
// Params 0, eflags: 0x0
// Checksum 0x0, Offset: 0x280
// Size: 0x1c9
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_ob_schematic_soldier_buddy_4" );
    self.var_534e788bc498be9f = getscriptbundle( %"hash_57d804ea117bcdbd" );
...
function precache()
{
    agent_type = "actor_jup_ob_schematic_soldier_buddy_4";
    ...
    if ( !isdefined( level.agent_definition[ agent_type ] ) )
    {
        ...
        level.agent_definition[ agent_type ][ "subclass" ] = getscriptbundle( %"hash_57d804ea117bcdbd" );
