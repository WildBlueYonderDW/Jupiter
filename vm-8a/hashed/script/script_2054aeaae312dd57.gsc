...
/#
    ...
    function function_4166f565abe2876a(command, arglist) {
        function_c5fb911b37a009a9(arglist, 2, 3, 1, "<dev string:x41>");
    }
    ...
    function function_13c592c4aa8f479f(command, arglist) {
        function_c5fb911b37a009a9(arglist, 2, 3, 1, "<dev string:x6b>");
    }
    ...
    function private function_c5fb911b37a009a9(arglist, startpositionargument, var_de528f4c380636d4, var_d9b34d95d095735, usagestring) {
        cmdargstr = "<dev string:x93>";
        foreach (arg in arglist) {
            cmdargstr += arg + "<dev string:x94>";
        }
    ...
    function function_96aa55e08b9d714f(startpos, targetpos) {
        ...
        if (!isdefined(level.mit.var_fbb0c17bb4e37ee8)) {
            botinfo = spawnstruct();
            botinfo.name = "<dev string:x93>";
            botconnected = level spawnbots([botinfo], "<dev string:x96>", undefined, undefined, "<dev string:xa1>");
            if (isarray(botconnected) && isdefined(botconnected[0])) {
                level.mit.var_fbb0c17bb4e37ee8 = botconnected[0].clientid;
                return;
            }
            assert("<dev string:xae>");
        }
    }
    ...
    function private strtovec3(str) {
        output = undefined;
        values = strtok(str, "<dev string:x11e>");
        if (values.size == 3) {
    ...
    function private function_c296da4701b1ce9b(arguments, index) {
        ...
        while (count < index) {
            var_b2f125581538bafc = function_1e5dca407ad4bf4a(arguments, "<dev string:x120>", var_53b4c911d83a4925 + 1);
            var_53b4c911d83a4925 = function_1e5dca407ad4bf4a(arguments, "<dev string:x122>", var_b2f125581538bafc + 1);
