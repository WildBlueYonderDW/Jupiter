...
function private function_4f2d84b47d6319a2(params) {
    ...
    namespace_446fc987a980892f::playevent("teammate_down", teammates);
}
...
function setspawnpoint() {
    ...
    if (var_736bfbe730557cf.size > 0) {
        var_e32c245d5fd5e8d5 = random(var_736bfbe730557cf).origin;
    } else {
        var_e32c245d5fd5e8d5 = self.origin;
    }
    randomdistance = ter_op(var_736bfbe730557cf.size > 0, randomintrange(0, 7500), randomintrange(7500, 20000));
    var_773f52a7d94b7f69 = [];
    for (i = 1; i <= 32; i++) {
        pos = var_e32c245d5fd5e8d5 + anglestoforward((0, randomangle + 11.25 * i, 0)) * randomdistance;
    ...
    /#
        thread function_99cccfd31080bb65(var_e32c245d5fd5e8d5, var_773f52a7d94b7f69);
    #/
...
/#
    ...
    // Size: 0xb5
    function function_99cccfd31080bb65(var_e32c245d5fd5e8d5, var_773f52a7d94b7f69) {
        level endon("<dev string:x73>");
        self endon("<dev string:x81>");
        while (true) {
            waitframe();
            sphere(var_e32c245d5fd5e8d5, 7500, (1, 0, 0));
            sphere(var_e32c245d5fd5e8d5, 20000, (0, 1, 0));
...
function private function_50c0ea10b250b9e() {
    ...
    if (istrue(level.var_305f2037d12f6c5)) {
        namespace_feea61bc660e9e0f::function_b9d2aee928c46b5f(8554, 1, 0, undefined);
        waitframe();
        namespace_f8d3520d3483c1::repair_armor(self.maxarmorhealth);
    }
...
function function_5fedebeea12bd089(randomloadoutindex) {
    ...
    primaryweapon = namespace_e0ee43ef2dddadaa::buildweapon(primaryweaponname, var_22fbb0794aa3448c, "none", "none", -1);
    ...
    secondaryweapon = namespace_e0ee43ef2dddadaa::buildweapon(secondaryweaponname, var_d5c5c1aaa36c30cc, "none", "none", -1);
    ...
    if (isdefined(level.var_f742f900fb0a4ee8)) {
        namespace_a4ff02beedc1bce8::pap_weapon(primaryweapon, level.var_f742f900fb0a4ee8 - 1);
    }
}
...
function function_27fd1477dccfa12b() {
    ...
    currentpoints = namespace_301533d2f1378cb9::function_b86115649d705017();
    ...
    namespace_301533d2f1378cb9::function_5fb17ad4d286b0d5(respawnpoints);
}
...
function function_fb5b37eb3eccc267() {
    ...
    foreach (var_751df20fceaee5 in level.var_2562ea48235e90b5) {
        ...
        if (!istrue(var_751df20fceaee5.b_disabled) || var_751df20fceaee5 == level.aether_storm.final_exfil) {
            continue;
        }
        var_431e0d4d4f3f7c54 = getdvarint(@"hash_1aa07ed6ff79f1b", 25000);
        if (distance2d(var_751df20fceaee5.origin, level.aether_storm.starting_origin) > var_431e0d4d4f3f7c54) {
            var_5fe035f355489855 = function_6d6af8144a5131f1(var_5fe035f355489855, var_751df20fceaee5);
        }
    }
    assertex(var_5fe035f355489855.size >= var_6e374d053c0edc74, "<dev string:x157>");
    for (i = 0; i < var_6e374d053c0edc74; i++) {
        var_751df20fceaee5 = var_5fe035f355489855[i];
        if (isdefined(var_751df20fceaee5)) {
            var_751df20fceaee5.b_disabled = 0;
            var_751df20fceaee5 namespace_9f6a961447bab709::function_2e0dc001c9a5c661();
...
// Size: 0x34
function function_dfdda3d98b049b3c(var_751df20fceaee5, var_6d94a1f3678a98a6) {
    ...
    function private function_5be6f854fd9386d8() {
        while (true) {
            ...
            if (eventref != "<dev string:x176>") {
                ...
                namespace_446fc987a980892f::playevent(eventref, [level.players[0]]);
            }
            waitframe();
        }
    }
