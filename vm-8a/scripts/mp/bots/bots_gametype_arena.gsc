...
// Namespace bots_gametype_arena / scripts\mp\bots\bots_gametype_arena
// Params 0, eflags: 0x0
...
function bot_dom_debug_should_capture_all() {
    /#
        if (getdvar(@"hash_d19b61818b442235") == "<dev string:x1c>") {
            return true;
        }
    #/
    return false;
...
function bot_dom_debug_should_protect_all() {
    /#
        if (getdvar(@"hash_e1e41766847222dc") == "<dev string:x1c>") {
            return true;
        }
    #/
    return false;
