        ...
        if (itemtype == #"weapon") {
            ...
            if (isdefined(lootid) && lootid > 0) {
                ...
                if (getdvarint(@"hash_ad67cf67992fe5f2", 0)) {
                    ...
                    fullweaponobj = weapon::buildweapon(baseweaponname, attachmentsarray, "none", "none", -1);
                }
                fullweaponname = getcompleteweaponname(fullweaponobj);
...
function function_2d397216d0fc2167() {
    foreach (scriptablename, itemtype in level.br_pickups.br_itemtype) {
        ...
        case #"gametype_item": 
            ...
            break;
        default: 
            println("<dev string:x1c>" + function_3c8848a3a11b2553(scriptablename) + "<dev string:x2f>" + function_3c8848a3a11b2553(itemtype) + "<dev string:x47>");
            break;
        }
    }
}
...
function function_ec07a134a6ed91fd(rarity, var_14004b68ddacb781) {
    ...
    if (isdefined(rarity)) {
        if (rarity == #"common") {
            ...
            println("<dev string:x49>" + function_3c8848a3a11b2553(var_14004b68ddacb781) + "<dev string:x47>");
        }
    }
    return rarityint;
}
                ...
                if (isdefined(lootidname) && lootidname.size > 0) {
                    ...
                    if (getdvar(@"hash_9cc91f7c70752fa7", "1") != "1") {
                        /#
                            ...
                            icon = weapon::function_b8811a0fc04e4b9d(weaponroot, #"image", "<dev string:x6e>");
                            ...
                            attachmentsstring = "<dev string:x6e>";
                            if (isdefined(attachmentsall)) {
                                foreach (key, aid in attachmentsall) {
                                    ...
                                    if (attachmentsstring != "<dev string:x6e>") {
                            ...
                            if (var_287363cd98ae15a8 != baseweaponname) {
                                println("<dev string:x6f>" + var_14004b68ddacb781 + "<dev string:x9b>" + var_287363cd98ae15a8 + "<dev string:x9f>" + baseweaponname + "<dev string:xa6>");
                                var_5c845b7a0ef0780f = 1;
                            }
                            if (var_361a437d788f1ff4 != fullweaponname) {
                                println("<dev string:xa8>" + var_14004b68ddacb781 + "<dev string:x9b>" + var_361a437d788f1ff4 + "<dev string:x9f>" + fullweaponname + "<dev string:xa6>");
                                var_5c845b7a0ef0780f = 1;
                            }
                            if (var_2278b4e29d8c7ddd != icon) {
                                println("<dev string:xd4>" + var_14004b68ddacb781 + "<dev string:x9b>" + var_2278b4e29d8c7ddd + "<dev string:x9f>" + icon + "<dev string:xa6>");
                                var_5c845b7a0ef0780f = 1;
                            }
                        #/
                    }
                    ...
                    /#
                        if (int(raritystring) != 10) {
                            ...
                            var_6a537ee3949585f4[var_6a537ee3949585f4.size] = weapon::function_13aeabbe4210eadc(var_14004b68ddacb781, raritystring, "<dev string:x6e>", baseweaponname, attachmentsstring, fullweaponname, titlestring, %"<dev string:x6e>", icon, pickupsound);
...
function function_78ad8eb4cc92f407(loadout, slotstring) {
    ...
    if (slotstring == "Primary") {
        ...
        assertmsg("Invalid slot " + slotstring + " in buildWeaponStandardLoadoutBySlot\n");
    }
...
/#
    ...
    function function_d2d7b153b9d3889e(index, name, start, end, traceresults) {
        ...
        if (traceresults["<dev string:xf6>"] < 1) {
            line(start, traceresults["<dev string:xff>"], (1, 0, 0), 1, 0, var_a16891a5162df351);
            if (isdefined(traceresults["<dev string:x108>"])) {
                selectedentity = traceresults["<dev string:x108>"];
                println("<dev string:x10f>" + index + "<dev string:x11e>" + name + "<dev string:x121>" + traceresults["<dev string:xf6>"] + "<dev string:x127>" + traceresults["<dev string:xff>"] + "<dev string:x12c>" + utility::default_to(selectedentity.name, "<dev string:x132>"));
            } else {
                println("<dev string:x10f>" + index + "<dev string:x11e>" + name + "<dev string:x121>" + traceresults["<dev string:xf6>"] + "<dev string:x127>" + traceresults["<dev string:xff>"]);
            }
            return;
        }
        println("<dev string:x10f>" + index + "<dev string:x11e>" + name + "<dev string:x13c>");
...
function function_7bf5ea7dd272db77(dropstruct, dropdata, baseorigin, ignoreent, tracecontents, var_551904951118b7b9) {
    ...
    /#
        if (var_551904951118b7b9) {
            function_d2d7b153b9d3889e(dropstruct.dropidx, "<dev string:x145>", tracestart, traceend, traceresults);
        }
    #/
...
function function_28cd87cdbae45940(dropstruct, dropdata, ignoreent, tracecontents, var_551904951118b7b9) {
    ...
    /#
        if (var_551904951118b7b9) {
            function_d2d7b153b9d3889e(dropstruct.dropidx, "<dev string:x148>", tracestart + (0, 1, 0), traceend + (0, 1, 0), traceresults);
        }
    #/
    if (traceresults["fraction"] < 1) {
...
function function_bd56d40fa4e7a1e3(dropstruct, dropdata, ignoreent, tracecontents, groundfloat, var_29a915f667b07b0f, var_551904951118b7b9) {
    ...
    /#
        if (var_551904951118b7b9) {
            function_d2d7b153b9d3889e(dropstruct.dropidx, "<dev string:x14b>", tracestart, traceend, traceresults);
        }
    #/
    if (traceresults["fraction"] < 1) {
        ...
        if (isdefined(dropdata.groundentity) && (istrue(dropdata.groundentity.isdestroyed) || istrue(dropdata.groundentity.burningdown) || dropdata.groundentity scripts\cp_mp\vehicles\vehicle::function_794b5f886cced2d0())) {
            ...
            /#
                if (var_551904951118b7b9) {
                    function_d2d7b153b9d3889e(dropstruct.dropidx, "<dev string:x14e>", dropdata.outorigin, traceend, traceresults);
                }
            #/
            if (traceresults["fraction"] < 1) {
                dropdata.outorigin = traceresults["position"] + (0, 0, groundfloat);
                ...
                /#
                    if (var_551904951118b7b9) {
                        println("<dev string:x10f>" + dropstruct.dropidx + "<dev string:x152>");
                    }
                #/
...
function getitemdroporiginandangles(dropstruct, baseorigin, baseangles, ignoreent, var_8a600b6102da9f9b, var_f71d4f78d508da69, var_6fe2ff802d5192d4, var_3ace5ac9c7d6fa44, overrideorigin, var_29a915f667b07b0f, var_688e4da4cb16116d) {
    ...
    dropdata.ring = int(dropstruct.dropidx / var_a9d5ad9414f5ecb7);
    dropdata.slot = dropstruct.dropidx - dropdata.ring * var_a9d5ad9414f5ecb7;
    dropdata.yaw = baseangles[1] + dropdata.slot * slot_yaw + dropdata.ring * 10 + randomfloatrange(var_ab9f50e5b2c2e07e, var_ab7c62e5b29cc05c);
    dropdata.dist = 60 + dropdata.ring * 35 + randomfloatrange(-5, 5);
    ...
    if (true) {
        /#
            if (var_551904951118b7b9) {
                println("<dev string:x10f>" + dropstruct.dropidx + "<dev string:x15e>" + baseorigin + "<dev string:x166>" + dropdata.outorigin + "<dev string:x16b>" + dropdata.dist);
            }
        #/
    ...
    /#
        if (var_551904951118b7b9) {
            println("<dev string:x10f>" + dropstruct.dropidx + "<dev string:x175>" + dropdata.outorigin + "<dev string:x185>" + dropdata.outangles);
        }
    #/
...
// Size: 0x3a0
function br_forcegivecustompickupitem(player, scriptablename, var_43fb3d97abb79854, countoverride, fromkiosk, droppurchased) {
    ...
    if (results == 1) {
        ...
        player onusecompleted(fakepickup, var_43fb3d97abb79854, undefined, fromkiosk);
        return true;
    } else if (results == 20) {
        lootid = undefined;
...
function function_877ff2bc34ed0e27(player) {
    ...
    totalsize = namespace_e50e624d9af51c8c::function_b13e35608b336d65(player);
    if (totalsize <= 0) {
        return "";
    }
...
function function_4e335a6589199847(pickupent, var_a5b2c541413aa895, var_db943473454f6ea6, backpackequip, fromkiosk) {
    ...
    pickupremains = 0;
    hasperkpack = isdefined(self.var_28c944f222f4814.var_183ec729c8876d57);
    ...
    targetent = pickupent;
    var_aee3b96540ed46e1 = ter_op(hasperkpack, namespace_708f627020de59d3::function_43044da0ed44d79f(self.var_28c944f222f4814.var_183ec729c8876d57), 0);
...
function dropequipmentinslot(dropstruct, slot, fromkiosk, ammocountoverride, var_db943473454f6ea6, allowautopickup, itemtype, dropfeedback, pickup) {
    ...
    if (isdefined(var_feb782334dd23a66)) {
        ...
        if (issuperpickup(scriptablename)) {
            allowautopickup = getdvarint(@"hash_8c7fd24cb9dc68f0", 0) || allowautopickup && isalive(self);
        }
...
function addspecialistbonuspickup(skipsplash) {
    player = self;
    assert(!player br_public::hasspecialistbonus());
...
function _givebrsuper(equipname, supername, supercount) {
    if (level.allowsupers || istrue(self.var_678855513f5076ca) && !supers::function_f95bcca44e8cba53(supername)) {
        ...
        thread scripts\mp\supers::function_bdcbe42d37001209(2);
    }
...
function takesuperpickup(pickupent, fromkiosk, var_db943473454f6ea6) {
    ...
    if (isdefined(self.equipment["super"])) {
        if (scripts\mp\equipment::getequipmentslotammo("super") > 0 || var_d539af51a08b192d || scripts\mp\supers::isUsingSuperWeapon()) {
            dropstruct = function_7b9f3966a7a42003();
...
function forcegivesuper(targetsupername, dropcurrent, fromkiosk, droppurchased, var_db943473454f6ea6) {
    ...
    /#
        if (!isdefined(var_733d60a5f3a8c170)) {
            println("<dev string:x187>" + utility::default_to(targetsupername, "<dev string:x132>") + "<dev string:x1a4>");
        }
    #/
...
function takegasmask(pickupent, fromkiosk, itemslotindex, backpackequip) {
    ...
    if (gasmask::hasgasmask(self)) {
        if (pickupent.scriptablename == "brloot_equip_gasmask" && self.gasmasktype == "brloot_equip_gasmask_durable" && !istrue(backpackequip)) {
            lootid = function_dc5a935ab4958490(pickupent);
            namespace_e50e624d9af51c8c::addItemToBackpack(lootid, pickupent);
            return;
        }
        function_73ffc9bcd6d1e62d(fromkiosk);
        dodrop = !istrue(namespace_e50e624d9af51c8c::function_7e103028c464ab9a(pickupent.scriptablename));
        if (!istrue(dodrop)) {
        ...
        if (istrue(dodrop)) {
            ...
            maskdrop = spawnpickup(self.gasmasktype, dropinfo, int(self.gasmaskhealth), 1);
            if (br_public::isplayeringulag()) {
                maskdrop.var_1b46a808091ea19c = 1;
            }
        }
        namespace_b16531563568eaba::function_777c89585478357b(self);
        if (pickupent.scriptablename == "brloot_equip_gasmask_durable" && self.gasmasktype == "brloot_equip_gasmask" && !istrue(backpackequip)) {
            var_9bdf1cfacd52af25 = self.gasmaskhealth;
            dropstruct = function_7b9f3966a7a42003();
            overridedist = utility::ter_op(isdefined(pickupent.overridedist), pickupent.overridedist, level.br_pickups.distanceoverride);
            dropinfo = getitemdroporiginandangles(dropstruct, self.origin, self.angles, self, level.br_pickups.var_ad49a38dd7c4c10f, overridedist, undefined, undefined, pickupent.origin);
            maskdrop = spawnpickup("brloot_equip_gasmask", dropinfo, int(var_9bdf1cfacd52af25), 1);
...
function function_d345eec68e01361f(lootid, scriptablename) {
    ...
    return namespace_85cd45b4fe0d86fb::function_3c17a26ce6a4668(lootid) || scripts\mp\gametypes\br_pickups::isgasmask(scriptablename) || scripts\mp\gametypes\br_pickups::function_5449da9d3d0358a4(scriptablename) || scripts\mp\gametypes\br_pickups::function_1be34022a4acce73(scriptablename) || scripts\mp\gametypes\br_public::function_12d9a293931f0455(scriptablename) || function_c51fec498a6283b5(scriptablename) || scripts\mp\gametypes\br_pickups::function_43e6c697b2fdde6e(scriptablename);
}
            ...
            if (isdefined(pickup.instance)) {
                if (!isdefined(pickup.instance.task)) {
                    ...
                    if (isdefined(pickup.instance.task) && isdefined(pickup.instance.task.safestructs)) {
                        ...
                        assertex(istrue(pickup.instance.task.safestructs.size > 0), "Safecracker does not have valid safe locations when picked up! ");
                    }
                }
            }
        ...
        if (function_c7279e910cefd2a4(pickup.scriptablename)) {
            ...
            if (var_9c597e5015ff9e26) {
                ...
                if (isdefined(var_af989994e05fbdcb)) {
                    foreach (featureban in var_af989994e05fbdcb) {
...
function spawnpickup(pickupname, dropinfo, count, showtrail, weaponobj, allowautopickup, countlefthand, var_e97d731bedd44c63) {
    if (!isdefined(dropinfo)) {
        println("<dev string:x1dd>" + pickupname + "<dev string:x1fd>");
        return;
    }
    if (dropinfo.origin == (0, 0, 0)) {
        println("<dev string:x1dd>" + pickupname + "<dev string:x242>");
        return;
    }
        ...
        if (!isdefined(var_c9c301a888170672)) {
            if (br_weapons::isvalidcustomweapon(weaponobj)) {
                ...
                if (!isdefined(weaponclasstoken)) {
                    println("<dev string:x283>" + weaponobj.basename);
                    return;
                }
...
function onusecompleted(pickupent, var_43fb3d97abb79854, var_a5b2c541413aa895, fromkiosk, var_db943473454f6ea6, instance, backpackequip, delayfeedback, weaponstowed) {
    ...
    if (isweaponpickupitem(pickupent)) {
        ...
        takegasmask(pickupent, fromkiosk, var_db943473454f6ea6, backpackequip);
...
function playpickupfeedback(pickupent, var_a5b2c541413aa895) {
    ...
    assertex(isvector(origin_pickup), "playPickupFeedback unexpected pickupEnt");
...
function dropbrgasmask(dropstruct, dontspawnitem, delaydrop) {
    ...
    self endon("death_or_disconnect");
    if (gasmask::hasgasmask(self)) {
        if (istrue(delaydrop) && level.var_e79884673ac9666e) {
        ...
        gasmask = undefined;
        if (!istrue(dontspawnitem) && self.gasmaskhealth > 0) {
            gasmask = spawnpickup(self.gasmasktype, dropinfo, int(self.gasmaskhealth), 1, undefined, allowautopickup);
        }
...
function dropbrkillstreak(dropstruct, fromkiosk, var_db943473454f6ea6, dropfeedback, pickup) {
    if (hasanykillstreak()) {
        ...
        if (isdefined(var_db943473454f6ea6)) {
            ...
            allowautopickup = isalive(self) || getdvarint(@"hash_75376790b7cf7e23", 0);
...
function dropspecialistbonus(dropstruct) {
    if (br_public::hasspecialistbonus()) {
        dropinfo = getitemdroporiginandangles(dropstruct, self.origin, self.angles, self);
        item = spawnpickup("brloot_specialist_bonus", dropinfo, undefined, undefined, undefined, isalive(self));
        function_2f4e0022c686dbe6(item);
...
/#
    ...
    function function_874048c58e96731() {
        br_forcegivecustompickupitem(self, "<dev string:x323>", 1, 3);
        ...
        br_forcegivecustompickupitem(self, "<dev string:x336>", 1);
        br_forcegivecustompickupitem(self, "<dev string:x34b>", 1);
        br_forcegivecustompickupitem(self, "<dev string:x36e>", 1);
        br_forcegivecustompickupitem(self, "<dev string:x381>", 1);
        br_forcegivecustompickupitem(self, "<dev string:x397>", 1);
        br_forcegivecustompickupitem(self, "<dev string:x3ad>", 1);
        br_forcegivecustompickupitem(self, "<dev string:x3cc>", 1);
    }
...
function function_750e9a7f11becd51(player, dontspawnitem) {
    ...
    dropstruct = function_7b9f3966a7a42003();
    dropstruct.dropidx = slot;
    player thread dropbrgasmask(dropstruct, dontspawnitem, 1);
    return true;
}
...
function dangercircletick(var_819edacdacb810e4, dangercircleradius, thresholdradius) {
    ...
    for (index = level.br_pickups.droppedgasmasks.size - 1; index >= 0; index--) {
        ...
        if (distance2dsquared(gasmask.origin, var_819edacdacb810e4) > circleradiussquared) {
...
function function_e44c2d69db881894(lootname) {
    ...
    if (maxcount > 0 && isdefined(lootid)) {
        for (i = 0; i < namespace_e50e624d9af51c8c::function_b13e35608b336d65(self); i++) {
            currentlootid = namespace_e50e624d9af51c8c::function_6196d9ea9a30e609(i);
