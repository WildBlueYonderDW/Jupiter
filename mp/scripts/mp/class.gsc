...
function loadout_updateclassgamemode(struct, class) {
    ...
    for (attachmentindex = 0; attachmentindex < 7; attachmentindex++) {
        ...
        var_1708b873a34eeb50 = function_9f808ad55705b616(attachmentindex, #"primary");
        if (isdefined(gamemodeLoadout[var_1708b873a34eeb50])) {
            struct.loadoutprimaryattachmentids[attachmentindex] = gamemodeLoadout[var_1708b873a34eeb50];
        }
    }
    for (var_36d2abbdcbcb186c = 0; var_36d2abbdcbcb186c < 5; var_36d2abbdcbcb186c++) {
    ...
    for (attachmentindex = 0; attachmentindex < 7; attachmentindex++) {
        ...
        var_1708b873a34eeb50 = function_9f808ad55705b616(attachmentindex, #"secondary");
        if (isdefined(gamemodeLoadout[var_1708b873a34eeb50])) {
            struct.loadoutsecondaryattachmentids[attachmentindex] = gamemodeLoadout[var_1708b873a34eeb50];
        }
    }
    for (var_36d2abbdcbcb186c = 0; var_36d2abbdcbcb186c < 5; var_36d2abbdcbcb186c++) {
...
function respawnitems_saveweapons(respawnitems) {
    ...
    foreach (weapon in var_5bc770e98fe2f25e) {
        if (function_da27e3343b019fde() && function_72ce982d9fc26f1c(weapon)) {
            continue;
        }
...
function function_6baf1dc15666ea19(var_5996df3d783693e8, data) {
    ...
    iskillstreakweapon = namespace_e0ee43ef2dddadaa::iskillstreakweapon(var_5996df3d783693e8);
    var_84444ff0b7f0f04f = !iskillstreakweapon || iskillstreakweapon && scripts\mp\utility\killstreak::isjuggernaut();
    return var_5996df3d783693e8 != data.backupPistol && !namespace_f8d3520d3483c1::function_6aa482957b62905c(var_5996df3d783693e8) && !scripts\mp\utility\weapon::isgunlessweapon(var_5996df3d783693e8) && var_84444ff0b7f0f04f;
}
