...
function private function_a10148d5861bcad7() {
    ...
    /#
        if (!isdefined(operatorlistbundle)) {
            println("<unknown string>" + gamemodebundle.operatorlist);
            return;
        }
    #/
    ...
    for (i = 0; i < operatorlist.size; i++) {
        ...
        /#
            ...
            if (!isdefined(operatorbundle)) {
                println("<unknown string>" + gamemodebundle.operatorlist + "<unknown string>" + operatorlist[i].operator);
                continue;
            }
        #/
...
function private function_36a7c07e40354ae7() {
    ...
    /#
        if (!isdefined(var_728e4ee3adb777cd)) {
            println("<unknown string>" + projectscriptbundle.var_bc9940f5b35f3ff5);
            return;
        }
    #/
...
function private function_53b243a75e43d0af() {
    ...
    /#
        if (!isdefined(var_edd8be499278b105)) {
            println("<unknown string>" + gamemodebundle.execution_list);
            return;
        }
    #/
    ...
    for (i = 0; i < executionlist.size; i++) {
        ...
        /#
            if (!isdefined(executionbundle)) {
                println("<unknown string>" + gamemodebundle.execution_list + "<unknown string>" + executionlist[i].operatorexecution);
                continue;
            }
        #/
