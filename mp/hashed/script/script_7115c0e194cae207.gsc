...
#namespace jup_spawner_zombie_vault_mimic_hvt;

// Namespace jup_spawner_zombie_vault_mimic_hvt / namespace_1b251215c7606ae3
// Params 0
// Checksum 0x0, Offset: 0x24b
// Size: 0x1e8
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_spawner_zombie_vault_mimic_hvt" );
