...
function flares_think(vehicle) {
    ...
    while (vehicle.health > 0) {
        if (isdefined(vehicle.playercontrolled)) {
            ...
            emissile = vehicle waittill("incomming_missile");
...
function getenemytarget(fradius, var_803fde08d46aef72, var_70183020b339e69, dosighttrace, var_390b6d8b1c31fb95, var_1680cd837efb560a, var_a3658e5ee7a7dda1) {
    ...
    for (i = 0; i < possibletargets.size; i++) {
        ...
        var_ad1e1d53e47e3b02[var_ad1e1d53e47e3b02.size] = possibletargets[i];
    }
    if (var_ad1e1d53e47e3b02.size == 0) {
        self notify("gunner_new_target", var_fc25f80bd447ed26);
        return var_fc25f80bd447ed26;
    }
    if (var_ad1e1d53e47e3b02.size == 1) {
        self notify("gunner_new_target", var_ad1e1d53e47e3b02[0]);
        return var_ad1e1d53e47e3b02[0];
    }
    var_a8f8e9a95733bd9 = getclosest(self.origin, var_ad1e1d53e47e3b02);
    self notify("gunner_new_target", var_a8f8e9a95733bd9);
...
// Size: 0xce
function attachmissiles(weapon1, weapon2, var_a7756cbfed84307a, var_a77567bfed84257b) {
    ...
    if (isdefined(var_a7756cbfed84307a)) {
        weapon[2] = var_a7756cbfed84307a;
    }
    if (isdefined(var_a77567bfed84257b)) {
        weapon[3] = var_a77567bfed84257b;
    }
