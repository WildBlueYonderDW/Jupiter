...
// Size: 0x2f
function function_3f11738e6c8250e1(target_ent, var_c862ca7056a698ab) {
    self.var_a48c549d4a877cd6 = var_c862ca7056a698ab;
...
function private function_f104d7887d46f98e() {
    /#
        ...
        while (1) {
            if (!isdefined(var_e494de5eb86a0117) || !isalive(var_e494de5eb86a0117)) {
                return;
            }
            target = var_e494de5eb86a0117.enemy;
            if (!var_e494de5eb86a0117 function_550c2a40a7f8e322()) {
                var_e494de5eb86a0117._blackboard.var_6b0939cf3fd5d7a1 = 1;
                var_e494de5eb86a0117._blackboard.var_d15d23565f5a60a1 = randomint(2) == 0;
                var_e494de5eb86a0117 notify("<unknown string>");
            }
            waitframe();
        }
    #/
