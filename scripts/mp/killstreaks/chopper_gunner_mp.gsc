...
function chopper_gunner_assigntargetmarkers() {
    ...
    self.enemytargetmarkergroup = scripts/cp_mp/targetmarkergroups::targetmarkergroup_on("overlaytargetmarkerenemy", self.owner, var_2cd52bbc2a67b7cf, self.owner, 0, 1, 1);
