...
function private function_7e2e3e062b49f13b(params) {
    ...
    if (agent.unittype == "soldier") {
        ...
        if (is_equal(agent.agent_type, "jup_ob_ally_fletcher_base")) {
            agent namespace_2fdc8e343bfb2334::function_848612e5b224425b("flet", "b25", "b25");
        }
...
function private function_c3a8389891d2f901() {
    namespace_c39580665208f0a4::function_4981209c2c509828("ob_sergeant", "body_c_jup_sp_enemy_pmc_capt_03", "head_sc_m_jimenez", "mp_vm_opforce_shadow_company_elite_1_1", "vestlight", "millightgr");
}
