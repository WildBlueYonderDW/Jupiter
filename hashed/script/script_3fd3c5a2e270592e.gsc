...
#namespace namespace_9f78b8694cfa43bf;

// Namespace namespace_9f78b8694cfa43bf / namespace_1ad0622c44d22e1a
// Params 0, eflags: 0x0
...
function init() {
    ...
    if (level.br_armory_kiosk_enabled) {
        ...
        #/
        namespace_2f242676eb49ca88::function_19f98938b071a88f();
...
function _getactualcost(player, itemdata) {
    ...
    var_1a61fa389340ae66 = getdvarint(hashcat(@"hash_d98c82b5a26dc973", itemdata.ref, "_cost_override"), 0);
...
// Size: 0xc7
function dangercircletick(var_819edacdacb810e4, dangercircleradius) {
    ...
    foreach (armorykiosk in level.br_armory_kiosk.scriptables) {
        if (isdefined(armorykiosk.visible) && distance2dsquared(armorykiosk.origin, var_819edacdacb810e4) > radiussquared) {
...
function _getequipmentammotomax(equipmentref) {
    ...
    ammo = player namespace_4fb9dddfb8c1a67a::getequipmentammo(equipmentref);
    ammomax = player namespace_4fb9dddfb8c1a67a::getequipmentmaxammo(equipmentref);
...
function _maxoutequipmentammo(equipmentref) {
    ...
    ammomax = player namespace_4fb9dddfb8c1a67a::getequipmentmaxammo(equipmentref);
    if (ammo < ammomax) {
        player namespace_4fb9dddfb8c1a67a::setequipmentammo(equipmentref, ammomax);
    }
}
...
function _findgivearmoramountanddropleftovers(fromkiosk, var_2737cac9ee8f6098) {
    ...
    if (function_83e3b506365bafc5()) {
        ...
        if (leftover > 0 && !istrue(var_2737cac9ee8f6098)) {
            ...
            dropinfo = namespace_6250b14b3f614101::getitemdroporiginandangles(0, player.origin, player.angles, player, undefined, overridedist);
        ...
        if (istrue(fromkiosk)) {
            var_ad49a38dd7c4c10f = getkioskyawoffsetoverride();
        }
        dropinfo = function_bb87cfae1e28e70b(0, player.origin, player.angles, player, var_ad49a38dd7c4c10f);
...
function function_90b0e9eb26e38443(itemdata, var_7dddac09987d559e, var_452130d9d126e506, var_db943473454f6ea6) {
    ...
    var_bffcbf6249872947 = function_cfb85293f9660751(level.br_lootiteminfo[scriptablename].fullweaponobj);
    var_35ead47ed0d7507e = var_bffcbf6249872947[2];
    ammoleft = var_bffcbf6249872947[1];
    ammo = var_bffcbf6249872947[0];
...
function _handlespecialpurchase(itemdata, var_7dddac09987d559e, var_452130d9d126e506, kiosk) {
    ...
    case #"hash_63d4978a15e681a8": 
        ...
        assert(purchasesuccess);
        itemdata.lootid = namespace_38b993c4618e76cd::function_fae5e1d3de32d3f7("brloot_offhand_advancedvehicledrop");
        break;
...
function restartcircleelimination(origin) {
    ...
    if (function_946938d9fde4bdce("oneLife")) {
        ...
        setdynamicdvar(hashcat(@"hash_d98c82b5a26dc973", function_67386b14d0c7d1ee(), "_numLives"), 1);
    }
}
