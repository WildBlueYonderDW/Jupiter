...
function reinitspawns() {
    /#
        ...
        scripts/mp/spawnlogic::function_8390bf8c3b74466a("time_limit_reached");
        spawns = scripts/mp/spawnlogic::getspawnpointarray("isPublicMatch");
        ...
        scripts/mp/spawnlogic::registerspawnset("time_limit_reached", spawnssecondary);
    #/
}
