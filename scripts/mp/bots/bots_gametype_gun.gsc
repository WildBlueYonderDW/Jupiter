...
#namespace namespace_8652b057d883f62f;

// Namespace namespace_8652b057d883f62f/namespace_6b97ab111640dd77
// Params 0, eflags: 0x0
...
// Size: 0x7f
function bot_gun_pick_personality_from_weapon(weaponname, var_8739a29d57d25941) {
    if (isdefined(weaponname) && weaponname != "none") {
        ...
        if (isdefined(var_6f94db6d48b3fd6d) && var_6f94db6d48b3fd6d.size > 0) {
            choice = undefined;
            if (array_contains(var_6f94db6d48b3fd6d, var_8739a29d57d25941)) {
                choice = var_8739a29d57d25941;
            } else {
    ...
    while (1) {
        ...
        if (current_weapon.basename != "none" && !iskillstreakweapon(current_weapon) && current_weapon.basename != last_weapon_name && !ismeleeoverrideweapon(current_weapon)) {
            ...
            if (self botgetdifficultysetting("advancedPersonality") && self botgetdifficultysetting("strategyLevel") > 0) {
                bot_gun_pick_personality_from_weapon(current_weapon.basename, var_3fff2e131f17cf45);
            }
        }
