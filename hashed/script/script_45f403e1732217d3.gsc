...
// Namespace namespace_3a38da80071a2614 / namespace_e77194a0203f683
// Params 2, eflags: 0x4
// Checksum 0x0, Offset: 0xda56
// Size: 0x186
function private function_968a17536a9b61d3(origin, angles) {
    var_c00a2f624996341c = namespace_7349d2dcd492da87::function_45d01d27e99f49d7();
    round_num = var_c00a2f624996341c[5];
    playlist_name = var_c00a2f624996341c[4];
    playlist_id = var_c00a2f624996341c[3];
    sub_game_type = var_c00a2f624996341c[2];
    game_type = var_c00a2f624996341c[1];
    map_name = var_c00a2f624996341c[0];
    if (!isdefined(origin)) {
        origin[0] = -1;
        origin[1] = -1;
        origin[2] = -1;
...
// Namespace namespace_3a38da80071a2614 / namespace_e77194a0203f683
// Params 1, eflags: 0x4
// Checksum 0x0, Offset: 0xde5e
// Size: 0x26d
function private function_234528691f62628b(data) {
    var_c00a326249963ab5 = namespace_7349d2dcd492da87::function_45d01d27e99f49d7();
    round_num = var_c00a326249963ab5[5];
    playlist_name = var_c00a326249963ab5[4];
    playlist_id = var_c00a326249963ab5[3];
    sub_game_type = var_c00a326249963ab5[2];
    game_type = var_c00a326249963ab5[1];
    map_name = var_c00a326249963ab5[0];
...
function function_83e5e7d28c56eef1(data) {
    ...
    var_c00a336249963ce8 = namespace_7349d2dcd492da87::function_45d01d27e99f49d7();
    round_num = var_c00a336249963ce8[5];
    playlist_name = var_c00a336249963ce8[4];
    playlist_id = var_c00a336249963ce8[3];
    sub_game_type = var_c00a336249963ce8[2];
    game_type = var_c00a336249963ce8[1];
    map_name = var_c00a336249963ce8[0];
...
// Namespace namespace_3a38da80071a2614 / namespace_e77194a0203f683
// Params 2, eflags: 0x4
// Checksum 0x0, Offset: 0xe7f1
// Size: 0x2cb
function private function_b06acd6b01e90383(round_start_time_ms, round_end_time_ms) {
    var_bffcba6249871e48 = namespace_7349d2dcd492da87::function_45d01d27e99f49d7();
    round_num = var_bffcba6249871e48[5];
    playlist_name = var_bffcba6249871e48[4];
    playlist_id = var_bffcba6249871e48[3];
    sub_game_type = var_bffcba6249871e48[2];
    game_type = var_bffcba6249871e48[1];
    map_name = var_bffcba6249871e48[0];
