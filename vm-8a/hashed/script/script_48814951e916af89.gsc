...
function function_bd14655b29f9a64() {
    ...
    if (!tableexists(level.var_bbc459244382ae0f)) {
        println("<dev string:x1c>" + level.var_bbc459244382ae0f + "<dev string:x5c>");
        return;
    }
...
function ai_mp_requestspawnagent(agenttype, groundspawnorigin, spawnangles, priority, category, subcategory, groupname, team, destination, poiname, skipstealth, var_5a6a87fa3f95753f, var_5f0c541b305bf851, var_80f4bde7090a4773, forcedormant, subarea, threatbiasgroup) {
    ...
    assert(isdefined(agenttype) && isdefined(groundspawnorigin) && isdefined(priority) && isdefined(category), "ai_mp_requestSpawnAgent: Called without having all of its mandatory params defined");
    /#
        if (isdefined(poiname) && scripts\mp\poi::function_47d356083884f913()) {
            assert(scripts\mp\poi::poi_ispoiactive(poiname), "<dev string:x6b>" + poiname + "<dev string:x94>");
        }
    #/
    ...
    if (!var_644d90de7685f75) {
        var_57ad1dc40b3000d = function_559886efcd7d1a19(priority, groundspawnorigin, spawndormant);
    ...
    if (spawndormant) {
        ...
        var_451a9d27d63c746b = function_e2fa9b378bbf03a6(agenttype, groundspawnorigin, spawnangles, priority, category, subcategory, groupname, team, destination, poiname, skipstealth, undefined, threatbiasgroup);
        processAgentSpawned(var_451a9d27d63c746b, var_80f4bde7090a4773);
        subArea_findAndAssignForDormancyID(groundspawnorigin, poiname, destination, var_451a9d27d63c746b);
    ...
    /#
        if (0 && category == "<dev string:xa4>") {
            thread scripts\mp\utility\debug::drawsphere(groundspawnorigin, 64, 500, (0, 1, 0));
        }
        namespace_d1a9ca87d78d9813::function_9533653868e59fb6("<dev string:xac>", "<dev string:xb8>" + priority, category + "<dev string:xc2>" + subcategory, undefined, undefined, undefined, poiname, groundspawnorigin);
        if (!var_644d90de7685f75 && getdvarint(@"hash_bcbe3309344bb6d2", 0) == 1) {
            ...
            print3d(agent.origin + (0, 0, 105), "<dev string:xc4>", (0, 1, 0), 1, 0.6, 6000);
            print3d(agent.origin + (0, 0, 90), "<dev string:xe0>" + priority, (0, 1, 0), 1, 0.4, 6000);
            print3d(agent.origin + (0, 0, 80), "<dev string:xeb>" + category, (0, 1, 0), 1, 0.4, 6000);
            print3d(agent.origin + (0, 0, 70), "<dev string:xf6>" + subcategory, (0, 1, 0), 1, 0.4, 6000);
            println("<dev string:x104>" + priority + "<dev string:x129>" + category + "<dev string:x138>" + subcategory);
        }
    #/
    if (level.var_3a89274682239c28 <= gettime()) {
...
function private function_eea40a1b6180f90a(agenttype, groundspawnorigin, spawnangles, priority, category, subcategory, groupname, team, destination, poiname, skipstealth) {
    ...
    if (!isdefined(level.agent_definition[var_94d391b4017fe505])) {
        println("<dev string:x1e7>" + agenttype + "<dev string:x213>");
        return undefined;
    }
...
function function_d5bc07eabf352abb(node, poiname, var_fcdc7f62624c71ff, basetype, tier, nationality) {
    ...
    var_57acedc40b2f974 = function_bd5c9a8459875e7a(basetype, tier);
    tier = var_57acedc40b2f974[1];
    basetype = var_57acedc40b2f974[0];
...
function function_59cdfe39e161a336(node) {
    /#
        stealth_group = getdvar(@"hash_a839371d8b7bad64", "<dev string:x284>");
        if (stealth_group != "<dev string:x284>") {
...
function function_559886efcd7d1a19(priority, requestedspawnorigin, spawndormant) {
    var_c00a2d6249962fb6 = function_56e8fd646957529c(priority, 0, requestedspawnorigin, spawndormant);
    var_c9cb5ceef8c11eea = var_c00a2d6249962fb6[1];
    success = var_c00a2d6249962fb6[0];
    if (!success) {
        var_c00a30624996364f = function_56e8fd646957529c(priority, 1, requestedspawnorigin, spawndormant);
...
function private function_56e8fd646957529c(priority, ruthless, requestedspawnorigin, spawndormant) {
    ...
    assert(isdefined(priorityint), "tryRemoveAI: Given an invalid priority");
...
function function_67224249ba9c2e2e(priority, ruthless, requestedspawnorigin, subarea) {
    numchecked = 0;
    priorityint = array_find(level.var_41670c1c65f3d3cf.priorities, priority);
    assert(isdefined(priorityint), "tryRemoveAI_spawnedOnlyAnywhere: Given an invalid priority");
    if (!isdefined(subarea)) {
        subarea = function_a44e168e8cced18(requestedspawnorigin);
    }
    foreach (testpriority in level.var_41670c1c65f3d3cf.var_1d7de2571d2c82a7) {
...
function function_28b90eb2b591003f() {
    /#
        namespace_d1a9ca87d78d9813::function_9533653868e59fb6("<dev string:x285>", "<dev string:xb8>" + priority_get(self), self.category + "<dev string:xc2>" + self.subcategory, undefined, undefined, undefined, agentpers_getagentpersdata(self, "<dev string:x290>"), self.origin);
        if (getdvarint(@"hash_bcbe3309344bb6d2", 0) == 1) {
            level thread draw_arrow_time(self.origin + (0, 0, 250), self.origin + (0, 0, 5000), (1, 0, 0), 120);
            print3d(self.origin + (0, 0, 105), "<dev string:x298>", (1, 0, 0), 1, 0.6, 6000);
            print3d(self.origin + (0, 0, 90), "<dev string:xe0>" + priority_get(self), (1, 0, 0), 1, 0.4, 6000);
            print3d(self.origin + (0, 0, 80), "<dev string:xeb>" + self.category, (1, 0, 0), 1, 0.4, 6000);
            print3d(self.origin + (0, 0, 70), "<dev string:xf6>" + self.subcategory, (1, 0, 0), 1, 0.4, 6000);
            iprintlnbold("<dev string:x2aa>" + priority_get(self) + "<dev string:x129>" + self.category + "<dev string:x138>" + self.subcategory);
        }
    #/
    ...
    function function_49d965cff987ed32() {
        while (true) {
            ...
            if (getdvarint(@"hash_d054932c3f2f177b", 0) != 0) {
                ...
                aitype = function_7f1a2e2ebe0c1693("<dev string:x2c1>", tier);
                agent = ai_mp_requestspawnagent(aitype, level.players[0].origin, (0, 0, 0), "<dev string:x2c4>", "<dev string:x2cd>", "<dev string:x2d4>", undefined, undefined, undefined, undefined, 0, 0, 0);
                overridetier3(agent);
...
function function_ae8293438b86ca23() {
    ...
    foreach (spawnpackagemainnode in var_c034726a93bbff6e) {
        ...
        if (!isdefined(subarea)) {
            /#
                if (isdefined(spawnpackagemainnode.poi)) {
                    println("<dev string:x2df>" + spawnpackagemainnode.poi + "<dev string:x35a>");
                    return;
                }
...
function function_359f24553bdcca92(number, priority) {
    ...
    priorityint = array_find(level.var_41670c1c65f3d3cf.priorities, priority);
    assert(isdefined(priorityint), "aiBudget_canKillOffNumAgents: Given an invalid priority");
    foreach (testpriority in level.var_41670c1c65f3d3cf.var_1d7de2571d2c82a7) {
        if (array_find(level.var_41670c1c65f3d3cf.priorities, testpriority) <= priorityint) {
            break;
        }
            ...
            if (getdvarint(@"hash_9e9be127028294d2", 0) == 1) {
                ...
                foreach (agent in agents) {
                    if (isdefined(agent) && isagent(agent) && isalive(agent)) {
                        print3d(agent.origin + (0, 0, 100), "<dev string:x3da>" + agent.poi, (1, 0, 1), 1, 0.4);
                        print3d(agent.origin + (0, 0, 90), "<dev string:xe0>" + priority_get(agent), (1, 0, 1), 1, 0.4);
                        print3d(agent.origin + (0, 0, 80), "<dev string:xeb>" + agent.category, (1, 0, 1), 1, 0.4);
                        print3d(agent.origin + (0, 0, 70), "<dev string:xf6>" + agent.subcategory, (1, 0, 1), 1, 0.4);
                    }
                }
            }
            waitframe();
...
function function_77acc10c4823dd8a(numagents, reinforceorigin, priority, category, subcategory, groupname, team, var_93390a6953905fef, poiname, reinforcementtype, goalradius, var_21f24aecb313e479, var_ec862c2c00c7ab5d, nationality) {
    ...
    assert(scripts\mp\flags::gameflagexists("prematch_done") && scripts\mp\flags::gameflag("prematch_done"), "reinforce_requestReinforcements: requesting reinforcements before the prematch is done. Please simply spawn these agents directly.");
    agents = [];
    if (!isdefined(team)) {
            ...
            if (!isdefined(agents) || agents.size == 0) {
                ...
                if (reinforcementoptions.size == 0 && isdefined(fallback)) {
                    if (istrue(level.var_ba36989c7e24e4ff)) {
                        println("<dev string:x3e0>" + poiname + "<dev string:x3f4>");
                    }
...
function function_2f3b04fc531b4115(numagents, reinforceorigin, priority, category, subcategory, groupname, team, var_93390a6953905fef, poiname, reinforcementtype, goalradius, var_21f24aecb313e479, var_ec862c2c00c7ab5d, nationality) {
    ...
    if (issubstr(reinforcementtype, "closet") || reinforcementtype == "Monster Closet") {
        ...
        var_ec95d227d54f8c70 = namespace_43bf74a2ee9234c0::function_a5b0665e0a814be6(numagents, var_ec862c2c00c7ab5d, reinforceorigin, priority, category, subcategory, groupname, team, var_93390a6953905fef, poiname, nationality, vehicleoverride);
        ...
        agents = namespace_7ae25d9e5d5a28ef::function_3779deb97b61a65(numagents, reinforceorigin, priority, category, subcategory, groupname, team, var_93390a6953905fef, poiname, goalradius, var_21f24aecb313e479, var_ec862c2c00c7ab5d, undefined, undefined, nationality, undefined);
...
function function_4bcc15a45628da41(poiname) {
    ...
    while (true) {
        if (level.var_41670c1c65f3d3cf.poi[poiname].reinforcementqueue.size > 0) {
            ...
            reinforceorigin = var_ec9ee327d559d081[0];
            if (isdefined(reinforceorigin)) {
                ...
                if (istrue(level.var_ba36989c7e24e4ff)) {
                    println("<dev string:x40e>" + poiname + "<dev string:x428>" + gettime());
                }
                ...
                if (isdefined(agents) && agents.size > 0) {
                    ...
                    if (istrue(level.var_ba36989c7e24e4ff)) {
                        println("<dev string:x42b>" + poiname + "<dev string:x44d>" + delaytime);
                    }
                    function_374ecacad63bb411(delaytime, poiname, "Success");
                } else {
                    if (istrue(level.var_ba36989c7e24e4ff)) {
                        println("<dev string:x45a>" + poiname + "<dev string:x44d>" + 1);
                    }
                ...
                println("<dev string:x479>" + poiname);
...
function function_99b2104c78855a16(subarea) {
    ...
    if (subarea.var_71ad22c5d093d90b != "orphan") {
        ...
        if (var_abc2b29e98e397c7.size == 0) {
            println("<dev string:x49c>" + subarea.poi + "<dev string:x4e4>" + subarea.var_71ad22c5d093d90b);
            return subarea.trigger.origin;
        }
        return random(var_abc2b29e98e397c7).origin;
    }
    if (alllocs.size == 0) {
        println("<dev string:x4e8>" + subarea.poi + "<dev string:x4e4>" + subarea.var_71ad22c5d093d90b);
        return;
    }
...
function function_e332d48077f00441(poiname) {
    ...
    while (level.var_41670c1c65f3d3cf.poi[poiname].var_9d2f71782a11c15c) {
        ...
        foreach (delaypackage in var_70bcbf0ad5028219) {
            if (istrue(level.var_ba36989c7e24e4ff)) {
                println("<dev string:x52a>" + poiname + "<dev string:x428>" + delaypackage.delaytime);
            }
...
function function_346caf10322931c8(poiname, origin) {
    ...
    if (function_47d356083884f913()) {
        ...
        if (!level.var_1171d24dd4142369[poiname] && curtime - level.var_e5fd74b71bdf51fa[poiname] > level.var_d1a95e3c3d6ea9fc) {
            ...
            namespace_446fc987a980892f::playevent("poi_ai_reinforce", var_600052562a9f7fa4);
            level.var_1171d24dd4142369[poiname] = 0;
        }
        return;
    }
...
function spawnhiddenagent(team, hiddenpos) {
    ...
    agent = namespace_bfef6903bca5845d::ai_mp_requestspawnagent(aitype, hiddenpos, (0, 0, 0), "absolute", "reinforcements", "hidden", undefined, team, undefined, poi, 1, undefined, 0);
    if (!isdefined(agent)) {
        return;
    }
    agent.ignoreall = 1;
...
function function_8c8c6dbf143ab5b2(agent, lootstruct) {
    if (!isdefined(lootstruct.lootid)) {
        lootstruct.lootid = namespace_38b993c4618e76cd::function_fae5e1d3de32d3f7(lootstruct.scriptablename);
    }
...
function function_82ed67ae79913551(agent, agenttype, groupname) {
    ...
    deathcountpers = namespace_14d36171baccf528::agentpers_getagentpersdata(agent, "skipDeathCount");
    ...
    agentweapon = namespace_14d36171baccf528::agentpers_getagentpersdata(agent, "weapon");
    ...
    if (isdefined(agentweapon) && shoulddropweapon) {
        ...
        persorigin = namespace_14d36171baccf528::agentpers_getagentpersdata(agent, "weaponDropOrigin");
        ...
        var_ecb05727d56cd9f9 = scripts\mp\gametypes\br_gametype_dmz::getDefaultWeaponAmmo(agentweapon, maxammo);
        var_35ead47ed0d7507e = var_ecb05727d56cd9f9[2];
        ammoleft = var_ecb05727d56cd9f9[1];
    ...
    if (var_dddf3a91daabebd2) {
        ...
        keystruct = function_edabf4238e9d70b5(keyname, namespace_38b993c4618e76cd::getlootidfromref(keyname), keyname);
...
function private function_b66240f19684ff3a(agent, killerclientnum, droponground, dropstruct) {
    ...
    if (!isdefined(level.var_aeb6974202e8f2db[killerclientnum])) {
        ...
        level.var_aeb6974202e8f2db[killerclientnum] = level.var_aeb6974202e8f2db[killerclientnum] + 1;
    }
...
function private function_79946c09ebe3b406(var_8051a869c25eb076, var_78ebfe48861e28d8) {
    ...
    if (isdefined(var_a6825f20b535b471)) {
        ...
        foreach (lootscriptable in var_a6825f20b535b471) {
            lootpool[lootpool.size] = function_edabf4238e9d70b5(lootscriptable, namespace_38b993c4618e76cd::function_fae5e1d3de32d3f7(lootscriptable), lootscriptable, 1, level.br_pickups.counts[lootscriptable]);
        }
    }
    return lootpool;
}
...
function private function_d0f2ec7f450fcb7(lootpool, grenadetype, grenadecount) {
    if (grenadecount > 0) {
        ...
        lootpool[lootpool.size] = function_edabf4238e9d70b5(level.var_370eed78aa5c01a5[grenadetype], namespace_38b993c4618e76cd::getlootidfromref(grenaderef), grenaderef, 1, grenadecount);
    }
    return lootpool;
}
...
function private function_4fd2e36bfd98b4c2(lootpool, agentweapon, killerweapon) {
    ...
    lootpool[lootpool.size] = function_edabf4238e9d70b5(ammoref, namespace_38b993c4618e76cd::getlootidfromref(ammoref), ammoref, 1, level.br_pickups.counts[ammoref] * 2);
    return lootpool;
}
...
// Size: 0x20
function private function_6b1dc8167c1c7378(lootpool, var_f7ea2887b1e3535b) {
    lootpool[lootpool.size] = function_4fc5b97f88757e83(var_f7ea2887b1e3535b);
    return lootpool;
}
...
function private function_305b1ba9c9b7f7b4(droponground, lootstruct, agent, dropstruct) {
    ...
    if (droponground && isdefined(lootstruct.scriptablename)) {
        ...
        dropinfo = scripts\mp\gametypes\br_pickups::getitemdroporiginandangles(dropstruct, agent.origin, agent.angles, agent);
        if (namespace_85cd45b4fe0d86fb::function_3c17a26ce6a4668(lootstruct.lootid)) {
            var_ecabd227d567bfa3 = namespace_85cd45b4fe0d86fb::function_379463a84adb07b4(lootstruct.count);
            var_dab81ead77442a10 = var_ecabd227d567bfa3[2];
            itemcountlefthand = var_ecabd227d567bfa3[1];
        ...
        if (isdefined(lootstruct.var_69f4f638abf12fbf)) {
            namespace_14d36171baccf528::agentpers_setagentpersdata(agent, "dropCallback", lootstruct.var_69f4f638abf12fbf);
        }
        return false;
    }
    return false;
...
/#
    ...
    function function_63bc1945791044c9() {
        ...
        wait 1;
        level.var_f43197e4f524c1f7 = getstructarray("<dev string:x55b>", "<dev string:x569>");
    ...
    function function_a04953ad5de27960(node) {
        ...
        agent = ai_mp_requestspawnagent(aitype, node.origin, node.angles, "<dev string:x57b>", "<dev string:x580>", "<dev string:x58c>");
        if (isdefined(agent)) {
            agent thread function_9bbf1713a14fa580(agent);
        }
        return agent;
    ...
    function function_bd78689b17ee5ca5(textx, texty, poiname, enabledcolor) {
        ...
        printtoscreen2d(textx, texty + 20, "<dev string:x5a0>", enabledcolor, 1);
        printtoscreen2d(textx, texty + 40, "<dev string:x5bf>" + function_abbd4595d76ccc5e(poiname, "<dev string:x5cb>"), (0, 0, 1), 1);
        printtoscreen2d(textx, texty + 60, "<dev string:x5d5>" + function_abbd4595d76ccc5e(poiname, "<dev string:x5e1>"), (0, 1, 1), 1);
        printtoscreen2d(textx, texty + 80, "<dev string:x5ea>" + function_abbd4595d76ccc5e(poiname, "<dev string:x2cd>"), (1, 0.5, 0), 1);
        printtoscreen2d(textx, texty + 100, "<dev string:x5f3>" + function_abbd4595d76ccc5e(poiname, "<dev string:x602>"), (1, 0, 0), 1);
        printtoscreen2d(textx, texty + 120, "<dev string:x60e>" + function_abbd4595d76ccc5e(poiname, "<dev string:x61e>"), (1, 0, 0), 1);
        printtoscreen2d(textx, texty + 140, "<dev string:x62b>" + function_abbd4595d76ccc5e(poiname, "<dev string:x63f>"), (0, 1, 0), 1);
        printtoscreen2d(textx, texty + 160, "<dev string:x64f>" + function_abbd4595d76ccc5e(poiname, "<dev string:x661>"), (1, 1, 1), 1);
        printtoscreen2d(textx, texty + 180, "<dev string:x670>" + function_abbd4595d76ccc5e(poiname, "<dev string:x683>"), (1, 1, 1), 1);
        printtoscreen2d(textx, texty + 200, "<dev string:x693>" + function_abbd4595d76ccc5e(poiname, "<dev string:x6a4>"), (0, 0, 1), 1);
    }
    ...
    function function_7b85b68e72867306(poiinfo) {
        ...
        var_a2d7918a1c23c968["<dev string:x5e1>"] = "<dev string:x6b3>";
        var_a2d7918a1c23c968["<dev string:x2cd>"] = "<dev string:x6c8>";
        var_a2d7918a1c23c968["<dev string:x602>"] = "<dev string:x6df>";
        var_a2d7918a1c23c968["<dev string:x61e>"] = "<dev string:x6df>";
        var_a2d7918a1c23c968["<dev string:x63f>"] = "<dev string:x6f3>";
        var_a2d7918a1c23c968["<dev string:x661>"] = "<dev string:x709>";
        var_a2d7918a1c23c968["<dev string:x683>"] = "<dev string:x709>";
        var_a2d7918a1c23c968["<dev string:x6a4>"] = "<dev string:x71f>";
        var_a2d7918a1c23c968["<dev string:xa4>"] = "<dev string:x734>";
        var_a2d7918a1c23c968["<dev string:x74b>"] = "<dev string:x709>";
        foreach (poiname in level.poi_names) {
            dvarstring = hashcat(@"hash_831b14ba4dbdd316", poiname, "<dev string:x758>");
            if (getdvarint(dvarstring, 0) == 1 || getdvarint(@"hash_6e6e9391065dc426", 0)) {
                assertex(isdefined(level.var_41670c1c65f3d3cf.poi[poiname]), poiname + "<dev string:x75f>");
                if (isdefined(level.var_41670c1c65f3d3cf.poi[poiname])) {
                    if (!poiinfo.var_6ad2d5385a612cd5[poiname].outlined) {
                        ...
                        foreach (agent in function_7e3f22e620f3f71e(poiname, "<dev string:x5cb>")) {
                            if (isalive(agent)) {
                                var_4430b08d5a2d47bf = "<dev string:x79b>";
                                if (isdefined(agent.category) && isdefined(var_a2d7918a1c23c968[agent.category])) {
                                    ...
                                    assertmsg("<dev string:x7b1>" + poiname + "<dev string:x7e0>" + agent.category);
                                }
                                id = scripts\mp\utility\outline::outlineenableforall(agent, var_4430b08d5a2d47bf, "<dev string:x7fd>");
                    ...
                    } else if (poiinfo.var_6ad2d5385a612cd5[poiname].numagents != function_abbd4595d76ccc5e(poiname, "<dev string:x5cb>")) {
                        if (poiinfo.var_6ad2d5385a612cd5[poiname].numagents < function_abbd4595d76ccc5e(poiname, "<dev string:x5cb>")) {
                            foreach (agent in function_7e3f22e620f3f71e(poiname, "<dev string:x5cb>")) {
                                if (isalive(agent) && (!isdefined(agent.outlined) || !agent.outlined)) {
                                    ...
                                    if (isdefined(agent.category) && isdefined(var_a2d7918a1c23c968[agent.category])) {
                                        ...
                                        assertmsg("<dev string:x7b1>" + poiname + "<dev string:x80a>" + agent.category);
                                    }
                                    id = scripts\mp\utility\outline::outlineenableforall(agent, var_4430b08d5a2d47bf, "<dev string:x7fd>");
                                    if (!isdefined(poiinfo.var_6ad2d5385a612cd5[poiname].agents[id])) {
                                        poiinfo.var_6ad2d5385a612cd5[poiname].agents[id] = agent;
                        ...
                        poiinfo.var_6ad2d5385a612cd5[poiname].numagents = function_abbd4595d76ccc5e(poiname, "<dev string:x5cb>");
                    }
                }
        ...
        if (!aiinfo.disabledoutlines) {
            ...
            foreach (agent in level.agentarray) {
                if (isalive(agent)) {
                    ...
                    id = scripts\mp\utility\outline::outlineenableforall(agent, "<dev string:x825>", "<dev string:x7fd>");
    ...
    function function_f44f49a345c4a1f0(var_ae626a6e4fde83b2) {
        if (getdvarint(@"hash_eea0b8db6857e8e1", 0) == 1) {
            if (var_ae626a6e4fde83b2.var_4ed3980e80a4c5c9) {
                ...
                foreach (agent in function_7eb04ca16d045775("<dev string:x5e1>")) {
                    if (isalive(agent) && distance(level.player.origin, agent.origin) < getdvarint(@"hash_354e12ea3dd218ff", 5000)) {
                        id = scripts\mp\utility\outline::outlineenableforall(agent, "<dev string:x840>", "<dev string:x7fd>");
        ...
        if (getdvarint(@"hash_98991913f1b99ae3", 0) == 1) {
            if (var_ae626a6e4fde83b2.enabledenemies) {
                ...
                foreach (agent in function_7eb04ca16d045775("<dev string:x5cb>")) {
                    if (isalive(agent) && agent.category != "<dev string:x5e1>" && distance(level.player.origin, agent.origin) < getdvarint(@"hash_354e12ea3dd218ff", 5000)) {
                        id = scripts\mp\utility\outline::outlineenableforall(agent, "<dev string:x85a>", "<dev string:x7fd>");
                        if (!isdefined(var_ae626a6e4fde83b2.var_69a1fe96c22ba481[id])) {
                            var_ae626a6e4fde83b2.var_69a1fe96c22ba481[id] = agent;
                        }
                    }
    ...
    function function_8366a665eecd13aa() {
        ...
        foreach (poiname in level.poi_names) {
            ...
            command = "<dev string:x87d>" + poiname + "<dev string:x8ab>" + poiname + "<dev string:x8be>";
            adddebugcommand(command);
            poiinfo.var_6ad2d5385a612cd5[poiname] = spawnstruct();
            poiinfo.var_6ad2d5385a612cd5[poiname].outlined = 0;
            poiinfo.var_6ad2d5385a612cd5[poiname].agents = [];
            poiinfo.var_6ad2d5385a612cd5[poiname].numagents = function_abbd4595d76ccc5e(poiname, "<dev string:x5cb>");
            setdvarifuninitialized(hashcat(@"hash_831b14ba4dbdd316", poiname, "<dev string:x758>"), 0);
            wait 0.1;
            command = "<dev string:x8ca>" + poiname + "<dev string:x8ab>" + poiname + "<dev string:x907>";
            adddebugcommand(command);
            wait 0.1;
            setdvarifuninitialized(hashcat(@"hash_831b14ba4dbdd316", poiname, "<dev string:x91b>"), 0);
            command = "<dev string:x92a>" + poiname + "<dev string:x8ab>" + poiname + "<dev string:x965>";
            adddebugcommand(command);
            wait 0.1;
            setdvarifuninitialized(hashcat(@"hash_831b14ba4dbdd316", poiname, "<dev string:x977>"), 0);
            command = "<dev string:x984>" + poiname + "<dev string:x8ab>" + poiname + "<dev string:x9c0>";
            adddebugcommand(command);
            wait 0.1;
            setdvarifuninitialized(hashcat(@"hash_831b14ba4dbdd316", poiname, "<dev string:x9d3>"), 0);
            command = "<dev string:x9e1>" + poiname + "<dev string:x8ab>" + poiname + "<dev string:xa21>";
            adddebugcommand(command);
            wait 0.1;
            setdvarifuninitialized(hashcat(@"hash_831b14ba4dbdd316", poiname, "<dev string:xa31>"), 0);
            wait 0.2;
        }
    ...
    function function_576ed049f93d9496() {
        ...
        while (true) {
            if (getdvarint(@"hash_7e32df0ad3c385c1", 0) == 1) {
                ...
                foreach (poiname, poi in level.poi) {
                    setdevdvar(hashcat(@"hash_831b14ba4dbdd316", poiname, "<dev string:x91b>"), 0);
                }
            }
            var_5a77a5f00881f00c = getdvarint(@"hash_7f1d33bb4719a3c2", 0);
            if (var_5a77a5f00881f00c == 1) {
                if (!istrue(level.var_289df80e1ded586f)) {
                    printtoscreen2d(1000, 100, "<dev string:xa3c>", (0, 0, 1), 2.5);
                } else {
                    topxpos = 50;
                    printtoscreen2d(topxpos, 54, "<dev string:xa4c>" + function_e884d14c5b07b811(), (0, 0, 1), 2.5);
                    topxpos += 250;
                    printtoscreen2d(topxpos, 50, "<dev string:xa54>" + function_e8c0ac958d093ec2() + "<dev string:xa5e>" + level.var_41670c1c65f3d3cf.maxagents, (0, 0, 1), 1.5);
                    topxpos += 250;
                    printtoscreen2d(topxpos, 50, "<dev string:xa60>" + function_1c0a768a2d940491(), (0, 0, 1), 1.5);
                    topxpos += 200;
                    printtoscreen2d(topxpos, 50, "<dev string:xa6a>" + function_9368fb9261e4cd0a("<dev string:xa4>"), (0, 0, 1), 1.5);
                    topxpos += 200;
                    printtoscreen2d(topxpos, 50, "<dev string:xa74>" + function_9368fb9261e4cd0a("<dev string:x6a4>"), (0, 0, 1), 1.5);
                    topxpos += 200;
                    printtoscreen2d(topxpos, 50, "<dev string:xa80>" + level.var_41670c1c65f3d3cf.agentdeaths, (0, 0, 1), 1.5);
                    if (function_47d356083884f913()) {
                        printtoscreen2d(topxpos + 300, 50, "<dev string:xa8f>" + level.poi_names.size, (0, 0, 1), 1.5);
                        numlines = 0;
                        x = 50;
                        y = 90;
                        foreach (poiname, poi in level.poi) {
                        ...
                        pos = 160;
                        pos += 10;
                        printtoscreen2d(x, pos, "<dev string:xa96>", (0, 0, 1), 1);
                        pos += 12;
                        printtoscreen2d(x, pos, "<dev string:xab1>", (0, 0, 1), 1);
                        pos += 12;
                        printtoscreen2d(x, pos, "<dev string:xa96>", (0, 0, 1), 1);
                        pos += 16;
                        foreach (key in function_d20fe6bad41c065c()) {
                            if (key != "<dev string:x5cb>") {
                                firststring = key + "<dev string:x428>";
                                secondstring = function_718d435f9750c1b5(key);
                                thirdstring = "<dev string:xa5e>" + function_9a83377c98bce82a(key);
                        ...
                        pos += 10;
                        printtoscreen2d(x, pos, "<dev string:xac1>" + level.var_41670c1c65f3d3cf.agentdeaths, (0, 0, 1), 1);
                        pos += 12;
                        printtoscreen2d(x, pos, "<dev string:xa96>", (0, 0, 1), 1);
                        pos += 12;
                        printtoscreen2d(x, pos, "<dev string:xad0>" + function_9a83377c98bce82a("<dev string:x5cb>") + "<dev string:xadc>" + function_3813364e2323b789(), (0, 0, 1), 1);
                        pos += 12;
                        printtoscreen2d(x, pos, "<dev string:xa96>", (0, 0, 1), 1);
                    }
                }
            ...
            if (var_5a77a5f00881f00c == 2) {
                printtoscreen2d(100, 54, "<dev string:xa4c>" + function_e884d14c5b07b811() + "<dev string:xadc>" + level.var_41670c1c65f3d3cf.maxagents, (0, 0, 1), 2.5);
                printtoscreen2d(450, 50, "<dev string:xa6a>" + function_9368fb9261e4cd0a("<dev string:xa4>"), (0, 0, 1), 1.5);
                printtoscreen2d(750, 50, "<dev string:xa74>" + function_9368fb9261e4cd0a("<dev string:x6a4>"), (0, 0, 1), 1.5);
                printtoscreen2d(1050, 50, "<dev string:xa80>" + level.var_41670c1c65f3d3cf.agentdeaths, (0, 0, 1), 1.5);
                if (function_47d356083884f913()) {
                    printtoscreen2d(1300, 50, "<dev string:xa8f>" + level.poi_names.size, (0, 0, 1), 1.5);
                    x = 50;
                    y = 90;
                    foreach (poiname, poi in level.poi) {
                        if (array_contains(level.var_ab20b3a256911579, poiname)) {
            ...
            if (var_5a77a5f00881f00c == 5) {
                if (!istrue(level.var_289df80e1ded586f)) {
                    printtoscreen2d(750, 100, "<dev string:xae0>", (0, 0, 1), 2.5);
                    ...
                    if (function_47d356083884f913()) {
                        ...
                        foreach (poiname, poi in level.poi) {
                            ...
                            pos += 12;
                            printtoscreen2d(x, pos, "<dev string:x5a0>", (0, 0, 1), 1);
                            pos += 20;
                            color = (0, 1, 0);
                            ...
                            printtoscreen2d(x, pos, "<dev string:xb08>" + level.startracker[poiname].starlevel, color, 1.5);
                            pos += 12;
                            printtoscreen2d(x, pos, "<dev string:x5a0>", (0, 0, 1), 1);
                            pos += 16;
                            printtoscreen2d(x, pos, "<dev string:xb15>" + level.startracker[poiname].starmeter, (0, 0, 1), 1);
                            pos += 20;
                            printtoscreen2d(x, pos, "<dev string:xb22>" + level.startracker[poiname].var_924d5d49fde54cdd, (0, 0, 1), 1);
                            pos += 20;
                            printtoscreen2d(x, pos, "<dev string:xb35>", (0, 0, 1), 1);
                            pos += 20;
                            printtoscreen2d(x, pos, "<dev string:xb4c>" + level.startracker[poiname].var_19d6896c9e881cc4, (0, 0, 1), 1);
                            pos += 20;
                            ...
                            printtoscreen2d(x, pos, "<dev string:xb5f>" + requirements, (0, 0, 1), 1);
                            pos += 20;
                            printtoscreen2d(x, pos, "<dev string:xb35>", (0, 0, 1), 1);
                            pos += 20;
                            printtoscreen2d(x, pos, "<dev string:xb74>" + level.startracker[poiname].var_38951249a8cf8968, (0, 0, 1), 1);
                            pos += 20;
                            printtoscreen2d(x, pos, "<dev string:xb7b>" + level.startracker[poiname].var_fe385543116077b5, (0, 0, 1), 1);
                            pos += 20;
                            printtoscreen2d(x, pos, "<dev string:xb89>" + level.startracker[poiname].var_55cf9e4f74d2f4c2, (0, 0, 1), 1);
                            pos += 20;
                            printtoscreen2d(x, pos, "<dev string:xb92>" + level.startracker[poiname].var_356bde2b53efa8cf, (0, 0, 1), 1);
                            x += 250;
                            if (x > 1750) {
                                x = startx;
                                starty += 325;
                        ...
                        printtoscreen2d(400, 50, "<dev string:xb08>" + level.startracker.starlevel, (1, 1, 1), 1);
                        printtoscreen2d(400, 70, "<dev string:xb15>" + level.startracker.starmeter, (1, 1, 1), 1);
                        printtoscreen2d(400, 90, "<dev string:xb22>" + level.startracker.var_924d5d49fde54cdd, (1, 1, 1), 1);
                        printtoscreen2d(400, 110, "<dev string:xb35>", (1, 1, 1), 1);
                        printtoscreen2d(400, 130, "<dev string:xb4c>" + level.startracker.var_19d6896c9e881cc4, (1, 1, 1), 1);
                        printtoscreen2d(400, 150, "<dev string:xb5f>" + level.var_1a6233bc0d61faf.reqreinforcements[level.startracker.starlevel] - level.startracker.var_a93671354b676c18, (1, 1, 1), 1);
                        printtoscreen2d(400, 170, "<dev string:xb35>", (0, 0, 1), 1);
                        printtoscreen2d(400, 190, "<dev string:xb74>" + level.startracker.var_38951249a8cf8968, (0, 0, 1), 1);
                        printtoscreen2d(400, 210, "<dev string:xb7b>" + level.startracker.var_fe385543116077b5, (0, 0, 1), 1);
                        printtoscreen2d(400, 230, "<dev string:xb89>" + level.startracker.var_55cf9e4f74d2f4c2, (0, 0, 1), 1);
                        printtoscreen2d(400, 250, "<dev string:xb92>" + level.startracker.var_356bde2b53efa8cf, (0, 0, 1), 1);
                    }
                } else {
                    printtoscreen2d(750, 100, "<dev string:xb99>", (0, 0, 1), 2.5);
                }
            }
            if (getdvarint(@"hash_959247ebc7eac6b5", 0) == 1) {
                println("<dev string:xbb0>");
                println("<dev string:xbd6>");
                println("<dev string:xbb0>");
                if (!function_47d356083884f913()) {
                    println("<dev string:xbf4>" + function_9a83377c98bce82a("<dev string:x5cb>") + "<dev string:xadc>" + level.var_41670c1c65f3d3cf.maxagents);
                    println("<dev string:xc02>" + function_9a83377c98bce82a("<dev string:x5e1>"));
                } else {
                    println("<dev string:xbf4>" + function_9a83377c98bce82a("<dev string:x5cb>") + "<dev string:xadc>" + level.var_41670c1c65f3d3cf.maxagents);
                    civmax = getdvarint(@"hash_bd4798a9b7d01479", 8) * level.poi.size;
                    println("<dev string:xc02>" + function_9a83377c98bce82a("<dev string:x5e1>") + "<dev string:xadc>" + civmax);
                }
                println("<dev string:xbb0>");
                println("<dev string:xc10>");
                println("<dev string:xbb0>");
                ...
                if (function_47d356083884f913()) {
                    ...
                    foreach (poiname, poi in level.poi) {
                        ...
                        if (isdefined(level.var_41670c1c65f3d3cf.poi[poiname].var_8bcd79921ba8147e) && isdefined(level.var_41670c1c65f3d3cf.poi[poiname].agentdeaths)) {
                            printtoscreen2d(x, pos, "<dev string:xc2c>" + level.var_41670c1c65f3d3cf.poi[poiname].var_8bcd79921ba8147e - level.var_41670c1c65f3d3cf.poi[poiname].agentdeaths, (0, 0, 1), 1.2);
                        } else {
                            printtoscreen2d(x, pos, "<dev string:xc54>", (0, 0, 1), 1.2);
                        }
                        pos += 12;
                        printtoscreen2d(x, pos, "<dev string:xc7f>", (0, 0, 1), 1);
                        pos += 20;
                        if (!isdefined(level.var_41670c1c65f3d3cf.poi[poiname].var_a87122636ff072d3)) {
                            text = "<dev string:xc94>";
                        } else {
                            text = level.var_41670c1c65f3d3cf.poi[poiname].var_a87122636ff072d3;
                        }
                        printtoscreen2d(x, pos, text, (0, 0, 1), 1);
                        pos += 25;
                        printtoscreen2d(x, pos, "<dev string:xcae>", (0, 0, 1), 1.2);
                        pos += 12;
                        printtoscreen2d(x, pos, "<dev string:xc7f>", (0, 0, 1), 1);
                        pos += 20;
                        reinforcementstring = "<dev string:x284>";
                        if (!isdefined(level.var_41670c1c65f3d3cf.poi[poiname].reinforcementqueue) || level.var_41670c1c65f3d3cf.poi[poiname].reinforcementqueue.size == 0) {
                            reinforcementstring = "<dev string:xcc2>";
                        } else {
                            foreach (numagents in level.var_41670c1c65f3d3cf.poi[poiname].reinforcementqueue) {
                                reinforcementstring = reinforcementstring + "<dev string:xcce>" + numagents;
                            }
                        }
                    ...
                    pos = 50;
                    printtoscreen2d(700, pos, "<dev string:xcd0>", (1, 1, 1), 1);
                    pos += 20;
                    printtoscreen2d(700, pos, "<dev string:xcde>", (1, 1, 1), 1);
                    pos += 20;
                    printtoscreen2d(700, pos, level.var_a87122636ff072d3, (1, 1, 1), 1);
                    pos += 40;
                    printtoscreen2d(700, pos, "<dev string:xcae>", (1, 1, 1), 1);
                    pos += 20;
                    printtoscreen2d(700, pos, "<dev string:xc7f>", (1, 1, 1), 1);
                    pos += 20;
                    reinforcementstring = "<dev string:x284>";
                    if (level.var_41670c1c65f3d3cf.reinforcementqueue.size == 0) {
                        reinforcementstring = "<dev string:xcc2>";
    ...
    function function_491f405f5622af52(poiname, x, y) {
        ...
        pos += 10;
        printtoscreen2d(x, pos, "<dev string:xa96>", colorbody, 1);
        pos += 12;
        ...
        foreach (key in function_d7df76a9938f5871(poiname)) {
            if (key != "<dev string:x5cb>") {
                ...
                thirdstring = "<dev string:xa5e>" + function_abbd4595d76ccc5e(poiname, key);
                printtoscreen2d(x, pos, firststring, (0, 0, 1), 1);
                tempx = x + 150;
                printtoscreen2d(tempx, pos, secondstring, (0, 1, 0), 1);
                tempx += "<dev string:x284>" + secondstring.size * 10;
                printtoscreen2d(tempx, pos, thirdstring, (0, 0, 1), 1);
                pos += 20;
                numlines++;
            }
        ...
        pos += 10;
        printtoscreen2d(x, pos, "<dev string:xac1>" + level.var_41670c1c65f3d3cf.poi[poiname].agentdeaths, colorbody, 1);
        pos += 12;
        printtoscreen2d(x, pos, "<dev string:xa96>", colorbody, 1);
        pos += 12;
        printtoscreen2d(x, pos, "<dev string:xad0>" + function_abbd4595d76ccc5e(poiname, "<dev string:x5cb>"), colorbody, 1);
        pos += 12;
        printtoscreen2d(x, pos, "<dev string:xa96>", colorbody, 1);
        numlines += 4;
        return numlines;
    ...
    function function_6fb8f59559dfa4a7(poiname, x, y) {
        ...
        printtoscreen2d(x, pos, "<dev string:xa96>", colorbody, 1);
        pos += 16;
        foreach (subarea in poi["<dev string:xced>"]) {
            color = colorbody;
            extratext = "<dev string:x284>";
            if (istrue(subarea.isshutdown)) {
                color = (1, 0, 0);
                extratext = "<dev string:xcf6>";
            }
            printtoscreen2d(x, pos, subarea.var_71ad22c5d093d90b + "<dev string:x428>" + subarea.var_3ebb6024e3f220ca.size + "<dev string:xcce>" + extratext, colorbody, 1);
            pos += 20;
        }
        pos += 12;
        printtoscreen2d(x, pos, "<dev string:xa4c>" + function_abbd4595d76ccc5e(poiname, "<dev string:x5cb>"), colorbody, 1);
        pos += 12;
        printtoscreen2d(x, pos, "<dev string:xa96>", colorbody, 1);
    }
        ...
        while (true) {
                ...
                if (istrue(level.var_289df80e1ded586f)) {
                    ...
                    if (scripts\cp_mp\utility\game_utility::function_42e2dcfd4571b89b()) {
                        if (isdefined(level.var_4b195d3dd0024b9c)) {
                            ...
                            team = "<dev string:xcff>";
                        }
                    } else {
                        team = scripts\mp\utility\teams::getenemyteams(player.team)[0];
                    }
                    if (isdefined(player)) {
                        level thread function_27d0336b6b9b60c("<dev string:xd18>", player.origin, team, player);
                    }
                }
            ...
            if (getdvarint(@"hash_3812148f43182b8", 0) > 0) {
                if (istrue(level.var_289df80e1ded586f)) {
                    player = level.players[0];
                    if (isdefined(player)) {
                        level thread function_27d0336b6b9b60c("<dev string:xd18>", player.origin, player.team);
                    }
                }
            ...
            if (getdvarint(@"hash_56e9c6adae23f12b", 0) > 0) {
                if (istrue(level.var_289df80e1ded586f)) {
                    ...
                    if (isdefined(player)) {
                        level thread function_27d0336b6b9b60c("<dev string:xd1d>", player.origin, team, player);
                    }
                }
            ...
            if (getdvarint(@"hash_e98cb58666dc372d", 0) > 0) {
                if (istrue(level.var_289df80e1ded586f)) {
                    player = level.players[0];
                    if (isdefined(player)) {
                        level thread function_27d0336b6b9b60c("<dev string:xd1d>", player.origin, player.team);
                    }
                }
            ...
            if (getdvarint(@"hash_ab9e351e7bdd4002", 0) > 0) {
                if (istrue(level.var_289df80e1ded586f)) {
                    ...
                    if (isdefined(player)) {
                        ...
                        level thread function_27d0336b6b9b60c("<dev string:xd24>", origin, team);
                    }
                }
            ...
            if (getdvarint(@"hash_534dfd9d53977a3a", 0) > 0) {
                if (istrue(level.var_289df80e1ded586f)) {
                    ...
                    if (isdefined(player)) {
                        origin = function_61cbc488b27a6e61(player.origin);
                        level thread function_27d0336b6b9b60c("<dev string:xd24>", origin, player.team);
                    }
                }
            ...
            if (getdvarint(@"hash_249d0bd1bced7236", 0) > 0) {
                if (istrue(level.var_289df80e1ded586f)) {
                    ...
                    if (isdefined(player)) {
                        origin = function_61cbc488b27a6e61(player.origin);
                        level thread function_27d0336b6b9b60c("<dev string:xd2f>", origin, team, player);
                    }
                }
            ...
            if (getdvarint(@"hash_88ae422170005010", 0) > 0) {
                if (istrue(level.var_289df80e1ded586f)) {
                    ...
                    if (isdefined(player)) {
                        origin = function_61cbc488b27a6e61(player.origin);
                        level thread namespace_bfef6903bca5845d::function_77acc10c4823dd8a(2, origin, "<dev string:x57b>", "<dev string:x6a4>", "<dev string:x58c>", undefined, player.team);
                    }
                }
            ...
            if (getdvarint(@"hash_7882eb2f0ed5ba94", 0) > 0) {
                if (istrue(level.var_289df80e1ded586f)) {
                    ...
                    if (isdefined(player)) {
                        origin = function_61cbc488b27a6e61(player.origin);
                        level thread namespace_bfef6903bca5845d::function_77acc10c4823dd8a(5, origin, "<dev string:x57b>", "<dev string:x6a4>", "<dev string:x58c>", undefined, team);
                    }
                }
            ...
            if (getdvarint(@"hash_dd00a99e0fc8f650", 0) > 0) {
                if (istrue(level.var_289df80e1ded586f)) {
                    ...
                    if (isdefined(player)) {
                        level thread function_27d0336b6b9b60c("<dev string:xd34>", player.origin, team, player);
                    }
                }
            ...
            if (getdvarint(@"hash_a880595a62e6c674", 0) > 0) {
                if (istrue(level.var_289df80e1ded586f)) {
                    player = level.players[0];
                    if (isdefined(player)) {
                        level thread function_27d0336b6b9b60c("<dev string:xd34>", player.origin, player.team, player);
                    }
                }
            ...
            if (getdvarint(@"hash_61fc4efede6cbbe2", 0) > 0) {
                if (istrue(level.var_289df80e1ded586f)) {
                    ...
                    if (isdefined(player)) {
                        level thread function_27d0336b6b9b60c("<dev string:xd3b>", player.origin, team, player);
                    }
                }
            ...
            if (getdvarint(@"hash_f823061619fb9d9a", 0) > 0) {
                if (istrue(level.var_289df80e1ded586f)) {
                    player = level.players[0];
                    if (isdefined(player)) {
                        level thread function_27d0336b6b9b60c("<dev string:xd3b>", player.origin, player.team, player);
                    }
                }
    ...
    function function_27d0336b6b9b60c(type, origin, team, player) {
        ...
        case #"hash_b111a4547c7d9125": 
            agents = function_2f3b04fc531b4115(4, origin, "<dev string:x57b>", "<dev string:x6a4>", "<dev string:x58c>", undefined, team, undefined, poiname, type, undefined, undefined, undefined, function_bed4c95709497a6c(origin, undefined, poiname));
            break;
        case #"hash_8d96201d150187de": 
            agents = function_2f3b04fc531b4115(4, origin, "<dev string:x57b>", "<dev string:x6a4>", "<dev string:x58c>", undefined, team, undefined, poiname, type);
            break;
        case #"hash_f2a2ef6a2b0d207c": 
            function_353fecd1549f5f42(origin, 2048, "<dev string:xcff>");
            break;
        case #"hash_c72bb484b209c08b": 
            agents = function_2f3b04fc531b4115(5, origin, "<dev string:x57b>", "<dev string:x6a4>", "<dev string:x58c>", undefined, team, undefined, poiname, type);
            break;
    ...
    function function_5397fa12cf5b1665() {
        ...
        while (true) {
            ...
            if (var_d45c6fe613356b23 == 1) {
                if (function_47d356083884f913()) {
                    foreach (poi in level.poi) {
                        poiname = level.poi["<dev string:xd44>"];
            ...
            if (var_d45c6fe613356b23 == 2) {
                if (function_47d356083884f913()) {
                    foreach (poiname, poi in level.poi) {
                        foreach (subarea in poi["<dev string:xced>"]) {
                            if (subarea.var_71ad22c5d093d90b != "<dev string:xd49>") {
                                origin = function_ab3b7f9663bc2e89(subarea);
                                if (!isdefined(origin)) {
                                    continue;
                                }
                                thread scripts\mp\utility\debug::drawsphere(origin, 512, 1, (0, 1, 0));
                                print3d(origin + (0, 0, 550), poiname + "<dev string:x428>" + subarea.var_71ad22c5d093d90b, (1, 1, 1), 1, 2, 20);
                            }
                        }
                    }
                }
                ...
                if (function_47d356083884f913()) {
                    foreach (poiname, poi in level.poi) {
                        foreach (subarea in poi["<dev string:xced>"]) {
                            if (subarea.var_71ad22c5d093d90b != "<dev string:xd49>") {
                                foreach (spawnPackage in subarea.var_d276b08c96430bfc) {
                                    function_87edf0678d74d59a(spawnPackage, "<dev string:xd50>", poiname, subarea.var_71ad22c5d093d90b);
                                }
                                foreach (spawnPackage in subarea.var_24a2cd19eed8f75d) {
                                    function_87edf0678d74d59a(spawnPackage, "<dev string:xd59>", poiname, subarea.var_71ad22c5d093d90b);
                                }
                                continue;
                            }
                            foreach (spawnPackage in subarea.var_d276b08c96430bfc) {
            ...
            if (var_d45c6fe613356b23 == 4) {
                if (function_47d356083884f913()) {
                    foreach (poiname, poi in level.poi) {
                        foreach (node in poi["<dev string:xd62>"]) {
                            size = 32;
                            color = (1, 0, 0);
            ...
            if (var_d45c6fe613356b23 == 5) {
                if (function_47d356083884f913()) {
                    foreach (poiname, poi in level.poi) {
                        foreach (pathstruct in level.poi[poiname]["<dev string:xd72>"]) {
                            size = 32;
                            color = (1, 0, 0);
                            ...
                            for (i = 0; i < pathstruct.path.size; i++) {
                                ...
                                if (isdefined(node01.target)) {
                                    var_4ff83bffc51fbd1b = getstruct(node01.target, "<dev string:xd7e>");
                                }
            ...
            if (var_d45c6fe613356b23 == 6) {
                foreach (agent in level.agentarray) {
                    if (isalive(agent)) {
                        str = "<dev string:xd89>" + agent.agent_type;
                        if (isdefined(agent.var_80f4bde7090a4773) && agent.var_80f4bde7090a4773 == "<dev string:xd96>") {
                            str += "<dev string:xd9c>";
                        }
    ...
    function function_87edf0678d74d59a(spawnPackage, type, poiname, var_71ad22c5d093d90b) {
        color = undefined;
        if (type == "<dev string:xd50>") {
            color = (0, 1, 0);
        } else if (type == "<dev string:xd59>") {
            color = (0, 0, 1);
        } else {
            color = (1, 0, 0);
        }
    ...
    function function_6bbeb23006988aae() {
        ...
        for (i = 0; i < 20; i++) {
            ...
            for (j = 0; j < 20; j++) {
                ...
                ai_mp_requestspawnagent("<dev string:xda4>", safeorigin, undefined, "<dev string:x57b>", "<dev string:x6a4>", "<dev string:x58c>");
    ...
    function function_b510c28e573d0be6() {
        ...
        while (true) {
            foreach (player in level.players) {
                player setclientomnvar("<dev string:xdb5>", function_5cc0c507e92f7b47(player.closestpoi));
            }
            wait 1;
        }
    }
    ...
    function function_8b97c47b557d1c58() {
        ...
        while (true) {
            foreach (poiname, poi in level.poi) {
                if (getdvarint(hashcat(@"hash_831b14ba4dbdd316", poiname, "<dev string:x91b>"), 0) == 1) {
                    foreach (subarea in poi["<dev string:xced>"]) {
                        if (subarea.var_71ad22c5d093d90b != "<dev string:xd49>") {
                            foreach (spawnPackage in subarea.var_d276b08c96430bfc) {
                                function_87edf0678d74d59a(spawnPackage, "<dev string:xd50>", poiname, subarea.var_71ad22c5d093d90b);
    ...
    function function_9fae03fa905ef5ce() {
        ...
        while (true) {
            foreach (poiname, poi in level.poi) {
                if (getdvarint(hashcat(@"hash_831b14ba4dbdd316", poiname, "<dev string:x977>"), 0) == 1) {
                    foreach (node in level.poi[poiname]["<dev string:xd62>"]) {
                        size = 32;
                        color = (1, 0, 0);
                        if (istrue(node.var_1e9d8e53eeec48a)) {
                            size = 64;
    ...
    function function_8c74d71ffba1bda8() {
        ...
        while (true) {
            foreach (poiname, poi in level.poi) {
                if (getdvarint(hashcat(@"hash_831b14ba4dbdd316", poiname, "<dev string:x9d3>"), 0) == 1) {
                    foreach (pathstruct in level.poi[poiname]["<dev string:xd72>"]) {
                        size = 32;
                        color = (1, 0, 0);
                        if (istrue(pathstruct.var_1e9d8e53eeec48a)) {
    ...
    function function_389b1801f508c3f0() {
        ...
        while (true) {
            foreach (poiname, poi in level.poi) {
                if (getdvarint(hashcat(@"hash_831b14ba4dbdd316", poiname, "<dev string:xa31>"), 0) == 1) {
                    foreach (agent in function_7e3f22e620f3f71e(poiname, "<dev string:x5cb>")) {
                        if (isalive(agent)) {
                            str = "<dev string:xd89>" + agent.agent_type;
                            if (isdefined(agent.var_80f4bde7090a4773) && agent.var_80f4bde7090a4773 == "<dev string:xd96>") {
    ...
    function function_862dc7729fb4914b(bossname) {
        ...
        boss = ai_mp_requestspawnagent(aitype, point, level.players[0].angles, "<dev string:x2c4>", "<dev string:x5cb>", undefined, undefined, undefined, undefined, undefined, 0);
    }
