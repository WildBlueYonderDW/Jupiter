...
/#
    ...
    function private function_8f2b1c474a144a75() {
        ...
        waitframe();
        adddebugcommand("<dev string:x331>");
        waitframe();
        adddebugcommand("<dev string:x38c>");
        waitframe();
        test_names = [["<dev string:x3e3>", "<dev string:x3ea>", "<dev string:x3fa>"], ["<dev string:x3e3>", "<dev string:x401>", "<dev string:x40e>"], ["<dev string:x3e3>", "<dev string:x41d>", "<dev string:x42a>"], ["<dev string:x3e3>", "<dev string:x438>", "<dev string:x442>"], ["<dev string:x3e3>", "<dev string:x458>", "<dev string:x45c>"], ["<dev string:x467>", "<dev string:x3ea>", "<dev string:x473>"], ["<dev string:x467>", "<dev string:x401>", "<dev string:x47f>"], ["<dev string:x467>", "<dev string:x41d>", "<dev string:x493>"], ["<dev string:x467>", "<dev string:x438>", "<dev string:x4a6>"], ["<dev string:x467>", "<dev string:x458>", "<dev string:x4c1>"], ["<dev string:x4d1>", "<dev string:x3ea>", "<dev string:x4d7>"], ["<dev string:x4d1>", "<dev string:x401>", "<dev string:x4dd>"], ["<dev string:x4d1>", "<dev string:x41d>", "<dev string:x4eb>"], ["<dev string:x4d1>", "<dev string:x438>", "<dev string:x4f8>"], ["<dev string:x4d1>", "<dev string:x458>", "<dev string:x50d>"], ["<dev string:x458>", "<dev string:x3ea>", "<dev string:x517>"], ["<dev string:x458>", "<dev string:x401>", "<dev string:x530>"], ["<dev string:x458>", "<dev string:x41d>", "<dev string:x551>"], ["<dev string:x458>", "<dev string:x438>", "<dev string:x571>"], ["<dev string:x458>", "<dev string:x458>", "<dev string:x599>"]];
        foreach (test_name in test_names) {
            commandstring = "<dev string:x5b6>" + test_name[0] + "<dev string:x5f0>" + test_name[1] + "<dev string:x5f4>" + test_name[2] + "<dev string:x625>";
        ...
        while (true) {
            ...
            bundlename = getdvar(@"hash_338fd6962a58ef94", "<dev string:x628>");
            if (isdefined(bundlename) && bundlename != "<dev string:x628>" && isalive(level.players[0])) {
            ...
            setdvar(@"hash_338fd6962a58ef94", "<dev string:x628>");
            bundlename = getdvar(@"hash_92614d6e09af2f0", "<dev string:x628>");
            if (isdefined(bundlename) && bundlename != "<dev string:x628>" && isalive(level.players[0])) {
                fullbundlename = hashcat(%"ai_flood_fill_encounter:", bundlename);
                requestid = spawn_request(fullbundlename, level.players[0].origin, 1000, 1, 1);
                activerequests = array_add(activerequests, requestid);
            }
            setdvar(@"hash_92614d6e09af2f0", "<dev string:x628>");
            tagname = getdvar(@"hash_cb77d3c82e353f1d", "<dev string:x628>");
            if (isdefined(tagname) && tagname != "<dev string:x628>") {
                function_9b8829ab4092a7d7(tagname, 1);
                setdvar(@"hash_cb77d3c82e353f1d", "<dev string:x628>");
            }
            tagname = getdvar(@"hash_648b265962adac34", "<dev string:x628>");
            if (isdefined(tagname) && tagname != "<dev string:x628>") {
                function_9b8829ab4092a7d7(tagname, 0);
                setdvar(@"hash_648b265962adac34", "<dev string:x628>");
            }
            if (getdvarint(@"hash_7560a9c3d8fb8030", 0) == 1) {
                if (isdefined(level.players[0])) {
                    function_606642b946a01237("<dev string:x629>", level.players[0].origin, 2000);
                }
                setdvar(@"hash_7560a9c3d8fb8030", 0);
            }
            if (getdvarint(@"hash_a9bfe570a4470e77", 0) == 1) {
                if (isdefined(level.players[0])) {
                    function_c7311cb3f768f21e("<dev string:x629>");
                }
            ...
            if (getdvarint(@"hash_b887180c55479401", 0) == 1) {
                ...
                foreach (encounter in encounters) {
                    ...
                    if (data.status != 1) {
                        ...
                        iprintlnbold("<dev string:x638>" + encounter + "<dev string:x64e>");
                    }
                }
                if (!converted) {
                    iprintlnbold("<dev string:x65b>");
                }
            ...
            settag = getdvar(@"hash_6c37cbeecb7d7215", "<dev string:x628>");
            if (isdefined(settag) && settag != "<dev string:x628>") {
                subzone = function_2ee25a0fa15c04ce(level.players[0].origin);
                if (isdefined(subzone)) {
                    function_811e2ea8528614ba(subzone.zoneindex, subzone.subzoneindex, settag, 1);
                }
                setdvar(@"hash_6c37cbeecb7d7215", "<dev string:x628>");
            }
            cleartag = getdvar(@"hash_226b7063f48ab77a", "<dev string:x628>");
            if (isdefined(cleartag) && cleartag != "<dev string:x628>") {
                subzone = function_2ee25a0fa15c04ce(level.players[0].origin);
                if (isdefined(subzone)) {
                    function_811e2ea8528614ba(subzone.zoneindex, subzone.subzoneindex, cleartag, 0);
                }
                setdvar(@"hash_226b7063f48ab77a", "<dev string:x628>");
            }
            test_name = getdvar(@"hash_25688c988df289c3", "<dev string:x628>");
            if (test_name != "<dev string:x628>") {
                thread function_697246e491b82b(test_name);
                setdvar(@"hash_25688c988df289c3", "<dev string:x628>");
            }
            var_90284334e00894ac = getdvar(@"hash_76a02dcfeaf85e8a", "<dev string:x628>");
            if (var_90284334e00894ac != "<dev string:x628>") {
                thread function_b6206c1c64860991(var_90284334e00894ac);
                setdvar(@"hash_76a02dcfeaf85e8a", "<dev string:x628>");
            }
            if (getdvarint(@"hash_b8cb86dbb04715e2", 0) == 1) {
                function_9b8829ab4092a7d7("<dev string:x680>", 1);
                function_9b8829ab4092a7d7("<dev string:x692>", 0);
                setdvar(@"hash_19f0eb1fd6a2f87d", 1);
                setdvar(@"hash_b8cb86dbb04715e2", 0);
            }
            if (getdvarint(@"hash_48e36b0fa33ce48f", 0) == 1) {
                function_9b8829ab4092a7d7("<dev string:x680>", 0);
                function_9b8829ab4092a7d7("<dev string:x692>", 1);
                setdvar(@"hash_19f0eb1fd6a2f87d", 1);
    ...
    function private function_c5b8afd6e0f364ee(var_2cd4ce4a1e0c3ad9, dvarname) {
        ...
        foreach (bundlename in bundlenames) {
            ...
            array = strtok(bundlenamestring, "<dev string:x6a3>");
            if (!isdefined(array) || !isdefined(array[1])) {
                continue;
            }
            cmdstring = "<dev string:x6a5>" + array[1] + "<dev string:x6ce>" + dvarname + "<dev string:x6d6>" + array[1] + "<dev string:x625>";
...
function private _setgoalpos(origin, goalradius, var_1b6352ceb9bbc1d, var_ae3b556b0d3cd2a7) {
    ...
    if (!isdefined(safeorigin)) {
        println("<dev string:x6d8>" + origin);
        return;
    }
...
function private function_6710855bea599a1f(encounterradius) {
    ...
    while (true) {
        ...
        if (distancesquared(self.origin, spawnpoint) > maxdistancesqr) {
            /#
                function_b569203d69d8e9d9("<dev string:x717>" + self getentitynumber() + "<dev string:x72a>" + self.var_ad46aadd4e3290d7);
            #/
            function_cdc13899cf352216();
        }
    }
...
function private function_1a92c62e989f69c2(spawnedvehicle, goalpoint, pathindex, vehspeed) {
    ...
    if (getdvarint(@"hash_46c9c4287e87fcfd", 0)) {
        ...
        if (isdefined(goalvehiclenode)) {
            /#
                adddebugcommand("<dev string:x74b>");
...
/#
    ...
    function private function_b569203d69d8e9d9(text) {
        ...
        if (isdefined(shouldlog) && (isstring(shouldlog) && shouldlog == "<dev string:x794>" || !isstring(shouldlog) && shouldlog == 1)) {
            println("<dev string:x796>" + text);
        }
    }
    ...
    function private function_697246e491b82b(test_string) {
        level notify("<dev string:x7b1>");
        level endon("<dev string:x7b1>");
        test_params = strtok(test_string, "<dev string:x7c9>");
        test_types = [];
        should_move = 0;
        should_kill = 0;
        run_all = 0;
    ...
    function private function_455f6a83239d2c9f(test_name, should_move, should_kill) {
        ...
        var_4435be27f3e1110d += ter_op(should_move, "<dev string:x7de>", "<dev string:x7e6>");
        var_4435be27f3e1110d += ter_op(should_kill, "<dev string:x7f2>", "<dev string:x7fb>");
        iprintlnbold("<dev string:x807>" + var_4435be27f3e1110d);
        if (should_kill) {
            wait 240;
        } else {
            wait 60;
        ...
        iprintlnbold("<dev string:x80e>" + var_4435be27f3e1110d);
        waitframe();
    ...
    function private function_5ca76cbc5c022acd(test_name, should_move) {
        level notify("<dev string:x823>");
        level endon("<dev string:x823>");
    ...
    function private function_7a6ef66132ad3f88(var_7597ede1b3e40a8e, should_move) {
        ...
        var_7597ede1b3e40a8e = getclosestpointonnavmesh(var_7597ede1b3e40a8e, "<dev string:x842>", 0, 0, 1);
    ...
    function function_b6206c1c64860991(tablename) {
        ...
        for (rowindex = 3; rowindex < numrows; rowindex++) {
            ...
            case #"hash_cbfb23135a2db9a1": 
                ...
                level.var_23f1eadfcec14e18[entnum].startpos = getclosestpointonnavmesh(level.var_23f1eadfcec14e18[entnum].startpos, "<dev string:x842>", 0, 0, 1);
            ...
            case #"hash_82b3bcf2299864ac": 
                if (isdefined(level.var_23f1eadfcec14e18[entnum])) {
                    ...
                    level.var_23f1eadfcec14e18[entnum].endpos = getclosestpointonnavmesh((pos_x, pos_y, 0), "<dev string:x842>", 0, 0, 1);
                    level.var_23f1eadfcec14e18[entnum].starttime = gettime();
                }
                break;
            }
        }
        iprintlnbold("<dev string:x88b>");
    }
