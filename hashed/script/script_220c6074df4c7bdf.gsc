...
function evaluatescore(bot) {
    ...
    foreach (event in soundevents) {
        ...
        if (event.type == "footstep" || event.type == "footstep_walk" || event.type == "footstep_sprint") {
            eventscore = eventscore + function_9d1ab012058221bb(dist, self.constants.var_1c1e326edfaee326, self.constants.var_b17cbf80b52df82f);
        } else {
            eventscore = eventscore + function_9d1ab012058221bb(dist, self.constants.var_436444ebcb6bf7b3, self.constants.var_e8de868e20882c8a);
        }
        time = (var_7bf6ee12b10ec682 - event.time) / 1000;
        eventscore = eventscore + function_9d1ab012058221bb(time, self.constants.var_50cf5a797d61ae47, self.constants.var_f65cad93a3671678);
