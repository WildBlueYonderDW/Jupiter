    ...
    if (!var_91b2a18054e979ae) {
        ...
        if (isdefined(var_15309dae6e19a117) && var_15309dae6e19a117 > 0) {
            ...
            if (var_108eadcfc61719c) {
                ...
                /#
                    function_747e8968c9de65cd(player, broadcastinstance, 0, "<unknown string>");
                #/
            }
        }
        return;
...
function function_8b7e04a0cc14a82e(player, broadcastinstance) {
    if (!function_365e789cf7ee1a2f(player, broadcastinstance)) {
        /#
            function_747e8968c9de65cd(player, broadcastinstance, 2, "<unknown string>");
        #/
        return;
    }
...
function function_790e679b0f2d121e(var_9c34764b7d5ac247, broadcastinstance) {
    var_23d6245ff51f1599 = scripts/mp/utility/teams::function_5b7802e04b6d946(var_9c34764b7d5ac247);
...
function function_ab07dddb2e50773b(messagetext) {
    /#
        broadcastinstance = function_3186d88f9311acf4("<unknown string>");
...
function function_b3bcffc014571bbd(broadcastinstance) {
    /#
        var_be886913a2deb841 = "<unknown string>" + broadcastinstance function_54ad2295d6995862() + "<unknown string>" + broadcastinstance function_cf54c2c8650d9688();
...
function private function_83152f28715ba19f(player, broadcastinstance, broadcastcommand) {
    /#
        ...
        iprintln(function_fc8d2e5257bc9932() + "<unknown string>" + "<unknown string>" + player.guid + function_b3bcffc014571bbd(broadcastinstance) + function_8fcfb1771a833c28(broadcastcommand));
    #/
}
...
function private function_747e8968c9de65cd(player, broadcastinstance, broadcastcommand, details) {
    /#
        ...
        iprintln(function_fc8d2e5257bc9932() + "<unknown string>" + "<unknown string>" + player.guid + function_b3bcffc014571bbd(broadcastinstance) + function_8fcfb1771a833c28(broadcastcommand) + "<unknown string>" + details);
    #/
}
