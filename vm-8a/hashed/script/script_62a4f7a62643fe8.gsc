...
function init(var_736128b97152603e, no_timer, disable_ai) {
    ...
    assert(level.aether_storm.difficulty != "difficulty_undefined" && level.aether_storm.difficulty != "difficulty_easy", "AetherStormERROR: Difficulty must be one greater than the starting region, so it can't be REGION_DIFFICULTY_LVL1 (or REGION_DIFFICULTY_UNDEFINED).");
...
function start_expansion() {
    assert(isdefined(level.aether_storm.radiation), "AetherStormERROR: Must call aether_storm::init() before calling aether_storm::start_expansion()");
...
function private function_698d99f6cc939e34(heli) {
    if (expansion_started()) {
        ...
        if (!isdefined(var_af1e35abee93b10d)) {
            assertmsg("<dev string:x1c>" + function_3c8848a3a11b2553(%"hash_d03ed75a2d0089") + "<dev string:x65>");
            return;
        }
...
/#
    ...
    function private function_3a2ca530d33dbb7c() {
        level endon("<dev string:xd5>");
        devgui::function_6e7290c8ee4f558b("<dev string:xe0>");
        devgui::function_b23a59dfb4ca49a1("<dev string:xf1>", "<dev string:x119>", &function_9ecaf8b1fd98837e);
        devgui::function_b23a59dfb4ca49a1("<dev string:x166>", "<dev string:x18e>", &function_9ecaf8b1fd98837e);
        devgui::function_b23a59dfb4ca49a1("<dev string:x1db>", "<dev string:x201>", &function_9ecaf8b1fd98837e);
        devgui::function_b23a59dfb4ca49a1("<dev string:x24c>", "<dev string:x273>", &function_9ecaf8b1fd98837e);
        devgui::function_b23a59dfb4ca49a1("<dev string:x2bf>", "<dev string:x2e6>", &function_9ecaf8b1fd98837e);
        devgui::function_b23a59dfb4ca49a1("<dev string:x332>", "<dev string:x35a>", &function_9ecaf8b1fd98837e);
        devgui::function_b23a59dfb4ca49a1("<dev string:x3a7>", "<dev string:x3cf>", &function_9ecaf8b1fd98837e);
        devgui::function_b23a59dfb4ca49a1("<dev string:x41c>", "<dev string:x442>", &function_9ecaf8b1fd98837e);
        devgui::function_b23a59dfb4ca49a1("<dev string:x48d>", "<dev string:x4b4>", &function_9ecaf8b1fd98837e);
        devgui::function_b23a59dfb4ca49a1("<dev string:x500>", "<dev string:x527>", &function_9ecaf8b1fd98837e);
        devgui::function_b23a59dfb4ca49a1("<dev string:x573>", "<dev string:x59e>", &function_9ecaf8b1fd98837e);
        devgui::function_b23a59dfb4ca49a1("<dev string:x5ee>", "<dev string:x619>", &function_9ecaf8b1fd98837e);
        devgui::function_b23a59dfb4ca49a1("<dev string:x669>", "<dev string:x692>", &function_9ecaf8b1fd98837e);
        devgui::function_b23a59dfb4ca49a1("<dev string:x6e0>", "<dev string:x70a>", &function_9ecaf8b1fd98837e);
        devgui::function_b23a59dfb4ca49a1("<dev string:x759>", "<dev string:x783>", &function_9ecaf8b1fd98837e);
        devgui::function_b23a59dfb4ca49a1("<dev string:x7d2>", "<dev string:x7f3>", &function_9ecaf8b1fd98837e);
        devgui::function_b23a59dfb4ca49a1("<dev string:x840>", "<dev string:x863>", &function_9ecaf8b1fd98837e);
        devgui::function_b23a59dfb4ca49a1("<dev string:x8ab>", "<dev string:x8cd>", &function_9ecaf8b1fd98837e);
        devgui::function_b23a59dfb4ca49a1("<dev string:x914>", "<dev string:x936>", &function_9ecaf8b1fd98837e);
        devgui::function_b23a59dfb4ca49a1("<dev string:x97d>", "<dev string:x99f>", &function_9ecaf8b1fd98837e);
        devgui::function_b23a59dfb4ca49a1("<dev string:x9e6>", "<dev string:xa08>", &function_9ecaf8b1fd98837e);
        devgui::function_b2159fbbd7ac094e("<dev string:xa4e>", @"hash_c970fe9ef25b9a04");
        devgui::function_b23a59dfb4ca49a1("<dev string:xa5e>", "<dev string:xa6c>", &function_108d531ae15fcc87);
        devgui::function_b23a59dfb4ca49a1("<dev string:xa98>", "<dev string:xaa6>", &function_108d531ae15fcc87);
        devgui::function_b23a59dfb4ca49a1("<dev string:xad2>", "<dev string:xae0>", &function_108d531ae15fcc87);
        devgui::function_b23a59dfb4ca49a1("<dev string:xb0c>", "<dev string:xb1a>", &function_108d531ae15fcc87);
        devgui::function_b23a59dfb4ca49a1("<dev string:xb46>", "<dev string:xb54>", &function_108d531ae15fcc87);
        devgui::function_b23a59dfb4ca49a1("<dev string:xb80>", "<dev string:xb8f>", &function_108d531ae15fcc87);
        devgui::function_b2159fbbd7ac094e("<dev string:xbbc>", @"hash_e2d799f3be57182c");
        devgui::function_b2159fbbd7ac094e("<dev string:xbd4>", @"hash_15f2625555966cc5");
        devgui::function_b2159fbbd7ac094e("<dev string:xbec>", @"hash_427ed1f525368516");
        devgui::function_b2159fbbd7ac094e("<dev string:xc04>", @"hash_bd3120ea0bb6d372");
        devgui::function_b2159fbbd7ac094e("<dev string:xc1e>", @"hash_d6c6f72d0fa198e1");
        devgui::function_b2159fbbd7ac094e("<dev string:xc36>", @"hash_1ba1d0074052d695");
        devgui::function_b2159fbbd7ac094e("<dev string:xc4d>", @"hash_e240cfe5c52e96b9");
        devgui::function_b2159fbbd7ac094e("<dev string:xc65>", @"hash_e045509608ce5be3");
        ...
        while (true) {
            ...
            if (getdvarint(@"hash_15f2625555966cc5", 0)) {
                ...
                if (!isdefined(level.aether_storm.final_exfil)) {
                    println("<dev string:xd15>");
                    continue;
                }
                println("<dev string:xd46>" + level.aether_storm.final_exfil.origin);
                foreach (player in level.players) {
            ...
            if (getdvarint(@"hash_e240cfe5c52e96b9", 0)) {
                ...
                if (isdefined(trace["<dev string:xe51>"]) && isdefined(trace["<dev string:xe5a>"]) && trace["<dev string:xe5a>"] < 1) {
                    function_ea13f5b63d920d2f(trace["<dev string:xe51>"]);
                }
            }
            if (getdvarint(@"hash_e045509608ce5be3", 0)) {
                ...
                trace = trace::ray_trace(player geteye(), player geteye() + forward * 150000);
                if (isdefined(trace["<dev string:xe51>"]) && isdefined(trace["<dev string:xe5a>"]) && trace["<dev string:xe5a>"] < 1) {
                    namespace_6c8a837ec98fe0b8::update_objective_position(level.aether_storm.var_d5422504409025bf, trace["<dev string:xe51>"]);
                    namespace_6c8a837ec98fe0b8::objective_playermask_showtoall(level.aether_storm.var_d5422504409025bf);
                    level.aether_storm.var_bcf79bebe2066931.origin = trace["<dev string:xe51>"];
                    level.aether_storm.var_bcf79bebe2066931 setscriptablepartstate(#"strike", #"on");
                    level.aether_storm.var_bcf79bebe2066931 waittill("<dev string:xe63>");
                    namespace_6c8a837ec98fe0b8::objective_playermask_hidefromall(level.aether_storm.var_d5422504409025bf);
                }
            }
        }
    ...
    function private function_8c073da924b036f8() {
        ...
        for (timer = 0; true; timer = 0) {
            if (getdvarint(@"hash_e2d799f3be57182c", 0) && timer == 0) {
                print3d(level.aether_storm.final_exfil.origin + (0, 0, 300), "<dev string:xe8a>", (1, 1, 1), 1, 25, 5, 1);
    ...
    function function_108d531ae15fcc87(params) {
        ...
        if (istrue(level.aether_storm.final_exfil.var_1326008dc390c510) && isdefined(level.aether_storm.final_exfil.var_18da16a5ee3e8314) && isdefined(level.aether_storm.final_exfil.var_18da16a5ee3e8314.var_e3d833b1e5d30b03["<dev string:xea3>"])) {
            foreach (player in level.aether_storm.final_exfil.var_c9164736baf0694a) {
                if (isalive(player) && player.sessionstate == "<dev string:xeaf>") {
        ...
        var_49a313cc785a2410 -= getdvarint(@"hash_346baccb7a031727", 7);
        if (var_49a313cc785a2410 > 0) {
            thread function_fb316270994fd943("<dev string:xdbf>", var_49a313cc785a2410);
        } else {
            if (!istrue(level.aether_storm.final_exfil.var_1326008dc390c510) && !istrue(level.aether_storm.var_e42fed415ee7a4eb)) {
                thread function_4b40a61f53dd9122();
            }
    ...
    function function_9ecaf8b1fd98837e(params) {
        ...
        case #"hash_c579023a5e0694ad": 
            foreach (player in level.players) {
                player thread hud_message::showsplash("<dev string:xf76>", undefined, undefined, undefined, 1, "<dev string:xf95>");
            }
            break;
        case #"hash_c0f39f4bc1059d04": 
            foreach (player in level.players) {
                player thread hud_message::showsplash("<dev string:xfa8>", undefined, undefined, undefined, 1, "<dev string:xf95>");
            }
            break;
        }
        if (params[0] == "<dev string:xfc9>") {
            switch (level.aether_storm.announcement_handler) {
            case 0: 
                thread overlord::playconversation("<dev string:xff0>", level.players);
                break;
            case 1: 
                thread overlord::playconversation("<dev string:x1017>", level.players);
                break;
            case 2: 
                thread overlord::playconversation("<dev string:x103c>", level.players);
                break;
            case 3: 
                thread overlord::playconversation("<dev string:x1062>", level.players);
                break;
            }
            return;
        }
        if (params[0] == "<dev string:xeb7>") {
            switch (level.aether_storm.announcement_handler) {
            case 0: 
                thread overlord::playconversation("<dev string:xede>", level.players);
                break;
            case 1: 
                thread overlord::playconversation("<dev string:xf05>", level.players);
                break;
            case 2: 
                thread overlord::playconversation("<dev string:xf2a>", level.players);
                break;
            case 3: 
                thread overlord::playconversation("<dev string:xf50>", level.players);
                break;
            }
            return;
        }
        if (params[0] == "<dev string:x1088>") {
            switch (level.aether_storm.announcement_handler) {
            case 0: 
                thread overlord::playevent("<dev string:x10b2>", level.players);
                break;
            case 1: 
                thread overlord::playevent("<dev string:x10dc>", level.players);
                break;
            case 2: 
                thread overlord::playevent("<dev string:x1104>", level.players);
                break;
            case 3: 
                thread overlord::playevent("<dev string:x112d>", level.players);
                break;
            }
            return;
        }
        if (params[1] == "<dev string:x1156>") {
