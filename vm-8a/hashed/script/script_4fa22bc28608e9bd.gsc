...
/#
    ...
    function private function_cf5eaf96bd01b79a() {
        ...
        function_a9a864379a098ad6("<dev string:x36>", "<dev string:x41>", &function_4acca603a0ce23a6);
        function_a9a864379a098ad6("<dev string:x4c>", "<dev string:x57>", &function_db5535809b0dccc5);
        function_a9a864379a098ad6("<dev string:x62>", "<dev string:x78>", &function_e318de3b93fddd0d);
    ...
    function private function_4acca603a0ce23a6() {
        disciple = function_30dd4f3ef5f328ea(level.players[0].origin, undefined, undefined, "<dev string:x8c>");
    ...
    function private function_db5535809b0dccc5() {
        function_2fb888667001fc39("<dev string:xa4>", @"hash_bcd6dcf5babd2641");
    }
    ...
    function private function_701e81274adba94a(text, pos) {
        if (getdvarint(@"hash_bcd6dcf5babd2641", 0)) {
            ...
            print3d(pos, "<dev string:xb8>" + text, (1, 0, 0));
        }
    }
