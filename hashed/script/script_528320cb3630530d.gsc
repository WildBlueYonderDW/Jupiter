...
function escort_idle() {
    ...
    escortinteract = getstructarray(self.varianttag, "script_noteworthy");
...
function function_2674a21020618651() {
    ...
    self.vh_escort.e_start = namespace_5775ad2badedbcaa::register_interact(self.vh_escort.origin, 48, &escort_interact, "JUP_OB_OBJECTIVES/ESCORT_ZOMBIES_START_ACV");
...
function private function_fdda881efcfe245e() {
    ...
    if (isdefined(nd_current.script_label)) {
        crystals = getentitylessscriptablearray(nd_current.script_label, "targetname");
        crystal = crystals[0];
