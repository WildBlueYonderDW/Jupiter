...
// Size: 0x24
function init() {
    namespace_9c383b14c4908e46::function_8ece37593311858a(&playerconnectwatcher);
    register_end_game_string_index();
    function_abfba47378ec78af();
...
function endgame(winner, endReasonTextIndex) {
    ...
    foreach (player in level.players) {
        ...
        player thread namespace_d4aab8c9cb8ecb14::hide_all_revive_icons(player);
    ...
    setnojiptime(1);
    if (isdefined(level.var_51c1068f1991312e) && namespace_335a44243dec84f3::function_3f8b7ecacb8eb472(level.var_51c1068f1991312e)) {
        level.var_51c1068f1991312e.victim thread namespace_1b51be0488919ce5::playerkilled_killcam(level.var_51c1068f1991312e);
    ...
    case 1: 
        ...
        break;
    case 4: 
        namespace_5aac85eab99c40a::rankedmatchupdates("axis");
        break;
    default: 
        namespace_5aac85eab99c40a::rankedmatchupdates("axis");
        break;
    ...
    namespace_162cff1cf88b9bbf::function_ea9fc8f6656867d7();
    foreach (player in level.players) {
        ...
        if (isdefined(player.pers["prestige"]) && scripts\cp\utility::matchmakinggame()) {
            prestige = player namespace_5aac85eab99c40a::getprestigelevel();
    ...
    foreach (player in level.players) {
        if (isdefined(var_d6a0a72d985e3414)) {
            player thread [[ var_d6a0a72d985e3414 ]](endReasonTextIndex);
        }
    }
...
function function_2aa8a9f0bf64f8b9(waittill_notify) {
    ...
    while (true) {
        msg = self waittill("luinotifyserver");
...
// Size: 0xd1
function markgameended(result, var_3012abbf8b098d0f) {
    game["state"] = "postgame";
    level.gameended = 1;
    if (result == "SUCCESS") {
...
function cleanup_player_on_game_end(player) {
    ...
    player namespace_6c67e93a4c487d83::set_player_currency(0);
...
function restart_map(delay, result) {
    for (i = 0; i < level.players.size; i++) {
        ...
        if (isdefined(level.players[i].pers["prestige"]) && scripts\cp\utility::matchmakinggame()) {
            prestige = level.players[i] namespace_5aac85eab99c40a::getprestigelevel();
...
function kill_em_all() {
    foreach (character in level.characters) {
        ...
        character namespace_14d36171baccf528::despawnagent();
    }
}
...
function display_retry_dialog(winner, var_3558c2912c0fad64) {
    ...
    self endon("disconnect");
    namespace_d4aab8c9cb8ecb14::clear_last_stand_timer(self);
    wait 1;
...
function deathfx() {
    ...
    player thread deathfxoverlay("death_black", "ui_player_death_black_overlay", 1, var_ca20019ee673ff, 20);
    wait 1;
    player setblurforplayer(6, var_411f1d6833233bc3);
}
...
function function_3167b5f4f0e8eb9e(var_379d26c8ac032e3d, condition) {
    ...
    foreach (player in level.players) {
        ...
        player namespace_1d99ddaf3fc03543::function_7f47e1420fd2b2a();
    }
}
...
function private function_166b4e48c8756c40(videoname, var_379d26c8ac032e3d, condition) {
    self endon("disconnect");
    namespace_1d99ddaf3fc03543::freezeplayerforroundend();
    ...
    if (istrue(level.var_ed5707896c1f5275)) {
        thread namespace_162cff1cf88b9bbf::userskip_wait();
        ...
        if (result == "userskipped") {
            if (scripts\cp\utility::function_138028ca2b958511()) {
                namespace_162cff1cf88b9bbf::votesys_new("vote_igc_skip", function_1a1f3c44edec248e());
                namespace_162cff1cf88b9bbf::vote_player_set("vote_igc_skip", 1);
        ...
        namespace_162cff1cf88b9bbf::userskip_stop();
        return;
    }
...
// Size: 0x174
function function_abfba47378ec78af() {
