...
function recordxpgains( type, var_7c6b134e84356e37, bonusxp )
{
    ...
    switch ( group )
    {
        ...
        case #"gametype":
            ...
            else if ( type == #"dmz_contract_complete" || type == #"hash_903730f789cd3ea8" || type == #"hash_39a2298d6704df34" || type == #"hash_73698e98eee3b648" )
            {
