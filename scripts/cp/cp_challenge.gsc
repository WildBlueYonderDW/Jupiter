...
function onplayerkilled(inflictor, attacker, damage, damageflags, meansofdeath, objweapon, hitloc, modifiers) {
    ...
    if (!scripts\cp\utility\player::isfriendly(attacker.team, victim)) {
        equipmentname = namespace_4fb9dddfb8c1a67a::getequipmentreffromweapon(objweapon);
        ...
        operators = [attacker namespace_751288259782653c::lookupcurrentoperator(attacker.team), attacker namespace_751288259782653c::lookupotheroperator(attacker.team)];
        ...
        if (isdefined(objweapon.attachments)) {
            ...
            foreach (attachment in objweapon.attachments) {
                ...
                if (namespace_a0628d6954815ef8::attachmentisselectable(objweapon, attachment)) {
...
function getoperators() {
    operators = [];
    operators[0] = namespace_751288259782653c::lookupcurrentoperator(self.team);
    operators[1] = namespace_751288259782653c::lookupotheroperator(self.team);
    return operators;
}
