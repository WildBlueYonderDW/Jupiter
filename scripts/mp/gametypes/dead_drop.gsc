        ...
        if (getdvarint(@"hash_c3da1a11f720d408", 0) && !namespace_a38a2e1fe7519183::function_e0fc1230452cf4e7()) {
            ...
            if (var_3d437f1697570e9a > 0) {
                ...
                if (testval == 0) {
                    ...
                    namespace_446fc987a980892f::playevent("<dev string:x40>", [player]);
                } else if (testval == 2) {
                    namespace_446fc987a980892f::playevent("<dev string:x61>", [player]);
                } else if (testval == 3) {
                    namespace_446fc987a980892f::playevent("<dev string:x85>", [player]);
                }
            }
            if (testval == 4) {
                namespace_446fc987a980892f::playevent("<dev string:xa7>", [player]);
            }
        }
    #/
}
