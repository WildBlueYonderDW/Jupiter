...
// Size: 0x1b
function iscp() {
    return string_starts_with(getdvar(@"hash_687fb8f9b7a23245"), "cp_");
}
...
// Size: 0x41
function ismp() {
    return string_starts_with(getdvar(@"hash_f644e90eb9a008cf"), "mp_") || isdefined(level.mapname) && string_starts_with(level.mapname, "mp_");
}
