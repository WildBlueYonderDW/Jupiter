...
function table_getaddblueprintattachments(tablename, classindex, weaponindex) {
    return function_aacbcd2576b3af83(tablename, classindex, weaponindex).var_8886d83d8d183347;
}
...
function function_6baf1dc15666ea19(var_5996df3d783693e8, data) {
    ...
    return var_5996df3d783693e8 != data.backupPistol && !namespace_f8d3520d3483c1::function_6aa482957b62905c(var_5996df3d783693e8) && !scripts\mp\utility\weapon::isgunlessweapon(var_5996df3d783693e8) && !namespace_e0ee43ef2dddadaa::iskillstreakweapon(var_5996df3d783693e8);
}
