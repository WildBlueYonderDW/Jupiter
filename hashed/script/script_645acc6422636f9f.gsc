    ...
    /#
        ...
        while (true) {
            if (getdvarint(@"hash_d0316f72a21f836e", 0) && timer == 0) {
                foreach (starter in level.var_5b7c4eafd38d35c.var_915f0d3c3a61e38) {
                    print3d(starter.origin + (0, 0, 300), "<unknown string>" + function_de53ed8e35d0ed7a(starter.activity_instance) + "<unknown string>" + function_a4748b32a824c79c(starter.activity_instance) + "<unknown string>" + function_f0f498aed6f8fa5d(starter.activity_instance), (1, 1, 1), 1, 2, var_fd5a08e385a75f6c, 1);
