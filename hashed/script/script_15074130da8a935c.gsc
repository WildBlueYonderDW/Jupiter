...
function function_83f276ef36c2e4ab(var_428c9aad17e4e279, spawnratio) {
    ...
    foreach (item in var_bed8b702214653a5) {
        ...
        spawnlistweight = spawnlistweight + item.weight;
    }
    ...
    for (i = priorityspawns; i < totalspawns; i++) {
        ...
        foreach (item in spawnlist) {
            weighttarget = weighttarget - item.weight;
            if (weighttarget <= 0) {
                spawnitem = item;
                break;
            }
        ...
        spawnlistweight = spawnlistweight - spawnitem.weight;
...
function function_d0fe7707ad955a32() {
    /#
        ...
        foreach (item in var_bed8b702214653a5) {
            ...
            debug_str = item.var_d2d351beaab03413 + "<unknown string>" + debug_origin;
            debug::debug_print3d(debug_origin, debug_str, (1, 0, 1), undefined, "<unknown string>", undefined, 1, 0.2);
        }
    #/
}
