...
function function_64ea0c4f3f0f33a8() {
    ...
    while (isdefined(currnode.target)) {
        ...
        if (isdefined(currnode.script_noteworthy)) {
            ...
            case #"hash_be0e5b930f64d78a": 
                /#
                    if (isdefined(level.var_83ced3c593a28a8a["<dev string:x1c>"])) {
            ...
            case #"hash_fa039494e8eed1fe": 
                /#
                    if (isdefined(level.var_83ced3c593a28a8a["<dev string:x80>"])) {
            ...
            case #"hash_7641f1d29b2dccef": 
                /#
                    if (isdefined(level.var_83ced3c593a28a8a["<dev string:xe5>"])) {
                ...
                break;
            default: 
                assertmsg("<dev string:x141>" + currnode.script_noteworthy);
                break;
            }
        }
        patharray[patharray.size] = currnode.origin;
    ...
    /#
        assertex(isdefined(level.var_83ced3c593a28a8a["<dev string:x1c>"]), "<dev string:x16b>");
        assertex(isdefined(level.var_83ced3c593a28a8a["<dev string:xe5>"]), "<dev string:x1bc>");
        assertex(isdefined(level.var_83ced3c593a28a8a["<dev string:x80>"]), "<dev string:x209>");
    #/
    return patharray;
}
...
function function_bfb64f4634ca3fd9(ownerteam) {
    ...
    case 5:
    case 6: 
        playerspeedmultiplier += 0.3;
        break;
    case 3: 
        playerspeedmultiplier += 0.2;
        break;
    case 2: 
        playerspeedmultiplier += 0.1;
        break;
    default: 
        break;
    }
...
function function_a23540f3bc3fd8f5(var_7aad5f9cffb6b8ee, captureteam, pathdirection) {
    while (true) {
        ...
        level.escortent.currnodeindex += pathdirection;
...
/#
    ...
    function function_d492fb429a8aa923() {
        level endon("<dev string:x259>");
        level notify("<dev string:x264>");
        level endon("<dev string:x264>");
        while (true) {
            if (getdvarint(@"hash_46a6b424af6acbc2") != 0) {
                ...
                scripts\mp\gamescore::giveteamscoreforobjective("<dev string:x27e>", points, 0);
                break;
            }
            wait 1;
        }
