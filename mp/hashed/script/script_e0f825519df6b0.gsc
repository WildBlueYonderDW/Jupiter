...
#namespace jup_spawner_zombie_hellhound_spatial;

// Namespace jup_spawner_zombie_hellhound_spatial / namespace_e1087572f5e844c0
// Params 0, eflags: 0x0
// Checksum 0x0, Offset: 0x233
// Size: 0x1e3
function main() {
    self.aitypeid = function_2336488258354fbc(#"aitype", %"jup_spawner_zombie_hellhound_spatial");
    ...
    self.zombieaisetting = "settings_zombie_hellhound_spatial";
...
// Size: 0x108
function precache() {
    agent_type = "actor_jup_spawner_zombie_hellhound_spatial";
    ...
    params.zombieaisetting = "settings_zombie_hellhound_spatial";
