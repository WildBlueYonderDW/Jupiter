...
function function_56e8f78ce1511d35(warlordtype, callbackfunction, userdata) {
    /#
        assertex(isdefined(level.ob.warlordcallbacks["WarlordInitialization"]), "Need to setup warlord data before adding a callback!");
    #/
...
function function_32d58ef031f811e5(warlordtype, callbackfunction, userdata) {
    /#
        assertex(isdefined(level.ob.warlordcallbacks["WarlordEnterCombat"]), "Need to setup warlord data before adding a callback!");
    #/
...
function function_dbfada6bda9049b3(warlordtype, callbackfunction, userdata) {
    /#
        assertex(isdefined(level.ob.warlordcallbacks["BodyguardInitialization"]), "Need to setup warlord data before adding a callback!");
    #/
    ...
    foreach (var_eda9f5416ee74e1a in var_9414c7e6e6b170eb) {
        ...
        if (var_2837ba0ad9d0ca86.warlordparameters.size > 0) {
            ...
            if (isdefined(warlordparameters) && warlordparameters.warlordtype == warlordtype) {
                ...
                level.ob.var_ebde11a65d618ef6["actor_" + var_2837ba0ad9d0ca86.var_fff6b84dc56a9504] = warlordtype;
                return;
            }
        }
    }
    /#
        assertmsg("Unable to find a script bundle matching the warlord type: " + warlordtype + ". Warlord data is not correctly setup!");
    #/
}
...
function private function_81d8f6b92521b89e(requestid, var_2189bfeed28cbb65) {
    ...
    /#
        assertex(!isdefined(var_3ecf047d758de560.warlord) && var_3ecf047d758de560.bodyguards.size == 0, "Trying to clean a warlordFightData which is still active.");
    #/
...
function function_395c3a00db83ba6(incomingdamage, smeansofdeath, objweapon) {
    ...
    if (isdefined(objweapon)) {
        if (namespace_e0ee43ef2dddadaa::iswonderweapon(objweapon)) {
...
function private function_8834b75a040f482c(agent, requestid) {
    ...
    if (isdefined(warlordtype)) {
        ...
        agent thread function_a25ef95b556a9ab1(warlordtype);
...
// Size: 0xbd
function private function_a25ef95b556a9ab1(warlordtype) {
