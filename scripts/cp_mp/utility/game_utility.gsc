...
// Size: 0x3b
function function_2536e99eb6586f8f() {
    if (!isdefined(level.gametype)) {
        return 0;
    }
...
function function_244067e915c0eabe() {
    return istrue(level.var_f8df85ee28f001e3);
}
...
function function_6ae03efb52c52c29(player) {
    if (function_5a094c7dc3b36ebd()) {
        var_c262d94feef124f0 = function_f3bb4f4911a1beb2("game", "getGametypeNumLives");
        if (isdefined(player.pers["deaths"]) && player.pers["deaths"] >= var_c262d94feef124f0) {
            return 1;
        }
    }
    return 0;
...
function function_6c1fce6f6b8779d5() {
    if (isbrstylegametype()) {
        ...
        if (var_faf0d2fac3f47583 != "") {
            return var_faf0d2fac3f47583;
        }
    }
    return getgametype();
}
...
// Size: 0x128
function function_1e9ff68a8f2562bd(var_f991f7356fb3ee15) {
    /#
    ...
    foreach (row in var_f991f7356fb3ee15) {
        ...
        var_218bf995909cf648 = function_53c4c53197386572(row.var_faf0d2fac3f47583, "");
        if (var_e372edac926cde62 == gametype && var_218bf995909cf648 == var_faf0d2fac3f47583) {
            bestmatch = row;
            break;
        } else if (var_e372edac926cde62 == gametype && var_218bf995909cf648 == "") {
            bestmatch = row;
        } else if (var_e372edac926cde62 == "" && !isdefined(bestmatch)) {
            bestmatch = row;
        }
    }
    return bestmatch;
...
function getlocaleent(entname, var_8a8a9680c8ad47a2, var_783ab83623b57681) {
    var_6f0350c82fc94c38 = getentarray(entname, "targetname");
    var_44716bcb2430218b = undefined;
    if (isdefined(var_6f0350c82fc94c38) && var_6f0350c82fc94c38.size == 1) {
        return var_6f0350c82fc94c38[0];
    }
    if (isdefined(getlocaleid()) && !istrue(var_783ab83623b57681)) {
        foreach (ent in var_6f0350c82fc94c38) {
            ...
            } else if (level.mapname == "mp_port2_gw" && entname == "airstrikeheight") {
...
// Size: 0x14d
function getlocalestruct(var_cab957adc8d7710f, var_8a8a9680c8ad47a2) {
    var_6f0350c82fc94c38 = getstructarray(var_cab957adc8d7710f, "targetname");
    var_44716bcb2430218b = undefined;
    ...
    /#
        if (isdefined(level.localeid)) {
            println("reportChallengeUserSerializedEventWrapper" + var_cab957adc8d7710f + "tjugg" + level.localeid + "brm");
        }
    #/
    if (istrue(var_8a8a9680c8ad47a2)) {
        /#
...
// Size: 0x11f
function getlocalestructarray(var_cab957adc8d7710f, var_8a8a9680c8ad47a2) {
    var_6f0350c82fc94c38 = getstructarray(var_cab957adc8d7710f, "targetname");
    ...
    if (isdefined(getlocaleid())) {
        foreach (ent in var_6f0350c82fc94c38) {
            ...
            } else if (isdefined(ent.script_noteworthy) && ent.script_noteworthy == level.localeid) {
                var_134cb8f60ff902c0[var_134cb8f60ff902c0.size] = ent;
            }
        }
        return var_134cb8f60ff902c0;
    }
    if (var_6f0350c82fc94c38.size == 0) {
        /#
            if (isdefined(level.localeid)) {
                println("reportChallengeUserSerializedEventWrapper" + var_cab957adc8d7710f + "tjugg" + level.localeid + "brm");
            }
...
function function_21322da268e71c19() {
    return istrue(level.var_1af27f387b8d3369) || namespace_36f464722d326bbe::function_b2c4b42f9236924();
}
...
function startkeyearning() {
    ...
    var_7c6183ce9e04512e = #"start_match";
    var_a7a6077754bbc2f8 = function_6e2deb013c9ca85e(var_7c6183ce9e04512e);
    params = [0:function_d6f771aedba70ce7(var_7c6183ce9e04512e, #"version"), 1:1, 2:function_d6f771aedba70ce7(var_7c6183ce9e04512e, #"playlist_id"), 3:getplaylistid(), 4:function_d6f771aedba70ce7(var_7c6183ce9e04512e, #"hash_f49dbd32adacb71c"), 5:var_8283ee79fff791be, 6:function_d6f771aedba70ce7(var_7c6183ce9e04512e, #"lobby_id"), 7:function_4f9373a1227db35c(), 8:function_d6f771aedba70ce7(var_7c6183ce9e04512e, #"match_id"), 9:function_94c7ae7049488358()];
...
function stopkeyearning(winner) {
    ...
    namespace_aad14af462a74d08::function_b5929663421247fa(self, result, winner);
...
// Size: 0xb4
function _visionsetnakedforplayer(visionset, var_647b7cd7ece0574a) {
    /#
...
function _visionunsetnakedforplayer(visionset) {
    ...
    if (self.activevisionsetlist[visionset] == 0) {
        ...
        foreach (var_b830ab0b24e02ba3, var_c901fc1c126661a in var_bfd32f432f9daccf) {
            waitframe();
            self visionsetnakedforplayer(var_b830ab0b24e02ba3, level.framedurationseconds);
        }
    }
}
...
function initchallengeandeventglobals() {
    ...
    level.challengeandeventglobals = var_584994fab4a8712b;
    var_584994fab4a8712b.game_type_col = [];
    var_584994fab4a8712b.game_type_col["missions"] = function_b40278e5e468c6c1(#"gametype", #"hash_94a3e9eef8486ceb");
    var_584994fab4a8712b.game_type_col["dm"] = function_b40278e5e468c6c1(#"gametype", #"hash_283088392650cf49");
    var_584994fab4a8712b.game_type_col["war"] = function_b40278e5e468c6c1(#"gametype", #"hash_27a9511c6b561209");
    var_584994fab4a8712b.game_type_col["sd"] = function_b40278e5e468c6c1(#"gametype", #"hash_28716139268823f9");
    var_584994fab4a8712b.game_type_col["dom"] = function_b40278e5e468c6c1(#"gametype", #"hash_9b3fa11c1b49e24a");
    var_584994fab4a8712b.game_type_col["conf"] = function_b40278e5e468c6c1(#"gametype", #"hash_ef25fedf53b657bc");
    var_584994fab4a8712b.game_type_col["sr"] = function_b40278e5e468c6c1(#"gametype", #"hash_287173392688428f");
    var_584994fab4a8712b.game_type_col["grind"] = function_b40278e5e468c6c1(#"gametype", #"hash_ef9a4413a5aba5c4");
    var_584994fab4a8712b.game_type_col["ball"] = function_b40278e5e468c6c1(#"gametype", #"hash_cfecd0d34f64445f");
    var_584994fab4a8712b.game_type_col["infect"] = function_b40278e5e468c6c1(#"gametype", #"hash_d2318c9d1c1c48c7");
    var_584994fab4a8712b.game_type_col["tjugg"] = function_b40278e5e468c6c1(#"gametype", #"hash_dc39a236526e4509");
    var_584994fab4a8712b.game_type_col["gun"] = function_b40278e5e468c6c1(#"gametype", #"hash_93dc951c177762dc");
    var_584994fab4a8712b.game_type_col["grnd"] = function_b40278e5e468c6c1(#"gametype", #"hash_8be52fbbc7559ed1");
    var_584994fab4a8712b.game_type_col["siege"] = function_b40278e5e468c6c1(#"gametype", #"hash_32ae842c947a11b1");
    var_584994fab4a8712b.game_type_col["koth"] = function_b40278e5e468c6c1(#"gametype", #"hash_e72de898a6de98ec");
    var_584994fab4a8712b.game_type_col["ctf"] = function_b40278e5e468c6c1(#"gametype", #"hash_b7b1431c2c18d7ed");
    var_584994fab4a8712b.game_type_col["dd"] = function_b40278e5e468c6c1(#"gametype", #"hash_28308f392650db2e");
    var_584994fab4a8712b.game_type_col["tdef"] = function_b40278e5e468c6c1(#"gametype", #"hash_bae2324a6357ff25");
    var_584994fab4a8712b.game_type_col["front"] = function_b40278e5e468c6c1(#"gametype", #"hash_9596002d37fafad9");
    var_584994fab4a8712b.game_type_col["cmd"] = function_b40278e5e468c6c1(#"gametype", #"hash_b7ff231c2c5ac2de");
    var_584994fab4a8712b.game_type_col["br"] = function_b40278e5e468c6c1(#"gametype", #"hash_283771392656c6e2");
    var_584994fab4a8712b.game_type_col["resurgence"] = function_b40278e5e468c6c1(#"gametype", #"hash_f619a150a59cd8b8");
    var_584994fab4a8712b.game_type_col["zonecontrol"] = function_b40278e5e468c6c1(#"gametype", #"hash_1c4004bc52aa7574");
    var_584994fab4a8712b.game_type_col["plunder"] = function_b40278e5e468c6c1(#"gametype", #"hash_731d29529dec358d");
    var_584994fab4a8712b.game_type_col["arena"] = function_b40278e5e468c6c1(#"gametype", #"hash_b6b155127486c1e9");
    var_584994fab4a8712b.game_type_col["cyber"] = function_b40278e5e468c6c1(#"gametype", #"hash_d5007927e17e9f2f");
    var_584994fab4a8712b.game_type_col["rush"] = function_b40278e5e468c6c1(#"gametype", #"hash_a237b75bff436418");
    var_584994fab4a8712b.game_type_col["esc"] = function_b40278e5e468c6c1(#"gametype", #"hash_a595c41c219e743f");
    var_584994fab4a8712b.game_type_col["vip"] = function_b40278e5e468c6c1(#"gametype", #"hash_1572e41c60c50539");
    var_584994fab4a8712b.game_type_col["btm"] = function_b40278e5e468c6c1(#"gametype", #"hash_ace80f1c2562eb87");
    var_584994fab4a8712b.game_type_col["rugby"] = function_b40278e5e468c6c1(#"gametype", #"hash_96132a53224a13f9");
    var_584994fab4a8712b.game_type_col["arm"] = function_b40278e5e468c6c1(#"gametype", #"hash_c68b8a1c33cecfb0");
    var_584994fab4a8712b.game_type_col["mtmc"] = function_b40278e5e468c6c1(#"gametype", #"hash_4083828bb7543117");
    var_584994fab4a8712b.game_type_col["snatch"] = function_b40278e5e468c6c1(#"gametype", #"hash_7cad9b981acb29d");
    var_584994fab4a8712b.game_type_col["hq"] = function_b40278e5e468c6c1(#"gametype", #"hash_28236c3926461559");
    var_584994fab4a8712b.game_type_col["defcon"] = function_b40278e5e468c6c1(#"gametype", #"hash_155388b4618596b");
    var_584994fab4a8712b.game_type_col["pill"] = function_b40278e5e468c6c1(#"gametype", #"hash_cb35b96938bb6729");
    var_584994fab4a8712b.game_type_col["blitz"] = function_b40278e5e468c6c1(#"gametype", #"hash_400b8b2cb23f693d");
    var_584994fab4a8712b.game_type_col["brm"] = function_b40278e5e468c6c1(#"gametype", #"hash_acfbf31c257364fd");
    var_584994fab4a8712b.game_type_col["hvt"] = function_b40278e5e468c6c1(#"gametype", #"hash_7a4a101c0919e0e8");
    var_584994fab4a8712b.game_type_col["trial"] = function_b40278e5e468c6c1(#"gametype", #"hash_637597fbdf194e7a");
    var_584994fab4a8712b.game_type_col["cp_survival"] = function_b40278e5e468c6c1(#"gametype", #"hash_79cc8147f3dc8572");
    var_584994fab4a8712b.game_type_col["cp_wave_sv"] = function_b40278e5e468c6c1(#"gametype", #"hash_210b7c134eaec1f3");
    var_584994fab4a8712b.game_type_col["brtdm"] = function_b40278e5e468c6c1(#"gametype", #"hash_67c1df9e3d5023ed");
    var_584994fab4a8712b.game_type_col["oic"] = function_b40278e5e468c6c1(#"gametype", #"hash_4f413a1bf0cd2d97");
    var_584994fab4a8712b.game_type_col["ko"] = function_b40278e5e468c6c1(#"gametype", #"hash_281f8639264258b0");
    var_584994fab4a8712b.game_type_col["risk"] = function_b40278e5e468c6c1(#"gametype", #"hash_94545e5c8846c395");
    var_584994fab4a8712b.game_type_col["hstg"] = function_b40278e5e468c6c1(#"gametype", #"hash_c8df63a365d0db66");
    var_584994fab4a8712b.game_type_col["fr"] = function_b40278e5e468c6c1(#"gametype", #"hash_282a7939264c4a1e");
    var_584994fab4a8712b.game_type_col["gwbomb"] = function_b40278e5e468c6c1(#"gametype", #"hash_259348284f0f4cc4");
    var_584994fab4a8712b.game_type_col["rescue"] = function_b40278e5e468c6c1(#"gametype", #"hash_9ebabf7a445387c3");
    var_584994fab4a8712b.game_type_col["war_mgl"] = function_b40278e5e468c6c1(#"gametype", #"hash_2c940e978e2052e6");
    var_584994fab4a8712b.game_type_col["dom_mgl"] = function_b40278e5e468c6c1(#"gametype", #"hash_6bfe18dcf0bec72d");
    var_584994fab4a8712b.game_type_col["zm_rb"] = function_b40278e5e468c6c1(#"gametype", #"hash_ee1508011908d6f0");
    var_584994fab4a8712b.game_type_col["gwai"] = function_b40278e5e468c6c1(#"gametype", #"hash_a51fa5bbd5689172");
    var_584994fab4a8712b.game_type_col["control"] = function_b40278e5e468c6c1(#"gametype", #"hash_b7a4eaad0b7e7803");
    var_584994fab4a8712b.game_type_col["ob"] = function_b40278e5e468c6c1(#"gametype", #"hash_28127b392637bba3");
    var_584994fab4a8712b.game_type_col["elim"] = 7;
    var_584994fab4a8712b.game_type_col["benchmark"] = function_b40278e5e468c6c1(#"gametype", #"hash_6cca546ad092b105");
    var_584994fab4a8712b.game_type_col["ballmode"] = function_b40278e5e468c6c1(#"gametype", #"hash_3fe61236bae85f58");
    var_584994fab4a8712b.game_type_col["dungeons"] = 10;
    var_584994fab4a8712b.game_type_col["zm_turned"] = 6;
    var_584994fab4a8712b.game_type_col["bounty"] = function_b40278e5e468c6c1(#"gametype", #"hash_77c2b42a34b997bd");
    var_584994fab4a8712b.game_type_col["brtdm_mgl"] = function_b40278e5e468c6c1(#"gametype", #"hash_b04061cb04f6f43a");
    var_584994fab4a8712b.game_type_col["conflict"] = function_b40278e5e468c6c1(#"gametype", #"hash_44f627b6b4df0374");
    var_584994fab4a8712b.game_type_col["training_course"] = function_b40278e5e468c6c1(#"gametype", #"hash_206378862002a2dc");
}
...
function function_e1770d1e0f2d89e2() {
    ...
    level.challengeandeventglobals = var_584994fab4a8712b;
    var_584994fab4a8712b.game_type_col = [];
    var_584994fab4a8712b.game_type_col["dm"] = 5;
    var_584994fab4a8712b.game_type_col["war"] = 6;
    var_584994fab4a8712b.game_type_col["sd"] = 7;
    var_584994fab4a8712b.game_type_col["dom"] = 8;
    var_584994fab4a8712b.game_type_col["conf"] = 9;
    var_584994fab4a8712b.game_type_col["sr"] = 10;
    var_584994fab4a8712b.game_type_col["grind"] = 11;
    var_584994fab4a8712b.game_type_col["ball"] = 12;
    var_584994fab4a8712b.game_type_col["infect"] = 13;
    var_584994fab4a8712b.game_type_col["tjugg"] = 14;
    var_584994fab4a8712b.game_type_col["gun"] = 15;
    var_584994fab4a8712b.game_type_col["grnd"] = 16;
    var_584994fab4a8712b.game_type_col["siege"] = 17;
    var_584994fab4a8712b.game_type_col["koth"] = 18;
    var_584994fab4a8712b.game_type_col["ctf"] = 19;
    var_584994fab4a8712b.game_type_col["dd"] = 20;
    var_584994fab4a8712b.game_type_col["tdef"] = 21;
    var_584994fab4a8712b.game_type_col["front"] = 22;
    var_584994fab4a8712b.game_type_col["cmd"] = 23;
    var_584994fab4a8712b.game_type_col["br"] = 24;
    var_584994fab4a8712b.game_type_col["arena"] = 25;
    var_584994fab4a8712b.game_type_col["cyber"] = 26;
    var_584994fab4a8712b.game_type_col["rush"] = 27;
    var_584994fab4a8712b.game_type_col["esc"] = 28;
    var_584994fab4a8712b.game_type_col["vip"] = 29;
    var_584994fab4a8712b.game_type_col["btm"] = 30;
    var_584994fab4a8712b.game_type_col["rugby"] = 31;
    var_584994fab4a8712b.game_type_col["arm"] = 32;
    var_584994fab4a8712b.game_type_col["mtmc"] = 33;
    var_584994fab4a8712b.game_type_col["snatch"] = 34;
    var_584994fab4a8712b.game_type_col["hq"] = 35;
    var_584994fab4a8712b.game_type_col["defcon"] = 36;
    var_584994fab4a8712b.game_type_col["pill"] = 37;
    var_584994fab4a8712b.game_type_col["blitz"] = 38;
    var_584994fab4a8712b.game_type_col["brm"] = 39;
    var_584994fab4a8712b.game_type_col["hvt"] = 40;
    var_584994fab4a8712b.game_type_col["trial"] = 41;
    var_584994fab4a8712b.game_type_col["cp_survival"] = 42;
    var_584994fab4a8712b.game_type_col["cp_wave_sv"] = 43;
    var_584994fab4a8712b.game_type_col["brtdm"] = 44;
    var_584994fab4a8712b.game_type_col["oic"] = 45;
    var_584994fab4a8712b.game_type_col["cp_specops"] = 46;
    var_584994fab4a8712b.game_type_col["incursion"] = 47;
    var_584994fab4a8712b.game_type_col["missions"] = 48;
    var_584994fab4a8712b.game_type_col["cqc"] = 49;
    var_584994fab4a8712b.game_type_col["dungeons"] = 50;
}
...
// Size: 0x6e
function function_6b6b6273f8180522(var_e6f187bcb4b1648e, origin, radius, var_74526f264cee0949) {
    /#
        assertex(isdefined(self), "questCircle_create: self is undefined, please make sure you call this with a valid ent/struct.");
    #/
    if (isdefined(origin)) {
        self.mapcircle = function_dc11c1caffe56e16(var_e6f187bcb4b1648e, origin[0], origin[1], radius, var_74526f264cee0949);
    } else {
        self.mapcircle = function_dc11c1caffe56e16(var_e6f187bcb4b1648e, undefined, undefined, radius, var_74526f264cee0949);
    }
...
function removefromcharactersarray() {
    ...
    if (isdefined(self.var_7a9bd393dfab7faf)) {
        ...
        if (isdefined(level.characters[self.var_7a9bd393dfab7faf])) {
            ...
            if (level.characters[self.var_7a9bd393dfab7faf] == self) {
                var_d7f162f46219a14 = self.var_7a9bd393dfab7faf;
            }
        }
    }
    if (!isdefined(var_d7f162f46219a14)) {
        found = 0;
        for (entry = 0; entry < level.characters.size; entry++) {
            if (level.characters[entry] == self) {
                var_d7f162f46219a14 = entry;
                found = 1;
                break;
            }
        }
    ...
    if (isdefined(var_d7f162f46219a14)) {
        level.characters[var_d7f162f46219a14] = level.characters[level.characters.size - 1];
        level.characters[var_d7f162f46219a14].var_7a9bd393dfab7faf = var_d7f162f46219a14;
...
// Size: 0x95
function function_e8d365de417a3e14() {
...
function game_utility_init() {
    ...
    #/
    var_480c0d1316d8d13c = getdvarint(@"hash_95f4193739093e89");
    if (var_480c0d1316d8d13c > 4 || var_480c0d1316d8d13c < 0) {
        exitlevel(0);
    }
    level addbattlepassxpmultiplier(var_480c0d1316d8d13c, "online_battle_xpscale_dvar");
}
...
// Size: 0x3f
function function_ea9801bff6ccf12a() {
...
function getbattlepassxpultipliertotal() {
    var_99c98ef413b2a3a4 = level getbattlepassxpmultiplier();
    ...
    var_62563a3ab1624a5a = var_99c98ef413b2a3a4 * var_9a43fe5a154b7bc8;
...
function addbattlepassxpmultiplier(multiplier, ref) {
    var_427d7621553dfff6 = 4 / level getbattlepassxpmultiplier();
...
function function_e3ef0908b595e8e1() {
    ...
    var_c89cf11e0615debf = function_ebc8c5847567a441();
    return int(max(xpscale, var_c89cf11e0615debf));
}
