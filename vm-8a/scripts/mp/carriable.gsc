...
/#
    ...
    function function_a48e852b0f6a3295(args) {
        ...
        var_187ccfe910b75663 = getentitylessscriptablearray("<dev string:x5c>", "<dev string:x52>");
            ...
            foreach (carriable in var_dc44d971ba523f8) {
                ...
                if (var_5479151c606b66f8 < var_d6e1169355081a8e) {
                    if (var_5479151c606b66f8 < 1000000) {
                        name = "<dev string:x7f>";
                        if (carriable.type == "<dev string:x87>") {
                            name = "<dev string:x9f>";
                        }
                        print3d(carriable.origin + (0, 0, 10), name, (1, 1, 1), 1, 0.95, 62, 1);
                        continue;
                    }
                    print3d(carriable.origin + (0, 0, 0), "<dev string:xaa>", (0, 1, 0), 1, 1.9, 62, 1);
                }
            }
            wait 1;
        }
