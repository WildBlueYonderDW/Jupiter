...
function function_265afd733ff97699(deadplayer) {
    ...
    teamplayers = scripts/mp/utility/teams::getsquadmates(deadplayer.team, deadplayer.sessionsquadid, 1);
    ...
    if (isdefined(level.revivetriggers)) {
        foreach (guid, revivetrigger in level.revivetriggers) {
            if (isdefined(revivetrigger.victim)) {
                revivetrigger.victim thread scripts/mp/teamrevive::removetrigger(guid);
            }
        }
    }
    wait(fadedur + 5);
...
function function_1ebd7d347b85cae3() {
    ...
    /#
        if (getdvarint(@"hash_4106b1f86a235e22", 0)) {
            slot = scripts/mp/equipment::findequipmentslot("dmz_tutorial_end");
            currentammo = scripts/mp/equipment::getequipmentslotammo(slot);
            scripts/mp/equipment::takeequipment(slot);
            scripts/mp/equipment::giveequipment("dmz_tutorial_end", slot, 1);
    ...
    /#
        while (true) {
            ...
            if (getdvarint(@"hash_8ca28a9d28344f", 0)) {
                ...
                harddrive = spawnscriptable("<unknown string>", level.players[0].origin, level.players[0].angles);
...
function getspawnpoint() {
    ...
    if (isdefined(selfindex)) {
        if (isdefined(level.var_fc458ddec84c95a0)) {
            ...
            spawnorigin = spawnorigin + function_9ec9c03926f7b11c(selfindex, level.maxteamsize);
        }
    }
...
function function_9df0ee7fcb9589d4(player, slot, oldequipment) {
    ...
    if (isdefined(oldequipment) && oldequipment == "equip_throwing_knife") {
        player scripts/mp/equipment/throwing_knife_mp::throwing_knife_mp_ontake();
    }
}
...
function function_865b1a5a62c49d7(var_74753a0c1c255400) {
    ...
    if (namespace_8361bad7391de074::function_cff2f4f168b29b81()) {
        poisVisited = scripts/mp/utility/teams::getteamdata(self.team, "poisVisited");
    }
    ...
    if (istrue(self.extracted) || istrue(var_74753a0c1c255400)) {
        ...
        if (namespace_85cd45b4fe0d86fb::hasdogtag(self)) {
            flatbonus = flatbonus + getdvarint(@"hash_2b3cb1f1b979a35b", 500);
        }
    ...
    if (istrue(level.var_fe38a7ece3409052)) {
        ...
        contractscompleted = contractscompleted + self getplayerdata(level.var_5d69837cf4db0407, "DMZaarValue", 6);
        ...
        doorsunlocked = doorsunlocked + self getplayerdata(level.var_5d69837cf4db0407, "DMZaarValue", 14);
        areaUnlockedXP = areaUnlockedXP + self getplayerdata(level.var_5d69837cf4db0407, "DMZaarValue", 15);
        supplydropsopened = supplydropsopened + self getplayerdata(level.var_5d69837cf4db0407, "DMZaarValue", 16);
        ...
        agentxp = agentxp + self getplayerdata(level.var_5d69837cf4db0407, "DMZaarValue", 19);
        operatorkills = operatorkills + self getplayerdata(level.var_5d69837cf4db0407, "DMZaarValue", 20);
        ...
        bossxp = bossxp + self getplayerdata(level.var_5d69837cf4db0407, "DMZaarValue", 23);
...
function function_c574618f682ba25e() {
    /#
        ...
        while (true) {
            ...
            if (debugdvar == 1) {
                foreach (poiname in level.var_34858ba8086735c6) {
                    killstreakLocs = scripts/mp/poi::function_1af8a41e4c1252c7(poiname, "<unknown string>");
                    foreach (killstreakLoc in killstreakLocs) {
...
function function_53542cd8fe181d7() {
    /#
        ...
        while (true) {
            ...
            if (debugdvar == 1) {
                foreach (poiname in level.var_34858ba8086735c6) {
                    firelocs = scripts/mp/poi::function_1af8a41e4c1252c7(poiname, "<unknown string>");
                    foreach (fireloc in firelocs) {
                        if (!isdefined(fireloc.script_parameters)) {
                            continue;
                        }
...
function function_3fd2d65f62ca31b0() {
    /#
        ...
        pickup = scripts/mp/gametypes/br_pickups::spawnpickup("<unknown string>", dropinfo);
