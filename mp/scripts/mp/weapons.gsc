...
function watchmissileusage() {
    self endon("disconnect");
    for (;;) {
        var_c012b762499f4ae2 = waittill_missile_fire();
        missile = var_c012b762499f4ae2[1];
        objweapon = var_c012b762499f4ae2[0];
...
function function_4afcb847b264f855() {
    ...
    w_new = namespace_e0ee43ef2dddadaa::buildweapon(currentweapon.basename, attachments, camo, undefined, variantid, attachmentids, undefined, stickers);
...
function function_450edf11cb278f66() {
    ...
    while (true) {
        if (isdefined(self.laststance)) {
            if (self.laststance == "prone" || self function_e5bf22923d0004bc() || inprematch()) {
                wait 0.5;
                self function_35501b42058d4de9();
            } else {
