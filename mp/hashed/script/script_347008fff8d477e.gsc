...
function function_aa732b5da86f0593() {
    ...
    foreach (struct in var_c2f61447f2eeaaeb) {
        var_66dc4413345ac0b2 = spawn("script_model", struct.origin);
        var_66dc4413345ac0b2 setmodel("limbo_mode_safe_zone");
        var_66dc4413345ac0b2.targetname = "limbo_mode_safe_zone";
        level.var_11981ca7d3830496[level.var_11981ca7d3830496.size] = var_66dc4413345ac0b2;
        var_66dc4413345ac0b2.var_f12a39f35b1cb475 = spawn("script_origin", struct.origin + (0, 0, 30));
        var_66dc4413345ac0b2.var_a01231f3db9ebb77 = spawn("script_origin", struct.origin + (0, 0, 15));
        var_66dc4413345ac0b2.var_f12a39f35b1cb475 thread function_2a5d7d4c3d8520ef(0);
        var_66dc4413345ac0b2.var_a01231f3db9ebb77 thread function_2a5d7d4c3d8520ef(1);
        var_66dc4413345ac0b2.trigger = spawn("noent_volume_trigger_radius", struct.origin + (0, 0, -300), 0, 1056, 1156);
        thread scripts\mp\utility\trigger::makeenterexittrigger(var_66dc4413345ac0b2.trigger, &function_6bebd4f61d16974b, &function_2dc32ec13dd2839f, undefined, "jup_safezone_submix_clear", &function_affffa23de7582bb);
    }
}
...
// Size: 0x57
function SetPlayerInSafeZone(var_f3d9197b2e5b0e9d) {
    self notify("SetPlayerInSafeZone");
    self endon("SetPlayerInSafeZone");
    self.var_fa9f4c933e6df36d = var_f3d9197b2e5b0e9d;
    self setcamerathirdperson(var_f3d9197b2e5b0e9d);
    function_83dd64a37cf4be10(var_f3d9197b2e5b0e9d);
    if (var_f3d9197b2e5b0e9d) {
...
function function_567662cf9c1ccebb() {
    foreach (i, var_66dc4413345ac0b2 in level.var_11981ca7d3830496) {
        self setclientomnvar("ui_limbo_mode_safe_zone_entity_" + i + 1, var_66dc4413345ac0b2);
    }
}
