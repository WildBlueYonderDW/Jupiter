...
function function_e1a78f7ca6c76a52() {
    ...
    if (!isdefined(level.var_a9afa220306e1f68)) {
        level.var_a9afa220306e1f68 = function_a50a7be98d81e4fd();
    }
...
function use_killstreak(itembundle, item) {
    if (function_81b00a2ba10c143a()) {
        ...
        if (istrue(item.var_4ec444a18e7fc2c0)) {
            ...
            function_a2560fe66d697e02(var_2814cca693e6ef2d, quantity);
        }
        removekillstreak(1);
    }
...
// Size: 0xb6
function function_bd6da02766cc4480(itembundle, item, var_b2635db617b09abd, var_8bd8fa2792aa0511) {
...
// Size: 0x5c
function function_a6c2c08d6694cda3(itembundle, item, var_b2635db617b09abd, var_8bd8fa2792aa0511) {
    if (isdefined(self.triggeringstreak) || istrue(self.enabledequipdeployvfx) || function_e1a7409f30e3c964()) {
        return 0;
    }
    if (function_81b00a2ba10c143a()) {
...
function function_d6029511a9d0984() {
    ...
    if (isdefined(self.streakdata) && isdefined(self.streakdata.streaks)) {
        if (function_81b00a2ba10c143a()) {
            ...
            var_5ad12d18e74c1f78 = function_61d960957fcf3ca0(killstreakref);
            if (isdefined(var_5ad12d18e74c1f78)) {
                itembundle = getscriptbundle("itemspawnentry:" + var_5ad12d18e74c1f78);
                quantity = 1;
            }
        }
    }
...
// Size: 0x53
function function_81b00a2ba10c143a() {
...
function function_e1a7409f30e3c964() {
    return namespace_9abe40d2af041eb2::iskillstreakdeployweapon(self.currentweapon);
}
