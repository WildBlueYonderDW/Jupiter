...
function function_8d89ce0ee29f2012() {
    value = self waittill("loadout_class_selected");
    if (value == 1) {
...
function function_30760b510aeb8b65(fov_value, fov_time) {
    if (!isdefined(level.var_61017590a469f2de)) {
        level.var_61017590a469f2de = getdvarint(@"cg_targetBaseFov", 65);
    }
...
function function_683f31a0f8a1a6bf(var_507c9b4c6252f2d8) {
    while (true) {
        channel, value = level.player waittill("luinotifyserver");
...
function function_4576aecf9d0c4082(entity) {
    ...
    for (;;) {
        ...
        damage, attacker, direction, point, method, objweapon = entity waittill("friendlyfire_notify");
...
function notifydamage(entity) {
    entity endon("death");
    for (;;) {
        damage, attacker, direction, point, method, unused, unused, unused, unused, objweapon = entity waittill("damage");
...
function notifydeath(entity) {
    team = entity.team;
    attacker, method, objweapon = entity waittill("death");
