...
/#
    ...
    function function_157d2e0cb4457c53() {
        ...
        function_a9a864379a098ad6("<dev string:x3c>", "<dev string:x55>", &function_d5a60ed3fa596347);
        function_a9a864379a098ad6("<dev string:x6e>", "<dev string:x8a>", &function_dc415bc56699ba00);
        function_a9a864379a098ad6("<dev string:xa6>", "<dev string:xc1>", &function_2b6ac9200eee0f85);
    ...
    function function_d5a60ed3fa596347() {
        mimic = function_6d1fbda4b8524ef2(level.players[0].origin, undefined, "<dev string:xdc>");
        if (isdefined(mimic)) {
            mimic notify("<dev string:xf0>");
        }
    }
