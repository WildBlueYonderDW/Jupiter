...
function equipment_init() {
    ...
    utility::registersharedfunc("headgear", "breakHeadGear", &namespace_8beea18646ea4c36::breakHeadGear);
    utility::registersharedfunc("headgear", "resetGasMaskRemovalDelay", &namespace_8beea18646ea4c36::resetGasMaskRemovalDelay);
}
...
function game_init() {
    ...
    utility::registersharedfunc("game", "isPointInMultiCircleDanger", &namespace_bbc79db4c3949a5c::isPointInMultiCircleDanger);
...
function objective_init() {
    ...
    utility::registersharedfunc(#"objective", #"objective_add_objective", &namespace_6c8a837ec98fe0b8::objective_add_objective);
    utility::registersharedfunc(#"objective", #"objective_set_play_intro", &namespace_6c8a837ec98fe0b8::objective_set_play_intro);
    utility::registersharedfunc(#"objective", #"objective_set_play_outro", &namespace_6c8a837ec98fe0b8::objective_set_play_outro);
    utility::registersharedfunc(#"objective", #"update_objective_onentity", &namespace_6c8a837ec98fe0b8::update_objective_onentity);
    utility::registersharedfunc(#"objective", #"update_objective_setbackground", &namespace_6c8a837ec98fe0b8::update_objective_setbackground);
    utility::registersharedfunc(#"objective", #"update_objective_ownerteam", &namespace_6c8a837ec98fe0b8::update_objective_ownerteam);
    utility::registersharedfunc(#"objective", #"update_objective_ownerclient", &namespace_6c8a837ec98fe0b8::update_objective_ownerclient);
}
...
function function_52b5f55ca64bd530() {
    utility::registersharedfunc("featurebans", "featurebans_vehicleExplode", &namespace_923440a69c7ffdbe::featurebans_vehicleExplode);
    utility::registersharedfunc("featurebans", "featurebans_jumpScare", &namespace_923440a69c7ffdbe::featurebans_jumpScare);
}
