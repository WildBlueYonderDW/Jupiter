...
function function_5e15cf3721cdcaab(shockstick) {
    ...
    if (!shouldstowweapon) {
        ...
        if (shoulddropweapon) {
            velocityvec = (0, 0, 0);
            velocityvec = velocityvec + anglestoforward(self.angles) * getdvarfloat(@"hash_c7f7fb9ea22e108f", 200);
            velocityvec = velocityvec + anglestoup(self.angles) * getdvarfloat(@"hash_b2d4c6bd7da9e85f", 100);
