...
function private function_3fb94d3acc6c5bfa() {
    ...
    thread function_58fb6b6c5daffcaa();
...
// Size: 0x310
function private function_58fb6b6c5daffcaa() {
    level endon("game_ended");
    self endon("death_or_disconnect");
    if (isdefined(self.dog_companion)) {
        self.dog_companion kill();
        self.dog_companion = undefined;
        waitframe();
    }
...
function private function_ccb4e995b4be8323(player) {
    ...
    if (isdefined(targetpos)) {
        function_c789cc0bd60384c2(targetpos + (0, 0, 2000), targetpos);
        return true;
    }
    return false;
}
