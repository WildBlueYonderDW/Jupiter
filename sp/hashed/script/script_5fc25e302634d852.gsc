...
#namespace jup_enemy_cp_rpg_tier3_rus_pmc;

// Namespace jup_enemy_cp_rpg_tier3_rus_pmc / namespace_c473da6e8d47067e
// Params 0, eflags: 0x0
// Checksum 0x0, Offset: 0x2bc
// Size: 0x1df
function main() {
    self.aitypeid = function_2336488258354fbc(#"aitype", %"jup_enemy_cp_rpg_tier3_rus_pmc");
...
// Size: 0x106
function precache() {
    agent_type = "actor_jup_enemy_cp_rpg_tier3_rus_pmc";
