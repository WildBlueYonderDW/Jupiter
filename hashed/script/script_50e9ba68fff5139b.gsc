...
#namespace namespace_39b5209d638e5e70;

// Namespace namespace_39b5209d638e5e70 / namespace_ad66dcd6945e3423
// Params 0, eflags: 0x0
...
function main() {
    ...
    namespace_726729b14b4a7e1e::main();
    namespace_813e4ba6b29c9ad8::main();
    namespace_ccad715273481961::main();
    setsaveddvar(@"glass_damageToWeaken", 30);
    setsaveddvar(@"glass_damageToDestroy", 60);
    precache();
    preload();
    startpoints();
...
function function_2af739d19d5426cd() {
    ...
    thread function_330a3a27bf21fc28();
...
// Size: 0x27
function function_330a3a27bf21fc28() {
    self endon("death");
    while (true) {
...
function preload() {
    ...
    thread namespace_b8a89d525f3c95ba::function_a7781ba0aed1431(0);
    namespace_68728a7c04d69134::ally_equipment_init();
...
function precache() {
    ...
    if (isdefined(level._effect) && !isdefined(level._effect["vfx_helmet_tier3"])) {
        namespace_696e493179dbdfab::precache();
    }
}
...
function objectives() {
    ...
    case #"hash_a095097f67493cf1": 
        ...
        while (!isdefined(level.var_df52e41aad8c0344)) {
            wait 0.3;
        }
        objective_remove_all_locations("makarov");
        objective_update("makarov", undefined, level.var_df52e41aad8c0344.origin + (0, 0, 10));
