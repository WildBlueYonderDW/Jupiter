...
/#
    ...
    function function_7b3bb02905678cfe() {
        ...
        duration = 90;
        waittime = 8;
        printtoscreen2d(xpos, ypos, "<dev string:x8c>", color, scale, duration);
        wait 10;
        while (true) {
            playerlist = level.players;
            thread namespace_446fc987a980892f::playevent("<dev string:xae>", playerlist);
            printtoscreen2d(xpos, ypos, "<dev string:xae>", color, scale, duration);
            scripts\mp\gametypes\br_gametype_dmz::showdmzsplash("<dev string:xc0>", level.players, "<dev string:xd8>");
            wait waittime;
            thread namespace_446fc987a980892f::playevent("<dev string:xe4>", playerlist);
            printtoscreen2d(xpos, ypos, "<dev string:xe4>", color, scale, duration);
            wait waittime;
            thread namespace_446fc987a980892f::playevent("<dev string:xf5>", playerlist);
            printtoscreen2d(xpos, ypos, "<dev string:xf5>", color, scale, duration);
            scripts\mp\gametypes\br_gametype_dmz::showdmzsplash("<dev string:x103>", level.players, "<dev string:xd8>");
            wait waittime;
            thread namespace_446fc987a980892f::playevent("<dev string:x120>", playerlist);
            printtoscreen2d(xpos, ypos, "<dev string:x120>", color, scale, duration);
            wait waittime;
            thread namespace_446fc987a980892f::playevent("<dev string:x130>", playerlist);
            printtoscreen2d(xpos, ypos, "<dev string:x130>", color, scale, duration);
            scripts\mp\gametypes\br_gametype_dmz::showdmzsplash("<dev string:x142>", level.players, "<dev string:xd8>");
            wait waittime;
            thread namespace_446fc987a980892f::playevent("<dev string:x163>", playerlist);
            printtoscreen2d(xpos, ypos, "<dev string:x163>", color, scale, duration);
            wait waittime;
            thread namespace_446fc987a980892f::playevent("<dev string:x172>", playerlist);
            printtoscreen2d(xpos, ypos, "<dev string:x172>", color, scale, duration);
            scripts\mp\gametypes\br_gametype_dmz::showdmzsplash("<dev string:xc0>", level.players, "<dev string:xd8>");
            wait waittime;
            thread namespace_446fc987a980892f::playevent("<dev string:x18a>", playerlist);
            printtoscreen2d(xpos, ypos, "<dev string:x18a>", color, scale, duration);
            wait waittime;
            thread namespace_446fc987a980892f::playevent("<dev string:x1a7>", playerlist);
            printtoscreen2d(xpos, ypos, "<dev string:x1a7>", color, scale, duration);
            wait waittime;
        }
    }
    ...
    function function_7273b2652941f86a() {
        ...
        waittime = 10;
        while (true) {
            scripts\mp\gametypes\br_gametype_dmz::showdmzsplash("<dev string:xc0>", level.players);
            thread namespace_446fc987a980892f::playevent("<dev string:x130>", level.players);
            wait waittime;
            scripts\mp\gametypes\br_gametype_dmz::showdmzsplash("<dev string:x103>", level.players);
            thread namespace_446fc987a980892f::playevent("<dev string:x130>", level.players);
            wait waittime;
            scripts\mp\gametypes\br_gametype_dmz::showdmzsplash("<dev string:x142>", level.players);
            thread namespace_446fc987a980892f::playevent("<dev string:x130>", level.players);
            wait waittime;
            scripts\mp\gametypes\br_gametype_dmz::showdmzsplash("<dev string:x1ba>", level.players);
            thread namespace_446fc987a980892f::playevent("<dev string:x130>", level.players);
            wait waittime;
            scripts\mp\gametypes\br_gametype_dmz::showdmzsplash("<dev string:x1cf>", level.players);
            thread namespace_446fc987a980892f::playevent("<dev string:x130>", level.players);
            wait waittime;
            scripts\mp\gametypes\br_gametype_dmz::showdmzsplash("<dev string:x1e9>", level.players);
            thread namespace_446fc987a980892f::playevent("<dev string:x130>", level.players);
            wait waittime;
            scripts\mp\gametypes\br_gametype_dmz::showdmzsplash("<dev string:x209>", level.players);
            thread namespace_446fc987a980892f::playevent("<dev string:x130>", level.players);
            wait waittime;
            scripts\mp\gametypes\br_gametype_dmz::showdmzsplash("<dev string:x222>", level.players);
            thread namespace_446fc987a980892f::playevent("<dev string:x130>", level.players);
            wait waittime;
            scripts\mp\gametypes\br_gametype_dmz::showdmzsplash("<dev string:x241>", level.players);
            thread namespace_446fc987a980892f::playevent("<dev string:x130>", level.players);
            wait waittime;
            scripts\mp\gametypes\br_gametype_dmz::showdmzsplash("<dev string:x268>", level.players);
            thread namespace_446fc987a980892f::playevent("<dev string:x130>", level.players);
            wait waittime;
            scripts\mp\gametypes\br_gametype_dmz::showdmzsplash("<dev string:x27d>", level.players);
            thread namespace_446fc987a980892f::playevent("<dev string:x130>", level.players);
            wait waittime;
            scripts\mp\gametypes\br_gametype_dmz::showdmzsplash("<dev string:x296>", level.players);
            thread namespace_446fc987a980892f::playevent("<dev string:x130>", level.players);
            wait waittime;
            scripts\mp\gametypes\br_gametype_dmz::showdmzsplash("<dev string:x2b4>", level.players);
            thread namespace_446fc987a980892f::playevent("<dev string:x130>", level.players);
            wait waittime;
        }
    }
