...
function dangercircletick(var_819edacdacb810e4, dangercircleradius, thresholdradius) {
    ...
    foreach (armorykiosk in level.br_armory_kiosk.scriptables) {
        var_e4e4ae4481958d2e = !isdefined(armorykiosk.deconeffectcount) && exclusion_zones::function_de57b9616f575a63(armorykiosk.origin, 0, 0) == -1 && distance2dsquared(armorykiosk.origin, var_819edacdacb810e4) + level.var_53c0fa66001cff52 > var_c434624ff361bba2;
...
function function_1a1709943670772a() {
    ...
    hiddenkiosks = [];
    foreach (armorykiosk in level.br_armory_kiosk.scriptables) {
        var_e4e4ae4481958d2e = !isdefined(armorykiosk.deconeffectcount) && exclusion_zones::function_de57b9616f575a63(armorykiosk.origin, 0, 0) == -1 && !namespace_bbc79db4c3949a5c::function_ee854fdd1e77efc4(armorykiosk.origin, level.var_53c0fa66001cff52);
        if (istrue(armorykiosk.visible)) {
            if (var_e4e4ae4481958d2e) {
...
function private function_96e56767b949c013(stationstruct, var_3d329ebb0d03d6db, var_849e91c5e0d0e0df) {
    ...
    if (istrue(level.br_armory_kiosk.var_aaa31c1e28a5663c)) {
        namespace_37686d23b558ac76::function_43755e1816ee895b(buystation, &function_d1e097b50729f36e, &function_d9a3848f71c7c63a);
    }
...
function function_2fc170c3c08ec46(plunderspent) {
    ...
    if (var_a2167f3299d7f85c > 0) {
        function_8359cadd253f9604(self, "spend_friends_cash", var_a2167f3299d7f85c);
    }
}
