...
function function_99484082dc3884de() {
    ...
    self.var_a021045e9363771b = self.zombieaisettings.var_e58a65b7a8f5973c.var_395669381b27230b;
    ...
    self.var_cb7aa972a6412c9a[0].var_b2cdd51bc6f8d406 = 0;
    ...
    if (isdefined(var_304dafdce0b18e69) && var_304dafdce0b18e69.size > 0) {
        foreach (index, struct in var_304dafdce0b18e69) {
            ...
            self.var_cb7aa972a6412c9a[index].name = struct.var_b0469108aa1c5aa;
...
function function_d378e0b40b004bca(params) {
    ...
    if (isdefined(disciple) && isalive(disciple)) {
