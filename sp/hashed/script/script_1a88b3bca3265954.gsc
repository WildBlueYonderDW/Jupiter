...
#namespace namespace_2d889df055e215be;

// Namespace namespace_2d889df055e215be / namespace_510dc013043728fe
// Params 0, eflags: 0x0
...
function function_8003dec5036a7051() {
    ...
    if (isdefined(var_e2013fb183920c7a) && var_e2013fb183920c7a.size > 0) {
        ...
        foreach (var_be66f9030b258bed in var_e2013fb183920c7a) {
            var_31fdd9d22f01a472[i] = var_be66f9030b258bed.origin;
            i += 1;
        }
        i = 0;
        thread function_9db340fa3b64c054();
        foreach (var_be66f9030b258bed in var_e2013fb183920c7a) {
            if (i == 0) {
                var_be66f9030b258bed thread function_6d073581ee146281(var_31fdd9d22f01a472[i], i, var_3e44517f86f72f55);
            } else if (i == 1) {
                var_be66f9030b258bed thread function_6d073581ee146281(var_31fdd9d22f01a472[i], i, var_fd6b0eca3ec13099);
            } else if (i == 2) {
                var_be66f9030b258bed thread function_6d073581ee146281(var_31fdd9d22f01a472[i], i, var_5c38c505c59515b4);
            } else {
                var_be66f9030b258bed thread function_6d073581ee146281(var_31fdd9d22f01a472[i], i, var_f41964ceec53c84d);
            }
            i += 1;
            wait 1;
        }
...
// Size: 0x3f
function function_6d073581ee146281(position, index, var_65377cbed1237d6e) {
    wait 2;
...
// Size: 0x95
function function_9db340fa3b64c054() {
