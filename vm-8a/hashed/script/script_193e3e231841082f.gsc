...
function startemerge(asmname, statename, params) {
    /#
        function_8acdeae54b5a9492("<dev string:x2e>");
    #/
...
function private function_c1ce555e3408ec71() {
    ...
    /#
        function_8acdeae54b5a9492("<dev string:x3b>");
    #/
}
...
function private function_432128e123e154c5() {
    ...
    /#
        function_8acdeae54b5a9492("<dev string:x4e>");
    #/
}
    ...
    foreach (var_9ec3101004a66e6c in self.var_81de213f1930ca23) {
        ...
        /#
            if (function_1ec53e871d501656()) {
                function_8acdeae54b5a9492("<dev string:x68>", aim_pos);
    ...
    while (true) {
        ...
        foreach (target in potential_targets) {
            ...
            if (isai(target) && distancesquared(target.origin, head_pos) > squared(200 * var_9c6db806dd3ca34e)) {
                /#
                    function_8acdeae54b5a9492("<dev string:x7a>" + target getentitynumber() + "<dev string:x87>", target.origin + (0, 0, 70));
                #/
                continue;
            }
...
function private function_bd315b0ebd63273c(var_59bd8f4656f0af80) {
    ...
    /#
        if (function_1ec53e871d501656()) {
            ...
            function_8acdeae54b5a9492("<dev string:x93>", var_59bd8f4656f0af80);
        }
    #/
    if (players.size <= 0) {
        return [];
...
function private liftoff_ent(worm) {
    ...
    while (true) {
        ...
        /#
            function_8acdeae54b5a9492("<dev string:xaa>", self.origin);
...
function function_bea202648c100e56(target, head_pos, damage) {
    ...
    /#
        function_8acdeae54b5a9492("<dev string:xb6>" + target getentitynumber() + "<dev string:xbf>", target.origin + (0, 0, 70));
    #/
    return swallowed;
}
...
function private function_7f9eb46a76d2fa8b(is_enabled) {
    if (istrue(is_enabled)) {
        ...
        /#
            if (function_1ec53e871d501656()) {
                ...
                function_8acdeae54b5a9492("<dev string:xc9>", function_7b4daaf9179c9cee());
            }
        #/
        return;
    }
    ...
    /#
        function_8acdeae54b5a9492("<dev string:xe2>", function_7b4daaf9179c9cee());
    #/
}
...
function private function_80b969fbbf253b0() {
    ...
    if (isdefined(var_343e4908d0df33cc)) {
        ...
        /#
            function_8acdeae54b5a9492("<dev string:xfe>", target_pos);
        #/
        ...
        if (var_1fcc0b320595edf) {
            ...
            self.var_dccee8fd50aac81 = target_pos;
            /#
                function_8acdeae54b5a9492("<dev string:x112>", target_pos);
            #/
        }
    }
    if (!isdefined(target_pos) && isvector(self.var_dccee8fd50aac81)) {
        ...
        /#
            function_8acdeae54b5a9492("<dev string:x131>", target_pos);
        #/
    }
    ...
    if (!isdefined(var_831198d90cf1bdf4)) {
        /#
            function_8acdeae54b5a9492("<dev string:x14c>", var_831198d90cf1bdf4);
        #/
        return undefined;
    }
        ...
        foreach (event in events) {
            ...
            if (!var_1fcc0b320595edf) {
                ...
                /#
                    ...
                    function_8acdeae54b5a9492("<dev string:x164>" + var_6d9b6150b31df8a, var_febcd74f9b8d2e66.origin + (0, 0, 40));
                #/
            ...
            if (event.type == "gunshot") {
                ...
                /#
                    function_8acdeae54b5a9492("<dev string:x189>", event.entity.origin);
                #/
                continue;
            }
            if (event.type == "footstep_sprint") {
                ...
                /#
                    function_8acdeae54b5a9492("<dev string:x198>", event.entity.origin);
                #/
                continue;
            }
            if (event.type == "gunshot_impact") {
                ...
                /#
                    function_8acdeae54b5a9492("<dev string:x1a8>", event.origin);
                #/
                continue;
            }
            if (event.type == "explosion") {
                function_8789d22720f0612(chase_pos);
                /#
                    function_8acdeae54b5a9492("<dev string:x1be>", event.origin);
                #/
                continue;
            }
            if (event.type == "decoy_grenade") {
                function_8789d22720f0612(chase_pos);
                /#
                    function_8acdeae54b5a9492("<dev string:x1cf>", event.origin);
                #/
            }
        }
    }
...
function private function_11afde23727cd866(pos) {
    ...
    if (var_1fcc0b320595edf) {
        if (function_95d12d803b1f13bb(pos)) {
            ...
            /#
                function_8acdeae54b5a9492("<dev string:x1e4>", pos + (0, 0, 40));
            #/
        }
    }
...
function private function_1cdd35ae61fe41d3(tacpoint, var_12b128467439a5b6) {
    ...
    if (isdefined(self.var_28e5a71792b91a61) && self.var_28e5a71792b91a61 != tacpoint.roomindex) {
        ...
        /#
            function_8acdeae54b5a9492("<dev string:x210>", tacpoint.origin + (0, 0, 20));
        #/
    } else {
        ...
        if (tacpoint_exposure < (isdefined(self.zombieaisettings.var_e58a65b7a8f5973c.var_b93d09dcea4e24f5) ? self.zombieaisettings.var_e58a65b7a8f5973c.var_b93d09dcea4e24f5 : 0.5)) {
            var_8289fd24bc653ce6 = 0;
            /#
                function_8acdeae54b5a9492("<dev string:x231>" + tacpoint_exposure, tacpoint.origin + (0, 0, 20));
            #/
        } else {
            ...
            if (var_e5c33c3e7f358a71 <= 300) {
                var_8289fd24bc653ce6 = 0;
                /#
                    function_8acdeae54b5a9492("<dev string:x254>" + var_e5c33c3e7f358a71, tacpoint.origin + (0, 0, 20));
                #/
            }
        }
    }
    if (var_8289fd24bc653ce6 && istrue(var_12b128467439a5b6)) {
        if (function_95d12d803b1f13bb(tacpoint.origin)) {
            var_8289fd24bc653ce6 = 0;
            /#
                function_8acdeae54b5a9492("<dev string:x27d>", tacpoint.origin + (0, 0, 20));
            #/
        }
    }
    if (var_8289fd24bc653ce6) {
        ...
        for (angle = 0; angle < 360; angle += 120) {
            ...
            if (!isdefined(ground_pos) || ground_pos == var_bbc8b087a12bb00 || ground_pos == var_bbc8b087a12bb00 + (0, 0, drop_height * -1)) {
                var_8289fd24bc653ce6 = 0;
                /#
                    function_8acdeae54b5a9492("<dev string:x2ac>", var_bbc8b087a12bb00);
                #/
                break;
            }
        }
...
function private function_370709234f11708d(ent, var_bf32f518568f490d, target_pos) {
    ...
    if (var_d08e5dd64fddbb4e) {
        if (distancesquared(self.var_f42116fb6fbbdebb.origin, self.origin) < distancesquared(ent.origin, self.origin)) {
            /#
                function_8acdeae54b5a9492("<dev string:x2d8>", ent.origin + (0, 0, 20));
            #/
            return;
        }
    }
...
function private function_e35cf2862b8a6c(underground_ent) {
    ...
    while (utility::ent_flag("is_underground")) {
        ...
        if (isdefined(var_3f2d5c250e1d0845)) {
            ...
            /#
                function_8acdeae54b5a9492("<dev string:x2f9>" + chase_intensity + "<dev string:x30b>" + var_9bdc682b3f231fc7, underground_ent.origin + (0, 0, 80));
            #/
            ...
            /#
                function_8acdeae54b5a9492("<dev string:x317>" + var_63fa055edecf2f46, underground_ent.origin + (0, 0, 80));
            #/
            ...
            /#
                if (var_e769acd0c61ec10) {
                    function_8acdeae54b5a9492("<dev string:x32b>" + var_fe4586b3ec1a118b, underground_ent.origin + (0, 0, 120));
                }
            #/
            ...
            if (surface_position[2] < underground_ent.origin[2] - drop_limit + 10) {
                /#
                    if (function_1ec53e871d501656()) {
                        ...
                        function_8acdeae54b5a9492("<dev string:x33f>", surface_position);
                        println("<dev string:x355>");
                    }
                #/
...
function private function_4b0fbbaee39f7489(underground_ent) {
    ...
    while (utility::ent_flag("is_underground")) {
        ...
        /#
            function_8acdeae54b5a9492("<dev string:x376>" + underground_ent.current_depth, underground_ent.origin + (0, 0, 160));
        #/
...
function private heal_update() {
    ...
    while (utility::ent_flag("healing")) {
        ...
        self.health += int(var_bda5255252a8e4b6);
...
/#
    ...
    function function_affdcaeb23533028() {
        devgui::function_6e7290c8ee4f558b("<dev string:x386>");
        devgui::function_a9a864379a098ad6("<dev string:x3a2>", "<dev string:x3af>", &function_63b466a9d511f482);
        devgui::function_a9a864379a098ad6("<dev string:x3bc>", "<dev string:x3c9>", &function_dfb388f8dab8c071);
        devgui::function_b23a59dfb4ca49a1("<dev string:x3d6>", "<dev string:x3f8>", &function_4516e2377c60aa32);
        devgui::function_b23a59dfb4ca49a1("<dev string:x40a>", "<dev string:x42e>", &function_4516e2377c60aa32);
        devgui::function_b23a59dfb4ca49a1("<dev string:x440>", "<dev string:x465>", &function_4516e2377c60aa32);
        devgui::function_b23a59dfb4ca49a1("<dev string:x477>", "<dev string:x49b>", &function_4516e2377c60aa32);
    ...
    function private function_63b466a9d511f482() {
        deathworm = zombie_utils::function_6d1fbda4b8524ef2(level.players[0].origin, undefined, "<dev string:x4ad>");
        if (!isdefined(deathworm)) {
            return;
        }
        deathworm function_3e89eb3d8e3f1811("<dev string:x4be>", 1);
    }
    ...
    function private function_4516e2377c60aa32(params) {
        worm = zombie_utils::function_6d1fbda4b8524ef2(level.players[0].origin, undefined, "<dev string:x4ad>");
        if (!isdefined(worm)) {
            return;
        }
        state_index = int(params[0]);
        if (state_index == 0) {
            worm.var_7aeae37022a80dc2 utility::function_3677f2be30fdd581("<dev string:x4c8>", "<dev string:x4d4>");
        }
        if (state_index == 1) {
            worm.var_7aeae37022a80dc2 utility::function_3677f2be30fdd581("<dev string:x4c8>", "<dev string:x4d8>");
        }
        if (state_index == 2) {
            worm.var_7aeae37022a80dc2 utility::function_3677f2be30fdd581("<dev string:x4c8>", "<dev string:x4e3>");
        }
        if (state_index == 3) {
            worm.var_7aeae37022a80dc2 utility::function_3677f2be30fdd581("<dev string:x4c8>", "<dev string:x4ef>");
        }
    }
    ...
    function private function_dfb388f8dab8c071() {
        devgui::function_2fb888667001fc39("<dev string:x4fa>", @"hash_9fd387aebcb22387");
    }
    ...
    function private function_8acdeae54b5a9492(text, pos) {
        ...
        if (function_1ec53e871d501656()) {
            ...
            print3d(pos, "<dev string:x511>" + text, (1, 0, 0));
        }
    }
    ...
    function private draw_underground() {
        ...
        while (true) {
            ...
            if (isdefined(worm)) {
                ...
                print3d(worm.var_7aeae37022a80dc2.origin + (0, 0, -10), "<dev string:x52a>", var_48f627463d405084, 0.8, 0.5);
            }
            waitframe();
        }
    }
        ...
        while (true) {
            ...
            if (isdefined(level.players) && level.players.size > 0 && isalive(level.players[0])) {
                ...
                if (isdefined(closest_tacpoint)) {
                    ...
                    printtoscreen2d(400, 400, "<dev string:x546>" + function_972570f45c9b09bc(closest_tacpoint), color);
                    printtoscreen2d(400, 450, "<dev string:x56f>" + function_5e2c6953b8312bd6(closest_tacpoint), color);
                    if (distance(level.players[0].origin, closest_tacpoint.origin) > 200) {
                        ...
                        printtoscreen2d(400, 500, "<dev string:x5a1>" + (var_641be59c6d0a32a1 ? "<dev string:x5ce>" : "<dev string:x5e9>"), var_641be59c6d0a32a1 ? (0, 1, 0) : (1, 0, 0));
                    }
                }
                roomindex = undefined;
                worm = zombie_utils::function_6d1fbda4b8524ef2(level.players[0].origin, undefined, "<dev string:x4ad>");
                ...
                if (isdefined(roomindex)) {
                    ...
                    if (isdefined(tacpoint)) {
                        ...
                        print3d(tacpoint.origin, "<dev string:x604>" + function_972570f45c9b09bc(tacpoint), color);
                    }
                }
            }
            waitframe();
