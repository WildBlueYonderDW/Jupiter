...
// Namespace namespace_69b5676020104b55 / namespace_1e328aa88d07474a
// Params 0, eflags: 0x0
...
function private function_8385e33cb3e5e39e() {
    ...
    var_e2818ad39a3341b4 = vehomn_getleveldataforvehicle("veh9_mil_lnd_mrap", 1);
    var_e2818ad39a3341b4.ammoids["popsmoke"] = 1;
...
function private function_6546f94c0980e1dd(turret) {
    self endon("death");
    while (true) {
        grenade = turret waittill("missile_fire");
