...
// bitSize: 0x9368, members: 2
struct root {
    // offset: 0x9360, bitSize: 0x8(0x1B)
    ValidationData validationData;
    // offset: 0x0, bitSize: 0x9360(0x126cB)
...
struct CommonData {
    ...
    byte isbad_preview;
    // offset: 0x9f0, bitSize: 0x3708(0x6e1B)
    SharedProgression sharedProgression;
    // offset: 0x40f8, bitSize: 0x20(0x4B)
    int32 firstPlayedSPTime;
    // offset: 0x4118, bitSize: 0x20(0x4B)
    uint32 CODAccountRestrictedTimestamp;
    // offset: 0x4138, bitSize: 0x20(0x4B)
    char loggingCohort[4];
    // offset: 0x4158, bitSize: 0x80(0x10B)
    int32 quartermasterEventIDs[4];
    // offset: 0x41d8, bitSize: 0x20(0x4B)
    int32 common_entitlement_xp;
    // offset: 0x41f8, bitSize: 0x8(0x1B)
    byte useEliteClanTag;
    // offset: 0x4200, bitSize: 0x8(0x1B)
    byte clanTagType;
    // offset: 0x4208, bitSize: 0x120(0x24B)
    uint32 favoriteColors[9];
    // offset: 0x4328, bitSize: 0x8(0x1B)
    byte mp_announcer_type;
    // offset: 0x4330, bitSize: 0x20(0x4B)
    int32 sp_upsell_open_timestamp_0;
    // offset: 0x4350, bitSize: 0x20(0x4B)
    int32 sp_upsell_open_timestamp_1;
    // offset: 0x4370, bitSize: 0xc0(0x18B)
    short common_read_news_articles[12];
    // offset: 0x4430, bitSize: 0x20(0x4B)
    int32 numConsumables;
    // offset: 0x4450, bitSize: 0x20(0x4B)
    int32 lastPlayedTime;
    // offset: 0x4470, bitSize: 0x20(0x4B)
    int32 common_clan_wars_xp;
    // offset: 0x4490, bitSize: 0x38(0x7B)
    MPProgression mpProgression;
    // offset: 0x44c8, bitSize: 0x1d40(0x3a8B)
    FilteredPlaylist filteredPlaylists[26];
    // offset: 0x6208, bitSize: 0x8(0x1B)
    byte season_pass_upsell_count;
    // offset: 0x6210, bitSize: 0x400(0x80B)
    int32 consumablesUsed[32];
    // offset: 0x6610, bitSize: 0x1860(0x30cB)
    int32 awards[195];
    // offset: 0x7e70, bitSize: 0x80(0x10B)
    byte lastMatchGUID[16];
    // offset: 0x7ef0, bitSize: 0x48(0x9B)
    commonCustomization commonCustomization;
    // offset: 0x7f38, bitSize: 0x20(0x4B)
    int32 extraCustomClassesPrestige;
    // offset: 0x7f58, bitSize: 0x190(0x32B)
    PetWatchData petWatchDataTurboAlt;
    // offset: 0x80e8, bitSize: 0x28(0x5B)
    char eliteClanTag[5];
    // offset: 0x8110, bitSize: 0x98(0x13B)
    PastTitleData pastTitleData;
    // offset: 0x81a8, bitSize: 0x190(0x32B)
    PetWatchData petWatchDataBlack;
    // offset: 0x8338, bitSize: 0x190(0x32B)
    PetWatchData petWatchDataTurbo;
    // offset: 0x84c8, bitSize: 0x8(0x1B)
    byte sp_upsell_action_0;
    // offset: 0x84d0, bitSize: 0x8(0x1B)
    byte sp_upsell_action_1;
    // offset: 0x84d8, bitSize: 0x800(0x100B)
    int32 lastLootDrops[64];
    // offset: 0x8cd8, bitSize: 0x200(0x40B)
    PetWatchGoData petWatchGoData;
    // offset: 0x8ed8, bitSize: 0x400(0x80B)
    byte reserved[128];
    // offset: 0x92d8, bitSize: 0x20(0x4B)
    int32 lastLootDropIndex;
    // offset: 0x92f8, bitSize: 0x20(0x4B)
    uint32 favoriteColorsCount;
    // offset: 0x9318, bitSize: 0x1
    bit shouldCheckCohortSampling;
    // offset: 0x9319, bitSize: 0x1
    bit quartermasterSale;
    // offset: 0x931a, bitSize: 0x1
    bit newCrateRewards;
    // offset: 0x931b, bitSize: 0x1
    bit shouldLogCohortData;
    // offset: 0x931c, bitSize: 0x1
    bit gender;
    // offset: 0x931d, bitSize: 0x1
    bit isPrivatePartyOpen;
    // offset: 0x931e, bitSize: 0x1
    bit CODAccountSignupRequest;
    // offset: 0x931f, bitSize: 0x40(0x8B)
    bit spCompletion[64];
    // offset: 0x935f, bitSize: 0x1
    pad __pad[1];
}
...
// bitSize: 0x3708, members: 3
struct SharedProgression {
    // offset: 0x0, bitSize: 0x3700(0x6e0B)
    WeaponLevel weaponLevel[176];
    // offset: 0x3700, bitSize: 0x5
    bit classicWeapons[5];
    // offset: 0x3705, bitSize: 0x3
    pad __pad[3];
}
