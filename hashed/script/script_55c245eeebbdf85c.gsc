...
function function_967c8a57bedde2ee(volume, interactionstruct, var_179343b5981c3088) {
    ...
    level endon("game_ended");
    volume endon("death");
    volume.interact = namespace_5775ad2badedbcaa::register_interact(interactionstruct.origin, interactionstruct.radius, &function_7f0f61d056244f1e);
    volume.interact namespace_5775ad2badedbcaa::function_e6c63f16f2258b80(&function_71b156e80b222071);
...
function private function_7f0f61d056244f1e(player) {
    ...
    if (isdefined(a_squad)) {
        ...
        foreach (squadmember in a_squad) {
            ...
            thread namespace_446fc987a980892f::playevent("RFT_S3_5_RGUQ_Whispers_Drawing", [squadmember]);
        }
    }
    wait 10;
