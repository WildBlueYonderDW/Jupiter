...
#namespace jup_enemy_mp_shotgun_tier2_pmc;

// Namespace jup_enemy_mp_shotgun_tier2_pmc / namespace_446cd61d94d9eb0f
// Params 0, eflags: 0x0
// Checksum 0x0, Offset: 0x269
// Size: 0x1e0
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_mp_shotgun_tier2_pmc" );
