...
function function_b3ff47edf02118d1(deathiconlocation) {
    ...
    if (!scripts\mp\utility\player::isreallyalive(player) && !br_public::isrespawningfromtoken(player) && !var_fbf7a3d9a735ec16 && !istrue(level.useautorespawn) && !var_c4e3fe6f0f6c591d) {
        return;
    }
