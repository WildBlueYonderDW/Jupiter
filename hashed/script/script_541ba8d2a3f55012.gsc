...
/#
    ...
    function init_debug() {
        ...
        function_a2fe753948998c89("<dev string:x5b>", "<dev string:x6b>");
        function_a2fe753948998c89("<dev string:xa7>", "<dev string:xb7>");
        function_a2fe753948998c89("<dev string:xf3>", "<dev string:x103>");
        function_a2fe753948998c89("<dev string:x13f>", "<dev string:x14f>");
        function_a2fe753948998c89("<dev string:x18b>", "<dev string:x19b>");
        function_a2fe753948998c89("<dev string:x1d7>", "<dev string:x1ec>");
