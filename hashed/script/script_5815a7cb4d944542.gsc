...
function private function_f13e664170ab692d(var_8d0b539295ebb58a, var_80fa831937e81d9d) {
    spawnedcache = var_8d0b539295ebb58a waittill("managed_reward_cache_spawn_done");
    ...
    var_80fa831937e81d9d.numwaitingtospawn = var_80fa831937e81d9d.numwaitingtospawn - 1;
...
function private function_eb4ddda3cbeb99b1(activityinstance, rewardgrouptype) {
    ...
    default:
        /#
            assertmsg("rewardGroupType " + rewardgrouptype + " is not recognized by the Nexus. Please check that your rewards bundle is configured correctly");
        #/
        break;
    }
