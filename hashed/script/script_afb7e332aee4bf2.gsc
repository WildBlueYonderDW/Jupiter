...
// Namespace laststand / namespace_d4aab8c9cb8ecb14
// Params 0, eflags: 0x0
// Checksum 0x0, Offset: 0x3aef
// Size: 0x714
function function_29cb39aa7064ed6() {
    if (getdvar(@"hash_e6afce2cf5cf7515") == "1" || level.createfx_enabled) {
        return;
    }
    namespace_9c383b14c4908e46::function_8ece37593311858a(&function_a305799c00d57b2e);
    ...
    level.laststandhealth = getoverridedvarintexceptmatchrulesvalues(hashcat(@"hash_d98c82b5a26dc973", gametype, "_lastStandHealth"), @"scr_player_lastStandHealth");
    level.laststandrevivehealth = getoverridedvarintexceptmatchrulesvalues(hashcat(@"hash_d98c82b5a26dc973", gametype, "_lastStandReviveHealth"), @"scr_player_lastStandReviveHealth");
    ...
    level.laststandweapon = getoverridedvarexceptmatchrulesvalues(hashcat(@"hash_d98c82b5a26dc973", gametype, "_lastStandWeapon"), @"scr_player_lastStandWeapon");
    level.laststandinvulntime = getoverridedvarfloatexceptmatchrulesvalues(hashcat(@"hash_d98c82b5a26dc973", gametype, "_lastStandInvulnTime"), @"scr_player_lastStandInvulnTime");
    level.laststandrevivedecayscale = getoverridedvarfloatexceptmatchrulesvalues(hashcat(@"hash_d98c82b5a26dc973", gametype, "_lastStandReviveDecayScale"), @"scr_player_lastStandReviveDecayScale");
    level.laststandrevivetimer = getoverridedvarfloatexceptmatchrulesvalues(hashcat(@"hash_d98c82b5a26dc973", gametype, "_lastStandReviveTimer"), @"scr_player_lastStandReviveTimer");
    level.laststandsuicidetimer = getoverridedvarfloatexceptmatchrulesvalues(hashcat(@"hash_d98c82b5a26dc973", gametype, "_lastStandSuicideTimer"), @"scr_player_lastStandSuicideTimer");
    level.laststandtimer = getoverridedvarfloatexceptmatchrulesvalues(hashcat(@"hash_d98c82b5a26dc973", gametype, "_lastStandTimer"), @"scr_player_lastStandTimer");
    level.laststandweapondelay = getoverridedvarfloatexceptmatchrulesvalues(hashcat(@"hash_d98c82b5a26dc973", gametype, "_lastStandWeaponDelay"), @"scr_player_lastStandWeaponDelay");
    level.lastStandInvulnAfterRevive = getoverridedvarfloatexceptmatchrulesvalues(hashcat(@"hash_d98c82b5a26dc973", gametype, "_lastStandInvulnAfterRevive"), @"hash_cdc84574d1513280");
...
// Size: 0x53
function function_a305799c00d57b2e() {
...
function function_9b04c8abb560ba40() {
    namespace_162cff1cf88b9bbf::broadcast_status(self, 0);
    entity_num = self getentitynumber();
    self setclientomnvar("ui_client_num", entity_num);
    namespace_6c67e93a4c487d83::setcoopplayerdata_for_everyone("EoGPlayer", entity_num, "ui_client_num", entity_num);
    namespace_6c67e93a4c487d83::setcoopplayerdata_for_everyone("EoGPlayer", entity_num, "laststand_time_ms", 0);
    scripts\cp\utility::function_1dbc717085326045(0, 0, -1);
    self setplayerdata("cp", "EoGPlayer", entity_num, "ui_revivee_entity_num", -1);
    namespace_6c67e93a4c487d83::setcoopplayerdata_for_everyone("EoGPlayer", entity_num, "ui_dog_tags_entity_num", -1);
}
...
function function_a44f7e2d76d0108() {
    ...
    switch (dvar_value) {
    case 0: 
        namespace_162cff1cf88b9bbf::broadcast_status(self, 1);
    case 1: 
        namespace_6c67e93a4c487d83::eog_player_update_stat("downs", 1);
    case 2:
    case 3: 
    ...
    case 5: 
        namespace_6c67e93a4c487d83::setcoopplayerdata_for_everyone("EoGPlayer", entity_num, "ui_client_num", entity_num);
    case 6: 
        namespace_6c67e93a4c487d83::setcoopplayerdata_for_everyone("EoGPlayer", entity_num, "laststand_time_ms", int(timeleft * 1000));
        break;
    }
}
...
function laststandthink(damage_data, dokillcam) {
    ...
    if (istrue(self.shouldskiplaststand)) {
        if (istrue(level.var_2dce4d6dcb6c3fb9)) {
            ...
            namespace_47366e00aa4211f4::function_7c70dc615da72c51();
        }
...
function onenter(damage_data, dokillcam) {
    ...
    if (isdefined(level.var_51c1068f1991312e) && dokillcam) {
        namespace_1b51be0488919ce5::playerkilled_deathscene(level.var_51c1068f1991312e);
    }
    ...
    /#
        if (!function_3ebb302e8386186()) {
            ...
            if (!isdefined(laststandweapon)) {
                laststandweapon = getdvar(@"scr_player_lastStandWeapon", "<dev string:x4d>");
            }
        }
    #/
...
function last_stand_sfx() {
    if (!istrue(self.deathsdoorsfx)) {
        ...
        thread namespace_4887422e77f3514e::function_501be800abf11f33(0.2, 1);
    ...
    /#
        if (!function_3ebb302e8386186()) {
            ...
            if (!isdefined(bleedouttime)) {
                bleedouttime = getdvarfloat(@"scr_player_lastStandTimer", 30);
            }
        }
    #/
    if (bleedouttime <= 0) {
    ...
    /#
        if (!function_3ebb302e8386186()) {
            ...
            if (!isdefined(timeleft)) {
                timeleft = getdvarfloat(@"scr_player_lastStandTimer", 30);
            }
        }
    #/
...
function function_ee33bc0a05a740a4() {
    if (istrue(self.var_b24e609023ce8208)) {
        thread namespace_6250b14b3f614101::playerplaygestureweaponanim("iw8_ges_plyr_self_revive_stim_pistol", 10);
        return;
    }
...
function selfrevivemonitorrevivebuttonpressed() {
    ...
    while (scripts\cp_mp\utility\player_utility::isreallyalive(downedplayer) && selfrevivebuttonpressed(downedplayer) && triggerent.curprogress < triggerent.usetime) {
        ...
        if (istrue(downedplayer.beingrevived)) {
            if (isdefined(triggerent.var_5150a7bb3c2957da)) {
                triggerent.id = triggerent.var_5150a7bb3c2957da;
                triggerent.var_5150a7bb3c2957da = undefined;
            }
        ...
        if (triggerent.id != "self_revive") {
            triggerent.var_5150a7bb3c2957da = triggerent.id;
        }
        ...
        if (triggerent.curprogress >= triggerent.usetime) {
            ...
            namespace_162cff1cf88b9bbf::broadcast_status(downedplayer, 0);
            downedplayer namespace_6250b14b3f614101::removeselfrevivetoken();
...
function updatesquadmemberlaststandreviveprogress(revivee, reviver, progress, var_979d1594b4f7f7be) {
    ...
    if (isdefined(revivee.var_3f78c6a0862f9e25)) {
...
function onexitcommon(revived) {
    ...
    if (scripts\cp\utility::_hasperk("specialty_block_health_regen")) {
        namespace_c4cab616edf9b2b9::removeperk("specialty_block_health_regen");
    }
    laststandweapon = level.laststandweapon;
    /#
        if (!function_3ebb302e8386186()) {
...
function function_804b8b356fff78b2(deathdata) {
    if (isdefined(deathdata) && isdefined(deathdata.attacker) && deathdata.attacker getentitynumber() != worldentnumber()) {
        namespace_1b51be0488919ce5::playerkilled_killcamsetup(deathdata);
    ...
    return namespace_335a44243dec84f3::function_3f8b7ecacb8eb472(deathdata);
}
...
function onbleedout(attacker, lifeid, smeansofdeath, damage_data) {
    ...
    if (gameshouldend && isdefined(level.endgame) && isdefined(level.end_game_string_index)) {
        ...
        level thread [[ level.endgame ]]("axis", level.end_game_string_index["kia"]);
        if (namespace_335a44243dec84f3::function_3f8b7ecacb8eb472(level.var_51c1068f1991312e)) {
    ...
    if (isdefined(self.laststandattacker)) {
        self.laststandattacker thread namespace_5aac85eab99c40a::scoreeventpopup(#"kill_confirmed");
    }
    if (!istrue(level.gameended)) {
...
function ondeath(deathdata) {
    ...
    if (gameshouldend && isdefined(level.endgame) && isdefined(level.end_game_string_index)) {
        ...
        if (namespace_335a44243dec84f3::function_3f8b7ecacb8eb472(deathdata)) {
            namespace_1b51be0488919ce5::playerkilled_deathscene(level.var_51c1068f1991312e);
        }
        level thread [[ level.endgame ]]("axis", level.end_game_string_index["kia"]);
        if (namespace_335a44243dec84f3::function_3f8b7ecacb8eb472(deathdata)) {
    ...
    for (;;) {
        ...
        if (revived) {
            ...
            if (function_7ba31cb6b21c346f()) {
                ...
                thread scripts\cp\cp_player_battlechatter::trysaylocalsound(self.owner, #"hash_a4c67e28dd65b35f");
            }
...
// Size: 0x123
function function_656840b28eb4c279(team, var_35e1ba03a83aa40b, var_db3f492b756b2ce7) {
    level endon("game_ended");
    if (isdefined(self.owner)) {
    ...
    if (revived) {
        ...
        if (function_7ba31cb6b21c346f()) {
            ...
            thread scripts\cp\cp_player_battlechatter::trysaylocalsound(var_b8b0a5e88fae74db, #"hash_a4c67e28dd65b35f");
        }
...
function finishreviveplayer(notifymsg, reviver) {
    ...
    foreach (weapon in revivee getweaponslistprimaries()) {
        if (weapon.clipsize != 0 && !weapon.ismelee) {
            ...
            revivee namespace_6250b14b3f614101::function_4906c10c3ffdd4ca(weapon, currentstock - var_1949291e417ccc24, 1);
        }
    }
...
function function_6ae06d3353229425() {
    ...
    if (isdefined(self.var_f13b2c408fe7ba46)) {
        ...
        if (!isdefined(self.equipment[slot]) || namespace_4fb9dddfb8c1a67a::getequipmentslotammo(slot) == 0) {
            namespace_4fb9dddfb8c1a67a::giveequipment("equip_armorplate", slot);
        }
        namespace_f8d3520d3483c1::function_9c6e9a6643b6c9a6(self.var_f13b2c408fe7ba46);
    ...
    if (notif == "use_hold_think_success") {
        if (isplayer(reviver)) {
            if (!istrue(reviver.can_give_revive_xp)) {
                reviver thread namespace_6099285b4066f63b::doScoreEvent(#"reviver", undefined, undefined, -1);
            } else {
                reviver thread namespace_6099285b4066f63b::doScoreEvent(#"reviver");
        ...
        revivee thread namespace_5aac85eab99c40a::scoreeventpopup(#"revived");
        revivee thread scripts\cp\cp_hud_message::showsplash("revived", undefined, reviver);
        revivee.inlaststand = 0;
        reviver namespace_6c67e93a4c487d83::eog_player_update_stat("revives", 1);
...
function showwaverespawnmessage() {
    wavebased = getdvarint(hashcat(@"hash_d98c82b5a26dc973", scripts\cp\utility::getgametype(), "_waverespawndelay")) > 0;
    if (!wavebased) {
        return;
    }
    self endon("last_stand_finished");
...
function makelaststandinvuln() {
    ...
    var_da0dd27ae8515e57 = gettime() + 1000;
    while (!self isonground() || gettime() > var_da0dd27ae8515e57) {
        waitframe();
    }
...
function callback_playerlaststand(einflictor, attacker, idamage, smeansofdeath, objweapon, vdir, shitloc, psoffsettime, deathanimduration) {
    ...
    if (isdefined(attacker)) {
        ...
        deathdata.isfriendlyfire = namespace_1b51be0488919ce5::isfriendlyfire(self, attacker);
        ...
        if (isdefined(self.carryobject)) {
            ...
            self.carryobject thread namespace_9911c99bb19ddd6a::setdropped();
        }
    }
    if (isplayer(self)) {
...
function playerkilled_precalc(deathdata) {
    ...
    deathdata.iskillstreakweapon = namespace_e0ee43ef2dddadaa::iskillstreakweapon(objweapon.basename);
    deathdata.weaponfullstring = getcompleteweaponname(objweapon);
    deathdata.isfriendlyfire = namespace_1b51be0488919ce5::isfriendlyfire(victim, attacker);
...
function function_229647d24707ecea(deathdata) {
    ...
    if (meansofdeath == "MOD_EXECUTION") {
        attacker namespace_22a50d845d3deb2d::incpersstat("executionKills", 1);
    ...
    if (istrue(level.var_2dce4d6dcb6c3fb9)) {
        ...
        victim namespace_47366e00aa4211f4::function_7c70dc615da72c51();
    }
    ...
    if (scripts\cp\utility::gameflag("prematch_done") && !istrue(victim.hvtnorevive) && istrue(victim.inlaststand)) {
        thread namespace_d4aab8c9cb8ecb14::ondeath(deathdata);
    }
...
function function_937633eb0e6aff1f(deathdata) {
    ...
    /#
        namespace_d4aab8c9cb8ecb14::function_f9249bb06eb48092(deathdata);
    #/
    /#
        namespace_d4aab8c9cb8ecb14::function_af3ebb9d1ecd18e7(deathdata);
    #/
}
...
function playerkilled_fixupattacker(deathdata) {
    ...
    if (isdefined(deathdata.attacker)) {
        ...
        if (deathdata.attacker.code_classname == "script_model" && isdefined(deathdata.attacker.owner)) {
            deathdata.attacker = deathdata.attacker.owner;
            if (!namespace_1b51be0488919ce5::isfriendlyfire(deathdata.victim, deathdata.attacker) && deathdata.attacker != deathdata.victim) {
...
function hide_all_revive_icons(player) {
    foreach (var_7bbe82017efe5c94 in player.revive_icons) {
        var_7bbe82017efe5c94.alpha = 0;
    }
}
...
function has_no_real_weapon(player) {
    var_2622298f62890966 = player getweaponslistall();
...
function record_revive_success(reviver, downedplayer) {
    if (isplayer(reviver)) {
        ...
        reviver namespace_6c67e93a4c487d83::increment_player_career_revives(reviver);
...
// Size: 0x132
function set_revive_icon_color(var_729984070498b386, color, var_56f0b746f85293f) {
    if (istrue(var_729984070498b386.owner.gettingupfromlaststand)) {
        return;
    }
    var_729984070498b386.current_revive_icon_color = color;
    if (isdefined(var_729984070498b386.revive_icons)) {
        var_729984070498b386.revive_icons = array_removeundefined(var_729984070498b386.revive_icons);
    }
    if (istrue(var_56f0b746f85293f) || isdefined(var_729984070498b386.owner.reviver) && !istrue(var_729984070498b386.owner.reviver.isreviving) || !isdefined(var_729984070498b386.owner.reviver)) {
        if (isdefined(var_729984070498b386.revive_icons)) {
            foreach (var_7bbe82017efe5c94 in var_729984070498b386.revive_icons) {
                var_7bbe82017efe5c94.color = color;
            }
        }
    }
}
...
function function_9d6ac1baf6c44970() {
    if (function_f1f7670d27b96e26()) {
        drop_info = namespace_6250b14b3f614101::getitemdroporiginandangles(namespace_7335f9420e698c48::function_b1c55038843de38b(), self.origin, self.angles);
        if (isdefined(self.plundercount) && self.plundercount > 0) {
            namespace_6250b14b3f614101::function_34dc33af893513b2(self.plundercount, namespace_7335f9420e698c48::function_b1c55038843de38b());
            drop_info = namespace_6250b14b3f614101::getitemdroporiginandangles(namespace_7335f9420e698c48::function_b1c55038843de38b(), self.origin, self.angles);
            namespace_6c67e93a4c487d83::set_player_currency(0);
        }
        if (isdefined(self.copy_fullweaponlist)) {
            for (i = 0; i < self.copy_fullweaponlist.size; i++) {
                if (namespace_6250b14b3f614101::function_b3b99f9f9371c997(self.copy_fullweaponlist[i])) {
                    namespace_6250b14b3f614101::weaponspawn(self.copy_fullweaponlist[i], drop_info, 0, 1);
                    drop_info = namespace_6250b14b3f614101::getitemdroporiginandangles(namespace_7335f9420e698c48::function_b1c55038843de38b(), self.origin, self.angles);
                }
            }
        } else if (isdefined(self.primaryweapons)) {
            for (i = 0; i < self.primaryweapons.size; i++) {
                if (namespace_6250b14b3f614101::function_b3b99f9f9371c997(self.primaryweapons[i])) {
                    namespace_6250b14b3f614101::weaponspawn(self.primaryweapons[i], drop_info, 0, 1);
                    drop_info = namespace_6250b14b3f614101::getitemdroporiginandangles(namespace_7335f9420e698c48::function_b1c55038843de38b(), self.origin, self.angles);
        ...
        if (isdefined(self.armorqueued) && self.armorqueued >= 1) {
            dropinfo = namespace_6250b14b3f614101::getitemdroporiginandangles(namespace_7335f9420e698c48::function_b1c55038843de38b(), self.origin, self.angles, self);
            item = namespace_6250b14b3f614101::spawnpickup("brloot_armor_plate", dropinfo, self.armorqueued, 1, undefined, 1);
        }
        if (isdefined(self.pre_laststand_powers)) {
            powers = getarraykeys(self.pre_laststand_powers);
            for (i = 0; i < powers.size; i++) {
                var_d49285246b443066 = namespace_6250b14b3f614101::function_63699875d9aca328(powers[i]);
                dropinfo = namespace_6250b14b3f614101::getitemdroporiginandangles(namespace_7335f9420e698c48::function_b1c55038843de38b(), self.origin, self.angles, self);
                count = self.pre_laststand_powers[powers[i]].charges;
                item = namespace_6250b14b3f614101::spawnpickup(var_d49285246b443066, dropinfo, count, 1, undefined, 0);
            }
        } else if (isdefined(self.powers)) {
            powers = getarraykeys(self.powers);
            for (i = 0; i < powers.size; i++) {
                var_d49285246b443066 = namespace_6250b14b3f614101::function_63699875d9aca328(powers[i]);
                if (isdefined(var_d49285246b443066)) {
                    dropinfo = namespace_6250b14b3f614101::getitemdroporiginandangles(namespace_7335f9420e698c48::function_b1c55038843de38b(), self.origin, self.angles, self);
        ...
        namespace_6250b14b3f614101::function_5cff081d620d2ef3();
    }
}
...
function wait_in_spectator(var_318ade4970c8f647, gameshouldend) {
    ...
    waitframe();
    namespace_162cff1cf88b9bbf::broadcast_status(self, 2);
    ...
    if (is_killed_by_kill_trigger(var_318ade4970c8f647)) {
        var_1a70694e2f9d6d5d = self;
        if (isdefined(self.var_80f9d0aeaa47cc0c) && scripts\cp\cp_outofbounds::isoob(self, 0)) {
            var_1a70694e2f9d6d5d = self.var_80f9d0aeaa47cc0c;
        } else if (isdefined(var_318ade4970c8f647)) {
            var_1a70694e2f9d6d5d = var_318ade4970c8f647;
        }
        spawnloc = drop_to_ground(var_1a70694e2f9d6d5d.origin, 32, -64) + (0, 0, 5);
        spawnangle = var_1a70694e2f9d6d5d.angles;
    } else {
...
function record_bleedout(var_318ade4970c8f647) {
    namespace_6c67e93a4c487d83::eog_player_update_stat("deaths", 1);
    if (!is_killed_by_kill_trigger(var_318ade4970c8f647)) {
...
function show_all_revive_icons() {
    if (isdefined(self.revive_icons)) {
        foreach (var_7bbe82017efe5c94 in self.revive_icons) {
            var_7bbe82017efe5c94.alpha = 1;
        }
    }
}
...
function makereviveicon(reviveiconent, owner, color, bleedouttime) {
    ...
    var_dcc2a5d189acf48d = undefined;
    foreach (player in level.players) {
        if (player == owner) {
        }
        ...
        var_dcc2a5d189acf48d = show_revive_icon_to_player(reviveiconent, player);
        add_to_revive_icon_ent_icon_list(reviveiconent, var_dcc2a5d189acf48d);
    }
    if (isdefined(bleedouttime)) {
        reviveiconent thread revive_icon_color_management(bleedouttime, owner);
    }
    return var_dcc2a5d189acf48d;
}
...
// Size: 0x20
function setup_revive_icon_ent(var_729984070498b386) {
    var_729984070498b386.revive_icons = [];
    add_to_revive_icon_entity_list(var_729984070498b386);
}
...
// Size: 0x51
function add_to_revive_icon_ent_icon_list(var_729984070498b386, var_7bbe82017efe5c94) {
    assertex(!array_contains(var_729984070498b386.revive_icons, var_7bbe82017efe5c94), "<dev string:x34c>");
    var_729984070498b386.revive_icons[var_729984070498b386.revive_icons.size] = var_7bbe82017efe5c94;
}
...
function show_revive_icon_to_player(reviveiconent, owner) {
    var_dcc2a5d189acf48d = newclienthudelem(owner);
    if (level.splitscreen) {
        var_dcc2a5d189acf48d setshader("hud_realism_head_revive", 10, 10);
    } else {
        var_dcc2a5d189acf48d setshader("hud_realism_head_revive", 5, 5);
    }
    var_dcc2a5d189acf48d setwaypoint(1, 1);
    var_dcc2a5d189acf48d settargetent(reviveiconent);
    var_dcc2a5d189acf48d.alpha = get_revive_icon_initial_alpha(owner);
    var_dcc2a5d189acf48d.color = reviveiconent.current_revive_icon_color;
    add_to_player_revive_icon_list(owner, var_dcc2a5d189acf48d);
    var_dcc2a5d189acf48d thread reviveiconcleanup(reviveiconent, owner);
    return var_dcc2a5d189acf48d;
}
...
// Size: 0x51
function add_to_player_revive_icon_list(player, var_7bbe82017efe5c94) {
    assertex(!array_contains(player.revive_icons, var_7bbe82017efe5c94), "<dev string:x380>");
    player.revive_icons[player.revive_icons.size] = var_7bbe82017efe5c94;
}
...
// Size: 0x5a
function remove_from_owner_revive_icon_list(var_7bbe82017efe5c94, owner) {
    if (!isdefined(owner)) {
        return;
    }
    assertex(array_contains(owner.revive_icons, var_7bbe82017efe5c94), "<dev string:x3b7>");
    owner.revive_icons = array_remove(owner.revive_icons, var_7bbe82017efe5c94);
}
...
function revive_use_hold_think(downed_player, reviver, use_ent, use_time) {
    ...
    while (should_revive_continue(reviver)) {
        if (var_14c1392e5d9436bc >= use_time) {
            result = 1;
            break;
        }
        progress_ratio = var_14c1392e5d9436bc / use_time;
        update_players_revive_progress_bar(downed_player, reviver, progress_ratio);
        var_14c1392e5d9436bc += 50;
        waitframe();
    }
...
function lock_player_stance(player) {
    var_e7af06f7a4040877 = player getstance();
    switch (var_e7af06f7a4040877) {
...
function laststandmoveawayfromvehicles(downedplayer, revivetime) {
    ...
    while (curtime < revivetime) {
        if (curtime >= var_abab6bc73fccef65 + 3) {
            var_fa0334fec6ba2bac = vehicle_getarray();
            foreach (vehicle in var_fa0334fec6ba2bac) {
...
function enable_dogtag_revive(downedplayer) {
    ...
    downedplayer.var_f13b2c408fe7ba46 = downedplayer namespace_4fb9dddfb8c1a67a::getequipmentslotammo("health");
    entity_num = downedplayer getentitynumber();
    var_c9f85aefa1694334 = dogtag getentitynumber();
    namespace_6c67e93a4c487d83::setcoopplayerdata_for_everyone("EoGPlayer", entity_num, "ui_dog_tags_entity_num", var_c9f85aefa1694334);
    if (!istrue(downedplayer.var_a14c34f117daf30a)) {
...
// Size: 0x6a
function function_449348b412e6b21(player, target_ent, var_c75370c3a04afa1, bleedouttime) {
    if (getdvarint(@"hash_155dcc14c52dacf8", 1)) {
        return;
    }
    if (!isdefined(var_c75370c3a04afa1)) {
        var_c75370c3a04afa1 = (0.929, 0.231, 0.141);
    }
    reviveiconent = makereviveiconentity(player, target_ent);
    makereviveicon(reviveiconent, player, var_c75370c3a04afa1, bleedouttime);
    return reviveiconent;
}
...
function function_153f83a298faf9c6(player_origin) {
    ...
    if (isdefined(closest_ai) && function_6eeef4a78f8955e7(closest_ai)) {
        closest_ai playsound(random(var_ba3322d31f0514ee));
    }
}
...
function function_79ddac0ef09b8d0f(var_ee13026b48e61129, var_440fa28f4fe729dd) {
    ...
    foreach (player in level.players) {
        if (!isalive(player) || player isspectatingplayer() || istrue(player.inlaststand)) {
            if (player namespace_d4aab8c9cb8ecb14::getbeingrevivedinternal()) {
...
function function_5ad98c689425d831() {
    ...
    namespace_d4aab8c9cb8ecb14::function_9597c3281050a3d8();
}
...
function function_a245aa068aad0c25(slotindex) {
    ...
    foreach (player in level.players) {
        player setclientdvar(hashcat(@"hash_47f4f73e3f1ef221", slotindex, "_desc"), "");
    }
}
...
function checkpoint_revive() {
    ...
    for (checkpoint = 1; true; checkpoint++) {
        ...
        var_9522874ab2bf9c33 = getstructarray("player_checkpoint_" + checkpoint, "targetname");
        foreach (i, player in level.players) {
            if (player_in_laststand(player)) {
                player.respawn_forcespawnorigin = var_9522874ab2bf9c33[i].origin;
                player.respawn_forcespawnangles = var_9522874ab2bf9c33[i].angles;
