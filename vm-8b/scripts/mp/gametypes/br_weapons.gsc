...
function takeweaponpickup(pickupent, var_db943473454f6ea6, weaponstowed, backpackequip, fromkiosk, var_b4b637b07f3f9f25) {
    ...
    foreach (weap in self.primaryweapons) {
        ...
        if (namespace_e0ee43ef2dddadaa::function_72ce982d9fc26f1c(weap)) {
            numprimaries--;
        }
    }
...
// Size: 0x32
function function_c4164078c9f799c0(weapon) {
    weapclass = function_317c33c16e7c1cf4(weapon);
    var_19fa3f93a6b62f59 = function_337d000926ac71f6(weapon);
...
// Size: 0x3a
function function_337d000926ac71f6(weapon) {
    if (istrue(weapon.isalternate)) {
        weapon = weapon getnoaltweapon();
    }
    var_19fa3f93a6b62f59 = weaponclass(weapon getbaseweapon());
...
// Size: 0x35
function function_317c33c16e7c1cf4(weapon) {
    if (istrue(weapon.isalternate)) {
        weapon = weapon getnoaltweapon();
    }
...
function br_ammo_type_for_weapon(weapon) {
    ...
    if (weapon.isalternate && !function_d132e8c198bedadb(weapon)) {
        ...
        return undefined;
    } else if (function_c4164078c9f799c0(weapon)) {
        weapclass = function_32e653f0d47413ae(function_317c33c16e7c1cf4(weapon));
    } else {
