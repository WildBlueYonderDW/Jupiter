...
function function_6ce4cd468e93ecd() {
    ...
    foreach (target in var_dd6dbe56be1a77fe) {
        ...
        if (isdefined(fortress)) {
            ...
            /#
                namespace_d1a9ca87d78d9813::function_9533653868e59fb6("<dev string:x83>", fortress.var_6a9a1aeeaa7c25df, undefined, undefined, undefined, undefined, fortress.poi, fortress.origin);
            #/
        }
    }
}
        ...
        foreach (zone in fortress.spawnzones["high"]) {
            ...
            /#
                if (zone.guardnodes.size < zone.agenttarget) {
                    println("<dev string:x8c>" + zone.origin + "<dev string:xc6>");
                }
            #/
        }
...
function function_401b0949743b45a9(fortress) {
    foreach (node in fortress.props) {
        ...
        if (!istrue(haspartstate)) {
            println("<dev string:xf7>" + node.origin);
...
function function_6d27f6675243f8be() {
    ...
    foreach (var_272bb004283094c7 in level.var_f1073fbd45b59a06.unusedfortresses) {
        ...
        if (distance2dsquared(closestvolume.origin, var_272bb004283094c7.origin) > 2359296) {
            println("<dev string:x170>" + var_272bb004283094c7.origin);
            continue;
        }
        ...
        while (true) {
            ...
            if (value == 1) {
                if (function_2cde636a73aead3d(level.players[0].origin)) {
                    printtoscreen2d(150, 100, "<dev string:x1c6>", (0, 0, 1), 2);
                } else if (function_f59f68adc71d49b3(level.players[0].origin)) {
                    printtoscreen2d(150, 100, "<dev string:x1d2>", (0, 0, 1), 2);
                } else {
                    printtoscreen2d(150, 100, "<dev string:x1e3>", (0, 0, 1), 2);
                }
            }
            if (value == 2) {
                ...
                if (isdefined(fortress)) {
                    ...
                    if (isdefined(agents)) {
                        ...
                        printtoscreen2d(150, 100, "<dev string:x1f3>" + agents.size, (1, 0, 0), 1, 2);
                    }
                }
            }
            waitframe();
