...
function spawntestconvoy(c130pathstruct) {
    ...
    /#
        println("<dev string:x1c>" + var_85ab47ef7f70892e + "<dev string:x51>" + var_76714bf77c396ac3);
        println("<dev string:x58>" + var_4a1a4bec206cbba2[var_85ab47ef7f70892e] + "<dev string:x64>" + var_4a1a4bec206cbba2[var_76714bf77c396ac3]);
        for (i = 0; i < var_4a1a4bec206cbba2.size; i++) {
            println("<dev string:x6a>" + i + "<dev string:x72>" + var_4a1a4bec206cbba2[i]);
        }
    #/
    ...
    for (i = 0; i < var_3dd1974e56ef9f1c; i++) {
        ...
        println("<dev string:x74>" + pathindices[pathindices.size - 1] + "<dev string:x89>" + var_4a1a4bec206cbba2[pathindices[pathindices.size - 1]]);
    }
    /#
        for (i = 0; i < pathindices.size; i++) {
            println("<dev string:x91>" + i + "<dev string:x72>" + pathindices[i]);
        }
    #/
    for (i = 0; i < pathindices.size; i++) {
