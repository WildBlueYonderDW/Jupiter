...
function main() {
    ...
    level.var_59c3f456a9e5d4f0 = &namespace_a3902e911697e714::init;
    ...
    namespace_162cff1cf88b9bbf::init();
    scripts\common\values::register("base_jumping", 0, 0, "$self", &function_f4116328ce66a82d, "$value");
    namespace_9c383b14c4908e46::function_8ece37593311858a(&function_d215b1e8242130cd);
    namespace_9c383b14c4908e46::function_8ece37593311858a(&function_476934ebcf86281d);
    namespace_9c383b14c4908e46::function_8ece37593311858a(&function_6a98c6da3dfa5426);
    namespace_9c383b14c4908e46::function_8ece37593311858a(&function_abe70d559db2e125);
    namespace_9c383b14c4908e46::function_8ece37593311858a(&scripts\common\ai::function_d7edb8535850db35);
    ...
    namespace_162cff1cf88b9bbf::function_d98e304dd9d5d8cd();
    /#
        thread function_699304dd575765c9(@"hash_acbe5067720d755d", &function_95374dd0e3f02eee);
...
/#
    ...
    // Size: 0x1cc
    function function_95374dd0e3f02eee(var_f91e0918144a746e) {
        flag_wait("<dev string:x160>");
        items = strtok(var_f91e0918144a746e, "<dev string:x177>");
        params = strtok(var_f91e0918144a746e, "<dev string:x179>");
        playertoks = strtok(var_f91e0918144a746e, "<dev string:x17b>");
        player = undefined;
        ...
        case #"hash_73a5a0f643a3b82b": 
            if (!istrue(level.var_39d5cd0d288ce8dc)) {
                level.var_39d5cd0d288ce8dc = 1;
            } else {
                level.var_39d5cd0d288ce8dc = 0;
            }
            level.player scripts\cp_mp\utility\game_utility::function_20cb4a5f727abe6e(0);
            thread scripts\cp_mp\utility\game_utility::fadetoblackforplayer(level.player, level.var_39d5cd0d288ce8dc, 0);
            announcement("<dev string:x187>" + level.var_39d5cd0d288ce8dc);
            break;
        case #"hash_cdd70bcaab30dd7d": 
            if (!istrue(level.var_18faea3b4d3b8e5e)) {
                level.var_18faea3b4d3b8e5e = 1;
            } else {
                level.var_18faea3b4d3b8e5e = 0;
            }
            level.player scripts\cp_mp\utility\game_utility::function_20cb4a5f727abe6e(0);
            thread scripts\cp_mp\utility\game_utility::function_852712268d005332(level.player, level.var_18faea3b4d3b8e5e, 0);
            announcement("<dev string:x1a5>" + level.var_18faea3b4d3b8e5e);
            break;
...
function function_d42eac96004b97e0() {
    ...
    while (true) {
        pos = level waittill("friendly_in_combat");
...
function function_fde594d4f618e65a() {
    self endon("PlayerMaskConditionMet");
    while (true) {
        _, _, _, _, _, _, _, _, _, _, _, _, _, inflictor = self waittill("damage");
...
function function_a872c0f90b1595a2() {
    self endon("PlayerMaskConditionMet");
    while (true) {
        ent = self waittill("bulletwhizby");
        if (isplayer(ent)) {
            self notify("PlayerMaskConditionMet");
            return;
        }
...
function function_e73f88105b0ed543() {
    ...
    setdvarifuninitialized(@"hash_7a47bfd5cd2d8123", 0);
    ...
    if (getdvarint(@"hash_302b919208fafa", 0) <= 0) {
        namespace_162cff1cf88b9bbf::registerfalldamagedvars();
    }
    ...
    namespace_da1f3c0af8e51b0f::function_60d43f6a3c2b5f1b(&namespace_751288259782653c::updatemovespeedscale);
    namespace_8235b93197138d09::g_speed_set_func(170);
    level.move_speed_scale = &namespace_751288259782653c::updatemovespeedscale;
    level.getnodearrayfunction = &getnodearray;
    level.prematchfunc = &prematchfunc;
    level.callbackplayerdamage = &namespace_1b51be0488919ce5::callback_playerdamage;
    ...
    level.enter_spectator_func = &namespace_d4aab8c9cb8ecb14::enable_dogtag_revive;
    level.prespawnfromspectatorfunc = &prespawnfromspectatorfunc;
    level.getspawnpoint = &getspawnpoint;
    level.removeselfrevivetoken = &namespace_d4aab8c9cb8ecb14::disable_self_revive;
    ...
    setdvar(@"compassVehicleHideEnemyDistance", -1);
    ...
    setdvar(@"hash_5b44ecf32ea05bb2", 90);
...
function onstartgametype() {
    ...
    namespace_a09f244480e07471::do_starts();
    load_binks();
    function_60d1324a435092b8();
    thread namespace_e99920489a7478d0::init_player_death();
    scripts\cp\utility::set_segmented_health_regen_parameters(100, 100, 25, 2, 1, 0.05);
    namespace_6c67e93a4c487d83::register_eog_to_lb_playerdata_mapping();
    ...
    namespace_6c67e93a4c487d83::rank_init();
    ...
    #/
    level thread namespace_d4aab8c9cb8ecb14::checkpoint_revive();
...
function function_60d1324a435092b8() {
    ...
    level.maxperplayerexplosives = max(getintproperty(@"scr_maxperplayerexplosives", 2), 8);
    ...
    #/
    level thread namespace_5550d2d927c5944f::initcarriables();
    namespace_335a44243dec84f3::init();
    ...
    level thread function_6669f1a0355a9e19();
    level thread function_18606a232217a9be();
...
// Size: 0x6d
function function_6669f1a0355a9e19() {
    ...
    for (;;) {
        ...
        var_b6a57549a0ce42f1 = level.player waittill("player_landed");
...
function function_958370571ded2e92(winner, endReasonTextIndex) {
    level thread namespace_1d99ddaf3fc03543::endgame(winner, endReasonTextIndex);
    if (winner == "allies") {
        namespace_1170726b2799ea65::function_3fc39fc10ef1d9d1(1);
        function_cd65c2cdeeb89a30(namespace_1170726b2799ea65::function_ce720be6f935d1d4(level.mapname), "completed");
        return;
    }
    function_cd65c2cdeeb89a30(namespace_1170726b2799ea65::function_ce720be6f935d1d4(level.mapname), "failed");
}
...
// Size: 0x1c
function function_21d8267ef66746a3(var_386258bb01e2c08, var_f01f8e178ff54eda) {
    self notify("loadout_class_selected", var_386258bb01e2c08);
}
...
function function_47f5bdce6050f955() {
    ...
    thread namespace_6bbbe2460b441162::function_5e7912079314d79a();
    ...
    if (!istrue(self.pers["restarted"]) && namespace_a09f244480e07471::is_first_start()) {
        self freezecontrols(1);
    }
    val::set("cp_spawn", "nvg", 0);
    function_d013543a33878267();
    thread namespace_6250b14b3f614101::function_2ccaa3823e5cb766();
    ...
    if (!var_bb1a64a19851a24d && var_bc038544215707c1) {
        ...
        var_c5dd18f6afdff70b = undefined;
        if (isdefined(var_9d5e14018a42cda5)) {
            var_c5dd18f6afdff70b = spawn("script_model", var_9d5e14018a42cda5.origin);
            var_c5dd18f6afdff70b setmodel("tag_origin");
            var_c5dd18f6afdff70b.angles = (0, 0, 0);
            waitframe();
            self dontinterpolate();
            self cameraunlink();
            self cameralinkto(var_c5dd18f6afdff70b, "tag_origin", 1, 1);
    ...
    var_4c7c8c272a931d5d = level.var_1b908bf18691b097.var_884e10986cbfccc7.var_4c7c8c272a931d5d;
    var_85f6878b365d2b5a = [];
    for (i = 0; i < var_4c7c8c272a931d5d.size; i++) {
        if (istrue(var_4c7c8c272a931d5d[i].isdefault)) {
            itemid = namespace_1170726b2799ea65::function_60bebdf35a6b266f(var_4c7c8c272a931d5d, i, namespace_1170726b2799ea65::function_ce720be6f935d1d4(level.mapname));
    ...
    if (!var_bc038544215707c1) {
        ...
        if (isdefined(var_c5dd18f6afdff70b)) {
            var_c5dd18f6afdff70b delete();
        }
    } else {
        self notify("loadout_class_selected", 1);
        if (!function_aae789091735229f()) {
...
function function_c52192a1d946af6e(equipment) {
    ...
    case #"hash_4059066c2be514e6": 
        ...
        var_cd3915d41574c13 = getstructarray("nvg_pickup", "targetname");
        return (!isdefined(var_cd3915d41574c13) || var_cd3915d41574c13.size == 0 ? -1 : istrue(var_8d100d16b384050b) ? 1 : level.var_1b908bf18691b097.nvg);
    case #"hash_32d233f7333dcec": 
        ascenders = getstructarray("cp_ascender_device", "targetname");
        return (isdefined(ascenders) && ascenders.size > 0 ? level.var_1b908bf18691b097.var_c15a756c46f86d7 : -1);
    case #"hash_6718050cbce9d770": 
        return (level.var_1b908bf18691b097.var_5feb596b2efa27b6 - 1);
    case #"hash_48feb3ef9a8f1c80": 
        activators = getstructarray("cp_parachute_activator", "targetname");
        return (isdefined(activators) && activators.size > 0 ? level.var_1b908bf18691b097.var_5d7f8f33889c093c : 1);
    default: 
        return -1;
    }
}
...
function private function_ed0d19eac2d87abe() {
    ...
    self endon("disconnect");
    while (true) {
        pickupname = level waittill("pickup_hidden");
        if (isdefined(pickupname)) {
            ...
            case #"hash_69a21010d8ea33c6": 
                ...
                level.player thread namespace_1170726b2799ea65::function_525da54dd2ac1fe2(pickupname);
                if (!istrue(level.var_bb3505b72e24c478) && !istrue(level.var_1b908bf18691b097.var_5d7f8f33889c093c)) {
            ...
            case #"hash_f915fbc169649855": 
                ...
                level.player thread namespace_1170726b2799ea65::function_525da54dd2ac1fe2(pickupname);
                if (!istrue(level.var_bb3505b72e24c478) && !istrue(level.var_1b908bf18691b097.var_c15a756c46f86d7)) {
            ...
            case #"hash_ada0805eed9156de": 
                if (!istrue(level.var_bb3505b72e24c478) && isdefined(level.var_1b908bf18691b097.var_5feb596b2efa27b6)) {
                    namespace_1170726b2799ea65::function_58311dfacdcaf94c(self.var_bed158a6dfac230d);
                }
                var_3a84254a9631f527 = self.var_bed158a6dfac230d == namespace_1170726b2799ea65::function_c9e9a9b526daf36a();
                ...
                function_316420283a77f32b("armorCarrier", self.var_bed158a6dfac230d - 1);
...
function private function_d013543a33878267() {
    ...
    foreach (equipment in equipments) {
        ...
        case #"hash_4059066c2be514e6": 
            ...
            break;
        case #"hash_32d233f7333dcec": 
            var_497dc8c08579d3fe = istrue(level.var_bb3505b72e24c478) ? level.player.pers["ascender_device_unlocked"] : istrue(level.var_1b908bf18691b097.var_c15a756c46f86d7);
            level.special_equipment[equipment] = "cp_ascender_device";
            break;
        case #"hash_48feb3ef9a8f1c80": 
            var_497dc8c08579d3fe = istrue(level.var_bb3505b72e24c478) ? level.player.pers["parachute_activator_unlocked"] : istrue(level.var_1b908bf18691b097.var_5d7f8f33889c093c);
...
// Size: 0x145
function function_18606a232217a9be(ai_array, var_e7973285a767ead9, var_fa1ab29bf6705c71, var_4cbcaddbe471ecb1) {
    ...
    foreach (ai in ai_array) {
        if (isalive(ai)) {
            ...
            if (var_cedbb1f41f5e3294 <= var_fa1ab29bf6705c71) {
                ai namespace_14d36171baccf528::despawnagent();
                continue;
            }
...
function private function_33f1e9fdc4b2d1a() {
    ...
    if (!namespace_a09f244480e07471::is_first_start()) {
...
function function_454165a6188e7913() {
    /#
        if (flag("<dev string:x1d2>") && getdvar(@"hash_8cb00b8c1f5ff522", "<dev string:x1c1>") != "<dev string:x1c1>") {
            return true;
        }
    #/
    return false;
...
function function_bc038544215707c1() {
    ...
    return level.var_1b908bf18691b097.var_eb7eef48d12a4125 == 1 && getdvarint(@"hash_f619f65c8609c7d0", 0) == 0;
}
...
function function_3c60e4a82eeaad2e() {
    ...
    level thread namespace_92d3af7d6c233f98::function_5e512a9e89597b21();
    ...
    function_2f892d37929665fa(namespace_1170726b2799ea65::function_ce720be6f935d1d4(level.mapname));
...
function init_enemy_spawner() {
    namespace_74cdb67d92596cfe::spawner_scoring_init();
}
...
function onprecachegametype() {
    ...
    namespace_873a796d1ccabb0c::function_41b2475a04910ba();
    namespace_873a796d1ccabb0c::function_47f4f9f3fa1a644d();
}
...
// Size: 0xed
function function_476934ebcf86281d() {
    ...
    if (rankingenabled()) {
        var_69a07d6024aeb70b = getdvarint(@"online_zombie_party_weapon_xpscale");
        partyxpscale = getdvarint(@"online_zombie_party_xpscale");
...
// Size: 0xc
function function_abe70d559db2e125() {
    self.num_of_plays = [];
}
...
function function_d215b1e8242130cd() {
    ...
    thread namespace_162cff1cf88b9bbf::player_init_health_regen();
    namespace_6c67e93a4c487d83::session_stats_init();
    ...
    namespace_6c67e93a4c487d83::lb_player_update_stat("waveNum", level.wave_num, 1);
    namespace_6c67e93a4c487d83::player_persistence_init();
...
function function_e33b20f5fe616a() {
    level endon("game_ended");
    while (true) {
        channel, index = self waittill("luinotifyserver");
        /#
            if (channel == "<dev string:x238>") {
                map_name = getdvar(@"ui_mapname");
                var_a1f826c73e18485b = "<dev string:x245>" + map_name + "<dev string:x249>";
                var_63a2d0ccb8bc9e6 = tablelookup(var_a1f826c73e18485b, 0, index, 1);
                var_419db796b177b94b = hashcat(@"hash_287b3b75f2c14fe9", map_name);
                setdvarifuninitialized(var_419db796b177b94b, var_63a2d0ccb8bc9e6);
                setdvar(var_419db796b177b94b, var_63a2d0ccb8bc9e6);
                namespace_1d99ddaf3fc03543::function_180b06d3d67d483c("<dev string:x259>");
                namespace_1d99ddaf3fc03543::restart_map(undefined, "<dev string:x26b>");
            }
        #/
        if (function_53aa0268e875eafb()) {
            if (channel == "restart_from_checkpoint") {
                ...
                namespace_1d99ddaf3fc03543::freezeallplayers(1, @"cg_fovScale", 1);
                ...
                namespace_1d99ddaf3fc03543::function_180b06d3d67d483c("Restart From Checkpoint Used");
                wait 2;
                namespace_1d99ddaf3fc03543::restart_map(undefined, "map_restart");
            }
            if (channel == "mission_restart") {
                ...
                namespace_1d99ddaf3fc03543::function_180b06d3d67d483c("Mission Restart Used");
                for (i = 0; i < level.players.size; i++) {
                    level.players[i].ignoreme = 1;
                    level.players[i].ability_invulnerable = 1;
                    level.players[i] notify("force_regeneration");
                }
                namespace_1d99ddaf3fc03543::restart_map(undefined, "pauseMenu_restart");
            }
            continue;
        }
...
function onspawnplayer(fauxspawn) {
    ...
    thread namespace_c4cab616edf9b2b9::watchcombatspeedscaler();
    ...
    namespace_162cff1cf88b9bbf::player_init_invulnerability();
    namespace_162cff1cf88b9bbf::player_init_damageshield();
    thread namespace_ee632c9a776f5f85::function_ed62d4f89b19c4f7();
    thread namespace_d4aab8c9cb8ecb14::function_73707f2512aa6814();
...
function add_player_to_threatbias_group() {
    for (i = 0; i < level.players.size; i++) {
        if (self == level.players[i]) {
            var_64f22d47f382bd43 = i + 1;
            if (var_64f22d47f382bd43 == 5) {
                return;
            }
            self setthreatbiasgroup("player" + var_64f22d47f382bd43);
        }
    }
}
...
function set_spawn_loc(player) {
    ...
    player namespace_162cff1cf88b9bbf::setforcespawninfo(spawnpoint.origin, spawnpoint.angles);
...
function getplayerrespawnloc(downed_player) {
    ...
    var_5dd3d8aa84432ca3 = get_available_respawn_locs();
    if (var_5dd3d8aa84432ca3.size == 0) {
        return get_respawn_loc_near_team_center(downed_player);
    }
    if (var_5dd3d8aa84432ca3.size == 1) {
        return var_5dd3d8aa84432ca3[0];
    }
    return downed_player get_respawn_loc_rated(var_5dd3d8aa84432ca3);
}
...
function get_available_respawn_locs() {
    ...
    foreach (var_c337fc4166b34662 in level.active_player_respawn_locs) {
        ...
        var_5dd3d8aa84432ca3[var_5dd3d8aa84432ca3.size] = var_c337fc4166b34662;
    }
    return var_5dd3d8aa84432ca3;
}
...
// Size: 0x8a
function is_respawn_loc_near_alive_enemies(var_d95ef4bcc28fa1aa) {
    var_ccc9f9c05abcfde9 = scripts\mp\mp_agent::getaliveagentsofteam("axis");
    foreach (var_2e90373c39823c95 in var_ccc9f9c05abcfde9) {
        if (distancesquared(var_2e90373c39823c95.origin, var_d95ef4bcc28fa1aa.origin) < 250000) {
            return true;
        }
    }
    return false;
...
function get_respawn_loc_near_team_center(downed_player) {
    var_5b96a0b63b2da7f = 0;
    var_5b9690b63b2d84c = 0;
    var_5b96c0b63b2dee5 = 0;
    counter = 0;
    var_bf41d0ce35d5c8ec = (var_5b96a0b63b2da7f / counter, var_5b9690b63b2d84c / counter, var_5b96c0b63b2dee5 / counter);
    var_2d6c745afab7a7b1 = sortbydistance(level.active_player_respawn_locs, var_bf41d0ce35d5c8ec);
...
// Size: 0x12f
function get_respawn_loc_rated(var_5dd3d8aa84432ca3) {
    ...
    foreach (var_fdf23b2021e21ba2 in var_5dd3d8aa84432ca3) {
        var_2cec23ddabf59363 = 0;
        foreach (var_c8c0e3cbce8f401a in level.spawned_enemies) {
            var_2cec23ddabf59363 += distancesquared(var_c8c0e3cbce8f401a.origin, var_fdf23b2021e21ba2.origin);
        }
...
function getspawnpoint() {
    ...
    var_267cc90c53834b52 = getstructarray("default_player_start", "targetname");
    if (isdefined(level.default_player_spawns)) {
        var_f0700e8b95517cb = getstructarray(level.default_player_spawns, "targetname");
        if (var_f0700e8b95517cb.size > 0) {
            var_267cc90c53834b52 = var_f0700e8b95517cb;
        }
    }
    if (scripts\engine\utility::issharedfuncdefined("player_spawn", "getPlayerSpawnPointOverride")) {
        ...
        return [[ funcname ]](var_267cc90c53834b52);
    }
    return getassignedspawnpoint(var_267cc90c53834b52);
}
...
function onplayerdisconnect(var_2421296ba8ccb5ee, reason) {
    ...
    namespace_6c67e93a4c487d83::eog_update_on_player_disconnect(var_2421296ba8ccb5ee);
    if (isdefined(level.var_88714f70dbea9fe4)) {
        [[ level.var_88714f70dbea9fe4 ]](var_2421296ba8ccb5ee);
    }
}
...
function function_d099c5897e9877a0() {
    ...
    level endon("game_ended");
    delay, duration = level waittill("show_chyrons");
    if (isdefined(delay)) {
        wait delay;
    }
    show_introscreen_text();
    var_f01533a036a16f09 = 6;
    if (isdefined(duration)) {
        var_f01533a036a16f09 = duration;
    }
    wait var_f01533a036a16f09;
...
function function_ab7b0eb488a92ec2() {
    ...
    map_name = getdvar(@"ui_mapname");
    var_892708eff6520b44 = getdvar(hashcat(@"hash_287b3b75f2c14fe9", map_name), function_62438bc91ac11d42());
    return isdefined(var_892708eff6520b44) && var_892708eff6520b44 != "";
}
...
function show_introscreen_text() {
    ...
    if (isdefined(var_892708eff6520b44) && var_892708eff6520b44 != "") {
...
function callbackplayerkilled(inflictor, attacker, damage, damageflags, meansofdeath, objweapon, direction_vec, hitloc, psoffsettime, deathanimduration) {
    namespace_1b51be0488919ce5::playerkilled_internal(inflictor, attacker, self, damage, damageflags, meansofdeath, objweapon, direction_vec, hitloc, psoffsettime, deathanimduration, 0);
}
...
function enter_laststand(player, attacker) {
    player namespace_6c67e93a4c487d83::eog_player_update_stat("downs", 1);
    ...
    player namespace_47366e00aa4211f4::function_7c70dc615da72c51();
    player namespace_4fb9dddfb8c1a67a::clearallequipment();
    currentweapon = player getcurrentweapon();
    var_66b240bf0b2baff8 = getweaponbasename(currentweapon);
    var_6a3b7f7386ab3be8 = player getcurrentweaponclipammo();
    if (!isdefined(player.downsperweaponlog[var_66b240bf0b2baff8])) {
        player.downsperweaponlog[var_66b240bf0b2baff8] = 1;
    } else {
        player.downsperweaponlog[var_66b240bf0b2baff8]++;
    }
...
function update_laststand_times() {
    ...
    namespace_d4aab8c9cb8ecb14::set_revive_time(normal_revive_time, spectator_revive_time, fast_revive_time);
}
...
function function_52343d5c1b190cf0() {
    ...
    if (scripts\cp_mp\utility\game_utility::function_b2c4b42f9236924()) {
        level.modifyplayerdamage = &namespace_1b51be0488919ce5::gamemodemodifyplayerdamage;
        ...
        namespace_9c383b14c4908e46::function_8ece37593311858a(&function_3708850eab3864c2);
...
function destructible_vehicle_thread() {
    ...
    while (true) {
        note, param = self waittill("scriptableNotification");
        switch (note) {
