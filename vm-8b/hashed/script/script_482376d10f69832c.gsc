...
function function_d7f5721cea7df9c5(reward_instance) {
    ...
    foreach (player in reward_instance.var_6c29f2fdb0054bbe) {
        ...
        if (player scripts\mp\utility\perk::_hasperk("specialty_exfil_contract_percent_reward")) {
            ...
            player namespace_301533d2f1378cb9::function_ddee59d6b1a2b9e(var_7b60c91792761e4f, undefined, 1, undefined, var_527bff0c92d4a0aa);
        }
    }
}
...
function function_24781fccafc7f6dc(cache) {
    ...
    if (istrue(player.var_f618a05d316a2fd6) || istrue(player.var_d34c91079b4d1515) || istrue(player.var_f277fbd58fcf41c8)) {
