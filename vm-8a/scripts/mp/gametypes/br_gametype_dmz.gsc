...
function function_c2a1bc0c5a905217() {
    ...
    namespace_378f8281e2d12ced::function_33bdd4ad6aa14edc(battlechatteroverrides);
}
...
function initpostmain() {
    ...
    level thread namespace_abc7ed0cde8527d4::initsafes();
    if (level.var_eef1d450c2d5d682) {
...
function function_265afd733ff97699(deadplayer) {
    ...
    namespace_446fc987a980892f::playevent("squad_revive_reminder", teamplayers);
}
...
function function_74e0aae435a09a51(player) {
    ...
    var_57ac4dc40b2e376 = player scripts\mp\gametypes\br::calculatebrbonusxp(teamplacement, player.team);
    var_d6a23fdabd1d282c = var_57ac4dc40b2e376[2];
    var_1b70c48b930405f0 = var_57ac4dc40b2e376[1];
    brbonusxp = var_57ac4dc40b2e376[0];
...
function function_d056e6d06ba65ca8(player) {
    ...
    teamplacement = remainingteams.size + 1;
    var_c00a2d6249962fb6 = player scripts\mp\gametypes\br::calculatebrbonusxp(teamplacement, player.team);
    var_d6a23fdabd1d282c = var_c00a2d6249962fb6[2];
    var_1b70c48b930405f0 = var_c00a2d6249962fb6[1];
    brbonusxp = var_c00a2d6249962fb6[0];
    var_b01aca3236595958 = namespace_b5e6108f786dfb5a::function_87ecb716bc207294(player);
    player scripts\mp\gametypes\br::givebrbonusxp(brbonusxp, undefined, "squadEliminated", var_b01aca3236595958);
    player.matchbonus = scripts\mp\rank::function_c18c8bb0776284c6(var_1b70c48b930405f0, var_b01aca3236595958);
    player.placementbonus = scripts\mp\rank::function_9e1336d25eb66326(var_d6a23fdabd1d282c, var_b01aca3236595958);
        ...
        foreach (key, item in self.var_d2dbb2fa012e6d9c) {
            if (isdefined(item)) {
                ...
                if (weaponcount == 3 && isweaponpickup) {
                    ...
                    pickup.var_e97d731bedd44c63 = scripts\mp\gametypes\br_pickups::function_3a5f7703319142dd(item);
                    pickup.instance = item;
                    if (isdefined(item.customweaponname)) {
                        pickup.customweaponname = item.customweaponname;
                    }
                    newweaponinfo = scripts\mp\gametypes\br_weapons::function_55c5d35c8c76a95b(pickup);
...
function endmatchfade(fadedur) {
    ...
    wait fadedur;
    namespace_446fc987a980892f::playevent("exfil_none", [self]);
...
function checktimelimitevents() {
    ...
    if (!level.var_cca4e7f5433dd7d8 && minutesremaining < 30) {
        ...
        namespace_446fc987a980892f::playevent("match_remaining_30", level.players);
    }
    if (!level.var_ccadf0f543480a51 && minutesremaining < 15) {
        level.var_ccadf0f543480a51 = 1;
        namespace_446fc987a980892f::playevent("match_remaining_15", level.players);
    }
    if (!level.var_ccadf3f5434810ea && minutesremaining < 10) {
        level.var_ccadf3f5434810ea = 1;
        namespace_446fc987a980892f::playevent("match_remaining_10", level.players);
    }
    if (!level.var_fc4b2bcc24f36e2a && minutesremaining < 5) {
        level.var_fc4b2bcc24f36e2a = 1;
        namespace_446fc987a980892f::playevent("match_remaining_5", level.players);
    }
    if (!level.var_fc4b28cc24f36791 && minutesremaining <= 0) {
        level.var_fc4b28cc24f36791 = 1;
        namespace_446fc987a980892f::playevent("match_remaining_0", level.players);
    }
}
...
function playerwelcomesplashes(data) {
    ...
    wait 1;
    /#
        if (level.mapname == "<dev string:x1c>" && getdvarint(@"hash_7713e10380b6cb97", 0) == 0) {
...
function function_73bdf8b18e29b13f(players) {
    if (!scripts\mp\gametypes\br_gametypes::isfeaturedisabled("oneLife")) {
        setdynamicdvar(hashcat(@"hash_d98c82b5a26dc973", getgametype(), "_numLives"), 1);
    }
...
function function_1ebd7d347b85cae3() {
    ...
    /#
        if (getdvarint(@"hash_4106b1f86a235e22", 0)) {
            slot = scripts\mp\equipment::findequipmentslot("<dev string:x2c>");
            currentammo = scripts\mp\equipment::getequipmentslotammo(slot);
            scripts\mp\equipment::takeequipment(slot);
            scripts\mp\equipment::giveequipment("<dev string:x2c>", slot, 1);
            player.var_a6dd5c7e74106ce3["<dev string:x2c>"] = 1;
        }
    #/
}
...
function function_adf1fe22b2cd5bd2(player) {
    ...
    if (isdefined(currentstreak) && currentstreak >= getdvarint(@"hash_f5ffdc69acc2ed9e", 2)) {
        namespace_446fc987a980892f::playevent("streak_reminder", [player]);
    ...
    while (true) {
        ...
        foreach (player in aliveplayers) {
            ...
            if (dist >= getdvarint(@"hash_f49edd0604d1e232", 7500)) {
                namespace_446fc987a980892f::playevent("teammates_far_away_nag", aliveplayers);
                break;
            }
        }
        wait getdvarint(@"hash_69b4eb1d49243c68", 120);
...
/#
    ...
    function function_f7920586b5a59226() {
        while (true) {
            ...
            if (type) {
                ...
                switch (type) {
                case 2: 
                    splash = "<dev string:x37>";
                    break;
                case 3: 
                    splash = "<dev string:x55>";
                    break;
                case 4: 
                    splash = "<dev string:x73>";
                    break;
                case 5: 
                    splash = "<dev string:x91>";
                    break;
                default: 
                    splash = "<dev string:xaf>";
                    break;
                }
    ...
    function function_2ff493cd8ff03634() {
        while (true) {
            ...
            if (type) {
                ...
                splash = "<dev string:xcb>";
                poiname = undefined;
                if (type == 2) {
                    splash = "<dev string:xdd>";
                }
                if (type == 3) {
                    splash = "<dev string:xf5>";
                }
                if (type == 4) {
                    splash = "<dev string:x108>";
                }
                if (type == 5) {
                    splash = "<dev string:x120>";
                }
                poiname = "<dev string:x136>";
                if (type == 6) {
                    splash = "<dev string:x141>";
                }
                poiname = "<dev string:x136>";
                if (type == 7) {
                    splash = "<dev string:x159>";
                }
                if (type == 8) {
                    combineddata = 2 | 48;
                    splash = "<dev string:x178>";
                    level.var_cc9e990b6e83975b = 0;
                ...
                if (type == 9) {
                    splash = "<dev string:x195>";
                }
                if (type == 10) {
                    splash = "<dev string:x1b1>";
                }
                scripts\mp\gametypes\br_gametype_dmz::showdmzsplash(splash, level.players, poiname);
            }
            ...
            if (state != -1) {
                ...
                level.players[0] setclientomnvar("<dev string:x1ca>", state);
            }
            state = getdvarint(@"hash_5e0729bf2d69d066", 0);
            if (state) {
                setdvar(@"hash_5e0729bf2d69d066", 0);
                level.players[0] setclientomnvar("<dev string:x1ec>", 1);
            }
            wait 1;
        }
    }
        ...
        while (true) {
            ...
            if (getdvarint(@"hash_84a792cec0ba5b7c", 0) == 1) {
                ...
                foreach (team in level.teamnamelist) {
                    players = level.teamdata[team]["<dev string:x207>"];
    ...
    function function_459e2558e6d936ed() {
        while (true) {
            if (getdvarint(@"hash_b72ce628db69ef4b", 0)) {
                ...
                restock = spawnscriptable("<dev string:x20f>", level.players[0].origin, level.players[0].angles);
            }
            if (getdvarint(@"hash_edc010da9e9d687b", 0)) {
                setdvar(@"hash_edc010da9e9d687b", 0);
                cache = spawnscriptable("<dev string:x22b>", level.players[0].origin, level.players[0].angles);
                cache setscriptablepartstate("<dev string:x247>", "<dev string:x24c>");
            }
            if (getdvarint(@"hash_25f4358ca3b846e3", 0)) {
                setdvar(@"hash_25f4358ca3b846e3", 0);
                cache = spawnscriptable("<dev string:x25a>", level.players[0].origin, level.players[0].angles);
                cache setscriptablepartstate("<dev string:x247>", "<dev string:x24c>");
            }
            if (getdvarint(@"hash_8ca28a9d28344f", 0)) {
                setdvar(@"hash_8ca28a9d28344f", 0);
                laptop = spawnscriptable("<dev string:x276>", level.players[0].origin, level.players[0].angles);
                harddrive = spawnscriptable("<dev string:x287>", level.players[0].origin, level.players[0].angles);
    ...
    function function_dc98aeb4dd4b727a() {
        while (true) {
            if (getdvarint(@"hash_f2cfce8dc99e0fd4", 0)) {
                ...
                hostage = spawnscriptable("<dev string:x29b>", level.players[0].origin, level.players[0].angles);
                hostage setscriptablepartstate("<dev string:x29b>", "<dev string:x2a7>");
                for (i = 0; i < 5; i++) {
                    plate = spawnscriptable("<dev string:x2ae>", level.players[0].origin + 32 * function_6174330574a2a273(), level.players[0].angles);
                    plate setscriptablepartstate("<dev string:x2ae>", "<dev string:x2c1>");
                }
            }
            if (getdvarint(@"hash_db675935826560a", 0)) {
                setdvar(@"hash_db675935826560a", 0);
                spawnscriptable("<dev string:x2c8>", level.players[0].origin, level.players[0].angles);
                for (i = 0; i < 5; i++) {
                    plate = spawnscriptable("<dev string:x2ae>", level.players[0].origin + 32 * function_6174330574a2a273(), level.players[0].angles);
                    plate setscriptablepartstate("<dev string:x2ae>", "<dev string:x2c1>");
                }
    ...
    function function_37eaf2bc0bb3e28a() {
        ...
        foreach (name, data in level.var_1b7407dffe81e6e8.spawndatamap) {
            if (name == "<dev string:x2da>") {
                nodes[name] = namespace_5ffce5a43b2d1ec2::function_a07f7c4c0c4ef8e3();
            }
            if (name == "<dev string:x2df>") {
                nodes[name] = namespace_e1bfa87a2a692d3c::function_a07f7c4c0c4ef8e3();
            }
            if (name == "<dev string:x2e3>") {
                nodes[name] = namespace_4f4cbea0f5b0bdb8::function_a07f7c4c0c4ef8e3();
            }
            if (name == "<dev string:x2ea>") {
                nodes[name] = namespace_300f9f7dca7fc109::function_a07f7c4c0c4ef8e3();
            }
            if (name == "<dev string:x2ef>") {
                nodes[name] = namespace_b11859036e02907d::function_a07f7c4c0c4ef8e3();
            }
            if (name == "<dev string:x2f4>") {
                nodes[name] = namespace_fa9fd40f68ab8478::function_a07f7c4c0c4ef8e3();
            }
            if (name == "<dev string:x2fa>") {
                nodes[name] = namespace_b8c00f1eafbbd213::function_a07f7c4c0c4ef8e3();
            }
            if (name == "<dev string:x2ff>") {
                nodes[name] = namespace_30baceecda213256::function_a07f7c4c0c4ef8e3();
            }
            if (name == "<dev string:x303>") {
                nodes[name] = namespace_232aeaeb467df5bd::function_a07f7c4c0c4ef8e3();
            }
            if (name == "<dev string:x30b>") {
                nodes[name] = namespace_38da3c68826ceb02::function_a07f7c4c0c4ef8e3();
            }
            if (name == "<dev string:x310>") {
                nodes[name] = namespace_168c086126cfa488::function_a07f7c4c0c4ef8e3();
            }
            if (name == "<dev string:x31d>") {
                nodes[name] = namespace_d0483bb41cd4e112::function_a07f7c4c0c4ef8e3();
            }
            if (name == "<dev string:x327>") {
                nodes[name] = namespace_210d6dd43cfaf195::function_a07f7c4c0c4ef8e3();
            }
        }
        nodes["<dev string:x334>"] = getstructarray("<dev string:x334>", "<dev string:x33e>");
        nodes["<dev string:x349>"] = getstructarray("<dev string:x351>", "<dev string:x33e>");
        nodes["<dev string:x30b>"] = getstructarray("<dev string:x35d>", "<dev string:x366>");
        nodes["<dev string:x378>"] = getstructarray("<dev string:x378>", "<dev string:x33e>");
        nodes["<dev string:x384>"] = getstructarray("<dev string:x396>", "<dev string:x33e>");
        nodes["<dev string:x3ab>"] = getstructarray("<dev string:x3ba>", "<dev string:x366>");
        nodes["<dev string:x3cc>"] = getstructarray("<dev string:x3cc>", "<dev string:x366>");
        nodes["<dev string:x3df>"] = getstructarray("<dev string:x3df>", "<dev string:x366>");
        nodes["<dev string:x3f1>"] = getstructarray("<dev string:x3f1>", "<dev string:x366>");
        nodes["<dev string:x409>"] = getstructarray("<dev string:x409>", "<dev string:x366>");
        nodes["<dev string:x421>"] = getstructarray("<dev string:x421>", "<dev string:x366>");
        nodes["<dev string:x43d>"] = getstructarray("<dev string:x43d>", "<dev string:x366>");
        nodes["<dev string:x453>"] = getstructarray("<dev string:x453>", "<dev string:x366>");
        nodes["<dev string:x46d>"] = getentitylessscriptablearray("<dev string:x477>", "<dev string:x490>");
        while (true) {
            dvar = getdvar(@"hash_5d80cf4f5ced4150", "<dev string:x49a>");
            if (dvar != "<dev string:x49a>") {
...
function function_e1fa80f536692a32() {
    while (true) {
        ...
        if (getdvarint(@"hash_77012bc5215f715e", 0)) {
            ...
            /#
                printtoscreen2d(50, 50, "<dev string:x49f>" + items.size);
            #/
...
function function_effb4f29bf72a97b(targetnoteworthy) {
    ...
    println("<dev string:x4ac>" + var_3bafc217f6706130);
    return startpoints;
}
...
function getspawnpoint() {
    ...
    if (!isdefined(self.team) || !isdefined(level.teamdata) || !isdefined(level.teamdata[self.team])) {
        ...
        /#
            println("<dev string:x4be>" + self.name);
            println("<dev string:x4cc>" + self.sessionteam);
            println("<dev string:x4ee>" + "<dev string:x501>" + point.origin[0] + "<dev string:x504>" + point.origin[1] + "<dev string:x504>" + point.origin[2] + "<dev string:x507>");
        #/
    ...
    if (!isdefined(level.teamdata[self.team]["startPoint"])) {
        ...
        /#
            if (isdefined(self.team)) {
                namespace_d1a9ca87d78d9813::function_9533653868e59fb6("<dev string:x50a>", self.team, undefined, undefined, undefined, undefined, level.teamdata[self.team]["<dev string:x510>"].poi, level.teamdata[self.team]["<dev string:x510>"].origin);
            }
        #/
    }
...
function function_11750957aa915a23() {
    ...
    /#
        ...
        level notify("<dev string:x51b>");
        setomnvar("<dev string:x52f>", 5);
        level waittill("<dev string:x542>");
        setomnvar("<dev string:x52f>", 9);
    #/
}
...
function function_f1c3982d13453d32(streakitem, slotnumber) {
    if (getdvarint(@"hash_3d843517229cd382", 1) && isdefined(level.samsites)) {
        if (namespace_7afff53e7b73476b::function_f3354ddc02e867c9(streakitem)) {
            return 0;
        }
    }
        ...
        foreach (node in connectednodes) {
            if (isdefined(node.script_noteworthy)) {
                ...
                if (issubstr(script_noteworthy, "guard")) {
                    namespace_bfef6903bca5845d::spawnguard(node, 1, 1, "medium", "extraGuards");
                    continue;
                }
                if (script_noteworthy == "patrolstart" || issubstr(script_noteworthy, "patrolpath")) {
                    ...
                    namespace_bfef6903bca5845d::spawnpatrol(pathstruct, 1, 2, undefined, "high", "extraPatrols");
                }
            }
        }
    }
...
function function_f3a2435f8e39438b() {
    ...
    foreach (player in level.players) {
        ...
        if (level.mapname != "mp_bio_lab" && isdefined(matchcount) && matchcount < matchlimit) {
            namespace_446fc987a980892f::playevent(random(["mission_reminder_1", "mission_reminder_2"]), [player]);
        }
    }
}
    ...
    while (true) {
        ...
        foreach (agent in var_1c4f6d991c751924) {
            if (isdefined(agent) && isagent(agent) && isalive(agent)) {
                ...
                fakeowner = namespace_bfef6903bca5845d::function_af3034a7c69d7edb(agent.team);
...
function function_39aceb03c0aace46(player, meansofdeath) {
    ...
    foreach (nationality, var_cb2f0f5908924bc1 in player.var_c669906a542b9baf) {
        ...
        if (var_cb2f0f5908924bc1 == int(level.var_a3de977788317ef5 / 3) && namespace_14d36171baccf528::function_46c0de7595d8cab2(player, var_24316e3669fb6dda)) {
...
/#
    ...
    function function_6a65488b49f1f350() {
        ...
        while (true) {
            ...
            if (debugdvar == 1) {
                foreach (poiname in level.var_34858ba8086735c6) {
                    agents = function_7e3f22e620f3f71e(poiname, "<dev string:x560>");
    ...
    function function_c574618f682ba25e() {
        ...
        while (true) {
            ...
            if (debugdvar == 1) {
                foreach (poiname in level.var_34858ba8086735c6) {
                    killstreakLocs = scripts\mp\poi::function_1af8a41e4c1252c7(poiname, "<dev string:x56a>");
                    foreach (killstreakLoc in killstreakLocs) {
    ...
    function function_53542cd8fe181d7() {
        ...
        while (true) {
            ...
            if (debugdvar == 1) {
                foreach (poiname in level.var_34858ba8086735c6) {
                    firelocs = scripts\mp\poi::function_1af8a41e4c1252c7(poiname, "<dev string:x579>");
                    foreach (fireloc in firelocs) {
                        if (!isdefined(fireloc.script_parameters)) {
                            continue;
                        }
    ...
    function function_3fd2d65f62ca31b0() {
        ...
        pickup = scripts\mp\gametypes\br_pickups::spawnpickup("<dev string:x585>", dropinfo);
        ...
        pickup = scripts\mp\gametypes\br_pickups::spawnpickup("<dev string:x59e>", dropinfo);
    }
