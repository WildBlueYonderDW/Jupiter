...
function function_49df6ae49b0cbe54(player, origin) {
    ...
    scores["valuables"] = level.huntprops.var_15b2bbc2239d50e1 * player namespace_301533d2f1378cb9::function_b86115649d705017();
    return scores;
}
...
function function_632b43ad8c51d71(var_92eea146514289f2) {
    ...
    if (var_92eea146514289f2) {
        ...
        foreach (player in var_b733333748d3f129) {
            namespace_76a219af07c28c13::function_bb4125d6847af349(player, "contract_target");
        }
        return;
    }
    level.var_aab4fba7a041b281 = array_remove_array(level.var_aab4fba7a041b281, var_b733333748d3f129);
    foreach (player in var_b733333748d3f129) {
        namespace_76a219af07c28c13::function_59cf08630dd70540(player, "contract_target");
    }
}
