...
function private function_e7f010f72a055377() {
    ...
    /#
        namespace_d1a9ca87d78d9813::function_9533653868e59fb6("<dev string:x3f>", self.activity.name, undefined, "<dev string:x1c>", undefined, undefined, self.activity.poi, origin);
    #/
    cache.task = self;
    self.cache = cache;
    ...
    function function_d781a77d91710067() {
        while (true) {
            if (getdvarint(@"hash_3f7460cd0a96699d", 0)) {
                ...
                task.cache setscriptablepartstate("<dev string:x1c>", "<dev string:x50>");
