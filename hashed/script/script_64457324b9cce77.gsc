...
function function_450e4cf17da1bc5(weapon, itembundle, item, auto_use) {
    ...
    if (upgradetype == "ammomod") {
        ...
        if (namespace_a4ff02beedc1bce8::can_pap(weapon)) {
            paplv = namespace_a4ff02beedc1bce8::get_pap_level(weapon);
            var_84bda2c733869e7c = itembundle.rarity;
            if (isdefined(var_84bda2c733869e7c)) {
                ...
                case 2: 
                    if (paplv == 0) {
                        ...
                        namespace_a4ff02beedc1bce8::pap_weapon(weapon, paplv);
                        return (item.count - 1);
                    }
                    break;
                case 3: 
                    if (paplv == 0 || paplv == 1) {
                        ...
                        paplv = 1;
                        self playsoundtoplayer("evt_aetherium_crystal_use", self);
                        namespace_a4ff02beedc1bce8::pap_weapon(weapon, paplv, undefined, var_26a62bdd3e2cd19a);
                        return (item.count - 1);
                    }
                    break;
                case 4: 
        ...
        if (issharedfuncdefined("ob_disciple_bottle", "spawn_disciple_pet")) {
            self playsoundevent("sndevent_classified_acquisition_used");
            self [[ getsharedfunc("ob_disciple_bottle", "spawn_disciple_pet") ]]();
            return (item.count - 1);
        }
    }
...
function function_24d050ba31898496(itembundle, item, autouse, allowswap) {
    ...
    if (istrue(namespace_e0ee43ef2dddadaa::iskillstreakweapon(weapon)) && !function_d56493bc318d5c5a(itembundle, item)) {
        return false;
    }
    if (upgradetype == "ammomod") {
