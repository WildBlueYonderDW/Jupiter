...
function function_2dcca6d862cc31d5(params) {
    ...
    if (getdvarint(@"hash_8e03c888469910b0", 0)) {
        namespace_7b853fc16496a9b1::function_b60de1b748c7230f();
    }
    if (getdvarint(@"hash_ad8d5450e8812fde", 0)) {
...
function function_7e3b3e54fd85da26() {
    ...
    thread function_87c128cff95b5d57();
    ...
    activity_common::function_8b5b2a3392fc7e2a("ActivityBegin", &function_cce044c80f7ca41e, "REV_OB_OUTLAST");
    activity_common::function_8b5b2a3392fc7e2a("ActivityBegin", &function_cce044c80f7ca41e, "REV_OB_BIGBOUNTY");
    activity_common::function_8b5b2a3392fc7e2a("ActivityBegin", &function_cce044c80f7ca41e, "REV_OB_ESCORT_ZOMBIES");
    activity_common::function_8b5b2a3392fc7e2a("ActivitySuccess", &function_b6697d395d77e302, "REV_OB_OUTLAST");
    activity_common::function_8b5b2a3392fc7e2a("ActivitySuccess", &function_b6697d395d77e302, "REV_OB_BIGBOUNTY");
    activity_common::function_8b5b2a3392fc7e2a("ActivitySuccess", &function_b6697d395d77e302, "REV_OB_ESCORT_ZOMBIES");
...
function function_61aea37385c298a9(params) {
    ...
    thread namespace_446fc987a980892f::playevent("s3_rr_portal_spawn", [self], 0.5);
}
    ...
    if (isdefined(player) && part == "nexus_activity_joiner_phone") {
        foreach (obelisk in level.Obelisks) {
            if (obelisk.activityinstance.type == instance.activity_instance.type) {
                ...
                thread function_c5c782caa574255f(item);
                player namespace_2abc885019e1956::function_576728d3d4486bd6(item, 0, 0, 0);
        ...
        if (isdefined(var_cd6b3ace7362b192)) {
            thread namespace_446fc987a980892f::playevent(var_cd6b3ace7362b192, level.players, 4.5);
        }
...
// Size: 0x3a
function function_cce044c80f7ca41e(var_b6d035b4e3489246) {
...
// Size: 0x23
function function_b6697d395d77e302(var_6f8af5eb76deac21) {
...
function function_8d61e53700cfa26d() {
    ...
    thread namespace_446fc987a980892f::playevent("s3_rr_arrive", level.players, 7);
}
...
function function_3d203d1752c3714c() {
    ...
    level.var_54c6f60291f6049a = utility::spawn_model("jup_zm_rift_run_cyclone", var_17fbc4ea1388535e.origin, var_17fbc4ea1388535e.angles);
}
...
function function_d58ad4f904032ed0() {
    ...
    foreach (var_7bd2768769ec27ca in var_3c0264cdf25b5bdb) {
        var_a01dfb6cde8f348e = var_7bd2768769ec27ca.script_noteworthy;
        level.Obelisks[var_a01dfb6cde8f348e] = spawnstruct();
        level.Obelisks[var_a01dfb6cde8f348e].base = spawnscriptable("jup_zm_rift_altar", var_7bd2768769ec27ca.origin, var_7bd2768769ec27ca.angles);
        level.Obelisks[var_a01dfb6cde8f348e].base.var_49833d40d310dcb8 = var_a01dfb6cde8f348e;
        level.Obelisks[var_a01dfb6cde8f348e].top = spawnscriptable("jup_zm_rift_altar_top", var_7bd2768769ec27ca.origin + (0, 0, 40), var_7bd2768769ec27ca.angles);
        ...
        namespace_5775ad2badedbcaa::function_32645103f7520635(level.Obelisks[var_a01dfb6cde8f348e].base, &function_c0b488aa76c77316, undefined, &function_3940ad0af0562d02);
        level.Obelisks[var_a01dfb6cde8f348e].base namespace_5775ad2badedbcaa::function_e6c63f16f2258b80(&function_dda97bcf0f20e53f);
...
// Size: 0xb6
function function_c5c782caa574255f(item) {
...
function private function_a911ba043cf91b47() {
    ...
    thread namespace_c7b56f74bc8bd1ce::function_a5b76e0f5024cc9a(level.var_5ab941ab8b7ca1bd, "players_near_heart", 3000, 1, "weakpoints_defeated", 0, 0);
...
function private function_6c863f8d5cda37cf(var_c2d35eda877c6b2c, var_76753b341c69cd90) {
    if (isdefined(level.var_190c066f1b962111[var_76753b341c69cd90]) && isdefined(level.var_190c066f1b962111) && isdefined(var_76753b341c69cd90) && isdefined(var_c2d35eda877c6b2c) && isdefined(level.var_190c066f1b962111[var_76753b341c69cd90].item_bundle)) {
        return namespace_2abc885019e1956::function_c465d27f3f6066b4(level.var_190c066f1b962111[var_76753b341c69cd90].item_bundle, var_c2d35eda877c6b2c, (0, 0, 0), 1, 1);
    } else {
...
function function_e31bb9a7109b02bb(player) {
    foreach (var_3385d73d20c9b3d8 in level.var_190c066f1b962111) {
        if (isdefined(var_3385d73d20c9b3d8.var_7994f872ac0cd2cd) && var_3385d73d20c9b3d8.var_7994f872ac0cd2cd == player && isdefined(var_3385d73d20c9b3d8.var_50b449d2553ac489)) {
            item = [[ var_3385d73d20c9b3d8.var_50b449d2553ac489 ]](player.origin, var_3385d73d20c9b3d8.itemtype);
        }
    }
}
...
function function_f7d395f2f09077dd(params) {
    ...
    if (function_c3d2fefa443b3a22(self) && !istrue(params.var_feef4b237a6beb07) && (params.shitloc == "head" || params.shitloc == "neck" || params.shitloc == "helmet") && params.smeansofdeath != "MOD_MELEE") {
        ...
        dmgmodifier = function_59957d924fbc58e0(params.objweapon, params.shitloc, var_cc5a11780bf1efb0);
...
function function_67a4fbdf5f4c5d94(var_e49ce046b0ea3e3d) {
    ...
    self endon("death");
    while (true) {
        ent = var_e49ce046b0ea3e3d waittill("trigger");
        if (isplayer(ent)) {
            if (!istrue(self.var_e7d1ea8c5f5eae24)) {
                self.var_e7d1ea8c5f5eae24 = 1;
                var_9919b2cae1b0b78 = namespace_1c689dd3986a841c::spawn_request("ai_encounter:" + "enc_ob_s3_hydro_rift_run_damage", level.var_e0eabcf3e2b9c0da.origin, level.var_e0eabcf3e2b9c0da.radius, 0, 1);
...
function function_c783cee7dbc9575c(var_ed6902a570df45a5) {
    ...
    self endon("death");
    while (true) {
        ent = var_ed6902a570df45a5 waittill("trigger");
        if (isplayer(ent)) {
            if (!istrue(self.var_883d2ecf94f85a5f)) {
                self.var_883d2ecf94f85a5f = 1;
                var_564b8996b53e8223 = namespace_1c689dd3986a841c::spawn_request("ai_encounter:" + "enc_ob_s3_hydro_rift_run_movement", level.var_5a23243b27ec2602.origin, level.var_5a23243b27ec2602.radius, 0, 1);
...
function function_eb6c4f407b06d7d7(var_6ccb60434f6c1c28) {
    ...
    self endon("death");
    while (true) {
        ent = var_6ccb60434f6c1c28 waittill("trigger");
        if (isplayer(ent)) {
            if (!istrue(self.var_4b0148bc226207d2)) {
                self.var_4b0148bc226207d2 = 1;
                var_2145bda107ad1c2a = namespace_1c689dd3986a841c::spawn_request("ai_encounter:" + "enc_ob_s3_hydro_rift_run_vision", level.var_49a91aa847fad815.origin, level.var_49a91aa847fad815.radius, 0, 1);
...
// Size: 0x2d5
function function_87c128cff95b5d57() {
    var_790f35dd57e633e4 = getstructarray("arteryspawn", "targetname");
    level.var_85a85964b56787d8 = [];
    level.var_4e288ca6b67852 = 0;
    foreach (struct in var_790f35dd57e633e4) {
        ...
        weakpoint.shield.aitypeid = function_2336488258354fbc(#"aitype", %"hash_c1cd7460b629486");
...
function function_dd1de37a34de7820(e_shield) {
    ...
    while (isalive(e_shield)) {
        damage, attacker, direction_vec, point, smeansofdeath, modelname, tagname, partname, idflags, weapon, sorigin, angles, normal, einflictor, eventid = e_shield waittill("damage");
        e_shield.health = 100;
        thread function_6246344836fa47f7(einflictor, attacker, self, damage, idflags, smeansofdeath, weapon, normal, point);
    }
}
...
function function_14a1d8fbf92cd97(params) {
    if (isdefined(params.instance.shield_health) && params.instance.shield_health > 0) {
        ...
        params.eattacker namespace_e072c8407b2a861c::updatehitmarker("hitresolute", params.instance.health <= 0, 0, 0, undefined);
...
// Size: 0x478
function function_6246344836fa47f7(einflictor, eattacker, instance, idamage, idflags, smeansofdeath, objweapon, vdir, shitloc, modelindex, partname) {
    level endon("game_ended");
    ...
    if (!function_80f3ebd3a5b5b432() && is_equal(instance.type, "jup_zm_rift_weakpoint")) {
        function_51b521e60a5390ca(eattacker, instance, smeansofdeath, objweapon);
        return;
    }
    ...
    if (function_80f3ebd3a5b5b432() && is_equal(instance.type, "jup_zm_rift_weakpoint")) {
        ...
        if (instance.health <= 0) {
            ...
            foreach (ai in var_e724d95f4de4fdb5) {
                ai namespace_db1ce2c035564e2c::function_e96aac065abbec4e(var_a4bdc2718d388075);
            }
            if (level.var_4e288ca6b67852 >= level.var_85a85964b56787d8.size) {
                level notify("weakpoints_completed");
                level.var_5ab941ab8b7ca1bd function_f9d964480130473f();
            } else {
                level.var_5ab941ab8b7ca1bd.shield setscriptablepartstate("damage_states", "damage_state_" + level.var_4e288ca6b67852 + 1);
            }
        }
...
function function_4bb2f4017b25f5d3() {
    var_703b5f448b03e81 = getstruct("heartspawn", "targetname");
    navmesh_pos = getclosestpointonnavmesh(var_703b5f448b03e81.origin);
    ground_pos = getgroundposition(navmesh_pos, 1);
    rayinfo = trace::ray_trace(ground_pos + (0, 0, 12), ground_pos - (0, 0, 999));
    raynormal = rayinfo["normal"];
    var_5ab941ab8b7ca1bd = spawnscriptable("jup_zm_rift_heart", ground_pos - (0, 0, 1), raynormal);
    var_5ab941ab8b7ca1bd setscriptablepartstate("body", "spawned");
    var_5ab941ab8b7ca1bd.shield = utility::spawn_model("jup_zm_heart_shell", ground_pos - (0, 0, 1), raynormal);
    var_5ab941ab8b7ca1bd.shield solid();
    var_5ab941ab8b7ca1bd.shield.aitypeid = function_2336488258354fbc(#"aitype", %"hash_638c5a9aa5146c68");
    var_5ab941ab8b7ca1bd.shield.var_534e788bc498be9f = getscriptbundle(%"hash_29ceeef6c31e0bfb");
    var_5ab941ab8b7ca1bd.shield.subclass = var_5ab941ab8b7ca1bd.shield.var_534e788bc498be9f.name;
    var_5ab941ab8b7ca1bd.shield setcandamage(1);
    var_5ab941ab8b7ca1bd.shield.health = 7000;
    var_5ab941ab8b7ca1bd.shield.navobstacleid = createnavobstaclebyent(var_5ab941ab8b7ca1bd.shield);
    var_5ab941ab8b7ca1bd thread function_efa5b8e5e2cb6d3c(var_5ab941ab8b7ca1bd.shield);
    var_5ab941ab8b7ca1bd.spore_base = spawnscriptable("jup_ob_zombie_control_spore_base", ground_pos, raynormal);
    level.var_5ab941ab8b7ca1bd = var_5ab941ab8b7ca1bd;
    var_5ab941ab8b7ca1bd.shield.identifier = "jup_zm_rift_heart";
    var_5ab941ab8b7ca1bd.shield.weakpoint = var_5ab941ab8b7ca1bd;
    var_5ab941ab8b7ca1bd callback::add("heart_shield_damaged", &function_8d1334d4c835a5b);
    var_5ab941ab8b7ca1bd.health = 8000;
    var_5ab941ab8b7ca1bd setscriptablepartstate("health", "damage_detect");
    var_5ab941ab8b7ca1bd function_4205fad7b0bab020();
    var_5ab941ab8b7ca1bd thread function_8ebaa43ed2640274();
}
...
function function_8ebaa43ed2640274() {
    ...
    level.var_5ab941ab8b7ca1bd setscriptablepartstate("ground_vfx", "active");
    level waittill("heart_destroyed");
    level.var_5ab941ab8b7ca1bd setscriptablepartstate("ground_vfx", "disabled");
    ...
    if (function_86305a10c0580c9() && is_equal(instance.type, "jup_zm_rift_heart")) {
        ...
        if (instance.health <= 0) {
            ...
            foreach (ai in var_227c6710f39c1f7) {
                ai namespace_db1ce2c035564e2c::function_e96aac065abbec4e(var_6c50b9f4f4172857);
            }
        }
        instance.shield.fake_health = instance.health;
        instance setscriptablepartstate("spore_damage", "impact");
...
function function_9e433ff809422ffa() {
    ...
    thread namespace_446fc987a980892f::playevent("s3_rr_heart_exposed", level.players, 0.5);
}
...
function function_eb58b3302b0dcfb8() {
    ...
    agent = scripts\mp\mp_agent::spawnnewagentaitype("jup_spawner_zombie_disciple_s3_rr", level.var_5ab941ab8b7ca1bd.origin, level.var_5ab941ab8b7ca1bd.angles, "team_two_hundred");
    level.var_7f26f0ab75172e97 = agent;
    waitframe();
    agent.var_e23d72f180832aa = 1;
    agent function_65cdab0fc78aba8f(level.var_5ab941ab8b7ca1bd.origin, 4096);
    ...
    thread namespace_446fc987a980892f::playevent("s3_rr_disciple_spawned", level.players, 2.5);
    /#
...
function function_157eba852e9f6ccc(data, isdebug) {
    ...
    var_8232fe13bffb624 = istrue(isdebug) ? level.players[0].origin : level.var_5ab941ab8b7ca1bd.origin;
    var_f064b76727edb83a = namespace_71ca15b739deab72::function_3ae7f99339b96499(var_8232fe13bffb624);
    a_players = level.players[0] namespace_ca7b90256548aa40::getsquadmembers();
    ...
    namespace_e8853d3344e33cf6::function_863be9e39e19fe2f(reward_groups, var_f064b76727edb83a, &function_e01530991969a465, undefined, var_3c99a2a84c4b850f);
    if (!istrue(isdebug)) {
...
function function_904e96c563b1581d(sparams) {
    ...
    if (!istrue(self.var_667de86d25eebb9b) && self.health <= self.maxhealth * 0.33) {
        ...
        namespace_446fc987a980892f::playevent("s3_rr_disciple_low_health", level.players);
    }
}

// Namespace namespace_6faadab2b3f756a1 / namespace_72d85a5f3cb24eec
// Params 0, eflags: 0x0
// Checksum 0x0, Offset: 0x6794
// Size: 0x97
...
function ob_ambient_zombie_waves_setup(difficulty) {
    ...
    if (isdefined(var_5e64675a5f0ce8cb) && !isdefined(level.var_c9f71ccc98610c37)) {
        level.var_c9f71ccc98610c37 = namespace_614554f86e52695c::spawn_request("ai_encounter:enc_ob_s3_hydro_rift_run_ambient_zombie_waves", var_5e64675a5f0ce8cb.origin, var_5e64675a5f0ce8cb.radius, 1, 0, 0);
...
function function_8894dff666d97dd4(requestid, userdata, var_9f82bb66fd374ef5) {
    ...
    if (isdefined(var_9f82bb66fd374ef5) && isdefined(requestdata)) {
        ...
        aitypes = [];
        var_dee92f874c6bcf57 = requestdata.var_a0e7c1e4fa26235e + 1;
        ...
        level.var_c45e3dbe3f74f8bc.var_dee92f874c6bcf57 = var_dee92f874c6bcf57;
...
/#
    ...
    function function_2476244023968f4b() {
        ...
        while (true) {
            ...
            if (!isdefined(level.var_c45e3dbe3f74f8bc)) {
                ...
                function_6c9dbd2f5d5a6f02("<dev string:x33b>");
                function_6c9dbd2f5d5a6f02("<dev string:x360>" + level.var_c45e3dbe3f74f8bc.var_dee92f874c6bcf57);
    ...
    function function_32d14a03db893f0e() {
        level.players[0] namespace_feea61bc660e9e0f::function_4b5b6b5953138fe7(getscriptbundle("<dev string:x396>" + "<dev string:x3a9>"), 1);
        level.players[0] namespace_feea61bc660e9e0f::function_4b5b6b5953138fe7(getscriptbundle("<dev string:x396>" + "<dev string:x3d3>"), 1);
        level.players[0] namespace_feea61bc660e9e0f::function_4b5b6b5953138fe7(getscriptbundle("<dev string:x396>" + "<dev string:x3fc>"), 1);
        params = spawnstruct();
        ...
        level.players[0] on_item_pickup(params);
        foreach (obelisk in level.Obelisks) {
            obelisk.base function_c0b488aa76c77316(level.players[0]);
            wait 0.5;
        }
    }
