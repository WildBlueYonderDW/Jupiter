...
function function_2689681546ac00b4() {
    ...
    foreach (zoneduration in level.brgametype.zonedurations) {
        matchduration = matchduration + zoneduration;
    }
    foreach (zoneactivationdelay in level.brgametype.var_adafbaf3c7e24ad3) {
        matchduration = matchduration + zoneactivationdelay;
    }
...
function function_43d0931e0c776713(team) {
    ...
    foreach (player in teamplayers) {
        ...
        var_d46bc9be217ec18d = var_d46bc9be217ec18d - player.pointsmultiplier;
    }
...
function function_adebca556fbb1224(time, type) {
    level.brgametype.addedtime = level.brgametype.addedtime + time;
    if (isdefined(type)) {
...
function function_60afa719948a5de2(points, zone, var_7a58fc3a248245b0) {
    ...
    if (!istrue(var_7a58fc3a248245b0)) {
        points = points * player.pointsmultiplier;
    }
...
function debug_init() {
    /#
        scripts/common/devgui::function_6e7290c8ee4f558b("dialog");
        scripts/common/devgui::function_a9a864379a098ad6("lead_lost", "zncn_grav_vccf", &function_2e238c75db4dd1de);
        scripts/common/devgui::function_a9a864379a098ad6("_secured", "zc_mvp", &function_1423f70cfe3c2937);
        scripts/common/devgui::function_a9a864379a098ad6("medic", "1", &function_1b4adfc797fdf296);
...
function function_63bf192d1fd856e5(roundindex) {
    ...
    totalscore = totalscore / level.brgametype.activezones.size;
    eventparams = [];
    eventparams[eventparams.size] = "round_index";
    eventparams[eventparams.size] = roundindex;
