...
function function_bc4d94fa05ac7078(str_perk) {
    ...
    println("<dev string:x1c>" + level.gamemodebundle.pricelist + "<dev string:x5c>" + str_perk + "<dev string:x62>" + "<dev string:x73>");
    return "essence";
}
...
function private function_ea6ad508534fc509(str_perk) {
    ...
    if (isdefined(var_c82bc608d1423259) && isdefined(var_c82bc608d1423259.var_fff87512f24a9908)) {
        ...
        println("<dev string:x7b>" + level.gamemodebundle.pricelist + "<dev string:x5c>" + str_perk);
    }
}
...
/#
    ...
    function function_2e0cc380e14c340b(currency_type) {
        ...
        scripts\common\devgui::function_b23a59dfb4ca49a1("<dev string:xc8>" + currency_type, "<dev string:xd2>" + currency_type, &function_382bfcbb2e043576, 0);
    ...
    function function_382bfcbb2e043576(params) {
        ...
        foreach (player in level.players) {
            ...
            iprintln(currency_type + "<dev string:xe5>");
        }
    }
