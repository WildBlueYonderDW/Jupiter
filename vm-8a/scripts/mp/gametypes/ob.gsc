...
function function_1cb9f6a2397a8029(var_c1074ab6cac2169f, pingtype, pingindex) {
    ...
    if (calloutmarkerping::function_c648f0fd527e089a(pingtype)) {
        ...
        case 17: 
            /#
                iprintln("<dev string:xea>");
            #/
        case 18: 
            /#
                iprintln("<dev string:x114>");
            #/
        case 2: 
            /#
                iprintln("<dev string:x13e>");
            #/
            break;
        case 6: 
            /#
                iprintln("<dev string:x166>");
            #/
...
function private function_6d402ea224e021c2(params) {
    println("<dev string:x1b6>" + params.index);
...
function private function_5b696bb30d753873(params) {
    ...
    println("<dev string:x1d1>" + name + "<dev string:x1e3>" + params.index + "<dev string:x1ee>" + params.memberindex);
...
function private function_f629d46279a25c95(params) {
    name = isdefined(self.name) ? self.name : "unknown";
    println("<dev string:x1fd>" + name + "<dev string:x1e3>" + params.index + "<dev string:x1ee>" + params.memberindex);
                            ...
                            if (!istrue(self.vehicle.var_d547bf7eec5d2fc3)) {
                                /#
                                    if (getdvarint(@"hash_cedfd894822951d7", 0) == 1) {
                                        println("<dev string:x21d>" + zombie.aicategory);
                                        println("<dev string:x232>" + zombie.origin);
                                        println("<dev string:x243>" + self.vehicle.origin);
                                        println("<dev string:x25a>" + distancesquared(zombie.origin, self.vehicle.origin));
                                    }
                                #/
...
/#
            ...
            if (int(getdvar(@"hash_a7493d6bda4d686b", 0)) == 1) {
                ...
                if (isdefined(enemies) && enemies.size > 0) {
                    foreach (enemy in enemies) {
                        ...
                        print3d(enemy.origin + (0, 0, 60), "<dev string:x27c>" + currenthelmet + "<dev string:x28c>" + maxhelmet);
                        print3d(enemy.origin + (0, 0, 80), "<dev string:x28e>" + var_815f2cee6f7f75cd + "<dev string:x28c>" + maxarmor);
                    }
                }
            }
            waitframe();
    ...
    function function_ce34466b3cece887(params) {
        ...
        ammo_mods = ["<dev string:x29d>", "<dev string:x2a6>", "<dev string:x2af>", "<dev string:x2bb>", "<dev string:x2c6>"];
        perks = ["<dev string:x2d3>", "<dev string:x2e7>", "<dev string:x2fd>", "<dev string:x310>", "<dev string:x324>", "<dev string:x33c>", "<dev string:x357>", "<dev string:x36a>"];
        supers = ["<dev string:x37e>", "<dev string:x392>", "<dev string:x3a5>", "<dev string:x3b7>", "<dev string:x3c9>", "<dev string:x3de>"];
        raygun_weapon = "<dev string:x3f0>";
        var_7a072bf64e5a9686 = "<dev string:x401>";
        var_c7c6de07e094477d = [];
        var_c7c6de07e094477d["<dev string:x41e>"] = [];
        var_c7c6de07e094477d["<dev string:x41e>"]["<dev string:x421>"] = "<dev string:x426>";
        var_c7c6de07e094477d["<dev string:x41e>"]["<dev string:x445>"] = "<dev string:x44b>";
        var_c7c6de07e094477d["<dev string:x41e>"]["<dev string:x470>"] = "<dev string:x475>";
        var_c7c6de07e094477d["<dev string:x41e>"]["<dev string:x499>"] = "<dev string:x4a0>";
        var_c7c6de07e094477d["<dev string:x41e>"]["<dev string:x4c6>"] = "<dev string:x4cd>";
        var_c7c6de07e094477d["<dev string:x4f3>"] = [];
        var_c7c6de07e094477d["<dev string:x4f3>"]["<dev string:x421>"] = "<dev string:x4fb>";
        var_c7c6de07e094477d["<dev string:x4f3>"]["<dev string:x445>"] = "<dev string:x51c>";
        var_c7c6de07e094477d["<dev string:x4f3>"]["<dev string:x470>"] = "<dev string:x543>";
        var_c7c6de07e094477d["<dev string:x4f3>"]["<dev string:x499>"] = "<dev string:x569>";
        var_c7c6de07e094477d["<dev string:x4f3>"]["<dev string:x4c6>"] = "<dev string:x591>";
        ...
        foreach (player in level.players) {
            name = isdefined(player.name) ? player.name : "<dev string:x5f4>";
            zombie_perks::function_33e402afcb6d2c04([name]);
            waitframe();
            if (!utility::is_equal(power_level, "<dev string:x5fc>")) {
                player armor::setArmorHealth(self.maxarmorhealth);
                waitframe();
                player armor::function_9c6e9a6643b6c9a6(1);
                waitframe();
                ...
                waitframe();
                player currency::function_3036cef61495210f("<dev string:x60b>", 10000);
                waitframe();
            }
            if (utility::is_equal(give_weapon, "<dev string:x613>") && !utility::is_equal("<dev string:x5e5>")) {
                weapon_name = var_c7c6de07e094477d["<dev string:x41e>"]["<dev string:x421>"];
                if (isdefined(weapon_rarity)) {
                    weapon_name = var_c7c6de07e094477d["<dev string:x41e>"][weapon_rarity];
                }
                fakeitem = spawnstruct();
                var_d7732d0238eae9ff = 180;
                item_entry = weapon_name;
                item_bundle = getscriptbundle("<dev string:x61e>" + item_entry);
                ...
                wait 1.5;
                weapon_name = var_c7c6de07e094477d["<dev string:x4f3>"]["<dev string:x421>"];
                if (isdefined(weapon_rarity)) {
                    weapon_name = var_c7c6de07e094477d["<dev string:x4f3>"][weapon_rarity];
                }
                fakeitem = spawnstruct();
                var_d7732d0238eae9ff = 180;
                item_entry = weapon_name;
            ...
            case #"hash_b76c1b30b726b92c": 
                ...
                break;
            case #"hash_40f74392d7695be8": 
                if (utility::is_equal(give_weapon, "<dev string:x613>")) {
                    fakeitem = spawnstruct();
                    var_d7732d0238eae9ff = weaponmaxammo(raygun_weapon);
                    item_bundle = getscriptbundle("<dev string:x61e>" + var_7a072bf64e5a9686);
                    item_scriptable = item_bundle.scriptable;
                    fakeitem.count = common_item::function_7209c8cd4b2e3afd(var_d7732d0238eae9ff);
                    player common_item::function_7f6f62ba8dfd0da0(item_bundle, fakeitem);
                    wait 0.25;
    ...
    function function_85bb0f2f9de2f140(params) {
        ...
        foreach (player in level.players) {
            ...
            player setclientomnvar("<dev string:x64b>", issuccessful);
            player setclientomnvar("<dev string:x665>", 1);
        }
    }
    ...
    function function_69cc0ae8201249ac() {
        foreach (player in level.players) {
            ...
            player setclientomnvar("<dev string:x64b>", 0);
            player setclientomnvar("<dev string:x665>", 0);
        }
    }
    ...
    function ob_devgui() {
        ...
        waitframe();
        devgui::function_6e7290c8ee4f558b("<dev string:x683>");
        devgui::function_b23a59dfb4ca49a1("<dev string:x691>", "<dev string:x69f>", &function_bfd214941fe81721, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:x6b3>", "<dev string:x6c1>", &function_bfd214941fe81721, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:x6d5>", "<dev string:x6e7>", &function_bfd214941fe81721, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:x6fe>", "<dev string:x70f>", &function_bfd214941fe81721, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:x725>", "<dev string:x738>", &function_bfd214941fe81721, 0);
        devgui::function_fe953f000498048f();
        waitframe();
        devgui::function_6e7290c8ee4f558b("<dev string:x750>");
        devgui::function_a9a864379a098ad6("<dev string:x75a>", "<dev string:x765>", &function_4dbb22600ebb3c58, 0);
        devgui::function_a9a864379a098ad6("<dev string:x770>", "<dev string:x781>", &function_548326adbe72c4c3, 0);
        devgui::function_fe953f000498048f();
        waitframe();
        devgui::function_6e7290c8ee4f558b("<dev string:x792>");
        devgui::function_b23a59dfb4ca49a1("<dev string:x7c6>", "<dev string:x7d2>", &function_ce34466b3cece887, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:x7fc>", "<dev string:x809>", &function_ce34466b3cece887, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:x834>", "<dev string:x840>", &function_ce34466b3cece887, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:x86a>", "<dev string:x878>", &function_ce34466b3cece887, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:x8a4>", "<dev string:x8b2>", &function_ce34466b3cece887, 0);
        devgui::function_fe953f000498048f();
        devgui::function_6e7290c8ee4f558b("<dev string:x8de>");
        devgui::function_b23a59dfb4ca49a1("<dev string:x906>", "<dev string:x919>", &function_ce34466b3cece887, 0);
        devgui::function_fe953f000498048f();
        devgui::function_6e7290c8ee4f558b("<dev string:x93c>");
        devgui::function_b23a59dfb4ca49a1("<dev string:x7c6>", "<dev string:x970>", &function_ce34466b3cece887, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:x7fc>", "<dev string:x999>", &function_ce34466b3cece887, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:x834>", "<dev string:x9c3>", &function_ce34466b3cece887, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:x86a>", "<dev string:x9ec>", &function_ce34466b3cece887, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:x8a4>", "<dev string:xa17>", &function_ce34466b3cece887, 0);
        devgui::function_fe953f000498048f();
        devgui::function_6e7290c8ee4f558b("<dev string:xa42>");
        devgui::function_b23a59dfb4ca49a1("<dev string:x906>", "<dev string:xa6a>", &function_ce34466b3cece887, 0);
        devgui::function_fe953f000498048f();
        devgui::function_6e7290c8ee4f558b("<dev string:xa8c>");
        devgui::function_b23a59dfb4ca49a1("<dev string:x7c6>", "<dev string:xac0>", &function_ce34466b3cece887, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:x7fc>", "<dev string:xae9>", &function_ce34466b3cece887, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:x834>", "<dev string:xb13>", &function_ce34466b3cece887, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:x86a>", "<dev string:xb3c>", &function_ce34466b3cece887, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:x8a4>", "<dev string:xb67>", &function_ce34466b3cece887, 0);
        devgui::function_fe953f000498048f();
        devgui::function_6e7290c8ee4f558b("<dev string:xb92>");
        devgui::function_b23a59dfb4ca49a1("<dev string:x906>", "<dev string:xbba>", &function_ce34466b3cece887, 0);
        devgui::function_fe953f000498048f();
        devgui::function_6e7290c8ee4f558b("<dev string:xbdc>");
        devgui::function_b23a59dfb4ca49a1("<dev string:x7c6>", "<dev string:xc10>", &function_ce34466b3cece887, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:x7fc>", "<dev string:xc3b>", &function_ce34466b3cece887, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:x834>", "<dev string:xc67>", &function_ce34466b3cece887, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:x86a>", "<dev string:xc92>", &function_ce34466b3cece887, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:x8a4>", "<dev string:xcbf>", &function_ce34466b3cece887, 0);
        devgui::function_fe953f000498048f();
        devgui::function_6e7290c8ee4f558b("<dev string:xcec>");
        devgui::function_b23a59dfb4ca49a1("<dev string:x906>", "<dev string:xd14>", &function_ce34466b3cece887, 0);
        devgui::function_fe953f000498048f();
        devgui::function_6e7290c8ee4f558b("<dev string:xd38>");
        devgui::function_b23a59dfb4ca49a1("<dev string:xd5d>", "<dev string:xd69>", &function_ce34466b3cece887, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:x906>", "<dev string:xd8e>", &function_ce34466b3cece887, 0);
        devgui::function_fe953f000498048f();
        waitframe();
        if (getdvarint(@"hash_10f0811105fc2f93", 0)) {
            devgui::function_6e7290c8ee4f558b("<dev string:xdb1>");
            devgui::function_b23a59dfb4ca49a1("<dev string:xdc8>", "<dev string:xdd0>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:xdf0>", "<dev string:xdf8>", &common_item::function_f8162124bbb6ece3);
            devgui::function_fe953f000498048f();
            devgui::function_6e7290c8ee4f558b("<dev string:xe20>");
            devgui::function_b23a59dfb4ca49a1("<dev string:xe34>", "<dev string:xe47>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:xe64>", "<dev string:xe81>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:xea8>", "<dev string:xebc>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:xeeb>", "<dev string:xefb>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:xf28>", "<dev string:xf38>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:xf65>", "<dev string:xf77>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:xfa6>", "<dev string:xfc1>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:xfed>", "<dev string:x1006>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x102d>", "<dev string:x1045>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x106b>", "<dev string:x1084>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x10af>", "<dev string:x10c7>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x10f1>", "<dev string:x1107>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1142>", "<dev string:x1160>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x11a3>", "<dev string:x11bc>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x11fa>", "<dev string:x121b>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1261>", "<dev string:x1276>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x12b0>", "<dev string:x12cd>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x130f>", "<dev string:x132b>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x136c>", "<dev string:x1382>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x13b2>", "<dev string:x13c9>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x13fa>", "<dev string:x1407>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1426>", "<dev string:x1433>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1452>", "<dev string:x145f>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x147e>", "<dev string:x148b>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x14aa>", "<dev string:x14be>", &common_item::function_f8162124bbb6ece3);
            devgui::function_fe953f000498048f();
            devgui::function_6e7290c8ee4f558b("<dev string:x14f2>");
            devgui::function_b23a59dfb4ca49a1("<dev string:x150a>", "<dev string:x1512>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x153e>", "<dev string:x154d>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1576>", "<dev string:x1583>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x15aa>", "<dev string:x15b4>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x15d8>", "<dev string:x15e6>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x160e>", "<dev string:x161f>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1648>", "<dev string:x165b>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1686>", "<dev string:x1697>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x16c0>", "<dev string:x16d1>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x16fa>", "<dev string:x170d>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1738>", "<dev string:x1743>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1768>", "<dev string:x1772>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1796>", "<dev string:x17a6>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x17cf>", "<dev string:x17dd>", &common_item::function_f8162124bbb6ece3);
            devgui::function_fe953f000498048f();
            devgui::function_6e7290c8ee4f558b("<dev string:x1805>");
            devgui::function_b23a59dfb4ca49a1("<dev string:x181d>", "<dev string:x1825>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1848>", "<dev string:x1850>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1873>", "<dev string:x187e>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x18a4>", "<dev string:x18b1>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x18d7>", "<dev string:x18e3>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x190a>", "<dev string:x1915>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x193a>", "<dev string:x1953>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1980>", "<dev string:x198f>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x19b0>", "<dev string:x19c0>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x19eb>", "<dev string:x1a01>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1a31>", "<dev string:x1a3b>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1a5d>", "<dev string:x1a72>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1a9f>", "<dev string:x1ab3>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1adf>", "<dev string:x1aee>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1b14>", "<dev string:x1b21>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1b49>", "<dev string:x1b54>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1b7a>", "<dev string:x1b83>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1ba6>", "<dev string:x1baa>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1bc9>", "<dev string:x1bda>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1bfc>", "<dev string:x1c07>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1c2c>", "<dev string:x1c41>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1c70>", "<dev string:x1c7d>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1ca4>", "<dev string:x1cb2>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1cdb>", "<dev string:x1ce2>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1d04>", "<dev string:x1d0e>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1d33>", "<dev string:x1d3b>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1d5e>", "<dev string:x1d65>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1d87>", "<dev string:x1d99>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1db8>", "<dev string:x1dc4>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1deb>", "<dev string:x1dff>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1e29>", "<dev string:x1e35>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1e5c>", "<dev string:x1e67>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1e8d>", "<dev string:x1ea4>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1ec3>", "<dev string:x1ec9>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1eea>", "<dev string:x1ef5>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1f15>", "<dev string:x1f1f>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1f44>", "<dev string:x1f51>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1f79>", "<dev string:x1f80>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1fa2>", "<dev string:x1fb1>", &common_item::function_f8162124bbb6ece3);
            devgui::function_fe953f000498048f();
            devgui::function_6e7290c8ee4f558b("<dev string:x1fd7>");
            var_590e41714d712137 = getscriptbundle("<dev string:x1ff1>" + "<dev string:x2000>");
            if (isdefined(var_590e41714d712137)) {
                foreach (itementry in var_590e41714d712137.itementries) {
                    ...
                    devgui::function_b23a59dfb4ca49a1(itementry.itemspawnentry, "<dev string:x2018>" + itementry.itemspawnentry, &common_item::function_f8162124bbb6ece3);
                }
            }
            devgui::function_fe953f000498048f();
            devgui::function_6e7290c8ee4f558b("<dev string:x2024>");
            devgui::function_b23a59dfb4ca49a1("<dev string:x2040>", "<dev string:x2048>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x206c>", "<dev string:x2070>", &common_item::function_f8162124bbb6ece3);
            devgui::function_fe953f000498048f();
        }
        devgui::function_6e7290c8ee4f558b("<dev string:x2091>");
        devgui::function_b23a59dfb4ca49a1("<dev string:x2099>", "<dev string:x20a9>", &function_85bb0f2f9de2f140, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:x20b8>", "<dev string:x20c8>", &function_85bb0f2f9de2f140, 0);
        devgui::function_a9a864379a098ad6("<dev string:x20d7>", "<dev string:x20e1>", &function_69cc0ae8201249ac, 0);
        devgui::function_fe953f000498048f();
    }
...
function function_d6d378c8b68bc20b() {
    ...
    /#
        adddebugcommand("<dev string:x20f4>");
    #/
}
...
function private getstartspawnpoint(player) {
    ...
    if (!isdefined(spawnpoint) && level.var_7a8e039103b51e0f.size) {
        ...
        if (isdefined(spawnpoint)) {
            println("<dev string:x20f9>" + player.sessionsquadid + "<dev string:x213a>" + player.var_3f78c6a0862f9e25 + "<dev string:x214b>");
...
function private function_781ce82d9ee85375(player) {
    ...
    /#
        iprintlnbold("<dev string:x217a>" + player.sessionsquadid + "<dev string:x21b6>");
    #/
    return undefined;
}
