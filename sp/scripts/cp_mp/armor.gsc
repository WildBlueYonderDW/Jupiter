...
function function_1b593d5e688a409c()
{
    ...
    if ( istrue( level.var_fb2b3c3db6061df5 ) )
    {
        var_8f098991d1e07346 = self.platecarrierlevel << 9;
    ...
    if ( var_7820f81ee1adf7b9 || function_244067e915c0eabe() && !istrue( victim.inlaststand ) )
    {
        ...
        if ( !istrue( var_94974807c7dc3acf ) || function_244067e915c0eabe() )
        {
            ...
            else
            {
                ...
                var_84b2b2a1586de527 = istrue( level.var_fb2b3c3db6061df5 ) && isdefined( victim.platecarrierlevel ) && victim.platecarrierlevel >= 3;
                doscoreevents = 0;
...
// Size: 0x9a
function clampstepdamage( var_be4285b26ed99ab1, weapon, stepclamp )
{
...
{
    return isdefined( victim ) && isdefined( victim.platecarrierlevel ) && victim.platecarrierlevel >= 2 && var_1da1a66b5c6a06a7 > 0 && isdefined( victim.armorhealth ) && victim.armorhealth > 50;
}
...
{
    return isdefined( victim ) && isdefined( victim.platecarrierlevel ) && isdefined( level.var_4b78859bacc88808 ) && victim.platecarrierlevel >= 3 && var_1da1a66b5c6a06a7 > 0 && victim.armorhealth + var_1da1a66b5c6a06a7 > level.var_4b78859bacc88808 * 2;
}
...
{
    return isdefined( victim ) && isdefined( victim.platecarrierlevel ) && victim.platecarrierlevel >= 3 && armorvest_wasbroke( attacker ) && idamage == victim.maxhealth - 10 && var_1da1a66b5c6a06a7 > 100;
}
