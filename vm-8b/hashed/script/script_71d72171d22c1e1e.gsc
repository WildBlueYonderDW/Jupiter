...
// Size: 0x54
function function_43755e1816ee895b(scriptable, var_c3edfd187c0f7dba, var_fe62c505a48cbca7) {
    scriptable scripts\cp_mp\emp_debuff::set_apply_emp_callback(var_c3edfd187c0f7dba);
    scriptable.var_3545410459b16762 = var_c3edfd187c0f7dba;
    scriptable.var_fe62c505a48cbca7 = var_fe62c505a48cbca7;
...
function function_a488516398cf6ae3(victimteam, attacker, explodelocation, empduration, emprange) {
    ...
    if (isdefined(level.var_dc53645ad882c8f2) && isdefined(level.var_dc53645ad882c8f2.vehiclename) && level.var_dc53645ad882c8f2.vehiclename != "" && istrue(level.var_dc53645ad882c8f2.var_4e9df5e4d1c7d66f)) {
        if (isdefined(level.vehicle) && isdefined(level.vehicle.instances) && isdefined(level.vehicle.instances[level.var_dc53645ad882c8f2.vehiclename])) {
            foreach (spy_drone in level.vehicle.instances[level.var_dc53645ad882c8f2.vehiclename]) {
