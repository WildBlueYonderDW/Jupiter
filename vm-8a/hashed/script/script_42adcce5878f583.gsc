...
function private function_93caad88720d8064(category, contextentity, overridecooldown) {
    ...
    if (!isdefined(aliases) || !isarray(aliases) || aliases.size == 0) {
        /#
            function_78ea414bb61b846c("<dev string:x6a>" + category + "<dev string:xa3>");
        #/
        return false;
    }
    ...
    if (!isdefined(alias)) {
        /#
            function_78ea414bb61b846c("<dev string:x6a>" + category + "<dev string:xc7>");
        #/
        return false;
    }
    if (isdefined(self.var_50cf411802ee43ce.var_d4d48422d1660504)) {
        /#
            function_78ea414bb61b846c("<dev string:x6a>" + category + "<dev string:xe4>");
        #/
        return false;
    }
    if (!istrue(overridecooldown) && isdefined(self.var_50cf411802ee43ce.var_9c3f4df602c70997) && isdefined(self.var_50cf411802ee43ce.var_5fa7de1d4e75d893)) {
        if (self.var_50cf411802ee43ce.var_9c3f4df602c70997 + self.var_50cf411802ee43ce.var_5fa7de1d4e75d893 > gettime()) {
            /#
                function_78ea414bb61b846c("<dev string:x6a>" + category + "<dev string:x10c>");
            #/
            return false;
        }
    }
    if (isdefined(contextentity) && function_841c15d31f2a24d6(category, contextentity)) {
        /#
            function_78ea414bb61b846c("<dev string:x6a>" + category + "<dev string:x130>");
        #/
        return false;
    }
    level endon("game_ended");
    ...
    if (istrue(result)) {
        ...
        /#
            function_78ea414bb61b846c("<dev string:x6a>" + category + "<dev string:x16d>" + alias);
        #/
    } else {
        /#
            function_78ea414bb61b846c("<dev string:x6a>" + category + "<dev string:x184>");
        #/
    }
    self.var_50cf411802ee43ce.var_d4d48422d1660504 = undefined;
...
/#
    ...
    function private function_bb1d5509c601171a() {
        ...
        level notify("<dev string:x1a9>");
        level endon("<dev string:x1a9>");
        for (;;) {
            if (!getdvarint(@"hash_48a3c38e3b8d5b4d", 0) || !isdefined(self) || !isdefined(self.var_50cf411802ee43ce)) {
                ...
                default_color = (0, 1, 0);
                if (isdefined(self.var_50cf411802ee43ce.var_d4d48422d1660504)) {
                    printtoscreen2d(offset_x, offset_y, "<dev string:x1c6>" + self.var_50cf411802ee43ce.var_d4d48422d1660504, (1, 0, 0), scale);
                    offset_y += line_y;
                    printtoscreen2d(offset_x, offset_y, "<dev string:x1d2>" + self.var_50cf411802ee43ce.activecategory, (1, 0, 0), scale);
                    offset_y += line_y;
                } else {
                    printtoscreen2d(offset_x, offset_y, "<dev string:x1de>", default_color, scale);
                    offset_y += line_y;
                }
                if (isdefined(self.var_50cf411802ee43ce.var_3231bfdeb1f1382c)) {
                    foreach (category, aliases in self.var_50cf411802ee43ce.var_3231bfdeb1f1382c) {
                        printtoscreen2d(offset_x, offset_y, "<dev string:x1ed>" + category, (1, 0, 0), scale);
                        offset_y += line_y;
                        foreach (alias in aliases) {
                            printtoscreen2d(offset_x, offset_y, "<dev string:x1f8>" + alias, default_color, scale);
                            offset_y += line_y;
                        }
                    }
                }
    ...
    function private function_78ea414bb61b846c(text) {
        ...
        if (isdefined(self) && isdefined(self.agent_type)) {
            text += "<dev string:x1fb>" + self.agent_type;
        }
        println(text);
    }
