...
function spawn_kidnapper_for_player(target_player) {
    ...
    vip = level waittill("cp_kidnapper_spawned");
    soldier = vip;
...
function release_player_on_damage(soldier, target_player, var_8d2503ebcbbfd4a1) {
    ...
    for (damagetaken = 0; damagetaken < var_8d2503ebcbbfd4a1; damagetaken += damage) {
        damage, attacker, direction_vec, point, meansofdeath, modelname, tagname, partname, idflags, objweapon, origin, angles, normal, inflictor, eventid = soldier waittill("damage");
    }
