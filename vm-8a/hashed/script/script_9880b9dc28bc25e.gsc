...
function function_aa5b896e0db21411(attractor_struct, scriptmodel) {
    ...
    assertex(isdefined(scriptmodel physics_getentityaabb()), "<dev string:x1c>");
}
...
/#
    ...
    function private function_c7f9ea43d1d31e4() {
        function_6e7290c8ee4f558b("<dev string:x63>");
        function_a9a864379a098ad6("<dev string:x75>", "<dev string:x94>", &function_a42573c2443e726b);
        function_a9a864379a098ad6("<dev string:xb3>", "<dev string:xcf>", &function_a21a8d430150a412);
        function_a9a864379a098ad6("<dev string:xe2>", "<dev string:x10a>", &function_b0384ff098c7e2c9);
        function_a9a864379a098ad6("<dev string:x128>", "<dev string:x14c>", &function_53b06be1a4d442b5);
        function_a9a864379a098ad6("<dev string:x16e>", "<dev string:x195>", &function_352da1bb7ed454f0);
        function_a9a864379a098ad6("<dev string:x1ba>", "<dev string:x1df>", &function_402293d746366a91);
        function_a9a864379a098ad6("<dev string:x1ff>", "<dev string:x21b>", &function_8714e28fdc1b009a);
    ...
    function private function_53b06be1a4d442b5() {
        pos = function_9b4c82dba041b23d();
        zombies = getaispeciesarray("<dev string:x237>", "<dev string:x23c>");
    ...
    function private function_8714e28fdc1b009a() {
        pos = function_9b4c82dba041b23d();
        pos -= (0, 0, 4);
        table = spawn("<dev string:x240>", pos);
        table setmodel("<dev string:x24d>");
        table.health = 100;
    ...
    function private function_3554b56e0cccd80f(attractor) {
        ...
        range_text = ter_op(attractor.range > 0, "<dev string:x268>" + attractor.range, "<dev string:x273>");
        collision_ent = default_to(attractor.var_eb287a759525f0bd, attractor.source);
        health_text = ter_op(isdefined(collision_ent.health), "<dev string:x274>" + string(default_to(collision_ent.health, 0)), "<dev string:x273>");
        record3dtext("<dev string:x27d>" + string(attractor.priority) + range_text, attractor.source.origin + (0, 0, 32), color);
        if (attractor.is_attackable) {
            record3dtext("<dev string:x292>" + health_text, attractor.source.origin + (0, 0, 24), color);
        ...
        if (getdvarint(@"hash_a83f59607205c9c0", 0) <= 0) {
            print3d(attractor.source.origin + (0, 0, 32), "<dev string:x27d>" + string(attractor.priority) + range_text, color);
            if (attractor.is_attackable) {
                print3d(attractor.source.origin + (0, 0, 24), "<dev string:x292>" + health_text, color);
            }
            if (attractor.range > 0) {
