...
function function_defb9f9d0ce11b2b(ent, time, endintensity, flickerpercentage) {
    ...
    if (isdefined(flickerpercentage)) {
        while (t < time) {
            ...
            new_intensity = new_intensity * (1 + flickerpercentage);
            t = t + 0.05;
...
function function_830e692e8b173603(dvar_name, state, var_6030244e11bf3e1b, strength_goal, var_235ac5072a1ae788, var_1339c9f748769b8b, var_bf8e19640d7f4ad0) {
    ...
    /#
        if (var_235ac5072a1ae788 > 0) {
            ...
            level.var_9f347f3156d0dee3 = dvar_short + "<unknown string>" + var_9e9430cfada07d0e + "<unknown string>" + var_65ce6f8a79b7508 + "<unknown string>" + level.var_9f347f3156d0dee3;
        }
    #/
    return is_done;
}
...
function lerp_dvar(dvar, end_value, duration) {
    ...
    for (t = 0.05; t <= duration + 0.0001; t = t + 0.05) {
        time_fraction = t / duration;
...
function function_1500aeb623f5d725(player, target, aperture, var_965582b4f1f2f995, var_a90c6783e05bab5f, tag) {
    ...
    while (true) {
        ...
        fstop = aperture;
        if (dof_dist < 60) {
            fstop = fstop + abs(60 - dof_dist) * 0.1;
        }
...
function bob_mask(hudelement) {
    ...
    while (true) {
        if (isdefined(hudelement)) {
            ...
            weapidletime = weapidletime + frametime * 1000 * var_ab67df38f60f6a9b;
            ...
            offsetx = offsetx + clamp(offsetxchange, -1, 1);
...
function function_1fce2623d8fec063(time, targetsample) {
    ...
    while (currframe < numframes) {
        ...
        var_c3c8ead438d06ca0 = var_c3c8ead438d06ca0 + currsample;
...
function function_3f730819900e0fa0(duration, end_value) {
    ...
    wait(0.05);
    for (t = 0.05; t <= duration; t = t + 0.05) {
...
function function_a18b3876df7ffbb1(timeleft) {
    ...
    while (level.accelerationfactor > var_ff294ea72dd3a5df) {
        level.accelerationfactor = level.accelerationfactor - stepsize;
