...
function autoexec main() {
    ...
    namespace_20237ca8e4edbc82::function_d6736c5ef5ac2990(var_601bcee5d276f46d, &function_b9f4b7206d76e7ce);
}
...
function private function_b9f4b7206d76e7ce(params) {
    ...
    namespace_20237ca8e4edbc82::function_3d2728c0e2252a1d(var_c02b1f6c1721c844, "destroyed");
    namespace_20237ca8e4edbc82::function_7380ccd6f2c49392(var_c02b1f6c1721c844, 1);
    ...
    if (var_c02b1f6c1721c844 == "armored_torso" || var_c02b1f6c1721c844 == "armored_head") {
        ...
        var_58239f09cf37ad7f = self.maxhealth * self.var_48a12f8371457fbb;
        if (self.var_47399212b3052720.var_e58a65b7a8f5973c.var_c7869dfe1aa33f55 && isdefined(self.var_47399212b3052720.var_e58a65b7a8f5973c.var_8ccd14d6a1cff2bf)) {
            pos = self gettagorigin("j_weapon_spin");
            function_38e113a4c30f6c0d(self.var_47399212b3052720.var_e58a65b7a8f5973c.var_8ccd14d6a1cff2bf, pos);
            var_36a1e9c4ae94fe26 = var_36a1e9c4ae94fe26 + "_loot";
        }
        if (isplayer(params.eattacker)) {
            params.eattacker function_e800498086e36c29(#"hash_5c30831462239b12");
        }
        self dodamage(var_58239f09cf37ad7f, self.origin, params.eattacker, params.einflictor, "MOD_EXPLOSIVE", undefined, "right_arm_upper", undefined, 65536);
        if (isalive(self)) {
