...
function function_55aae48e013652fa() {
    ...
    if (scripts\mp\utility\weapon::ismeleeonly(playerweaponobj) || scripts\mp\utility\weapon::issuperweapon(playerweaponobj) || namespace_e0ee43ef2dddadaa::iskillstreakweapon(playerweaponobj) || scripts\mp\utility\weapon::isgamemodeweapon(playerweaponobj) || scripts\mp\utility\weapon::issinglehitweapon(playerweaponobj.basename) || namespace_e0ee43ef2dddadaa::isminigunweapon(playerweaponobj) || !function_a364b6e4dc3cc30a(playerweaponobj) || playerweaponobj.basename == "iw8_lm_dblmg_mp" || playerweaponobj.basename == "iw9_me_fists_mp") {
