...
function function_1c518ee0267d39a7() {
    ...
    if (!isdefined(self.main_struct)) {
        println("<dev string:xc5>" + self.varianttag + "<dev string:xdf>");
        return;
    }
    if (!isdefined(self.main_struct.target)) {
        println("<dev string:xc5>" + self.varianttag + "<dev string:x16b>");
        return;
    }
    root_structs = getstructarray(self.main_struct.target, "targetname");
    if (!isdefined(root_structs) || root_structs.size == 0) {
        println("<dev string:xc5>" + self.varianttag + "<dev string:x201>");
        return;
    }
    ...
    if (!isdefined(self.root_struct)) {
        println("<dev string:xc5>" + self.varianttag + "<dev string:x28d>");
        return;
    }
    ...
    case #"hash_af83e47edfa8900a": 
        ...
        break;
    default: 
        println("<dev string:xc5>" + self.varianttag + "<dev string:x30d>");
...
function function_922249df70b163b4() {
    if (!isdefined(self.safe_struct)) {
        println("<dev string:xc5>" + self.varianttag + "<dev string:x372>");
        function_4bc22996edea81f1(self);
        return;
    }
    if (!isdefined(self.safe_reinforce)) {
        println("<dev string:xc5>" + self.varianttag + "<dev string:x3ba>");
        function_4bc22996edea81f1(self);
        return;
    }
    if (isdefined(self.safe_struct)) {
...
function function_44f59d05c32d272e() {
    ...
    foreach (var_7d1484060301dfa7 in self.var_10f090a9e9488068) {
        ...
        var_98fa2809e21ff34f = namespace_f6368c72597c6d90::function_ad1b6accbaab404e(var_7d1484060301dfa7, self.locked_doors, "human_stronghold", istrue(var_7d1484060301dfa7.canunlock), 1, self.mapdoors);
        ...
        if (isdefined(safe)) {
            ...
            /#
                if (getdvarint(@"hash_230f5449e5459051", 0) == 1) {
                    level thread debug::drawline(safe.origin, reinforcementposition, 9999, game["<dev string:x40b>"]["<dev string:x412>"]);
                    level thread debug::drawsphere(reinforcementposition, 24, 9999, game["<dev string:x40b>"]["<dev string:x412>"]);
                }
            #/
        }
    }
...
function function_8b6c9d30305fd087(agent, activityinstance) {
    ...
    if (isdefined(var_9a2ade83732f36f2) && isdefined(var_c6b2d4e3dc77cf9d)) {
        /#
            if (getdvarint(@"hash_230f5449e5459051", 0) == 1) {
                level thread debug::drawline(var_9a2ade83732f36f2, agent.origin, 9999, game["<dev string:x40b>"]["<dev string:x412>"]);
                level thread debug::drawsphere(var_9a2ade83732f36f2, var_c6b2d4e3dc77cf9d, 9999, game["<dev string:x40b>"]["<dev string:x412>"]);
            }
        #/
...
function private function_a7fafdf4ccb30418(players) {
    /#
        ob_humans::function_f7e877aa7e97d952(self, "<dev string:x418>");
    #/
    ...
    foreach (player in players) {
        if (!isdefined(player) || array_contains(var_694cf27a7080216, player)) {
            /#
                ob_humans::function_dd0ceeddc603cb3e(player, self, "<dev string:x439>");
            #/
            continue;
        }
        /#
            ob_humans::function_d170903981c617de(player);
            ob_humans::function_dd0ceeddc603cb3e(player, self, "<dev string:x472>");
        #/
...
function private function_9dbc2d439e39df13(players) {
    /#
        ob_humans::function_f7e877aa7e97d952(self, "<dev string:x48c>");
    #/
    if (!isdefined(players) || !isarray(players) || players.size == 0) {
        return;
    }
    ...
    foreach (player in players) {
        if (!isdefined(player) || array_contains(var_694cf27a7080216, player)) {
            /#
                ob_humans::function_dd0ceeddc603cb3e(player, self, "<dev string:x4ac>");
            #/
            continue;
        }
        /#
            ob_humans::function_d170903981c617de(player);
            ob_humans::function_dd0ceeddc603cb3e(player, self, "<dev string:x4e4>");
        #/
...
function private function_dd78c34c770c2497(players) {
    /#
        ob_humans::function_f7e877aa7e97d952(self, "<dev string:x4fd>");
    #/
    if (!isdefined(players) || !isarray(players) || players.size == 0) {
        return;
    }
    if (percent_chance(30)) {
        /#
            ob_humans::function_f7e877aa7e97d952(self, "<dev string:x523>");
        #/
        var_694cf27a7080216 = [];
        foreach (player in players) {
            if (!isdefined(player) || array_contains(var_694cf27a7080216, player)) {
        ...
        foreach (player in players) {
            if (!isdefined(player) || array_contains(var_694cf27a7080216, player)) {
                /#
                    ob_humans::function_dd0ceeddc603cb3e(player, self, "<dev string:x54f>");
                #/
                continue;
            }
            /#
                ob_humans::function_d170903981c617de(player);
                ob_humans::function_dd0ceeddc603cb3e(player, self, "<dev string:x593>");
            #/
    ...
    foreach (player in players) {
        /#
            ob_humans::function_d170903981c617de(player);
            ob_humans::function_dd0ceeddc603cb3e(player, self, "<dev string:x5b8>");
        #/
    }
...
function private function_99f612c991e568a0(player) {
    ...
    /#
        ob_humans::function_dd0ceeddc603cb3e(player, self, "<dev string:x5e3>");
    #/
    ...
    if (!var_8c4ed29f8594fb86 && !on_mission) {
        ...
        /#
            ...
            ob_humans::function_dd0ceeddc603cb3e(player, self, "<dev string:x5ff>");
        #/
    ...
    /#
        ob_humans::function_dd0ceeddc603cb3e(player, self, "<dev string:x614>");
    #/
}
...
function private function_f390f4ebbe42c73c(var_d6bfa53c531546d6) {
    ...
    if (istrue(var_a917328b0b1b2a19) && isdefined(self.locked_doors) && self.locked_doors.size > 0) {
        /#
            ob_humans::function_dd0ceeddc603cb3e(player, self, "<dev string:x646>");
        #/
        function_bbdcd857d0c2a65e(self, player, "PlayerJoinedOther");
        squadmembers = player namespace_ca7b90256548aa40::getsquadmembers(player.team, 1);
        if (isdefined(squadmembers) && isarray(squadmembers) && squadmembers.size > 0 && !namespace_9718b9a169c3ead0::function_1abf09c903e6c16b(squadmembers, "loot_key_human_stronghold")) {
            ...
            if (on_mission) {
                ...
                /#
                    ob_humans::function_dd0ceeddc603cb3e(player, self, "<dev string:x660>");
                #/
            } else {
                /#
                    ob_humans::function_d170903981c617de(player);
                    ob_humans::function_dd0ceeddc603cb3e(player, self, "<dev string:x692>");
                #/
        ...
        /#
            ob_humans::function_dd0ceeddc603cb3e(player, self, "<dev string:x6a5>");
        #/
    }
}
...
function private function_3d04c4bc0abbcfa1(players, var_25978461c6e4f61b) {
    /#
        ob_humans::function_f7e877aa7e97d952(self, "<dev string:x6db>");
    #/
    ...
    if (isdefined(var_fbc7b9b8af0387d9)) {
        ...
        foreach (player in players) {
            if (!isdefined(player) || array_contains(var_694cf27a7080216, player)) {
                /#
                    ob_humans::function_dd0ceeddc603cb3e(player, self, "<dev string:x6f9>");
                #/
                continue;
            }
            /#
                ob_humans::function_d170903981c617de(player);
                ob_humans::function_dd0ceeddc603cb3e(player, self, "<dev string:x72f>" + var_fbc7b9b8af0387d9 + "<dev string:x74f>");
            #/
    ...
    /#
        ob_humans::function_f7e877aa7e97d952(self, "<dev string:x751>");
    #/
}
...
/#
    ...
    function private function_f927f5dd26f5e076() {
        wait 5;
        function_6e7290c8ee4f558b("<dev string:x788>");
        function_a9a864379a098ad6("<dev string:x7c6>", "<dev string:x7df>", &function_4cc130b05adeaae0);
    ...
    function function_4cc130b05adeaae0() {
        foreach (player in level.players) {
            function_38e113a4c30f6c0d("<dev string:x810>", player.origin, player.angles, 0, 1);
        }
    }
