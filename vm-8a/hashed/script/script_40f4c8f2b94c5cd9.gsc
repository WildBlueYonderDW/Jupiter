...
function create_player_rig(animname, var_486db5fa512a3b6b, animstruct, var_40a4287d8d2e7ef9) {
    ...
    if (isplayer(self)) {
        ...
        println("<dev string:x1c>" + self.name + "<dev string:x46>" + animname + "<dev string:x53>" + isdefined(self.player_rig));
        animstruct.player_rigs[animstruct.player_rigs.size] = self.player_rig;
        self.player_rig.playernum = self getentitynumber();
    } else {
        println("<dev string:x5b>" + animname + "<dev string:x53>" + isdefined(self.player_rig));
...
function remove_player_rig() {
    if (isdefined(self)) {
        println("<dev string:x9b>" + self.name + "<dev string:x46>" + self.animname + "<dev string:x53>" + isdefined(self.player_rig));
        self unlink();
    }
