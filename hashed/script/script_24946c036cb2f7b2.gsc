...
function function_43007b614b2eb884(activationname, players, var_c90d7e9a9fa9a981) {
    ...
    function_7175613cab6db0dc(var_1d1eecf1ed7cbdb0, var_d4464743d0edff8c.ref, players, var_c90d7e9a9fa9a981);
}
...
// Size: 0x4e
function function_5b45cad5c8f016ab(eventref, players, var_3be94fc7d74bc059, var_c3b480c3f8207bab) {
    var_2787b644956f87d9 = function_73e12b91e73e2977(players);
    if (var_2787b644956f87d9.size == 0) {
        return 0;
    }
    return namespace_446fc987a980892f::function_d87d5deb069bf8e5(eventref, var_2787b644956f87d9, 0, var_3be94fc7d74bc059, var_c3b480c3f8207bab);
}
...
// Size: 0x8c
function function_7175613cab6db0dc(var_1d1eecf1ed7cbdb0, eventref, players, var_c90d7e9a9fa9a981) {
    ...
    if (isdefined(var_73ddaf989477e28c) && var_73ddaf989477e28c + var_c90d7e9a9fa9a981 * 1000 > currenttime) {
        return;
    }
...
function private function_a6dfaa6e79adbc09(activationname) {
    ...
    var_a0df226025d98d74.delay = function_ffbb8d6b4076cfa7(var_440272a7c84e0ab8[0]);
    var_a0df226025d98d74.var_85d4a2a50c756c8a = function_63b7c6f0e6f2a9f7(var_440272a7c84e0ab8[0]);
    var_a0df226025d98d74.var_a992c85bbf2c3bd6 = function_63b7c6f0e6f2a9f7(var_440272a7c84e0ab8[0]);
...
function function_d52f11eff492795d(player, var_45e792783f2a92ab, var_81c927dcd9cba1f9) {
    ...
    if (isdefined(player)) {
        if (istrue(var_45e792783f2a92ab)) {
            if (isdefined(player.team) && isdefined(player.var_ff97225579de16a)) {
                key = "team:" + player.team + "id:" + player.var_ff97225579de16a;
            }
    ...
    if (isdefined(key) && istrue(var_81c927dcd9cba1f9) && isdefined(self)) {
        var_6acb6a9be36af50d = namespace_4fda5d7358015a06::function_f0f498aed6f8fa5d(self);
        if (isdefined(var_6acb6a9be36af50d)) {
            key = "activityid:" + var_6acb6a9be36af50d + key;
        }
    }
    return key;
}
...
// Size: 0xbd
function function_1abf09c903e6c16b(players, var_a0ce8000d303764c) {
    if (!isdefined(players) || !isarray(players) || players.size == 0) {
        return 0;
    }
