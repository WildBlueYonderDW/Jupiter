...
function updatebrscoreboardstat(statname, value) {
    ...
    case #"hash_f2919dcdb66b73b4":
        var_c00a326249963ab5 = [0, 10, 4];
        infoindex = var_c00a326249963ab5[2];
        bitwidth = var_c00a326249963ab5[1];
        bitoffset = var_c00a326249963ab5[0];
        break;
    case #"hash_d4536c3cd58937a6":
        var_c00a316249963882 = [10, 3, 4];
        infoindex = var_c00a316249963882[2];
