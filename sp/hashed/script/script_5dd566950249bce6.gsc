...
// Size: 0x4f
function function_fa2f61f680989e86(vo_line, delay_before, delay_after, actor) {
...
function function_d61b10a951adbc62(ai_actor, anim_struct) {
    ...
    if (isdefined(self.player_pos) && self.player_pos.size > 0) {
        ...
        ai_actor thread function_8e310442d0eb60d0(closest_pos);
...
// Size: 0x14b
function private function_8e310442d0eb60d0(closest_pos) {
...
function function_dd230b54e233f4bd(ai_actor, struct, scene, shot) {
    if (isdefined(ai_actor)) {
        ...
        if (isdefined(scene) && isdefined(shot) && isdefined(struct)) {
            var_16345aa956bf0ede = spawn("script_model", ai_actor.origin);
            var_16345aa956bf0ede setmodel(ai_actor.model);
            var_16345aa956bf0ede.angles = ai_actor.angles;
            var_16345aa956bf0ede.targetname = ai_actor.targetname;
            var_16345aa956bf0ede.animname = ai_actor.animname;
            var_16345aa956bf0ede scripts\sp\utility::assign_human_animtree();
            var_16345aa956bf0ede hide();
            enter_animations = struct scene::function_10a1cbb13da3a4fe(var_16345aa956bf0ede.animname, shot, scene);
            enter_animation = enter_animations[enter_animations.size - 1];
            ...
            if (isdefined(enter_animation)) {
                var_16345aa956bf0ede animscripted("gettingpos", alignmentinfo.origin, alignmentinfo.angles, enter_animation, undefined, undefined, 0, 0);
                var_16345aa956bf0ede setanimtime(enter_animation, 1);
                var_16345aa956bf0ede dontinterpolate();
                wait 0.05;
                pos_info.origin = var_16345aa956bf0ede gettagorigin("tag_eye");
                pos_info.angles = var_16345aa956bf0ede gettagangles("tag_origin");
            }
...
function function_77875203287214db(dialog_tree, anim_struct, timer, kill_notify, use_dist, display_dist, use_angles, use_offset, var_31d55a939e9cbc7a, var_bb0e04b41962c3ae) {
    ...
    scripts\sp\player\cursor_hint::create_cursor_hint(tagname, use_offset, var_529d4f9260f8008e, undefined, display_dist, use_dist, 0, undefined, undefined, undefined, undefined, undefined, undefined, undefined, use_angles);
...
function run(ai_actor, anim_struct, timer, activator, var_31d55a939e9cbc7a, var_b763c53f8a399479, var_6a5d78d46f3a9e2) {
    ...
    if (ai_actor.var_41fc4f898c255d37 <= 1) {
        ...
        if (isai(ai_actor) && self.force_headlook) {
            ai_actor namespace_17a0e830dd8fa113::enablelookatplayer(0.5, 1);
        }
    ...
    while (!end_dialog) {
        ...
        ai_actor function_cba0984334ba3279(var_d4109911bd0c278f);
    ...
    if (ai_actor.var_41fc4f898c255d37 <= 1) {
        ...
        if (isai(ai_actor) && self.force_headlook) {
            ai_actor namespace_17a0e830dd8fa113::disablelookatplayer();
        }
...
function function_3041b446fbb7cebe(exclude_forever) {
    ...
    exclude_count = 0;
    if (exclude_forever) {
        foreach (choice_id in var_274e22942d9863f3) {
    ...
    return var_274e22942d9863f3.size - exclude_count;
}
...
function private function_90cdd85860a9e8df(parent_id, option_text, ai_vo, ai_anim, var_228a30311662ac48, end_dialog, set_flag, var_661a368853d6a900, var_176104ebd5b06dab, selected_func, func_parameter, skip_func, important, var_f76e8406f0920af2, var_251b1b5ad40a075d, var_672f1e3cc01453d2) {
    ...
    option.var_885448f843aa6aa3 = option_text;
    option.vo_npc = ai_vo;
...
function function_b78240c8809979a3(index) {
    ...
    choice_string = "^S " + var_6812df4b08b0f7ac + " ^E";
...
function function_b0a4d1a45e3cc77b(var_5cd1d0ff865b8b4e, ai_actor, var_b763c53f8a399479) {
    ...
    if (selected_index < 0) {
        player thread function_530ad7e8e4ec7d2a(var_274e22942d9863f3, ai_actor, 1);
        return selected_index;
    }
    player thread function_530ad7e8e4ec7d2a(var_274e22942d9863f3, ai_actor);
...
// Size: 0x86
function function_baf288decd65aa7a(old_indices, new_indices, var_274e22942d9863f3) {
...
// Size: 0x52
function function_530ad7e8e4ec7d2a(var_274e22942d9863f3, ai_actor, quick_clear) {
