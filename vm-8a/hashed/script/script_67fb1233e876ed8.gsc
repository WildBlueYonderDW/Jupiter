...
/#
    ...
    function private init_debug() {
        ...
        function_a2fe753948998c89("<dev string:x159>", "<dev string:x165>");
        function_a2fe753948998c89("<dev string:x18e>", "<dev string:x19b>");
        function_a2fe753948998c89("<dev string:x1c5>", "<dev string:x1d6>");
        function_a2fe753948998c89("<dev string:x204>", "<dev string:x213>");
        function_a2fe753948998c89("<dev string:x240>", "<dev string:x24a>");
        function_a2fe753948998c89("<dev string:x272>", "<dev string:x27f>");
        function_a2fe753948998c89("<dev string:x2a9>", "<dev string:x2bb>");
        function_a2fe753948998c89("<dev string:x2ed>", "<dev string:x301>");
        function_a2fe753948998c89("<dev string:x332>", "<dev string:x340>");
        function_fe953f000498048f();
    }
    ...
    function private debug_watch(dvarstring, funcdebug) {
        ...
        while (true) {
            ...
            debug_print("<dev string:x376>" + function_3c8848a3a11b2553(dvarstring) + "<dev string:x37f>" + debugstate);
    ...
    function private debug_draw(scriptstruct, spawns) {
        ...
        debug_cleanup();
        iprintlnbold("<dev string:x386>" + scriptstruct + "<dev string:x3a0>");
        if (spawns == undefined) {
            spawns = level.ssc.indexes;
        }
        foreach (entry in spawns) {
    ...
    function private function_fd78bc2f959fe5cc(text, origin, angles, color) {
        ...
        thread draw_line_for_time(origin, ray, color[0], color[1], color[2], timesec, "<dev string:x3aa>" + level.ssc.drawcount);
        thread draw_arrow_time(origin, forwardpos, color, timesec, "<dev string:x3aa>" + level.ssc.drawcount);
    }
    ...
    function private function_51c00e624bf397fd(text, origin, color, timeframes) {
        level endon("<dev string:x3aa>" + level.ssc.drawcount);
        while (timeframes > 0) {
    ...
    function private debug_cleanup(drawindex) {
        ...
        level notify("<dev string:x3aa>" + drawindex);
    }
    ...
    function private function_1c9f19f5e86da1ab(var_ca2c833762e5466c) {
        ...
        debug_print("<dev string:x3ba>" + var_ca2c833762e5466c + "<dev string:x1c>" + numtimes + "<dev string:x3d2>");
        for (i = 0; i < numtimes; i++) {
            debug_print("<dev string:x3da>" + i + 1 + "<dev string:x3f0>" + var_ca2c833762e5466c);
    ...
    function private function_4af2c94919958f2e(var_ca2c833762e5466c, spawns, var_9c15d8194b83aac) {
        ...
        foreach (index in level.ssc.indexes) {
            ...
            if (array_contains_key(spawncounts, index) && spawncounts[index] > 0) {
                ...
                function_fd78bc2f959fe5cc(index + "<dev string:x3f5>" + spawncounts[index] + "<dev string:x3f7>", origin, angles, color);
                continue;
            }
            debug_print("<dev string:x3f9>" + index + "<dev string:x400>" + var_9c15d8194b83aac + "<dev string:x41f>" + var_ca2c833762e5466c);
            function_fd78bc2f959fe5cc(index + "<dev string:x435>", origin, angles, (1, 1, 1));
        }
        level.ssc.drawcount++;
    }
