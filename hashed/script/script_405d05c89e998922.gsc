...
function autoexec init() {
    utility::registersharedfunc("zombie_dismemberment", "dismemberHead", &function_baa0bcc5adbdacc4);
}
...
function function_b718bd8a845dc9ab() {
    callback::function_e7fddda1f0b46b5e(self.var_ae3ea15396b65c1f) callback::add("on_zombie_ai_damaged", &function_e2c1f2a81d46d73d);
    callback::function_e7fddda1f0b46b5e(self.var_ae3ea15396b65c1f) callback::add("on_zombie_ai_killed", &function_d37efd30de1a9951);
    callback::function_e7fddda1f0b46b5e(self.var_ae3ea15396b65c1f) callback::add("killed_body_cloned", &function_3cf0e5ddfe2f900);
    callback::function_e7fddda1f0b46b5e(self.var_ae3ea15396b65c1f) callback::add("on_corpse_annihilated", &on_corpse_annihilated);
}
...
function function_9d6df53b2bb22d73() {
    ...
    self.var_3e84854a738e628d = &function_baa0bcc5adbdacc4;
...
// Size: 0x16
function function_baa0bcc5adbdacc4(var_4fc7a28f98adb334) {
    dismember(16, var_4fc7a28f98adb334);
}
...
function function_ca5cecb3f1666b6(str_location) {
    var_905e0ea5ed788f80 = function_acb5b44b64b97f9f(str_location);
    ...
    return (var_44c6db708d4a15fe & var_905e0ea5ed788f80) > 0;
}
...
// Size: 0xe
function function_a1dee428e87727df() {
    dismember(12, 0, 0);
}
...
function private function_e2c1f2a81d46d73d(params) {
    ...
    var_ee9f7f2b851cc905 = function_acb5b44b64b97f9f(params.shitloc);
    var_60bb62a476e57bad = isdefined(params.smeansofdeath) && isexplosivedamagemod(params.smeansofdeath);
    if (var_65de9a18ad444853 && !is_friendly_damage(self, params.eattacker)) {
        ...
        } else if (var_60bb62a476e57bad) {
            dismember(19 | 12, var_65de9a18ad444853);
        } else if (var_ee9f7f2b851cc905 != 0 && var_ee9f7f2b851cc905 != 1) {
            dismember(var_ee9f7f2b851cc905, var_65de9a18ad444853);
    ...
    if (var_60bb62a476e57bad && damage_percent >= 50 && randomint(100) < 20) {
        dismember(12, var_65de9a18ad444853);
    }
    if (var_ee9f7f2b851cc905 == 16) {
    ...
    } else if (var_ee9f7f2b851cc905 == 2 || var_ee9f7f2b851cc905 == 0) {
        damage_percent = ter_op(self.maxhealth > 0, params.idamage / self.maxhealth, 1) * 100;
        if (damage_percent > 10 && randomint(100) < 5) {
            dismember(2, var_65de9a18ad444853);
        }
    } else if (var_ee9f7f2b851cc905 == 4 || var_ee9f7f2b851cc905 == 8) {
        damage_percent = ter_op(self.maxhealth > 0, params.idamage / self.maxhealth, 1) * 100;
...
function private on_corpse_annihilated(params) {
    ...
    if (isdefined(corpse)) {
        if (isdefined(params.var_18262b2d0ba142d4)) {
            wait_time = params.var_18262b2d0ba142d4 - level.framedurationseconds;
            if (wait_time > 0) {
                wait(wait_time);
            }
        }
...
function function_bce021b0a87015f6(var_332cbc3917a73aa1) {
    ...
    if (var_5b2447741c6ede0a > 0) {
        ...
        for (var_d0b7ecd4d3903367 = 0; (19 | 12) >> var_d0b7ecd4d3903367 > 0; var_d0b7ecd4d3903367++) {
            var_ee9f7f2b851cc905 = 1 << var_d0b7ecd4d3903367;
            if (var_5b2447741c6ede0a & var_ee9f7f2b851cc905) {
                if (var_17bd5a9839793309 == var_a6ef929aaddcf48d) {
                    dismember(var_ee9f7f2b851cc905, var_332cbc3917a73aa1);
                    break;
                }
...
// Size: 0x138
function private dismember(var_e58e22b5be4f0e82, var_65de9a18ad444853, annihilate) {
    var_9cb196782b2726c9 = var_e58e22b5be4f0e82;
    var_9cb196782b2726c9 = var_9cb196782b2726c9 & ~self._blackboard.var_75b2c9ba4bfca43d;
    if (var_9cb196782b2726c9 & 3 && self._blackboard.var_75b2c9ba4bfca43d & 3) {
        var_9cb196782b2726c9 = var_9cb196782b2726c9 & ~3;
    }
    ...
    self._blackboard.var_75b2c9ba4bfca43d = self._blackboard.var_75b2c9ba4bfca43d | var_9cb196782b2726c9;
...
function annihilate() {
    ...
    var_7382a37c2abf2079 = self gettagorigin("j_spine4");
    var_8f8922f650e9a081 = self gettagangles("j_spine4");
    if (isdefined(var_7382a37c2abf2079) && isdefined(var_8f8922f650e9a081)) {
        playfx(effect_id, var_7382a37c2abf2079, anglestoforward(var_8f8922f650e9a081), anglestoup(var_8f8922f650e9a081));
    }
}
...
// Size: 0x2e
function private function_bb2659ad962ee09e(var_e58e22b5be4f0e82) {
    var_6445ec1e71d64192 = 0;
    while (var_e58e22b5be4f0e82 > 0) {
        var_6445ec1e71d64192++;
        var_e58e22b5be4f0e82 = var_e58e22b5be4f0e82 - (var_e58e22b5be4f0e82 & 0 - var_e58e22b5be4f0e82);
    }
    return var_6445ec1e71d64192;
}
...
function function_dd8dcd65f2ebbb35(is_crawling) {
    ...
    /#
        /#
            assertex(istrue(is_crawling) || !istrue(var_93f193eea56d3601), "prone");
        #/
    #/
...
function function_cd37404b5eaaf996() {
    /#
        ...
        function_b23a59dfb4ca49a1("<unknown string>", "<unknown string>", &function_98ea8376136fd179);
        function_b23a59dfb4ca49a1("<unknown string>", "<unknown string>", &function_98ea8376136fd179);
        function_b23a59dfb4ca49a1("<unknown string>", "<unknown string>", &function_98ea8376136fd179);
        function_b23a59dfb4ca49a1("<unknown string>", "<unknown string>", &function_98ea8376136fd179);
        function_b23a59dfb4ca49a1("<unknown string>", "<unknown string>", &function_98ea8376136fd179);
        function_b23a59dfb4ca49a1("<unknown string>", "<unknown string>", &function_98ea8376136fd179);
        function_b23a59dfb4ca49a1("<unknown string>", "<unknown string>", &function_98ea8376136fd179);
        function_b23a59dfb4ca49a1("<unknown string>", "<unknown string>", &function_eb0611465b70a805);
...
// Size: 0xd5
function function_98ea8376136fd179(param) {
    /#
        switch (param[0]) {
        case #"hash_b107b5547c755d23":
...
// Size: 0x6e
function private function_eb0611465b70a805(params) {
    /#
        all_ai = getaiarray();
...
// Size: 0xcb
function function_d01b0187d13524d0(var_e58e22b5be4f0e82, var_65de9a18ad444853, annihilate) {
    /#
        ...
        foreach (ai in all_ai) {
            ...
            ai dismember(var_e58e22b5be4f0e82, var_65de9a18ad444853, annihilate);
