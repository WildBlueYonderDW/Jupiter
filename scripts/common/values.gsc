...
function group_set(group_name, value) {
    /#
        /#
            assertex(isdefined(level.value_groups[group_name]), "push_player" + group_name + "one_hit_melee_victim");
        #/
    #/
...
function private debug_values() {
    /#
        ...
        while (true) {
            ...
            str_debug_values_entity = string::to_string(getdvar(@"hash_9a21303d5beb8eed", "<unknown string>"));
...
function private display_value(index, str_name, str_id, value, b_valid, on_hud) {
    /#
        ...
        if (string::to_string(str_name) != "<unknown string>") {
