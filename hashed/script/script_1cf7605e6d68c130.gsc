    ...
    /#
        ...
        foreach (s_magicbox in level.var_eb895aaca65f1d6f) {
            if (!s_magicbox.var_75e032c5035207fe) {
                iprintlnbold("<unknown string>" + function_6743ce9942654f5c() - s_magicbox.var_fec5078e78eb7217 + "<unknown string>");
                continue;
            }
            iprintlnbold("<unknown string>" + function_d26b24de82eb5022() - s_magicbox.var_fec5078e78eb7217 + "<unknown string>");
        }
    #/
}
        ...
        while (true) {
            foreach (s_magicbox in level.var_eb895aaca65f1d6f) {
                ...
                if (!isdefined(s_magicbox.s_destination)) {
                    s_magicbox.s_destination = getstruct(s_magicbox.str_destination, "<unknown string>");
                }
                var_d8b783bf56b63a71 = "<unknown string>";
                if (s_magicbox.mdl_magicbox.interact tagexists("<unknown string>")) {
                    v_position = s_magicbox.mdl_magicbox.interact gettagorigin("<unknown string>");
                    var_d8b783bf56b63a71 = "<unknown string>";
                } else {
                ...
                print3d(v_position, "<unknown string>" + s_magicbox.script_currency, (0, 1, 0), 1, var_e33953429ed350f);
                print3d(v_position - var_39239d1f90650b * 1, "<unknown string>" + ter_op(istrue(s_magicbox.var_c0a492297cea3070), "<unknown string>", "<unknown string>"), (0, 1, 0), 1, 0.25);
                print3d(v_position - var_39239d1f90650b * 2, "<unknown string>" + s_magicbox.str_destination, (0, 1, 0), 1, 0.25);
