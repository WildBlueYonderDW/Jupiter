...
function debug_friendlyfire() {
    /#
        setdvarifuninitialized(@"hash_b49dcbcb279aae41", "<dev string:x1c>");
        x = 0;
        y = 72;
        ...
        for (;;) {
            if (getdvar(@"hash_b49dcbcb279aae41") == "<dev string:x30>") {
    ...
    for (;;) {
        ...
        if (killed) {
            ...
            if (var_55d426dd45a49e09 && !attacker enemy_is_visible()) {
                ...
                /#
                    if (getdvarint(@"hash_b49dcbcb279aae41")) {
...
function notifydamagenotdone(entity) {
    damage, attacker, unused, unused, method = entity waittill("damage_notdone");
