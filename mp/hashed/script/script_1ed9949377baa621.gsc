...
function private function_af7a62a8522565bd( v_teleport, starter, a_players, itembundlename )
{
    ...
    thread scripts\cp_mp\overlord::playevent( "quest_s1_rift_gate_unlock_contract_start", a_players, 3 );
}
...
function function_19e866494b6bb2d8( params )
{
    ...
    switch ( instance.ai_type )
    {
        case #"hash_57f1e1130e644c8e":
            instance.var_cda97c89ff1bb729 = scripts\cp_mp\loot\common_item::function_2c836ad05e5f634c( "jup_rift_gate_key_season1_toxic_attuned" );
            break;
        case #"hash_d5d252eb91d1700b":
            instance.var_cda97c89ff1bb729 = scripts\cp_mp\loot\common_item::function_2c836ad05e5f634c( "jup_rift_gate_key_season1_fire_attuned" );
            break;
        case #"hash_8b1acdb45ebb6052":
            instance.var_cda97c89ff1bb729 = scripts\cp_mp\loot\common_item::function_2c836ad05e5f634c( "jup_rift_gate_key_season1_electric_attuned" );
            break;
    }
    ...
    {
        thread scripts\cp_mp\overlord::playevent( "quest_s1_rift_gate_unlock_contract_success", instance.var_6c29f2fdb0054bbe, 3.5 );
    }
}
