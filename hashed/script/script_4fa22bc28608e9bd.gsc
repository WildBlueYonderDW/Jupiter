...
function function_d956fa70427897a() {
    self.var_f66d11abec68c93 = [];
    self.var_4077aa0de2a5581a = 0;
    self.var_8ca9efd89609be81 = 0;
    self.var_8cd38ec42108e4c7 = self.var_47399212b3052720.var_e58a65b7a8f5973c.var_80680f186a663a85;
    self.var_a4c14dc60d4dd398 = self.var_47399212b3052720.var_e58a65b7a8f5973c.var_119f8409b2099b1c;
...
function function_9bdbd82cc19b68a8() {
    return max(self.var_8cd38ec42108e4c7 - self.var_f66d11abec68c93.size, 0);
}
...
function function_b377e44b6f4f14d9() {
    ...
    if (isdefined(closest_target)) {
        var_e237373d5ec4a6f8 = 10000;
        if (lengthsquared(closest_target.velocity) > lengthsquared(self.velocity)) {
            var_e237373d5ec4a6f8 = 20000;
        }
        if (distancesquared(closest_target.origin, self.origin) < var_e237373d5ec4a6f8) {
            return 1;
        }
    }
    return 0;
...
function function_2ff4b9df7de5dbb9() {
    return isdefined(self.var_22e48be427c33b1e) && self.var_22e48be427c33b1e.size > 0;
}
...
function function_785d7295faee2a05(params) {
    if (isplayer(params.eattacker) && isdefined(self.var_f66d11abec68c93) && self.var_f66d11abec68c93.size >= 5) {
...
function function_6f68035ca50bc6ea() {
    ...
    var_22e48be427c33b1e = get_array_of_closest(self.origin, self.var_a45b8880623f6ceb, self.var_f66d11abec68c93, var_7e23f88eb99b10f2, 200);
    self.var_22e48be427c33b1e = function_fdc9d5557c53078e(var_22e48be427c33b1e);
    if (self.var_22e48be427c33b1e.size <= 0) {
        self function_3e89eb3d8e3f1811("in_bind", 0);
        return;
    }
    var_c28d099db87d11de = 2000;
    var_c28d099db87d11de = var_c28d099db87d11de + max(0, self.var_22e48be427c33b1e.size - 1) * 2000;
    foreach (zombie in self.var_22e48be427c33b1e) {
    ...
    if (self.var_f66d11abec68c93.size == 0) {
        var_8b660e984fb7ef71 = var_8b660e984fb7ef71 * 0.25;
    }
    var_f36ee2fbccdcd06d = gettime() + var_8b660e984fb7ef71;
    while (1) {
        waitframe();
        self.var_22e48be427c33b1e = function_fdc9d5557c53078e(self.var_22e48be427c33b1e);
        if (self.var_22e48be427c33b1e.size <= 0) {
            break;
        }
        ...
        if (gettime() > var_f36ee2fbccdcd06d) {
            var_27d0614247095f05 = array_get_first_item(self.var_22e48be427c33b1e);
            ...
            self.var_22e48be427c33b1e = array_remove(self.var_22e48be427c33b1e, var_27d0614247095f05);
        }
    }
    self function_3e89eb3d8e3f1811("in_bind", 0);
    foreach (zombie in self.var_22e48be427c33b1e) {
    ...
    self.var_22e48be427c33b1e = undefined;
    if (self.var_8ca9efd89609be81 >= 5) {
...
function function_47d28404278627cd() {
    ...
    if (isalive(var_27d0614247095f05)) {
        ...
        if (yaw_diff <= 30 && (!isdefined(self.var_bd10b456b983ed6b) || self.var_bd10b456b983ed6b != var_27d0614247095f05)) {
            ...
            var_af41529ff92e56ca = getdvarfloat(@"hash_7e729eb90dd89489", 400);
            /#
                assert(var_af41529ff92e56ca > 0);
            #/
            n_time = distance(var_4c76655da6f30aa8, target_pos) / var_af41529ff92e56ca;
...
function function_4fd65777163a9be4(e_target) {
    ...
    while (isdefined(e_target) && gettime() < n_timeout && e_target ent_flag("disciple_binding")) {
        var_dbc98a586e1f6959 = getdvarfloat(@"hash_dbcf496cc1cc3580", 20);
        if (distancesquared(self.origin, e_target.origin + (0, 0, 50)) < squared(var_dbc98a586e1f6959)) {
            self delete();
            return;
        }
        waitframe();
...
function function_1fca749b9ae92b76(zombie) {
    ...
    zombie clearenemy();
    zombie clearpath();
    zombie callback::add("on_ai_killed", &function_602da523d564264c);
    ...
    self.var_f66d11abec68c93[self.var_f66d11abec68c93.size] = zombie;
...
function function_a1ea85d89b2fead4() {
    ...
    self clearenemy();
    self clearpath();
    callback::remove("on_ai_killed", &function_602da523d564264c);
...
// Size: 0xa0
function function_602da523d564264c(params) {
    if (isalive(self.commander) && isdefined(self.commander.var_f66d11abec68c93)) {
        self.commander.var_f66d11abec68c93 = array_remove(self.commander.var_f66d11abec68c93, self);
...
function function_c98c0afcd608b815(var_a4c14dc60d4dd398) {
    if (isdefined(self.var_22e48be427c33b1e)) {
        foreach (zombie in self.var_22e48be427c33b1e) {
            if (isdefined(zombie)) {
                zombie clear_stun();
                zombie ent_flag_clear("disciple_binding");
    ...
    if (isdefined(self.var_f66d11abec68c93)) {
        foreach (zombie in self.var_f66d11abec68c93) {
            if (isalive(zombie)) {
...
function function_997cc9f014de985e() {
    ...
    foreach (target in self.var_a45b8880623f6ceb) {
        ...
        var_26c750c289c6be7c = getclosest(target.origin, level.var_435b0b02f90918e6);
        if (!isdefined(var_26c750c289c6be7c) || distance2dsquared(var_26c750c289c6be7c.origin, target.origin) > squared(var_26c750c289c6be7c.radius)) {
            var_ce30c49c552496c5 = spawnstruct();
            var_ce30c49c552496c5.origin = target.origin;
            var_ce30c49c552496c5.radius = 200;
            level.var_435b0b02f90918e6[self getentitynumber()] = var_ce30c49c552496c5;
            return target;
        }
    }
    return undefined;
...
function private function_3a97865288f76c1() {
    ...
    if (!isdefined(level.var_6871167d3305002a)) {
        level.var_6871167d3305002a = function_e4c99b0f178ffb98("disciple_bind_seek", 1);
    }
    ...
    while (1) {
        ...
        var_fd02f94787a8f6dd = 1000;
        var_fd02f94787a8f6dd = var_fd02f94787a8f6dd - self.var_f66d11abec68c93.size * 170;
        var_fd02f94787a8f6dd = max(var_fd02f94787a8f6dd, 200);
        var_d5d86ba6c0666c9c = [];
        var_c627aeb66d53c60e = getaiarrayinradius(self.origin, var_fd02f94787a8f6dd, self.team);
        foreach (var_d6bbd8ce2a803432 in var_c627aeb66d53c60e) {
            ...
            var_d5d86ba6c0666c9c[var_d5d86ba6c0666c9c.size] = var_d6bbd8ce2a803432;
            if (var_d5d86ba6c0666c9c.size > self.var_8cd38ec42108e4c7 * 2) {
                break;
            }
        }
        self.var_a45b8880623f6ceb = sortbydistance(var_d5d86ba6c0666c9c, self.origin);
    }
}
...
function private function_52c89f7a18377d66() {
    ...
    if (!isdefined(level.var_e15ecdfc97f7c5ac)) {
        level.var_e15ecdfc97f7c5ac = function_e4c99b0f178ffb98("disciple_bound_wander", 1);
    }
