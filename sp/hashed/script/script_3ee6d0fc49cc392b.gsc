...
#namespace namespace_302d5c93465d1b8a;

// Namespace namespace_302d5c93465d1b8a / namespace_54e9bc2384ada773
// Params 0, eflags: 0x0
...
function main() {
    ...
    namespace_8532defdbaede15a::main();
    ...
    init_flags();
    function_508e65c95fcc242d();
    thread function_f17dcd8e9b481dd7();
    thread function_d4ae4354629ac8e5();
    ...
    namespace_da16efa8eb97d1c0::main();
...
function function_ff5d9827b7a048eb() {
    ...
    add_start("riot", &function_34c2a4e3152a6460, &function_3efabbdb5813a9f9, ["sp_jup_vip_cell_tr", "sp_jup_vip_panopticon_tr"], &function_da753a8b4cc3cdb6);
    add_start("elevator", &function_fc9d076b0de32ba8, &function_28d49916627cdb61, ["sp_jup_vip_cell_tr", "sp_jup_vip_panopticon_tr"], &function_ba71f4c16efdae8e);
    ...
    add_start("cliff_start", &cliff_start, &function_53f02424578f97df, ["sp_jup_vip_rooftop_tr", "sp_jup_vip_gulag_exterior_tr", "sp_jup_vip_exfil_tr", "sp_jup_vip_exfil_hallway_tr", "sp_jup_vip_infil_vista_tr", "sp_jup_vip_tower_tr"], &function_45ec82c0014d1b4c);
    add_start("slide_start", &slide_start, &function_4d59903d07765916, ["sp_jup_vip_rooftop_tr", "sp_jup_vip_gulag_exterior_tr", "sp_jup_vip_exfil_tr", "sp_jup_vip_exfil_hallway_tr", "sp_jup_vip_infil_vista_tr", "sp_jup_vip_tower_tr"], &function_b3737ce225248a9f);
...
// Size: 0x194
function function_7f9cf75b9c10ff95() {
    ...
    wait 2;
    function_9185173ee7017a51(explosion, 0);
    function_9185173ee7017a51(var_8248e8af5fd4ed8a, 0);
    ...
    wait 10;
    if (isdefined(alarms)) {
        function_9185173ee7017a51(alarms, 2.5);
    }
    flag_wait("flag_infil_player_at_door");
    if (isdefined(walla)) {
        function_9185173ee7017a51(walla, 2.5);
    }
...
// Size: 0x368
function function_d4ae4354629ac8e5() {
...
// Size: 0x900
function function_f17dcd8e9b481dd7() {
    ...
    var_1a9894427b039642 = getstruct("obj_infil_reach_cells_wall", "targetname");
    objective_update("rescue_makarov", "current", var_1a9894427b039642.origin, %SP_JUP_VIP/OBJ_RESCUE_PRISONER);
    objectiveindex = _objective_getindexforname("rescue_makarov");
    objective_setplayintro(objectiveindex, 1);
    flag_wait("flag_obj_synch_with_bravo");
    flag_wait("flag_obj_infil_wall_complete");
    var_1a9894427b039642 = getstruct("obj_infil_reach_cells_maintenance", "targetname");
    objective_update("rescue_makarov", "current", var_1a9894427b039642.origin, %SP_JUP_VIP/OBJ_RESCUE_PRISONER);
    flag_wait("flag_obj_infil_maintenance_start");
    flag_clear("wind_on");
    var_1a9894427b039642 = getstruct("obj_infil_maint_hatch", "targetname");
    objective_update("rescue_makarov", "current", var_1a9894427b039642.origin, %SP_JUP_VIP/OBJ_RESCUE_PRISONER);
    function_3234e40df03b0a40("rescue_makarov");
    flag_wait("flag_maint_obj_update");
    var_1a9894427b039642 = getstruct("obj_infil_maint_hatch_lower", "targetname");
    objective_update("rescue_makarov", "current", var_1a9894427b039642.origin, %SP_JUP_VIP/OBJ_RESCUE_PRISONER);
    flag_wait("flag_obj_infil_maintenance_complete");
    var_1a9894427b039642 = getstruct("obj_infil_reach_cells_pipe_room_end", "targetname");
    objective_update("rescue_makarov", "current", var_1a9894427b039642.origin, %SP_JUP_VIP/OBJ_RESCUE_PRISONER);
    function_ff959ec1bd44c166("rescue_makarov", 0);
    flag_wait("flag_obj_infil__pipe_room_complete");
    var_1a9894427b039642 = getstruct("infil_pipe_gate_interact", "targetname");
    objective_update("rescue_makarov", "current", var_1a9894427b039642.origin, %SP_JUP_VIP/OBJ_RESCUE_PRISONER);
    function_ff959ec1bd44c166("rescue_makarov", -90);
    flag_wait("flag_obj_reach_makarov_activate");
    function_ff959ec1bd44c166("rescue_makarov", 0);
    var_1a9894427b039642 = getstruct("obj_location_rescue_627", "targetname");
    objective_update("rescue_makarov", "current", var_1a9894427b039642.origin, %SP_JUP_VIP/OBJ_RESCUE_PRISONER, undefined, undefined, undefined, undefined, undefined);
    objectiveindex = _objective_getindexforname("rescue_makarov");
    objective_setplayintro(objectiveindex, 1);
    flag_wait("flag_obj_assess_threat_1");
    var_1a9894427b039642 = getstruct("lookat_level_1_pushdown", "targetname");
    objective_add("assess_threats", "current", var_1a9894427b039642.origin, %SP_JUP_VIP/OBJ_ELIMINATE_GUARDS, undefined, undefined, undefined, undefined, undefined, 1);
    objective_add_location_position("assess_threats", "lookat_level_1_cells", var_1a9894427b039642.origin);
    objectiveindex = _objective_getindexforname("assess_threats");
    objective_setplayintro(objectiveindex, 1);
    flag_wait("flag_obj_assess_threat_2");
    var_1a9894427b039642 = getstruct("lookat_level_2_cells", "targetname");
    objective_add_location_position("assess_threats", "lookat_level_2_cells", var_1a9894427b039642.origin);
    flag_wait("flag_obj_assess_threat_3");
    var_1a9894427b039642 = getstruct("lookat_level_3_cells", "targetname");
    objective_add_location_position("assess_threats", "lookat_level_3_cells", var_1a9894427b039642.origin);
    ...
    var_1a9894427b039642 = getstruct("obj_infil_rescue_makarov", "targetname");
    objective_update("rescue_makarov", "current", var_1a9894427b039642.origin, %SP_JUP_VIP/OBJ_RESCUE_PRISONER);
    objectiveindex = _objective_getindexforname("rescue_makarov");
    objective_setplayintro(objectiveindex, 1);
    ...
    var_bc4cbb9e7a2477d3 = getstruct("reach_vip_pcap_interact", "targetname");
    objective_update("rescue_makarov", "current", var_bc4cbb9e7a2477d3.origin, %SP_JUP_VIP/OBJ_RESCUE_PRISONER, undefined, undefined, 0, 1);
    objectiveindex = _objective_getindexforname("rescue_makarov");
    objective_setplayintro(objectiveindex, 1);
    function_ff959ec1bd44c166("rescue_makarov", -110);
    ...
    objective_remove_location("escape_makarov", "makarov");
    objective_set_z_offset("escape_makarov", 0);
    var_1a9894427b039642 = getstruct("obj_struct_gatehouse_tunnel", "targetname");
    objective_update("escape_makarov", "current", var_1a9894427b039642.origin, %SP_JUP_VIP/OBJ_ESCAPE_MAKAROV, undefined, undefined, 0, 1);
    objectiveindex = _objective_getindexforname("escape_makarov");
    objective_setplayintro(objectiveindex, 1);
...
// Size: 0x79
function function_508e65c95fcc242d() {
