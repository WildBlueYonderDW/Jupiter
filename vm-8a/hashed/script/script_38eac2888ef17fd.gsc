...
function init_nuke() {
    ...
    /#
        ...
        function_b23a59dfb4ca49a1("<dev string:x2c>", "<dev string:x43>", &function_e2b8eeccc951133f);
        function_b23a59dfb4ca49a1("<dev string:x5e>", "<dev string:x75>", &function_e2b8eeccc951133f);
