...
function sharekillxp(inxp) {
    ...
    if (players.size > 1) {
        ...
        case #"hash_fa7b69e7b63430d3":
            ...
            returnval = returnval * var_774c32865ce6ed66;
            break;
        ...
        case #"hash_8f01ce022684fbc8":
            ...
            var_909fb4fd1b455b29 = 1;
            returnval = returnval * var_281f5f544dfe29d6;
            break;
        ...
        case #"hash_ca6516c10db2c95":
            ...
            var_909fb4fd1b455b29 = 1;
            returnval = returnval * var_cd4f215570e9f234;
            break;
        default:
            break;
        }
...
function private modifyunifiedpoints(event, points, objweapon) {
    ...
    if (isdefined(level.modifyunifiedpointscallback)) {
        ...
        points = points * self.point_scalar;
    }
    return int(points);
}
