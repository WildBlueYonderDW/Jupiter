...
function function_45b5920db7a5ad60(var_bb7a49ed7b440d16) {
    ...
    #/
    while (true) {
        idamage, eattacker, vdir, vpoint, smeansofdeath, smodelname, stagname, spartname, idflags, objweapon, origin, angles, normal, einflictor, eventid = self waittill("damage");
...
function function_f6bc7d593d54cfec(use_ent, var_830905e5c2645826, var_cebb22306f7a7c58) {
    ...
    while (true) {
        player = use_ent waittill("trigger");
        if (!isplayer(player)) {
            continue;
        }
...
function script_model_spawn_and_use_logic(var_b1ad25ad91b2627d, var_45cfcb352a9b4a37, single_use) {
    var_b1ad25ad91b2627d endon("entitydeleted");
    while (true) {
        capturer = var_b1ad25ad91b2627d waittill("trigger");
...
function function_560360ba45cb3607() {
    ...
    while (true) {
        var_9a194154f62d1bdc function_dfb78b3e724ad620(1);
        player = var_9a194154f62d1bdc waittill("trigger");
...
function function_976823b9e5a0aa81(stop_trigger, groupname) {
    level endon("game_ended");
    while (true) {
        player = stop_trigger waittill("trigger");
        if (!isplayer(player)) {
            continue;
        }
