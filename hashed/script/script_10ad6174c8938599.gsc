...
function function_6360197cfe54c18e(immediaterelease) {
    ...
    bundle = level.streakglobals.streakbundles["cluster_spike"];
    while (true) {
        grenade, objweapon, tickpercent, originalowner = clusterowner waittill("grenade_fire");
...
function function_b6f9b15b3da67aa0() {
    /#
        ...
        level endon("<unknown string>" + self.clusterid);
        while (true) {
        ...
        self notify("<unknown string>", [self.owner]);
    #/
}
