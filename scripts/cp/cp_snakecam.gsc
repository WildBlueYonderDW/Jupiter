...
function function_db2fc31c8b3c4ec1() {
    ...
    namespace_6250b14b3f614101::takeweaponsdefaultfunc();
}
...
function restoreweaponsdefaultfunc() {
    ...
    if (isdefined(self.primaryweaponobj)) {
        ...
        if (isdefined(self.primaryweaponclipammo)) {
            ...
            namespace_6250b14b3f614101::function_4906c10c3ffdd4ca(self.primaryweaponobj, self.primaryweaponstockammo);
        }
    }
    if (isdefined(self.secondaryweaponobj)) {
        ...
        if (isdefined(self.secondaryweaponclipammo)) {
            namespace_6250b14b3f614101::function_4906c10c3ffdd4ca(self.secondaryweaponobj, self.secondaryweaponstockammo);
        }
    }
...
function snake_cam_control(var_693ec2852a7de810, var_f55fe461499f0e19) {
    ...
    while (istrue(self.isusingcamera)) {
        ...
        currentangles = input;
        var_4d8cd161a8eaadc2 = math::factor_value(0, 0.165, var_fed6e82d22bb75e);
        rumble = math::factor_value(0, 0.08, var_fed6e82d22bb75e);
        if (var_4d8cd161a8eaadc2 > 0.165) {
            var_4d8cd161a8eaadc2 = 0.165;
        }
        if (var_4d8cd161a8eaadc2 > 0.005) {
            self earthquakeforplayer(var_4d8cd161a8eaadc2, 0.07, self.origin, 2000);
        }
        if (rumble > 0.0001) {
...
function function_d25799279ec14c4c(var_aa8ac5c98f3a9029) {
    ...
    foreach (var_26baefb3804b52c3 in var_8c73c4add30bb4b2) {
    ...
    wait 2.5;
    foreach (var_26baefb3804b52c3 in var_8c73c4add30bb4b2) {
        if (var_26baefb3804b52c3 scriptableisdoor() && !istrue(var_26baefb3804b52c3.var_7b4b93daa27c204e)) {
...
// Size: 0x212
function function_b7ba2558645c3bba() {
...
function _ontabletgiven(streakinfo, switchresult) {
    ...
    thread namespace_47366e00aa4211f4::_cleanuptabletallows();
    thread namespace_47366e00aa4211f4::_cancelputawayonuseend(streakinfo);
    return true;
}
...
// Size: 0x1a2
function function_45da058b481f8049(streakinfo, var_bdffc63c4171c131, var_8fd4d93dd619da88, var_91f739c2c51347d4, var_d55d8445518099b, var_f6a32dcc4b19aad9, var_67a06b4ea269058e, waittime) {
    level endon("game_ended");
    self endon("disconnect");
    ...
    var_2ed8c4e06182fd14 = getanimlength(deployanim) - 1.5;
    ...
    switchresult = switchtodeployweapon(weaponobj, streakinfo, &function_67f13db1409ec06d, var_bdffc63c4171c131, var_8fd4d93dd619da88, var_91f739c2c51347d4, var_d55d8445518099b);
    ...
    animresult = function_2fe0097fb626c353(streakinfo, var_2ed8c4e06182fd14, var_67a06b4ea269058e);
    ondeployfinished(streakinfo);
