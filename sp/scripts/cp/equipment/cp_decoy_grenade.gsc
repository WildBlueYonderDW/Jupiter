...
#namespace cp_decoy_grenade;

// Namespace cp_decoy_grenade / scripts\cp\equipment\cp_decoy_grenade
// Params 0, eflags: 0x0
...
function decoy_debuffenemiesinrange()
{
    ...
    foreach ( ai in all_ai )
    {
        ...
        if ( ai scripts\cp\spawning::is_specified_unittype( "suicidebomber" ) )
        {
