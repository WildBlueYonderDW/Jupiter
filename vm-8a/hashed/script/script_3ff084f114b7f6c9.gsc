...
/#
    ...
    function function_ec7c2b6761cd9ab3() {
        ...
        scripts\common\devgui::function_b2159fbbd7ac094e("<dev string:x32>", @"hash_f7804c5dfa9407ca");
        scripts\common\devgui::function_b2159fbbd7ac094e("<dev string:x42>", @"hash_b954d42a85390b5b");
        scripts\common\devgui::function_b2159fbbd7ac094e("<dev string:x5b>", @"hash_5eedf824f533d2e6");
        scripts\common\devgui::function_b2159fbbd7ac094e("<dev string:x76>", @"hash_8b77db100df49d5e");
    ...
    function private function_5a35520fca6b5b34(bot, player) {
        ...
        player setclientomnvar("<dev string:x95>", bot getentitynumber());
        player setclientomnvar("<dev string:xaf>", 0);
        player.var_7f1423df13bbb144 = bot;
        player thread function_b530aa511cac761(player);
        if (issharedfuncdefined("<dev string:xce>", "<dev string:xd2>")) {
            splashcooldown = function_82aca4b8517cf46a();
            if (!isdefined(player.var_312490cd130c9914) || player.var_312490cd130c9914 + splashcooldown > gettime() || player.var_4f8afa3693e318d4 != 0) {
                [[ getsharedfunc("<dev string:xce>", "<dev string:xd2>") ]]("<dev string:xe2>", [player], undefined, bot getentitynumber());
                player.var_312490cd130c9914 = gettime();
            }
        }
        player.var_4f8afa3693e318d4 = 0;
        namespace_446fc987a980892f::playevent("<dev string:x102>", [bot]);
        var_3d290d914e1249a0 = [player];
        if (var_3d290d914e1249a0.size > 0) {
            namespace_446fc987a980892f::playevent("<dev string:x11c>", var_3d290d914e1249a0);
            function_f3bb4f4911a1beb2("<dev string:x131>", "<dev string:x13e>", bot, var_3d290d914e1249a0);
        }
    }
