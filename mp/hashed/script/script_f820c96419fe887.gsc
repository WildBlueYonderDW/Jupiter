...
function init() {
    ...
    level.brgametype.var_a4a60d445462181d = getdvarint(@"hash_b5ac32636b6ff882", 0);
...
function modifyplayerdamage(data) {
    ...
    if (var_7bfcad6985f865ac && var_8d6deeb9c425ce1b && data.meansofdeath == "MOD_MELEE") {
        ...
        var_49e6ef3edadd524e = namespace_e0ee43ef2dddadaa::getweaponrootname(data.objweapon);
        weapontype = weaponclass(weaponbasename);
        var_1646fe11681a5388 = namespace_f8d3520d3483c1::isbulletpenetration(data.idflags);
        if (!var_1646fe11681a5388) {
            switch (weapontype) {
            case #"hash_6191aaef9f922f96":
                if (data.shitloc == "head" || data.shitloc == "helmet") {
                    if (scripts\mp\gametypes\br::issnipersemi(var_49e6ef3edadd524e)) {
        ...
        var_6721e451f9be96aa = hashcat(@"hash_199e1d44104c7cb8", var_49e6ef3edadd524e);
        defaultsetting = 0;
        if (var_49e6ef3edadd524e == "iw8_sh_charlie725") {
            defaultsetting = 1.43;
        }
...
function playersetiszombie(value, var_5fd0c9cf6d0e1d68) {
    ...
    if (value) {
        ...
        if (level.brgametype.var_a4a60d445462181d) {
...
function playerzombierespawn(var_fd96c3c1ec7b2988, var_babf157dec7ecb90) {
    ...
    if (scripts\mp\gametypes\br_gametypes::isbrgametypefuncdefined("playerGetZombieSpawnLocation")) {
        var_57ac4dc40b2e376 = scripts\mp\gametypes\br_gametypes::runbrgametypefunc("playerGetZombieSpawnLocation");
        spawnangles = var_57ac4dc40b2e376[1];
        spawnorigin = var_57ac4dc40b2e376[0];
    } else {
        var_57ac5dc40b2e5a9 = playergetzombiespawnlocation();
    ...
    childthread function_1d3f5814f83dd9ac(var_e3438b8cb9c2c515);
...
// Size: 0x5b
function playerregenhealthadd(var_7c90dd5575d81006) {
    if (playeriszombie()) {
        if (istrue(self.zombieingas)) {
            return int(level.brgametype.zombieregenratescaleingas * var_7c90dd5575d81006);
        } else {
            return int(level.brgametype.zombieregenratescaleoutgas * var_7c90dd5575d81006);
        }
    }
    return undefined;
}
...
function function_fd7bdffe7cea51ed(iszombie) {
    ...
    namespace_8ade6bdb04213c12::function_9368fff2b3156346(iszombie);
}
...
// Size: 0x57
function playerregendelayspeed(var_dec837630eb16caf) {
    if (playeriszombie()) {
        if (istrue(self.zombieingas)) {
            return (1 / level.brgametype.zombieregendelayscaleingas * var_dec837630eb16caf);
        } else {
            return (1 / level.brgametype.zombieregendelayscaleoutgas * var_dec837630eb16caf);
        }
    }
    return undefined;
}
...
function function_10ffa1071b1c2681() {
    ...
    foreach (offhandobj in var_a8b87696ab744141) {
        ...
        var_45f93a3ba26bd0b7.ammoclip[offhandname] = var_26d3ccffc7bebec9;
    }
...
function playergetzombiespawnlocation() {
    ...
    var_c00a346249963f1b = getvalidatedspawnorgangles(origin, dir, dist);
    spawnangles = var_c00a346249963f1b[1];
    startorigin = var_c00a346249963f1b[0];
    if (!isdefined(startorigin)) {
        dir *= -1;
        var_c00a336249963ce8 = getvalidatedspawnorgangles(origin, dir, dist);
        spawnangles = var_c00a336249963ce8[1];
        startorigin = var_c00a336249963ce8[0];
    }
    if (!isdefined(startorigin)) {
        dir = (1, 0, 0);
        var_bffcba6249871e48 = getvalidatedspawnorgangles(origin, dir, dist);
        spawnangles = var_bffcba6249871e48[1];
        startorigin = var_bffcba6249871e48[0];
    }
    if (!isdefined(startorigin)) {
        dir = (-1, 0, 0);
        var_bffcbb624987207b = getvalidatedspawnorgangles(origin, dir, dist);
        spawnangles = var_bffcbb624987207b[1];
        startorigin = var_bffcbb624987207b[0];
    }
    if (!isdefined(startorigin)) {
        dir = (0, 1, 0);
        var_bffcbc62498722ae = getvalidatedspawnorgangles(origin, dir, dist);
        spawnangles = var_bffcbc62498722ae[1];
        startorigin = var_bffcbc62498722ae[0];
    }
    if (!isdefined(startorigin)) {
        dir = (0, -1, 0);
        var_bffcbd62498724e1 = getvalidatedspawnorgangles(origin, dir, dist);
        spawnangles = var_bffcbd62498724e1[1];
        startorigin = var_bffcbd62498724e1[0];
    }
    if (!isdefined(startorigin)) {
...
function playerzombieisingas() {
    ...
    return distance2dsquared(var_819edacdacb810e4, self.origin) > dangercircleradius * dangercircleradius;
}
...
// Size: 0x64
function private function_1d3f5814f83dd9ac(weapon) {
    player = self;
...
function onplayerdamaged(data) {
    ...
    if (data.victim playeriszombie() && var_e255f974b378c965) {
        data.attacker thread function_a6e881dadec5222e(data.victim, data.victim.headicon);
    }
...
// Size: 0x64
function function_a6e881dadec5222e(targetent, var_fafaa28d217bf19c) {
    level endon("game_ended");
...
// Size: 0x1e0
function addpowerbutton(powerstruct, powerref, var_918ea1f249a033ae, var_fb3a9f61fc511db4, var_91513a57aa89be6d, var_1a5269312d3a0b00, cleanupfunc, var_7939d347ade41da0, label, labelpc, cooldownsec, var_84f872ff989aaf52, var_b11f66f8bf2c2553) {
    var_2afd19924dad2b4f = hashcat(@"hash_b75ff36b09040395", powerref);
    if (getdvarint(var_2afd19924dad2b4f, 1) == 0) {
        return;
    }
    if (isstring(var_918ea1f249a033ae)) {
        var_918ea1f249a033ae = [var_918ea1f249a033ae];
    }
    powerstruct.powers[powerref] = spawnstruct();
    powerstruct.powers[powerref].bindings = var_918ea1f249a033ae;
    ...
    powerstruct.powers[powerref].var_84f872ff989aaf52 = var_84f872ff989aaf52;
    powerstruct.powers[powerref].var_b11f66f8bf2c2553 = var_b11f66f8bf2c2553;
...
function playerstartpowers(powerstruct) {
    ...
    foreach (powerref, var_8723cff430a72c82 in powerstruct.powers) {
        if (isdefined(powerstruct.powers[powerref].var_84f872ff989aaf52)) {
            function_936f0ef6e203a7fc(powerstruct.powers[powerref].var_84f872ff989aaf52, 2);
        }
    }
}
...
function kioskreviveplayer(sponsor, tokenused) {
    ...
    if (!isalive(player) && istrue(player.br_iseliminated)) {
        ...
        var_c017426249a4726a = namespace_8bfdb6eb5a3df67a::playerhandlesponsor(sponsor, tokenused, 0, 1, 0, "zombiesRevive");
        var_df2fbb13c226be75 = var_c017426249a4726a[1];
        var_84e2123aaca9a965 = var_c017426249a4726a[0];
...
function function_90f6fbbb6332dadd(powerstruct, powerref, cooldownsec, var_25ccce114196d19c) {
    ...
    self endon("zombie_set");
    self endon("disableCooldown");
    if (!isdefined(powerstruct.powers[powerref].var_84f872ff989aaf52) || !isdefined(powerstruct.powers[powerref].var_b11f66f8bf2c2553)) {
        return;
    }
    function_936f0ef6e203a7fc(powerstruct.powers[powerref].var_84f872ff989aaf52, 1);
    ...
    while (gettime() < endtime) {
        ...
        function_936f0ef6e203a7fc(powerstruct.powers[powerref].var_b11f66f8bf2c2553, int(progress));
        waitframe();
    }
...
function function_f2ddb7c78178c1be(powerstruct, powerref) {
    ...
    self endon("zombie_unset");
    if (isdefined(powerstruct.powers[powerref].var_84f872ff989aaf52)) {
        function_936f0ef6e203a7fc(powerstruct.powers[powerref].var_84f872ff989aaf52, 3);
    }
...
function playerzombiejump(powerstruct, powerref) {
    ...
    while (!function_77bab0532bc12f0e()) {
        ...
        if (level.brgametype.var_a4a60d445462181d && prevfrac < var_eec1ca5327266614 && self.var_17c60a92aea65107 >= var_eec1ca5327266614) {
...
function sortbylastzombietime(left, right) {
    var_10374502ed47925d = level.teamdata[left]["lastZombieTime"];
    var_1b1911b9658c8a60 = level.teamdata[right]["lastZombieTime"];
    return var_10374502ed47925d >= var_1b1911b9658c8a60;
}
...
function function_e4cffb22a28408e2() {
    wait 5;
    namespace_e688cd9db0404268::function_f1aed36ab4598ea("br_zxp");
}
