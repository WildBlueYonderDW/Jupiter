...
function function_359ea987396492db() {
    ...
    /#
        if (istrue(level.var_8abd2c3c0748dfdd)) {
            ...
            println("<dev string:x60>" + var_ccff9574f6a53859);
            println("<dev string:x77>" + var_b60a2ad1b8eb2369);
            println("<dev string:x89>" + level.agentarray.size);
            println("<dev string:x9a>" + isdefined(level.stealth));
            println("<dev string:x1c>");
        }
    #/
    possiblelocations = [];
        ...
        if (isdefined(loc) && isdefined(loc.origin) && isdefined(loc.angles) && isdefined(objectivename)) {
            ...
            /#
                if (!isdefined(agent) && istrue(level.var_8abd2c3c0748dfdd)) {
                    ...
                    println("<dev string:xca>" + aitype);
                    println("<dev string:xd3>" + loc.origin);
                    println("<dev string:xdb>" + loc.angles);
                    println("<dev string:x1c>");
                }
            #/
        }
