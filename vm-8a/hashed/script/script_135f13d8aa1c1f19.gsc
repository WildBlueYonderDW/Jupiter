...
function function_b92559336d4290b3() {
    assertex(isdefined(level.var_81e77c935dfefd11), "<dev string:x49>");
...
function function_9f181ae293d9b65f(task, team, success) {
    ...
    assertex(isdefined(questchain), "<dev string:x71>");
...
function function_e447c95f657d5325(task, team, success) {
    level endon("game_ended");
    questchain = function_c6ec58a3c19cd74d(team);
    assertex(isdefined(questchain), "<dev string:xb7>");
    if (istrue(success)) {
...
function function_95241846d4382372(task, team) {
    ...
    assertex(isdefined(questchain), "<dev string:xf4>");
...
function function_ee4cd3ba8fd7b953(task, team) {
    questchain = function_c6ec58a3c19cd74d(team);
    assertex(isdefined(questchain), "<dev string:x132>");
    if (!isdefined(questchain)) {
        return;
    }
    questchain.index++;
...
function function_26f3066ca0cd1957(task, team, success) {
    questchain = function_c6ec58a3c19cd74d(team);
    assertex(isdefined(questchain), "<dev string:x16f>");
    if (!isdefined(questchain)) {
        return;
    }
...
function function_3dd1a630275d19af(team) {
    ...
    task = self;
    questchain = function_c6ec58a3c19cd74d(team);
    assertex(isdefined(questchain), "<dev string:x1a7>");
    if (!isdefined(questchain)) {
        return;
    }
    level endon("game_ended");
