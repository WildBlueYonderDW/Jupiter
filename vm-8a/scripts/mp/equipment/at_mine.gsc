...
/#
    ...
    function function_d9f2aec6c4f8ed31() {
        ...
        mineowner notifyonplayercommand("<dev string:x40>", "<dev string:x4c>");
        mineowner notifyonplayercommand("<dev string:x40>", "<dev string:x57>");
        while (true) {
            mineowner waittill("<dev string:x40>");
