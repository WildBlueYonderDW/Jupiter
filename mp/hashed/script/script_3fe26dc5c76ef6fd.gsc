...
function function_2dcca6d862cc31d5(params) {
    ...
    if (getdvarint(@"hash_1feb217517503155", 0)) {
        namespace_e66982003565a5bf::function_b60de1b748c7230f();
    }
...
function private function_868dda939525d6dd() {
    ...
    if (var_a284af43d8329f61.size > 1) {
        return (distance2d(var_a284af43d8329f61[0].origin, var_a284af43d8329f61[1].origin) / 1.1);
    }
}
...
function function_1bf53eccbaaa61d3() {
    ...
    thread function_461a53da789dc8f7();
    thread function_37a680e171e980b();
    thread function_d6be862ee76f002c();
    namespace_e66982003565a5bf::function_2e656805e9a5c512();
    ...
    activity_common::function_8b5b2a3392fc7e2a("ActivityBegin", &function_cce044c80f7ca41e, "REV_OB_ZOMBIE_CONTROL");
    ...
    activity_common::function_8b5b2a3392fc7e2a("ActivitySuccess", &function_b6697d395d77e302, "REV_OB_ZOMBIE_CONTROL");
...
function function_37a680e171e980b(var_a435c0ced8cb1a74) {
    ...
    if (!var_a435c0ced8cb1a74) {
        ...
        level.var_9dadf39af32dd792 = getdvarint(@"hash_73cfb77eb49c943", 0) ? 900 : 1800;
    ...
    while (true) {
        if (isdefined(self.analysis_progress) && self.analysis_progress >= 50) {
            if (!istrue(self.var_d2b773de97960edb)) {
                ...
                var_2e5d36dbe0e4cffd = self.var_a897d5b8c6afdc34.origin;
                ...
                wait 2.5;
                var_17d6270e00b876fc = namespace_1c689dd3986a841c::spawn_request("ai_encounter:" + "s5_rift_run_outlast_boss", level.var_fbb9f03952513155.origin, level.var_fbb9f03952513155.radius, 1, 1);
                break;
            }
        }
        wait 0.1;
...
// Size: 0x85
function function_461a53da789dc8f7() {
    if (!getdvarint(@"hash_73cfb77eb49c943", 0)) {
    ...
    for (i = 0; i < a_spawns.size; i++) {
        ...
        foreach (var_9eb7ab2bffa0be65 in var_763be5feec8258b8) {
            if (var_9eb7ab2bffa0be65.script_noteworthy == a_spawns[i].script_noteworthy) {
                ...
                if (var_9eb7ab2bffa0be65.script_noteworthy == "OUTLAST_TOWER") {
                    b_invert = 1;
...
function function_4afe89cc48518762() {
    ...
    while (true) {
        if (self.origin[2] <= 400) {
            if (!self.var_8034062bebf15f98) {
                self.var_8034062bebf15f98 = 1;
                self function_d493e7fe15e5eaf4("zombie_default_fog");
            }
        } else if (self.var_8034062bebf15f98) {
...
function function_d6be862ee76f002c() {
    ...
    foreach (scriptable in var_3ba758145a58afe0) {
        if (scriptable getscriptablehaspart("nexus_activity_joiner_phone")) {
            ...
            namespace_5775ad2badedbcaa::function_32645103f7520635(scriptable, &function_3b588416e348d52a);
        }
    }
}
...
function function_97d209693a217b2a() {
    ...
    foreach (var_6540852fe2570bf0 in var_3f06b4ec56e5119) {
        namespace_2abc885019e1956::function_cd45408bd44fab07("ob_jup_items_rift_run_locked_spaces_loot", 1, var_6540852fe2570bf0.origin, var_6540852fe2570bf0.angles + (0, 90, 0), 1, 1);
    }
}
...
function function_79eeaeaaa71ade27() {
    ...
    foreach (var_5309b78f7ad7d3c4 in var_f8bf483b77217871) {
        if (isdefined(var_5309b78f7ad7d3c4.script_noteworthy)) {
            ...
            e_floater.var_280fff393f8fb869 = 1;
...
// Size: 0x2fa
function function_25ec394f5469ed5b(var_3268b3995f1128e0) {
    self endon("death");
    self endon("pause_floater");
    level endon("game_ended");
    var_3268b3995f1128e0 = default_to(var_3268b3995f1128e0, "floater_custom_endon_flag");
    if (flag(var_3268b3995f1128e0)) {
        return;
    }
    level endon(var_3268b3995f1128e0);
    ...
    while (true) {
        ...
        if (isdefined(self.script_radius)) {
            var_bde0a0fd36314443 = randomfloatrange(self.script_radius * 0.334, self.script_radius);
        } else {
...
// Size: 0x12d
function function_18954968a63cc736(var_3268b3995f1128e0) {
    self endon("death");
    self endon("pause_floater");
    level endon("game_ended");
    var_3268b3995f1128e0 = default_to(var_3268b3995f1128e0, "floater_custom_endon_flag");
...
/#
    ...
    function function_766051ffd48a45ca() {
        ...
        while (!isdefined(level.var_5e700e2eb2fb2b97)) {
            wait 1;
        }
        while (true) {
            var_cb22b07a6265b426 = 0;
            foreach (var_5309b78f7ad7d3c4 in level.var_5e700e2eb2fb2b97) {
                if (istrue(var_5309b78f7ad7d3c4.var_280fff393f8fb869)) {
                    var_cb22b07a6265b426++;
                }
            }
            iprintlnbold("<dev string:x32>" + var_cb22b07a6265b426);
            wait 1;
        }
    }
...
function function_3ca7c1eaca8ca4d() {
    ...
    if (!istrue(self.var_fd76d1923bb8c803)) {
        ...
        var_df26ef1a4bdb476f = namespace_1c689dd3986a841c::spawn_request("ai_encounter:" + "s5_rift_run_match_start", level.var_9bdc7aed9af0a5d4.origin, level.var_9bdc7aed9af0a5d4.radius, 0, 1);
    ...
    while (true) {
        ...
        if (isplayer(ent)) {
            if (!istrue(self.var_10f8a48333511315)) {
                ...
                var_c1f77bbfaeb5d0fd = namespace_1c689dd3986a841c::spawn_request("ai_encounter:" + "s5_rift_run_escort_boss", level.var_aa61eff511d67c2e.origin, level.var_aa61eff511d67c2e.radius, 0, 1);
...
// Size: 0xac
function function_239e2507cceca751(var_e2fb5f745074aa6a) {
    level endon("game_ended");
    self endon("death");
    while (true) {
        var_e2fb5f745074aa6a waittill("trigger", ent);
        if (isplayer(ent)) {
            if (!istrue(self.var_518e4c5e9bca442c)) {
                self.var_518e4c5e9bca442c = 1;
                var_7897c5673cbcbe40 = namespace_1c689dd3986a841c::spawn_request("ai_encounter:" + "s5_rift_run_outlast", level.var_4afe965b997ab16f.origin, level.var_4afe965b997ab16f.radius, 0, 1);
...
// Size: 0xac
function function_6c2bd45f5e066d83(var_d5b0e04296d191bc) {
    level endon("game_ended");
    self endon("death");
    while (true) {
        var_d5b0e04296d191bc waittill("trigger", ent);
        if (isplayer(ent)) {
            if (!istrue(self.var_139b92f0eff06e6e)) {
                self.var_139b92f0eff06e6e = 1;
                var_5033bf896fb4400e = namespace_1c689dd3986a841c::spawn_request("ai_encounter:" + "s5_rift_run_escort", level.var_1309d4dcd226e8c9.origin, level.var_1309d4dcd226e8c9.radius, 0, 1);
...
// Size: 0xac
function function_63a5040c5afb5679(var_599ba9148c2aee32) {
    level endon("game_ended");
    self endon("death");
    while (true) {
        var_599ba9148c2aee32 waittill("trigger", ent);
        if (isplayer(ent)) {
            if (!istrue(self.var_2faacf290160ef54)) {
                self.var_2faacf290160ef54 = 1;
                var_c3f62259e0902628 = namespace_1c689dd3986a841c::spawn_request("ai_encounter:" + "s5_rift_run_sporecontrol", level.var_65a553350002cdb7.origin, level.var_65a553350002cdb7.radius, 0, 1);
...
function ob_ambient_zombie_waves_setup(difficulty) {
    ...
    if (isdefined(var_5e64675a5f0ce8cb) && !isdefined(level.var_c9f71ccc98610c37)) {
        level.var_c9f71ccc98610c37 = namespace_614554f86e52695c::spawn_request("ai_encounter:s5_rift_run_ambient_zombie_waves", var_5e64675a5f0ce8cb.origin, var_5e64675a5f0ce8cb.radius, 1, 0, 0);
    ...
    function function_2476244023968f4b() {
        ...
        while (true) {
            ...
            if (!isdefined(level.var_c45e3dbe3f74f8bc)) {
                ...
                function_6c9dbd2f5d5a6f02("<dev string:xa6>");
                function_6c9dbd2f5d5a6f02("<dev string:xcb>" + level.var_c45e3dbe3f74f8bc.var_dee92f874c6bcf57);
