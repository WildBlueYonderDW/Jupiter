...
#namespace jup_ob_schematic_soldier_buddy_5;

// Namespace jup_ob_schematic_soldier_buddy_5 / namespace_e8bb657e7ce6bdf5
// Params 0, eflags: 0x0
// Checksum 0x0, Offset: 0x27f
// Size: 0x1c9
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_ob_schematic_soldier_buddy_5" );
    self.var_534e788bc498be9f = getscriptbundle( %"hash_57d803ea117bcc0a" );
...
function precache()
{
    agent_type = "actor_jup_ob_schematic_soldier_buddy_5";
    ...
    if ( !isdefined( level.agent_definition[ agent_type ] ) )
    {
        ...
        level.agent_definition[ agent_type ][ "subclass" ] = getscriptbundle( %"hash_57d803ea117bcc0a" );
