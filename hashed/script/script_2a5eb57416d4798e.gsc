...
function private function_70bd06355933aec9(shotindex, animindex, notifystring, alignmentinfo, var_4f3089070d8b1e24, var_866b3a3066122e39, blendtime, blendcurve, lerptime) {
    ...
    if (entity.model == "") {
        /#
            println("<unknown string>" + var_214d924f4e137244.sceneobject.variant_object.name + "<unknown string>");
        #/
        return 0;
    }
    ...
    animlengthtime = animlengthtime + getanimlength(var_4f3089070d8b1e24);
