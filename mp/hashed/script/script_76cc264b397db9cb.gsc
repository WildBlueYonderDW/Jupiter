...
function joinsquad(team, index) {
    ...
    if (getdvarint(@"hash_631315ea4a7701a8", 0) > 0) {
        message = "[SQUAD CHANGE DEBUGGING] Player Joined Squad. Player: " + self.name + " Session Squad ID: " + index + " Session UI Member Index: " + self.var_3f78c6a0862f9e25;
...
function leavesquad(team, index) {
    ...
    callback::callback(#"hash_58cd2edf70911e82", {#memberindex:self.var_3f78c6a0862f9e25, #index:index, #team:team});
    ...
    if (getdvarint(@"hash_631315ea4a7701a8", 0) > 0) {
        message = "[SQUAD CHANGE DEBUGGING] Player: " + self.name + " Left Squad: " + index + " Session UI Member Index: " + self.var_3f78c6a0862f9e25;
        scripts\mp\utility\script::demoforcesre(message);
    }
...
function choosesquadleader(team, index) {
    ...
    if (getdvarint(@"hash_631315ea4a7701a8", 0) > 0) {
        message = "[SQUAD CHANGE DEBUGGING] Choose Squad Leader - Squad: " + index + " squadLeader: " + candidate.name + " Session UI Member Index: " + self.var_3f78c6a0862f9e25;
        scripts\mp\utility\script::demoforcesre(message);
    }
}
