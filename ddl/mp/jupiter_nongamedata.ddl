...
// bitSize: 0xcc10, members: 2
struct root {
    // offset: 0xcc08, bitSize: 0x8(0x1B)
    ValidationData validationData;
    // offset: 0x0, bitSize: 0xcc08(0x1981B)
...
struct NonGameData {
    ...
    // offset: 0x320, bitSize: 0x97c0(0x12f8B)
    UnlockTable isNew;
    // offset: 0x9ae0, bitSize: 0x40(0x8B)
    uint32 customization_background[2];
    // offset: 0x9b20, bitSize: 0x8(0x1B)
    SocialPrivacySetting receiveWhispers;
    // offset: 0x9b28, bitSize: 0x40(0x8B)
    uint64 toastNotificationUnpauseTimestamp;
    // offset: 0x9b68, bitSize: 0x20(0x4B)
    uint32 lastSeenChapterSteamOverlayOffToast;
    // offset: 0x9b88, bitSize: 0xc80(0x190B)
    SeasonalEventData seasonalEvents[8];
    // offset: 0xa808, bitSize: 0x80(0x10B)
    int32 consoleIDChunkHigh[4];
    // offset: 0xa888, bitSize: 0x20(0x4B)
    int32 lastPlayedCategoryID;
    // offset: 0xa8a8, bitSize: 0x8(0x1B)
    byte quickplayFilter;
    // offset: 0xa8b0, bitSize: 0x80(0x10B)
    int32 playerXuidLow[4];
    // offset: 0xa930, bitSize: 0x280(0x50B)
    TrackedChallenge trackedChallenge[10];
    // offset: 0xabb0, bitSize: 0x80(0x10B)
    int32 tournamentQuits[4];
    // offset: 0xac30, bitSize: 0x8(0x1B)
    SocialPrivacySetting receiveFriendRequests;
    // offset: 0xac38, bitSize: 0x200(0x40B)
    char lastPlayedPlayMenuRef[64];
    // offset: 0xae38, bitSize: 0xb8(0x17B)
    uint6 battlePassBreadCrumbs[23];
    // offset: 0xaef0, bitSize: 0x8(0x1B)
    PartyPrivacySetting partyPrivacySettings;
    // offset: 0xaef8, bitSize: 0x20(0x4B)
    int32 bigTournamentBanStart;
    // offset: 0xaf18, bitSize: 0x20(0x4B)
    uint32 mpMotdChecksum;
    // offset: 0xaf38, bitSize: 0x20(0x4B)
    int32 lastPlayedPlaylistID;
    // offset: 0xaf58, bitSize: 0x40(0x8B)
    uint64 influencerCodeTime;
    // offset: 0xaf98, bitSize: 0x20(0x4B)
    uint32 dailyChallengesLastSeenTime;
    // offset: 0xafb8, bitSize: 0x20(0x4B)
    uint32 brMotdChecksum;
    // offset: 0xafd8, bitSize: 0x20(0x4B)
    uint32 dailyChallengesPopupChecksum;
    // offset: 0xaff8, bitSize: 0x258(0x4bB)
    SocialPartySettings socialPartySettings[5];
    // offset: 0xb250, bitSize: 0x20(0x4B)
    uint32 cpMotdChecksum;
    // offset: 0xb270, bitSize: 0x20(0x4B)
    int32 tokensEarnedSinceLastBattlePassUpsell;
    // offset: 0xb290, bitSize: 0x80(0x10B)
    int32 connectionIDChunkHigh[4];
    // offset: 0xb310, bitSize: 0x20(0x4B)
    uint32 spUninstallPromptLastSeenTimestamp;
    // offset: 0xb330, bitSize: 0x20(0x4B)
    uint32 lastBattlePassMenuXp;
    // offset: 0xb350, bitSize: 0x8(0x1B)
    SocialPrivacySetting receiveChannelInvites;
    // offset: 0xb358, bitSize: 0x80(0x10B)
    int32 connectionIDChunkLow[4];
    // offset: 0xb3d8, bitSize: 0x20(0x4B)
    uint32 lastRank;
    // offset: 0xb3f8, bitSize: 0x20(0x4B)
    uint32 lastSeenSeasonSteamOverlayOffToast;
    // offset: 0xb418, bitSize: 0x10(0x2B)
    DefaultPartySettings defaultPartySettings;
    // offset: 0xb428, bitSize: 0x8(0x1B)
    SocialPrivacySetting receiveActivityInvites;
    // offset: 0xb430, bitSize: 0x80(0x10B)
    int32 playerXuidHigh[4];
    // offset: 0xb4b0, bitSize: 0x40(0x8B)
    int32 maxPrivatePartySize[2];
    // offset: 0xb4f0, bitSize: 0x650(0xcaB)
    TelescopeData telescopeData;
    // offset: 0xbb40, bitSize: 0x40(0x8B)
    uint32 customization_patch[2];
    // offset: 0xbb80, bitSize: 0x20(0x4B)
    int32 lastSeenActiveArmoryIndex;
    // offset: 0xbba0, bitSize: 0xa80(0x150B)
    DeviceConnectionHistory deviceConnectionHistory[3];
    // offset: 0xc620, bitSize: 0x8(0x1B)
    SocialPrivacySetting receiveGroupInvites;
    // offset: 0xc628, bitSize: 0x40(0x8B)
    uint32 customization_playercard_frame[2];
    // offset: 0xc668, bitSize: 0x40(0x8B)
    uint32 customization_playercard_title[2];
    // offset: 0xc6a8, bitSize: 0x80(0x10B)
    PlayerSortPreferences sortPreferences;
    // offset: 0xc728, bitSize: 0x200(0x40B)
    char savedUsername[64];
    // offset: 0xc928, bitSize: 0x200(0x40B)
    char influencerCode[64];
    // offset: 0xcb28, bitSize: 0x8(0x1B)
    byte lastBattlePassFreeTierSeen;
    // offset: 0xcb30, bitSize: 0x20(0x4B)
    uint32 storeLastSeenTime;
    // offset: 0xcb50, bitSize: 0x8(0x1B)
    byte battlePassPurchasePendingSeason;
    // offset: 0xcb58, bitSize: 0x20(0x4B)
    int32 currentTournament;
    // offset: 0xcb78, bitSize: 0x60(0xcB)
    PlayerConnectionHistory playerConnectionHistory;
    // offset: 0xcbd8, bitSize: 0x1
    bit toggleOfflineFriends;
    // offset: 0xcbd9, bitSize: 0x1
    bit alreadySeenSettingsMenu;
    // offset: 0xcbda, bitSize: 0x1
    bit isBPOnboardingCleared;
    // offset: 0xcbdb, bitSize: 0x1
    bit wereOperatorExecutionsValidated;
    // offset: 0xcbdc, bitSize: 0x1
    bit cross_play_enabled;
    // offset: 0xcbdd, bitSize: 0x1
    bit isShowProsAndConsEnabled;
    // offset: 0xcbde, bitSize: 0x1
    bit hasAnyTempBanActive;
    // offset: 0xcbdf, bitSize: 0x1
    bit mobileShaderDlogStarted;
    // offset: 0xcbe0, bitSize: 0x1
    bit wereWeaponEquippedAttachmentCategoriesValidated;
    // offset: 0xcbe1, bitSize: 0x1
    bit muteOnJoinParty;
    // offset: 0xcbe2, bitSize: 0x1
    bit party_autofill_lock;
    // offset: 0xcbe3, bitSize: 0x1
    bit disableProximityVoice;
    // offset: 0xcbe4, bitSize: 0x1
    bit wasProtuningPlayerDataConverted;
    // offset: 0xcbe5, bitSize: 0x20(0x4B)
    bit postShipFlags[32];
    // offset: 0xcc05, bitSize: 0x3
    pad __pad[3];
}

// bitSize: 0x97c0, members: 33
struct UnlockTable {
    // offset: 0x0, bitSize: 0xb20(0x164B)
    int32 camo[89];
    // offset: 0xb20, bitSize: 0xc0(0x18B)
    int32 perk[6];
    // offset: 0xbe0, bitSize: 0x20(0x4B)
    int32 temp[1];
    // offset: 0xc00, bitSize: 0x60(0xcB)
    int32 super[3];
    // offset: 0xc60, bitSize: 0xa0(0x14B)
    int32 firstpartylicense[5];
    // offset: 0xd00, bitSize: 0xa0(0x14B)
    int32 gun_screen[5];
    // offset: 0xda0, bitSize: 0x100(0x20B)
    int32 executions[8];
    // offset: 0xea0, bitSize: 0xc60(0x18cB)
    int32 playercards[99];
    // offset: 0x2020, bitSize: 0x20(0x4B)
    int32 currencypack[1];
    // offset: 0x2040, bitSize: 0x20(0x4B)
    int32 mission[1];
    // offset: 0x2060, bitSize: 0x80(0x10B)
    int32 equipment[4];
    // offset: 0x20e0, bitSize: 0x60(0xcB)
    int32 reticle[3];
    // offset: 0x2140, bitSize: 0x3c0(0x78B)
    int32 operator_skin[30];
    // offset: 0x2500, bitSize: 0x2e0(0x5cB)
    int32 loadingscreen[23];
    // offset: 0x27e0, bitSize: 0x60(0xcB)
    int32 vehicle_track[3];
    // offset: 0x2840, bitSize: 0x20(0x4B)
    int32 parachute[1];
    // offset: 0x2860, bitSize: 0x20(0x4B)
    int32 battlepass[1];
    // offset: 0x2880, bitSize: 0x120(0x24B)
    int32 vehicle_camo[9];
    // offset: 0x29a0, bitSize: 0x20(0x4B)
    int32 vehicle_horn[1];
    // offset: 0x29c0, bitSize: 0x20(0x4B)
    int32 special[1];
    // offset: 0x29e0, bitSize: 0x4a40(0x948B)
    int32 attachment[594];
    // offset: 0x7420, bitSize: 0x700(0xe0B)
    int32 sticker[56];
    // offset: 0x7b20, bitSize: 0xbe0(0x17cB)
    int32 emblems[95];
    // offset: 0x8700, bitSize: 0x40(0x8B)
    int32 calloutmarkerpingitem[2];
    // offset: 0x8740, bitSize: 0x40(0x8B)
    int32 feature[2];
    // offset: 0x8780, bitSize: 0x20(0x4B)
    int32 genericblueprint[1];
    // offset: 0x87a0, bitSize: 0x8c0(0x118B)
    int32 weapon[70];
    // offset: 0x9060, bitSize: 0x20(0x4B)
    int32 instanceloot[1];
    // offset: 0x9080, bitSize: 0x40(0x8B)
    int32 killstreak[2];
    // offset: 0x90c0, bitSize: 0x20(0x4B)
    int32 contrail[1];
    // offset: 0x90e0, bitSize: 0xa0(0x14B)
    int32 operator[5];
    // offset: 0x9180, bitSize: 0x640(0xc8B)
    int32 consumable[50];
    // offset: 0x1b00, bitSize: 0x520(0xa4B)
    int32 weapon_charm[41];
}
