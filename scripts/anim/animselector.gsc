...
function function_99322e10827a8683(statename, var_e9db8fc3741a7e52) {
    /#
        warningstring = "max_length" + self.animsetname + "<unknown string>" + statename + "<unknown string>";
        foreach (key, value in var_e9db8fc3741a7e52) {
            warningstring = warningstring + key + "<unknown string>" + value + "<unknown string>";
        }
        warningstring = warningstring + "<unknown string>" + self.origin + "<unknown string>";
...
function selectanim(statename, var_e9db8fc3741a7e52, var_1b240bbf89180b65) {
    ...
    foreach (alias in traverseinfo.aliases) {
        if (isai(self) && !asm_hasalias(statename, alias)) {
            /#
                println("<unknown string>" + alias + "<unknown string>" + statename + "<unknown string>" + self.animsetname + "<unknown string>");
            #/
            continue;
        }
