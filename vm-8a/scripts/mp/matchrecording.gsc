...
/#
    ...
    function matchrecording_scriptdata_openfilewrite() {
        ...
        level.var_ac13a3f4ca2c6c83 = "<dev string:x6f>" + level.script + "<dev string:x89>" + getgametype() + "<dev string:x89>" + scripts\mp\matchdata::getmatchstarttimeutc() + "<dev string:x8b>";
        fileid = openfile(level.var_ac13a3f4ca2c6c83, "<dev string:x90>");
        if (fileid == -1) {
            assertmsg("<dev string:x96>" + level.var_ac13a3f4ca2c6c83);
        }
        return fileid;
    }
    ...
    function matchrecording_scriptdata_openfileappend() {
        ...
        fileid = openfile(level.var_ac13a3f4ca2c6c83, "<dev string:x133>");
        if (fileid == -1) {
            assertmsg("<dev string:x13a>" + level.var_ac13a3f4ca2c6c83);
        }
        return fileid;
    }
...
function matchrecording_scriptdata_dump() {
    /#
        ...
        fileid = closefile(fileid);
        if (fileid == -1) {
            assertmsg("<dev string:x168>" + level.var_ac13a3f4ca2c6c83);
        }
        level.matchrecevents = [];
    #/
}
