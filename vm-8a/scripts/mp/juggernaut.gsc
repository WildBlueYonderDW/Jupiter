...
function function_4217f11ffb352425(damage, shitloc, smeansofdeath, attacker) {
    ...
    if (!isdefined(var_1f48003b8e69560c)) {
        if (isdefined(attacker) && isdefined(shitloc) && isplayer(attacker)) {
            /#
                attacker iprintln("<dev string:x58>" + shitloc);
            #/
        }
        return;
    }
...
function function_c0aa811f7b45687c(shitloc, smeansofdeath, attacker) {
    ...
    /#
        if (isdefined(shitloc) && shitloc != "<dev string:x9e>" && isdefined(attacker) && isplayer(attacker)) {
            attacker iprintlnbold("<dev string:xa3>" + shitloc);
        }
    #/
...
/#
    ...
    function private function_5e9c6b97e4c3c059() {
        ...
        while (true) {
            ...
            var_f05a031dc1df54df = "<dev string:xba>";
            var_5aa83db0e5d721db = armorstate;
            if (armorstate == "<dev string:xc6>") {
                var_5aa83db0e5d721db = "<dev string:xce>";
            }
            function_8e6b2de818370baa(var_f05a031dc1df54df, var_5aa83db0e5d721db);
            helmetpart = "<dev string:xd8>";
            var_e0aad72b2cb25382 = armorstate;
            if (armorstate == "<dev string:xc6>") {
                var_e0aad72b2cb25382 = "<dev string:xdf>";
            }
            function_8e6b2de818370baa(helmetpart, var_e0aad72b2cb25382);
            partstoset = ["<dev string:xe3>", "<dev string:xf6>", "<dev string:x109>", "<dev string:x120>", "<dev string:x137>", "<dev string:x14d>", "<dev string:x163>", "<dev string:x174>", "<dev string:x184>", "<dev string:x18e>", "<dev string:x197>", "<dev string:x1a5>", "<dev string:x1b3>", "<dev string:x1c0>", "<dev string:x1cd>", "<dev string:x1d3>", "<dev string:x1de>"];
            function_8e6b2de818370baa(partstoset, armorstate);
            if (armorstate == "<dev string:x1e9>") {
                juggcontext.partshealth["<dev string:xba>"] = ter_op(isdefined(juggconfig.head_health), juggconfig.head_health, 100);
                juggcontext.partshealth["<dev string:xe3>"] = ter_op(isdefined(juggconfig.torso_upper_health), juggconfig.torso_upper_health, 100);
                juggcontext.partshealth["<dev string:xf6>"] = ter_op(isdefined(juggconfig.torso_lower_health), juggconfig.torso_lower_health, 100);
                juggcontext.partshealth["<dev string:x109>"] = ter_op(isdefined(juggconfig.right_upper_arm_health), juggconfig.right_upper_arm_health, 100);
                juggcontext.partshealth["<dev string:x120>"] = ter_op(isdefined(juggconfig.right_lower_arm_health), juggconfig.right_lower_arm_health, 100);
                juggcontext.partshealth["<dev string:x137>"] = ter_op(isdefined(juggconfig.left_upper_arm_health), juggconfig.left_upper_arm_health, 100);
                juggcontext.partshealth["<dev string:x14d>"] = ter_op(isdefined(juggconfig.left_lower_arm_health), juggconfig.left_lower_arm_health, 100);
                juggcontext.partshealth["<dev string:x163>"] = ter_op(isdefined(juggconfig.right_leg_health), juggconfig.right_leg_health, 100);
                juggcontext.partshealth["<dev string:x174>"] = ter_op(isdefined(juggconfig.left_leg_health), juggconfig.left_leg_health, 100);
            } else {
                juggcontext.partshealth["<dev string:xba>"] = undefined;
                juggcontext.partshealth["<dev string:xe3>"] = undefined;
                juggcontext.partshealth["<dev string:xf6>"] = undefined;
                juggcontext.partshealth["<dev string:x109>"] = undefined;
                juggcontext.partshealth["<dev string:x120>"] = undefined;
                juggcontext.partshealth["<dev string:x137>"] = undefined;
                juggcontext.partshealth["<dev string:x14d>"] = undefined;
                juggcontext.partshealth["<dev string:x163>"] = undefined;
                juggcontext.partshealth["<dev string:x174>"] = undefined;
            }
    ...
    function private function_59469cc44ca7fa81() {
        ...
        while (true) {
            ...
            if (armorstate == "<dev string:x1e9>") {
                armorstate = "<dev string:xc6>";
                if (armorpart == "<dev string:xd8>") {
                    armorstate = "<dev string:xdf>";
                }
            } else {
                armorstate = "<dev string:x1e9>";
            }
