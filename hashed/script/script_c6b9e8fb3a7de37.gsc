...
function function_ebfe4ffaa1829677() {
    ...
    while (true) {
        ...
        if (function_d4be90854c90c61()) {
            ...
            self.analysis_progress = self.analysis_progress + 0.1 * progress_multiplier;
            ...
            self.analysis_progress = self.analysis_progress - 0.05;
...
function function_826ac3e8eda7dcbd(wave_number) {
    ...
    if (isdefined(self.var_e9c1fd52868a6722["flood_fill"])) {
        ...
        if (is_equal(var_ae600836b9c6bee1, "wave_4")) {
            ...
            /#
                iprintlnbold("+weapnext" + wave_struct.script_noteworthy);
            #/
...
function function_540f9b357f3b5419(var_b381b0883bcd4847) {
    ...
    self.ping_owner scripts/cp_mp/calloutmarkerping::calloutmarkerping_removecallout(self.ping_index);
