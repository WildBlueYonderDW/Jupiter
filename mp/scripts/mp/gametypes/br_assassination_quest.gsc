...
function function_2529487ea7a39317() {
    ...
    var_57acddc40b2f741 = function_ad56d982450c9db2("br_assassination_quest_start_hunter_team", "br_assassination_quest_start_tablet_finder");
    var_19400d1b86740a76 = var_57acddc40b2f741[1];
    var_765bece0781ff770 = var_57acddc40b2f741[0];
    function_6a5270845ce88f1e(self.hunterteam, var_765bece0781ff770, params);
    if (isdefined(self.var_d154ac2657c5f44)) {
...
function function_7b16ac880855a705() {
    ...
    function_cecc87ac1b243e3c(self, self.var_d154ac2657c5f44);
}
