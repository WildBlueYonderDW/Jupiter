...
#namespace namespace_a49adcf65e889349;

// Namespace namespace_a49adcf65e889349/namespace_250014dec221561c
// Params 0, eflags: 0x2 linked
// Checksum 0x0, Offset: 0x1bf
// Size: 0x192
function init() {
    var_16e73b10a8080dd2 = isdefined(level.modifyplayerdamage) && level.modifyplayerdamage == &namespace_d20f8ef223912e12::brmodifyplayerdamage;
    /#
...
// Size: 0x5c
function function_fa674fb6e8372620() {
...
function function_f0f8107cb455be5c() {
    ...
    foreach (player in namespace_448ccf1ca136fbbe::playersnear(self.origin, level.var_d5af0d323eade962)) {
...
function function_cf9f51cc2da4f3bd() {
    ...
    while (1) {
        ...
        var_be660a98af9f4fd4 = clamp(var_c14047c4299f9c74 / range, 0, 1);
        var_c4353552b0c9f04b = level.var_99f79c82a10bb035 - level.var_94ce8b45176db281;
        self.var_762e79833c568872 = var_be660a98af9f4fd4 * var_c4353552b0c9f04b + level.var_94ce8b45176db281;
        waitframe();
    }
    /#
        if (level.var_218972ae124946da) {
...
function function_cfce6a9d8f6de32f(objweapon) {
    return isdefined(objweapon) && namespace_3e725f3cc58bddd3::function_7b2f2a8a9aa41d44(objweapon.basename);
}
...
function function_b18f9e23b7bbbc7f(einflictor, victim, eattacker, idamage, smeansofdeath, objweapon, vpoint, vdir, shitloc, idflags, var_be4285b26ed99ab1) {
    if (istrue(level.var_3ff7c73209fcf59d)) {
        if (!function_cfce6a9d8f6de32f(objweapon)) {
            if (istrue(victim.var_38841d8e75a06ab3) && isdefined(victim.var_762e79833c568872)) {
    ...
    idamage = namespace_d20f8ef223912e12::brmodifyplayerdamage(einflictor, victim, eattacker, idamage, smeansofdeath, objweapon, vpoint, vdir, shitloc, idflags, var_be4285b26ed99ab1);
    /#
        if (level.var_218972ae124946da) {
            if (!is_equal(objweapon.basename, "<unknown string>") && !function_cfce6a9d8f6de32f(objweapon)) {
                spawnprotection = istrue(victim.var_38841d8e75a06ab3);
                var_d32d44161df022be = ter_op(isdefined(victim.var_762e79833c568872), victim.var_762e79833c568872, 0);
                logstring("<unknown string>" + victim.name + "<unknown string>" + var_2bb9843391a39639 + "<unknown string>" + idamage + "<unknown string>" + shitloc + "<unknown string>" + var_be4285b26ed99ab1 + "<unknown string>" + objweapon.basename + "<unknown string>" + spawnprotection + "<unknown string>" + var_d32d44161df022be + "<unknown string>" + victim.health + "<unknown string>" + victim.armorhealth);
            }
        }
    #/
    return idamage;
...
function function_2ccadd23ce09858e() {
    var_c3fbb6661b91750f = namespace_2a184fc4902783dc::create_contents(0, 1, 1, 1, 0, 0, 1, 0, 0, 0, 1);
    ground = namespace_d3d40f75bb4e4c32::droptogroundmultitrace(self.origin, 0, -100000, var_c3fbb6661b91750f);
...
function private function_d93fc50310a48215() {
    /#
        ...
        while (1) {
            ...
            text = "<unknown string>";
            color = (1, 0, 0);
            if (istrue(self.var_38841d8e75a06ab3) || istrue(self.var_ce34e72182b33556)) {
                color = (0, 1, 0);
                text = "<unknown string>";
                if (istrue(self.var_38841d8e75a06ab3) && isdefined(self.var_762e79833c568872)) {
