#using character\c_jup_sp_hero_gaz_london_tactical;
...
{
    return character\c_jup_sp_hero_gaz_london_tactical::main();
}
...
{
    character\c_jup_sp_hero_gaz_london_tactical::precache_sp();
