    ...
    /#
        foreach (itemsource, itemlist in var_78311d69ed34c252) {
            foreach (item in itemlist) {
                ...
                namespace_36be7f9eab6ca7bc::function_e1b1d2af636da618("<unknown string>", player.name, item.quantity, scriptablename, item.lootid, itemsource);
            }
        }
    #/
...
function private function_dfa39169979c22d8(player, var_78311d69ed34c252) {
    ...
    totalcashvalue = totalcashvalue + player.plundercount;
    ...
    foreach (itemsource, itemlist in var_78311d69ed34c252) {
        foreach (item in itemlist) {
            ...
            if (!var_38aa5958a501629d) {
                ...
                /#
                    namespace_36be7f9eab6ca7bc::function_e1b1d2af636da618("<unknown string>", scriptablename, item.lootid, itemsource, player.name, itemtype);
                #/
                continue;
            }
            var_95ba1f30ea5d8a76 = function_10440574d3361667(item.lootid);
            var_12740f4650a020e2 = var_95ba1f30ea5d8a76 * item.quantity;
            totalcashvalue = totalcashvalue + var_12740f4650a020e2;
            /#
                namespace_36be7f9eab6ca7bc::function_e1b1d2af636da618("<unknown string>", player.name, item.quantity, scriptablename, item.lootid, itemsource, var_12740f4650a020e2, var_95ba1f30ea5d8a76, item.quantity);
            #/
        }
    }
...
function function_a2415c12f0dccc7b(player, var_2b465f51da1e8fcf, var_2b465e51da1e8d9c, var_6b92729cd2d4b6a6) {
    /#
        tabletitle = "<unknown string>" + player.name;
        var_cd8110645a9a2632 = ["<unknown string>", "<unknown string>", "<unknown string>", "<unknown string>", "<unknown string>", "<unknown string>"];
...
function function_408da9b4e0f08fb2(player, var_2b465f51da1e8fcf, var_2b465e51da1e8d9c, var_6b92729cd2d4b6a6) {
    /#
        tabletitle = "<unknown string>" + player.name;
        var_cd8110645a9a2632 = ["<unknown string>", "<unknown string>", "<unknown string>", "<unknown string>", "<unknown string>"];
        var_871bdbc7e5abb341 = [];
...
function function_3d87fb81fa720ae2(player, var_2b465f51da1e8fcf, var_2b465e51da1e8d9c, var_6b92729cd2d4b6a6) {
    /#
        tabletitle = "<unknown string>" + player.name;
        var_cd8110645a9a2632 = ["<unknown string>", "<unknown string>", "<unknown string>", "<unknown string>"];
        var_871bdbc7e5abb341 = [];
