...
/#
    ...
    function private function_f1c3dc8c80e536c4() {
        ...
        while (true) {
            ...
            var_d9acb3895ab8440b = getdvar(@"hash_d61b2e700fcd4a9", "<dev string:x27>");
            ...
            } else if (var_d9acb3895ab8440b != "<dev string:x27>") {
                setdvar(@"hash_d61b2e700fcd4a9", "<dev string:x27>");
