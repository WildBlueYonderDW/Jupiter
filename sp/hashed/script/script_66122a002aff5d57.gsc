...
// Namespace pickups / namespace_6250b14b3f614101
// Params 0, eflags: 0x0
...
function init() {
    ...
    namespace_9c383b14c4908e46::function_8ece37593311858a(&function_52db16c0f1b89f36);
    br_pickups_init();
...
function initarrays() {
    if (function_240f7f4e57340e8f()) {
        ...
        level.var_6178ce645aeeb787 = getdvar(@"hash_496705f4c6403e66", "cp/loot/dungeons/loot_table_zones.csv");
        ...
        level.var_6178ce645aeeb787 = getdvar(@"hash_496705f4c6403e66", "cp/loot/default/loot_table_zones.csv");
        if (level.var_6178ce645aeeb787 == "") {
            ...
            if (itemtype == "weapon") {
                ...
                if (isdefined(lootidname) && lootidname.size > 0) {
                    ...
                    if (!isdefined(var_91bbf8d2294a656e)) {
                        fullweaponobj = namespace_e0ee43ef2dddadaa::buildweapon_blueprint(weaponroot, camo, undefined, variantid);
                    } else {
                        fullweaponobj = namespace_e0ee43ef2dddadaa::buildweapon_attachmentidmap(weaponroot, var_91bbf8d2294a656e, camo, undefined, variantid, undefined, undefined, 1);
                    }
                    ...
                    if (getdvarint(@"hash_9cc91f7c70752fa7", 1)) {
                        /#
                            ...
                            icon = namespace_e0ee43ef2dddadaa::function_b8811a0fc04e4b9d(weaponroot, #"image", "<dev string:x1e>");
                            attachmentsall = namespace_e0ee43ef2dddadaa::weaponattachcustomtoidmap(weaponroot, variantid);
                            attachmentsdefault = namespace_e0ee43ef2dddadaa::weaponattachdefaulttoidmap(weaponroot, variantid);
                    ...
                    if (getdvarint(@"hash_ad67cf67992fe5f2", 0)) {
                        fullweaponobj = namespace_e0ee43ef2dddadaa::buildweapon(baseweaponname, attachmentsarray, "camo_11a", "none", -1);
                    } else {
                        fullweaponobj = namespace_e0ee43ef2dddadaa::buildweapon(baseweaponname, attachmentsarray, "none", "none", -1);
                    }
                    fullweaponname = getcompleteweaponname(fullweaponobj);
                    variantlootid = namespace_38b993c4618e76cd::getlootidfromref(baseweaponname);
...
// Size: 0x61
function function_ec51234e00e53e8a(item_type, var_d49285246b443066) {
    var_aba40a4e9a19401e = "agentdrops_+" + var_d49285246b443066;
    var_4aff050e56974dd6 = item_type + "/" + var_d49285246b443066;
    cmd = "devgui_cmd \"CP Debug:2 / Loot Drops / " + var_4aff050e56974dd6 + "\" \"set scr_start_debug " + var_aba40a4e9a19401e + "\" \n";
...
function getitemdroporiginandangles(index, baseorigin, baseangles, ignoreent, var_8a600b6102da9f9b, var_f71d4f78d508da69, var_6fe2ff802d5192d4, var_3ace5ac9c7d6fa44, pickupent) {
    ...
    yaw = baseangles[1] + slot * slot_yaw + ring * var_ac72a33c0ed48603 + randomfloatrange(var_ab9f50e5b2c2e07e, var_ab7c62e5b29cc05c);
    ...
    if (isdefined(pickupent) && !istrue(pickupent.isstuck)) {
        if (isdefined(pickupent.instance) && (isdefined(pickupent.instance.var_e0bcc7da9dbd4c17) || istrue(pickupent.instance.var_b5c99a0d29afb1ac))) {
            origin = baseorigin;
...
function function_73ffc9bcd6d1e62d(fromkiosk) {
    if (istrue(fromkiosk)) {
        level.br_pickups.var_ad49a38dd7c4c10f = getkioskyawoffsetoverride();
...
// Size: 0x10f
function function_8a1c7c62c1a6f261(var_5d405fccdb4719d2, part, state, player) {
    starttime = gettime();
    while (!player function_66bdd7e1d2e05f14() && gettime() - starttime < 500) {
        waitframe();
    }
    var_18c497e15343fe91 = getentitylessscriptablearray(undefined, undefined, var_5d405fccdb4719d2, 30);
    var_18c497e15343fe91 = sortbydistance(var_18c497e15343fe91, var_5d405fccdb4719d2);
    foreach (instance in var_18c497e15343fe91) {
        if (instance.type == part) {
            pickup = function_2e99748b7a8e1fe4(instance, 0);
            if (player function_ea3cee541617e9ce(pickup)) {
                pickup.var_6d17679c7a7a2abd = 1;
...
function function_b5f5576a0017c089(pickup, state, player, var_a5b2c541413aa895, instance) {
    ...
    if (istrue(level.var_aba762658155f642) && istrue(var_a5b2c541413aa895)) {
        return 0;
    }
...
function function_2a6a614936c17ac0(value) {
    if (isdefined(value)) {
        self.var_ffb4606ce142f6a = int(value);
    }
}
...
function function_d3507041e41e9dd0(value) {
    if (isdefined(value)) {
        self.var_f5e8dc8531286c60 = int(value);
    }
}
...
function loothide(instance, part) {
    ...
    if (isdefined(instance.var_e0bcc7da9dbd4c17)) {
        instance.var_e0bcc7da9dbd4c17 notify("self_hidden");
    }
...
function onusecompleted(pickupent, var_43fb3d97abb79854, var_a5b2c541413aa895, fromkiosk, var_db943473454f6ea6, instance, backpackequip) {
    ...
    if (isweaponpickupitem(pickupent)) {
        if (var_a5b2c541413aa895 && getdvarint(@"hash_4fe68158dff053c", 0)) {
            ...
            var_49e6ef3edadd524e = getweaponrootname(weaponbasename);
            clipsize = weaponclipsize(weaponbasename);
            var_7e7ac47753d9e2e3 = br_ammo_type_for_weapon(var_49e6ef3edadd524e);
        ...
        thread namespace_f8d3520d3483c1::function_ef6d8b8c2ed89e8a(pickupent.count);
    } else if (function_4aa12e0ed3f6b745(pickupent.scriptablename)) {
        platelevel = function_692c3df266580df6(pickupent.scriptablename);
        self.var_bed158a6dfac230d = platelevel;
        self.maxarmorhealth = self.var_bed158a6dfac230d * 50;
        ...
        thread namespace_1f50a6a7107e9381::function_4a1fd54affdaa367(killstreakref, 1, 0, 0, 1, backpackequip, pickupent);
        ...
        thread namespace_1f50a6a7107e9381::function_4a1fd54affdaa367(var_630da9780891fbe9, 1, 0, 0, 1, backpackequip, pickupent);
...
function takesuperpickup(pickupent, fromkiosk, var_db943473454f6ea6, backpackequip) {
    ...
    if (isdefined(backpackequip) && backpackequip) {
        lootid = namespace_38b993c4618e76cd::getlootidfromref(supername);
        namespace_bc7b29dcc022d887::function_6f39f9916649ac48(lootid, 1);
    }
    if (isdefined(self.superweapon)) {
        if (level.noinventory) {
            function_21779eb63ee9edb0(namespace_38b993c4618e76cd::function_b88cfb4893ceedac(self.supername), undefined, undefined, 1, undefined, undefined, 4, undefined, pickupent);
        } else {
            function_9d094fac5ae6454e(self.supername, "super", 1);
        }
    }
...
function forcegivesuper(targetsupername, dropcurrent, fromkiosk, droppurchased, var_db943473454f6ea6) {
    ...
    if (istrue(dropcurrent)) {
        if (isdefined(self.equipment["super"]) && namespace_4fb9dddfb8c1a67a::getequipmentslotammo("super") > 0) {
...
function takeequipmentpickup(pickupent, fromkiosk, var_db943473454f6ea6, backpackequip) {
    ...
    if (pickupissameasequipmentslot(equipname, slot)) {
        if (equipmentslothasroom(pickupent.scriptablename, slot)) {
            if (slot != "health" && !self usingtouch()) {
                ...
                namespace_e072c8407b2a861c::hudicontype(icontype);
            }
            var_5324597edfaff57c = namespace_4fb9dddfb8c1a67a::getequipmentslotammo(slot);
            var_b5cdf4d935e6ac13 = namespace_4fb9dddfb8c1a67a::getequipmentmaxammo(equipname);
            if (var_5324597edfaff57c + pickupent.count > var_b5cdf4d935e6ac13) {
                ...
                namespace_4fb9dddfb8c1a67a::setequipmentammo(equipname, var_b5cdf4d935e6ac13);
                pickupent.count -= var_97c23a1323acc7df;
                pickupremains = 1;
            } else {
                namespace_4fb9dddfb8c1a67a::incrementequipmentslotammo(slot, pickupent.count);
            }
    ...
    } else if (!isdefined(self.equipment[slot]) || namespace_4fb9dddfb8c1a67a::getequipmentslotammo(slot) == 0) {
        var_b5cdf4d935e6ac13 = namespace_4fb9dddfb8c1a67a::getequipmentmaxammo(equipname);
        namespace_4fb9dddfb8c1a67a::giveequipment(equipname, slot);
        if (pickupent.count > var_b5cdf4d935e6ac13) {
            ...
            namespace_4fb9dddfb8c1a67a::setequipmentammo(equipname, pickupent.count);
        }
        ...
        if (isdefined(var_db943473454f6ea6)) {
            ...
            function_84772ebf836af5db(var_db943473454f6ea6, -1 * var_3fa041e4f059bc71);
        }
...
function function_276e0e89c09af369(slot, lootid, ammocount, pickupent) {
    ...
    if (level.noinventory) {
        ...
        quantity = function_15308562fda076aa(lootid, fakepickup);
        if (quantity > 0) {
...
function function_21779eb63ee9edb0(equipindex, fromkiosk, var_273a070109cfc7e0, ammocount, var_db943473454f6ea6, allowautopickup, itemtype, dropfeedback, pickupent) {
    ...
    if (isdefined(var_db943473454f6ea6)) {
        lootid = namespace_38b993c4618e76cd::function_fae5e1d3de32d3f7(equipindex);
        fakepickup = spawnstruct();
        fakepickup.scriptablename = function_91c1be871300a518(lootid);
        fakepickup.count = ammocount;
        quantity = function_15308562fda076aa(lootid, fakepickup);
        if (quantity > 0) {
            ...
            dropinfo = getitemdroporiginandangles(placementindex, self.origin, self.angles, self, level.br_pickups.var_ad49a38dd7c4c10f, level.br_pickups.distanceoverride, undefined, undefined, pickupent);
    ...
    dropinfo = getitemdroporiginandangles(placementindex, self.origin, self.angles, self, level.br_pickups.var_ad49a38dd7c4c10f, undefined, undefined, undefined, pickupent);
...
function dropequipmentinslot(slot, fromkiosk, var_273a070109cfc7e0, ammocountoverride, var_db943473454f6ea6, allowautopickup, itemtype, dropfeedback, pickupent) {
    ammocount = namespace_4fb9dddfb8c1a67a::getequipmentslotammo(slot);
...
function giveequipment(ref, slot) {
    namespace_4fb9dddfb8c1a67a::giveequipment(ref, slot);
}
...
function takeequipment(slot) {
    ...
    ref = namespace_4fb9dddfb8c1a67a::getcurrentequipment(slot);
    if (!isdefined(ref)) {
        return;
    }
    ...
    if (isdefined(data)) {
        if (isdefined(data.player)) {
            ...
            if (isdefined(data.playerscoreeventref) && (!isdefined(data.playerscoreeventvalue) || data.playerscoreeventvalue > 0)) {
                data.player thread namespace_6099285b4066f63b::doScoreEvent(data.playerscoreeventref, undefined, data.playerscoreeventvalue);
            }
        }
...
function function_99e27ed6b392b6a9(pickupent) {
    ...
    if (isdefined(pickupent.count)) {
        ...
        pickupent.count = namespace_f8d3520d3483c1::function_9c6e9a6643b6c9a6(var_6018edf2459ae384);
...
function function_355165dac88b5d17(pickupent) {
    pickupremains = 1;
    namespace_f8d3520d3483c1::function_9c6e9a6643b6c9a6(2);
    return pickupremains;
}
...
// Size: 0x16f
function br_ammo_give_type(player, ammotype, amount, var_8bb770d6eeda5198, var_dff84541dcb30d24) {
    ...
    if (player.br_ammo[ammotype] > level.br_ammo_max[ammotype]) {
        ...
        if (isbackpackinventoryenabled() && !istrue(var_dff84541dcb30d24)) {
            ...
            player addItemToBackpack(lootid, var_bada25504e8844d7, !var_8bb770d6eeda5198);
            var_2c86af91e7e20602 = 0;
...
function addselfrevivetoken(skipsplash, var_7405289ebaf266bd) {
    ...
    namespace_d4aab8c9cb8ecb14::enable_self_revive();
...
function removeselfrevivetoken() {
    ...
    if (issolos && player _hasperk("specialty_pistoldeath")) {
        player namespace_c4cab616edf9b2b9::removeperk("specialty_pistoldeath");
    }
    if (function_240f7f4e57340e8f()) {
...
function takeweaponpickup(pickupent, var_db943473454f6ea6) {
    ...
    if (var_29893f13d84d295f) {
        var_c9e3aab3cb667506 = istrue(pickupent.instance.var_b5c99a0d29afb1ac) || isdefined(pickupent.instance.var_e0bcc7da9dbd4c17) || istrue(pickupent.instance.isweaponfromcrate);
    } else {
    ...
    if (var_7dc30386b50647a1) {
                    ...
                    if (isdefined(item)) {
                        ...
                        for (i = 0; i < self.primaryweapons.size; i++) {
                            if (issameweapon(self.primaryweapons[i], var_ec22a950f210e39)) {
                                ...
                                var_fedb77aad2340743 = function_64ccc54bdbae5cf6(int(function_e511e6f4347ff261(level.var_82191bfa9f751f4c, self.var_ff741d59e10631a[i])));
                                weapontocheck = namespace_e0ee43ef2dddadaa::buildweapon_blueprint(var_79ff1ab6ab43cb7d, weapon_camo, undefined, var_fedb77aad2340743);
        ...
        var_c00a2d6249962fb6 = function_6738846da50730f1(var_db943473454f6ea6);
        quantity = var_c00a2d6249962fb6[1];
        lootid = var_c00a2d6249962fb6[0];
    ...
    if (istrue(newweapon.isweaponfromcrate) || istrue(pickupent.isweaponfromcrate)) {
        ...
        if (isdefined(ammotype)) {
            ...
            maxstock = namespace_6250b14b3f614101::function_ecdfc73e68dcc209(ammotype);
        ...
        if (newweapon.hasalternate) {
            var_c883522792ef6bba = pickupent.var_e97d731bedd44c63;
    ...
    if (!istrue(var_7b9de6db6a90dbe7)) {
        ...
        namespace_a0628d6954815ef8::updatelastweaponobj(newweapon);
    }
...
function function_f58ee288a541af2e(newweapon) {
    ...
    var_a91035f0aa427fa = self playerads();
    if (self isswitchingweapon() || self isreloading() || self ismantling() || self isthrowinggrenade() || self israisingweapon() || self ismeleeing() || var_a91035f0aa427fa > 0 || istrue(self.insertingarmorplate)) {
        return;
    }
...
function private function_64f6ebff728689ab(player, weapon) {
    ...
    if (isdefined(weaponammotype)) {
        self.br_ammo[weaponammotype] = self.br_ammo[weaponammotype] + clipammo;
    }
}
...
function br_ammo_update_weapons(player) {
    ...
    foreach (weap in var_509d86412c9d7426) {
        ...
        if (isdefined(var_1c0baeec9828351c)) {
            newstockammo = get_int_or_0(player.br_ammo[var_1c0baeec9828351c]);
...
function function_bc12e1ef44f08efa() {
    ...
    foreach (weap in var_509d86412c9d7426) {
        ...
        if (isdefined(var_1c0baeec9828351c)) {
            ...
            newstockammo = get_int_or_0(self.br_ammo[var_1c0baeec9828351c]);
            br_ammo_max = level.var_e6ea72fc5e3fcd00[var_1c0baeec9828351c];
            var_190b69d94afe0a15 = currentstock + newstockammo;
            if (var_190b69d94afe0a15 >= br_ammo_max) {
                var_190b69d94afe0a15 = br_ammo_max;
            }
            self.br_ammo[var_1c0baeec9828351c] = var_190b69d94afe0a15;
        }
    }
...
function spawnpickup(pickupname, dropinfo, count, showtrail, weaponobj, allowautopickup, countlefthand, var_e97d731bedd44c63) {
    ...
    var_7ee485b3faecdeba = isdefined(weaponobj);
    ...
    if (isdefined(level.br_pickups.br_weapontoscriptable[pickupname])) {
        ...
        weaponclasstoken = namespace_e0ee43ef2dddadaa::getweaponclasstoken(weaponobj.basename);
        if (weaponclasstoken != "me" && weaponclasstoken != "pi" && weaponclasstoken != "sh" && weaponclasstoken != "sm" && weaponclasstoken != "ar" && weaponclasstoken != "lm" && !namespace_e0ee43ef2dddadaa::isminigunweapon(weaponobj) && weaponclasstoken != "dm" && weaponclasstoken != "sn" && weaponclasstoken != "la" && weaponclasstoken != "kn") {
    ...
    item function_828247536ca07ac1(var_c9c301a888170672, dropinfo, var_7ee485b3faecdeba, allowautopickup, showtrail);
...
// Size: 0x5b
function function_828247536ca07ac1(var_c9c301a888170672, dropinfo, var_7ee485b3faecdeba, allowautopickup, showtrail) {
    state = function_3646de62d5cf4d0d(var_c9c301a888170672, dropinfo, var_7ee485b3faecdeba, allowautopickup, showtrail);
    if (!isdefined(state)) {
        return;
    }
...
// Size: 0x14d
function function_3646de62d5cf4d0d(var_c9c301a888170672, dropinfo, var_7ee485b3faecdeba, allowautopickup, showtrail) {
    state = undefined;
    if (istrue(dropinfo.var_97331585b4002aa7)) {
    ...
    if (function_240f7f4e57340e8f()) {
        state = function_4160979a238b2cd5(var_c9c301a888170672, dropinfo, var_7ee485b3faecdeba, state, allowautopickup);
    }
    return state;
}
...
// Size: 0x9b
function function_4160979a238b2cd5(var_c9c301a888170672, dropinfo, var_7ee485b3faecdeba, state, allowautopickup) {
    if (istrue(dropinfo.var_54ed99022c529d4a)) {
        return "visible_no_outline";
    }
    if (!isdefined(state)) {
        return function_82d002965498f57d(dropinfo, var_7ee485b3faecdeba, allowautopickup);
    }
...
// Size: 0x80
function function_82d002965498f57d(dropinfo, var_7ee485b3faecdeba, allowautopickup) {
    state = undefined;
    if (istrue(dropinfo.var_a61783b788746c54)) {
...
function isvalidcustomweapon(weaponobj) {
    ...
    if (namespace_a0628d6954815ef8::isfistweapon(weaponobj) || namespace_a0628d6954815ef8::isgunlessweapon(weaponobj) || namespace_a0628d6954815ef8::ismeleeoverrideweapon(weaponobj)) {
        return false;
    }
    return true;
}
...
function function_8a9c22c541e0dd5b(fullweaponobj, var_3ace5ac9c7d6fa44) {
    dropinfo = getitemdroporiginandangles(namespace_7335f9420e698c48::function_b1c55038843de38b(), self.origin, self.angles, self, undefined, undefined, undefined, var_3ace5ac9c7d6fa44, undefined);
...
function br_ammo_type_for_weapon(weapon) {
    ...
    if (!isstring(weapon) && isdefined(weapon.underbarrel)) {
        ...
        if (istrue(weapon.isalternate) && !var_d0a536d5580f1bde) {
            if (namespace_e0ee43ef2dddadaa::function_de04e13ab01e1a10(weapon.underbarrel)) {
...
function cantakepickup(pickup) {
    if (!function_240f7f4e57340e8f() && !isdefined(scripts\cp\loot_system::get_empty_munition_slot(self)) && namespace_94359011b63230a6::function_af07aad35b55fd73(pickup.scriptablename)) {
    ...
    if (function_240f7f4e57340e8f() && namespace_94359011b63230a6::function_af07aad35b55fd73(pickup.scriptablename)) {
    ...
    if (isweaponpickupitem(pickup)) {
        ...
        if (namespace_ce29426d87a9df99::function_76ca0b3d8b2555ca(current_weapon)) {
            return 30;
        }
        if (!val::get("weapon_pickup") || function_8c58cd733dfc8cce(pickup.customweaponname)) {
            if (isdefined(level.br_pickups) && isdefined(level.br_pickups.br_pickupdenyequipnoroom)) {
                var_68d1ee3a807fd204 = level.br_pickups.br_pickupdenyequipnoroom;
                if (scripts\engine\utility::issharedfuncdefined("hud", "showErrorMessage")) {
                    self [[ scripts\engine\utility::getsharedfunc("hud", "showErrorMessage") ]](var_68d1ee3a807fd204);
                }
                return 0;
            }
        }
        ...
        foreach (weap in self.primaryweapons) {
            if (issameweapon(weap, newweapon)) {
                ...
                if (isminigunweapon(newweapon)) {
                    var_3dbc3b058135cbfb = self getweaponammoclip(weap);
                    if (var_3dbc3b058135cbfb == weaponclipsize(weap)) {
                        return 3;
                    }
                    var_97c3703f332729d6 = min(var_3dbc3b058135cbfb + 100, fakepickup.count);
    ...
    if (isequipment(pickup.scriptablename) || function_15ecbc9a1a51007f(pickup.scriptablename)) {
        ...
        if (isautouse && (slot == "primary" || slot == "secondary")) {
            ...
            if (!isbackpackinventoryenabled()) {
                if (self usingtouch() && (!isdefined(self.equipment[slot]) || namespace_4fb9dddfb8c1a67a::getequipmentslotammo(slot) == 0)) {
                    return 1;
                }
                return 12;
            }
        }
        if (!isdefined(self.equipment[slot]) || namespace_4fb9dddfb8c1a67a::getequipmentslotammo(slot) == 0) {
            return 1;
        }
        if (pickupissameasequipmentslot(equipname, slot)) {
            ...
            if (isdefined(self.equipment[slot])) {
                lootid = namespace_38b993c4618e76cd::getlootidfromref(self.equipment[slot]);
    ...
    if (isquesttablet(pickup.scriptablename)) {
        if (pickup.scriptablename == "brloot_blueprintextract_tablet") {
            ...
            if (getdvarint(@"hash_82bde055b11e6698", 0)) {
                var_9cf0b8c1be24c64d = array_contains(level.questinfo.teamsonquests, self.team);
            } else {
                var_9cf0b8c1be24c64d = function_7094c7010c5e3827(self.team);
            }
    ...
    if (isrevivepickup(pickup.scriptablename)) {
        ...
        if (pickup.scriptablename == "brloot_self_revive") {
            if (namespace_d4aab8c9cb8ecb14::hasselfrevivetoken() && getdvarint(@"hash_bd54dd62349d46c8", 0) == 0) {
                return 14;
            } else {
                return 1;
            }
    ...
    if (issuperpickup(pickup.scriptablename)) {
        ...
        if (!namespace_44edfb3e2b433c17::issuperinuse()) {
            equipammo = namespace_4fb9dddfb8c1a67a::getequipmentslotammo("super");
        ...
        if (isbackpackinventoryenabled()) {
            if (function_5e7049647595ab97() || namespace_44edfb3e2b433c17::issuperinuse()) {
                result = function_cbbf9bf3544dc456(pickup);
                if (result == 4 && !namespace_44edfb3e2b433c17::issuperinuse()) {
                    return 1;
                } else {
                    return result;
                }
    ...
    if (isarmor(pickup.scriptablename)) {
        ...
        if (namespace_f8d3520d3483c1::function_cd4a78b4a236ddc8(level.br_pickups.br_equipname[pickup.scriptablename])) {
            return 1;
        } else {
            return 6;
        }
    ...
    if (function_4294e9b331377c31(pickup.scriptablename)) {
        ...
        if (isbackpackinventoryenabled()) {
            ...
            pickup.count = namespace_f8d3520d3483c1::function_47320a25b8ee003();
            pickup.count -= namespace_f8d3520d3483c1::function_600f6cf462e983f();
    ...
    if (function_51adf909541800d7(pickup.scriptablename)) {
        ...
        if (self.var_bed158a6dfac230d >= namespace_ee632c9a776f5f85::function_6f16016c53d6cf63()) {
    ...
    if (pickup.scriptablename == "brloot_ammo_grenade") {
        ...
        var_f2b2c8de93ebf806 = namespace_4fb9dddfb8c1a67a::getequipmentslotammo("primary");
        var_e93897bc10c40746 = namespace_4fb9dddfb8c1a67a::getequipmentslotammo("secondary");
    ...
    if (function_4aa12e0ed3f6b745(pickup.scriptablename)) {
        ...
        if (self.var_bed158a6dfac230d < platelevel) {
            return 1;
        } else if (self.var_bed158a6dfac230d == platelevel) {
            return 25;
        } else {
            return 26;
        }
...
function incrementequipmentslotammo(slot, var_930290d7f474a0ae) {
    ...
    var_3dbc3b058135cbfb = namespace_4fb9dddfb8c1a67a::getequipmentammo(ref);
    newammo = int(min(var_3dbc3b058135cbfb + var_930290d7f474a0ae, namespace_4fb9dddfb8c1a67a::getequipmentmaxammo(ref)));
    namespace_4fb9dddfb8c1a67a::setequipmentammo(ref, newammo);
}
...
function function_195f5055031ad0cb() {
    ...
    if (self.plundercount == 0) {
        thread namespace_bc7b29dcc022d887::playersetplundercount(0);
    }
}
...
function function_461334c52833c744() {
    ...
    while (true) {
        ...
        var_8bb6eb01fcde5851 = self getweaponammoclip(objweapon);
        ...
        if (getdvarint(@"hash_11a55f76d25d5bd5", 0) && isdefined(self.br_ammo[weaponammotype]) && self.br_ammo[weaponammotype] <= 0) {
            lootid = namespace_38b993c4618e76cd::function_fae5e1d3de32d3f7(weaponammotype);
            if (isdefined(lootid)) {
        ...
        if (isdefined(ammotypecomparison) && ammotype == ammotypecomparison) {
            if (function_6b531c76815d77f3(ammotype) && !var_a9bc5314d494806d) {
                ...
                for (i = 0; i < function_b13e35608b336d65(player); i++) {
                    if (player function_6196d9ea9a30e609(i) == lootid) {
...
function function_4906c10c3ffdd4ca(weapon, stock_ammo, var_2b2365bad962f899) {
    ...
    ammotype = br_ammo_type_for_weapon(weapon);
    var_89f473b8328b7973 = get_int_or_0(self.br_ammo[ammotype]);
    if (istrue(weapon.isalternate) && !isdefined(weapon.underbarrel)) {
        return;
    }
    self setweaponammostock(weapon, var_89f473b8328b7973);
}
...
// Size: 0xa4
function function_34dc33af893513b2(amount, dropinfoindex) {
    if (amount >= 5000) {
...
function function_5cff081d620d2ef3() {
    dropinfo = getitemdroporiginandangles(namespace_7335f9420e698c48::function_b1c55038843de38b(), self.origin, self.angles, self);
    drops = ["brloot_ammo_762", "brloot_ammo_919", "brloot_ammo_50cal", "brloot_ammo_12g", "brloot_ammo_rocket"];
    for (i = 0; i < drops.size; i++) {
        if (namespace_162cff1cf88b9bbf::function_c5251179824f0deb(drops[i])) {
            count = namespace_162cff1cf88b9bbf::function_f9c71b46b5e50150(drops[i], namespace_162cff1cf88b9bbf::function_93f256198133479f(drops[i]));
...
function function_c78e977650c14d64() {
    drop_info = getitemdroporiginandangles(namespace_7335f9420e698c48::function_b1c55038843de38b(), self.origin, self.angles);
...
function dropbrequipment(fromkiosk, droppurchased, equipmentref) {
    ...
    if (var_11f2059012065537) {
        ...
        if (isdefined(var_1a37fa6c580bb395)) {
            function_73ffc9bcd6d1e62d(fromkiosk);
            dropinfo = getitemdroporiginandangles(var_65cad465fd8e737c, self.origin, self.angles, self, level.br_pickups.var_ad49a38dd7c4c10f, level.br_pickups.distanceoverride);
...
// Size: 0x203
function private _givebrsuper(equipname, supername, supercount, var_939bb6b71c0c11f0) {
    if (isdefined(level.allowsupers) && level.allowsupers) {
        supercount = namespace_44edfb3e2b433c17::getcurrentsuperpoints() >= namespace_44edfb3e2b433c17::getsuperpointsneeded();
    } else {
        self setclientomnvar("ui_perk_package_state", 3);
        self setclientomnvar("ui_perk_package_super1", namespace_4a3033eafa6fd07::getsuperid(supername));
        self setclientomnvar("ui_super_progress", 1);
        if (!isdefined(var_939bb6b71c0c11f0) || !var_939bb6b71c0c11f0) {
    ...
    if (isdefined(supername)) {
        ...
        namespace_4fb9dddfb8c1a67a::giveequipment(equipname, "super");
        namespace_4fb9dddfb8c1a67a::setequipmentammo(equipname, supercount);
    }
...
function function_84521a355496476f(equipname) {
    if (isdefined(equipname)) {
        if (equipname == "equip_recondrone") {
            ...
            return namespace_893ac0cf28c5af44::function_ab931b44a2efddf7(streakinfo);
...
function addItemToBackpack(lootid, pickup, var_70e660487c2924ec, var_75f83bdffeda824b) {
    ...
    quantity = function_15308562fda076aa(lootid, pickup);
    if (quantity > 0) {
...
// Size: 0x8e
function function_c01eb7d2911f26e1(player, var_f53482ef48bdba8) {
    if (!isdefined(var_f53482ef48bdba8)) {
        return;
    }
    quantity = 0;
    backpacksize = namespace_bc7b29dcc022d887::function_b13e35608b336d65(player);
    if (!isdefined(backpacksize) || backpacksize <= 0) {
        return;
    }
    lootid = namespace_38b993c4618e76cd::function_fae5e1d3de32d3f7(var_f53482ef48bdba8);
    for (i = 0; i < backpacksize; i++) {
        var_e58ea7be13f8d8a4 = player namespace_bc7b29dcc022d887::function_6196d9ea9a30e609(i);
        if (var_e58ea7be13f8d8a4 == lootid) {
            quantity++;
        }
    }
    return quantity;
...
// Size: 0x7f
function function_f8d85c542911e3a9(player, var_f53482ef48bdba8) {
    if (!isdefined(var_f53482ef48bdba8)) {
        return;
    }
    backpacksize = namespace_bc7b29dcc022d887::function_b13e35608b336d65(player);
...
function lootitem(lootid, quantity) {
    ...
    if (isweaponpickupitem(var_bada25504e8844d7) && isbackpackinventoryenabled()) {
        var_c017406249a46e04 = getDefaultWeaponAmmo(level.br_lootiteminfo[scriptablename].fullweaponobj, 1);
        var_35ead47ed0d7507e = var_c017406249a46e04[2];
        ammoleft = var_c017406249a46e04[1];
        ammo = var_c017406249a46e04[0];
...
function function_e01d9736b2d100ac(lootid, quantity) {
    ...
    result = undefined;
    if (!function_3c17a26ce6a4668(lootid)) {
        result = function_3d7e44b7e940de24(lootid, quantity);
    } else {
...
// Size: 0x6e
function function_9d094fac5ae6454e(ref, type, quantity, var_70e660487c2924ec) {
    lootid = namespace_38b993c4618e76cd::getlootidfromref(ref);
    fakepickup = spawnstruct();
...
// Size: 0x142
function function_3d7e44b7e940de24(lootid, quantity) {
...
function br_forcegivecustomweapon(player, weaponobj, weaponfullname, weaponbasename, var_bde57922cf2180d3, var_eaac92793f70b7df) {
    ...
    fakepickup.var_e97d731bedd44c63 = 0;
    if (hasmaxammo) {
    ...
    if (namespace_a0628d6954815ef8::isakimbo(weaponobj)) {
    ...
    if (weaponobj.hasalternate) {
        ...
        fakepickup.var_e97d731bedd44c63 = var_6664d64b7cb8a858;
        if (hasmaxammo) {
            fakepickup.var_e97d731bedd44c63 = 999;
        }
    }
    ...
    if (weaponobj.hasalternate) {
        ...
        if (altweapon.isalternate && namespace_e0ee43ef2dddadaa::function_de04e13ab01e1a10(altweapon.underbarrel)) {
...
function function_8863381bf5a8c162(instance, part, state, player, var_a5b2c541413aa895, usestring) {
    if (isdefined(instance.var_2385d6a02352c53d) && istrue(instance.var_2385d6a02352c53d[player.name])) {
    ...
    primary = player namespace_4fb9dddfb8c1a67a::getcurrentequipment("primary");
    if (isdefined(primary)) {
        changed = player namespace_4fb9dddfb8c1a67a::incrementequipmentammo(primary, 10);
        if (changed) {
            used = 1;
        }
    }
    secondary = player namespace_4fb9dddfb8c1a67a::getcurrentequipment("secondary");
    if (isdefined(secondary)) {
        changed = player namespace_4fb9dddfb8c1a67a::incrementequipmentammo(secondary, 10);
        if (changed) {
            used = 1;
        }
    }
    ...
    if (var_1cd29382d1867470 < var_a81adeb0e1f89320) {
        player namespace_f8d3520d3483c1::function_9c6e9a6643b6c9a6(var_a81adeb0e1f89320 - var_1cd29382d1867470);
        used = 1;
    }
    if (used) {
        instance thread function_df1c9968b5cbf288(player);
...
function br_ammorestock_playeruse(player) {
    ...
    if (istrue(level.var_3480abea6656fce6)) {
        var_bf64f721310414a0 = player namespace_4fb9dddfb8c1a67a::function_1ab06e1478168800();
        var_a82c04c3789c6905 = player namespace_4fb9dddfb8c1a67a::function_f1c136649b4207d6();
    }
    ...
    if (istrue(level.var_cee48b761f8ca747)) {
        ...
        if (var_1cd29382d1867470 < var_a81adeb0e1f89320) {
            slot = "health";
            if (!isdefined(player.equipment[slot]) || player namespace_4fb9dddfb8c1a67a::getequipmentslotammo(slot) == 0) {
                player namespace_4fb9dddfb8c1a67a::giveequipment("equip_armorplate", slot);
            }
            player namespace_f8d3520d3483c1::function_9c6e9a6643b6c9a6(var_a81adeb0e1f89320 - var_1cd29382d1867470);
            var_535a3f9c599a0c5f = 1;
        }
    }
    var_c01bc56249a9885a = giveammo(player);
    var_d6a57b95fc473441 = var_c01bc56249a9885a[1];
    var_bf00bd1d7da56c26 = var_c01bc56249a9885a[0];
    var_6e10774fa3fb048e = function_a95732425992ae46(player);
    if (!var_bf00bd1d7da56c26 && !var_535a3f9c599a0c5f && !var_bf64f721310414a0 && !var_a82c04c3789c6905 && !var_6e10774fa3fb048e) {
    ...
    player namespace_e072c8407b2a861c::hudicontype("br_ammo");
...
function giveammo(player) {
    ...
    foreach (weap in var_509d86412c9d7426) {
        ...
        if (namespace_e0ee43ef2dddadaa::isminigunweapon(weap)) {
        ...
        if (giveammo) {
            ...
            var_bf00bd1d7da56c26 = 1;
        }
    }
    self notify("ammo_update");
    br_ammo_update_weapons(player);
    return [var_bf00bd1d7da56c26, var_d6a57b95fc473441];
}
...
function function_a95732425992ae46(player) {
    ...
    if (namespace_ce29426d87a9df99::function_76ca0b3d8b2555ca(current_weapon)) {
        foreach (weap in var_509d86412c9d7426) {
            if (namespace_ce29426d87a9df99::function_76ca0b3d8b2555ca(weap)) {
                continue;
            }
            current_weapon = weap;
            break;
...
function function_2145743924c7fc7b(weapon, player) {
    if (namespace_ce29426d87a9df99::function_76ca0b3d8b2555ca(weapon)) {
        return false;
    }
    return true;
}
...
function ammorestock_playeruse(player, loc) {
    ...
    if (istrue(level.var_3480abea6656fce6)) {
        player namespace_4fb9dddfb8c1a67a::function_1ab06e1478168800();
    }
    used = 0;
    var_12a372e8caa042bb = player.primaryweapons;
    temparray = [];
    foreach (item in var_12a372e8caa042bb) {
        if (!namespace_a0628d6954815ef8::ismeleeonly(item) && !scripts\cp\utility::issuperweapon(item) && !namespace_e0ee43ef2dddadaa::iskillstreakweapon(item)) {
    ...
    foreach (weaponobj in var_12a372e8caa042bb) {
        var_1c0baeec9828351c = br_ammo_type_for_weapon(weaponobj);
        if (br_ammo_type_player_full(player, var_1c0baeec9828351c, 1)) {
    ...
    foreach (weaponobj in var_12a372e8caa042bb) {
        ...
        singleclipammo = namespace_a0628d6954815ef8::getammooverride(weaponobj);
        if (isakimbo) {
...
function private function_df1c9968b5cbf288(player) {
    level endon("game_ended");
    if (!isdefined(self.var_2385d6a02352c53d)) {
        self.var_2385d6a02352c53d = [];
    }
    player_name = player.name;
    self.var_2385d6a02352c53d[player_name] = 1;
    wait_time = 0;
    ...
    wait wait_time;
    self.var_2385d6a02352c53d[player_name] = undefined;
}
...
function function_46ee9182cf6872d5(value) {
    ...
    namespace_14f37777effc564d::playersetplunderomnvar(int(value / multiplier));
}
...
// Size: 0x64
function function_ae362da9982c5413() {
    foreach (ss in level.var_effb351e78e1ed6c) {
        if (isdefined(ss)) {
            namespace_6250b14b3f614101::loothide(ss);
        }
    }
...
// Size: 0x6c
function function_2ccaa3823e5cb766() {
    level endon("game_ended");
...
function function_6fe97cf815da0051() {
    ...
    foreach (var_906fc18f33b5177f, var_997b28e32a97c75 in level.var_965aac045d1ffd23) {
        var_c2c7f18e2611a8b5 = getstructarray(var_997b28e32a97c75.tname, "targetname");
        ...
        foreach (loc in var_c2c7f18e2611a8b5) {
            ...
            if (var_906fc18f33b5177f == "brloot_offhand_molotov") {
                x = 0;
            }
            if (!var_97331585b4002aa7) {
                if (istrue(var_3f0c694d3bf37be1)) {
                    loc.angles += var_997b28e32a97c75.angles_offset;
                } else if (istrue(var_997b28e32a97c75.var_85bca64deb9b3318)) {
                    loc.angles += var_997b28e32a97c75.var_4ea1b18bd2c984c5;
                } else {
                    loc.angles = var_997b28e32a97c75.var_4ea1b18bd2c984c5;
                }
                loc.origin += var_997b28e32a97c75.origin_offset;
            }
            drop_info = namespace_6250b14b3f614101::getitemdropinfo(loc.origin, loc.angles, undefined, undefined, var_97331585b4002aa7);
            item = namespace_6250b14b3f614101::spawnpickup(var_906fc18f33b5177f, drop_info, var_997b28e32a97c75.var_861be59c011e535e, undefined, undefined, 1);
            if (isdefined(loc.script_objective)) {
                item.count = int(loc.script_objective);
            }
            if (getdvarint(@"hash_41ab31c3b86aa5b1", 0) == 1 && isrevivepickup(var_906fc18f33b5177f)) {
...
function function_244e6c9f27c6d81() {
    function_b66d552f8466aac1("snapshot_pickup", "brloot_offhand_snapshot", 1, (0, 0, 0), 1);
    function_b66d552f8466aac1("molotov_pickup", "brloot_offhand_molotov", 1, (0, 0, -90));
    function_b66d552f8466aac1("semtex_pickup", "brloot_offhand_semtex", 1, (0, 0, 0));
    function_b66d552f8466aac1("c4_pickup", "brloot_offhand_c4", 1, (0, 0, -90), 1);
    function_b66d552f8466aac1("frag_grenade_pickup", "brloot_offhand_frag", 1, (0, 0, 0), 1);
    function_b66d552f8466aac1("claymore_pickup", "brloot_offhand_claymore", 1, (0, 0, 0), 1);
    function_b66d552f8466aac1("thermite_pickup", "brloot_offhand_thermite", 1, (0, 0, 0), 1);
    function_b66d552f8466aac1("throwing_knife_pickup", "brloot_offhand_throwingknife", 1, (0, 0, 0), 1);
    function_b66d552f8466aac1("fire_throwing_knife_pickup", "brloot_offhand_throwingknife_fire", 1, (0, 0, 0), 1);
    function_b66d552f8466aac1("at_mine_pickup", "brloot_offhand_atmine", 1, (0, 0, 0), 1);
    function_b66d552f8466aac1("shock_pickup", "brloot_offhand_shockstick", 1, (0, 0, 0), 1);
    function_b66d552f8466aac1("self_revive_pickup", "brloot_self_revive", undefined, (0, 0, 0), 1);
    function_b66d552f8466aac1("armor_pickup_vest", "brloot_plate_pouch", undefined, (0, 0, 0), 1);
    function_b66d552f8466aac1("armor_pickup_plate", "brloot_armor_plate", undefined, (0, 0, 0), 1);
    function_b66d552f8466aac1("armor_platecarrier_upgrade", "jup_armor_platecarrier_upgrade", undefined, (0, 0, 0), 1);
    function_b66d552f8466aac1("adrenaline_pickup", "brloot_health_adrenaline", 1, (0, 0, 0), 1);
    function_b66d552f8466aac1("bottle_pickup", "brloot_offhand_jup_bottle", 1, (0, 0, 0));
    function_b66d552f8466aac1("flash_pickup", "brloot_offhand_flash", 1, (0, 0, 0));
    function_b66d552f8466aac1("gas_pickup", "brloot_offhand_gas", 1, (0, 0, 0), 1);
    function_b66d552f8466aac1("hbsensor_pickup", "brloot_offhand_heartbeatsensor", 1, (0, 0, 0), 1);
    function_b66d552f8466aac1("gasmask_pickup", "brloot_equip_gasmask", 1, (0, 0, 0), 1);
    function_b66d552f8466aac1("nvg_pickup", "brloot_nvg", 1, (0, 0, 0), 1);
}
...
function function_fb4fb47ca3cada2c() {
    ...
    for (i = 0; i < equipment_spawns.size; i++) {
        ...
        dropinfo = namespace_6250b14b3f614101::getitemdropinfo(equipment_spawns[i].origin, equipment_spawns[i].angles, undefined, undefined, var_97331585b4002aa7);
        item_name = equipment_spawns[i].script_noteworthy;
        item = namespace_6250b14b3f614101::spawnpickup(item_name, dropinfo);
        if (!isdefined(item)) {
            continue;
        }
...
function function_edc3bc07b0a2a146() {
    ...
    foreach (struct in structs) {
        ...
        dropinfo = namespace_6250b14b3f614101::getitemdropinfo(struct.origin, struct.angles, undefined, undefined, var_97331585b4002aa7);
...
function function_8847aa701752972b() {
    ...
    var_bfe232624969ca26 = function_1c134e183bc46cd7("brloot_weapon");
    angles_offset = var_bfe232624969ca26[1];
    origin_offset = var_bfe232624969ca26[0];
...
// Size: 0x1a6
function function_8119f212171548bf(weapon_name, spawn_origin, spawn_angles, var_62593976efda2b1b, count, var_97331585b4002aa7) {
    ...
    if (weapon_obj.hasalternate) {
        ...
        if (br_ammo_type_for_weapon(var_414f6f05dd56d073) != br_ammo_type_for_weapon(weapon_obj)) {
            var_e97d731bedd44c63 = weaponclipsize(var_414f6f05dd56d073) * 3;
        }
    }
    drop_info = namespace_6250b14b3f614101::getitemdropinfo(spawn_origin, spawn_angles, undefined, undefined, var_97331585b4002aa7);
    var_d9755f3d1d426a77 = namespace_6250b14b3f614101::spawnpickup(completeweaponname, drop_info, count, 1, weapon_obj, undefined, undefined, var_e97d731bedd44c63);
...
// Size: 0x116
function function_b66d552f8466aac1(tname, var_906fc18f33b5177f, var_861be59c011e535e, var_4ea1b18bd2c984c5, var_85bca64deb9b3318) {
    if (!isdefined(level.var_965aac045d1ffd23)) {
        level.var_965aac045d1ffd23 = [];
    }
    level.var_965aac045d1ffd23[var_906fc18f33b5177f] = spawnstruct();
    level.var_965aac045d1ffd23[var_906fc18f33b5177f].tname = tname;
    level.var_965aac045d1ffd23[var_906fc18f33b5177f].var_861be59c011e535e = var_861be59c011e535e;
    level.var_965aac045d1ffd23[var_906fc18f33b5177f].var_4ea1b18bd2c984c5 = var_4ea1b18bd2c984c5;
    level.var_965aac045d1ffd23[var_906fc18f33b5177f].var_85bca64deb9b3318 = var_85bca64deb9b3318;
    var_bfe23f624969e6bd = function_1c134e183bc46cd7(var_906fc18f33b5177f);
    angles_offset = var_bfe23f624969e6bd[1];
    origin_offset = var_bfe23f624969e6bd[0];
    level.var_965aac045d1ffd23[var_906fc18f33b5177f].origin_offset = origin_offset;
    level.var_965aac045d1ffd23[var_906fc18f33b5177f].angles_offset = angles_offset;
}
...
function spawnhealthpickup() {
    ...
    if (!isdefined(self.healthpickup)) {
        ...
        pickup = namespace_9911c99bb19ddd6a::createuseobject("neutral", trigger, visuals, undefined, undefined, 1);
        pickup.onuse = &function_75c517d33cd52b54;
        pickup.usetime = 0;
        pickup namespace_9911c99bb19ddd6a::function_58281ac4da450ded("any");
        pickup.owner = self;
...
function function_884dc0265a0070ac() {
    ...
    namespace_9911c99bb19ddd6a::deleteuseobject();
}
