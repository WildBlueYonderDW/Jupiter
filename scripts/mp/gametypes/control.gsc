...
function flagsetup() {
    /#
        setdevdvarifuninitialized(@"hash_695e8f43f6b03cd4", "<dev string:xa5>");
    #/
...
/#
    ...
    function function_8861fae4db7f9c2() {
        ...
        colors[128] = (1, 0, 1);
        while (true) {
            if (getdvar(@"hash_695e8f43f6b03cd4") != "<dev string:x130>") {
                wait 1;
                continue;
            }
            setdevdvar(@"hash_9d60ff019dc50c22", "<dev string:x130>");
            while (true) {
                if (getdvar(@"hash_695e8f43f6b03cd4") != "<dev string:x130>") {
                    setdevdvar(@"hash_9d60ff019dc50c22", "<dev string:xa5>");
                    break;
                }
