...
#namespace namespace_24e240b9cee9d3b9;

// Namespace namespace_24e240b9cee9d3b9/namespace_5a1ea9d54418bd42
...
function function_53088602ea68d303() {
    ...
    level.var_5b530d6e84ac2128.var_cb871a5b28f14e14 = getdvarint(@"hash_90416440e434dbf2", 20);
...
function function_202939344423679c() {
    ...
    namespace_17c25f0877bfb620::scriptable_addusedcallbackbypart("second_chance_drive", &function_34c2ab381e6c17cb);
    namespace_d576b6dc7cef9c62::setwaypointiconinfo("waypoint_captureneutral", 2, "neutral", "MP/BR_DOM_GULAG_EXIT", "ui_mp_br_icon_gulag_escape_objective", 0);
    foreach (arena in level.gulag.arenas) {
        arena.var_d5bdb69eb6ecfb2f = [];
        arena.keys = [];
        arena.var_45e35b44ec23ab43 = [];
        arena.domflag = [];
        arena.var_ab7aa90965bbffae = [];
        arena.var_79f102b3abcc6f8a = [];
        arena.var_d7baafc9b07f5094 = [];
        ...
        foreach (var_bdf25d8a73ff7dad in var_bb81957d1ae1cf3a) {
            if (var_bdf25d8a73ff7dad.script_noteworthy == "gulag_dom_escape") {
                ...
                var_66be6e0502fcd39f thread function_8de238b2a0070a51(arena);
                arena.var_d5bdb69eb6ecfb2f[arena.var_d5bdb69eb6ecfb2f.size] = var_66be6e0502fcd39f;
            }
            if (var_bdf25d8a73ff7dad.script_noteworthy == "gulag_dom_key" && level.var_43307855f189eb31.var_cddd2b80c91e5cab > 0) {
            ...
            if (var_bdf25d8a73ff7dad.script_noteworthy == "gulag_dom_point") {
                arena.var_ab7aa90965bbffae[arena.var_ab7aa90965bbffae.size] = var_bdf25d8a73ff7dad.origin;
            }
            if (var_bdf25d8a73ff7dad.script_noteworthy == "gulag_dom_ai_spawn") {
                arena.var_79f102b3abcc6f8a[arena.var_79f102b3abcc6f8a.size] = var_bdf25d8a73ff7dad;
            }
            if (var_bdf25d8a73ff7dad.script_noteworthy == "patrolstart" || issubstr(var_bdf25d8a73ff7dad.script_noteworthy, "patrolpath")) {
                pathstruct = function_9edcf99159abb0b(var_bdf25d8a73ff7dad, issubstr(var_bdf25d8a73ff7dad.script_noteworthy, "looped"));
                arena.var_d7baafc9b07f5094[arena.var_d7baafc9b07f5094.size] = pathstruct;
            }
            if (var_bdf25d8a73ff7dad.script_noteworthy == "gulag_dom_cameras") {
...
function function_c68da8e2dde4dfa3(arena) {
    ...
    if (level.var_5b530d6e84ac2128.var_b5b3db55c42637c3 >= 0) {
        player namespace_c6ccccd95254983f::playersetplundercount(2);
    }
...
// Size: 0x16
function function_a48b4bedb9bd286(var_607899d4420fe1a5, arena) {
    return 1;
}
...
function function_8b208c4ca074aaeb(arena) {
    ...
    player thread namespace_44abc05161e2e2cb::showsplash("br_dom_gulag_start");
    if (level.var_5b530d6e84ac2128.var_f2adaafe5f7860e8) {
        foreach (var_6f2d5ac61454ff66 in arena.var_d5bdb69eb6ecfb2f) {
            if (istrue(var_6f2d5ac61454ff66.dooropen)) {
                player namespace_ad49798629176e96::function_6ce94cf4eee9eab7(var_6f2d5ac61454ff66);
            }
        }
    }
...
function function_8de238b2a0070a51(arena) {
    ...
    while (1) {
        ...
        if (isdefined(player) && isplayer(player) && player namespace_d3d40f75bb4e4c32::isplayerinorgoingtogulag() && !istrue(player.var_4af73ce40a5d8572)) {
            if (!isdefined(player.var_c1057221e17f180b) || isdefined(player.var_c1057221e17f180b) && player.var_c1057221e17f180b == var_6f2d5ac61454ff66) {
...
function gulagdom_dooropened(arena) {
    ...
    foreach (p in arena.arenaplayers) {
        if (isdefined(p.var_c1057221e17f180b) && p.var_c1057221e17f180b == var_6f2d5ac61454ff66) {
            continue;
        }
        p namespace_ad49798629176e96::function_6ce94cf4eee9eab7(var_6f2d5ac61454ff66);
    }
    wait(level.var_43307855f189eb31.var_4304a1e29279a798);
    var_6f2d5ac61454ff66 function_5f0d7586dda3b8db(arena);
    var_6f2d5ac61454ff66.dooropen = 0;
}
...
function function_f63efa737ca0e7c1(arena) {
    ...
    if (level.var_5b530d6e84ac2128.var_b5b3db55c42637c3 >= 0) {
        ...
        player namespace_c6ccccd95254983f::playersetplundercount(var_9714ddda6a6df159);
    }
...
// Size: 0x95
function function_34c2ab381e6c17cb(instance, part, state, player, var_a5b2c541413aa895, var_cc38472e36be1b61) {
...
function function_37f6a694b8c6656a() {
    ...
    if (isdefined(arena)) {
        foreach (p in arena.arenaplayers) {
            ...
            if (level.var_5b530d6e84ac2128.var_f455b3807d4ea69d) {
                headicon = player namespace_7bdde15c3500a23f::setheadicon_singleimage(p, iconname, var_f9cd7fda74e92e2a, var_e0e11f3b4551be11, maxdistance, var_30516b4afd1763de, undefined, 1, 1, undefined);
    ...
    if (level.var_5b530d6e84ac2128.var_17ee664650bd17cb == 0) {
        ...
        var_6f2d5ac61454ff66 = player function_c46cdee20f0bd709();
        player namespace_ad49798629176e96::function_6ce94cf4eee9eab7(var_6f2d5ac61454ff66);
        player.var_c1057221e17f180b = var_6f2d5ac61454ff66;
    }
...
function function_c46cdee20f0bd709() {
    ...
    var_1af1e8013fa97e2c = sortbydistance(arena.var_d5bdb69eb6ecfb2f, player.origin);
    timeleft = abs((gettime() - player.var_f42099a4e4fa8bc9 + level.gulag.timelimit * 1000) / 1000);
...
// Size: 0x56
function function_fa6fe679b2067ac9(headicon, var_b37aef355ba7b694) {
...
function function_12495ee9a0fa83c2(arena) {
    foreach (var_6f2d5ac61454ff66 in arena.var_d5bdb69eb6ecfb2f) {
        ...
        if (objid != -1) {
            namespace_5a22b6f3a56f7e9b::objective_add_objective(objid, "current", var_6f2d5ac61454ff66.origin + (0, 0, 60), "ui_mp_br_icon_gulag_exit_objective");
...
function function_5f0d7586dda3b8db(arena) {
    ...
    foreach (p in arena.arenaplayers) {
        ...
        namespace_5a22b6f3a56f7e9b::objective_playermask_hidefrom(var_6f2d5ac61454ff66.objid, p);
    }
}
...
function function_6e29d1220ea1a70e() {
    ...
    arena = namespace_ad49798629176e96::function_2f4344abdc200e43(player);
    foreach (var_6f2d5ac61454ff66 in arena.var_d5bdb69eb6ecfb2f) {
        objective_addclienttomask(var_6f2d5ac61454ff66.objid, player);
        objective_showtoplayersinmask(var_6f2d5ac61454ff66.objid);
    }
}
...
function function_31b5a57beac56067() {
    ...
    } else if (level.var_43307855f189eb31.var_5466042078981ff3 == 3) {
...
function function_3104d393dc6cc377(arena) {
    ...
    if (!isdefined(player.var_f73178c689f257ae)) {
        player.var_f73178c689f257ae = 0;
    }
    points = player.var_32484cd3b17f16c8 + player.var_f73178c689f257ae;
    wait(5);
...
function function_6ec844085b807d62(agent, killer) {
    ...
    if (istrue(level.var_5b530d6e84ac2128.var_4d40d2fec8e9c5b0)) {
        ...
        killer function_de9ddf5a99c3e235(killer.var_f73178c689f257ae + killer.var_32484cd3b17f16c8);
    }
    if (istrue(level.var_43307855f189eb31.var_6efb9d0afa7efcb2)) {
        dropstruct = namespace_cb965d2f71fefddc::function_7b9f3966a7a42003();
        agent thread namespace_cb965d2f71fefddc::function_55463a3679678e2f(dropstruct);
    }
    if (getdvarint(@"hash_39d4d700e41d2edc", 1)) {
        var_c229d93c0bb4f8e8 = arena.var_79f102b3abcc6f8a[randomint(arena.var_79f102b3abcc6f8a.size)];
        if (isdefined(agent.var_c229d93c0bb4f8e8)) {
...
function function_d22e87091afd9fb7(attacker, victim) {
    ...
    if (!isdefined(attacker.var_f73178c689f257ae)) {
        attacker.var_f73178c689f257ae = 0;
    }
    ...
    if (istrue(level.var_5b530d6e84ac2128.var_4d40d2fec8e9c5b0)) {
        ...
        attacker function_de9ddf5a99c3e235(attacker.var_f73178c689f257ae + attacker.var_32484cd3b17f16c8);
    }
...
function function_6e49ea089039048a() {
    ...
    /#
        /#
            assertex(var_283bf79efcf70762 < 16, "archetype_assault");
        #/
        /#
...
function function_db60abb28498007b() {
    player = self;
    if (isdefined(level.var_5b530d6e84ac2128) && istrue(level.var_5b530d6e84ac2128.var_3e34096b136f9a10) && player namespace_d3d40f75bb4e4c32::isplayerinorgoingtogulag() && istrue(player.var_43b2a82936a5e974) && istrue(level.var_43307855f189eb31.var_ec2eaa1a4b68c0cf)) {
        return 1;
    }
    return 0;
}
...
function function_9971773d776c97ab(arena) {
    if (namespace_ad49798629176e96::function_d8f18f1d691c0ef8(arena)) {
        ...
        foreach (var_55e69fb0ce97f15e in arena.var_79f102b3abcc6f8a) {
            thread function_7b5f223f3ea0fd5a(arena, var_55e69fb0ce97f15e);
        }
    }
}
...
// Size: 0x112
function function_7b5f223f3ea0fd5a(arena, var_55e69fb0ce97f15e) {
...
// Size: 0x139
function function_a4f7aa7494769dcc(arena, var_37e3a1eaa43ea82c) {
    var_d0ead7e588a015c5 = getdvarint(@"hash_177d32d81bd6bc15", 130);
    var_d30b471f5a146c39 = spawn("trigger_radius", var_37e3a1eaa43ea82c, 0, var_d0ead7e588a015c5, 120);
    var_d30b471f5a146c39.script_label = "_a";
    arenaflag = namespace_98b55913d2326ac8::setupobjective(var_d30b471f5a146c39, "neutral", undefined, 1);
...
function function_ac9e0da4d9b4494d(var_5ab435632b934364) {
    ...
    foreach (var_687e3456e754e3e1 in var_2b24aedf3a828b22) {
        foreach (touchlist in var_687e3456e754e3e1) {
            p = touchlist.player;
            if (!isdefined(p)) {
                continue;
            }
...
function gulagdom_arenaflagrestartdom(arena) {
    ...
    index = randomint(arena.var_ab7aa90965bbffae.size);
    location = arena.var_ab7aa90965bbffae[index];
...
function function_f49d19b1b7acfa56(var_5ab435632b934364) {
    ...
    namespace_19b4203b51d56488::setusetime(level.var_5b530d6e84ac2128.var_cb871a5b28f14e14);
    namespace_19b4203b51d56488::setobjectivestatusicons("waypoint_taking", "waypoint_taking");
}
...
function function_f9fae1b8f601f0ea(arena) {
    ...
    player endon("disconnect");
    player namespace_ad49798629176e96::function_3f18739ae34d9958();
    if (isdefined(arena.var_d5bdb69eb6ecfb2f)) {
        foreach (var_6f2d5ac61454ff66 in arena.var_d5bdb69eb6ecfb2f) {
            if (isdefined(var_6f2d5ac61454ff66) && isdefined(var_6f2d5ac61454ff66.objid) && isdefined(player)) {
                namespace_5a22b6f3a56f7e9b::objective_playermask_hidefrom(var_6f2d5ac61454ff66.objid, player);
            }
        }
    }
