...
function function_9c13c9f95161d576(player, isunderwater) {
    ...
    if (isunderwater) {
        player namespace_cb965d2f71fefddc::function_cdf7f2f6bd3207("underwater");
    } else {
        player namespace_cb965d2f71fefddc::function_8206bc54a1ed73cb("underwater");
    }
}
...
function function_4e41bf5f9d46e115() {
    ...
    while (1) {
        ...
        if (isdefined(self.origin) && !istrue(self.plotarmor)) {
            namespace_9c6cddd872ad75f7::processdamage(var_76e563db5d11a0ea);
        }
