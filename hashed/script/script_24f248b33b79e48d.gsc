...
function function_c24185c47d989c1a(broadcastdefinition) {
    ...
    /#
        ...
        var_5ae6a11bbc87d784 = default_to(uniquename, "X_Percentage_Remaining");
        /#
            assertex(isdefined(uniquename), " broadcast ID: ");
        #/
    #/
    return "None";
}
...
function function_f5a44c850aa837e3(broadcastdefinition) {
    ...
    /#
        var_5ae6a11bbc87d784 = default_to(function_97d99a58c1ec5772(broadcastdefinition), "X_Percentage_Remaining");
    #/
    return "Instance";
}
...
function function_45575393a3d8e399(broadcastinstance) {
    /#
        ...
        if ("<unknown string>" != broadcastdestination) {
            /#
                assertmsg("<unknown string>" + broadcastinstance function_cf54c2c8650d9688() + "<unknown string>");
            #/
            return;
        }
    #/
