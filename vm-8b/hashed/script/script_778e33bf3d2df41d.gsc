...
// Namespace mp_jup_skydiving_zone_1_create_script / namespace_c8ab2d84daadcbf3
// Params 2, eflags: 0x0
...
function createstructs(fe, us, cf) {
    f = &strike_additem;
    s = s();
    s.var_ca7eef470d1b0ef2 = "mp_jup_skydiving_zone_1_create_script";
    s.script_accel = float(35);
    s.script_decel = float(35);
    s.var_f2bc1b4875488d73 = "ahotel64";
    ...
    s.var_ca7eef470d1b0ef2 = "mp_jup_skydiving_zone_1_create_script";
    s.script_accel = float(30);
    s.var_d69d7ea717062c4b = "missile";
    s.script_decel = float(60);
    ...
    s.var_ca7eef470d1b0ef2 = "mp_jup_skydiving_zone_1_create_script";
    s.script_accel = float(30);
    s.var_59c8ac73106455e = "ahotel64";
    s.script_decel = float(60);
    ...
    s.var_ca7eef470d1b0ef2 = "mp_jup_skydiving_zone_1_create_script";
    s.script_accel = float(30);
    s.var_59c8ac73106455e = "hit_building";
    s.script_decel = float(60);
    ...
    s.var_ca7eef470d1b0ef2 = "mp_jup_skydiving_zone_1_create_script";
    s.script_accel = float(30);
    s.var_d69d7ea717062c4b = "shoot";
    s.script_decel = float(60);
    s.var_47bb12d3d697dd03 = "5";
    ...
    s.script_decel = float(60);
    s.var_47bb12d3d697dd03 = "5";
    s.var_489a6a79e9f53f80 = "heli_ash_2_target";
    s.var_d22e1aff382cd1a5 = "15";
    ...
    s.script_decel = float(60);
    s.var_47bb12d3d697dd03 = "5";
    s.var_489a6a79e9f53f80 = "heli_ash_3_target";
    s.var_d22e1aff382cd1a5 = "30";
