    ...
    if ( isdefined( self ) || isalive( self ) )
    {
        ...
        /#
            if ( getdvarint( @"hash_e9e247c60cd8800a" ) )
            {
                ...
                debug_print3d( attacker.scripted_melee_player_rig gettagorigin( level.scripted_melee.player_link_bone ), "<dev string:x4b>" + gettime(), ( 1, 0, 0 ), 1, 0.1, 1000 );
...
{
    defaultattachments = function_6527364c1ecca6c6( weapon.basename );
