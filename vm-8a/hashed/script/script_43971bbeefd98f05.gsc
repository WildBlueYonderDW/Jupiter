...
function function_68085c72d7b628ec(container, opener) {
    ...
    /#
        if (isdefined(level.var_61e6e1b83a8f3486) && isdefined(level.var_61e6e1b83a8f3486.var_9549d82a3fba4746) && container == level.var_61e6e1b83a8f3486.var_9549d82a3fba4746) {
            opener setclientomnvar("<dev string:x6b>", 0);
            opener.var_2fa5b49969def47 = undefined;
            container notify("<dev string:x7f>");
            return;
        }
    #/
...
function function_f4fda26d9ae6dbe0(player, index, obtaintype, var_a1803fc19dffd729, cache) {
    ...
    if (isdefined(weapondata) && isdefined(weapondata.baseweapon)) {
        ...
        itembundle = getscriptbundle("itemspawnentry:" + itembundlename);
        assert(isdefined(itembundle), "<dev string:x86>" + itembundlename + "<dev string:xc4>");
    } else {
        itembundlename = function_fc925a153c7fd55c(lootid);
    ...
    if (!isdefined(container) || !isdefined(container.contents) || !isdefined(lootid) || !isint(lootid)) {
        /#
            if (!isdefined(container) || !isdefined(container.contents)) {
                ...
                assertmsg("<dev string:x117>");
            }
        #/
        return [undefined, undefined];
    }
    for (containerindex = 0; containerindex < container.contents.size; containerindex += 1) {
...
/#
    ...
    function private setup_devgui() {
        ...
        zonelist = getscriptbundle("<dev string:x169>" + level.gametypebundle.var_328f56c2f24c4831);
        ...
        foreach (var_8bfddc20fd955e32 in zonelist.zonedefs) {
            if (isdefined(var_8bfddc20fd955e32.zonedef) && !isdefined(var_2db9da2642048a13[var_8bfddc20fd955e32.zonedef])) {
                var_2db9da2642048a13[var_8bfddc20fd955e32.zonedef] = getscriptbundle("<dev string:x17c>" + var_8bfddc20fd955e32.zonedef);
            }
        }
        devgui::function_6e7290c8ee4f558b("<dev string:x18e>");
        devgui::function_b23a59dfb4ca49a1("<dev string:x1ad>", "<dev string:x1af>", &function_fda80ec40b57c4cf);
        devgui::function_b23a59dfb4ca49a1("<dev string:x1c5>", "<dev string:x1c7>", &function_fda80ec40b57c4cf);
        devgui::function_b23a59dfb4ca49a1("<dev string:x1dd>", "<dev string:x1df>", &function_fda80ec40b57c4cf);
        devgui::function_b23a59dfb4ca49a1("<dev string:x1f5>", "<dev string:x1f7>", &function_fda80ec40b57c4cf);
        devgui::function_b23a59dfb4ca49a1("<dev string:x20d>", "<dev string:x20f>", &function_fda80ec40b57c4cf);
        devgui::function_b23a59dfb4ca49a1("<dev string:x225>", "<dev string:x227>", &function_fda80ec40b57c4cf);
        devgui::function_b23a59dfb4ca49a1("<dev string:x23d>", "<dev string:x23f>", &function_fda80ec40b57c4cf);
        devgui::function_b23a59dfb4ca49a1("<dev string:x255>", "<dev string:x257>", &function_fda80ec40b57c4cf);
        devgui::function_b23a59dfb4ca49a1("<dev string:x26d>", "<dev string:x26f>", &function_fda80ec40b57c4cf);
        devgui::function_b23a59dfb4ca49a1("<dev string:x285>", "<dev string:x288>", &function_fda80ec40b57c4cf);
        devgui::function_b23a59dfb4ca49a1("<dev string:x29f>", "<dev string:x2a2>", &function_fda80ec40b57c4cf);
        ...
        foreach (var_e20693215273eb59, var_a91353c4805838d2 in var_2db9da2642048a13) {
            foreach (entry in var_a91353c4805838d2.var_280b92209c904804) {
                if (isdefined(entry.var_b312af7d766b0713) && isdefined(entry.cacheitemspawnlist) && isdefined(entry.var_afbb6e9b90b03af)) {
                    devgui::function_b23a59dfb4ca49a1(var_e20693215273eb59 + "<dev string:x2d9>" + entry.var_afbb6e9b90b03af, "<dev string:x2e3>" + entry.var_afbb6e9b90b03af + "<dev string:x2f4>" + entry.cacheitemspawnlist + "<dev string:x2f4>" + entry.var_b312af7d766b0713, &function_35b40f5e98dc4ee4, 0);
                }
            }
            foreach (entry in var_a91353c4805838d2.var_d13f1f3566674f10) {
                if (isdefined(entry.var_b312af7d766b0713) && isdefined(entry.cacheitemspawnlist) && isdefined(entry.var_afbb6e9b90b03af)) {
                    devgui::function_b23a59dfb4ca49a1(var_e20693215273eb59 + "<dev string:x2f6>" + entry.var_afbb6e9b90b03af, "<dev string:x2e3>" + entry.var_afbb6e9b90b03af + "<dev string:x2f4>" + entry.cacheitemspawnlist + "<dev string:x2f4>" + entry.var_b312af7d766b0713, &function_35b40f5e98dc4ee4, 0);
                }
            }
            foreach (entry in var_a91353c4805838d2.var_9e5e8749b0f570be) {
                if (isdefined(entry.scriptkey) && isdefined(entry.var_b312af7d766b0713) && isdefined(entry.cacheitemspawnlist) && isdefined(entry.var_afbb6e9b90b03af)) {
                    devgui::function_b23a59dfb4ca49a1(var_e20693215273eb59 + "<dev string:x2fe>" + function_3c8848a3a11b2553(entry.scriptkey), "<dev string:x2e3>" + entry.var_afbb6e9b90b03af + "<dev string:x2f4>" + entry.cacheitemspawnlist + "<dev string:x2f4>" + entry.var_b312af7d766b0713, &function_35b40f5e98dc4ee4, 0);
                }
            }
        }
        devgui::function_fe953f000498048f();
    ...
    function function_7029bab8ebd74e1d(contents) {
        ...
        if (!isdefined(level.var_61e6e1b83a8f3486.var_9549d82a3fba4746)) {
            ...
            level.var_61e6e1b83a8f3486.var_9549d82a3fba4746.type = "<dev string:x307>";
