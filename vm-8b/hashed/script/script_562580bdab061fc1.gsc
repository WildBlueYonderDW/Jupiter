...
/#
    ...
    // Namespace namespace_fb4e60babf7f8008 / namespace_ceba5eb2bad92af9
    // Params 0, eflags: 0x0
    // Checksum 0x0, Offset: 0x7912
    // Size: 0xb7
    function function_ad8fdc6004c25e47() {
        self endon("<dev string:x181>");
        while (true) {
            damage, attacker, direction_vec, point, meansofdeath, modelname, tagname, partname, idflags, objweapon, origin, angles, normal, inflictor = self waittill("<dev string:x18a>");
            if (false) {
                iprintlnbold(damage);
            }
            waitframe();
