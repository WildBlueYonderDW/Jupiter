...
function main() {
    ...
    namespace_ac7e8770abb7eb1::attachhead("c_jup_zmb_zombie_base_female_jeans_head_rz", namespace_3533caf9c67d2326::main());
...
function function_430419022a9c3ffe() {
    precache();
    namespace_ac7e8770abb7eb1::precachemodelarray(namespace_857e5d80736a0998::main());
    namespace_ac7e8770abb7eb1::precachemodelarray(namespace_3533caf9c67d2326::main());
}
