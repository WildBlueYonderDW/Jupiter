...
function function_390c90207bac8552() {
    ...
    foreach (var_a0185a724941f02f in self.Mind.var_f0a8822dcc782c9d.var_577f45571c039a54) {
        var_a0185a724941f02f.enabled = 0;
        var_a0185a724941f02f.var_10f0b5c52ece08ce = 0;
    }
}
