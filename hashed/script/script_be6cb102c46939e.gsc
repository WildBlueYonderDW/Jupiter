...
// Namespace movement_trigger / namespace_6bbbe2460b441162
// Params 2, eflags: 0x0
...
function function_70b3ca07d4c0f3f8(ent, var_3e36f415f762070e) {
    ...
    return isdefined(ent.var_38c28a5cc311c668) && ent.var_38c28a5cc311c668 > 0;
}
...
function function_65c16fd9e382bfa5(ent) {
    if (!isdefined(ent.var_38c28a5cc311c668)) {
        ent.var_38c28a5cc311c668 = 0;
    }
    ent.var_38c28a5cc311c668++;
    if (ent.var_38c28a5cc311c668 >= 1) {
...
function function_cb19ee46faa81f4e(ent, var_d5c909837fd4deb4) {
    assertex(isdefined(ent.var_38c28a5cc311c668), "disablemovementTrigger called on an entity that was not in the Ai Region. ");
    if (!isdefined(ent.var_38c28a5cc311c668)) {
        if (isdefined(ent)) {
        }
    }
    if (!istrue(var_d5c909837fd4deb4)) {
        assertex(ent.var_38c28a5cc311c668 > 0, "disablemovementTrigger more times than enablemovementTrigger.");
    }
    ent.var_38c28a5cc311c668--;
    if (ent.var_38c28a5cc311c668 == 0) {
        ent.var_38c28a5cc311c668 = undefined;
        if (!isdefined(ent.var_b55efc7e48cdb8ea) || ent.var_b55efc7e48cdb8ea <= 0) {
...
function function_b3f8ecf3b39399b7(ent) {
    ...
    if (ent.var_b55efc7e48cdb8ea == 1) {
        if (isdefined(ent.var_38c28a5cc311c668) && ent.var_38c28a5cc311c668 > 0) {
            function_d695c5f1c8b04647(ent, 0);
        }
    }
}
...
function function_7487311d783befd(ent) {
    ...
    if (isplayer(ent)) {
        ...
        struct = function_d7c5841ba3c7f86a();
        var_106b10573bdeadf0 = struct.outoftimecallbacks[ent.var_c7146296a3fd5b15];
    }
    if (isdefined(var_106b10573bdeadf0)) {
        ent thread [[ var_106b10573bdeadf0 ]]("movementTrigger_timeout_end", "clear_movementTrigger");
    }
}
...
function playerentercallback(exitnotify, clearnotify, triggertype, trigger) {
    ...
    /#
        if (namespace_6bbbe2460b441162::function_4aca25cbf5674e7()) {
...
function function_6bf7d3e9a6d1b183(trigger, ent) {
    ...
    temparr = [trigger];
    foreach (var_7dc0e1c6207a7144 in ent.var_9a1bdb96d46fbf5) {
        temparr[temparr.size] = var_7dc0e1c6207a7144;
    }
...
function function_7f94d7fd3ed90c14(trigger, ent) {
    ...
    temparr = [trigger];
    foreach (var_733b07b3a5d133f1 in ent.var_7ba5c84eb36c67fe) {
        temparr[temparr.size] = var_733b07b3a5d133f1;
    }
...
function movementChangeRequests() {
    ...
    while (true) {
        movement_trigger, var_8d04a2d6273459eb, var_bbba777adf94982f = self waittill("movement_speed_update_request");
        if (istrue(var_bbba777adf94982f)) {
            ...
            #/
            namespace_8235b93197138d09::function_36d589dc5c4191f6();
            continue;
        }
        ...
        if (isdefined(movement_trigger.script_count)) {
            namespace_8235b93197138d09::function_36d589dc5c4191f6(var_74da84eac189e996, movement_trigger.script_count);
            continue;
        }
        namespace_8235b93197138d09::function_36d589dc5c4191f6(var_74da84eac189e996);
    }
}
