...
/#
    ...
    function function_a07f7c4c0c4ef8e3() {
        return getstructarray("<dev string:x1c>", "<dev string:x25>");
    }
...
function function_42c897c05fdda094() {
    ...
    /#
        namespace_d1a9ca87d78d9813::function_9533653868e59fb6("<dev string:x37>", self.activity.name, undefined, "<dev string:x1c>", undefined, undefined, self.activity.poi, self.node.origin);
    #/
    /#
        namespace_d1a9ca87d78d9813::function_9533653868e59fb6("<dev string:x37>", self.activity.name, undefined, "<dev string:x48>", undefined, undefined, self.activity.poi, self.node.origin);
    #/
    trigger = spawn("trigger_radius", self.node.origin, 0, int(level.safeprops.captureradius), int(level.safeprops.captureradius));
    trigger trigger_off();
    self.trigger = trigger;
    /#
        namespace_d1a9ca87d78d9813::function_9533653868e59fb6("<dev string:x56>", self.activity.name, undefined, "<dev string:x63>", undefined, undefined, self.activity.poi, self.node.origin);
    #/
    ...
    /#
        namespace_d1a9ca87d78d9813::function_9533653868e59fb6("<dev string:x72>", self.activity.name, undefined, "<dev string:x84>", undefined, undefined, self.activity.poi, self.node.origin);
    #/
