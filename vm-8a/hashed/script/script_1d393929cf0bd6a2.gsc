...
function function_8e5aab643e51aaf9() {
    foreach (player in self.playeropen) {
        ...
        println(player getplayerdata(level.var_5d69837cf4db0407, "<dev string:x1c>") + "<dev string:x2a>");
        println(player.name + "<dev string:x51>");
        ...
        println(player getplayerdata(level.var_5d69837cf4db0407, "<dev string:x1c>") + "<dev string:x7f>");
        ...
        println(player.name + "<dev string:xa4>");
        player namespace_aead94004cf4c147::printinventory();
