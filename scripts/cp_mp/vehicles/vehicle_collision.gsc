...
function vehicle_collision_updateinstance(vehicle) {
    ...
    while (isdefined(vehicle)) {
        body0, body1, flag0, flag1, position, normal, normalspeed, ent, partenum = vehicle waittill("collision");
        ...
        if (var_42a333103449127c) {
            foreach (tempvehicle in [vehicle, ent]) {
                ...
                var_e2818ad39a3341b4 = vehicle_collision_getleveldataforvehicle(tempvehicle function_d93ec4635290febd(), 0, 1);
...
function private function_10d733624bfda604(vehicle, otherent, body0, body1, flag0, flag1, position, normal, normalspeed, partenum) {
    ...
    if (var_7b2c3e974fa33cf2) {
        ...
        var_57acadc40b2f0a8 = function_1ab37f5b6734e44d(baseclass, otherclass);
...
function private function_74ce9dc0a18ac393(vehicle, position, normal, timeinair) {
    ...
    timeinair = timeinair * multiplier;
    ...
    /#
        if (false) {
            ...
            print3d(position, "<unknown string>" + timeinair + "<unknown string>" + damagetier, color, 1, 1, 4000);
