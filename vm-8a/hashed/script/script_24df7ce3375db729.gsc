...
/#
    ...
    function function_7af4fc80d8a7506f(params) {
        ...
        devgui::function_b23a59dfb4ca49a1("<dev string:x4b>", "<dev string:x5a>", &function_12b5e47689dd56e9, 1);
    ...
    function function_12b5e47689dd56e9(params) {
        if (!isdefined(params[0]) || utility::is_equal(params[0], "<dev string:x73>")) {
            return;
        }
        switch (params[0]) {
        case #"hash_108e564bd5f431c1": 
            function_38e113a4c30f6c0d("<dev string:x7e>", level.players[0].origin);
            return;
        }
    }
