...
// Size: 0x2e6
function function_6226a01fb62f39fd(player, var_3aa66d1cfed21aca, var_ecf8d79fb68e4fb, var_9f4347003cf3a72a, var_f7c06d80611e778e, var_f55638498fcbc37c, var_602a20eb3aa23bfa) {
    ...
    if (isdefined(safeorigin)) {
        ...
        while (true) {
            ...
            if (distancesquared(player.origin, var_95b51daa0fb10c76) > var_3aa66d1cfed21aca && distancesquared(player.origin, self.origin) < var_ecf8d79fb68e4fb) {
                ...
                function_69e98977aca657e7(self.var_66c1831357048c02.origin, var_602a20eb3aa23bfa);
                function_e3952036dafb66ee();
                break;
            }
...
// Size: 0x11e
function function_69e98977aca657e7(point, var_602a20eb3aa23bfa) {
    level endon("game_ended");
    self endon("death");
    safeorigin = getclosestpointonnavmesh(point, self);
    if (isdefined(safeorigin)) {
        if (istrue(var_602a20eb3aa23bfa)) {
