...
/#
    ...
    function function_6d1c17a3f1f2d562() {
        ...
        while (true) {
            ...
            wait 0.2;
            posstring = int(var_1a1ddfa1a9811c7c.targetpos[0]) + "<dev string:x50>" + int(var_1a1ddfa1a9811c7c.targetpos[1]) + "<dev string:x50>" + int(var_1a1ddfa1a9811c7c.targetpos[2]);
            screenshotfilename = "<dev string:x52>" + var_1a1ddfa1a9811c7c.testphase + "<dev string:x50>" + posstring + "<dev string:x5d>" + var_1a1ddfa1a9811c7c.var_31e45429b9998458;
            adddebugcommand("<dev string:x69>" + screenshotfilename + "<dev string:x79>");
            wait 0.5;
            if (var_1a1ddfa1a9811c7c.testphase == "<dev string:x48>") {
                level notify("<dev string:x7c>" + var_1a1ddfa1a9811c7c.var_31e45429b9998458);
            }
            if (defaultplayer isnoclip()) {
                defaultplayer noclip();
            }
