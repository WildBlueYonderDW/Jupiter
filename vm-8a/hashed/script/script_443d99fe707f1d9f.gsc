...
function private function_94cbe3c6bcb49cb1(params) {
    if (namespace_2b1145f62aa835b8::function_61575e37b9200c0d() && isdefined(self.revivecount)) {
        ...
        for (reviveweaponindex = 0; reviveweaponindex < reviveweapons.size; reviveweaponindex += 1) {
            for (var_5db61256ca3c39bd = 0; var_5db61256ca3c39bd < self.var_dd3d589a27a0b26.size; var_5db61256ca3c39bd += 1) {
...
function function_b5be5fff64626153(itembundlename) {
    ...
    if (!isdefined(level.commonitem.var_37d10554e6936847[itembundle.baseweapon].bundles[blueprintindex][rarity])) {
        ...
        /#
            print("<dev string:x23>" + function_3c8848a3a11b2553(level.commonitem.var_37d10554e6936847[itembundle.baseweapon].bundles[blueprintindex][rarity]) + "<dev string:x5e>" + itembundlename + "<dev string:x66>" + function_3c8848a3a11b2553(itembundle.baseweapon) + "<dev string:x72>" + rarity + "<dev string:x86>");
        #/
    }
    if (!istrue(itembundle.var_5a5e50bc261c907a)) {
        if (!isdefined(level.commonitem.var_37d10554e6936847[itembundle.baseweapon].scriptable)) {
            ...
            /#
                print("<dev string:x23>" + function_3c8848a3a11b2553(level.commonitem.var_37d10554e6936847[itembundle.baseweapon].var_35799804650f8bea) + "<dev string:x5e>" + itembundlename + "<dev string:x66>" + function_3c8848a3a11b2553(itembundle.baseweapon) + "<dev string:x72>" + rarity + "<dev string:x86>");
            #/
        }
        if (isdefined(itembundle.var_64a5f9f552b5c973) || isdefined(itembundle.var_89616f2bce6b4ee6)) {
            ...
            /#
                print("<dev string:x23>" + function_3c8848a3a11b2553(level.commonitem.var_37d10554e6936847[itembundle.baseweapon].transform.bundle) + "<dev string:x5e>" + function_3c8848a3a11b2553(itembundlename) + "<dev string:xdd>" + function_3c8848a3a11b2553(itembundle.baseweapon) + "<dev string:xf5>");
            #/
        }
    }
}
...
function function_b5f358d46f69b20e(weaponobject, rarity, primaryweaponindex) {
    ...
    if (!isdefined(primaryweaponindex) || primaryweaponindex < 0 || primaryweaponindex >= 2) {
        println("<dev string:x13e>" + (isdefined(weaponobject.basename) ? weaponobject.basename : "<dev string:x19e>") + "<dev string:x1aa>" + (isdefined(primaryweaponindex) ? primaryweaponindex : "<dev string:x1d7>"));
        return undefined;
    }
...
/#
    ...
    function private function_95cd4c99989f7140() {
        ...
        devgui::function_6e7290c8ee4f558b("<dev string:x1e1>");
        devgui::function_b2159fbbd7ac094e("<dev string:x1f4>", @"hash_d1415bb7a04b48f9");
        devgui::function_b23a59dfb4ca49a1("<dev string:x208>", "<dev string:x226>", &function_2388563f2076e75e, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:x23a>", "<dev string:x25a>", &function_2388563f2076e75e, 1);
        devgui::function_b23a59dfb4ca49a1("<dev string:x26e>", "<dev string:x289>", &function_2388563f2076e75e, 2);
        devgui::function_b23a59dfb4ca49a1("<dev string:x29d>", "<dev string:x2ba>", &function_2388563f2076e75e, 3);
        devgui::function_b23a59dfb4ca49a1("<dev string:x2ce>", "<dev string:x2f0>", &function_2388563f2076e75e, 4);
        devgui::function_b23a59dfb4ca49a1("<dev string:x304>", "<dev string:x31a>", &function_c6fb716427c35c50, 0);
        devgui::function_b2159fbbd7ac094e("<dev string:x340>", @"hash_8b93e6e651c920bb", 1);
        devgui::function_df648211d66cd3dd("<dev string:x35b>", "<dev string:x370>", 2);
        devgui::function_df648211d66cd3dd("<dev string:x3ae>", "<dev string:x3c3>", 3);
        devgui::function_df648211d66cd3dd("<dev string:x401>", "<dev string:x413>", 4);
    ...
    function private function_cb5a17997d502c15(var_9ec97bdad14a0a5b) {
        item_bundle = function_50f8a8f765bad85e("<dev string:x44f>" + var_9ec97bdad14a0a5b, [#"ref", #"subtype", #"rarity"]);
        if (!isdefined(item_bundle.ref) || getdvarint(@"hash_10f0811105fc2f93", 0) == 0) {
            return;
        }
        subtype = isdefined(item_bundle.subtype) ? item_bundle.subtype : "<dev string:x45f>";
        rarity = isdefined(item_bundle.rarity) ? "<dev string:x461>" + item_bundle.rarity : "<dev string:x462>";
        if (!isdefined(level.var_61e6e1b83a8f3486.weapondevgui[subtype])) {
            ...
            devgui::function_b23a59dfb4ca49a1("<dev string:x464>" + subtype, "<dev string:x47f>" + subtype, &function_acbdc55d88b2babd, 0, 0);
        }
    ...
    function private function_acbdc55d88b2babd(params) {
        ...
        rarity = params[2];
        if (isdefined(rarity)) {
            rarity_menu = "<dev string:x4a3>" + rarity + "<dev string:x4a6>";
            switch (rarity) {
            case #"hash_311010bc01bd3a0f": 
                rarity_menu = "<dev string:x4a8>";
                break;
            case #"hash_31100fbc01bd387c": 
                rarity_menu = "<dev string:x4be>";
                break;
            case #"hash_311012bc01bd3d35": 
                rarity_menu = "<dev string:x4d6>";
                break;
            case #"hash_311011bc01bd3ba2": 
                rarity_menu = "<dev string:x4e9>";
                break;
            case #"hash_31100cbc01bd33c3": 
                rarity_menu = "<dev string:x4fe>";
                break;
            case #"hash_31100bbc01bd3230": 
                rarity_menu = "<dev string:x461>";
                break;
            }
            devgui_menu = "<dev string:x464>" + subtype + "<dev string:x518>" + item_ref + rarity_menu + "<dev string:x51a>";
            devgui::add_debug_command("<dev string:x51d>" + devgui_menu + "<dev string:x52d>");
            var_9ec97bdad14a0a5b = level.var_61e6e1b83a8f3486.weapondevgui[subtype].refs[item_ref].rarities[rarity];
            devgui::function_b23a59dfb4ca49a1(devgui_menu + "<dev string:x530>", "<dev string:x537>" + var_9ec97bdad14a0a5b, &common_item::function_f8162124bbb6ece3, 0, 0);
            devgui::function_b23a59dfb4ca49a1(devgui_menu + "<dev string:x543>", "<dev string:x54a>" + var_9ec97bdad14a0a5b, &function_d26496ac40030d8a, 0, 1);
            devgui::function_b23a59dfb4ca49a1(devgui_menu + "<dev string:x55d>", "<dev string:x566>" + var_9ec97bdad14a0a5b, &function_9ea2acdd3cda26a2, 0, 2);
            devgui::function_b23a59dfb4ca49a1(devgui_menu + "<dev string:x57b>", "<dev string:x58d>" + var_9ec97bdad14a0a5b, &function_c6fb716427c35c50, 0, 3);
            devgui::function_b23a59dfb4ca49a1(devgui_menu + "<dev string:x5b4>", "<dev string:x5c6>" + var_9ec97bdad14a0a5b, &function_c6fb716427c35c50, 0, 4);
            devgui::function_b23a59dfb4ca49a1(devgui_menu + "<dev string:x5ed>", "<dev string:x5ff>" + var_9ec97bdad14a0a5b, &function_c6fb716427c35c50, 0, 5);
            devgui::function_b23a59dfb4ca49a1(devgui_menu + "<dev string:x626>", "<dev string:x639>" + var_9ec97bdad14a0a5b, &function_c6fb716427c35c50, 0, 6);
            devgui::add_debug_command("<dev string:x661>" + devgui_menu + "<dev string:x52d>");
        ...
        if (isdefined(item_ref)) {
            ...
            devgui_menu = "<dev string:x464>" + subtype + "<dev string:x518>" + item_ref + "<dev string:x51a>";
            devgui::add_debug_command("<dev string:x51d>" + devgui_menu + "<dev string:x52d>");
            foreach (rarity, rarity_info in level.var_61e6e1b83a8f3486.weapondevgui[subtype].refs[item_ref].rarities) {
                ...
                devgui::function_b23a59dfb4ca49a1(devgui_menu + rarity_menu, "<dev string:x47f>" + subtype + "<dev string:x66f>" + item_ref + "<dev string:x66f>" + rarity, &function_acbdc55d88b2babd, 0, 0);
            }
            devgui::add_debug_command("<dev string:x661>" + devgui_menu + "<dev string:x52d>");
            return;
        }
        ...
        devgui_menu = "<dev string:x464>" + subtype + "<dev string:x51a>";
        devgui::add_debug_command("<dev string:x51d>" + devgui_menu + "<dev string:x52d>");
        foreach (item_ref, ref_info in level.var_61e6e1b83a8f3486.weapondevgui[subtype].refs) {
            devgui::function_b23a59dfb4ca49a1(devgui_menu + "<dev string:x518>" + item_ref, "<dev string:x47f>" + subtype + "<dev string:x66f>" + item_ref, &function_acbdc55d88b2babd, 0, 0);
        }
        devgui::add_debug_command("<dev string:x661>" + devgui_menu + "<dev string:x52d>");
    }
    ...
    function private function_c6fb716427c35c50(params) {
        ...
        if (command == "<dev string:x683>") {
            if (isdefined(level.var_61e6e1b83a8f3486.var_bdbda066e5e5a822[var_9ec97bdad14a0a5b])) {
                total_count = level.var_61e6e1b83a8f3486.var_bdbda066e5e5a822[var_9ec97bdad14a0a5b].iterations;
                count_str = "<dev string:x461>" + total_count + (total_count > 9 ? total_count > 99 ? total_count > 999 ? "<dev string:x68a>" : "<dev string:x68c>" : "<dev string:x68f>" : "<dev string:x693>");
                ...
                foreach (slot, attachments in level.var_61e6e1b83a8f3486.var_bdbda066e5e5a822[var_9ec97bdad14a0a5b].attachments) {
                    ...
                    count_str = "<dev string:x461>" + slot_count + (slot_count > 9 ? slot_count > 99 ? slot_count > 999 ? "<dev string:x68c>" : "<dev string:x68f>" : "<dev string:x693>" : "<dev string:x698>");
                    percent_str = "<dev string:x69e>" + 100 * float(slot_count) / float(total_count) + "<dev string:x6a1>";
                    ...
                    foreach (attachment, att_count in level.var_61e6e1b83a8f3486.var_bdbda066e5e5a822[var_9ec97bdad14a0a5b].attachments[slot]) {
                        count_str = "<dev string:x461>" + att_count + (att_count > 9 ? att_count > 99 ? att_count > 999 ? "<dev string:x68f>" : "<dev string:x693>" : "<dev string:x698>" : "<dev string:x6a4>");
                        percent_str = "<dev string:x69e>" + 100 * float(att_count) / float(slot_count) + "<dev string:x6a1>";
    ...
    function private function_a99e8a91fa0b3b39(var_9ec97bdad14a0a5b) {
        while (true) {
            ...
            if (getdvarint(@"hash_8b93e6e651c920bb", 1)) {
                ...
                total_count = level.var_61e6e1b83a8f3486.var_bdbda066e5e5a822[var_9ec97bdad14a0a5b].iterations;
                printtoscreen2d(x, y, "<dev string:x461>" + total_count, (1, 1, 1), scale, frames);
                printtoscreen2d(x + 4 * space, y, "<dev string:x68a>", (1, 1, 1), scale, frames);
                printtoscreen2d(x + 5 * space, y, var_9ec97bdad14a0a5b, (1, 1, 1), scale, frames);
                y += line_height;
                foreach (slot, attachments in level.var_61e6e1b83a8f3486.var_bdbda066e5e5a822[var_9ec97bdad14a0a5b].attachments) {
                    slot_count = level.var_61e6e1b83a8f3486.var_bdbda066e5e5a822[var_9ec97bdad14a0a5b].slots[slot];
                    percent = "<dev string:x69e>" + 100 * float(slot_count) / float(total_count) + "<dev string:x6a1>";
                    printtoscreen2d(x, y, "<dev string:x461>" + slot_count, (1, 1, 1), scale, frames);
                    printtoscreen2d(x + 5 * space, y, "<dev string:x68a>", (1, 1, 1), scale, frames);
                    printtoscreen2d(x + 6 * space, y, slot + percent, (1, 1, 1), scale, frames);
                    y += line_height;
                    foreach (attachment, att_count in level.var_61e6e1b83a8f3486.var_bdbda066e5e5a822[var_9ec97bdad14a0a5b].attachments[slot]) {
                        percent = "<dev string:x69e>" + 100 * float(att_count) / float(slot_count) + "<dev string:x6a1>";
                        printtoscreen2d(x, y, "<dev string:x461>" + att_count, (1, 1, 1), scale, frames);
                        printtoscreen2d(x + 6 * space, y, "<dev string:x68a>", (1, 1, 1), scale, frames);
