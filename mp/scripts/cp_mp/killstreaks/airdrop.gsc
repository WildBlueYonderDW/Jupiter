...
function function_c6f053f1952c1fec(player, ison) {
    ...
    if (function_889644f4a21bb5b9()) {
        ...
        var_21f43d417f625e44 = (player getclientomnvar("scriptable_crate_outline_mask") & 1 << bitindex) > 0;
        if (ison ^ var_21f43d417f625e44) {
...
function private function_9bbd441f216541c5(team) {
    ...
    level.cratedata.var_18ac5e12446ca8d[team] = level.cratedata.var_18ac5e12446ca8d[team] + 1;
...
function private function_db23cf58d610d7a2() {
    var_fea5e9fbbbdfc912 = self getscriptablepartstate("outline");
    waveindex = getsubstr(var_fea5e9fbbbdfc912, "spawn_wave_".size, var_fea5e9fbbbdfc912.size);
