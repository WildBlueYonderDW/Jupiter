...
function function_dd834b585f86b332(params) {
    ...
    if (isdefined(level.var_5b7c4eafd38d35c) && isdefined(level.var_5b7c4eafd38d35c.var_915f0d3c3a61e38)) {
        for (i = 0; i < level.var_5b7c4eafd38d35c.var_915f0d3c3a61e38.size; i = i + 1) {
...
function function_4b40a61f53dd9122() {
    ...
    var_49a313cc785a2410 = var_49a313cc785a2410 - level.aether_storm.var_be0e041e85848a6d;
    ...
    while (level.aether_storm.radiation.active) {
        ...
        foreach (agent in var_b31e57d1a1fc8871) {
            if (!isalive(agent) || istrue(agent.var_102a9d2cf99ab325)) {
                updated_counter = updated_counter + 0.1;
                continue;
            }
...
function function_ea13f5b63d920d2f(cluster_origin) {
    ...
    #/
    for (strike_count = 0; strike_count < level.aether_storm.var_284270df3a99404; strike_count = strike_count + 1) {
    ...
    /#
        ...
        while (true) {
            ...
            if (getdvarint(@"hash_15f2625555966cc5", 0)) {
                ...
                println("<unknown string>" + level.aether_storm.final_exfil.origin);
                foreach (player in level.players) {
            ...
            if (getdvarint(@"hash_e045509608ce5be3", 0)) {
                ...
                trace = trace::ray_trace(player geteye(), player geteye() + forward * 150000);
                if (isdefined(trace["<unknown string>"]) && isdefined(trace["<unknown string>"]) && trace["<unknown string>"] < 1) {
                    namespace_6c8a837ec98fe0b8::update_objective_position(level.aether_storm.var_d5422504409025bf, trace["<unknown string>"]);
                    namespace_6c8a837ec98fe0b8::objective_playermask_showtoall(level.aether_storm.var_d5422504409025bf);
                    level.aether_storm.var_bcf79bebe2066931.origin = trace["<unknown string>"];
                    level.aether_storm.var_bcf79bebe2066931 setscriptablepartstate(#"strike", #"on");
                    level.aether_storm.var_bcf79bebe2066931 waittill("<unknown string>");
                    namespace_6c8a837ec98fe0b8::objective_playermask_hidefromall(level.aether_storm.var_d5422504409025bf);
                }
            }
        }
    ...
    /#
        ...
        for (timer = 0; true; timer = 0) {
            if (getdvarint(@"hash_e2d799f3be57182c", 0) && timer == 0) {
                print3d(level.aether_storm.final_exfil.origin + (0, 0, 300), "<unknown string>", (1, 1, 1), 1, 25, 5, 1);
...
function function_108d531ae15fcc87(params) {
    /#
        ...
        if (istrue(level.aether_storm.final_exfil.var_1326008dc390c510) && isdefined(level.aether_storm.final_exfil.var_18da16a5ee3e8314) && isdefined(level.aether_storm.final_exfil.var_18da16a5ee3e8314.var_e3d833b1e5d30b03["<unknown string>"])) {
...
function function_9ecaf8b1fd98837e(params) {
    /#
        ...
        if (params[0] == "<unknown string>") {
            switch (level.aether_storm.announcement_handler) {
            case 0:
                thread overlord::playconversation("<unknown string>", level.players);
                break;
            case 1:
                thread overlord::playconversation("<unknown string>", level.players);
                break;
        ...
        if (params[0] == "<unknown string>") {
            switch (level.aether_storm.announcement_handler) {
            case 0:
                thread overlord::playevent("<unknown string>", level.players);
                break;
            case 1:
                thread overlord::playevent("<unknown string>", level.players);
                break;
