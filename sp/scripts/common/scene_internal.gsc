...
function private function_9745e01cedd81c85( alignmentinfo, shotindex )
{
    ...
    if ( shotanimations.size != 0 )
    {
        ...
        if ( isent( entity ) && entity.model != "" )
        {
            ...
            /#
                function_ce4b6d4d859ede39( var_214d924f4e137244, "<dev string:xf2>" + function_3c8848a3a11b2553( getanimname( animasset ) ), entity.origin, entity.angles );
            #/
            
            /#
                function_ce4b6d4d859ede39( var_214d924f4e137244, "<dev string:xff>" + function_3c8848a3a11b2553( getanimname( animasset ) ), alignmentinfo.origin, alignmentinfo.angles );
            #/
        }
    }
}
...
function private function_c34fc4bc3e1ecbcb( shotindex, animindex, notifystring, alignmentinfo, animasset, var_866b3a3066122e39, blendtime, blendcurve, lerptime, animationtype )
{
    ...
    if ( animationtype == "DeltaAnimation" )
    {
        ...
        var_214d924f4e137244 thread object_play_anim_waittill_end( animasset, [ var_214d924f4e137244.entity, anim_entity ], "death", animationtype, notifystring );
    ...
    {
        /#
            function_ce4b6d4d859ede39( var_214d924f4e137244, "<dev string:x128>" + animasset, alignmentinfo.origin, alignmentinfo.angles );
        #/
        ...
        /#
            function_ce4b6d4d859ede39( var_214d924f4e137244, "<dev string:x133>" + animasset, alignmentinfo.origin, alignmentinfo.angles );
        #/
    }
    else if ( animationtype == "MayhemAnimation" )
    {
        ...
        /#
            function_ce4b6d4d859ede39( var_214d924f4e137244, "<dev string:x13e>" + animasset, alignmentinfo.origin, alignmentinfo.angles );
        #/
        ...
        /#
            function_ce4b6d4d859ede39( var_214d924f4e137244, "<dev string:x14b>" + animasset, alignmentinfo.origin, alignmentinfo.angles );
        #/
    }
...
function private function_532562ce2e63032f( alignmentinfo, shotindex )
{
    ...
    if ( shotanimations.size != 0 )
    {
        var_214d924f4e137244 function_d0ffa1bea912444d( var_214d924f4e137244.sceneplay.shotinit, "mayhem", alignmentinfo, shotanimations[ 0 ], 0, 0, 0, "MayhemAnimation" );
...
function private function_bae0f68830d519ad( valgroup, player, animasset, var_866b3a3066122e39, notifystring, alignmentinfo, shotindex )
{
    ...
    if ( animasset != "" )
    {
        ...
        {
            player function_cebd47970f60e9b( animasset, 0, alignmentinfo.alignent, default_to( alignmentinfo.aligntag, "" ), starttime, 1, var_be9e9d8d5ea874f9, var_a9eb89bfa3d96107, thirdpersonplayer );
        }
        else
        {
