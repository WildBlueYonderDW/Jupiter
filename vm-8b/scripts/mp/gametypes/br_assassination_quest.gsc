...
function function_2529487ea7a39317() {
    ...
    function_6a5270845ce88f1e(self.hunterteam, "br_assassination_quest_start_hunter_team", params);
    if (isdefined(self.var_d154ac2657c5f44)) {
        function_70eb08dc68820a5a(self.var_d154ac2657c5f44, "br_assassination_quest_start_tablet_finder", params);
...
function function_7b16ac880855a705() {
    ...
    if (isdefined(self.targetplayer.lastkilledby) && isplayer(self.targetplayer.lastkilledby) && isdefined(self.targetplayer.lastkilledby.team) && self.targetplayer.lastkilledby.team == self.teams[0]) {
        ...
        function_6a5270845ce88f1e(self.targetteam, "br_" + questmodifier + "assassination_target_killed_target_team");
    ...
    params = spawnstruct();
    rewards = function_6ddd1eecbe562acf(rewardgroup, self.hunterteam, self.var_d154ac2657c5f44, self);
    if (isdefined(rewards) && isdefined(rewards["plunder"])) {
        params.intvar = int(rewards["plunder"]);
        function_cba960b48c4b1e3c(splash, function_3d262d56274bd22e(questmodifier + "assassination"), rewards["plunder"], self.hunterteam);
    }
    if (getdvarint(@"hash_827f1bf2224b0d61", 0) == 1) {
        self.var_d154ac2657c5f44 function_496ed653faacacd2(self.hunterteam);
    }
    if (!scripts\mp\gametypes\br_public::function_d6ae35e0ce14bbaf()) {
        if (!istrue(level.var_7e12f6eb4fcb4ea1.var_2ef19bc785de8e88)) {
...
function function_654d23cd5c127447(targetteam) {
    if (scripts\mp\gametypes\br_publicevents::ispubliceventoftypeactive(%"hash_66e797f53ce5bafb")) {
        if (isdefined(level.var_c8b9f26dcad07806) && isdefined(level.var_c8b9f26dcad07806.var_a96c1e1bb32b7f6e)) {
