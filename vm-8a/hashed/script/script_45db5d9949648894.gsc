...
/#
    ...
    function function_a9bcc765070d0b08() {
        ...
        function_a9a864379a098ad6("<dev string:x2d>", "<dev string:x42>", &function_f104d7887d46f98e, 1);
    ...
    function private function_f104d7887d46f98e() {
        zombies = getaispeciesarray("<dev string:x57>", "<dev string:x5c>");
        ...
        while (true) {
            ...
            if (!closest_zombie function_550c2a40a7f8e322()) {
                ...
                closest_zombie notify("<dev string:x60>");
            }
            waitframe();
        }
    }
