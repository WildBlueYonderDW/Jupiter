...
function function_54b1b98949d747f() {
    ...
    if (flag("flag_player_disarmed_neighbor")) {
        ...
        var_2669395d52d6cbe7 = getent("takedown_npc_1", "target");
        npc2 = getent("takedown_npc_2", "target");
        var_26693b5d52d6d04d = getent("takedown_npc_3", "target");
        var_2669345d52d6c0e8 = getent("takedown_npc_4", "target");
        var_2669355d52d6c31b = getent("takedown_npc_5", "target");
        thread function_587b8e0d4e4090f4(var_2669395d52d6cbe7, animnode, "jup_hij_0150_disarm_from_enemy_01_civ01");
        thread function_587b8e0d4e4090f4(npc2, animnode, "jup_hij_0150_disarm_from_enemy_01_civ02");
        thread function_587b8e0d4e4090f4(var_26693b5d52d6d04d, animnode, "jup_hij_0150_disarm_from_enemy_01_civ03");
        thread function_587b8e0d4e4090f4(var_2669345d52d6c0e8, animnode, "jup_hij_0150_disarm_from_enemy_01_civ04");
        thread function_587b8e0d4e4090f4(var_2669355d52d6c31b, animnode, "jup_hij_0150_disarm_from_enemy_01_civ05");
...
function function_b2ed98f0b1f7a6f9() {
    ...
    thread namespace_2f067fefb7259496::function_1ce7339df27e2d49();
