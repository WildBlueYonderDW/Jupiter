...
function private function_d3323396f592c0ea() {
    ...
    level.var_4a77e3d00962be2.var_db362b4f739b7928.var_5f59cdfbf4669cc3 = getdvarint(@"hash_521bf4fafecb1dca", 60);
    level.var_4a77e3d00962be2.var_db362b4f739b7928.var_73e374ce21fb4fb5 = getdvarint(@"hash_88b474bd6434b0a1", 200);
    level.var_4a77e3d00962be2.var_db362b4f739b7928.var_64ab0a075a4d97e4 = getdvarfloat(@"hash_b62baf4cdccb0ac4", 500);
    level.var_4a77e3d00962be2.var_db362b4f739b7928.var_f9b853a2bbd2f0d8 = getdvarfloat(@"hash_d4bce7a24c7fce3", 0.03);
...
function private function_390bae294ff550a6(grenade) {
    ...
    beacon namespace_b6b4a3ac458ab6e2::function_172d848d58051fdf(&function_9d6c964e1422e8d1);
...
function private function_359418189c5933ae(beacon, var_c1ae356f3991b37, var_7ca34bfe0bc687c0) {
    var_57ad1dc40b3000d = function_e3ed19e8256d0323(beacon, var_c1ae356f3991b37);
    sphereradius = var_57ad1dc40b3000d[2];
    var_dba39463727fdc54 = var_57ad1dc40b3000d[1];
    var_e139d2bb0710565d = var_57ad1dc40b3000d[0];
...
function private function_e3ed19e8256d0323(beacon, var_c1ae356f3991b37) {
    ...
    return [var_e139d2bb0710565d, var_dba39463727fdc54, sphereradius];
}
...
function private function_f1cd2c473addb49(ownerplayer, var_d1c48e73f2053374) {
    ...
    return var_d1c48e73f2053374 + (var_2c8030191210ba2c[0] * -500, var_2c8030191210ba2c[1] * -500, 2800);
}
...
function private function_53af621b4742ea1a(beacon, var_88986f82b7321745, var_9879c458a14bced3) {
    ...
    var_d4362557f18b407.var_9879c458a14bced3 = var_9879c458a14bced3;
...
function private function_a98c5a0487bcd428() {
    var_d4362557f18b407 = self;
    assert(isdefined(level.var_4a77e3d00962be2.var_477de27131738e4c[var_d4362557f18b407.var_9879c458a14bced3]), "<dev string:x59>");
    var_5aa1c7cf87120965 = var_d4362557f18b407.var_7a6430ba88c4d983;
    var_c8ae7ccab7d5cc90 = var_5aa1c7cf87120965 + level.var_4a77e3d00962be2.var_6395f1ed044d892d[var_d4362557f18b407.var_9879c458a14bced3];
    var_d4362557f18b407.brushmodel = spawn("script_model", var_c8ae7ccab7d5cc90);
    var_d4362557f18b407.brushmodel clonebrushmodeltoscriptmodel(level.var_4a77e3d00962be2.var_477de27131738e4c[var_d4362557f18b407.var_9879c458a14bced3]);
}
...
/#
    ...
    function private function_391adac64d5fa47(player, beacon, var_e43451c4c85f5b88) {
        ...
        while (true) {
            wait waittime;
            var_1a1dab914d027dd = getdvarint(@"hash_e0b5816cbcf9bbd1", 0) == 1;
            if (!var_1a1dab914d027dd) {
                continue;
            }
