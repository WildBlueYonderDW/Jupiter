...
#namespace namespace_107fd938b396338e;

// Namespace namespace_107fd938b396338e/namespace_539894a454fad0d1
// Params 0, eflags: 0x1
        ...
        if (isdefined(self) && isdefined(self.subclass)) {
            ...
            if (var_c70099220a5c67ee > 0) {
                ...
                case #"hash_f297af39454fdc7b":
                    if (var_c70099220a5c67ee >= 1 && function_51d76700600cebe3(getdvarint(@"hash_6dea1d89fd168935", 75))) {
                        thread function_cfe3570e67097cbb(spawn_location);
                    }
                    break;
                case #"hash_99a38be9e88b5244":
                    if (var_c70099220a5c67ee >= 1 && function_51d76700600cebe3(getdvarint(@"hash_652b35661fa52935", 100))) {
                        thread function_54ecfd55ae0b248e(spawn_location, self.subclass);
                    }
                    break;
                case #"hash_99d5ac2f7a4d8083":
                    if (var_c70099220a5c67ee >= 2 && function_51d76700600cebe3(getdvarint(@"hash_e1878b1f5eae27dd", 100))) {
                        thread function_54ecfd55ae0b248e(spawn_location, self.subclass);
                    }
                    break;
                case #"hash_59740dd906312a95":
                case #"hash_c1fa8721b046b258":
                    if (var_c70099220a5c67ee >= 3 && function_51d76700600cebe3(getdvarint(@"hash_1947619f873ba823", 100))) {
                        thread function_54ecfd55ae0b248e(spawn_location, self.subclass);
                    }
                    break;
                default:
...
// Size: 0x52
function function_cfe3570e67097cbb(spawn_location) {
...
// Size: 0xd2
function function_54ecfd55ae0b248e(spawn_location, var_73a0f3ed96803f36) {
...
function function_42322dcd60709cc3(player) {
    ...
    if (!isdefined(player.var_74ac8f1bfad7368b)) {
        player.var_74ac8f1bfad7368b = 0;
    }
    player.var_74ac8f1bfad7368b++;
    player namespace_aad14af462a74d08::function_8359cadd253f9604(player, "event_the_hunt_bones", level.var_e6d635dd9b7f73b3);
...
function function_5ef509a71c51c2a0(player) {
    ...
    case #"hash_99a38be9e88b5244":
        foreach (member in squad) {
            ...
            member namespace_aad14af462a74d08::function_8359cadd253f9604(member, "event_the_hunt_skulls_armored", level.var_eb9d721411a7178a);
    ...
    case #"hash_99d5ac2f7a4d8083":
        foreach (member in squad) {
            ...
            member namespace_aad14af462a74d08::function_8359cadd253f9604(member, "event_the_hunt_skulls_hellhound", level.var_2862a46691940273);
    ...
    case #"hash_c1fa8721b046b258":
        foreach (member in squad) {
            ...
            member namespace_aad14af462a74d08::function_8359cadd253f9604(member, "event_the_hunt_skulls_mimic", level.var_2a0c9dcc6a722a85);
...
function function_b216b39d9ea94e4a(drop_amount) {
    ...
    self.var_71466585b9fe6080 = self.var_71466585b9fe6080 + drop_amount;
...
function function_cadce08fab348041(drop_amount) {
    ...
    self.var_4096aeb7caafc01f = self.var_4096aeb7caafc01f + drop_amount;
