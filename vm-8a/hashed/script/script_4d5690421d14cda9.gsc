...
function private function_403d98066db9adbd() {
    ...
    while (isalive(self) && isalive(target_ent) && !istrue(target_ent.inlaststand)) {
        ...
        if (n_frames == 10) {
            ...
            var_bda5255252a8e4b6 += self.var_a39609c30eeab15b * 0.9;
            self.var_a39609c30eeab15b = 0;
...
/#
    ...
    function private function_4aa1128bb0cf132() {
        ...
        function_a9a864379a098ad6("<dev string:x36>", "<dev string:x47>", &function_2e23970d7f46208a);
        function_a9a864379a098ad6("<dev string:x58>", "<dev string:x69>", &function_dc591bebf0dce66d);
    ...
    function private function_2e23970d7f46208a() {
        disciple = function_6d1fbda4b8524ef2(level.players[0].origin, undefined, "<dev string:x7a>");
        if (isdefined(disciple)) {
            disciple function_3e89eb3d8e3f1811("<dev string:x8a>", 1);
        }
    }
    ...
    function private function_dc591bebf0dce66d() {
        function_2fb888667001fc39("<dev string:x98>", @"hash_5ea28fb57e748699");
    }
    ...
    function private function_ea2d00bafd61346e(text, pos) {
        if (getdvarint(@"hash_5ea28fb57e748699", 0)) {
            ...
            print3d(pos, "<dev string:xb2>" + text, (1, 0, 0));
        }
    }
