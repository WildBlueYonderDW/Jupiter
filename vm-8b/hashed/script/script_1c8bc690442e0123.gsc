...
function function_49cab10caac7c6cd() {
    /#
        thread function_326cc1213268415a("<dev string:x1c>", 3);
    #/
    ...
    /#
        thread function_326cc1213268415a("<dev string:x2f>", 3);
    #/
}
...
function walkstep() {
    /#
        thread function_326cc1213268415a("<dev string:x4d>", 3);
    #/
    ...
    /#
        thread function_326cc1213268415a("<dev string:x55>", 3);
    #/
}
...
function function_b5799765f0103e33() {
    /#
        thread function_326cc1213268415a("<dev string:x6c>", 3);
    #/
    ...
    /#
        thread function_326cc1213268415a("<dev string:x88>", 3);
    #/
}
...
function function_91b5b282cb2b18fc(positionid) {
    /#
        thread function_326cc1213268415a("<dev string:xa8>", 3);
    #/
    ...
    /#
        thread function_326cc1213268415a("<dev string:xbc>", 3);
    #/
}
...
function function_931dc024b9a4425d() {
    /#
        thread function_326cc1213268415a("<dev string:xdf>", 3);
    #/
    ...
    /#
        thread function_326cc1213268415a("<dev string:xf5>", 3);
    #/
}
...
function function_6c00d659b72888bf() {
    ...
    /#
        thread function_326cc1213268415a("<dev string:x116>", 3);
    #/
}
...
function function_4b422fdc1b596ef9() {
    /#
        thread function_326cc1213268415a("<dev string:x137>", 3);
    #/
    ...
    /#
        thread function_326cc1213268415a("<dev string:x14b>", 3);
    #/
}
...
function function_b6001ea887635de4(var_ded14ae1ea8c4446) {
    /#
        thread function_326cc1213268415a("<dev string:x16a>", 3);
    #/
    ...
    /#
        thread function_326cc1213268415a("<dev string:x17d>", 3);
    #/
}
...
function reloadstep() {
    /#
        thread function_326cc1213268415a("<dev string:x18e>", 3);
    #/
    ...
    /#
        thread function_326cc1213268415a("<dev string:x19f>", 3);
    #/
}
...
function function_8ab6a96b2278d5cf() {
    /#
        thread function_326cc1213268415a("<dev string:x1b2>", 3);
    #/
    ...
    /#
        thread function_326cc1213268415a("<dev string:x1bf>", 3);
    #/
}
...
function function_ed36379da3790cba() {
    /#
        thread function_326cc1213268415a("<dev string:x1da>", 3);
    #/
    ...
    /#
        thread function_326cc1213268415a("<dev string:x1f9>", 3);
    #/
}
...
function killwithads(var_ded14ae1ea8c4446) {
    /#
        thread function_326cc1213268415a("<dev string:x209>", 3);
    #/
    ...
    /#
        thread function_326cc1213268415a("<dev string:x25a>", 3);
    #/
}
...
function function_7931a9f93d82dd27() {
    /#
        thread function_326cc1213268415a("<dev string:x274>", 3);
    #/
    ...
    /#
        thread function_326cc1213268415a("<dev string:x28d>", 3);
    #/
}
...
function combatstep(var_ded14ae1ea8c4446) {
    /#
        thread function_326cc1213268415a("<dev string:x2a2>", 3);
    #/
    ...
    /#
        thread function_326cc1213268415a("<dev string:x2b2>", 3);
    #/
}
...
function function_ab5ab2886323a8a5() {
    /#
        thread function_326cc1213268415a("<dev string:x2cb>", 20);
    #/
    if (isdefined(level.allybot)) {
    ...
    if (isdefined(stepdata.function) && function_a791a878e9049670(stepdata.id)) {
        /#
            if (isdefined(stepdata.isoverride) && stepdata.isoverride) {
                thread function_326cc1213268415a("<dev string:x2e5>" + stepdata.id + "<dev string:x2f5>", 1, 10, 120);
            } else {
                thread function_326cc1213268415a("<dev string:x2e5>" + stepdata.id, 1, 10, 120);
            }
        #/
