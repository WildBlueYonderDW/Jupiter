...
function getprematchlocationspawnorigins() {
    ...
    /#
        if (!spawnlocations.size && getdvar(@"hash_344ec7639d9d44", "<dev string:x6f>") != "<dev string:x6f>") {
...
function givebrbonusxp(brbonusxp, objweapon, reason, var_b01aca3236595958) {
    ...
    /#
        if (isdefined(var_b01aca3236595958)) {
            logstring("<dev string:x70>" + var_b01aca3236595958);
        }
    #/
    suppresspopup = 0;
    if (!isdefined(reason)) {
...
function function_15fa5f9b3a2b7a52() {
    assertex(!istrue(level.var_9d0412c6ba5a4084), "<dev string:x123>");
