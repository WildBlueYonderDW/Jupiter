...
function function_bf040858853b69df(zoneindex) {
    ...
    if (isdefined(mainbounds) && isdefined(mainbounds.midpoint)) {
        debugstring = debugstring + "[MainBoundsMidpoint:" + mainbounds.midpoint + "]";
    }
    return debugstring;
}
...
function function_b1ea22d278623807(var_2b465f51da1e8fcf, var_2b465e51da1e8d9c, tabletitle, var_cd8110645a9a2632, var_871bdbc7e5abb341, textcolor, textscale, var_594f5bfc88a91bd3) {
    ...
    foreach (row in tabledata) {
        ...
        foreach (column in row) {
            ...
            #/
            var_d14d9c622b832290 = var_d14d9c622b832290 + (column.size + columnspacing) * var_1d5dc6edc3ab5ad7;
        }
        tablewidth = var_d14d9c622b832290;
        tableheight = tableheight + var_be90131b8f3ba968;
    }
...
function private function_fb61b372bc6cca0f() {
    /#
        ...
        header = ["<unknown string>", "<unknown string>", "<unknown string>", "<unknown string>"];
        tabledata = [[], ["<unknown string>", 2, 3.5, undefined], [1, 2, 3, 4, 5]];
        actualoutput = function_83c890a0c71ae6b8(title, header, tabledata);
        var_567a66b58f939a3c = [["<unknown string>"], ["<unknown string>", "<unknown string>", "<unknown string>", "<unknown string>"], ["<unknown string>", "<unknown string>", "<unknown string>", "<unknown string>"], ["<unknown string>", "<unknown string>", "<unknown string>", "<unknown string>"], ["<unknown string>", "<unknown string>", "<unknown string>", "<unknown string>"]];
...
function private function_4641ac23689d9d78() {
    /#
        asserteq(formatstring("<unknown string>"), "<unknown string>");
        asserteq(formatstring("<unknown string>"), "<unknown string>");
        asserteq(formatstring("<unknown string>"), "<unknown string>");
        asserteq(formatstring("<unknown string>"), "<unknown string>");
        asserteq(formatstring("<unknown string>", 1), "<unknown string>");
        asserteq(formatstring("<unknown string>", 1.5), "<unknown string>");
        asserteq(formatstring("<unknown string>", "<unknown string>"), "<unknown string>");
        asserteq(formatstring("<unknown string>", undefined), "<unknown string>");
        asserteq(formatstring("<unknown string>", 1), "<unknown string>");
        asserteq(formatstring("<unknown string>", 1), "<unknown string>");
        asserteq(formatstring("<unknown string>", 1), "<unknown string>");
        asserteq(formatstring("<unknown string>", 1, 2), "<unknown string>");
        asserteq(formatstring("<unknown string>", 1), "<unknown string>");
        asserteq(formatstring("<unknown string>", 1, 2), "<unknown string>");
        asserteq(formatstring("<unknown string>", 1, 2), "<unknown string>");
        asserteq(formatstring("<unknown string>", 1, 2), "<unknown string>");
        asserteq(formatstring("<unknown string>", 1, 2), "<unknown string>");
        asserteq(formatstring("<unknown string>", 1, 2, 3, 4, 5, 6, 7, 8), "<unknown string>");
        asserteq(formatstring("<unknown string>"), "<unknown string>");
        asserteq(formatstring("<unknown string>", 1, 2), "<unknown string>");
        asserteq(formatstring("<unknown string>", 1, 2, 3, 4, 5, 6), "<unknown string>");
    #/
}
