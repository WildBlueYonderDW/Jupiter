...
function function_8861fae4db7f9c2() {
    /#
        ...
        fallbacks = spawnlogic::getteamfallbackspawnpoints("attackers");
        ...
        while (true) {
            ...
            while (true) {
                ...
                endpoints = [];
                endpoints[1] = [level.objectives["OBJECTIVES/CONTROL_SCORE"]];
                endpoints[2] = [level.objectives["auto_change"]];
                endpoints[4] = [level.objectives["switchedsides"]];
                endpoints[8] = [level.objectives["kill"]];
                endpoints[16] = [level.objectives["Crit_Default"]];
                endpoints[32] = [level.objectives["OBJECTIVES/CONTROL_SCORE"], level.objectives["auto_change"]];
                endpoints[64] = [level.objectives["switchedsides"], level.objectives["auto_change"]];
                endpoints[128] = [level.objectives["OBJECTIVES/CONTROL_SCORE"], level.objectives["switchedsides"]];
                foreach (spawnpoint in spawnpoints) {
                ...
                foreach (flaglocation in level.objectives) {
                    if (flaglocation == level.bestspawnflag["Default"]) {
                        print3d(flaglocation.trigger.origin + heightoffsetnames, "defender");
                    }
                    if (flaglocation == level.bestspawnflag["attackers"]) {
                        print3d(flaglocation.trigger.origin + heightoffsetnames, "icon_medium");
                    }
                }
                waitframe();
            }
    ...
    /#
        ...
        while (true) {
            if (getdvarint(@"hash_46a6b424af6acbc2") != 0) {
                scripts/mp/gamescore::giveteamscoreforobjective("Default", getdvarint(@"hash_46a6b424af6acbc2"), 1);
                break;
            } else if (getdvarint(@"hash_86e14326e43c0115") != 0) {
                scripts/mp/gamescore::giveteamscoreforobjective("attackers", getdvarint(@"hash_86e14326e43c0115"), 1);
                break;
            }
            wait(1);
        }
    ...
    /#
        ...
        while (true) {
            if (getdvar(@"hash_29d45d6822a1cf6d", "6v6") != "6v6") {
                flaglabel = getdvar(@"hash_29d45d6822a1cf6d", "6v6");
                zone = spawnstruct();
                ...
                domflag = scripts/mp/gameobjects::createuseobject("mp_jup_control_win_section", zone.trigger, zone.visuals, (0, 0, 100));
                domflag scripts/mp/gameobjects::allowuse("<unknown string>");
                ...
                domflag scripts/mp/gameobjects::setvisibleteam("<unknown string>");
