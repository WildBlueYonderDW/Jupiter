...
function getquestrewardstablevalue(rewardref, team) {
    ...
    if (isdefined(level.contractmanager.var_b6fae9c9655c73bf[team]) && istrue(level.contractmanager.var_b6fae9c9655c73bf[team].var_7531d578f772b7a0) && !isstring(value)) {
