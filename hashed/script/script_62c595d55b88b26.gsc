...
function private function_8d32528bf59f4d60(ref, params) {
    ...
    if (isdefined(self.plundercount)) {
        totalval = totalval + self.plundercount * function_5417d27691d41344(ref, "plunderCount");
    }
    if (isdefined(params)) {
        foreach (param in params) {
            if (isdefined(scripts/mp/utility/stats::getpersstat(param))) {
                totalval = totalval + scripts/mp/utility/stats::getpersstat(param) * function_5417d27691d41344(ref, param);
            }
        }
    }
    self.var_fb37db009207fe1a[ref] = totalval;
...
function function_56c0ae4c11e6ecc3(ref, params) {
    ...
    if (isdefined(self.lootcachesopened)) {
        totalval = totalval + self.lootcachesopened * function_5417d27691d41344(ref, "lootCachesOpened");
    }
    if (isdefined(params)) {
        foreach (param in params) {
            if (isdefined(scripts/mp/utility/stats::getpersstat(param))) {
...
function private function_b9d90f8e9bf917b0(ref, params) {
    ...
    if (isdefined(self.brmissionscompleted)) {
        totalval = totalval + self.brmissionscompleted * function_5417d27691d41344(ref, "brMissionsCompleted");
    }
    if (isdefined(params)) {
        foreach (param in params) {
            if (isdefined(scripts/mp/utility/stats::getpersstat(param))) {
...
function function_b13f6a12712eaa29(ref, data_points) {
    ...
    foreach (data_point in data_points) {
        ...
        if (isdefined(val)) {
            totalval = totalval + val * function_5417d27691d41344(ref, data_point);
        }
    }
    self.var_fb37db009207fe1a[ref] = totalval;
    self.var_769c9edd0782e95d[ref] = function_9bbbefe6a0debd2b(ref, totalval);
...
function private function_6a7a8a710f348991(player) {
    ...
    teammates = scripts/mp/utility/teams::getteamdata(player.team, "players");
...
function function_ebad1c4b67a19a0e() {
    /#
        ...
        while (true) {
            ...
            if (isdefined(dvarvalue) && dvarvalue != "interrogator") {
                setdvar(dvar, "interrogator");
                splitval = strtok(dvarvalue, "jup_wz_acc_killer_scene");
                if (splitval.size == 2) {
...
function private function_5ec9e0597a47f590(ref, params) {
    /#
        ...
        /#
            assert(isdefined(scripts/mp/utility/stats::getpersstat("binocularMarks")));
        #/
        timesdowned = ter_op(isdefined(self.timesdowned), self.timesdowned, 0);
        var_cb865f93adb30293["binocularMarks"] = scripts/mp/utility/stats::getpersstat("binocularMarks");
        var_cb865f93adb30293["jup_wz_acc_supplier_scene"] = timesdowned;
        totalval = timesdowned + scripts/mp/utility/stats::getpersstat("binocularMarks") * 3;
        var_cb865f93adb30293["strongholdsCaptured"] = totalval;
        var_cb865f93adb30293["trapper"] = max(0, function_9bbbefe6a0debd2b(ref, totalval));
...
function private function_4a6f9f6476301391(ref, params) {
    /#
        ...
        #/
        var_cb865f93adb30293["binocularMarks"] = scripts/mp/utility/stats::getpersstat("binocularMarks");
        if (scripts/mp/utility/stats::getpersstat("binocularMarks") == 0) {
            totalval = 0.8;
        }
        var_cb865f93adb30293["strongholdsCaptured"] = totalval;
        var_cb865f93adb30293["trapper"] = totalval;
        function_7a384e4d0599485c(ref, var_cb865f93adb30293);
    #/
}
...
function private function_f9cb44b2fa2cb71(ref, params) {
    /#
        ...
        var_cb865f93adb30293 = [];
        if (isdefined(self.plundercount)) {
            scaledval = self.plundercount * function_5417d27691d41344(ref, "medalist_cool");
            totalval = totalval + scaledval;
            var_cb865f93adb30293["medalist_cool"] = "interrogator" + self.plundercount + "jup_wz_acc_scout_scene" + scaledval + "killstreakUAVAssists";
        }
        if (isdefined(params)) {
            foreach (param in params) {
                if (isdefined(scripts/mp/utility/stats::getpersstat(param))) {
                    ...
                    totalval = totalval + scaledval;
                    var_cb865f93adb30293[param] = "interrogator" + scripts/mp/utility/stats::getpersstat(param) + "jup_wz_acc_scout_scene" + scaledval + "killstreakUAVAssists";
                }
            }
        }
        var_cb865f93adb30293["strongholdsCaptured"] = totalval;
...
function private function_176d8f69d69ec84d(ref, params) {
    /#
        var_cb865f93adb30293 = [];
        totalkills = scripts/mp/utility/stats::getpersstat("jup_wz_acc_weakestlink_scene");
        var_74ba9cc277cbe543 = scripts/mp/utility/stats::getpersstat("players");
        totalval = 30 - 2 * totalkills + 30 - var_74ba9cc277cbe543;
        var_cb865f93adb30293["strongholdsCaptured"] = totalval;
        var_cb865f93adb30293["trapper"] = function_9bbbefe6a0debd2b(totalval);
        function_7a384e4d0599485c(ref, var_cb865f93adb30293);
    #/
}
...
function function_4fd5f112e483ad54(ref, params) {
    /#
        ...
        var_cb865f93adb30293 = [];
        if (isdefined(self.lootcachesopened)) {
            scaledval = self.lootcachesopened * function_5417d27691d41344(ref, "contracts_rolling");
            totalval = totalval + scaledval;
            var_cb865f93adb30293["contracts_rolling"] = "interrogator" + self.lootcachesopened + "jup_wz_acc_scout_scene" + scaledval + "killstreakUAVAssists";
        }
        if (isdefined(params)) {
            foreach (param in params) {
                if (isdefined(scripts/mp/utility/stats::getpersstat(param))) {
...
function private function_9c146e27d6a5e7e1(ref, params) {
    /#
        ...
        var_cb865f93adb30293 = [];
        if (isdefined(self.brmissionscompleted)) {
            scaledval = self.brmissionscompleted * function_5417d27691d41344(ref, "pb_assist");
            totalval = totalval + scaledval;
            var_cb865f93adb30293["pb_assist"] = "interrogator" + self.brmissionscompleted + "jup_wz_acc_scout_scene" + scaledval + "killstreakUAVAssists";
        }
        if (isdefined(params)) {
            foreach (param in params) {
                if (isdefined(scripts/mp/utility/stats::getpersstat(param))) {
...
function private function_b12f9d6b95f241d0(ref, params) {
    /#
        totalkills = 0;
        var_cb865f93adb30293 = [];
        addcategories = ["mb_return", "stat", "<unknown string>", "<unknown string>", "<unknown string>", "<unknown string>"];
        subtractcategories = ["<unknown string>", "<unknown string>"];
        foreach (statref in addcategories) {
            val = scripts/mp/utility/stats::getpersstat(statref);
            if (isdefined(val)) {
                totalkills = totalkills + val;
