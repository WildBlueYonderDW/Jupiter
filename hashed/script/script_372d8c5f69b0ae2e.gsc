...
function private function_631805963060a8e4() {
    ...
    /#
        if (getdvarint(@"hash_e9e247c60cd8800a") && isdefined(victim) && utility::issp()) {
            victimeye = victim gettagorigin("melee");
            ...
            debug_print3d(victimeye, "front" + abs(dot), (1, 1, 1), 1, 0.05, 1);
            debug_line(victimeye, victimeye + anglestoright(victim gettagangles("melee")) * 60, (1, 1, 1), 1, 0, 1);
    ...
    if (var_5abf35eba9e29a41.size > 0) {
        ...
        /#
            for (i = 0; i < var_fabf3a6fdd01a7b2.size; i++) {
                debug_print3d(victim.origin, "scripted_melee" + var_fabf3a6fdd01a7b2[i].script_key, (0, 1, 0), 1, 0.1, 1, "scripted_melee_anim_ended_longest" + i + 2);
            }
        #/
...
function private function_4122323699a9de19() {
    level endon("scripted_melee_stop");
    while (true) {
        victim, victim_parent, victim_origin, var_51e0b68e2cd1ede6, origin_offset, angles_offset, animScene = self waittill("animscripted_predicted_entry");
...
function private function_497214b31d3bc138(attacker, animScene) {
    ...
    if (isdefined(self) || isalive(self)) {
        ...
        /#
            if (getdvarint(@"hash_e9e247c60cd8800a")) {
                collision_info = attacker getcollision("longest melee anim finished");
...
function private function_8cff6477a8994cc0(meleeweapon, startStance, endStance) {
    ...
    /#
        if (getdvarint(@"hash_e9e247c60cd8800a")) {
            collision_info = self getcollision("longest melee anim finished");
