...
#namespace jup_ob_schematic_soldier_buddy_7;

// Namespace jup_ob_schematic_soldier_buddy_7 / namespace_e8bb637e7ce6b98f
// Params 0, eflags: 0x0
// Checksum 0x0, Offset: 0x280
// Size: 0x1c9
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_ob_schematic_soldier_buddy_7" );
    self.var_534e788bc498be9f = getscriptbundle( %"hash_57d801ea117bc8a4" );
...
function precache()
{
    agent_type = "actor_jup_ob_schematic_soldier_buddy_7";
    ...
    if ( !isdefined( level.agent_definition[ agent_type ] ) )
    {
        ...
        level.agent_definition[ agent_type ][ "subclass" ] = getscriptbundle( %"hash_57d801ea117bc8a4" );
