...
function function_afd0248aff5dc21(powerstruct, powerref) {
    ...
    var_6bfc753f335a482d = magicgrenademanual("jup_mutant_sludge_ball", fireorigin, velocity * forward);
    var_6bfc723f335a4194 = magicgrenademanual("jup_mutant_sludge_ball", fireorigin - 8 * right, velocity * var_4f8bb17d0fad6744);
    var_6bfc733f335a43c7 = magicgrenademanual("jup_mutant_sludge_ball", fireorigin + 8 * right, velocity * var_4f8bb27d0fad6977);
    array_thread([var_6bfc753f335a482d, var_6bfc723f335a4194, var_6bfc733f335a43c7], &function_e1c46f218ae01158, zombie);
    zombie thread function_2d4d1e5adf4110f5(var_6bfc753f335a482d, var_6bfc723f335a4194, var_6bfc733f335a43c7);
    var_5b23b1652cad3c0a = getdvarfloat(@"hash_ad5c1a6a44d0a85c", 10);
    cooldowntime = getdvarfloat(@"hash_5c585d5f44aacc5d", 10);
    wait var_5b23b1652cad3c0a;
    if (isdefined(powerstruct.powers[powerref].var_84f872ff989aaf52) && cooldowntime > var_5b23b1652cad3c0a) {
...
// Size: 0x155
function function_2d4d1e5adf4110f5(var_6bfc753f335a482d, var_6bfc723f335a4194, var_6bfc733f335a43c7) {
    self endon("disconnect");
    ...
    while (isdefined(var_6bfc753f335a482d) || isdefined(var_6bfc723f335a4194) || isdefined(var_6bfc733f335a43c7)) {
        ...
        foreach (enemy in alive_enemies) {
            ...
            if (isdefined(var_6bfc753f335a482d) && distance(var_6bfc753f335a482d.origin, origin) < 30) {
                ...
                var_6bfc753f335a482d detonate(self);
            }
            if (isdefined(var_6bfc723f335a4194) && distance(var_6bfc723f335a4194.origin, origin) < 30) {
                var_6bfc723f335a4194 notify("detonated");
                var_6bfc723f335a4194 detonate(self);
            }
