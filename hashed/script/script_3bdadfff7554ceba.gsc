...
function function_2366683817cdb090() {
    ...
    /#
        if (!level.onlinegame) {
            ...
            if (istrue(level.teambased)) {
                level.var_69def5c06e03559 = scripts/engine/utility::array_remove(level.var_69def5c06e03559, level.player.pers["<unknown string>"]);
                level.var_69def5c06e03559 = scripts/engine/utility::array_combine([level.player.pers["<unknown string>"]], level.var_69def5c06e03559);
            } else {
                level.var_69def5c06e03559 = ["<unknown string>", "<unknown string>"];
            }
        }
    #/
