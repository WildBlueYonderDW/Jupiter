...
function function_7dc98f165fe5f59d(player) {
    ...
    bomb.origin = bomb.origin + fwdoffset;
        ...
        if (namespace_9823ee6035594d67::function_ae011f52b2b15baf(safestruct.safelocation.origin, 0)) {
            ...
            if (!resetsuccessful) {
                /#
                    ...
                    level.contractmanager.var_b2c94adf9c0eb16 = level.contractmanager.var_b2c94adf9c0eb16 + 1;
                    println("elite_safecracker_loot" + level.contractmanager.var_b2c94adf9c0eb16);
                #/
...
function function_a11aea6569521300() {
    level endon("game_ended");
    wait(level.var_d8b853b40a83b85a.var_8fe0e04a07e07422 + level.contractmanager.var_1108707ce662e831);
...
function debug_init() {
    /#
        ...
        scripts/common/devgui::function_a9a864379a098ad6("<unknown string>", "<unknown string>", &function_105695786af8edd6);
