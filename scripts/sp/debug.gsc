...
/#
    ...
    function function_e066e339dfed70f3() {
        ...
        thread camera();
        setdvarifuninitialized(@"hash_92d5917e55acdb33", "<dev string:x2d>");
        if (getdvar(@"hash_92d5917e55acdb33") == "<dev string:x31>") {
            debug_corner();
        }
        thread debugdvars();
...
/#
    ...
    // Size: 0xf70
    function debugdvars() {
        setdvarifuninitialized(@"hash_4cf87963a7f9f6eb", "<dev string:x1c>");
        setdvarifuninitialized(@"hash_6c95956099ac3fc9", "<dev string:x165>");
        setdvarifuninitialized(@"hash_37d76fdaaaf3cdc2", 5000);
        setdvarifuninitialized(@"hash_2f6380dc3031a0fc", "<dev string:x165>");
        setdvarifuninitialized(@"hash_c7c097e45db2ecd3", 0);
        ...
        setdvarifuninitialized(@"hash_412920682e862f44", "<dev string:x172>");
        setdvarifuninitialized(@"hash_693e9933a3c8a920", "<dev string:x172>");
        setdvarifuninitialized(@"hash_1b1be305fcc4105c", "<dev string:x172>");
        ...
        setdvarifuninitialized(@"hash_feca256fb706dfcf", "<dev string:x2d>");
        ...
        setdvarifuninitialized(@"hash_28bc70041570ac17", "<dev string:x2d>");
        ...
        setdvarifuninitialized(@"hash_a30498031a934b2e", "<dev string:x165>");
        setdvarifuninitialized(@"hash_4589562a903db3e0", 1);
        for (i = 1; i <= level.animsound_hudlimit; i++) {
            setdvarifuninitialized(hashcat(@"hash_a30498031a934b2e", i), "<dev string:x165>");
        }
        setdvarifuninitialized(@"hash_e9355959302204a", "<dev string:x165>");
        setdvarifuninitialized(@"hash_efbe60582471bfcb", "<dev string:x165>");
        setdvarifuninitialized(@"hash_2b581a25764e207a", 0);
        setdvarifuninitialized(@"hash_d939f84ade697638", "<dev string:x1c>");
        ...
        for (;;) {
            ...
            if (getdvarint(@"hash_6c95956099ac3fc9")) {
                viewfx();
                setdvar(@"hash_6c95956099ac3fc9", "<dev string:x165>");
            }
            ...
            if (getdvarint(@"hash_4cf87963a7f9f6eb")) {
                chasecam(getdvarint(@"hash_4cf87963a7f9f6eb"));
            }
            ...
            if (getdvarint(@"hash_2b581a25764e207a")) {
                thread debug_colornodes();
            }
            if (getdvar(@"hash_1ff4a87138925423") == "<dev string:x31>") {
                thread debug_enemyposreplay();
            }
            if (getdvar(@"hash_a30498031a934b2e") != "<dev string:x165>") {
                thread debug_animsoundtagselected();
            }
            for (i = 1; i <= level.animsound_hudlimit; i++) {
                if (getdvar(hashcat(@"hash_a30498031a934b2e", i)) != "<dev string:x165>") {
                    thread debug_animsoundtag(i);
                }
            }
            if (getdvar(@"hash_28bc70041570ac17") != "<dev string:x2d>") {
                thread debug_nuke();
            }
            ...
            if (getdvarint(@"hash_412920682e862f44") != -1) {
                thread debug_enemypos(getdvarint(@"hash_412920682e862f44"));
                setdvar(@"hash_412920682e862f44", "<dev string:x172>");
            }
            if (getdvarint(@"hash_1b1be305fcc4105c") != -1) {
                thread debug_stopenemypos(getdvarint(@"hash_1b1be305fcc4105c"));
                setdvar(@"hash_1b1be305fcc4105c", "<dev string:x172>");
            }
            ...
            if (getdvar(@"hash_feca256fb706dfcf") == "<dev string:x31>") {
                if (!isdefined(level.tracestart)) {
                    thread showdebugtrace();
                }
                level.tracestart = level.player geteye();
                setdvar(@"hash_feca256fb706dfcf", "<dev string:x2d>");
            }
            debug_fxlighting();
    ...
    function debug_fxlighting() {
        if (getdvar(@"hash_d939f84ade697638") == "<dev string:x1e>" && level.debug_fxlighting != 1) {
            create_fxlighting_object();
            level.debug_fxlighting = 1;
            return;
        }
        if (getdvar(@"hash_d939f84ade697638") == "<dev string:x1c>" && level.debug_fxlighting != 0) {
    ...
    function debug_fxlighting_buttons() {
        ...
        while (getdvar(@"hash_d939f84ade697638") == "<dev string:x1e>" || getdvar(@"hash_d939f84ade697638") == "<dev string:x342>") {
...
function debug_character_count() {
    ...
    for (;;) {
        dvar = getdvar(@"hash_b3cfa089e4c57e2d");
        if (dvar == "off") {
...
/#
    ...
    // Size: 0x216
    function debug_nuke() {
        dvar = getdvar(@"hash_28bc70041570ac17");
        ...
        setdvar(@"hash_28bc70041570ac17", "<dev string:x2d>");
    }
...
function camera() {
    ...
    for (;;) {
        /#
            if (getdvar(@"hash_1e144937c5086a29") != "<dev string:x31>") {
                if (getdvar(@"hash_1e144937c5086a29") != "<dev string:x2d>") {
                    setdvar(@"hash_1e144937c5086a29", "<dev string:x2d>");
                }
                wait 1;
                continue;
            }
...
function updateminimapsetting() {
    ...
    if (!isdefined(level.minimapheight)) {
        setdvar(@"hash_7ce3fa1fabfd4530", "0");
...
/#
    ...
    function debug_animsoundtag(var_2cd7da4d7cca2fb5) {
        tag = getdvar(hashcat(@"hash_a30498031a934b2e", var_2cd7da4d7cca2fb5));
        if (tag == "<dev string:x165>") {
            iprintlnbold("<dev string:x404>");
            return;
        }
        tag_sound(tag, var_2cd7da4d7cca2fb5 - 1);
        setdvar(hashcat(@"hash_a30498031a934b2e", var_2cd7da4d7cca2fb5), "<dev string:x165>");
    }
    ...
    function debug_animsoundtagselected() {
        tag = getdvar(@"hash_a30498031a934b2e");
        if (tag == "<dev string:x165>") {
            iprintlnbold("<dev string:x42e>");
            return;
        }
        tag_sound(tag, level.var_bd911aed9062c5ed);
        setdvar(@"hash_a30498031a934b2e", "<dev string:x165>");
    }
...
/#
    ...
    function function_90f1dceaf8276e36() {
        setdvarifuninitialized(@"hash_9b149e8e74dd70e", "<dev string:x1c>");
        if (!getdvarint(@"hash_9b149e8e74dd70e")) {
            return;
        }
        ents = getentarray();
        list = [];
