...
// Namespace dmz_safes / namespace_abc7ed0cde8527d4
...
function function_d2441b457fa14419(node, forcedlootid) {
    ...
    /#
        namespace_d1a9ca87d78d9813::function_9533653868e59fb6("<dev string:x37>", "<dev string:x48>", undefined, "<dev string:x1c>", undefined, undefined, node.poi, node.origin);
    #/
    ...
    /#
        namespace_d1a9ca87d78d9813::function_9533653868e59fb6("<dev string:x54>", "<dev string:x48>", undefined, "<dev string:x61>", undefined, undefined, node.poi, node.origin);
    #/
