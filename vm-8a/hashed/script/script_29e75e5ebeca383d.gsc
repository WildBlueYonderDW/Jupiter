        ...
        if (namespace_9823ee6035594d67::function_ae011f52b2b15baf(safestruct.safelocation.origin, 0)) {
            ...
            if (!resetsuccessful) {
                /#
                    ...
                    println("<dev string:x41>" + level.contractmanager.var_b2c94adf9c0eb16);
                #/
...
/#
    ...
    function debug_init() {
        ...
        scripts\common\devgui::function_a9a864379a098ad6("<dev string:x90>", "<dev string:xa9>", &function_105695786af8edd6);
