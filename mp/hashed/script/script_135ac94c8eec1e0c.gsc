...
#namespace jup_enemy_mp_smg_tier2_pmc;

// Namespace jup_enemy_mp_smg_tier2_pmc / namespace_761dd031803ed834
// Params 0
// Checksum 0x0, Offset: 0x25f
// Size: 0x1e0
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_mp_smg_tier2_pmc" );
...
function precache()
{
    agent_type = "actor_jup_enemy_mp_smg_tier2_pmc";
