// file ddl_3f412e78a78b0d43

// bitSize: 0x2ab80, members: 17
struct root {
    ...
    int32 team3Score;
    // offset: 0x1a8, bitSize: 0x1f40(0x3e8B)
    byte scoreboards[1000];
    // offset: 0x20e8, bitSize: 0x20(0x4B)
    int32 maxPlayerCount;
    // offset: 0x2108, bitSize: 0x3840(0x708B)
    Death deaths[300];
    // offset: 0x5948, bitSize: 0x20(0x4B)
    int32 scoreProgressLimit;
    // offset: 0x5968, bitSize: 0x20(0x4B)
    int32 alliesDeaths;
    // offset: 0x5988, bitSize: 0x20(0x4B)
    float axisTTB;
    // offset: 0x59a8, bitSize: 0x251c0(0x4a38B)
    Player players[200];
    // offset: 0x2ab68, bitSize: 0x10(0x2B)
    short deathCount;
    // offset: 0x2ab78, bitSize: 0x1
    bit isPublicMatch;
    // offset: 0x2ab79, bitSize: 0x7
    pad __pad[7];
}
...
struct Player {
    ...
    short prestige;
    // offset: 0x160, bitSize: 0x8(0x1B)
    Factions faction;
    // offset: 0x168, bitSize: 0x10(0x2B)
    short assists;
    // offset: 0x178, bitSize: 0x170(0x2eB)
    char username[46];
    // offset: 0x2e8, bitSize: 0x8(0x1B)
    byte uniqueClientId;
    // offset: 0x2f0, bitSize: 0x1
    bit isBot;
    // offset: 0x2f1, bitSize: 0x1
    bit leaguePlayMatchCancelled;
    // offset: 0x2f2, bitSize: 0x6
    pad __pad[6];
}
