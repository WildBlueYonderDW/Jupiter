...
#namespace namespace_28d42f426c20a240;

// Namespace namespace_28d42f426c20a240 / scripts\cp\coop_stealth
// Params 0, eflags: 0x0
...
function regular_enemy_death_func() {
    ...
    var_cd977be97bc0fc1e leave_corpse_for_others_to_see();
    var_cd977be97bc0fc1e delete_stealth_meter(var_cd977be97bc0fc1e);
    var_cd977be97bc0fc1e delete_combat_icon(var_cd977be97bc0fc1e);
}
...
function leave_corpse_for_others_to_see() {
    ...
    if (!istrue(self.died_poorly)) {
        var_1d9b3a3fa1867eba = spawnstruct();
        var_1d9b3a3fa1867eba.loc = self.origin + (0, 0, 120);
        var_1d9b3a3fa1867eba.time_stamp = gettime();
        var_1d9b3a3fa1867eba.index = self getentitynumber() + randomint(100);
        level.enemy_ai_corpse_locations = scripts\engine\utility::array_add(level.enemy_ai_corpse_locations, var_1d9b3a3fa1867eba);
    }
}
...
// Size: 0xb9
function stealth_meter_sp_stealth_display_think(var_cd977be97bc0fc1e) {
    level endon("game_ended");
    level endon("weapons_free");
    var_cd977be97bc0fc1e endon("death");
    var_cd977be97bc0fc1e endon("enter_combat");
    var_cd977be97bc0fc1e endon("exit_stealth_think");
    var_cd977be97bc0fc1e notify("stealth_meter_sp_stealth_display_think");
    var_cd977be97bc0fc1e endon("stealth_meter_sp_stealth_display_think");
    while (true) {
        player = var_cd977be97bc0fc1e waittill("display_stealth_meter_to");
        /#
            function_a464c293616a3a6("<dev string:x1c>" + player.name);
        #/
        player thread ping_enemy_and_player_for_duration(var_cd977be97bc0fc1e, player, 1);
        /#
            if (function_e39a555170607456()) {
                thread scripts\cp_mp\utility\debug_utility::drawline(var_cd977be97bc0fc1e.origin, player.origin, 3, (1, 0, 0));
            }
        #/
    }
}
...
// Size: 0x6c
function ping_enemy_and_player_for_duration(var_cd977be97bc0fc1e, player, duration) {
    ...
    player.sightstate = player getaisightdirection(var_cd977be97bc0fc1e);
...
// Size: 0x6a
function mark_seen_this_player_this_frame(var_cd977be97bc0fc1e, player) {
    var_cd977be97bc0fc1e.player_most_recently_saw = player;
    player_id = player getentitynumber();
    if (!isdefined(var_cd977be97bc0fc1e.time_seeing_players)) {
        var_cd977be97bc0fc1e thread seeing_player_time_tracker(var_cd977be97bc0fc1e);
    }
    if (!isdefined(var_cd977be97bc0fc1e.time_seeing_players[player_id])) {
        var_cd977be97bc0fc1e.time_seeing_players[player_id] = 0;
    }
}
...
// Size: 0x201
function seeing_player_time_tracker(var_cd977be97bc0fc1e) {
    level endon("game_ended");
    level endon("weapons_free");
    var_cd977be97bc0fc1e notify("seeing_player_time_tracker");
    var_cd977be97bc0fc1e endon("seeing_player_time_tracker");
    var_cd977be97bc0fc1e endon("death");
    var_cd977be97bc0fc1e endon("long_death");
    var_cd977be97bc0fc1e endon("enter_combat");
    var_cd977be97bc0fc1e.player_most_recently_saw = undefined;
    var_cd977be97bc0fc1e.time_seeing_players = [];
    var_7670d6a914797e69 = 0;
    if (getdvarint(@"hash_91536e3e17dddc14", 0) != 0) {
        return;
    }
    while (true) {
        if (isdefined(var_cd977be97bc0fc1e.player_most_recently_saw)) {
            var_7670d6a914797e69 = 0;
        } else {
            var_7670d6a914797e69 += 0.1;
        }
        foreach (player_id, time in var_cd977be97bc0fc1e.time_seeing_players) {
            if (isdefined(var_cd977be97bc0fc1e.player_most_recently_saw) && player_id == var_cd977be97bc0fc1e.player_most_recently_saw getentitynumber()) {
                var_cd977be97bc0fc1e.time_seeing_players[player_id] = var_cd977be97bc0fc1e.time_seeing_players[player_id] + 0.1;
                var_cd977be97bc0fc1e.player_most_recently_saw = undefined;
                continue;
            }
            var_cd977be97bc0fc1e.time_seeing_players[player_id] = max(var_cd977be97bc0fc1e.time_seeing_players[player_id] - 0.05, 0);
        }
        foreach (player in level.players) {
            player_id = player getentitynumber();
            if (isdefined(var_cd977be97bc0fc1e.time_seeing_players[player_id]) && var_cd977be97bc0fc1e.time_seeing_players[player_id] == 0) {
                hide_stealth_meter_from(player, var_cd977be97bc0fc1e);
            }
        }
        if (var_7670d6a914797e69 >= 0.5) {
            stop_stealth_meter(var_cd977be97bc0fc1e);
        }
        wait 0.1;
    }
}
...
// Size: 0x2a
function stop_stealth_meter(var_cd977be97bc0fc1e) {
    var_cd977be97bc0fc1e.target_stealth_meter_progress = var_cd977be97bc0fc1e.current_stealth_meter_progress;
    var_cd977be97bc0fc1e notify("stop_stealth_meter");
}
...
// Size: 0x3da
function run_common_functions(var_cd977be97bc0fc1e, var_5001d8d3a6a01d08, var_b723fe98dd0f39f4, fov, var_d5ae73a7cc51f85a, var_f31ba637cec4081e, var_5438269deeb18825) {
    ...
    if (isdefined(level.var_2a7a0dd9628ab102)) {
        var_cd977be97bc0fc1e [[ level.var_2a7a0dd9628ab102 ]]();
    }
    var_34c6d56fa2022688 = 0;
    if (scripts\cp_mp\utility\game_utility::isnightmap()) {
        var_cd977be97bc0fc1e laseron();
    }
    if (isdefined(level.var_b20a836da84340b0) && isfunction(level.var_b20a836da84340b0)) {
        var_cd977be97bc0fc1e function_640ddd42cdc91a26();
        if ([[ level.var_b20a836da84340b0 ]](var_cd977be97bc0fc1e, var_cd977be97bc0fc1e.script_stealthgroup)) {
            var_cd977be97bc0fc1e scripts\asm\soldier\patrol::function_3aba5f22b60d37f5();
            if (var_cd977be97bc0fc1e should_run_sp_stealth()) {
                var_cd977be97bc0fc1e function_640ddd42cdc91a26();
                var_cd977be97bc0fc1e thread scripts\stealth\enemy::main();
                var_cd977be97bc0fc1e thread namespace_42207369e7a21b21::monitor_death_thread(level.stealth.damage_auto_range, level.stealth.damage_sight_range);
                var_cd977be97bc0fc1e thread seeing_player_time_tracker(var_cd977be97bc0fc1e);
                var_cd977be97bc0fc1e thread watch_for_level_weapons_free();
                var_cd977be97bc0fc1e.fnstealthgotonode = &go_to_node_callback;
            }
            return;
        } else {
            var_cd977be97bc0fc1e scripts\asm\soldier\patrol::function_3aba5f22b60d37f5();
            if (var_cd977be97bc0fc1e should_run_sp_stealth()) {
                ...
                var_cd977be97bc0fc1e thread seeing_player_time_tracker(var_cd977be97bc0fc1e);
                var_cd977be97bc0fc1e thread watch_for_level_weapons_free();
                if (var_cd977be97bc0fc1e.agent_type != "dog_agent") {
                    var_cd977be97bc0fc1e.fnstealthgotonode = &go_to_node_callback;
                }
            }
        }
    ...
    if (istrue(level.global_stealth_broken) || istrue(level.var_1cbecb12f3ec3970) && istrue(var_34c6d56fa2022688)) {
        var_cd977be97bc0fc1e scripts\asm\soldier\patrol::function_3aba5f22b60d37f5();
        if (var_cd977be97bc0fc1e should_run_sp_stealth()) {
            var_cd977be97bc0fc1e function_640ddd42cdc91a26();
            var_cd977be97bc0fc1e thread scripts\stealth\enemy::main();
            ...
            var_cd977be97bc0fc1e thread seeing_player_time_tracker(var_cd977be97bc0fc1e);
            var_cd977be97bc0fc1e thread watch_for_level_weapons_free();
            var_cd977be97bc0fc1e scripts\stealth\utility::set_stealth_func("event_combat", &enter_combat_callback);
            var_cd977be97bc0fc1e.fnstealthgotonode = &go_to_node_callback;
        }
        return;
    }
...
function function_640ddd42cdc91a26() {
    var_cd977be97bc0fc1e = self;
    if (isdefined(var_cd977be97bc0fc1e.group) && isdefined(var_cd977be97bc0fc1e.group.group_name)) {
        var_cd977be97bc0fc1e.script_stealthgroup = var_cd977be97bc0fc1e.group.group_name;
    } else if (isdefined(var_cd977be97bc0fc1e.directorspawndata) && isdefined(var_cd977be97bc0fc1e.directorspawndata.script_stealthgroup)) {
        var_cd977be97bc0fc1e.script_stealthgroup = var_cd977be97bc0fc1e.directorspawndata.script_stealthgroup;
    } else {
        var_cd977be97bc0fc1e.script_stealthgroup = "group";
    }
    if (isdefined(var_cd977be97bc0fc1e.spawnpoint)) {
        if (isdefined(var_cd977be97bc0fc1e.spawnpoint.script_stealthgroup)) {
            var_cd977be97bc0fc1e.script_stealthgroup = var_cd977be97bc0fc1e.spawnpoint.script_stealthgroup;
        }
        if (isdefined(var_cd977be97bc0fc1e.spawnpoint.script_sightrange)) {
            var_cd977be97bc0fc1e.stealth.override_damage_auto_range = int(var_cd977be97bc0fc1e.script_sightrange);
        }
    }
}
...
function suspicious_door_monitor() {
    ...
    while (true) {
        origin, user = level waittill("door_event");
...
// Size: 0x51
function change_stealth_state_to(var_cd977be97bc0fc1e, var_6879f8f1b126e993) {
    level endon("weapons_free");
    var_cd977be97bc0fc1e notify("change_stealth_state_to", var_6879f8f1b126e993);
    var_cd977be97bc0fc1e endon("change_stealth_state_to");
    var_cd977be97bc0fc1e endon("death");
    var_cd977be97bc0fc1e endon("enter_combat");
    exit_current_stealth_state(var_cd977be97bc0fc1e);
    set_current_stealth_state(var_cd977be97bc0fc1e, var_6879f8f1b126e993);
    enter_current_stealth_state(var_cd977be97bc0fc1e);
}
...
// Size: 0x21
function exit_current_stealth_state(var_cd977be97bc0fc1e) {
    var_cd977be97bc0fc1e [[ level.exit_stealth_state_func[get_current_stealth_state(var_cd977be97bc0fc1e)] ]](var_cd977be97bc0fc1e);
}
...
// Size: 0x21
function enter_current_stealth_state(var_cd977be97bc0fc1e) {
    var_cd977be97bc0fc1e [[ level.enter_stealth_state_func[get_current_stealth_state(var_cd977be97bc0fc1e)] ]](var_cd977be97bc0fc1e);
}
...
// Size: 0x20
function set_current_stealth_state(var_cd977be97bc0fc1e, current_stealth_state) {
    var_cd977be97bc0fc1e.current_stealth_state = current_stealth_state;
}
...
// Size: 0x16
function get_current_stealth_state(var_cd977be97bc0fc1e) {
    return var_cd977be97bc0fc1e.current_stealth_state;
}
...
// Size: 0x13
function is_ai_in_stealth(var_cd977be97bc0fc1e) {
    return isdefined(get_current_stealth_state(var_cd977be97bc0fc1e));
}
...
// Size: 0x22
function enter_casual(var_cd977be97bc0fc1e) {
    var_cd977be97bc0fc1e namespace_5729d24318b60bcd::set_demeanor_from_unittype("patrol");
    var_cd977be97bc0fc1e scripts\engine\utility::set_movement_speed(25);
}
...
// Size: 0xb
function exit_casual(var_cd977be97bc0fc1e) {
...
// Size: 0xb
function enter_alert(var_cd977be97bc0fc1e) {
...
// Size: 0x13
function exit_alert(var_cd977be97bc0fc1e) {
    delete_stealth_meter(var_cd977be97bc0fc1e);
}
...
// Size: 0x3b
function enter_combat(var_cd977be97bc0fc1e) {
    var_cd977be97bc0fc1e endon("death");
    var_cd977be97bc0fc1e endon("enter_combat");
    if (scripts\cp\utility::coop_mode_has("sp_stealth")) {
...
// Size: 0x46
function ai_is_juggernaut(var_cd977be97bc0fc1e) {
    return var_cd977be97bc0fc1e.agent_type == "actor_enemy_cp_rus_juggernaut" || var_cd977be97bc0fc1e.agent_type == "actor_enemy_cp_jugg_aq" || var_cd977be97bc0fc1e.agent_type == "actor_enemy_cp_jugg_cartel";
}
...
// Size: 0xb
function exit_combat(var_cd977be97bc0fc1e) {
...
function stop_patrol(var_65773575afb98ed4) {
    var_cd977be97bc0fc1e = self;
    var_cd977be97bc0fc1e notify("stop_going_to_node");
    var_cd977be97bc0fc1e notify("patrol_using_cover_nodes");
    if (istrue(var_65773575afb98ed4)) {
        var_cd977be97bc0fc1e namespace_5729d24318b60bcd::set_goal_pos(var_cd977be97bc0fc1e.origin);
    }
}
...
// Size: 0x129
function make_headicon_on_ai(var_cd977be97bc0fc1e, var_5b78e77c334fa943) {
    if (getdvarint(@"hash_52188cd691f99b29", 0) != 0) {
        return;
    }
    if (has_headicon(var_cd977be97bc0fc1e)) {
        return;
    }
    var_d4478d6ecc123a9a = get_reinforcement_icon_image(var_cd977be97bc0fc1e);
    var_8a0b23d4a234efbc = createheadicon(var_cd977be97bc0fc1e);
    setheadiconimage(var_8a0b23d4a234efbc, var_d4478d6ecc123a9a);
    setheadiconzoffset(var_8a0b23d4a234efbc, 10);
    setheadiconsnaptoedges(var_8a0b23d4a234efbc, 0);
    setheadicondrawthroughgeo(var_8a0b23d4a234efbc, 1);
    setheadiconmaxdistance(var_8a0b23d4a234efbc, 5000);
    setheadiconnaturaldistance(var_8a0b23d4a234efbc, 500);
    reinforcement_icon_objective_id = scripts\cp\cp_objectives::requestworldid("enemy_AI_combat_ID_" + var_cd977be97bc0fc1e getentitynumber(), 22);
    objective_state(reinforcement_icon_objective_id, "active");
    objective_icon(reinforcement_icon_objective_id, var_d4478d6ecc123a9a);
    ...
    objective_onentity(reinforcement_icon_objective_id, var_cd977be97bc0fc1e);
    var_cd977be97bc0fc1e thread [[ var_5b78e77c334fa943 ]](reinforcement_icon_objective_id, var_8a0b23d4a234efbc, var_cd977be97bc0fc1e);
    var_cd977be97bc0fc1e.reinforcement_icon_objective_id = reinforcement_icon_objective_id;
}
...
// Size: 0x83
function get_reinforcement_icon_image(var_cd977be97bc0fc1e) {
    assertex(isdefined(var_cd977be97bc0fc1e.reinforcement_type), "<dev string:x37>");
    switch (var_cd977be97bc0fc1e.reinforcement_type) {
...
// Size: 0xd5
function make_combat_icon_on_ai(var_cd977be97bc0fc1e) {
    if (getdvarint(@"hash_52188cd691f99b29", 0) != 0) {
        return;
    }
    if (has_combat_icon(var_cd977be97bc0fc1e)) {
        return;
    }
    combat_icon_objective_id = scripts\cp\cp_objectives::requestworldid("enemy_AI_combat_ID_" + var_cd977be97bc0fc1e getentitynumber(), 22);
    objective_state(combat_icon_objective_id, "active");
    objective_icon(combat_icon_objective_id, "hud_icon_stealth");
    objective_onentity(combat_icon_objective_id, var_cd977be97bc0fc1e);
    ...
    var_cd977be97bc0fc1e.combat_icon_objective_id = combat_icon_objective_id;
}
...
// Size: 0xf4
function make_stealth_meter_on_ai(var_cd977be97bc0fc1e) {
    if (getdvarint(@"hash_52188cd691f99b29", 0) != 0) {
        return;
    }
    if (has_stealth_meter(var_cd977be97bc0fc1e)) {
        return;
    }
    stealth_meter_objective_id = scripts\cp\cp_objectives::requestworldid("enemy_AI_stealth_ID_" + var_cd977be97bc0fc1e getentitynumber(), 21);
    objective_state(stealth_meter_objective_id, "active");
    objective_icon(stealth_meter_objective_id, "hud_icon_stealth");
    objective_onentity(stealth_meter_objective_id, var_cd977be97bc0fc1e);
    ...
    var_cd977be97bc0fc1e.showing_the_stealth_meter_to_players = [];
    var_cd977be97bc0fc1e.stealth_meter_objective_id = stealth_meter_objective_id;
    var_cd977be97bc0fc1e thread clear_up_stealth_meter_when_enter_combat(var_cd977be97bc0fc1e);
}
...
// Size: 0x22
function clear_up_stealth_meter_when_enter_combat(var_cd977be97bc0fc1e) {
    var_cd977be97bc0fc1e endon("death");
    var_cd977be97bc0fc1e waittill("enter_combat");
    delete_stealth_meter(var_cd977be97bc0fc1e);
}
...
// Size: 0x5d
function show_stealth_meter_to(player, var_cd977be97bc0fc1e) {
    if (!has_stealth_meter(var_cd977be97bc0fc1e)) {
        make_stealth_meter_on_ai(var_cd977be97bc0fc1e);
    }
    if (is_showing_stealth_meter_to(player, var_cd977be97bc0fc1e)) {
        return;
    }
    var_cd977be97bc0fc1e.showing_the_stealth_meter_to_players[var_cd977be97bc0fc1e.showing_the_stealth_meter_to_players.size] = player;
    objective_addclienttomask(var_cd977be97bc0fc1e.stealth_meter_objective_id, player);
}
...
// Size: 0x4c
function show_combat_icon_to(player, var_cd977be97bc0fc1e) {
    if (getdvarint(@"hash_52188cd691f99b29", 0) != 0) {
        return;
    }
    if (!has_combat_icon(var_cd977be97bc0fc1e)) {
        make_combat_icon_on_ai(var_cd977be97bc0fc1e);
    }
    objective_addclienttomask(var_cd977be97bc0fc1e.combat_icon_objective_id, player);
}
...
// Size: 0x63
function show_headicon_to(player, var_cd977be97bc0fc1e, var_5b78e77c334fa943) {
    ...
    if (!has_headicon(var_cd977be97bc0fc1e)) {
        make_headicon_on_ai(var_cd977be97bc0fc1e, var_5b78e77c334fa943);
    }
    objective_addclienttomask(var_cd977be97bc0fc1e.reinforcement_icon_objective_id, player);
}
...
// Size: 0x30
function set_stealth_meter_progress(var_cd977be97bc0fc1e, progress) {
    if (get_current_stealth_state(var_cd977be97bc0fc1e) == "alert") {
        var_cd977be97bc0fc1e.target_stealth_meter_progress = progress;
    }
}
...
// Size: 0x76
function hide_stealth_meter_from(player, var_cd977be97bc0fc1e) {
    if (!has_stealth_meter(var_cd977be97bc0fc1e)) {
        return;
    }
    if (!is_showing_stealth_meter_to(player, var_cd977be97bc0fc1e)) {
    ...
    var_cd977be97bc0fc1e.showing_the_stealth_meter_to_players = scripts\engine\utility::array_remove(var_cd977be97bc0fc1e.showing_the_stealth_meter_to_players, player);
    objective_removeclientfrommask(var_cd977be97bc0fc1e.stealth_meter_objective_id, player);
    if (var_cd977be97bc0fc1e.showing_the_stealth_meter_to_players.size == 0) {
        var_cd977be97bc0fc1e.i_am_seeing_this_player = undefined;
    }
}
...
// Size: 0x25
function is_showing_stealth_meter_to(player, var_cd977be97bc0fc1e) {
    return scripts\engine\utility::array_contains(var_cd977be97bc0fc1e.showing_the_stealth_meter_to_players, player);
}
...
// Size: 0x17
function has_stealth_meter(var_cd977be97bc0fc1e) {
    return isdefined(var_cd977be97bc0fc1e.stealth_meter_objective_id);
}
...
// Size: 0x17
function has_combat_icon(var_cd977be97bc0fc1e) {
    return isdefined(var_cd977be97bc0fc1e.combat_icon_objective_id);
}
...
// Size: 0x17
function has_headicon(var_cd977be97bc0fc1e) {
    return isdefined(var_cd977be97bc0fc1e.reinforcement_icon_objective_id);
}
...
// Size: 0x4c
function delete_stealth_meter(var_cd977be97bc0fc1e) {
    if (has_stealth_meter(var_cd977be97bc0fc1e)) {
        scripts\cp\cp_objectives::freeworldid("enemy_AI_stealth_ID_" + var_cd977be97bc0fc1e getentitynumber());
        objective_delete(var_cd977be97bc0fc1e.stealth_meter_objective_id);
        var_cd977be97bc0fc1e.stealth_meter_objective_id = undefined;
        var_cd977be97bc0fc1e notify("exit_stealth_think");
    }
}
...
// Size: 0x4c
function delete_combat_icon(var_cd977be97bc0fc1e) {
    if (has_combat_icon(var_cd977be97bc0fc1e)) {
        scripts\cp\cp_objectives::freeworldid("enemy_AI_combat_ID_" + var_cd977be97bc0fc1e getentitynumber());
        objective_delete(var_cd977be97bc0fc1e.combat_icon_objective_id);
        var_cd977be97bc0fc1e.combat_icon_objective_id = undefined;
        var_cd977be97bc0fc1e notify("exit_stealth_think");
    }
}
...
// Size: 0x52
function delete_headicon(reinforcement_icon_objective_id, var_8a0b23d4a234efbc, var_cd977be97bc0fc1e, var_edcde399ccbc2094) {
    ...
    var_cd977be97bc0fc1e.reinforcement_icon_objective_id = undefined;
    deleteheadicon(var_8a0b23d4a234efbc);
    var_cd977be97bc0fc1e notify("exit_stealth_think");
}
...
// Size: 0x2f
function get_player_who_most_likely_broke_stealth(var_717279ada7c23d46, var_6ab916505c4d2e82) {
    result = [[ var_6ab916505c4d2e82 ]]();
    if (isdefined(result)) {
        return result;
    }
    return get_closest_valid_player(var_717279ada7c23d46);
}
...
// Size: 0x85
function get_closest_valid_player(var_717279ada7c23d46) {
    valid_players = [];
    foreach (player in level.players) {
        if (player.sessionstate == "spectator") {
            continue;
    ...
    return scripts\engine\utility::getclosest(var_717279ada7c23d46, valid_players);
}
...
// Size: 0x44
function change_stealth_state_to_combat_warpper(var_cd977be97bc0fc1e, player_name_who_broke_stealth, reason_stealth_broken) {
    var_cd977be97bc0fc1e.player_name_who_broke_stealth = player_name_who_broke_stealth;
    var_cd977be97bc0fc1e.reason_stealth_broken = reason_stealth_broken;
    var_cd977be97bc0fc1e thread change_stealth_state_to(var_cd977be97bc0fc1e, "combat");
}
...
// Size: 0xdc
function display_who_broke_stealth_message(var_cd977be97bc0fc1e) {
    assertex(isdefined(var_cd977be97bc0fc1e.player_name_who_broke_stealth), "<dev string:x68>");
    assertex(isdefined(var_cd977be97bc0fc1e.reason_stealth_broken), "<dev string:x8c>");
    foreach (player in level.players) {
        if (player.name == var_cd977be97bc0fc1e.player_name_who_broke_stealth) {
            display_message_to_guilty_player(player, var_cd977be97bc0fc1e.reason_stealth_broken);
            continue;
        }
        display_message_to_teammates(player, var_cd977be97bc0fc1e.player_name_who_broke_stealth, var_cd977be97bc0fc1e.reason_stealth_broken);
    }
}
...
// Size: 0x6a
function display_message_to_teammates(var_84cdd54dfea85ac7, var_a69465d9105a5cd5, reason_stealth_broken) {
    switch (reason_stealth_broken) {
    case #"hash_39fb8322da3b46f6": 
        var_84cdd54dfea85ac7 iprintlnbold("^1" + var_a69465d9105a5cd5 + "^7 has alerted the enemies");
        break;
    case #"hash_885c3e314392bb2": 
        var_84cdd54dfea85ac7 iprintlnbold("^1" + var_a69465d9105a5cd5 + "^7 has been spotted by the enemies");
        break;
    }
}
...
function function_b5eb90c4bf658113() {
    level endon("game_ended");
    while (true) {
        stealth_group = level waittill("stealth_combat");
...
function grenade_exploded_during_stealth_listener() {
    ...
    while (true) {
        grenade, grenade_type, grenade_owner_name = level waittill("grenade_exploded_during_stealth");
        switch (grenade_type) {
...
function nearby_ai_combat_via_grenade(var_33621118e3427b21, var_fc8aecb0c985e3f8, grenade, var_96c5db7b1e2f5891, grenade_owner_name) {
    if (level_should_run_sp_stealth()) {
        ...
        if (isvector(grenade)) {
            var_1fda6bb5f77eb472 = get_ai_within_range(grenade, var_33621118e3427b21, var_fc8aecb0c985e3f8);
        } else {
            var_1fda6bb5f77eb472 = get_ai_within_range(grenade.origin, var_33621118e3427b21, var_fc8aecb0c985e3f8);
        }
        foreach (var_310236dbf257fbb5 in var_1fda6bb5f77eb472) {
            if (isvector(grenade)) {
                thread function_663719d74fbec07f(var_310236dbf257fbb5, grenade);
                continue;
            }
            thread function_663719d74fbec07f(var_310236dbf257fbb5, grenade.origin);
        }
        return;
    }
    if (!isdefined(grenade_owner_name)) {
    ...
    foreach (var_310236dbf257fbb5 in var_1fda6bb5f77eb472) {
        if (isdefined(get_current_stealth_state(var_310236dbf257fbb5))) {
            var_310236dbf257fbb5 change_stealth_state_to_combat_warpper(var_310236dbf257fbb5, grenade_owner_name, "enemies_are_alerted");
        }
    }
}
...
function nearby_ai_investigate_grenade(var_33621118e3427b21, var_fc8aecb0c985e3f8, grenade, grenade_type, var_c7259036623763c1, grenade_owner_name) {
    ...
    var_1fda6bb5f77eb472 = get_ai_within_range(grenade.origin, var_33621118e3427b21, var_fc8aecb0c985e3f8);
    foreach (var_310236dbf257fbb5 in var_1fda6bb5f77eb472) {
        if (is_ai_in_stealth(var_310236dbf257fbb5)) {
            enemy_ai_enter_alert_due_to_grenade_explode(var_310236dbf257fbb5, grenade, grenade_type, var_c7259036623763c1, grenade_owner_name);
        }
    }
}
...
// Size: 0x4a
function enemy_ai_enter_alert_due_to_grenade_explode(var_cd977be97bc0fc1e, var_b5aad1bf0db6d8d4, var_29875973e882fa97, var_c7259036623763c1, grenade_owner_name) {
    if (get_current_stealth_state(var_cd977be97bc0fc1e) != "alert") {
        var_cd977be97bc0fc1e thread change_stealth_state_to(var_cd977be97bc0fc1e, "alert");
    }
}
...
// Size: 0xee
function get_ai_within_range(var_914e920ee4a75f55, var_92c8e5a6d23d9243, var_fc8aecb0c985e3f8) {
    result = [];
    var_8738c358f4873c51 = [];
    var_cf24c09b6f305a34 = getaiarray("axis");
    ...
    var_8738c358f4873c51 = sortbydistance(var_8738c358f4873c51, var_914e920ee4a75f55);
...
// Size: 0x142
function function_c72b7181608c8607(var_42012dd2e8ee7c69, var_e085cf82adc280a3, var_ae4236af36e273dc) {
    ...
    if (isdefined(var_ae4236af36e273dc)) {
        wait var_ae4236af36e273dc;
    }
    org = undefined;
...
function function_53c55a0c7af36050() {
    ...
    level.var_a8b79f12e1f36e34 = [];
    level.entered_combat = [];
    level.var_73af1476053ffac4 = [];
    level.var_2c2959c093a3ff43 = [];
}
...
function function_18cd746ff947ff3c(region) {
    ...
    level.var_a8b79f12e1f36e34[region] = 0;
    level.entered_combat[region] = 0;
    level.var_73af1476053ffac4[region] = 0;
    level.var_2c2959c093a3ff43[region] = 0;
...
function function_a5464841fa1292fe(type, obj, delay) {
    ...
    case #"hash_37bb23543c319104": 
        level.var_a8b79f12e1f36e34[obj]++;
        break;
    case #"hash_9e02cd4a0f3ca981": 
        level.entered_combat[obj]++;
        break;
    case #"hash_e21b072df2b47f94": 
        level.var_73af1476053ffac4[obj]++;
        break;
    case #"hash_b216c9cbf6b56ed0": 
        level.var_2c2959c093a3ff43[obj]++;
        break;
    }
}
