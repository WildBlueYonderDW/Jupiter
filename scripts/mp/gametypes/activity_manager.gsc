...
function onteameliminated(team) {
    ...
    teamcount = scripts/mp/teams::getactiveteamcount();
    if (teamcount == 1) {
        ...
        while (true) {
            ...
            if (isdefined(level.var_1b7407dffe81e6e8.spawndata)) {
                foreach (name, spawndata in level.var_1b7407dffe81e6e8.spawndata) {
                    if (getdvarint(hashcat(@"hash_31a2bba2a258c4a2", name, "Activity ent does not have a last touch time!"), 0) == 1 || getdvarint(hashcat(@"hash_31a2bba2a258c4a2", name, "task_ended"), 0) == 1) {
                        tobot = getdvarint(hashcat(@"hash_31a2bba2a258c4a2", name, "task_ended"), 0) == 1;
                        setdvar(hashcat(@"hash_31a2bba2a258c4a2", name, "Activity ent does not have a last touch time!"), 0);
                        setdvar(hashcat(@"hash_31a2bba2a258c4a2", name, "task_ended"), 0);
                        activity = undefined;
...
function function_ebe9b1e455d46450(player) {
    ...
    for (index = 0; index < var_c56664807b194adb.size && var_32f9bd0ca63c013e < 10; index++) {
        ...
        score = 0;
        score = score + function_5f083fb42518423c(playerorigin, activityorigin);
        ...
        if (var_b6b0b797c6ef02e2) {
            score = score + function_52bb8aec483e159a(playerorigin, activityorigin, var_a96c0ad7583e3d);
        }
...
function private function_5f083fb42518423c(playerorigin, activityorigin) {
    ...
    var_74f7841a848c74df = var_74f7841a848c74df * level.var_1b7407dffe81e6e8.scoring.var_6f1d78292f73ee46;
    var_bb7a6b74942c715e = (40000 - dist) / 40000;
    var_bb7a6b74942c715e = var_bb7a6b74942c715e * level.var_1b7407dffe81e6e8.scoring.var_5845ba08c276f11;
        ...
        if (getdvarint(@"hash_e0b8b49a793faf58", 0) == 1) {
            for (index = 0; index < var_c56664807b194adb.size; index++) {
                ...
                if (isdefined(var_7f767d0b39d7e455[index])) {
                    vectorheight = vectorheight + 4000 * var_7f767d0b39d7e455[index];
