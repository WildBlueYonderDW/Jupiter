...
function initbufferedstats() {
    ...
    /#
        println("<dev string:x35>" + self.bufferedstats["<dev string:x47>"]);
        println("<dev string:x58>" + self.bufferedstats["<dev string:x69>"]);
        println("<dev string:x79>" + self.bufferedstats["<dev string:x8a>"]);
        println("<dev string:x9a>" + self.bufferedstats["<dev string:xab>"]);
    #/
