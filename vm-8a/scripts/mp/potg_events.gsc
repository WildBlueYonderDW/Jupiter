...
/#
    ...
    function function_7caeba0dbb5a997f() {
        ...
        while (true) {
            printtoscreen2d(100, 400, "<dev string:x27>", (1, 0.5, 0.7), 1.5);
            printtoscreen2d(100, 420, ter_op(eventdata.shotgroupactive, "<dev string:x38>", "<dev string:x3f>"), (1, 0.5, 0.7), 1.5);
            printtoscreen2d(100, 440, "<dev string:x43>" + eventdata.shotgroupaccuracy, (1, 0.5, 0.7), 1.5);
            printtoscreen2d(100, 460, "<dev string:x4e>" + eventdata.shotgroupcount, (1, 0.5, 0.7), 1.5);
            printtoscreen2d(100, 480, "<dev string:x56>" + eventdata.shotgrouplastaccuracy, (1, 0.5, 0.7), 1.5);
            printtoscreen2d(100, 500, "<dev string:x66>" + eventdata.shotgrouplastcount, (1, 0.5, 0.7), 1.5);
            waitframe();
        }
    }
