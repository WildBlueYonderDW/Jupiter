...
function precache()
{
    ...
    if ( !isdefined( level.agent_definition[ agent_type ] ) )
    {
        ...
        character\c_jup_sp_enemy_pmc_grunt_01::precache_cpmp();
        namespace_849b81177e4bea9f::precache_cpmp();
        namespace_4637d00b0a3aa242::precache_cpmp();
        namespace_c1de7bab04ab94b1::precache_cpmp();
    }
