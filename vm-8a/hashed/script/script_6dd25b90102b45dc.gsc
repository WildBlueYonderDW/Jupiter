...
/#
    ...
    function function_493389d543d8fb87() {
        foreach (player in level.players) {
            ...
            player iprintlnbold("<dev string:x27>");
        }
    }
    ...
    function function_750b525ce60bef6c() {
        function_6e7290c8ee4f558b("<dev string:x40>");
        function_a9a864379a098ad6("<dev string:x4e>", "<dev string:x5f>", &function_493389d543d8fb87, 0);
