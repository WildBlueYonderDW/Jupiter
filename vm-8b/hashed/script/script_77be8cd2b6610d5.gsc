...
function private function_afc5ebe1299256f5(dmg_struct) {
    ...
    if (isdefined(dmg_struct.metabonename)) {
        ...
        if (isdefined(weakspot_data)) {
            ...
            additional_dmg = 0;
            if (dmg_struct.idflags & 262144) {
                var_cc5a11780bf1efb0 = 2;
            } else {
                var_cc5a11780bf1efb0 = 0;
            }
            var_4017a57c0bba213e = function_59957d924fbc58e0(dmg_struct.objweapon, "head", var_cc5a11780bf1efb0);
...
function function_10a52a9d2dcaf262(dmg_struct) {
    if (istrue(dmg_struct.var_feef4b237a6beb07)) {
        ...
        dmgmodifier = function_59957d924fbc58e0(dmg_struct.objweapon, dmg_struct.shitloc, var_cc5a11780bf1efb0);
...
function function_61d03b99e3e21bc2(dmg_struct) {
    if (isdefined(self.var_2c94b75746ceabe2) && istrue(self.var_2c94b75746ceabe2)) {
        var_547fbb568b6afa7f = getdvarfloat(@"hash_cf76ed10d29218fb", 0.008);
