    ...
    while (isdefined(goalpoint)) {
        ...
        /#
            if (isdefined(level.var_984bc6feaab3cad4)) {
                duration = 5000;
                var_17129dc345d151cf = ips_to_mph(self function_3dda404001a83ee(function_906e53c2fb9d3f9c("<dev string:x16c>", "<dev string:x170>")));
                goalThreshold = self function_3dda404001a83ee(function_906e53c2fb9d3f9c("<dev string:x16c>", "<dev string:x17c>"));
                sphere(goalpoint.origin, goalThreshold, (1, 1, 0), 0, duration);
                nextgoalpoint = getstruct(goalpoint.target, "<dev string:x18a>");
