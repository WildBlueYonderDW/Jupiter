...
// Namespace namespace_2d7f47b19ccdb41d / namespace_6c622b52017c6808
// Params 6, eflags: 0x0
// Checksum 0x0, Offset: 0xb143
// Size: 0x8f
function function_a4fc9a04b674a389(instance, part, state, player, var_a5b2c541413aa895, usestring) {
    if (part != "arrow_bombsite_body") {
        return;
    }
    var_bfe6c062496ef847 = instance function_790ec5dc7d594c13(player);
    slotlootid = var_bfe6c062496ef847[1];
    itemindex = var_bfe6c062496ef847[0];
...
function function_790ec5dc7d594c13(player) {
    ...
    var_bfe6bf62496ef614 = function_c1a30db229b1311d(player, 0);
    slotlootid = var_bfe6bf62496ef614[1];
    for (itemindex = var_bfe6bf62496ef614[0]; isdefined(itemindex); itemindex = var_bfe6c262496efcad[0]) {
        if (function_bc04f4b45cd80cf8(function_96a1620d901981d1(slotlootid, 5))) {
            return [itemindex, slotlootid];
        }
        var_bfe6c262496efcad = function_c1a30db229b1311d(player, itemindex + 1);
        slotlootid = var_bfe6c262496efcad[1];
    }
    return [undefined, undefined];
}
...
function function_e01bc5dba2da7d6a(victim) {
    ...
    if (teaminfo.state == 5) {
        ...
        var_c8a8cadcfbff950a += level.arrow.dvars.var_b983f90ab46b22a6 * 5;
    } else {
        ...
        var_c8a8cadcfbff950a += level.arrow.dvars.var_b983f90ab46b22a6 * stepscompleted;
    }
    lootid = level.br_pickups.var_7b2bff2d04ee1017["brloot_plunder_cash_uncommon_1"];
    if (isdefined(lootid)) {
...
function function_208f655060eef025() {
    ...
    while (true) {
        ...
        ingas = !istrue(level.br_circle_disabled) && !namespace_bbc79db4c3949a5c::isPointInMultiCircleDanger(container.origin);
        if (!istrue(ingas)) {
            continue;
        }
...
function function_ae4d9d04fb05bae9() {
    ...
    toofar = !namespace_bbc79db4c3949a5c::isPointInMultiCircleDanger(container.origin, level.arrow.dvars.var_bce042bdea07b805);
    if (istrue(toofar)) {
        teaminfo = level.arrow.teaminfo[container.targetteam];
...
function function_e80445bec743c7a9(player, var_4cf3f1d180aa34e7) {
    ...
    if (istrue(var_4cf3f1d180aa34e7)) {
        ...
        var_bff4e227b4310fe2 = element function_2d501383cd6a7711();
        iconoffset = var_bff4e227b4310fe2[1];
        iconent = var_bff4e227b4310fe2[0];
...
function function_325031a0b2f983e4() {
    ...
    var_bff4e327b4311215 = element function_2d501383cd6a7711();
    iconoffset = var_bff4e327b4311215[1];
    iconent = var_bff4e327b4311215[0];
...
function function_b28c6d87ea4cae30() {
    ...
    while (true) {
        ...
        ingas = !istrue(level.br_circle_disabled) && !namespace_bbc79db4c3949a5c::isPointInMultiCircleDanger(element.scriptable.origin);
        if (!istrue(ingas)) {
            continue;
        }
...
function function_411359cd8df47da0() {
    ...
    toofar = !namespace_bbc79db4c3949a5c::isPointInMultiCircleDanger(element.scriptable.origin, level.arrow.dvars.var_572d9f41a62cc17c);
    if (istrue(toofar)) {
        function_9eac0670a84449a5(element.targetteam);
        teaminfo = level.arrow.teaminfo[element.targetteam];
        if (!isdefined(teaminfo)) {
