...
function function_62e0bcef615a8d1d() {
    /#
        setdevdvarifuninitialized(@"hash_ed477691433d09ec", "<dev string:xd7>");
    ...
    function function_a5408bdf77302300() {
        ...
        while (true) {
            ...
            if (eventname != "<dev string:xd7>") {
                ...
                self setclientomnvar("<dev string:x119>", var_cabc886d846dd979);
                setdvar(@"hash_ed477691433d09ec", "<dev string:xd7>");
            }
            wait 0.05;
        }
    }
