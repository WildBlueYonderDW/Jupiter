...
#namespace namespace_91e898039f2fd457;

// Namespace namespace_91e898039f2fd457 / namespace_da16efa8eb97d1c0
// Params 0, eflags: 0x0
...
function main() {
    ...
    thread function_fdeeac6dd03e5d5d();
    ...
    thread function_40c998d604887d47();
    thread function_a1ad47d5291aeef4();
    thread function_56722a358a7d8004();
    thread function_3951cad1e2de0310();
    thread function_a840a70ceeb91af5();
    thread function_85f4506969c4eb3e();
    thread function_4450cdf9ea494c76();
    thread function_185cf3e673f08648();
    ...
    thread function_82654d0d3f524833();
    ...
    thread function_3206872568138436();
    thread sun_castle_btm();
    ...
    thread function_995e4a7e1e5259bc();
...
// Size: 0x6f
function function_ce8c04eed0d9e07c() {
    self endon("death");
    while (true) {
        waitframe();
...
function function_be7108cc4f05380d() {
    self endon("death");
    var_c23c8e1f2973248f = undefined;
    while (true) {
        ...
        if (self isnightvisionon()) {
            if (istrue(var_c23c8e1f2973248f)) {
                if (flag("lgt_descend")) {
                    setsaveddvar(@"fx_lights_intensity_scale", 0.15);
                } else {
                    setsaveddvar(@"fx_lights_intensity_scale", 0.5);
                }
                var_c23c8e1f2973248f = undefined;
            }
        }
...
// Size: 0x1e
function function_249935a288de9743() {
...
// Size: 0x11
function function_75435fbfafba50fd() {
    thread function_238c2a0aae70e973("tower_explosion_light", 0, 0);
}
...
// Size: 0x6f
function function_b1068e4a2925a813() {
...
function function_9f153f00841d1005() {
    ...
    setsaveddvar(@"r_volumetricDepth", 4096);
...
// Size: 0x216
function function_27b056aa45d078af() {
    ...
    setsaveddvar(@"r_volumetricDepth", 2176);
    thread function_a6fea76a4085e5c1();
    thread function_238c2a0aae70e973("tower_explosion_light", 0, 0);
    wait 0.5;
    setsuncolorandintensity(0);
...
function function_92223cfdf808190e() {
    ...
    setsaveddvar(@"sm_spotUpdateLimitDynLight", 6);
    setsaveddvar(@"r_lightGridTempSmoothingFactor", 0.1);
...
function function_acdd340de8aeefc() {
    ...
    setsaveddvar(@"r_volumetricsDensityTemporalFactor", 0.95);
    setsaveddvar(@"r_volumetricsAmbientTemporalFactor", 0.95);
    setsaveddvar(@"r_volumetricsScatterTemporalFactor", 0.95);
    flag_clear("wind_on");
...
function function_333c73e0dcbdc794() {
    ...
    thread function_238c2a0aae70e973("tower_explosion_light", 0, 0);
    thread namespace_da16efa8eb97d1c0::function_ef38136354fc0472();
...
// Size: 0x240
function function_4196e943eaf121aa() {
...
function function_69ad917e1822ff0d() {
    ...
    while (true) {
        ...
        if (level.var_c0539be4ffb94f6f > 0) {
            setsaveddvar(@"r_volumetricDepth", 2500);
            continue;
        }
        setsaveddvar(@"r_volumetricDepth", 2176);
    }
...
// Size: 0x19
function function_40c998d604887d47() {
    wait 0.05;
...
// Size: 0x19
function function_a1ad47d5291aeef4() {
    wait 0.05;
...
// Size: 0x19
function function_56722a358a7d8004() {
    wait 0.05;
...
// Size: 0x19
function function_3951cad1e2de0310() {
    wait 0.05;
...
// Size: 0x6b
function function_fb91e634dfe8642a() {
...
function function_9a73cff3a0f6f2c5(skipintro) {
    ...
    if (!skipintro) {
        ...
        thread function_1be9145b47c4b31d();
        setsaveddvar(@"r_volumetricDepth", 1);
        setsaveddvar(@"hash_227255b054ed2f30", 1);
        setsaveddvar(@"hash_f462015fd5b9ecc7", 1);
        setsaveddvar(@"hash_48befd65e5945e5", 1);
        setsaveddvar(@"hash_dacffbfd52c2fdc5", 32);
        ...
        thread function_fb91e634dfe8642a();
        ...
        setsaveddvar(@"r_volumetricsDensityTemporalFactor", 0.5);
        setsaveddvar(@"r_volumetricsAmbientTemporalFactor", 0.5);
    ...
    setsaveddvar(@"sm_sunMoving", 0);
    setsaveddvar(@"hash_93b4b56b615317b9", 2000);
    thread function_238c2a0aae70e973("water_emerge_begin_key", 4, 200);
    thread function_26280fbed5700639();
    setsaveddvar(@"r_mbVelocityScale", 2);
    setsaveddvar(@"r_volumetricsDensityTemporalFactor", 0.6);
    setsaveddvar(@"r_volumetricsAmbientTemporalFactor", 0.6);
    setsaveddvar(@"r_volumetricsScatterTemporalFactor", 0.6);
...
function function_e460bc303ea00462() {
    ...
    setsaveddvar(@"sm_spotUpdateLimit", 15);
    if (isplatformxb3() || isplatformps4()) {
        wait 0.1;
        setsaveddvar(@"sm_spotUpdateLimit", 8);
    }
    ...
    thread namespace_72b975aae422b41a::letterbox_enable(1, 1.25);
    ...
    setsaveddvar(@"r_volumetricsDensityTemporalFactor", 0.65);
    setsaveddvar(@"r_volumetricsAmbientTemporalFactor", 0.65);
    setsaveddvar(@"r_volumetricsScatterTemporalFactor", 0.65);
...
function function_e4cf2932f102d075() {
    ...
    ent.angles = level.player function_ca5f70a20456c678(xcam, var_adf0e9db54a43870, 0, animnode.origin, animnode.angles);
    endorigin = level.player getxcamposition(xcam, 1, 0, animnode.origin, animnode.angles) + (0, 0, -60);
    endangles = level.player function_ca5f70a20456c678(xcam, 1, 0, animnode.origin, animnode.angles);
...
// Size: 0xf6
function function_fdeeac6dd03e5d5d() {
    wait 0.5;
...
// Size: 0x2b
function function_f66c3791979aacf2() {
...
function flag_rappel_lightning(targetname) {
    ...
    var_31f3abb527949949 = getentarray(targetname, "targetname");
    flag_wait("flag_rappel_lightning");
    while (flag("flag_rappel_lightning")) {
        foreach (ent in var_31f3abb527949949) {
...
function function_d36dd41938d97870() {
    var_bcfeb046853a655f = randomfloat(1);
    return vectorlerp(level.storm.var_f516bed4300f6e70, level.storm.var_f516c1d4300f7509, var_bcfeb046853a655f);
}
...
function function_30919f9d32e03e65(var_c2a989438eb8d070, var_9c3d7716a239b594) {
    ...
    for (index = 0; index < var_c2a989438eb8d070; index++) {
        ...
        var_274e22942d9863f3 = ["sp_jup_vip_intro_bright", "sp_jup_vip_intro_bright2", "sp_jup_vip_intro_bright3"];
        var_10a442ef2940b545 = random(var_274e22942d9863f3);
    ...
    setsaveddvar(@"r_lightGridTempSmoothingFactor", 0.95);
    setsaveddvar(@"r_volumetricsDensityTemporalFactor", 0.95);
    setsaveddvar(@"r_volumetricsAmbientTemporalFactor", 0.95);
    function_26fc73f5366f147b(0);
}
...
// Size: 0x19
function function_185cf3e673f08648() {
    wait 0.05;
...
function function_8d3ebbf2a1a2d301() {
    ...
    fakeplayer.var_2a695fd7ba52b43f = spawn_tag_origin();
    fakeplayer.var_2a695fd7ba52b43f show();
    var_2a695fd7ba52b43f = fakeplayer.var_2a695fd7ba52b43f;
    var_2a695fd7ba52b43f linkto(fakeplayer, "tag_flash", (-30, 20, -12), (0, 0, 0), 0);
    playfxontag(level._effect["vfx_light_underwater_vol"], var_2a695fd7ba52b43f, "tag_origin");
    level waittill("cine_intro_end");
    killfxontag(level._effect["vfx_light_underwater_vol"], var_2a695fd7ba52b43f, "tag_origin");
    var_2a695fd7ba52b43f delete();
    player = level.player;
    player.var_2a695fd7ba52b43f = spawn_tag_origin();
    player.var_2a695fd7ba52b43f show();
    var_2a695fd7ba52b43f = player.var_2a695fd7ba52b43f;
    var_2a695fd7ba52b43f linktoplayerview(player, "j_dpv", (10, 4, -10), (0, 0, 0), 0);
    playfxontag(level._effect["vfx_light_underwater"], var_2a695fd7ba52b43f, "tag_origin");
}
...
function function_91684a8276eb067e() {
    wait 2;
    player = level.player;
    if (isdefined(player.var_2a695fd7ba52b43f)) {
        killfxontag(level._effect["vfx_light_underwater"], player.var_2a695fd7ba52b43f, "tag_origin");
        player.var_2a695fd7ba52b43f linkto(player, "TAG_ACCESSORY_LEFT", (0, 0, 0), (0, 0, 0), 0);
        playfxontag(level._effect["vfx_vip_dpv_light_ally_bright"], player.var_2a695fd7ba52b43f, "tag_origin");
    }
}
...
function function_bfbba57c24d8bf2f() {
    player = level.player;
    if (isdefined(player.var_2a695fd7ba52b43f)) {
        killfxontag(level._effect["vfx_vip_dpv_light_ally_bright"], player.var_2a695fd7ba52b43f, "tag_origin");
        player.var_2a695fd7ba52b43f delete();
    }
}
...
function function_9a005628dc3cf8e2() {
    ...
    var_2931ea04151e190f.var_2a695fd7ba52b43f = spawn_tag_origin();
    var_2931ea04151e190f.var_2a695fd7ba52b43f show();
    var_2931ea04151e190f.var_2a695fd7ba52b43f linkto(var_2931ea04151e190f, "tag_dpv_light", (0, 0, 0), (0, 0, 0), 0);
    playfxontag(level._effect["vfx_light_underwater"], var_2931ea04151e190f.var_2a695fd7ba52b43f, "tag_origin");
    flag_wait("lgt_emerge_swim_end");
    wait 2;
    killfxontag(getfx("vfx_light_underwater"), var_2931ea04151e190f.var_2a695fd7ba52b43f, "tag_origin");
}
...
// Size: 0xc7
function function_d8dc18179bcafb5e(var_35a0e3371254bfbc, ent, var_64094755c2fd8a59, fx) {
    thread function_57e5b8e4ac029421(var_35a0e3371254bfbc, ent, var_64094755c2fd8a59);
    playfx(getfx(fx), ent.origin, anglestoforward(ent.angles));
    if (isdefined(ent.target)) {
        target_ent = getent(ent.target, "targetname");
        if (isdefined(target_ent) && target_ent.classname == "light") {
...
// Size: 0x7c
function function_57e5b8e4ac029421(var_35a0e3371254bfbc, ent, var_64094755c2fd8a59) {
    wait var_35a0e3371254bfbc;
    var_c82eabb722c361a7 = 0.05;
    flickerpercentage = randomfloatrange(0, 1);
    thread function_defb9f9d0ce11b2b(ent, var_c82eabb722c361a7, 1600, flickerpercentage);
    wait 0.1;
    var_cec49f1254ec4d98 = 0.05;
    flickerpercentage = randomfloatrange(0, 1);
    thread function_defb9f9d0ce11b2b(ent, var_cec49f1254ec4d98, 0, flickerpercentage);
}
...
function function_2fc4e3b3450f3df7() {
    ...
    setsaveddvar(@"sm_spotUpdateMoreDynObj", 1);
    setsaveddvar(@"sm_dynlightAllSModels", 1);
    flag_wait("flag_control_room_clear");
    setsaveddvar(@"r_primaryLightMotionDetect", 1);
    setsaveddvar(@"sm_spotUpdateMoreDynEnt", 0);
    setsaveddvar(@"sm_spotUpdateMoreDynObj", 0);
...
function function_4068626e9ddd7a11() {
    ally1 = level.ally1;
    ally1.var_bed50c3a7a759bb = spawn_tag_origin();
    ally1.var_bed50c3a7a759bb show();
    ally1.var_bed50c3a7a759bb linkto(level.ally1, "j_gun", (15, -2, -8), (0, 0, 0), 0);
    playfxontag(level._effect["vfx_light_laser_fill"], ally1.var_bed50c3a7a759bb, "tag_origin");
    ally2 = level.ally2;
    ally2.var_bed50c3a7a759bb = spawn_tag_origin();
    ally2.var_bed50c3a7a759bb show();
    ally2.var_bed50c3a7a759bb linkto(level.ally2, "j_gun", (15, -2, -8), (0, 0, 0), 0);
    playfxontag(level._effect["vfx_light_laser_fill"], ally2.var_bed50c3a7a759bb, "tag_origin");
}
...
function function_82e700452debfc2d() {
    ally1 = level.ally1;
    if (isdefined(ally1.var_bed50c3a7a759bb)) {
        killfxontag(level._effect["vfx_light_laser_fill"], ally1.var_bed50c3a7a759bb, "tag_origin");
        ally1.var_bed50c3a7a759bb delete();
    }
    ally2 = level.ally2;
    if (isdefined(ally2.var_bed50c3a7a759bb)) {
        killfxontag(level._effect["vfx_light_laser_fill"], ally2.var_bed50c3a7a759bb, "tag_origin");
        ally2.var_bed50c3a7a759bb delete();
    }
}
...
function function_ffef59640da9b712() {
    flag_wait("lgt_mak_cig");
    animnode = getstruct("scene_vip_0800_reach_makarov_reveal", "targetname");
    var_a5637803b40c34be = animnode scene::get_entity("cigarette");
    wait 0.05;
    var_a5637803b40c34be.var_cfddb148e61187a6 = spawn_tag_origin();
    var_a5637803b40c34be.var_cfddb148e61187a6 show();
    var_a5637803b40c34be.var_cfddb148e61187a6 linkto(var_a5637803b40c34be, "tag_origin", (1, 0, 0), (0, 0, 0), 0);
    wait 0.05;
    playfxontag(level._effect["vfx_light_mak_cig"], var_a5637803b40c34be.var_cfddb148e61187a6, "tag_origin");
}
...
// Size: 0x21e
function function_9af6ecb59cc2bec9() {
...
function function_b43da6f1b78f953b() {
    ...
    wait 0.05;
    setsaveddvar(@"sm_spotUpdateLimit", 10);
    setsaveddvar(@"sm_spotUpdateLimitDynLight", 10);
    if (isplatformxb3() || isplatformps4()) {
        setsaveddvar(@"sm_spotUpdateLimit", 8);
    ...
    level.player_rig thread function_89af3404ac7beb0b();
...
// Size: 0x2
function function_9d19b75677be3ef2() {
...
function function_e35e87e1ea308b6a() {
    thread function_9d19b75677be3ef2();
    light = getent("lgt_cine_elevator_moving3", "targetname");
    high_pos = getstruct("lgt_cine_elevator_moving_pos_high3", "targetname");
    var_60a1bbb69dbeb0ec = getstruct("lgt_cine_elevator_moving_pos_low3", "targetname");
    light2 = getent("lgt_cine_elevator_moving2", "targetname");
    var_c3c786e304f663f6 = getstruct("lgt_cine_elevator_moving_pos_high2", "targetname");
    var_4260b09cea5ef83a = getstruct("lgt_cine_elevator_moving_pos_low2", "targetname");
    ...
    thread function_bb9b60091de365cc(light2, 0, var_c3c786e304f663f6.origin);
    thread function_69fdb565035993c5(light, high_pos, var_60a1bbb69dbeb0ec);
    thread function_7289e4265e006835(light2, var_c3c786e304f663f6, var_4260b09cea5ef83a);
    ...
    var_60a1bbb69dbeb0ec = getstruct("lgt_cine_elevator_moving_pos_low", "targetname");
    thread function_bb9b60091de365cc(light, 0, high_pos.origin);
    thread function_28b8448c309e426(light, high_pos, var_60a1bbb69dbeb0ec);
...
// Size: 0xc7
function function_69fdb565035993c5(light, high_pos, var_60a1bbb69dbeb0ec) {
    ...
    wait 0.05;
    thread function_bb9b60091de365cc(light, 10, var_60a1bbb69dbeb0ec.origin);
    wait 2;
...
// Size: 0xab
function function_7289e4265e006835(light, high_pos, var_60a1bbb69dbeb0ec) {
    wait randomfloatrange(0.5, 2);
...
// Size: 0x112
function function_28b8548c309e659(light, high_pos, var_60a1bbb69dbeb0ec) {
...
// Size: 0x150
function function_28b8448c309e426(light, high_pos, var_60a1bbb69dbeb0ec) {
    level.player endon("elevator stop");
...
function function_cf989893662dbcd2(animnode) {
    ...
    var_2cf81884316a3ae0 = animnode scene::get_entity("Makarov");
    var_2cf81f84316a4a45 = animnode scene::get_entity("Actor 4");
    var_2cf81e84316a4812 = animnode scene::get_entity("Actor 5");
    Boat01 = animnode scene::get_entity("Boat01");
    Boat02 = animnode scene::get_entity("Boat02");
    actors = [level.ally1, level.makarov, Nolan];
    function_a19904f15da81f7d([var_2cf81f84316a4a45, var_2cf81e84316a4812], animnode);
...
// Size: 0x59
function function_82654d0d3f524833() {
...
// Size: 0x68
function function_586d125647ea85d() {
    setsaveddvar(@"r_volumetricDepth", 1000);
    wait 2;
...
function TRIG_boat_visiblity() {
    wait 0.05;
    run_thread_on_targetname("TRIG_boat_visiblity", &function_7ffd85df3cab7d9d);
}
...
// Size: 0x1a8
function function_7ffd85df3cab7d9d() {
    while (true) {
        self waittill("trigger");
...
function function_60af931d01bdcc63() {
    ...
    setsaveddvar(@"sm_spotUpdateLimitDynLight", 3);
...
function function_ef38136354fc0472() {
    ...
    wait 0.1;
    thread function_238c2a0aae70e973("courtyard_castle_spot_light_r", 0, 0);
    var_e4a24b89cada6a32 = getent("courtyard_castle_spot_light_l", "targetname");
    var_e4a24b89cada6a32 rotateby((20, 20, 0), 0.05);
    thread function_238c2a0aae70e973("courtyard_castle_spot_light_l", 0, 10000);
    flag_wait("flag_courtyard_arrive_mg_pre_intro");
    var_e4a24b89cada6a32 rotateby((-20, -20, 0), 1);
    exploder("mg_nest_light");
...
function TRIG_heli_searchlight_hallway() {
    wait 0.05;
    run_thread_on_targetname("TRIG_heli_searchlight_hallway", &function_6494958acaac018f);
}
...
// Size: 0xdb
function function_6494958acaac018f() {
    while (true) {
        self waittill("trigger");
...
function TRIG_flare_adjust_down() {
    wait 0.05;
    run_thread_on_targetname("TRIG_flare_adjust_down", &function_c072a9eea3396d28);
}
...
// Size: 0x4e
function function_c072a9eea3396d28() {
    while (true) {
        self waittill("trigger");
        wait 0.05;
        wait 0.1;
...
// Size: 0x20d
function function_995e4a7e1e5259bc() {
    flag_wait("flag_courtyard_jet_strike_hit");
    wait 2;
    if (isplatformxb3() || isplatformps4()) {
        return;
...
// Size: 0xb8
function function_c3b418d519dfc231() {
    if (isplatformxb3() || isplatformps4()) {
        return;
    }
    wait 3;
...
// Size: 0x67
function function_c3b417d519dfbffe() {
    if (isplatformxb3() || isplatformps4()) {
        return;
    }
    self endon("kill_courtyard_riot_searchlight");
    ...
    setsaveddvar(@"r_volumetricDepth", 5000);
}
...
// Size: 0x67
function function_9afc0b80691d8057(boat, light) {
    level endon("stop_cliff_light");
    setsaveddvar(@"r_volumetricDepth", 2000);
...
function function_a19904f15da81f7d(actors, anim_node) {
    var_2cf81a84316a3f46 = anim_node scene::get_entity("Actor 1");
    var_2cf81984316a3d13 = anim_node scene::get_entity("Actor 2");
    var_2cf81884316a3ae0 = anim_node scene::get_entity("Actor 3");
    var_45ef534defeae115 = [var_2cf81a84316a3f46, var_2cf81984316a3d13, var_2cf81884316a3ae0];
    actors = array_combine(actors, var_45ef534defeae115);
    foreach (var_ae50a2bd65179a44 in actors) {
        namespace_c5f7e08ad7ea4280::function_8ba05ef17e2b7d10(var_ae50a2bd65179a44, "allies");
    }
}
...
function function_1bb3d949f3e37969() {
    wait 0.05;
    var_216bf65f2d8de935 = getentarray("scuba_lights_to_delete", "script_noteworthy");
    foreach (light in var_216bf65f2d8de935) {
        light setlightintensity(0);
        wait 0.1;
        light delete();
    }
