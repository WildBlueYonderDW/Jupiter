    ...
    if (argshave(args, "enemy_turret")) {
        ...
        /#
            if (!isdefined(level.testvehicle)) {
                ...
                var_ec88ca27d5416653 = scripts\cp_mp\vehicles\vehicle::function_84033ce50b8afce2("<dev string:x8b>", spawndata);
                seatid = var_ec88ca27d5416653[1];
                level.testvehicle = var_ec88ca27d5416653[0];
            }
