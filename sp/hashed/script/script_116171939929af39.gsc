...
#using scripts\cp\cp_music_and_dialog.gsc;
...
#using scripts\cp\intel\cp_intel.gsc;
...
#using scripts\cp\execution.gsc;
...
#using scripts\cp\coop_createfx.gsc;
#using script_293ba44c408fef1;

#namespace globallogic;

// Namespace globallogic / namespace_162cff1cf88b9bbf
// Params 0, eflags: 0x0
...
function init() {
    ...
    thread namespace_a09f244480e07471::init_starts();
...
function function_b204b08f674548ab() {
    ...
    function_fc091ec7a771f2ff();
    shellshock_init();
    function_5c5d6f7b09d3c739();
...
function function_6adc128d1309d048() {
    ...
    thread snd_init();
    namespace_c5f7e08ad7ea4280::main(&namespace_9e238f5e6fc1f074::function_764239e6a246c46a);
...
function function_ac74c1458f21b244() {
    level thread namespace_94359011b63230a6::init_munitions();
}
...
function function_4361a652d4e6cc62() {
    ...
    namespace_9911c99bb19ddd6a::init_gameobjects();
    ...
    namespace_1d99ddaf3fc03543::init();
    namespace_3d3d5211c3029f82::init();
    scripts\cp\coop_fx::main();
    scripts\cp\cp_merits::buildmeritinfo();
    thread namespace_4fb9dddfb8c1a67a::init();
    thread namespace_273c9542d33fa94f::init();
    thread namespace_9246f10206f50768::function_7dcad89b9c0264a6();
    scripts\cp\whizby::init();
    scripts\cp\cp_dialogue::main();
    level thread namespace_378f8281e2d12ced::init_battlechatter();
    level thread scripts\cp\cp_checkpoint::checkpoints_init();
    level thread namespace_5729d24318b60bcd::function_4c108af46678af57();
    level thread namespace_d4aab8c9cb8ecb14::function_29cb39aa7064ed6();
    level thread namespace_5aac85eab99c40a::init();
    level thread namespace_22a50d845d3deb2d::init();
    level thread scripts\cp\cp_deployablebox::init();
    level thread scripts\cp\drone\scout_drone::init();
    level thread namespace_86d0d418da518a0e::function_234851f94416f178();
    ...
    thread namespace_825ccfb644168cfe::init();
    ...
    level thread namespace_6099285b4066f63b::initpoints();
    level thread scripts\cp\cp_player_battlechatter::init();
    namespace_a0628d6954815ef8::weaponsinit();
    ...
    namespace_751288259782653c::init();
    ...
    level thread namespace_7335f9420e698c48::function_6620b2d387064d74();
    namespace_14d36171baccf528::function_a09756b37f2e0681();
    if (!function_f620e996a1d7d81a() && !is_operations_gametype()) {
        level thread namespace_6250b14b3f614101::init();
        level thread namespace_1ad0622c44d22e1a::init();
    }
    namespace_4f38e357ab5494ec::function_d86f905b2efc08b9();
    if (namespace_c058342275db1f64::function_ab29f5844aa437fb()) {
        namespace_c058342275db1f64::function_ae2bc8e7d8d4fc9b();
    }
    if (namespace_6bbbe2460b441162::function_777c44bdfc80c0bb()) {
        thread namespace_6bbbe2460b441162::function_fbbb9e404ce48427();
    }
    namespace_1fdb557af4bcd29e::function_4becaa200ddc0956();
    function_3bc2a3f24dcd4061();
    function_3069b525e1c98faf("START");
    level thread scripts\cp\cp_debug::function_27bbf9605c8354e8();
...
function function_3bc2a3f24dcd4061() {
    namespace_6652f29dded2b69b::init();
    namespace_1f50a6a7107e9381::init();
}
...
function function_7280babc254585b2() {
    level thread namespace_9c383b14c4908e46::init();
    ...
    level scripts\cp\utility\lui_game_event_aggregator::registeronluieventcallback(&namespace_94359011b63230a6::function_b64f3836c1d7a06);
    level scripts\cp\utility\lui_game_event_aggregator::registeronluieventcallback(&namespace_bc7b29dcc022d887::function_db908ecaccbe933c);
    ...
    level scripts\cp\utility\lui_game_event_aggregator::registeronluieventcallback(&function_fcd3a5870bcec50c);
    level scripts\cp\utility\lui_game_event_aggregator::registeronluieventcallback(&namespace_f8d3520d3483c1::function_13caa305c839a278);
    ...
    level namespace_9c383b14c4908e46::function_8ece37593311858a(&function_5c8bea04d4909519);
    level namespace_9c383b14c4908e46::function_8ece37593311858a(&function_64908cf46d806427);
    level namespace_9c383b14c4908e46::function_8ece37593311858a(&function_e14e30e8c9c40402);
    level namespace_9c383b14c4908e46::function_8ece37593311858a(&function_174cbb4c8632933f);
    level namespace_9c383b14c4908e46::function_8ece37593311858a(&namespace_bf9ffd2b22c7d819::function_342af7ea8a120b16);
    level scripts\cp\utility\spawn_event_aggregator::registeronplayerspawncallback(&namespace_f8d3520d3483c1::initarmor);
    level scripts\cp\utility\spawn_event_aggregator::registeronplayerspawncallback(&namespace_f8d3520d3483c1::givestartingarmor);
    level scripts\cp\utility\spawn_event_aggregator::registeronplayerspawncallback(&namespace_8235b93197138d09::function_36d589dc5c4191f6);
    level scripts\cp\utility\spawn_event_aggregator::registeronplayerspawncallback(&namespace_44edfb3e2b433c17::function_50eb338949884fca);
    level scripts\cp\utility\disconnect_event_aggregator::registerondisconnecteventcallback(&function_7fdeb6dccfd886ab);
    level namespace_9c383b14c4908e46::function_8ece37593311858a(&scripts\cp\intel\cp_intel::function_807054cfa320ff66);
    ...
    level scripts\cp\utility\spawn_event_aggregator::registeronplayerspawncallback(&namespace_f02c28a5e2bd7edd::function_3458e37bbac2ff9a);
}
...
function private function_532e7b905134a981(bool) {
    ...
    self function_5762cf97c6f1a2c1("none");
}
...
function function_9a82f8a066c216e0(channel, value) {
    if (channel == "jump_to_start") {
        var_b6364d542d70dc1b = getdvar(@"hash_c4b5f7005920fc31");
        tokens = strtok(var_b6364d542d70dc1b, ",");
        if (isdefined(tokens[value - 1])) {
            ...
            namespace_1d99ddaf3fc03543::function_180b06d3d67d483c("Jump To Start Used");
...
function function_f6a78bbe53021bf8() {
    ...
    level namespace_9bb409deb69fb31d::init();
    ...
    #/
    level thread namespace_f02c28a5e2bd7edd::vehicles_init();
...
function function_51337dedfd496b9c() {
    namespace_d56a43a0cbd2ac83::init();
}
...
function function_c4ada2395f072b1f() {
    ...
    level namespace_54a2eae43eaa8bf5::init_playerhealth();
    level namespace_4887422e77f3514e::init();
    scripts\cp\utility\spawn_event_aggregator::registeronplayerspawncallback(&namespace_4887422e77f3514e::function_9bc46d4b8891a740);
    scripts\cp\utility\spawn_event_aggregator::registeronplayerspawncallback(&namespace_54a2eae43eaa8bf5::manageplayerregen);
}
...
function function_56585b89be143a09() {
    ...
    level.var_ad231d0daae0bad9 = function_791e463b9df434fc();
    level.var_2cb04ca6155de37f = getdvarint(@"hash_cc4ee5aa21aa68d3", 1);
    level.onlinegame = getdvarint(@"onlinegame");
    level.rankedmatch = level.onlinegame && !getdvarint(@"hash_485ef1ed1d39d3a3") || getdvarint(@"hash_9c2d59c1962cac50");
    ...
    level.var_12226443217b5474 = 0;
    level.numgametypereservedobjectives = 0;
    level.numkills = 0;
    level.lethaldelay = 0;
    level.var_d67242e275d6f310 = 0;
    ...
    level.challengesallowed = level.matchmakingmatch || getdvarint(@"hash_37acf332efd205cc");
    ...
    level.func["scriptModelClearAnim"] = &scriptmodelclearanim;
    level.fnoffhandfire = &namespace_a0628d6954815ef8::ai_offhandfiremanager;
    ...
    level.maxteamsize = 4;
    level.maxsquadsize = getdvarint(@"hash_15115ef896ca26f2", 4);
    ...
    #/
    namespace_6250b14b3f614101::function_7a302a314424968f(1);
...
function function_e2fc4dea9278cbd8() {
    ...
    setdvar(@"hash_c00e244ea59d530e", getdvarint(@"hash_66c38b5b61297ac1"));
    setdvar(@"hash_8ed4dff39f3251f5", getdvar(@"hash_f16ba8db72f34fc3"));
    setdvar(@"hash_ccf9753c4ee466cc", matchmakinggame());
    setdvar(@"hash_caa6faec79f2c4c2", 0);
    ...
    setdvar(@"hash_2a277c7ca3d095af", 0);
    setdvar(@"hash_687f6fe472201df1", 1);
    setdvar(@"hash_4e5b353bf84974a9", 1);
    setdvar(@"hash_4ba1427c86b79dc5", 0);
...
function setup_callbacks() {
    ...
    level.callbackplayerlaststand = &namespace_d4aab8c9cb8ecb14::callback_playerlaststand;
    level.endgame = &namespace_1d99ddaf3fc03543::endgame;
    level.forceendgame = &namespace_1d99ddaf3fc03543::forceendgame;
    level.var_b11db2283dbd7ed3 = &namespace_8235b93197138d09::player_movement_state;
    ...
    scripts\cp\utility\lui_game_event_aggregator::registeronluieventcallback(&namespace_1d99ddaf3fc03543::function_51a7fd1c0c6690f9);
    scripts\cp\utility\lui_game_event_aggregator::registeronluieventcallback(&namespace_1d99ddaf3fc03543::function_899bd4add25ddd3);
...
function function_47320a25b8ee003() {
    kit = namespace_1f50a6a7107e9381::function_cab56589fd214c7e();
...
function function_167432a034a768dc() {
    level endon("game_ended");
    var_540d620f7a951bdc = "";
    while (true) {
        if (getdvar(@"hash_a18e65eb2a8dfec6", var_540d620f7a951bdc) != var_540d620f7a951bdc) {
            break;
        }
        wait 1;
    }
...
function defaultplayermaxhealth() {
    ...
    if (istrue(self.keep_perks)) {
        if (has_zombie_perk("perk_machine_tough")) {
            ...
            return getdvarint(@"hash_b1d561f9a9241e09", 100);
        }
        return;
    }
    return getdvarint(@"hash_b1d561f9a9241e09", 100);
...
function getassignedspawnpoint(spawnpoints) {
    ...
    var_556e8724dc4d8291 = self getentitynumber();
    assertex(isdefined(spawnpoints[var_556e8724dc4d8291]), "no spawn point for player id: " + var_556e8724dc4d8291);
    return spawnpoints[var_556e8724dc4d8291];
}
...
function startgametype() {
    ...
    namespace_c4cab616edf9b2b9::initperks();
    ...
    if (!istrue(level.dev_build)) {
        ...
        add_demo_button_combo(["ads", "use", "a", "use_release", "a_release"], &namespace_5729d24318b60bcd::print_active_modules_to_screen, "show active modules", 2);
    }
    ...
    namespace_dba31853823d1b3::register_ai_damage_callbacks();
    namespace_dba31853823d1b3::register_ai_drop_funcs();
...
function function_2933e78a1455a35f() {
    ...
    wait 5;
    var_57acadc40b2f0a8 = function_be99aa6c661d4a(@"hash_eb91d378c179ba9f", 480 - 60);
    time_remaining = var_57acadc40b2f0a8[1];
    var_985d5155902ab692 = var_57acadc40b2f0a8[0];
    ...
    var_57acbdc40b2f2db = function_be99aa6c661d4a(@"hash_ed70323c9a6e966b", 480 - 30);
    time_remaining = var_57acbdc40b2f2db[1];
    var_985d5155902ab692 = var_57acbdc40b2f2db[0];
    ...
    var_45dd7a4f2de86ab2 = var_985d5155902ab692;
    var_57ad0dc40b2fdda = function_be99aa6c661d4a(@"hash_dee32f538dba0794", 480 - 15);
    time_remaining = var_57ad0dc40b2fdda[1];
    var_985d5155902ab692 = var_57ad0dc40b2fdda[0];
    function_c77bc7bf12f9b7e2(var_985d5155902ab692 - var_45dd7a4f2de86ab2, "COOP_GAME_PLAY/SERVER_SHUT_DOWN_WARNING_MINUTES", int(time_remaining));
    var_45dd7a4f2de86ab2 = var_985d5155902ab692;
    var_57ad1dc40b3000d = function_be99aa6c661d4a(@"hash_3c8fb3b02192f953", 480 - 5);
    time_remaining = var_57ad1dc40b3000d[1];
    var_985d5155902ab692 = var_57ad1dc40b3000d[0];
    function_c77bc7bf12f9b7e2(var_985d5155902ab692 - var_45dd7a4f2de86ab2, "COOP_GAME_PLAY/SERVER_SHUT_DOWN_WARNING_MINUTES", int(time_remaining));
    var_45dd7a4f2de86ab2 = var_985d5155902ab692;
    var_57acedc40b2f974 = function_be99aa6c661d4a(@"hash_4182434f66636da8", 480 - 2);
    time_remaining = var_57acedc40b2f974[1];
    var_985d5155902ab692 = var_57acedc40b2f974[0];
    function_c77bc7bf12f9b7e2(var_985d5155902ab692 - var_45dd7a4f2de86ab2, "COOP_GAME_PLAY/SERVER_SHUT_DOWN_WARNING_MINUTES", int(time_remaining));
    var_45dd7a4f2de86ab2 = var_985d5155902ab692;
    var_57acfdc40b2fba7 = function_be99aa6c661d4a(@"hash_a233b185b88f1a75", 480 - 1);
    time_remaining = var_57acfdc40b2fba7[1];
    var_985d5155902ab692 = var_57acfdc40b2fba7[0];
    function_c77bc7bf12f9b7e2(var_985d5155902ab692 - var_45dd7a4f2de86ab2, "COOP_GAME_PLAY/SERVER_SHUT_DOWN_WARNING_MINUTES", int(time_remaining));
    var_45dd7a4f2de86ab2 = var_985d5155902ab692;
    var_57ac4dc40b2e376 = function_be99aa6c661d4a(@"hash_3902a722e6cc08f8", 480 - 0.5);
    time_remaining = var_57ac4dc40b2e376[1];
    var_985d5155902ab692 = var_57ac4dc40b2e376[0];
    ...
    var_45dd7a4f2de86ab2 = var_985d5155902ab692;
    var_57ac5dc40b2e5a9 = function_be99aa6c661d4a(@"hash_b5e11430896dccca", 480 - 0.25);
    time_remaining = var_57ac5dc40b2e5a9[1];
    var_985d5155902ab692 = var_57ac5dc40b2e5a9[0];
    function_c77bc7bf12f9b7e2(var_985d5155902ab692 - var_45dd7a4f2de86ab2, "COOP_GAME_PLAY/SERVER_SHUT_DOWN_WARNING_SECONDS", int(time_remaining * 60));
    wait 1;
...
// Size: 0x32
function function_c77bc7bf12f9b7e2(var_626341d24c77db50, var_e301921436f4fe9d, time_remaining) {
    level endon("game_ended");
    wait var_626341d24c77db50 * 60;
    level thread scripts\cp\cp_hud_message::showerrormessagetoallplayers(var_e301921436f4fe9d, time_remaining);
}
...
function defaultplayerconnect() {
    ...
    namespace_c4cab616edf9b2b9::init_each_perk();
    namespace_1b51be0488919ce5::initplayerdamagefunctions();
    ...
    thread namespace_49f64a73fb8b35eb::function_36bcbfd3365dc368();
...
function function_6361f223bf803c8e() {
    self.var_5814d27874b48e54 = spawnstruct();
    self.var_5814d27874b48e54.player = self;
}
...
function function_b9953eb97ad6c0d2() {
    return self.var_5814d27874b48e54;
}
...
function function_ea9fc8f6656867d7() {
    if (isdefined(level.var_94c009bd348d6aa6)) {
        keys = getarraykeys(level.var_94c009bd348d6aa6);
        for (i = 0; i < keys.size; i++) {
            dvar = keys[i];
            value = level.var_94c009bd348d6aa6[dvar];
            setdvar(dvar, value);
        }
    }
}
...
function demo_debug_outline_settings() {
    setdvar(@"hash_4569f157ef7f2410", ".5 .5 .5 1");
    setdvar(@"hash_4569f257ef7f2643", "1 1 1 .2");
    setdvar(@"hash_9457f5e8293a0c84", "1 .25 .25 1");
    setdvar(@"hash_aa498f5035d9ef17", ".7 .7 .7 1");
    setdvar(@"hash_5aeb9ef51530defc", "1 0 0 1");
    setdvar(@"hash_9114f61ddde3b6a5", 1);
}
...
function track_forward_velocity() {
    ...
    while (true) {
        ...
        var_6941e2c17cff7386 = 5;
        if (isdefined(level.disable_recent_area_memory)) {
            var_6941e2c17cff7386 = level.disable_recent_area_memory;
        }
        cap = int(min(var_6941e2c17cff7386, self.velo_forward_memory.size));
        for (i = 0; i < cap; i++) {
...
function give_playtest_munitions() {
    ...
    if (allow_munitions(self)) {
        if (function_240f7f4e57340e8f()) {
            namespace_1f50a6a7107e9381::function_4a1fd54affdaa367("ammo_crate", 1, 0, 0, 1);
            namespace_1f50a6a7107e9381::function_4a1fd54affdaa367("armor", 1, 0, 0, 1);
            namespace_1f50a6a7107e9381::function_4a1fd54affdaa367("grenade_crate", 1, 0, 0, 1);
        } else {
            namespace_94359011b63230a6::give_munition_to_slot("ammo_crate", 1);
            namespace_94359011b63230a6::give_munition_to_slot("armor", 2);
            namespace_94359011b63230a6::give_munition_to_slot("grenade_crate", 3);
        }
    }
...
function playermonitor() {
    ...
    namespace_94359011b63230a6::function_77084f05581a035();
    thread player_broadcast();
    thread namespace_751288259782653c::change_loadout_watcher(self);
}
...
function function_5c8bea04d4909519() {
    var_c3e79e839862170 = namespace_1170726b2799ea65::function_50f02a42c72031cb(level.script);
    if (isdefined(var_c3e79e839862170) && var_c3e79e839862170 != "") {
        if (!getdvarint(@"hash_f94e2fa79e0fa73c", 0)) {
            scripts\cp\cp_checkpoint::function_24490b05670afa23(var_c3e79e839862170);
            game["restart_checkpoint"] = var_c3e79e839862170;
        }
    }
...
function function_bfc702532eead581() {
    ...
    flag_wait("level_ready_for_script");
    foreach (player in level.players) {
        player namespace_f8d3520d3483c1::function_1b593d5e688a409c();
    }
    level thread namespace_a0628d6954815ef8::function_f2525bf18abad733("iw9_armor_plate_deploy_mp");
}
...
function function_41f5e1b0d3379c5c(notification, slotindex) {
    if (isdefined(notification)) {
        ...
        case #"hash_2492121b9170f54f":
            var_22366ec9a93104db = 1;
            drop_type = undefined;
            count = undefined;
            switch (slotindex) {
            case 0:
                var_8334742fe1363a27 = namespace_6c67e93a4c487d83::get_player_currency();
                if (thread namespace_6c67e93a4c487d83::try_take_player_currency(var_8334742fe1363a27)) {
                    var_22366ec9a93104db = 1;
                    count = var_8334742fe1363a27;
                    drop_type = "brloot_plunder_cash_common_1";
                    if (var_8334742fe1363a27 >= 5000) {
                        drop_type = "brloot_plunder_cash_epic_1";
                    } else if (var_8334742fe1363a27 >= 2500) {
                        drop_type = "brloot_plunder_cash_rare_1";
                    } else if (var_8334742fe1363a27 >= 1000) {
            ...
            if (var_22366ec9a93104db && isdefined(drop_type) && isdefined(count)) {
                dropinfo = namespace_6250b14b3f614101::getitemdroporiginandangles(0, self.origin, self.angles, self);
                item = namespace_6250b14b3f614101::spawnpickup(drop_type, dropinfo, count, 1, undefined, 0);
            }
            break;
        case #"hash_25c924f29082a36":
            ...
            case 0:
                ...
                var_8334742fe1363a27 = namespace_6c67e93a4c487d83::get_player_currency();
                if (var_8334742fe1363a27 > 0) {
                    drop_amount = int(min(var_a1708bf4c9f30fd8, var_8334742fe1363a27));
                    if (thread namespace_6c67e93a4c487d83::try_take_player_currency(drop_amount)) {
                        drop_type = "brloot_plunder_cash_common_1";
                        count = drop_amount;
                        var_22366ec9a93104db = 1;
                    }
...
// Size: 0x76
function function_f9c71b46b5e50150(drop_type, var_a586c04e36b58e35) {
    if (self.br_ammo[drop_type] > 0) {
        if (self.br_ammo[drop_type] >= var_a586c04e36b58e35) {
            count = var_a586c04e36b58e35;
        } else {
            count = self.br_ammo[drop_type];
        }
        self.br_ammo[drop_type] = self.br_ammo[drop_type] - count;
        namespace_6250b14b3f614101::br_ammo_update_weapons();
        return count;
    }
    return undefined;
}
...
function function_5ce6e63df1d04eca() {
    ...
    self.enemy_list = [];
    self.assigned_ai = 0;
    thread namespace_9bb409deb69fb31d::setsquad("allies");
}
...
function function_3999591663b82c6a() {
    ...
    if (level.teambased) {
        self setclientdvar(@"hash_cc2997fd2acb23e0", 0);
    }
}
...
function forceendmonitor() {
    ...
    while (true) {
        ...
        if (channel == "scoreboard_open") {
            namespace_de6e6777b0937bd7::function_80820d6d364c1836("callback_open_tacmap", self);
        }
    }
}
...
// Size: 0x34
function function_fcd3a5870bcec50c(channel, value) {
    if (channel == "backpack_toggled") {
        if (value == 0) {
            namespace_6250b14b3f614101::function_f0a8d592bdde9818();
            return;
        }
        namespace_6250b14b3f614101::function_410042dc2cc03264();
    }
}
...
// Size: 0xba
function spawnintermission(var_1379934a423852ef) {
    level endon("exitLevel_called");
    self endon("disconnect");
    setglobalintermissionspawninfo();
    var_e87cc8634b3e137f = self.forcespawnangles;
    self function_bc667001f9dd3808(self.forcespawnorigin);
    wait 2;
...
function function_297bf30b6352b598(player) {
    ...
    if (isdefined(player.var_bfebcd1c49c31e8)) {
        var_10fd8ed3fed0e0ae = player.var_bfebcd1c49c31e8;
...
function spawnplayer_actual(fauxspawn, var_ef83a4d91df14784) {
    ...
    thread namespace_c4cab616edf9b2b9::markedentities_think();
    var_5814d27874b48e54 = namespace_162cff1cf88b9bbf::function_b9953eb97ad6c0d2();
    namespace_de6e6777b0937bd7::function_80820d6d364c1836("callback_on_player_spawned", var_5814d27874b48e54.player);
    ...
    if (istrue(level.var_2dce4d6dcb6c3fb9)) {
        ...
        namespace_47366e00aa4211f4::function_2dd3214261e60026();
    }
    if (istrue(self.bspawningviaac130)) {
        namespace_d4aab8c9cb8ecb14::give_fists_if_no_real_weapon(self);
        return;
    }
    if (!istrue(fauxspawn) && !namespace_1d99ddaf3fc03543::gamealreadyended()) {
...
function function_38b1b50f4ea21c32(fauxspawn, var_ef83a4d91df14784) {
    ...
    if (checkpoint != "") {
        spawnpoint = scripts\cp\cp_checkpoint::function_666625d0030969ff(checkpoint);
...
function function_3141ea1d420f1715() {
    ...
    while (true) {
        ...
        if (namespace_d4aab8c9cb8ecb14::everyone_else_all_in_laststand()) {
            level thread [[ level.endgame ]]("axis", level.end_game_string_index["kia"]);
        }
    }
}
...
function defaultplayerdisconnect(reason) {
    ...
    if (disconnectshouldforceend()) {
        ...
        if (level.players.size == 0) {
            level thread namespace_1d99ddaf3fc03543::endgame("axis", namespace_1d99ddaf3fc03543::get_end_game_string_index("host_end"));
        } else {
            level thread namespace_1d99ddaf3fc03543::endgame("axis", namespace_1d99ddaf3fc03543::get_end_game_string_index("kia"));
        }
    }
...
function disconnectshouldforceend() {
    ...
    gameshouldend = 0;
    for (i = 0; i < level.players.size; i++) {
        if (namespace_d4aab8c9cb8ecb14::player_in_laststand(level.players[i])) {
            gameshouldend = namespace_d4aab8c9cb8ecb14::function_5de995015a65e87d(level.players[i]);
        }
    }
...
// Size: 0x73
function function_fc091ec7a771f2ff() {
...
// Size: 0x1ee
function function_5c5d6f7b09d3c739() {
    ...
    level.minimaponbydefault = getdvarint(@"hash_2a4effcaf5954d38") != 0 || getdvarint(@"hash_bc802deb1ff2a842") != 0;
}
...
function init_laststand() {
    ...
    namespace_d4aab8c9cb8ecb14::default_player_init_laststand();
}
...
function player_broadcast() {
    ...
    while (true) {
        ...
        function_f3467e4343b7b3bf(self);
        wait 5;
    }
}
...
function broadcast_currency(player) {
    ...
    namespace_6c67e93a4c487d83::setcoopplayerdata_for_everyone("EoGPlayer", entity_num, "currency", currency);
}
...
// Size: 0x66
function function_f3467e4343b7b3bf(player) {
    entity_num = player getentitynumber();
    kit = player namespace_1f50a6a7107e9381::function_cc1ccc9e93b22c24();
    var_1bc8cc8ce771cc3 = player namespace_1f50a6a7107e9381::function_ca8c9ff1ff9db6e();
    namespace_6c67e93a4c487d83::setcoopplayerdata_for_everyone("EoGPlayer", entity_num, "playerRole", kit);
    namespace_6c67e93a4c487d83::setcoopplayerdata_for_everyone("EoGPlayer", entity_num, "playerKitTier", var_1bc8cc8ce771cc3);
}
...
function broadcast_carry_items(player) {
    ...
    namespace_6c67e93a4c487d83::setcoopplayerdata_for_everyone("EoGPlayer", entity_num, "carryItem2", player.carryitem2omnvar);
    namespace_6c67e93a4c487d83::setcoopplayerdata_for_everyone("EoGPlayer", entity_num, "carryItem", player.carryitemomnvar);
    namespace_6c67e93a4c487d83::setcoopplayerdata_for_everyone("EoGPlayer", entity_num, "carryItem3", player.var_70e7c265a77e6dbf);
}
...
function broadcast_status(player, status) {
    entity_num = player getentitynumber();
    namespace_6c67e93a4c487d83::setcoopplayerdata_for_everyone("EoGPlayer", entity_num, "playerStatus", status);
}
...
// Size: 0x56
function update_target_health_variable(var_e9d476a3809cb3f1, value) {
    wait 0.05;
    if (!isdefined(value)) {
        return;
    }
...
function allow_dvar_infammo() {
    ...
    namespace_44edfb3e2b433c17::team_unlimited_ammo();
}
...
function monitor_num_players() {
    ...
    var_4e272a6bb24a5e12 = getdvar(@"hash_6317f96738d7a501");
    if (var_4e272a6bb24a5e12 != "1") {
...
/#
    ...
    function function_872f994e74eaf646() {
        ...
        level thread function_699304dd575765c9(@"hash_90e1341238d237ef", &function_6bd125a80b48cd00);
        cmd = "<dev string:x135>";
...
function function_3543eaafa6b72b85() {
    ...
    function_e41a5e1dee804551(level.var_84e3a11b470d0db0, level.var_ad231d0daae0bad9);
}
...
function function_afb6191a17745644() {
    ...
    progress = namespace_c8d5de7d515ce477::function_ec4c795c2898be52(self, achievementid, "progress", 0);
    subprogress = namespace_c8d5de7d515ce477::function_ec4c795c2898be52(self, achievementid, "sub_progress", 0);
...
function function_862c0d6f4c473c6() {
    ...
    namespace_c8d5de7d515ce477::getstate(self, 10277);
}
...
function function_b1b93d51d4e1fde8() {
    self endon("disconnect");
    if (function_9b578c5917366e94(scripts\cp_mp\utility\game_utility::getmapname() + "_igc_infil")) {
    ...
    if (function_9b578c5917366e94(scripts\cp_mp\utility\game_utility::getmapname() + "_igc_exfil")) {
...
function userskip_wait() {
    self endon("disconnect");
    var_b57418fde4f91e90 = "userskipped";
    var_5a5437bab7d7156b = "stop_userskip";
    flags = [var_b57418fde4f91e90, var_5a5437bab7d7156b];
    foreach (flag in flags) {
        ent_flag_clear(flag);
    }
    self setclientomnvar("ui_is_bink_skippable", 1);
    thread function_b94781adf9f9ff2d();
    while (!ent_flag(var_5a5437bab7d7156b) && !ent_flag(var_b57418fde4f91e90)) {
        waitframe();
    }
    ...
    return ent_flag(var_b57418fde4f91e90);
}
