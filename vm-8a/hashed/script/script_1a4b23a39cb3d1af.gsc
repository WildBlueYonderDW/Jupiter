...
function private function_f9f0c202070afb63(dmg_struct) {
    ...
    if (!isdefined(var_357455e188e9e3b8)) {
        /#
            function_2cb1324178d89dec("<dev string:x2a>");
        #/
        return;
    }
    ...
    if (!isdefined(head_index)) {
        /#
            function_2cb1324178d89dec("<dev string:x3a>" + var_357455e188e9e3b8);
        #/
        return;
    }
    ...
    if (head_state != 2) {
        /#
            function_2cb1324178d89dec("<dev string:x52>" + head_state);
        #/
        return;
    }
    if (function_f042d86bacba063b()) {
        /#
            function_2cb1324178d89dec("<dev string:x6c>");
        #/
        return;
    }
...
function private abom_swallow(dmg_struct, head_index) {
    ...
    if (!isdefined(grenade)) {
        /#
            function_2cb1324178d89dec("<dev string:x8b>");
        #/
        return;
    }
...
function private function_fc8dd3d00ebca77b(dmg_struct) {
    ...
    if (isdefined(dmg_struct.einflictor)) {
        ...
        /#
            function_2cb1324178d89dec("<dev string:xad>");
        #/
        ...
        if (var_179bf7d9d8c893b1 > 3500) {
            /#
                function_2cb1324178d89dec("<dev string:xd3>" + var_179bf7d9d8c893b1);
            #/
        ...
        if (self.var_739e0470ae2ed359.eattacker != dmg_struct.eattacker || dmg_struct.sweapon.classname != "grenade" || dmg_struct.smeansofdeath != "MOD_GRENADE_SPLASH" && dmg_struct.smeansofdeath != "MOD_EXPLOSIVE") {
            /#
                if (self.var_739e0470ae2ed359.eattacker != dmg_struct.eattacker) {
                    function_2cb1324178d89dec("<dev string:xe9>");
                } else {
                    function_2cb1324178d89dec("<dev string:x114>" + dmg_struct.sweapon.classname + "<dev string:x132>" + dmg_struct.smeansofdeath);
                }
            #/
            return -1;
        }
        ...
        if (!isdefined(dmg_struct.metabonename) || dmg_struct.metabonename != var_c02b1f6c1721c844) {
            ...
            if (var_35391e999d5450b1 > 100) {
                /#
                    function_2cb1324178d89dec("<dev string:x139>" + var_c02b1f6c1721c844 + "<dev string:x163>" + sqrt(var_35391e999d5450b1));
                #/
                return -1;
            }
        }
...
/#
    ...
    function private function_14b998b3a980d6fe() {
        function_6e7290c8ee4f558b("<dev string:x16b>");
        function_a9a864379a098ad6("<dev string:x188>", "<dev string:x196>", &function_dce8d747fc906ca1);
    ...
    function private function_dce8d747fc906ca1() {
        function_2fb888667001fc39("<dev string:x196>", @"hash_e6612e812211addd");
    }
    ...
    function private function_2cb1324178d89dec(text, pos) {
        if (function_502e2f61c14586cc()) {
            ...
            print3d(pos, "<dev string:x1a9>" + text, (1, 0, 0));
        }
    }
