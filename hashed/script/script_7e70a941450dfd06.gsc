...
function function_b5a3a7840d51404a() {
    /#
        foreach (instance in level.contentmanager.spawnedinstances["<unknown string>"]) {
            foreach (wallbuy_spawn in instance.contentgroups["<unknown string>"]) {
                if (isdefined(wallbuy_spawn.var_2dda78d4f81fa52f)) {
                    nextrarity = "<unknown string>";
