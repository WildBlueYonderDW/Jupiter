...
#namespace jup_ob_helicopter_healthbar;

// Namespace jup_ob_helicopter_healthbar / namespace_183fd0f6eb720d4b
// Params 0, eflags: 0x0
// Checksum 0x0, Offset: 0x13d
// Size: 0x129
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_ob_helicopter_healthbar" );
