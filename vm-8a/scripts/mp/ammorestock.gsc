...
function init() {
    ...
    if (var_ae19c7aac20a601e) {
        ...
        println("<dev string:x1c>" + ter_op(isdefined(scripts\cp_mp\utility\game_utility::getlocaleid()), scripts\cp_mp\utility\game_utility::getlocaleid(), "<dev string:x3c>") + "<dev string:x41>" + ammorestocklocs.size);
        foreach (loc in ammorestocklocs) {
            ...
            println("<dev string:x56>" + loc.origin + "<dev string:x80>" + ter_op(isdefined(loc.script_noteworthy), loc.script_noteworthy, "<dev string:x3c>") + "<dev string:x97>" + ter_op(isdefined(loc.script_string), loc.script_string, "<dev string:x3c>"));
            addlocation(loc);
        }
...
function removelocation(loc) {
    println("<dev string:xaa>" + loc.origin + "<dev string:x80>" + ter_op(isdefined(loc.script_noteworthy), loc.script_noteworthy, "<dev string:x3c>") + "<dev string:x97>" + ter_op(isdefined(loc.script_string), loc.script_string, "<dev string:x3c>"));
    ...
    /#
        if (getdvarint(@"hash_d684f98557413539", 0) == 1) {
            print3d(loc.origin + (0, 0, 100), "<dev string:xd6>" + loc.origin[0] + "<dev string:xd9>" + loc.origin[1] + "<dev string:xd9>" + loc.origin[2] + "<dev string:xdc>", (1, 1, 1), 1, 1, 9999, 1);
...
function addlocation(loc) {
    ...
    /#
        if (getdvarint(@"hash_d684f98557413539", 0) == 1) {
            print3d(loc.origin + (0, 0, 200), "<dev string:xd6>" + loc.origin[0] + "<dev string:xd9>" + loc.origin[1] + "<dev string:xd9>" + loc.origin[2] + "<dev string:xdc>", (1, 1, 1), 1, 1, 9999, 1);
