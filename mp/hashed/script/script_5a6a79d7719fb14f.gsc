...
#namespace jup_enemy_mp_shotgun_tier2_aq_gwtdm;

// Namespace jup_enemy_mp_shotgun_tier2_aq_gwtdm / namespace_406a8171fff301a9
// Params 0, eflags: 0x0
// Checksum 0x0, Offset: 0x256
// Size: 0x1e0
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_mp_shotgun_tier2_aq_gwtdm" );
