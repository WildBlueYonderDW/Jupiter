...
// Namespace namespace_8da7b4544e88075 / scripts\cp\equipment\cp_gas_grenade
// Params 1, eflags: 0x0
...
function gas_takeheldoffhand() {
    ...
    equipmentref = namespace_4fb9dddfb8c1a67a::getequipmentreffromweapon(self.gastakenweaponobj);
    if (isdefined(equipmentref) && namespace_4fb9dddfb8c1a67a::hasequipment(equipmentref)) {
        self.gastakenweaponammo = namespace_4fb9dddfb8c1a67a::getequipmentammo(equipmentref);
...
function gas_restoreheldoffhand() {
    ...
    if (isdefined(equipmentref) && namespace_4fb9dddfb8c1a67a::hasequipment(equipmentref)) {
        ...
        slot = namespace_4fb9dddfb8c1a67a::findequipmentslot(equipmentref);
        ...
        namespace_4fb9dddfb8c1a67a::setequipmentammo(equipmentref, self.gastakenweaponammo);
