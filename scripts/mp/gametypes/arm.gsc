...
/#
    ...
    function function_e3a2a0c2e544728e(var_a4ab3e1ca5d220c4) {
        if (var_a4ab3e1ca5d220c4 <= 5) {
            ...
            var_8a33e220c4aaa38b = level.spawnselectionlocations[key]["<dev string:xe9>"].spawnpoints;
            var_4c00998026fee890 = level.spawnselectionlocations[key]["<dev string:xf1>"].spawnpoints;
