...
function function_69b64f047b0af1db(var_325752cb29127eeb) {
    ...
    event.list = [];
    if (!isdefined(level.var_3c59090ee220ab3d.events.var_cbd599cc41b2a3f1)) {
        ...
        level.var_3c59090ee220ab3d.events.var_cbd599cc41b2a3f1 = var_2a96d0ea58c991be;
    }
...
function function_712abddb7195a3ee() {
    ...
    self endon("death");
    event = self.var_3c59090ee220ab3d.var_3c91684198954c83.var_83f7c458a67d43;
    while (1) {
        pos = time = eventtype = potentialtarget = self waittill("known_event");
        if (isdefined(level.var_3c59090ee220ab3d.events.var_cbd599cc41b2a3f1[eventtype]) && isdefined(potentialtarget) && isdefined(eventtype) && isdefined(time) && isdefined(pos)) {
            soundevent = spawnstruct();
            soundevent.owner = potentialtarget;
            soundevent.time = time;
            soundevent.pos = pos;
            soundevent.type = level.var_3c59090ee220ab3d.events.var_cbd599cc41b2a3f1[eventtype];
