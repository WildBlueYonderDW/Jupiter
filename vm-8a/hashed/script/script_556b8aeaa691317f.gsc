...
/#
    ...
    function function_b13d8e46564cdfda(triggerint) {
        ...
        if (triggerint == 2) {
            thread scripts\mp\gametypes\br_public::playerplaygestureweaponanim("<dev string:x35>", 10);
            return;
        }
        if (triggerint == 3) {
            thread scripts\mp\gametypes\br_public::playerplaygestureweaponanim("<dev string:x5a>", 10);
        }
    }
