...
#namespace jup_enemy_mp_rpg_tier2_pmc;

// Namespace jup_enemy_mp_rpg_tier2_pmc / namespace_723a58217f71f6ea
// Params 0, eflags: 0x0
// Checksum 0x0, Offset: 0x24c
// Size: 0x1e0
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_mp_rpg_tier2_pmc" );
...
function precache()
{
    agent_type = "actor_jup_enemy_mp_rpg_tier2_pmc";
