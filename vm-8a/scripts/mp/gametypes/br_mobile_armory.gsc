...
function _mobilearmoryusethink() {
    ...
    while (true) {
        player = mobilearmory.interactiveelement waittill("trigger");
...
function _mobilearmorychooseclass(mobilearmory) {
    ...
    while (true) {
        channel, newclass = player waittill("luinotifyserver");
...
function _onenterdefaultstate(mobilearmory) {
    ...
    mobilearmory.interactiveelement hudoutlineenable(var_4430b08d5a2d47bf);
