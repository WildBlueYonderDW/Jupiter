...
function private function_31a1df98de27eb46() {
    ...
    while (true) {
        ...
        /#
            function_aa106600fcdbb98a("<dev string:x2a>" + self.health, self.origin);
        #/
    }
}
...
/#
    ...
    function function_2ece3ee2d2c0e61e() {
        ...
        function_a9a864379a098ad6("<dev string:x4f>", "<dev string:x5d>", &function_5f4b3863b545675a);
        function_a9a864379a098ad6("<dev string:x6b>", "<dev string:x79>", &function_a450b30425deff57);
    ...
    function private function_5f4b3863b545675a() {
        deathworm = function_6d1fbda4b8524ef2(level.players[0].origin, undefined, "<dev string:x87>");
        if (!isdefined(deathworm)) {
            return;
        }
        deathworm function_3e89eb3d8e3f1811("<dev string:x98>", 1);
    }
    ...
    function private function_a450b30425deff57() {
        function_2fb888667001fc39("<dev string:xa3>", @"hash_c4c95fbc22ee699");
    }
    ...
    function private function_aa106600fcdbb98a(text, pos) {
        if (function_d0c59a39b0e76afe()) {
            ...
            print3d(pos, "<dev string:xbb>" + text, (1, 0, 0));
        }
    }
