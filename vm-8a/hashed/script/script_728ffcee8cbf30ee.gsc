...
function getcontractdata(data) {
    ...
    /#
        scripts\engine\utility::registersharedfunc("<dev string:x1c>", "<dev string:x27>", &arrow_debug);
        scripts\engine\utility::registersharedfunc("<dev string:x1c>", "<dev string:x33>", &function_f8669d894e660ea7);
    #/
...
/#
    ...
    function function_b6ab17c43e9fe40() {
        ...
        if (isdefined(hostplayer)) {
            hostplayer iprintlnbold("<dev string:x49>");
        }
...
/#
    ...
    function function_9000295ffdaa9d30() {
        ...
        if (!isdefined(level.arrow.elementsall)) {
            ...
            foreach (element in level.arrow.var_5fb0d01b9af82ac3) {
                if (isdefined(element.elementbundle)) {
                    currentelement = getscriptbundle("<dev string:x7e>" + element.elementbundle);
                } else {
                    continue;
                }
                if (isdefined(currentelement.elementpartname)) {
    ...
    function function_2774b40f1e337be5(position, radius, r0, r1, r2, r3, r4, r5) {
        ...
        if (isdebug) {
            ...
            if (isplayer(player) && !isbot(player) && !isagent(player)) {
                ...
                print3d(position, "<dev string:xce>" + int(dist), color, 1, 0.666, 1, 1);
            }
...
function function_f517a8eefb0eb61a(team) {
    ...
    assertex(rewardindex >= 0 && rewardindex < level.arrow.elementorder.size, "<dev string:xd5>");
...
/#
    ...
    function arrow_debug(debugstate, containertype) {
        level endon("<dev string:x104>");
        scripts\mp\flags::gameflagwait("<dev string:x10f>");
        ...
        tablet = namespace_1eb3c4e0e28fac71::function_fe5d4d0a6a530b1e("<dev string:x11d>", hostplayer.origin, hostplayer.angles);
    ...
    function function_12c1190750917903(hostplayer) {
        ...
        level.arrow.props.bombsite arrow_bombsitereveal(hostplayer);
        level.arrow.props.bombsite function_9ad2b2a571d4cdc9("<dev string:x129>");
    ...
    function function_41cef746f62d255b() {
        function_9c74ccdaa1e15c02("<dev string:x12d>");
        self iprintlnbold("<dev string:x133>");
    ...
    function function_f33a978051a54089(containertype, hostplayer) {
        ...
        case 1: 
            elementid = "<dev string:x145>";
            break;
        case 2: 
            elementid = "<dev string:x149>";
            break;
        case 3: 
            elementid = "<dev string:x14d>";
            break;
        case 4: 
            elementid = "<dev string:x151>";
            break;
        case 5: 
            elementid = "<dev string:x155>";
            break;
        default: 
            elementid = "<dev string:x159>";
            break;
        }
        if (isdefined(elementid)) {
            level.arrow.elementlist = [];
    ...
    function function_f043348ce33d559a(spawnelements, host) {
        ...
        foreach (container in containers) {
            container function_3182e44bb20cc5af("<dev string:x15d>");
            container function_362afd02a416e0e1(1);
    ...
    function function_59b2eb79d7349cb4(container, host) {
        ...
        scriptable function_f3548416f24b0f48("<dev string:x16c>");
    ...
    function function_f8669d894e660ea7() {
        ...
        while (true) {
            ...
            if (debugstate == var_683e4f17a8072b0c) {
                vision = "<dev string:x174>";
                hostplayer iprintlnbold("<dev string:x174>");
            } else if (debugstate == var_e0d20d0e684b8698) {
                vision = "<dev string:x190>";
                hostplayer iprintlnbold("<dev string:x190>");
            } else if (debugstate == var_8db42550e6529a50) {
                vision = "<dev string:x1a7>";
                hostplayer iprintlnbold("<dev string:x1a7>");
            } else {
                vision = "<dev string:x1be>";
                hostplayer iprintlnbold("<dev string:x1be>");
            }
            hostplayer function_36f999a7c7ed0d32(1, vision, 0.5);
            wait 3;
            hostplayer function_36f999a7c7ed0d32(1, "<dev string:x1d8>", 0);
            wait 1;
