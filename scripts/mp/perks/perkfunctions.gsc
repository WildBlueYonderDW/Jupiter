...
// Namespace perkfunctions / scripts\mp\perks\perkfunctions
// Params 0, eflags: 0x0
// Checksum 0x0, Offset: 0xd08f
// Size: 0x79
function function_c83b5a6a9dae783a() {
    level endon("game_ended");
    self endon("death_or_disconnect");
    ...
    if (player _hasperk("specialty_grenade_bandolier")) {
        ...
        if (slot == "primary") {
            if (issubstr(equipment, "aether_blade")) {
                ...
                rechargetime = getdvarfloat(@"hash_63e37ef08c86ccc", 25);
            }
        } else if (issubstr(equipment, "blackhole") || issubstr(equipment, "monkey")) {
            rechargetime = getdvarfloat(@"hash_b0610c059ea24de9", 300);
        } else if (issubstr(equipment, "decoy")) {
            rechargetime = getdvarfloat(@"hash_4db65827e4f40d8a", 120);
        } else {
            rechargetime = getdvarfloat(@"hash_e912109249383dff", 25);
        }
...
function function_d3a88fbbd1592a94(var_d1a37ff59732b305) {
    ...
    foreach (equipment in self.var_85e3aca304e129b2) {
        if (isdefined(equipment) && isdefined(equipment.var_50d8a278fa3d1ddd)) {
            namespace_6c8a837ec98fe0b8::objective_playermask_addshowplayer(equipment.var_50d8a278fa3d1ddd, self);
        }
    }
}
...
function function_1665d49ac1a4f08e(mindistoverride, maxdistoverride) {
    ...
    /#
        if (istrue(getdvarint(@"hash_21a13d02148f35f5", 0))) {
            position = grenade waittill("<dev string:x221>");
...
// Namespace perkfunctions / scripts\mp\perks\perkfunctions
// Params 2, eflags: 0x0
// Checksum 0x0, Offset: 0x150d9
// Size: 0x1a0
function function_388eaeb897276caa(event, objweapon) {
    if (!isdefined(self.var_1ea761e3a3d0b5f7)) {
        return;
    }
    iskillstreakweapon = isdefined(objweapon) && namespace_e0ee43ef2dddadaa::iskillstreakweapon(objweapon);
