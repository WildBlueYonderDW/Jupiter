...
function function_3edb9b978dca8642(scriptable, value) {
    self.current_code = self.current_code + value;
...
function private function_f4ce626fde09f7e2(destination) {
    ...
    self.interact = namespace_5775ad2badedbcaa::register_interact(self.interact_position, 128, &function_3684a2eb8cb2f9d7, "SHARED_HINTSTRINGS/ZIP_DOOR_USE");
...
function private function_3684a2eb8cb2f9d7(player) {
    if (isdefined(player)) {
        if (!player namespace_7dfc6454a70f3f39::attempt_purchase("essence", 1000, 1, 0, #"zip_door")) {
            return;
        }
