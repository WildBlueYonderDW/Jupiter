...
function evaluatescore(bot) {
    ...
    finalscore = finalscore + function_9d1ab012058221bb(var_b5aeb4a2ae3657fd, self.constants.var_50cf5a797d61ae47, self.constants.var_f65cad93a3671678);
    finalscore = finalscore + self.constants.teammatemodifier[var_6f378a329663705a];
