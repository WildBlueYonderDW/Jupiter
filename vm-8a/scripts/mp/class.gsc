...
function loadout_updateabilities(struct, class) {
        ...
        /#
            if (perkpackage.size > 0) {
                foreach (perk in perkpackage) {
                    if (perk != "<dev string:x1c>") {
                        var_e8826231d6ac089d = 1;
                        break;
                    }
                }
                assertex(var_e8826231d6ac089d, "<dev string:x2b>");
            }
        #/
    ...
    /#
        ...
        foreach (perk in struct.loadoutperks) {
            assertex(isdefined(level.perkbundles[perk]) && isdefined(level.var_d5f3dcf05b7e8be6[perk]), "<dev string:x63>" + perk);
        }
    #/
}
    ...
    function function_a1c8aa2264227d22(class) {
        if (isbot(self)) {
            ...
            if (var_61f5d15d65ccb2ba > 0) {
                class = "<dev string:x86>" + var_61f5d15d65ccb2ba;
...
/#
    ...
    function function_58e92934b81cbc64(respawnitems) {
        ...
        assert(isdefined(respawnitems.weapons["<dev string:x8e>"]) && isdefined(respawnitems.weapons["<dev string:x8e>"].weaponobj) && isdefined(respawnitems.weapons["<dev string:x8e>"].clipammo) && isdefined(respawnitems.weapons["<dev string:x8e>"].stockammo));
        assert(!isdefined(respawnitems.weapons["<dev string:x96>"]) || isdefined(respawnitems.weapons["<dev string:x96>"].weaponobj) && isdefined(respawnitems.weapons["<dev string:x96>"].clipammo) && isdefined(respawnitems.weapons["<dev string:x96>"].stockammo));
    }
...
/#
    ...
    function function_fddb6546d1d0bc28(respawnitems) {
        ...
        assert(!isdefined(respawnitems.equipment["<dev string:x8e>"]) || isdefined(respawnitems.equipment["<dev string:x8e>"].item) && isdefined(respawnitems.equipment["<dev string:x8e>"].ammo));
        assert(!isdefined(respawnitems.equipment["<dev string:x96>"]) || isdefined(respawnitems.equipment["<dev string:x96>"].item) && isdefined(respawnitems.equipment["<dev string:x96>"].ammo));
    }
...
/#
    ...
    function function_6f401b52c8322c1b(respawnitems) {
        ...
        if (respawnitems.superstate.super == "<dev string:xa0>") {
