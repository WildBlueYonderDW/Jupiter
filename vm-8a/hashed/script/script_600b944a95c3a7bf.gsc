...
function function_7d267b05c8f10c00() {
    ...
    for (i = 0; i < consumablelist.size; i++) {
        ...
        if (!isdefined(consumablebundle)) {
            println("<dev string:x49>" + projectscriptbundle.consumablelist + "<dev string:x7f>" + consumablelist[i].bundle);
            continue;
        }
...
function function_43b02b62387ec23e(consumableref) {
    ...
    println("<dev string:x82>" + consumableref);
    return undefined;
}
