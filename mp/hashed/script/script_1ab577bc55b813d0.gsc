...
function postinitfunc() {
    ...
    level.var_c8b9f26dcad07806.var_b6bb62bb4ae02eb8 = getdvarint(@"hash_d0cf244a05155e7d", 1) > 0;
...
function function_1739cfa5c3d3c5c1() {
    foreach (team, contract in level.contractmanager.var_b6fae9c9655c73bf) {
        ...
        if (istrue(level.var_c8b9f26dcad07806.var_b6bb62bb4ae02eb8)) {
            ...
            var_a47dc60b683f8e12 = namespace_1eb3c4e0e28fac71::function_cecc87ac1b243e3c(contract, contract.var_d154ac2657c5f44, team);
        }
...
function onplayerrespawn(params) {
    ...
    if (!isdefined(player) || arraycontains(level.var_c8b9f26dcad07806.eventdata.var_63f39a17b089760a, player.team)) {
        return;
    }
    ...
    if (isdefined(newtarget)) {
        ...
        level.var_c8b9f26dcad07806.eventdata.var_63f39a17b089760a = function_6d6af8144a5131f1(level.var_c8b9f26dcad07806.eventdata.var_63f39a17b089760a, player.team);
    }
}
