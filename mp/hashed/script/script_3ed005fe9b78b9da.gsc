...
function initpostmain() {
    ...
    level.var_ec4da42b3bbf344c.var_a4a60d445462181d = getdvarint(@"hash_b5ac32636b6ff882", 0);
...
function function_a17e5100d67f2109(powerstruct, powerref) {
    ...
    while (true) {
        ...
        var_c2e9f5c23c888ee4 = function_71d599be2232ae52(self.class, powerref);
        if (isdefined(var_c2e9f5c23c888ee4) && isdefined(var_c2e9f5c23c888ee4.var_fb3a9f61fc511db4)) {
            func = var_c2e9f5c23c888ee4.var_fb3a9f61fc511db4;
...
function function_539dc27334184e77(powerstruct) {
    foreach (powerref, var_8723cff430a72c82 in powerstruct.powers) {
        if (isdefined(var_8723cff430a72c82.var_1a5269312d3a0b00)) {
            var_c2e9f5c23c888ee4 = function_71d599be2232ae52(self.class, powerref);
            if (isdefined(var_c2e9f5c23c888ee4) && isdefined(var_c2e9f5c23c888ee4.var_1a5269312d3a0b00)) {
                self thread [[ var_c2e9f5c23c888ee4.var_1a5269312d3a0b00 ]](powerstruct, powerref);
                continue;
            }
