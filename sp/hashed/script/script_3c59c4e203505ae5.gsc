...
#namespace jup_enemy_police_pistol;

// Namespace jup_enemy_police_pistol / namespace_25ada56fc4077a67
// Params 0, eflags: 0x0
// Checksum 0x0, Offset: 0x21f
// Size: 0x19b
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_police_pistol" );
