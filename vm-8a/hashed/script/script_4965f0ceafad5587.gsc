...
/#
    ...
    function private function_c9e6fc61ad0c665f() {
        var_f041094a76e3b231 = ["<dev string:x1c>", "<dev string:x31>", "<dev string:x48>", "<dev string:x59>", "<dev string:x6b>", "<dev string:x82>", "<dev string:x92>", "<dev string:xa7>", "<dev string:xb9>", "<dev string:xca>", "<dev string:xe0>", "<dev string:xee>", "<dev string:xfe>"];
        devgui::function_6e7290c8ee4f558b("<dev string:x115>");
        foreach (var_45191fa57864b212 in var_f041094a76e3b231) {
            ...
            if (isdefined(n_required)) {
                var_cbbc62a23ead5290 = "<dev string:x130>" + var_45191fa57864b212;
                devgui::function_b23a59dfb4ca49a1(var_45191fa57864b212, var_cbbc62a23ead5290, &function_e07c698369eb6f3e);
            }
        }
        devgui::function_fe953f000498048f();
        devgui::function_6e7290c8ee4f558b("<dev string:x14a>");
        foreach (var_45191fa57864b212 in var_f041094a76e3b231) {
            n_required = function_a08380cd8b1316e5(var_45191fa57864b212);
            if (isdefined(n_required)) {
                var_8d08f244175aa0ac = "<dev string:x164>" + var_45191fa57864b212 + "<dev string:x17d>" + n_required;
            } else {
                var_8d08f244175aa0ac = "<dev string:x164>" + var_45191fa57864b212;
            }
...
function private on_player_revived(params) {
    ...
    if (isplayer(reviver)) {
        a_squad = reviver namespace_ca7b90256548aa40::getsquadmembers();
