...
#namespace jup_enemy_mp_ar_tier1_aq_gwtdm;

// Namespace jup_enemy_mp_ar_tier1_aq_gwtdm / namespace_41ba798aab75940b
// Params 0
// Checksum 0x0, Offset: 0x270
// Size: 0x1de
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_mp_ar_tier1_aq_gwtdm" );
...
function precache()
{
    ...
    if ( !isdefined( level.agent_definition[ agent_type ] ) )
    {
        ...
        namespace_fddc7e68d2378838::precache_cpmp();
        namespace_fddc8168d2378ed1::precache_cpmp();
        namespace_fddc8068d2378c9e::precache_cpmp();
        namespace_fddc8368d2379337::precache_cpmp();
        namespace_fddc8268d2379104::precache_cpmp();
    }
