...
function function_5dee7155086e9ada() {
    /#
        ...
        scripts/common/devgui::function_a9a864379a098ad6("<unknown string>", "<unknown string>", &function_1c35bcf919ecbf37);
        scripts/common/devgui::function_a9a864379a098ad6("<unknown string>", "<unknown string>", &function_3f460c87ff0d374);
        scripts/common/devgui::function_a9a864379a098ad6("<unknown string>", "<unknown string>", &function_d9f3e7f2b05c8ed9);
        scripts/common/devgui::function_a9a864379a098ad6("<unknown string>", "<unknown string>", &function_5c2f254d18707855);
...
function function_915ba9b028110d40() {
    ...
    foreach (info in level.arrow.teaminfo) {
        players = scripts/mp/utility/teams::getteamdata(info.targetteam, "players");
...
function function_5c2f254d18707855() {
    /#
        ...
        cratestruct.task.type.ref = "<unknown string>";
        ...
        level.var_81e77c935dfefd11.teaminstances[level.player.team].ref = "<unknown string>";
...
function function_1c35bcf919ecbf37() {
    /#
        ...
        println("<unknown string>" + level.var_a42d57d98410ffa8.chopperhealth);
        println("<unknown string>");
    #/
}
