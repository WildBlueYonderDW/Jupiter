...
function updatehitmarker(markertype, killingblow, headshot, nonplayer, icontype, targetentnum, var_f7ea2887b1e3535b, var_203066c6662e1f2d) {
    ...
    if (getdvarint(@"hash_2909726ff0e12a7d", 0) == 1 && isdefined(level.gamemodebundle) && istrue(level.gamemodebundle.var_e76a5e57e1ff6b9b)) {
        ...
        switch (markertype) {
        case 1:
            markerflag = markerflag | 1 << 0;
            if (killingblow) {
                markerflag = markerflag | 1 << 1;
            }
            if (isdefined(var_203066c6662e1f2d) && istrue(var_203066c6662e1f2d.isfriendly)) {
                markerflag = markerflag | 1 << 2;
            }
            if (headshot) {
                markerflag = markerflag | 1 << 3;
            }
...
function function_a76226d272200c64() {
    /#
        if (getdvarint(@"hash_2909726ff0e12a7d", 0) == 1 && isdefined(level.gamemodebundle) && istrue(level.gamemodebundle.var_e76a5e57e1ff6b9b)) {
            ...
            scripts/common/devgui::function_df648211d66cd3dd("<unknown string>", "<unknown string>");
            scripts/common/devgui::function_df648211d66cd3dd("<unknown string>", "<unknown string>");
            scripts/common/devgui::function_df648211d66cd3dd("<unknown string>", "<unknown string>");
            scripts/common/devgui::function_df648211d66cd3dd("<unknown string>", "<unknown string>");
            scripts/common/devgui::function_df648211d66cd3dd("<unknown string>", "<unknown string>");
            scripts/common/devgui::function_df648211d66cd3dd("<unknown string>", "<unknown string>");
            scripts/common/devgui::function_a9a864379a098ad6("<unknown string>", "<unknown string>", &function_f4137b4aff2d357f);
            scripts/common/devgui::function_a9a864379a098ad6("<unknown string>", "<unknown string>", &function_244f7ed1bde7a922);
            scripts/common/devgui::function_a9a864379a098ad6("<unknown string>", "<unknown string>", &function_9b3b346bf41b42ec);
            scripts/common/devgui::function_a9a864379a098ad6("<unknown string>", "<unknown string>", &function_dedbab246909a68b);
            scripts/common/devgui::function_a9a864379a098ad6("<unknown string>", "<unknown string>", &function_e9943edf01fae246);
            scripts/common/devgui::function_a9a864379a098ad6("<unknown string>", "<unknown string>", &function_12f0988382364fc5);
            scripts/common/devgui::function_a9a864379a098ad6("<unknown string>", "<unknown string>", &function_aad4b8e06fba7712);
            scripts/common/devgui::function_a9a864379a098ad6("<unknown string>", "<unknown string>", &function_5ccbb72c64ed64b0);
            scripts/common/devgui::function_a9a864379a098ad6("<unknown string>", "<unknown string>", &function_a481845bd08b83ea);
            scripts/common/devgui::function_a9a864379a098ad6("<unknown string>", "<unknown string>", &function_3cef16eb6c7ab7f5);
            scripts/common/devgui::function_a9a864379a098ad6("<unknown string>", "<unknown string>", &function_4a73df03aaeb1f40);
            scripts/common/devgui::function_a9a864379a098ad6("<unknown string>", "<unknown string>", &function_4b5b7c47cb916820);
            scripts/common/devgui::function_a9a864379a098ad6("<unknown string>", "<unknown string>", &function_7d67bfa0977275ef);
            scripts/common/devgui::function_a9a864379a098ad6("<unknown string>", "<unknown string>", &function_5ba699d40ad475b5);
            scripts/common/devgui::function_a9a864379a098ad6("<unknown string>", "<unknown string>", &function_847c3a90c31506da);
            scripts/common/devgui::function_a9a864379a098ad6("<unknown string>", "<unknown string>", &function_ff8a5baefaf2044);
            scripts/common/devgui::function_a9a864379a098ad6("<unknown string>", "<unknown string>", &function_f1c42880c41252b3);
            scripts/common/devgui::function_a9a864379a098ad6("<unknown string>", "<unknown string>", &function_c98bce4a7d0771f5);
            scripts/common/devgui::function_a9a864379a098ad6("<unknown string>", "<unknown string>", &function_21d0791f2931f95);
            scripts/common/devgui::function_a9a864379a098ad6("<unknown string>", "<unknown string>", &function_a319100f1b453a35);
            scripts/common/devgui::function_a9a864379a098ad6("<unknown string>", "<unknown string>", &function_fc755361ba8bc81);
            scripts/common/devgui::function_a9a864379a098ad6("<unknown string>", "<unknown string>", &function_fb89825e361fc1f0);
...
function function_f4137b4aff2d357f() {
    /#
        ...
        foreach (player in level.players) {
            player function_697d593ebcb428dd("<unknown string>", markerflag);
        }
    #/
}
