...
#using scripts\mp\maps\mp_jup_estate\gen\mp_jup_estate_art;
#using scripts\mp\maps\mp_jup_estate\mp_jup_estate_fx;
#using scripts\mp\maps\mp_jup_estate\mp_jup_estate_lighting;
...
function main()
{
    scripts\mp\maps\mp_jup_estate\gen\mp_jup_estate_art::main();
    scripts\mp\maps\mp_jup_estate\mp_jup_estate_fx::main();
    scripts\mp\maps\mp_jup_estate\mp_jup_estate_lighting::main();
