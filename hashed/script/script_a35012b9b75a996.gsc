...
// Size: 0x66
function function_13efd74a5091dc42(shockstick, var_c21cbb75e13200d4) {
    if (self == shockstick) {
        return 0;
    }
    if (!isdefined(self)) {
    ...
    while (ticks < var_5112e7794dca9367) {
        ...
        foreach (ent in ents) {
            if (!isdefined(ent)) {
                ...
                if (!ent function_13efd74a5091dc42(self)) {
                    /#
                    ...
                    /#
                        print("fire" + ent getentitynumber() + "<unknown string>");
                    #/
                    thread function_cf4ff41f0ae2047f(ent, objweapon, var_46d6554bcb2371a1);
...
function function_afa7236ce2426c99(victim) {
    ...
    foreach (target in targets) {
        thread function_cf4ff41f0ae2047f(target.ent, objweapon, 0);
    }
}
...
// Size: 0x128
function function_cf4ff41f0ae2047f(victim, objweapon, chain) {
    level endon("game_ended");
