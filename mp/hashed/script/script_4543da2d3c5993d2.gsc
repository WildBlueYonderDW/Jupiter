...
#namespace jup_ob_enemy_basic_grunt;

// Namespace jup_ob_enemy_basic_grunt / namespace_be1f12aa953a539a
// Params 0
// Checksum 0x0, Offset: 0x274
// Size: 0x1b1
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_ob_enemy_basic_grunt" );
