...
function private function_235edea6ee22bab3() {
    ...
    /#
        ...
        if (shotorder != "<dev string:x1c>") {
            introvariation = "<dev string:x1d>" + shotorder[0];
            outrovariation = "<dev string:x1d>" + shotorder[1];
        }
    #/
    shotslist[0] = shotslist[0] + introvariation;
    shotslist[1] = shotslist[1] + introvariation;
    shotslist[2] = shotslist[2] + introvariation;
    shotslist[3] = shotslist[3] + outrovariation;
    shotslist[4] = shotslist[4] + outrovariation;
    return shotslist;
}
...
function private function_93b66df7957f429(var_acd6e67641545f5a) {
    ...
    /#
        ...
        if (shot != "<dev string:x1c>") {
            variation = "<dev string:x1d>" + shot;
        }
    #/
    shotslist[0] = shotslist[0] + variation;
    shotslist[1] = shotslist[1] + variation;
    shotslist[2] = shotslist[2] + variation;
    shotslist[3] = shotslist[3] + variation;
    shotslist[4] = shotslist[4] + variation;
    return shotslist;
}
...
/#
    ...
    function private function_327d687c7f00c05d() {
        self waittill("<dev string:x1f>");
        if (self.var_8740420879100bee scene::get_state() == "<dev string:x34>") {
