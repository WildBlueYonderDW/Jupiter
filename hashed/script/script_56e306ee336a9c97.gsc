...
// Namespace c17_infil / namespace_490baaae4ec3af6f
// Params 1, eflags: 0x0
...
function function_36154e36d2455566() {
    ...
    if (isdefined(deploy_node)) {
        ...
        var_c1d6ed48ac403e55 = deploy_node.angles;
        self setorigin(var_435fa2dd84aa96ea, 1);
    }
    self setplayerangles(var_c1d6ed48ac403e55);
