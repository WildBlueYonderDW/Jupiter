...
function function_d7a7aa9ee1cc1071() {
    ...
    /#
        scripts/engine/utility::registersharedfunc("loadoutSuper", "resurgenceVengeanceDecreaseRespawnDelay", &function_98609987fbc9bcc3);
    #/
...
function function_ece0d8ae46d230c8() {
    ...
    packedvalue = packedvalue + (missionvalue << 8);
    return packedvalue;
}
...
function function_d33f6589a1c04ee9(var_92a674d94df29e77) {
    ...
    if (istrue(level.brgametype.var_7b3746fd57041fb7)) {
        ...
        var_92a674d94df29e77.respawndelta = var_92a674d94df29e77.respawndelta + level.brgametype.var_2cfdc1d6e92251bf;
...
function function_3709903d7ad3f711(player, evictim, event, points, var_645b1a1d2a1ddfb7) {
    ...
    if (is_equal(event, "br_kioskBuy") && is_equal(var_645b1a1d2a1ddfb7, "br_team_revive")) {
        var_780d8a24242378d5 = scripts/mp/utility/teams::getteamdata(player.team, "aliveCount");
        squadsize = scripts/mp/utility/teams::getteamdata(player.team, "teamCount");
...
function function_4e47f37a50cbac36(player, delaymodifier) {
    if (isdefined(player.respawndelay) && player.respawndelay > 0) {
        ...
        player.respawndelta = player.respawndelta + delaymodifier;
    }
}
...
function function_249ed663848b0e5f(player, delaymodifier, event) {
    ...
    foreach (dead in deadplayers) {
        if (isdefined(dead) && isdefined(dead.player) && dead.player != player) {
            if (dead.player.respawndelay > 0) {
                ...
                dead.player.respawndelta = dead.player.respawndelta + delaymodifier;
    ...
    if (var_7cd081d8bbc27830) {
        if (istrue(player.var_5c3b157495f480a2)) {
            player.var_5449b5708779ee8e = player.var_5449b5708779ee8e + delaymodifier;
            return;
        }
...
";
        ...
        foreach (name in flagnames) {
            gameflags = gameflags + name + " -> " + game["flags"][name] + "
";
        }
        errormsg = errormsg + gameflags;
...
function function_9e3c77b199d3c8c8(forceshow) {
    /#
        ...
        /#
            assert(isdefined(spectated), "resurgence2");
        #/
    #/
}
...
function debug_init() {
    /#
        ...
        scripts/common/devgui::function_6e7290c8ee4f558b(" became the best team beating team ");
        scripts/common/devgui::function_a9a864379a098ad6("<unknown string>", "<unknown string>", &function_cec96fed16a6d8e8);
        scripts/common/devgui::function_a9a864379a098ad6("<unknown string>", "<unknown string>", &function_eaf6e107769f9877);
...
function function_cec96fed16a6d8e8() {
    /#
        ...
        namespace_1eb3c4e0e28fac71::utilflare_shootflare(shoot_pos, "<unknown string>");
    #/
}
