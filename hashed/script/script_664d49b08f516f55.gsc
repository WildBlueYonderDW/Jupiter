...
function function_6475bae53da4eb10() {
    ...
    level.var_30a959d3248e68af = spawnstruct();
    level.var_30a959d3248e68af.origin = door.origin;
    level.var_30a959d3248e68af.angles = door.angles;
    level.var_30a959d3248e68af.door = door;
    level.var_30a959d3248e68af.clip = clip;
    level.var_30a959d3248e68af.struct = struct;
    clip linkto(door);
    ...
    level.var_30a959d3248e68af.door2 = door;
    level.var_30a959d3248e68af.struct2 = var_8cc17c239e3cb1be;
}
...
function function_97b8fd183c25fd05() {
    ...
    while (true) {
        ...
        selfeye = self geteye();
        if (within_fov(playereye, playerangles, selfeye, var_40696cd423823a88)) {
            break;
        }
        if (within_fov(playereye, playerangles, struct.origin, var_40696cd423823a88)) {
            break;
        }
    }
...
function function_ec9a35eb23caf07c(trigger) {
    ...
    level.var_30a959d3248e68af.door2 rotateto(level.var_30a959d3248e68af.struct2.angles, var_d1e5bc9c621233e2);
    level.var_30a959d3248e68af.door2 moveto(level.var_30a959d3248e68af.struct2.origin, var_d1e5bc9c621233e2);
    level.var_30a959d3248e68af.door2 playsound("scn_door_metal_heavy_close_fast");
}
...
function function_e92fa2aa650b3963() {
    ...
    level.player.var_f296f7e55b9e9150 = getdvarint(@"cg_targetBaseFov");
