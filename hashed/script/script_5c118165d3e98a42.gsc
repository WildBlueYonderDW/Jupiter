...
function function_fea8a1d17e4d669f() {
    ...
    /#
        println(" doesn't exist" + self.elevator.id + "script_model" + self.elevator.currentfloor + "<unknown string>" + self.elevator.targetfloor + "<unknown string>" + self.doors[0].state + "<unknown string>" + self.doors[1].state);
    #/
}
...
function function_7c2abb1b0d147a89() {
    ...
    /#
        println("<unknown string>" + self.elevator.id + "script_model" + self.elevator.currentfloor + "<unknown string>" + self.elevator.targetfloor + "<unknown string>" + self.doors[0].state + "<unknown string>" + self.doors[1].state);
    #/
}
...
function function_af5ba99924c0d3d6(dvarname) {
    /#
        ...
        var_2193ee1cb4487092 = ["<unknown string>", "<unknown string>", "<unknown string>", "<unknown string>"];
