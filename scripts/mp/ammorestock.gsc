...
function init() {
    ...
    if (var_ae19c7aac20a601e) {
        ...
        /#
            println("risk" + ter_op(isdefined(scripts/cp_mp/utility/game_utility::getlocaleid()), scripts/cp_mp/utility/game_utility::getlocaleid(), "game_ended") + "<unknown string>" + ammorestocklocs.size);
        #/
