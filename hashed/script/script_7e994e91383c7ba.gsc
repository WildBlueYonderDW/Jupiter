    ...
    if (!islargemap() && isdefined(level.heli_structs_entrances) && level.heli_structs_entrances.size > 0) {
        ...
        if (issharedfuncdefined("chopper_gunner", "findTargetStruct")) {
            ...
            if (isdefined(goalstruct)) {
                ...
                /#
                    owner iprintlnbold("chopper_gunner" + entrancestruct.script_linkto + "tag_origin");
                #/
            }
        }
    }
...
function function_1a2daa72951eb0a4() {
    /#
        ...
        escortowner notifyonplayercommand("iw9_mp_esc_airdrop_pack_l", "<unknown string>");
        escortowner notifyonplayercommand("iw9_mp_esc_airdrop_pack_l", "<unknown string>");
        while (true) {
            ...
            escortowner waittill("iw9_mp_esc_airdrop_pack_l");
...
function function_190c881f4cd38bf2() {
    /#
        ...
        turretfiretime = weaponfiretime("<unknown string>");
        var_de95d26a97999b92 = undefined;
        attackradius = 80;
        ...
        if (targettrace["<unknown string>"] != "<unknown string>") {
            var_de95d26a97999b92 = targettrace["<unknown string>"];
        } else {
            return;
        }
        testtarget = undefined;
        if (!isdefined(self.testtarget)) {
            testtarget = spawn("<unknown string>", var_de95d26a97999b92);
            testtarget setmodel("<unknown string>");
