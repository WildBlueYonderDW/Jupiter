...
function function_94b3d4076f1146ab() {
    ...
    amount, attacker, direction, point, means_of_death, model, tag, part_name, var_e31132044354eb0, weapon_name = self waittill("damage");
...
function function_c89de017c526954() {
    ...
    while (true) {
        idamage, eattacker, vdir, vpoint, damage_mod, smodelname, stagname, spartname, idflags, objweapon, origin, angles, normal, einflictor, eventid = self waittill("damage");
