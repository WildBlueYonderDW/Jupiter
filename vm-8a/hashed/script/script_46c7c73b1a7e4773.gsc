...
/#
    ...
    function private function_a0dc56fbe58ef8c3() {
        function_6e7290c8ee4f558b("<dev string:x6b>");
        function_a9a864379a098ad6("<dev string:x89>", "<dev string:xb2>", &function_8da31be1c7c3ed93);
        function_a9a864379a098ad6("<dev string:xc4>", "<dev string:xee>", &function_5342bd4e7a1c6d83);
        function_a9a864379a098ad6("<dev string:x101>", "<dev string:x12d>", &function_12a19de3d2346cbe);
        function_a9a864379a098ad6("<dev string:x142>", "<dev string:x16f>", &function_cd70135e68209b24);
        function_a9a864379a098ad6("<dev string:x185>", "<dev string:x1b0>", &function_44bea892ed0bc101);
        function_a9a864379a098ad6("<dev string:x1c3>", "<dev string:x1ec>", &function_5d400e584442179b);
    ...
    function private function_8da31be1c7c3ed93() {
        foreach (player in level.players) {
            for (i = 0; i < 50; i++) {
                player function_484194ec6ace15bb("<dev string:x1fd>");
            }
            player function_f10f600ac4ee4c09("<dev string:x21a>", 1, 0);
            for (i = 0; i < 10; i++) {
                player function_f10f600ac4ee4c09("<dev string:x234>", 1, 0);
            }
        }
    }
    ...
    function private function_5342bd4e7a1c6d83() {
        foreach (player in level.players) {
            for (i = 0; i < 50; i++) {
                player function_484194ec6ace15bb("<dev string:x250>");
            }
            player function_9db4c37d4f1415f("<dev string:x263>");
            player function_f10f600ac4ee4c09("<dev string:x27b>", 1, 0);
        }
    }
    ...
    function private function_12a19de3d2346cbe() {
        foreach (player in level.players) {
            for (i = 0; i < 50; i++) {
                player function_484194ec6ace15bb("<dev string:x292>", 2);
            }
            player function_f10f600ac4ee4c09("<dev string:x2aa>", 2, 0);
            player function_9db4c37d4f1415f("<dev string:x2be>");
        }
    }
    ...
    function private function_cd70135e68209b24() {
        foreach (player in level.players) {
            player function_f10f600ac4ee4c09("<dev string:x2cf>", 2, 0);
            player function_9db4c37d4f1415f("<dev string:x2e2>");
        }
    }
    ...
    function private function_44bea892ed0bc101() {
        foreach (player in level.players) {
            for (i = 0; i < 50; i++) {
                player function_484194ec6ace15bb("<dev string:x2fa>", 2);
            }
            player function_f10f600ac4ee4c09("<dev string:x313>", 2, 0);
            player function_9db4c37d4f1415f("<dev string:x32c>");
        }
    }
    ...
    function private function_5d400e584442179b() {
        foreach (player in level.players) {
            for (i = 0; i < 50; i++) {
                player function_484194ec6ace15bb("<dev string:x33b>", 2);
            }
            player function_f10f600ac4ee4c09("<dev string:x35a>", 2, 0);
            player function_9db4c37d4f1415f("<dev string:x32c>");
        }
    }
...
function function_3875d2b5b87e7e7d(victimstruct, objweapon, meansofdeath, inflictor) {
    ...
    if (!iskillstreakweapon(objweapon) && isplayer(self)) {
        ...
        if (attackerisinflictor) {
            ...
            } else if (scripts\mp\events::function_78dbf8d8bcbed882(self, meansofdeath)) {
