...
#using scripts\mp\maps\mp_jup_rust\gen\mp_jup_rust_art;
#using scripts\mp\maps\mp_jup_rust\mp_jup_rust_fx;
#using scripts\mp\maps\mp_jup_rust\mp_jup_rust_lighting;
...
function main()
{
    scripts\mp\maps\mp_jup_rust\gen\mp_jup_rust_art::main();
    scripts\mp\maps\mp_jup_rust\mp_jup_rust_fx::main();
    scripts\mp\maps\mp_jup_rust\mp_jup_rust_lighting::main();
    level.var_cceea51a1fecb716 = &scripts\mp\gametypes\aon::main;
    scripts\mp\load::main();
    level.outofboundstriggers = getentarray( "OutOfBounds", "targetname" );
    level.kill_border_triggers = getentarray( "kill_border_trigger", "targetname" );
    scripts\mp\compass::setupminimap( "compass_map_mp_jup_rust" );
