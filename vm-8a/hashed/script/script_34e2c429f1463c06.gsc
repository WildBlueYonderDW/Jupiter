...
function function_65c2611eff3a7dc4(camera) {
    ...
    while (true) {
        ...
        if (camera.pilot == self) {
            /#
                printtoscreen2d(180, 30, "<dev string:x1c>", (0, 0, 0), 2, 150);
            #/
...
function function_f8c09eabc74d0ca3(camera) {
    ...
    while (true) {
        ...
        if (camera.pilot == self) {
            ...
            /#
                printtoscreen2d(180, 30, "<dev string:x5f>", (0, 0, 0), 2, 150);
            #/
...
function private function_1ff427dc4b377abc(camera, forcewatcher) {
    ...
    /#
        printtoscreen2d(180, 30, "<dev string:x75>" + "<dev string:x7a>" + "<dev string:x82>" + "<dev string:x99>" + "<dev string:xa3>", (0, 0, 0), 2, 300);
    #/
}
