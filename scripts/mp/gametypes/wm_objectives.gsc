...
function function_3683331ec49168ba() {
    ...
    self.health = 9999999;
    while (true) {
        amount, attacker, direction_vec, damagelocation, meansofdeath, modelname, tagname, partname, dflags, objweapon = self waittill("damage");
    }
}
