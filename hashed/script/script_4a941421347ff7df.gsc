...
function function_8cda6b3ceb41b954() {
    ...
    namespace_10ca308be68952f::createevent(var_e217a69d1c18e3a4, var_dc4d6d091a7eaa09, var_aa0962b79aaca485, var_daf0a79cbe5456f6, var_c30b9eb47d7fc21c, var_23ede9cf81e42751);
...
function function_572268dda1c23c7() {
    ...
    foreach (name, proportion in proportions) {
        /#
            assertex(proportion >= 0, "Proportion of mind personality '" + name + "' shouldn't be negative.");
        #/
        var_2b22a39e9c6dc326 = var_2b22a39e9c6dc326 + proportion;
    ...
    foreach (personality in personalities) {
        personality.proportion = personality.proportion / var_2b22a39e9c6dc326;
    }
...
function function_3d84d2156c8e641a(mind_personality) {
    if (isdefined(level.mind.callbacks.var_b7d58173e645ec4f)) {
        return [[ level.mind.callbacks.var_b7d58173e645ec4f ]](mind_personality);
    }
    if (scripts/cp_mp/utility/game_utility::isbrstylegametype()) {
