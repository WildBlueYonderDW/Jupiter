...
#namespace jup_ob_spore_healthbar;

// Namespace jup_ob_spore_healthbar / namespace_44b5339458907313
// Params 0
// Checksum 0x0, Offset: 0x153
// Size: 0x145
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_ob_spore_healthbar" );
