    ...
    while (true) {
        ...
        /#
            if (function_f21916a31744af3d()) {
                ...
                bite_print("<dev string:x23>" + distance2d(self.origin, head_pos), head_pos);
            }
        #/
        waitframe();
    }
...
/#
    ...
    function function_ac58fa04e888ee59() {
        function_6e7290c8ee4f558b("<dev string:x36>");
        function_a9a864379a098ad6("<dev string:x52>", "<dev string:x64>", &function_c81577b184a48779);
        function_a9a864379a098ad6("<dev string:x7b>", "<dev string:x8d>", &function_6eb4d0ea6eb40878);
    ...
    function private function_c81577b184a48779() {
        worm = function_6d1fbda4b8524ef2(level.players[0].origin, undefined, "<dev string:xa4>");
        if (!isdefined(worm)) {
            return;
        }
        worm function_3e89eb3d8e3f1811("<dev string:xb5>", 1);
    }
    ...
    function private function_6eb4d0ea6eb40878() {
        function_2fb888667001fc39("<dev string:xc4>", @"hash_2602a364f90130b2");
    }
    ...
    function private bite_print(text, pos) {
        if (function_f21916a31744af3d()) {
            ...
            print3d(pos, "<dev string:xe0>" + text, (1, 0, 0));
        }
    }
