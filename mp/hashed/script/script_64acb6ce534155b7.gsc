...
function finishcontract( task, instance, team )
{
    ...
    {
        thread [[ task.type.funcs[ "onFinishContract" ] ]]( task, instance, team );
        return true;
    }
