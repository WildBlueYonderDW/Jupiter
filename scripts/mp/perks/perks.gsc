...
function init() {
    ...
    registerscriptperk("specialty_regen_on_objective_capture", &function_c83b5a6a9dae783a, &function_a797f6b499006809);
...
function updateactiveperks(einflictor, attacker, victim, idamage, smeansofdeath, objweapon, shitloc, vdir) {
    ...
    var_d5906c2afb710125 = function_160a992c78bdf589(objweapon);
