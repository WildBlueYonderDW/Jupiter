...
function reflectionprobe_hide_hp() {
    /#
        neutralpoint = getentarray("<dev string:x1c>", "<dev string:x32>");
        enemypoint = getentarray("<dev string:x3d>", "<dev string:x32>");
        friendpoint = getentarray("<dev string:x59>", "<dev string:x32>");
        contestpoint = getentarray("<dev string:x76>", "<dev string:x32>");
...
function reflectionprobe_hide_front() {
    /#
        var_a5d9ff994b1d7ab6 = getent("<dev string:x94>", "<dev string:x32>");
        if (isdefined(var_a5d9ff994b1d7ab6)) {
            var_a5d9ff994b1d7ab6 hide();
        }
        var_a5d9fe994b1d7883 = getent("<dev string:xb4>", "<dev string:x32>");
        if (isdefined(var_a5d9fe994b1d7883)) {
            var_a5d9fe994b1d7883 hide();
        }
        var_a5da04994b1d85b5 = getent("<dev string:xd3>", "<dev string:x32>");
        if (isdefined(var_a5da04994b1d85b5)) {
            var_a5da04994b1d85b5 hide();
        }
        var_a57411994aac8dfb = getent("<dev string:xf4>", "<dev string:x32>");
        if (isdefined(var_a57411994aac8dfb)) {
            var_a57411994aac8dfb hide();
        }
        var_a57412994aac902e = getent("<dev string:x112>", "<dev string:x32>");
        if (isdefined(var_a57412994aac902e)) {
            var_a57412994aac902e hide();
        }
        var_a57414994aac9494 = getent("<dev string:x12f>", "<dev string:x32>");
