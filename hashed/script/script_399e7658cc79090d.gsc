...
function nvg_mb_on(time) {
    ...
    thread script_func("lerp_savedDvar", @"r_mbRadialOverrideChromaticAberration", 10.5, time);
    thread script_func("lerp_savedDvar", @"r_mbRadialOverrideDistortion", 0.025, time);
    thread script_func("lerp_savedDvar", @"r_mbRadialOverrideRadius", 0.8, time);
    thread script_func("lerp_savedDvar", @"r_mbRadialOverrideStrength", 0.006, time);
...
function nvg_mb_off() {
    time = 0.1;
    thread script_func("lerp_savedDvar", @"r_mbRadialOverrideChromaticAberration", 0, time);
    thread script_func("lerp_savedDvar", @"r_mbRadialOverrideDistortion", 0, time);
    thread script_func("lerp_savedDvar", @"r_mbRadialOverrideRadius", 0, time);
    thread script_func("lerp_savedDvar", @"r_mbRadialOverrideStrength", 0, time);
