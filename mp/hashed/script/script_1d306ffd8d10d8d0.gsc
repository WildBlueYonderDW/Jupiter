...
#namespace namespace_a487c2d30d50eea3;

// Namespace namespace_a487c2d30d50eea3 / namespace_78226fae3eeabe9a
// Params 0, eflags: 0x0
...
function function_b64b9624f284a07f() {
    ...
    while (isdefined(level.var_db4f032e4875e23a)) {
        wait 5;
...
function function_a4e6bf2bf902f2bb() {
    var_276eed5871330ef5 = getscriptablearray("light_entity_spawn", "script_noteworthy");
    foreach (light in var_276eed5871330ef5) {
...
function function_7b292e2041de06e3() {
    var_276eed5871330ef5 = getscriptablearray("entity_light_01", "script_noteworthy");
    foreach (light in var_276eed5871330ef5) {
        light setscriptablepartstate("fire_flicker", "fire_flicker_start");
    }
}
...
function function_7b292f2041de0916() {
    var_276eed5871330ef5 = getscriptablearray("entity_light_02", "script_noteworthy");
    foreach (light in var_276eed5871330ef5) {
        light setscriptablepartstate("fire_flicker", "fire_flicker_start");
    }
}
...
function function_7b29302041de0b49() {
    var_276eed5871330ef5 = getscriptablearray("entity_light_03", "script_noteworthy");
    foreach (light in var_276eed5871330ef5) {
        light setscriptablepartstate("fire_flicker", "fire_flicker_start");
    }
}
...
function function_7b29312041de0d7c() {
    var_276eed5871330ef5 = getscriptablearray("entity_light_04", "script_noteworthy");
    foreach (light in var_276eed5871330ef5) {
        light setscriptablepartstate("fire_flicker", "fire_flicker_start");
    }
}
