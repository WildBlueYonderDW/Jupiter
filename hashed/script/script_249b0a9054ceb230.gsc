...
function function_3153056f9a15760f(params) {
    /#
        wait(5);
        scripts/common/devgui::function_6e7290c8ee4f558b("itemspawnentry:");
        scripts/common/devgui::function_b23a59dfb4ca49a1("<unknown string>", "<unknown string>", &function_de07a0000b48b33, 1);
        ...
        scripts/common/devgui::function_fe953f000498048f();
        scripts/common/devgui::function_6e7290c8ee4f558b("itemspawnentry:");
        scripts/common/devgui::function_b23a59dfb4ca49a1("<unknown string>", "<unknown string>", &function_6565310170d18089);
        scripts/common/devgui::function_fe953f000498048f();
    #/
}
