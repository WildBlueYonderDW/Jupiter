...
function waittill_offhand_box_accessed(player) {
    ...
    if (var_3f09b9a4149cc197) {
        ...
        self.interact create_cursor_hint(undefined, var_828f4d4b39d42b57, pickup_hint, 360, var_9c85d90245c105ba, 90, 0, undefined, undefined, self.icon, var_ad8472207b13c639, undefined, undefined, 45);
