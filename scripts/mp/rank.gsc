...
function init() {
    ...
    if (var_2f470c4c8dc44884 > 0 && var_2f470c4c8dc44884 < 1) {
...
function onplayerspawned() {
    if (isai(self)) {
        ...
        assertex(isdefined(self.class), "<dev string:x1c>");
        assertex(isdefined(self.class_num), "<dev string:x3e>");
    }
    playerupdaterank();
}
...
function giverankxp(type, value, objweapon, suppresspopup, forceimmediate, var_339e50a026e4674f, var_b01aca3236595958, eventinfo) {
    ...
    /#
        if (isdefined(level.var_55e0b414e3671f70) && istrue(level.var_55e0b414e3671f70.var_a5b0c4131fba9805)) {
            logstring("<dev string:x64>" + value + "<dev string:x77>" + function_3c8848a3a11b2553(type));
        }
    #/
    ...
    if (!isdefined(value)) {
        assertmsg(function_3c8848a3a11b2553(type) + "<dev string:x88>");
        value = 0;
    }
    ...
    if (!suppresspopup && level.var_27dcaf9644646944 == #"display_xp") {
        if (!level.playerxpenabled || level.var_ec2fb549b15ad827 || scripts\mp\utility\game::isanymlgmatch() && !getdvarint(@"hash_93109b9d6f2bf2")) {
            ...
            if (level.mapname != "mp_firingrange") {
                assertex(isdefined(var_b3a25cc5438cd047), "<dev string:xbd>" + function_3c8848a3a11b2553(type) + "<dev string:xe1>");
            }
        ...
        if (var_d44fd609866efce4 > 0) {
            ...
            for (scalingindex = 1; scalingindex <= var_d44fd609866efce4; scalingindex += 1) {
                ...
                if (scaling.benchmark >= 0) {
                    ...
                    assertex(scaling.benchmark >= previousscaling.benchmark, "<dev string:x12b>");
                    level.var_d81e28e42da9de5e[level.var_d81e28e42da9de5e.size] = scaling;
                }
            }
        ...
        if (var_de4ef628cc84d98e > 0) {
            ...
            for (scalingindex = 1; scalingindex <= var_de4ef628cc84d98e; scalingindex += 1) {
                ...
                if (scaling.benchmark >= 0) {
                    ...
                    assertex(scaling.benchmark >= previousscaling.benchmark, "<dev string:x191>");
                    level.var_2b6ac783e47905d8[level.var_2b6ac783e47905d8.size] = scaling;
                }
            }
            scaling.var_2b53305b09e9ca11 = 0;
...
function function_e9d048bc036717fa(originalvalue, applybonus, objweapon) {
    ...
    /#
        if (getdvarint(@"hash_4098c270c1841328", 0) == 1) {
            iprintln("<dev string:x1eb>" + "<dev string:x200>" + self.name + "<dev string:x20b>" + var_f38005d4b8f0ab05 + "<dev string:x221>" + self.pers["<dev string:x237>"]["<dev string:x242>"] - self.pers["<dev string:x237>"]["<dev string:x248>"]);
            if (isdefined(level.var_d81e28e42da9de5e)) {
                iprintln("<dev string:x253>" + "<dev string:x273>" + originalvalue + "<dev string:x283>" + scaledrankxp / getrankxpmultipliertotal() + "<dev string:x291>" + scaledrankxp + "<dev string:x2a3>" + self.pers["<dev string:x237>"]["<dev string:x242>"]);
            }
            if (isdefined(level.var_2b6ac783e47905d8)) {
                iprintln("<dev string:x2bb>" + "<dev string:x273>" + originalvalue + "<dev string:x283>" + var_2e1e3cce9930d323 / scripts\mp\weaponrank::getweaponrankxpmultipliertotal(objweapon) + "<dev string:x291>" + var_2e1e3cce9930d323 + "<dev string:x2a3>" + self.pers["<dev string:x237>"]["<dev string:x2dd>"]);
            }
        }
    #/
...
function recordxpgains(type, var_7c6b134e84356e37, bonusxp) {
    ...
    if (!isdefined(group) || group == "") {
        /#
            println("<dev string:x2e9>" + var_61339cc7c44bde8b);
            println("<dev string:x2fe>" + bonusxp);
        #/
    ...
    case #"hash_5b8ea26626b7f31e": 
        /#
            println("<dev string:x314>" + var_61339cc7c44bde8b);
            println("<dev string:x2fe>" + bonusxp);
        #/
    ...
    case #"hash_5ecdb5d7fae048c": 
        /#
            println("<dev string:x32e>" + var_61339cc7c44bde8b);
            println("<dev string:x2fe>" + bonusxp);
        #/
    ...
    default: 
        /#
            println("<dev string:x344>" + var_61339cc7c44bde8b);
            println("<dev string:x2fe>" + bonusxp);
        #/
        self.pers["summary"]["score"] = self.pers["summary"]["score"] + var_7c6b134e84356e37;
        self.pers["summary"]["bonusXP"] = self.pers["summary"]["bonusXP"] + bonusxp;
...
function updaterank(oldxp) {
    ...
    println("<dev string:x359>" + self.name + "<dev string:x366>" + var_e6633fe0fb633e52 + "<dev string:x375>" + var_7a8cd849f0dbf2c7 + "<dev string:x37d>" + oldxp + "<dev string:x375>" + getrankxp() + "<dev string:x398>");
...
function incrankxp(amount, objweapon, weapon_xp, type, var_158745de00c72d3e, var_b01aca3236595958, forceimmediate) {
    ...
    if (amount > 0) {
        ...
        if (isdefined(var_cf27bc26b98940ab)) {
            ...
            println("<dev string:x489>" + function_3c8848a3a11b2553(#"value") + "<dev string:x4a5>" + amount + "<dev string:x4ab>" + function_3c8848a3a11b2553(eventname));
        }
        self.logplayerxp += amount;
        if (!istrue(function_3db51a7599861afe(function_e3ef0908b595e8e1()))) {
            ...
            if (var_eae0bcbf8e33e5 != 0) {
                ...
                if (isdefined(var_cf27bc26b98940ab)) {
                    ...
                    println("<dev string:x489>" + function_3c8848a3a11b2553(#"bonus_xp") + "<dev string:x4a5>" + var_eae0bcbf8e33e5 + "<dev string:x4ab>" + function_3c8848a3a11b2553(eventname));
                }
                assert(function_d03495fe6418377b(eventname));
                ...
                if (isdefined(var_cf27bc26b98940ab)) {
                    ...
                    println("<dev string:x489>" + function_3c8848a3a11b2553(#"hash_73824491bffbc66a") + "<dev string:x4a5>" + 2 + "<dev string:x4ab>" + function_3c8848a3a11b2553(eventname));
                }
                ...
                if (var_6cf32c59a6c7c2d9 != 0) {
                    ...
                    if (isdefined(var_cf27bc26b98940ab)) {
                        ...
                        println("<dev string:x489>" + function_3c8848a3a11b2553(#"bonus_xp") + "<dev string:x4a5>" + var_6cf32c59a6c7c2d9 + "<dev string:x4ab>" + function_3c8848a3a11b2553(eventname));
                    }
                    assert(function_d03495fe6418377b(eventname));
                    assert(function_d03495fe6418377b(#"hash_73824491bffbc66a"));
                    var_cf27bc26b98940ab = namespace_649c2fab0fd72b8b::function_d6f771aedba70ce7(eventname, #"hash_73824491bffbc66a");
                    if (isdefined(var_cf27bc26b98940ab)) {
                        ...
                        println("<dev string:x489>" + function_3c8848a3a11b2553(#"hash_73824491bffbc66a") + "<dev string:x4a5>" + 1 + "<dev string:x4ab>" + function_3c8848a3a11b2553(eventname));
                    }
    ...
    if (weapon_xp > 0) {
        ...
        if (isdefined(var_cf27bc26b98940ab)) {
            ...
            println("<dev string:x489>" + function_3c8848a3a11b2553(#"weapon_xp") + "<dev string:x4a5>" + weapon_xp + "<dev string:x4ab>" + function_3c8848a3a11b2553(eventname));
        }
        assert(function_d03495fe6418377b(eventname));
        ...
        if (isdefined(var_cf27bc26b98940ab)) {
            ...
            println("<dev string:x489>" + function_3c8848a3a11b2553(#"weapon_loot_id") + "<dev string:x4a5>" + weaponlootid + "<dev string:x4ab>" + function_3c8848a3a11b2553(eventname));
        }
        self.var_ec2db7afa79d6329 += weapon_xp;
        if (!istrue(function_3db51a7599861afe(function_7d04fc91bee2ccd1()))) {
            ...
            if (var_eae0bcbf8e33e5 != 0) {
                ...
                if (isdefined(var_cf27bc26b98940ab)) {
                    ...
                    println("<dev string:x489>" + function_3c8848a3a11b2553(#"hash_48ad44d6a3d7d22a") + "<dev string:x4a5>" + var_eae0bcbf8e33e5 + "<dev string:x4ab>" + function_3c8848a3a11b2553(eventname));
                }
                assert(function_d03495fe6418377b(eventname));
                ...
                if (isdefined(var_cf27bc26b98940ab)) {
                    ...
                    println("<dev string:x489>" + function_3c8848a3a11b2553(#"hash_e16477c0e4e66937") + "<dev string:x4a5>" + 2 + "<dev string:x4ab>" + function_3c8848a3a11b2553(eventname));
                }
                ...
                if (var_6cf32c59a6c7c2d9 != 0) {
                    ...
                    if (isdefined(var_cf27bc26b98940ab)) {
                        ...
                        println("<dev string:x489>" + function_3c8848a3a11b2553(#"hash_48ad44d6a3d7d22a") + "<dev string:x4a5>" + var_6cf32c59a6c7c2d9 + "<dev string:x4ab>" + function_3c8848a3a11b2553(eventname));
                    }
                    assert(function_d03495fe6418377b(eventname));
                    assert(function_d03495fe6418377b(#"hash_e16477c0e4e66937"));
                    var_cf27bc26b98940ab = namespace_649c2fab0fd72b8b::function_d6f771aedba70ce7(eventname, #"hash_e16477c0e4e66937");
                    if (isdefined(var_cf27bc26b98940ab)) {
                        ...
                        println("<dev string:x489>" + function_3c8848a3a11b2553(#"hash_e16477c0e4e66937") + "<dev string:x4a5>" + 1 + "<dev string:x4ab>" + function_3c8848a3a11b2553(eventname));
                    }
    ...
    if (var_158745de00c72d3e > 0) {
        ...
        if (isdefined(var_cf27bc26b98940ab)) {
            ...
            println("<dev string:x489>" + function_3c8848a3a11b2553(#"battlepass_xp") + "<dev string:x4a5>" + var_158745de00c72d3e + "<dev string:x4ab>" + function_3c8848a3a11b2553(eventname));
        }
        self.var_f28d6120a5ec7857 += var_158745de00c72d3e;
        if (function_6d29dcaf4fd78604() < 2) {
            ...
            if (var_eae0bcbf8e33e5 != 0) {
                ...
                if (isdefined(var_cf27bc26b98940ab)) {
                    ...
                    println("<dev string:x489>" + function_3c8848a3a11b2553(#"hash_f0b251f180942558") + "<dev string:x4a5>" + var_eae0bcbf8e33e5 + "<dev string:x4ab>" + function_3c8848a3a11b2553(eventname));
                }
                assert(function_d03495fe6418377b(eventname));
                ...
                if (isdefined(var_cf27bc26b98940ab)) {
                    ...
                    println("<dev string:x489>" + function_3c8848a3a11b2553(#"hash_1e26bad639898fed") + "<dev string:x4a5>" + 2 + "<dev string:x4ab>" + function_3c8848a3a11b2553(eventname));
                }
                ...
                if (var_6cf32c59a6c7c2d9 != 0) {
                    ...
                    if (isdefined(var_cf27bc26b98940ab)) {
                        ...
                        println("<dev string:x489>" + function_3c8848a3a11b2553(#"hash_f0b251f180942558") + "<dev string:x4a5>" + var_6cf32c59a6c7c2d9 + "<dev string:x4ab>" + function_3c8848a3a11b2553(eventname));
                    }
                    assert(function_d03495fe6418377b(eventname));
                    assert(function_d03495fe6418377b(#"hash_1e26bad639898fed"));
                    var_cf27bc26b98940ab = namespace_649c2fab0fd72b8b::function_d6f771aedba70ce7(eventname, #"hash_1e26bad639898fed");
                    if (isdefined(var_cf27bc26b98940ab)) {
                        ...
                        println("<dev string:x489>" + function_3c8848a3a11b2553(#"hash_1e26bad639898fed") + "<dev string:x4a5>" + 1 + "<dev string:x4ab>" + function_3c8848a3a11b2553(eventname));
                    }
    ...
    if (operatorxp > 0) {
        ...
        assertex(operatorid != 0, "<dev string:x4bd>");
        assert(function_d03495fe6418377b(eventname));
        ...
        if (isdefined(var_cf27bc26b98940ab)) {
            ...
            println("<dev string:x489>" + function_3c8848a3a11b2553(#"operator_xp") + "<dev string:x4a5>" + operatorxp + "<dev string:x4ab>" + function_3c8848a3a11b2553(eventname));
        }
        assert(function_d03495fe6418377b(eventname));
        ...
        if (isdefined(var_cf27bc26b98940ab)) {
            ...
            println("<dev string:x489>" + function_3c8848a3a11b2553(#"hash_8fba2fc976d0515e") + "<dev string:x4a5>" + operatorid + "<dev string:x4ab>" + function_3c8848a3a11b2553(eventname));
        }
        if (function_b3bd8c86dbdd11c1() >= 2) {
    ...
    if (clanXP > 0) {
        ...
        if (isdefined(var_cf27bc26b98940ab)) {
            ...
            println("<dev string:x489>" + function_3c8848a3a11b2553(#"clan_xp") + "<dev string:x4a5>" + clanXP + "<dev string:x4ab>" + function_3c8848a3a11b2553(eventname));
        }
        if (function_574c0312c915c601() >= 2) {
    ...
    if (isdefined(var_cf27bc26b98940ab)) {
        ...
        println("<dev string:x489>" + function_3c8848a3a11b2553(#"version") + "<dev string:x4a5>" + 1 + "<dev string:x4ab>" + function_3c8848a3a11b2553(eventname));
    }
    assert(function_d03495fe6418377b(eventname));
    ...
    if (isdefined(var_cf27bc26b98940ab)) {
        ...
        println("<dev string:x489>" + function_3c8848a3a11b2553(#"hash_e1ad0562d81a9efa") + "<dev string:x4a5>" + var_22d9ebf9658572ca + "<dev string:x4ab>" + function_3c8848a3a11b2553(eventname));
    }
    ...
    if (isdefined(var_cf27bc26b98940ab)) {
        ...
        println("<dev string:x489>" + function_3c8848a3a11b2553(#"gamemode") + "<dev string:x4a5>" + gamemode + "<dev string:x4ab>" + function_3c8848a3a11b2553(eventname));
    }
...
function removerankxpmultiplier(ref) {
    if (!isdefined(self.rankxpmultipliers)) {
        assertmsg("<dev string:x4f0>" + ref + "<dev string:x519>");
        return;
    }
    if (!isdefined(self.rankxpmultipliers[ref])) {
        assertmsg("<dev string:x4f0>" + ref + "<dev string:x544>");
        return;
    }
...
function removeteamrankxpmultiplier(team, ref) {
    ...
    if (!isdefined(level.teamrankxpmultipliers)) {
        assertmsg("<dev string:x573>" + ref + "<dev string:x5a0>");
        return;
    }
    if (!isdefined(level.teamrankxpmultipliers[team])) {
        assertmsg("<dev string:x573>" + ref + "<dev string:x5d0>");
        return;
    }
    if (!isdefined(level.teamrankxpmultipliers[team][ref])) {
        assertmsg("<dev string:x573>" + ref + "<dev string:x60e>");
        return;
    }
...
/#
    ...
    function function_f440a654d455343e(type, amount) {
        if (getdvarint(@"hash_a59ff2bb10f08cc9", 0) == 1) {
            ...
            println("<dev string:x64c>" + self.name + "<dev string:x64c>");
            println("<dev string:x65f>");
            println("<dev string:x66f>" + function_3c8848a3a11b2553(type) + "<dev string:x676>" + amount);
            println("<dev string:x67b>" + getrankxpmultipliertotal());
            println("<dev string:x68e>");
            println("<dev string:x6b2>");
            foreach (key, value in self.xpamountdebug) {
                println("<dev string:x66f>" + function_3c8848a3a11b2553(key) + "<dev string:x676>" + value);
            }
            println("<dev string:x68e>");
        }
    }
