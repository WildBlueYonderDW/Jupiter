...
// Size: 0x419
function oncontractend(contractid, completed, var_1229758a8a60ba86, startingpoi, contractname, var_caac1a3de59f50c0, var_fcd717aeda26cf4c) {
    if (!challengesenabledforplayer()) {
        return;
    }
    gamemode = getchallengegamemode(self);
    ...
    if (istrue(var_fcd717aeda26cf4c)) {
