...
function function_8e297d719d663b78() {
    if (isplayer(self)) {
        return namespace_f8d3520d3483c1::function_ac266fc218266d08();
    }
...
function broadcast_armor(amount) {
    ...
    namespace_6c67e93a4c487d83::setcoopplayerdata_for_everyone("EoGPlayer", entity_num, "playerArmor", armor);
}
...
function function_e0d47de3df5f23ea() {
    entity_num = self getentitynumber();
    if (isdefined(self.var_c99db8962a6b36bb)) {
        namespace_6c67e93a4c487d83::setcoopplayerdata_for_everyone("EoGPlayer", entity_num, "playerArmorHardened", self.var_c99db8962a6b36bb);
    }
}
...
function usearmorplate(item, itemcount) {
    ...
    if (player_have_full_armor(self) || namespace_d4aab8c9cb8ecb14::player_in_laststand(self)) {
        return;
    }
...
function function_d251468d9c2fe73f() {
    ...
    while (true) {
        ...
        level.player namespace_f8d3520d3483c1::function_9c6e9a6643b6c9a6(3);
