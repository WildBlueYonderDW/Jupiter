...
function gunship_getbombingpoints(centerpoint, numpoints, var_a0edd3f59d938fb1) {
    ...
    for (i = 0; i < numpoints; i++) {
        ...
        var_953968ce39783e28[var_953968ce39783e28.size] = point;
    }
...
function enemygunship_spawngunship(var_2acd6736c2bc3edb, var_a2c5157971449c35, centeroverride, radiusoverride, heightoverride, var_b4a73ef4935724be) {
    ...
    namespace_a0628d6954815ef8::add_to_special_lockon_target_list(gunship);
...
function play_fake_vo_for_gunship() {
    ...
    var_a53ceb4a7edf2f4c = var_4d0ce2d79bf45d54 scripts\cp_mp\calloutmarkerping::calloutmarkerpingvo_getfulloperatorvoaliasfromsimplealias3d(voalias);
    var_c197335aad9f5e31 = soundexists(alias2d);
    var_c1934d5aad9ba188 = soundexists(var_a53ceb4a7edf2f4c);
    var_196ffc81c8206c2a = scripts\cp_mp\calloutmarkerping::calloutmarkerpingvo_getmaxsoundaliaslength(var_c197335aad9f5e31, alias2d, var_c1934d5aad9ba188, var_a53ceb4a7edf2f4c);
    ...
    if (istrue(var_57d0946b275fea34)) {
        ...
        foreach (teammate in playersquad) {
            ...
            if (var_c1934d5aad9ba188) {
                var_4d0ce2d79bf45d54 playsoundtoplayer(var_a53ceb4a7edf2f4c, teammate);
            }
        }
    }
}
