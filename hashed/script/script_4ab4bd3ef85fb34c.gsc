...
function function_9246165d7c3054cc(targetfov) {
    ...
    startfov = getdvarint(@"cg_targetBaseFov");
...
function function_96ef51c945a57bf7() {
    ...
    while (true) {
        damage, attacker, null, null, meansofdeath, null, null, null, null, objweapon, null, null, null, inflictor = self waittill("damage");
...
function in_screen_center(origin, var_9508c0c70b32eda1) {
    screenpos = level.player worldpointtoscreenpos(origin, getdvarint(@"cg_targetBaseFov"));
...
function proximity() {
    while (true) {
        who = self.proximity_trig waittill("trigger");
