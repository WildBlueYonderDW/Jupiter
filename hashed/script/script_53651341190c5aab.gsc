...
#namespace namespace_c9d0b05b2c55e339;

// Namespace namespace_c9d0b05b2c55e339/namespace_f901a4f9d899be59
...
// Size: 0x133
function function_efcea5d26798e5b6(var_cc4f2e0388379546) {
    ...
    case #"hash_996b6e15533d90f1":
        return &function_a75e4eaf48401358;
    ...
    case #"hash_cec0f8624eb06844":
        return &namespace_dd3a5c61bf082e18::function_8439b78c94685919;
    ...
    case #"hash_a56eca06864aaf61":
        return &function_327074d2913de71d;
...
function function_606c28b248baddfd(statename, params) {
    ...
    #/
    var_72c614d54174db7f = params[0];
    self._blackboard.var_7460b96395361857 = var_72c614d54174db7f;
}
...
function function_29946584b628c719(statename, params) {
    ...
    var_996949b7474560eb = function_a0cccf0b4c466b2c(self, params[0]);
    if (!isdefined(var_996949b7474560eb)) {
        return;
    }
    var_3e38ee41dc326fdc = var_996949b7474560eb.var_3e38ee41dc326fdc;
    ...
    if (isdefined(self findoverridearchetype("default"))) {
        ...
        if (archetypehasstate(var_3e38ee41dc326fdc, var_51fb64c4bfcd847)) {
            var_bcf3c74b1d8b4883 = var_51fb64c4bfcd847;
        }
    }
    if (isdefined(var_842a67ee2435339d) && isdefined(var_127e00a9379f717c)) {
        alias = archetypegetalias(animset, var_842a67ee2435339d, var_127e00a9379f717c, 0);
    ...
    self.var_718d80100704cc82 = getgroundposition(interaction.origin, 1);
    namespace_aebb27832287cd3a::cap_reach_and_arrive(interaction, var_3e38ee41dc326fdc, animset, var_bcf3c74b1d8b4883);
}
...
function function_b76d8b8ad8e2c823(statename, params) {
    ...
    self.var_a70672e669ca7f00 = interaction.angles;
    self.var_718d80100704cc82 = interaction.origin;
    namespace_aebb27832287cd3a::cap_start(var_3e38ee41dc326fdc, animset, 0);
    namespace_bf5a1761a8d1bb07::asm_fireephemeralevent("move", "end");
    self forceteleport(self.var_718d80100704cc82, self.var_a70672e669ca7f00, 2048);
}
...
// Size: 0x38
function function_a75e4eaf48401358(statename, params) {
    mindist = params[0];
    if (self.pathpending) {
        return 0;
    }
...
function processevent(receiver, info, origin) {
    if (info == "relaxed") {
        ...
        namespace_dd3a5c61bf082e18::function_bf3d5ae7e2eeda40();
        ...
        if (namespace_dd3a5c61bf082e18::function_f179ede0989e6734("curious", "curious_anim")) {
...
// Size: 0x4e
function function_327074d2913de71d(statename, params) {
    self._blackboard.var_f725b0bb1f8d27ee = 1;
    var_f8d4ed108521e632 = self function_92435c7a6ae85c3c();
    /#
        assert(isdefined(var_f8d4ed108521e632));
    #/
    function_c2a860252b030c52(var_f8d4ed108521e632);
}
...
// Size: 0x25
function function_25c933655d73066a(var_f8d4ed108521e632) {
    repulsorname = function_d980c506b2f1a19b(var_f8d4ed108521e632);
...
// Size: 0x13
function private function_d980c506b2f1a19b(var_f8d4ed108521e632) {
    return "civilian_interaction_" + var_f8d4ed108521e632;
}
...
// Size: 0x2c3
function private function_c2a860252b030c52(var_f8d4ed108521e632) {
    var_36b6c21725713470 = function_adf0d34ff483c35a(var_f8d4ed108521e632);
    if (var_36b6c21725713470.size == 0) {
        return;
    }
    var_97e5d2c62501499e = [];
    foreach (var_6beffe9c75d5e9a3 in var_36b6c21725713470) {
        if (var_6beffe9c75d5e9a3._blackboard.var_f725b0bb1f8d27ee) {
            var_97e5d2c62501499e[var_97e5d2c62501499e.size] = var_6beffe9c75d5e9a3;
        }
    }
    ...
    if (var_97e5d2c62501499e.size == 1) {
        ...
        for (i = 1; i < var_97e5d2c62501499e.size; i++) {
            ...
            } else if (var_5d8d3f6a643b89ed[1] > maxy) {
                maxy = var_5d8d3f6a643b89ed[1];
            }
        }
        circleorigin = ((maxx + minx) / 2, (maxy + miny) / 2, 0);
        var_1e5e9f053774bcb3 = 0;
        var_a1f8512fcba75b7f = 0;
        foreach (user in var_97e5d2c62501499e) {
            var_a1f8512fcba75b7f = var_a1f8512fcba75b7f + user.origin[2];
            var_289872f1c7a48d0f = distance2dsquared(circleorigin, user.origin);
            if (var_289872f1c7a48d0f > var_1e5e9f053774bcb3) {
                var_1e5e9f053774bcb3 = var_289872f1c7a48d0f;
            }
        }
        var_a1f8512fcba75b7f = var_a1f8512fcba75b7f / var_97e5d2c62501499e.size;
        circleorigin = circleorigin + (0, 0, var_a1f8512fcba75b7f);
        circleradius = sqrt(var_1e5e9f053774bcb3) + 24;
    }
    repulsorname = function_d980c506b2f1a19b(var_f8d4ed108521e632);
    destroynavrepulsor(repulsorname);
