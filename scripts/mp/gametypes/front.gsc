    ...
    /#
        ...
        while (true) {
            if (getdvarint(@"hash_46a6b424af6acbc2") != 0) {
                scripts/mp/gamescore::giveteamscoreforobjective("frontline_zone_axis", getdvarint(@"hash_46a6b424af6acbc2"), 0);
                break;
            } else if (getdvarint(@"hash_86e14326e43c0115") != 0) {
                scripts/mp/gamescore::giveteamscoreforobjective("trigger", getdvarint(@"hash_86e14326e43c0115"), 0);
                break;
            }
            wait(1);
        }
