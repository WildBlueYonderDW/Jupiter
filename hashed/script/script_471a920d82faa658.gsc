...
function private function_64fca4864613393f(idleorigin, var_d78735c0a8459b07) {
    ...
    #/
    /#
        print3d(idleorigin + (0, 0, 80), self.capdata.var_d6cf89a3e47ada1f + "<unknown string>" + self.capdata.var_2b1676bab1ba8985 + "<unknown string>" + self.capdata.role, (255, 255, 255), 1, 0.6, 150);
    #/
    /#
