...
function function_7d267b05c8f10c00() {
    ...
    /#
        if (!isdefined(var_ffa92a8d5e47d362)) {
            println("super_battlerage" + projectscriptbundle.consumablelist);
        }
    #/
    ...
    for (i = 0; i < consumablelist.size; i++) {
        ...
        if (!isdefined(consumablebundle)) {
            /#
                println("<unknown string>" + projectscriptbundle.consumablelist + "<unknown string>" + consumablelist[i].bundle);
            #/
            continue;
        }
...
function function_43b02b62387ec23e(consumableref) {
    ...
    /#
        println("<unknown string>" + consumableref);
    #/
    return undefined;
}
...
function function_2f80e9272a2074d(lootid, var_49e6ef3edadd524e) {
    ...
    bundledata = namespace_e0ee43ef2dddadaa::function_a622d54bb517923a(uniqueref, [#"baseref", #"category"]);
    var_6d996aceed8c8ee8 = undefined;
    if (isdefined(bundledata) && isdefined(bundledata.category) && bundledata.category == "CONVERSIONKIT") {
        var_6d996aceed8c8ee8 = uniqueref;
    }
    if (isdefined(bundledata) && isdefined(bundledata.baseref) && bundledata.baseref != "") {
        if (bundledata.baseref != uniqueref) {
            var_39dd70c4a332b134 = namespace_e0ee43ef2dddadaa::function_a622d54bb517923a(bundledata.baseref, [#"lootid", #"category"]);
            /#
                assertex(isdefined(var_39dd70c4a332b134), "Unable to retrieve base bundle data for: " + bundledata.baseref);
            #/
            if (isdefined(var_39dd70c4a332b134) && var_39dd70c4a332b134.lootid != 0) {
                ...
                if (isdefined(var_39dd70c4a332b134.category) && var_39dd70c4a332b134.category == "CONVERSIONKIT") {
                    var_6d996aceed8c8ee8 = bundledata.baseref;
                } else {
                    var_6d996aceed8c8ee8 = undefined;
                }
            }
