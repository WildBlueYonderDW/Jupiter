...
function function_9c8190123c567b0a(turretstruct) {
    ...
    turret thread damage::monitordamage(turret.maxhealth, "hitequip", &ai_sentry_turret::function_4424088da3075b69, &function_b8cef191ff4b199, 1);
...
function function_b8cef191ff4b199(data) {
    ...
    return ai_sentry_turret::function_cb32fe838a62170f(data);
}
