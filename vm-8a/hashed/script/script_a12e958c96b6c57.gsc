...
function private function_8e6ae0f9fd3a8de2(params) {
    ...
    var_12f08b5cb2718d76, tag, alias = params.body waittill("emergence_spawn");
...
/#
    ...
    function function_71fb46ec2e0bf63() {
        ...
        function_a9a864379a098ad6("<dev string:x40>", "<dev string:x60>", &function_572d7a042e2d9309, 1);
    ...
    function private function_572d7a042e2d9309() {
        zombies = getaispeciesarray("<dev string:x7a>", "<dev string:x7e>");
