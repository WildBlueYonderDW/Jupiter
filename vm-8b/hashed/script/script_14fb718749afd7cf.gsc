...
function function_a2a77fce983ed84f() {
    ...
    self.var_a3d0ad660af72d52.handtag = var_bd43ea367f2d9067.var_c206fe19a8e216fc;
...
function private function_a872fb483eb16ecd() {
    ...
    while (true) {
        ...
        duration = function_efc9be9e46d1f242(self.asmname, "teleport_enter", "teleport_dissolve_start", "teleport_dissolve_end");
        ...
        duration = function_efc9be9e46d1f242(self.asmname, "teleport_exit", "teleport_reappear_start", "teleport_reappear_end");
        if (!isdefined(duration)) {
            utility::function_3ab9164ef76940fd("reactive_miscellaneous", "off");
            continue;
        }
...
// Size: 0x135
function private function_efc9be9e46d1f242(asmname, statename, startnotetrack, endnotetrack) {
