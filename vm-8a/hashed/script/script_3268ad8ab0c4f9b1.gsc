...
function function_1216d39bcd3fb5de(constants) {
    ...
    constants.var_96af88c97db9ed21 = [195, 390, 1950, 3900];
    constants.var_49e2976ca0c853ef = [-30, 20, 65, 75];
    constants.var_b8eb6b85b8ebb591 = [-1, -0.5, 0, 0.5, 1];
    constants.var_aa7751bb8bb0bf4e = [25, 17, 10, 0, -10];
    constants.var_dff6f563a1619566 = [0, 0.2, 0.4, 0.6, 0.8, 1];
    constants.var_6b5b5a20f3356ee3 = [45, 33, 24, 13, 0, -5];
