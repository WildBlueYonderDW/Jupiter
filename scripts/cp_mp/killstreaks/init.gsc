...
function init() {
    ...
    /#
        scripts/engine/utility::issharedfuncdefined("<unknown string>", "<unknown string>", 1);
    #/
    ...
    level thread scripts/cp_mp/killstreaks/toma_strike::init();
    ...
    level thread scripts/cp_mp/killstreaks/nuke::init();
