...
function private function_eebde962fa39f72f() {
    ...
    var_afb7e0639adce453 = namespace_feea61bc660e9e0f::function_4776284a348ebb6a(50205);
...
function private function_ac531909f44e822e() {
    ...
    if (isdefined(var_92de6edf8f216904)) {
        level.var_94890eb1fce436af = namespace_5775ad2badedbcaa::register_interact(var_92de6edf8f216904.origin, 200, &function_2a5c422870861dd9);
        level.var_94890eb1fce436af namespace_5775ad2badedbcaa::function_e6c63f16f2258b80(&function_3710286101f0ad65);
    }
...
function function_2a5c422870861dd9(player) {
    ...
    if (player function_eebde962fa39f72f()) {
        ...
        thread namespace_446fc987a980892f::playevent("s2_rq_target_start", a_squad);
...
function private function_206285f148100a35(targetid, var_d8486273fd2c797f) {
    ...
    if (var_88029ddda02d9a53 == 4) {
        thread namespace_446fc987a980892f::playevent("s2_rq_target_half", a_squad);
    }
    /#
        targetcount = 0;
        foreach (target in level.var_adff83a13b355d74) {
...
function private function_bce801d6cae789ef(var_d8486273fd2c797f) {
    ...
    waitframe();
    level.var_1ed07ecae329d02f scripts\asm\shared\mp\utility::function_577d8abff6067c23("spawn_hop", "spawn_end", level.var_1ed07ecae329d02f.origin, level.var_1ed07ecae329d02f.angles);
    waitframe();
    var_10a5bcf5418ea283 = scripts\mp\utility\player::getplayersinradius(level.var_1ed07ecae329d02f.origin, 500);
    thread namespace_446fc987a980892f::playevent("s2_rq_targets_zombie_spawn", var_10a5bcf5418ea283);
    wait 1;
...
function private function_6eca18484fcc4e39() {
    ...
    if (isdefined(level.var_d4b1a97a578504fe)) {
        a_squad = level.var_d4b1a97a578504fe namespace_ca7b90256548aa40::getsquadmembers();
        thread namespace_446fc987a980892f::playevent("s2_rq_targets_zombie_death", a_squad);
...
function private function_2f2a2371dd591643(player) {
    ...
    item = namespace_2abc885019e1956::function_c465d27f3f6066b4(itembundle, level.var_d4b1a97a578504fe.origin, undefined, 0, 1, payload);
...
function private function_7ac8ae8bc8ac8afc(player) {
    ...
    a_squad = player namespace_ca7b90256548aa40::getsquadmembers();
    item = namespace_2abc885019e1956::function_c465d27f3f6066b4(itembundle, player.origin, undefined, 0, 1, payload);
    level.var_5c9bf13e99504765 setscriptablepartstate("entrance_vfx", "closing");
    if (isdefined(item)) {
        params = spawnstruct();
        params.item = item;
        ...
        wait 0.5;
        thread namespace_446fc987a980892f::playevent("s2_rq_get_attuned_targets_rvnv", a_squad);
        level.var_d4b1a97a578504fe = undefined;
    }
}
...
function private on_item_pickup(params) {
    if (isdefined(params.itembundlename) && params.itembundlename == "ob_jup_item_key_rift_gate_season2_targets_attuned") {
        if (!istrue(self.var_a7534b835943cd10)) {
            thread namespace_446fc987a980892f::playevent("s2_rq_get_attuned_targets_ent", [self]);
