...
function function_b18f9e23b7bbbc7f(einflictor, victim, eattacker, idamage, smeansofdeath, objweapon, vpoint, vdir, shitloc, idflags, var_be4285b26ed99ab1) {
    ...
    /#
        if (level.var_218972ae124946da) {
            if (!is_equal(objweapon.basename, "<dev string:x162>") && !function_cfce6a9d8f6de32f(objweapon)) {
                ...
                logstring("<dev string:x175>" + victim.name + "<dev string:x18a>" + var_2bb9843391a39639 + "<dev string:x19c>" + idamage + "<dev string:x1a6>" + shitloc + "<dev string:x1b0>" + var_be4285b26ed99ab1 + "<dev string:x1c2>" + objweapon.basename + "<dev string:x1ce>" + spawnprotection + "<dev string:x1e0>" + spawnprotectionmodifier + "<dev string:x1fa>" + victim.health + "<dev string:x203>" + victim.armorhealth);
            }
        }
    #/
    return idamage;
