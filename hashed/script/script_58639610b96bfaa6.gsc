...
// Size: 0x47
function init() {
    namespace_17c25f0877bfb620::scriptable_addusedcallbackbypart("dmz_radioactive_object_1", &function_5bc57c3a339eba95);
    namespace_17c25f0877bfb620::scriptable_addusedcallbackbypart("dmz_radioactive_object_2", &function_5bc57c3a339eba95);
    namespace_17c25f0877bfb620::scriptable_addusedcallbackbypart("dmz_radioactive_object_3", &function_5bc57c3a339eba95);
    namespace_17c25f0877bfb620::scriptable_addusedcallbackbypart("dmz_secret_stash", &function_5bc57c3a339eba95);
}
...
// Size: 0xe6
function function_8a49992a2e6901e6(activity, var_6756bd882736e8bc, fortress, var_40dbdb41f33299f7) {
    if (!isdefined(var_6756bd882736e8bc)) {
        var_6756bd882736e8bc = 1;
    }
    if (!isdefined(var_40dbdb41f33299f7)) {
        var_40dbdb41f33299f7 = 0;
    }
    ...
    task.var_6756bd882736e8bc = var_6756bd882736e8bc;
    task.fortress = fortress;
    task.var_40dbdb41f33299f7 = var_40dbdb41f33299f7;
...
function function_a6ff88151cf5542b(teamname) {
    ...
    self.var_8c956c79a693924e = locations.size;
    self.var_1ae1be9ca33b1a87 = 0;
    self.var_4dbf4cabdbcedf5b = [];
    foreach (location in locations) {
        var_187e63a5cf6d992a = function_111ec726eaa1ce68(location);
        function_67e00b8d4251c284(var_187e63a5cf6d992a.origin, var_187e63a5cf6d992a.angles, teamname, self, self.var_40dbdb41f33299f7, var_187e63a5cf6d992a.script_noteworthy);
    }
...
function function_e2db801fc08bbfca(var_f934392aa6995070, teamname) {
    foreach (index, var_532ec2cd26095da3 in var_f934392aa6995070) {
        function_325390edb051cd5d("Explore_Dmz", [0:var_532ec2cd26095da3.origin], 1500, teamname);
        self.var_4dbf4cabdbcedf5b[var_532ec2cd26095da3.script_noteworthy] = self.var_b0f4bf8621b96c0a[index];
    }
}
...
function function_c15ef1bb5dd116a0(teamname) {
    ...
    namespace_a0229183a28ffd3::cleanup_cs_file_objects("mp_dmz_hydro_bads_create_script");
}
...
// Size: 0x82
function function_5bc57c3a339eba95(instance, part, state, player, var_a5b2c541413aa895, var_cc38472e36be1b61) {
    if ((part == "dmz_radioactive_object_1" || part == "dmz_radioactive_object_2" || part == "dmz_radioactive_object_3") && state == "usable") {
        ...
        function_bb50fb4b09b7f165(instance, part, state, player, var_a5b2c541413aa895, var_cc38472e36be1b61);
...
function function_db7e4ab290b642c1(instance, teamname) {
    foreach (var_cf1f227589f2acda, circle in self.var_4dbf4cabdbcedf5b) {
        if (var_cf1f227589f2acda == instance.var_72d392767c3b7b23) {
            circle function_629ed367d1393020();
        }
    }
}
...
function function_ec727a26a8b9db8f() {
    ...
    /#
        assertex(self.var_8c956c79a693924e >= self.var_1ae1be9ca33b1a87, " Number of objects collected is greater than the total number. Recheck Scripts");
    #/
}
...
function function_3710f7eb08295551() {
    return self.var_8c956c79a693924e == self.var_1ae1be9ca33b1a87;
}
...
// Size: 0x3b
function function_bb50fb4b09b7f165(instance, part, state, player, var_a5b2c541413aa895, var_cc38472e36be1b61) {
...
// Size: 0x5d
function function_b9beb2bb0e6b4941(var_f41c9d9347d0911a) {
    switch (var_f41c9d9347d0911a) {
...
// Size: 0x2e4
function function_67e00b8d4251c284(var_7e05c139fbbd8374, var_5b9c864b21207ff6, teamname, task, var_40dbdb41f33299f7, var_f41c9d9347d0911a) {
    cache = undefined;
    var_7e05c139fbbd8374 = var_7e05c139fbbd8374 + anglestoright(var_5b9c864b21207ff6) * -10;
    var_5b9c864b21207ff6 = (var_5b9c864b21207ff6[0], var_5b9c864b21207ff6[1] + 180, var_5b9c864b21207ff6[2]);
    var_91839babd32261f4 = function_b9beb2bb0e6b4941(var_f41c9d9347d0911a);
    cache = spawnscriptable(var_91839babd32261f4, var_7e05c139fbbd8374, var_5b9c864b21207ff6);
...
");
    ...
    cache.task = task;
    cache.var_72d392767c3b7b23 = var_f41c9d9347d0911a;
...
function function_111ec726eaa1ce68(parentstruct) {
    ...
    if (isdefined(parentstruct.target)) {
        ...
        var_97f1bd927537ddfd = getdvarint(@"hash_eb2f6d009f65cb77", 1);
        switch (var_97f1bd927537ddfd) {
        case 1:
...
function function_27f9050017807d8a() {
    level.var_a3a9959b0a31f7bc = spawnstruct();
    level.var_a3a9959b0a31f7bc.currentlevel = 1;
    level.var_a3a9959b0a31f7bc.functions = [];
    level.var_a3a9959b0a31f7bc.var_106a0c25c537a585 = "";
...
function function_9691dfef872dd7e4() {
    return getdvarint(@"hash_2967fdd4515a6756", level.var_a3a9959b0a31f7bc.currentlevel);
}
...
// Size: 0x31
function function_d6da0dd209b341c9(function, var_d2b4bf70079cbede) {
    level.var_a3a9959b0a31f7bc.functions["escalation_" + var_d2b4bf70079cbede] = function;
}
...
function function_60291dfce2923372() {
    level.var_a3a9959b0a31f7bc.currentlevel++;
    if (level.var_a3a9959b0a31f7bc.currentlevel > 3) {
        level.var_a3a9959b0a31f7bc.currentlevel = 3;
    }
    currentlevel = function_9691dfef872dd7e4();
    /#
        assert(currentlevel == 1 || currentlevel == 2 || currentlevel == 3);
    #/
    thread [[ level.var_a3a9959b0a31f7bc.functions["escalation_" + currentlevel] ]]();
}
...
function function_3645d8aee174afb3(spawngroup, objname) {
    ...
    var_3a64877d8ddfdd1c = function_43ae814062c7741b(var_eb096a9d4e8a54d2);
    foreach (var_756a07c77406000b in var_3a64877d8ddfdd1c) {
        var_92db85c8dcf21152 = function_471352520e6468(var_756a07c77406000b);
    ...
    foreach (var_756a07c77406000b in var_aa2b4adf749ccbee) {
        ...
        agent thread function_9648829771fb344(var_756a07c77406000b);
        /#
            if (getdvarint(@"hash_9bcca58e56e4c178", 1)) {
                namespace_cbd3754a0c69cc63::outlineenableforall(agent, "spawner_obj_b_exterior_roof_1", "spawner_obj_a_interior_smg_1");
            }
        #/
        agent.spawnpoint = var_756a07c77406000b;
...
function function_43ae814062c7741b(spawngroup) {
    var_4cc7f98c522a7843 = getstructarray(spawngroup, "targetname");
    return var_4cc7f98c522a7843;
}
...
// Size: 0x14
function function_9648829771fb344(var_ac7930c851fe41c2) {
    function_5add58433814dbc(var_ac7930c851fe41c2);
}
...
function function_2b1d55f8d82cef07(group_name, func) {
    if (namespace_86b52005c685dfb9::function_7956dfd1302cddff("dog")) {
...
function function_1b3e1d52186f7026(group_name, func) {
    ...
    if (function_eac0cd99c9c6d8ee() == "spotted") {
        ...
        namespace_6205bc7c5e394598::find_and_teleport_to_cover();
    } else {
...
function function_877ab7a7d5ed8172() {
    ...
    while (1) {
        ...
        objname = getdvar(function_2ef675c13ca1c4af(@"hash_287b3b75f2c14fe9", level.script), "stealth_container");
        ...
        if (!var_e61af03c9e384f0f && !var_e7758d1cef59fbf6 && !var_e4189f6142f280f1) {
            var_c837ad627899c30c = namespace_3c37cb17ade254d::getclosest(self.origin, getentarray("objective_trigger", "targetname"));
            if (!isdefined(var_c837ad627899c30c)) {
                /#
                    iprintln("spawner_obj_a_exterior_2");
                #/
                continue;
            }
            objname = var_c837ad627899c30c.script_noteworthy;
        } else {
...
function function_3a45f1c5e142d0f3(player) {
    ...
    var_a5ae61dd930bf2a5 = getent("exfil_area", "script_noteworthy");
    if (isdefined(player.recondronesuper)) {
        ...
        if (player.recondronesuper istouching(var_a5ae61dd930bf2a5)) {
    ...
    if (isdefined(player.vehicle)) {
        ...
        if (player.vehicle istouching(var_a5ae61dd930bf2a5)) {
            var_2795910ea142bebd = 1;
        }
    }
    ...
    if (player istouching(var_a5ae61dd930bf2a5)) {
        var_2795910ea142bebd = 1;
    }
    if (var_e61af03c9e384f0f) {
        return "stealth_a";
...
function function_b558b6dbca1a6491() {
    self endon("death");
    ignore_events = [0:"footstep", 1:"footstep_walk", 2:"silenced_shot", 3:"seek_backup", 4:"window_open"];
    while (1) {
...
function function_8855d1ba1fe4292(group_name, func) {
    ...
    if (function_eac0cd99c9c6d8ee() == "spotted") {
        ...
        self [[ self.fnsetstealthstate ]]("combat");
        function_ffd832f03f6ebb80();
    } else if (function_dcf52ed792cd5571()) {
        if (self [[ self.fnisinstealthcombat ]]() || self [[ self.fnisinstealthhunt ]]()) {
            return;
        }
        self [[ self.fnsetstealthstate ]]("hunt");
...
function function_f2d1dfd7a8ce1ec3(group_name, func) {
    function_c5793c2004afcbcc(group_name, func);
    if (namespace_86b52005c685dfb9::function_7956dfd1302cddff("juggernaut")) {
    ...
    if (issubstr(self.group.group_name, "vehicle")) {
        thread function_53004420672f13fa();
        thread namespace_d7b023c7eb3949d0::player_unresolved_collision_watch();
        self.stealth.funcs["event_investigate"] = &function_62615fdc150baa1a;
        self.stealth.funcs["event_cover_blown"] = &function_62615fdc150baa1a;
        self.stealth.funcs["event_combat"] = &function_62615fdc150baa1a;
        self.maxfacenewenemydist = 4000;
...
function function_53004420672f13fa() {
    ...
    while (1) {
        ...
        if (self istouching(var_a5ae61dd930bf2a5)) {
            var_2795910ea142bebd = 1;
        }
...
function function_45a008ca8959297f() {
    ...
    while (1) {
        ...
        case #"hash_a4157a2f0345f08d":
            self.soundent namespace_3c37cb17ade254d::playsoundonentity("anml_dog_growl", "dog_growl");
            break;
...
// Size: 0x209
function function_948291bd95f7c96a(var_c78fd6612d780da3) {
    self endon("death");
    while (1) {
        self waittill("weapon_fired");
        objname = getdvar(function_2ef675c13ca1c4af(@"hash_287b3b75f2c14fe9", level.script), "stealth_container");
        ...
        if (isdefined(var_c78fd6612d780da3)) {
            level thread function_3d5706b7f6e25709("upstairs", 0.05, var_c78fd6612d780da3);
            continue;
        }
        if (objname == "stealth_a") {
...
function function_52b755330ef9af41(group) {
    if (namespace_86b52005c685dfb9::function_7956dfd1302cddff("juggernaut") || namespace_86b52005c685dfb9::function_7956dfd1302cddff("dog")) {
        if (namespace_86b52005c685dfb9::function_7956dfd1302cddff("dog")) {
            thread function_45a008ca8959297f();
        }
        return;
    ...
    weapon = namespace_e0ee43ef2dddadaa::buildweapon("iw8_sm_uzulu_mp", [0:"thermal_west01", 1:"none", 2:"none", 3:"none", 4:"silencer_uzulu", 5:"laserrange_smg"], "none", "none");
    var_a664aad02ee98bd2 = "frag_grenade_mp";
    var_f9fa10e07f13f5fd = self.spawner.script_noteworthy;
    switch (var_f9fa10e07f13f5fd) {
    case #"hash_23209741b93850b5":
        body = "body_mp_eastern_nikto_2_1";
        head = "head_mp_eastern_nikto_3_1";
        weapon = namespace_e0ee43ef2dddadaa::buildweapon("iw8_sh_dpapa12_mp", [0:"none", 1:"none", 2:"none", 3:"muzzlemelee_dpapa12", 4:"caldb_dpapa12", 5:"none"], "none", "none");
        var_a664aad02ee98bd2 = "molotov_mp";
        break;
    case #"hash_6191aaef9f922f96":
        body = "body_mp_eastern_azur_8_1";
        head = "head_mp_eastern_azur_8_1";
        weapon = namespace_e0ee43ef2dddadaa::buildweapon("iw8_sn_alpha50_mp", [0:"vzscope_alpha50", 1:"laserbalancedsnpr", 2:"pistolgrip02_alpha50", 3:"xmags_alpha50", 4:"barlong_alpha50"], "none", "none");
        var_a664aad02ee98bd2 = "frag_grenade_mp";
        break;
    case #"hash_2f2d546c2247838f":
        body = "body_mp_eastern_velikan_1_1";
        head = "head_mp_eastern_velikan_1_1";
        weapon = namespace_e0ee43ef2dddadaa::buildweapon("iw8_lm_mgolf36_mp", [0:"thermal_west01", 1:"none", 2:"none", 3:"none", 4:"none", 5:"none"], "none", "none");
        var_a664aad02ee98bd2 = "semtex_mp";
        break;
    case #"hash_900cb96c552c5e8e":
    ...
    case #"hash_ff739c8b59c1e5ea":
        ...
        weapon = namespace_e0ee43ef2dddadaa::buildweapon("iw8_ar_mike4_mp", [0:"thermal_west01", 1:"none", 2:"none", 3:"none", 4:"silencer_west01", 5:"laserbalanced_mike4"], "none", "none");
        var_a664aad02ee98bd2 = "flash_mp";
        break;
    default:
        break;
    }
    body = "body_mp_eastern_velikan_1_1";
    head = "head_mp_eastern_velikan_1_1";
    function_8d7211588560dd1(body, head, weapon, var_a664aad02ee98bd2);
}
...
// Size: 0x17c
function function_8d7211588560dd1(body, head, weapon, var_a664aad02ee98bd2) {
    self setmodel(body);
    ...
    self.grenadeweapon = makeweapon(var_a664aad02ee98bd2);
    self.grenadeammo = 2;
...
function function_6c8eca00ebac031c(objweapon) {
    namespace_3bbb5a98b932c46f::updatelauncherusage();
}
...
// Size: 0xd8
function function_5add58433814dbc(var_ac7930c851fe41c2) {
    if (function_dc3e57164f1a2eb9(var_ac7930c851fe41c2.targetname)) {
        for (i = 0; i < level.ambientgroups[var_ac7930c851fe41c2.targetname].var_51ab71b549b8e798.size; i++) {
            thread function_420e3f1db78aac7(level.ambientgroups[var_ac7930c851fe41c2.targetname], level.ambientgroups[var_ac7930c851fe41c2.targetname].var_51ab71b549b8e798[i], undefined, self);
        }
    }
    if (isdefined(var_ac7930c851fe41c2.var_51ab71b549b8e798)) {
        for (i = 0; i < var_ac7930c851fe41c2.var_51ab71b549b8e798.size; i++) {
            thread function_420e3f1db78aac7(var_ac7930c851fe41c2, var_ac7930c851fe41c2.var_51ab71b549b8e798[i], undefined, self);
        }
    }
}
...
// Size: 0x125
function function_420e3f1db78aac7(group, var, var_4e62f8d216c2816b, var_a9c4d551b42af0fb) {
    level endon("game_ended");
    group endon("death");
    ...
    if (isstring(var)) {
        ...
        if (isarray(var[0])) {
            for (i = 0; i < var.size; i++) {
                var_43e4442d6ea9b20d = function_420e3f1db78aac7(group, var[i], var_4e62f8d216c2816b);
            }
        } else if (isfunction(var[0])) {
            func = var[0];
            var_params = [];
            var_8a69877ef3d6e5ca = function_91fa2f936230f998(group, var);
            var_43e4442d6ea9b20d = group function_31b0f98a06da6b4f(func, var_8a69877ef3d6e5ca, var_a9c4d551b42af0fb);
        } else {
            var_43e4442d6ea9b20d = var;
        }
    } else if (isfunction(var)) {
        if (istrue(var_4e62f8d216c2816b)) {
            return var;
        } else {
            var_43e4442d6ea9b20d = [[ var ]](group);
        }
    }
    return var_43e4442d6ea9b20d;
}
...
function function_91fa2f936230f998(group, var) {
    ...
    if (var.size < 2) {
        ...
        var_8a69877ef3d6e5ca = spawnstruct();
        var_8a69877ef3d6e5ca.var_params = [];
        var_bae8297148c7f7e8 = min(var.size, 9);
        for (i = 1; i < var_bae8297148c7f7e8; i++) {
            var_5b6f016c0007ca2c = var[i];
            var_8a69877ef3d6e5ca thread function_df50d8fcd21e9646("var_param_race_timeout");
            var_8a69877ef3d6e5ca.var_params[i - 1] = var_8a69877ef3d6e5ca function_420e3f1db78aac7(group, var_5b6f016c0007ca2c, 1);
        }
    }
    return var_8a69877ef3d6e5ca;
}
...
// Size: 0x3ed
function function_31b0f98a06da6b4f(func, params, var_a9c4d551b42af0fb) {
    if (isdefined(var_a9c4d551b42af0fb)) {
        var_84dae085357e37ad = var_a9c4d551b42af0fb;
    } else {
...
function function_bc28e12f0c1c8364(event) {
    ignore_events = [0:"silenced_shot", 1:"silenced_shot_impact", 2:"death"];
