...
function function_68ffb11dc4c6b979(value, aeeventname) {
    if (isdefined(value) && !isint(value) && !isstring(value)) {
        println("<dev string:x35e>" + value + "<dev string:x371>" + function_3c8848a3a11b2553(aeeventname));
        return int(0);
    }
    if (!isdefined(value)) {
        println("<dev string:x3ab>" + function_3c8848a3a11b2553(aeeventname));
        return int(0);
    }
    return value;
}
...
function function_d997435895422ecc(ref, eventtypebit, value) {
    ...
    /#
        if (!isdefined(var_335ba1ebe269094) || var_335ba1ebe269094 == 0) {
            println("<dev string:x400>" + ref + "<dev string:x416>");
        }
    #/
    location = 0;
    location2 = 0;
