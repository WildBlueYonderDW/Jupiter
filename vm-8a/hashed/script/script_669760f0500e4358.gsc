...
function function_858af52a8e277a68(towerstruct, identifier, var_73aa4684ecff09e9) {
    ...
    /#
        if (issharedfuncdefined("<dev string:x1c>", "<dev string:x24>")) {
            [[ getsharedfunc("<dev string:x1c>", "<dev string:x24>") ]]("<dev string:x2d>", "<dev string:x37>", undefined, "<dev string:x45>", undefined, undefined, towerstruct.poi, towerstruct.origin);
        }
    #/
    return scriptable;
}
    ...
    if (canuse) {
        ...
        if (cost > 0) {
            ...
            if (var_4c63764d12ed5def && istrue(instance.successfuluse)) {
                players = level.players;
                instance thread function_a301051f63fbbff9(instance, part, state, player, var_a5b2c541413aa895, usestring, players);
...
// Size: 0x6b3
function function_a301051f63fbbff9(instance, part, state, player, var_a5b2c541413aa895, usestring, streakinfo, players) {
    player endon("death_or_disconnect");
    player endon("enter_live_ragdoll");
...
function function_1a1709943670772a() {
    if (isdefined(level.uavtowers)) {
        foreach (tower in level.uavtowers) {
            ...
            if (!namespace_bbc79db4c3949a5c::function_ee854fdd1e77efc4(tower.uav_station.origin) && !tower.uav_station.gasdisabled) {
                tower_disable(tower.uav_station, "in_gas");
                tower.uav_station setscriptablepartstate("dmz_uav_tower", "unusable");
                tower.uav_station setscriptablepartstate("objective", "none");
                tower.uav_station setscriptablepartstate("dmz_uav_tower_laptop", "laptop_closed");
            ...
            if (namespace_bbc79db4c3949a5c::function_ee854fdd1e77efc4(tower.uav_station.origin) && tower.uav_station.gasdisabled) {
                if (level.var_d507e35282b50614 > 0 && !istrue(tower.uav_station.var_609d30214a3a142e)) {
                    tower.uav_station setscriptablepartstate("dmz_uav_tower", "usable_cost");
                } else {
                    tower.uav_station setscriptablepartstate("dmz_uav_tower", "usable");
                }
                tower.uav_station setscriptablepartstate("objective", "inactive");
...
/#
    ...
    function function_83565380b036f12d() {
        ...
        waitframe();
        scripts\common\devgui::function_6e7290c8ee4f558b("<dev string:x5a>");
        scripts\common\devgui::function_b2159fbbd7ac094e("<dev string:x6b>", @"hash_1583aa42d0c9d90a");
        scripts\common\devgui::function_b2159fbbd7ac094e("<dev string:x85>", @"hash_1583aa42d0c9d90a");
        scripts\common\devgui::function_b2159fbbd7ac094e("<dev string:xa1>", @"hash_c658346ed64f29db");
        scripts\common\devgui::function_b2159fbbd7ac094e("<dev string:xad>", @"hash_158fdc0be6244136");
        scripts\common\devgui::function_b2159fbbd7ac094e("<dev string:xc8>", @"hash_ce4d8222d33e9051");
        scripts\common\devgui::function_b2159fbbd7ac094e("<dev string:xd5>", @"hash_710ff2c3b923a971");
    ...
    function private function_853901492bb15e03() {
        level endon("<dev string:xe9>");
        while (true) {
            if (getdvarint(@"hash_1583aa42d0c9d90a", 0)) {
                setdvar(@"hash_1583aa42d0c9d90a", 0);
                namespace_446fc987a980892f::playevent("<dev string:xf4>", level.players);
                if (issharedfuncdefined("<dev string:x103>", "<dev string:x107>")) {
                    [[ getsharedfunc("<dev string:x103>", "<dev string:x107>") ]]("<dev string:x115>", level.players, 0);
                }
            }
            if (getdvarint(@"hash_4d4dcdd9dd9dd058", 0)) {
                setdvar(@"hash_4d4dcdd9dd9dd058", 0);
                namespace_446fc987a980892f::playevent("<dev string:x132>", level.players);
                if (issharedfuncdefined("<dev string:x103>", "<dev string:x107>")) {
                    [[ getsharedfunc("<dev string:x103>", "<dev string:x107>") ]]("<dev string:x148>", level.players, 0);
                }
            }
            ...
            if (getdvarint(@"hash_ce4d8222d33e9051", 0)) {
                ...
                foreach (player in level.players) {
                    ...
                    var_b608af6e8d86fe42 = 0;
                    if (player namespace_53fc9ddbb516e6e1::function_87072b42853a9c58("<dev string:x167>")) {
                        var_b608af6e8d86fe42 = 1;
                    }
                    radius = int(level.var_6acf91bbf5273e8f * ter_op(isdefined(level.var_c0fe6cb6face684e) && var_b608af6e8d86fe42, level.var_c0fe6cb6face684e, 1));
