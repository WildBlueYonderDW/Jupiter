...
function function_3d552e74ee7e3dee(activityinstance) {
    ...
    wait 1.5;
    self.crystal = activityinstance.var_a897d5b8c6afdc34;
    var_451ce1988c918291 = activityinstance.var_a897d5b8c6afdc34.origin;
    thread function_47b4ba0d70f54cee();
    wait 2;
    activityinstance namespace_edd624734aa27359::function_465ff95e69b7340();
    wait 0.5;
    var_3c41e488c621880d = getaiarrayinradius(var_451ce1988c918291, 1500);
    foreach (zombie in var_3c41e488c621880d) {
        if (isalive(zombie) && zombie.team != level.players[0].team) {
            zombie kill();
            corpse = zombie getcorpseentity();
            if (isdefined(corpse)) {
                var_a33d2a2c3ffecb81 = corpse.origin - var_451ce1988c918291 + (0, 0, 60);
                var_83fd98f3ac829176 = max(500 - distance2d(corpse.origin, var_451ce1988c918291), 0) / 4;
    ...
    function_606642b946a01237("ambient_blocker_stadium_outlast_complete", activityinstance.var_a897d5b8c6afdc34.origin, 1000, 1);
