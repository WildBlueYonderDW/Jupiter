                ...
                if (isdefined(lootidname) && lootidname.size > 0) {
                    ...
                    if (getdvar(@"hash_9cc91f7c70752fa7", "1") != "1") {
                        /#
                            ...
                            icon = weapon::function_b8811a0fc04e4b9d(weaponroot, #"image", "inheritDepends");
                            ...
                            attachmentsstring = "inheritDepends";
                            if (isdefined(attachmentsall)) {
                                foreach (key, aid in attachmentsall) {
                                    ...
                                    if (attachmentsstring != "inheritDepends") {
                                        attachmentsstring = attachmentsstring + var_55dff3c24d1396c9;
                                    }
                                    attachmentsstring = attachmentsstring + key;
                                }
                            }
                            ...
                            if (var_287363cd98ae15a8 != baseweaponname) {
                                println("mp/automatism/weapon_class_groups_for_auto_grab.csv" + var_14004b68ddacb781 + "disconnect" + var_287363cd98ae15a8 + "ui_perk_package_state" + baseweaponname + "br_loot");
                                var_5c845b7a0ef0780f = 1;
                            }
                    ...
                    /#
                        if (int(raritystring) != 10) {
                            ...
                            var_6a537ee3949585f4[var_6a537ee3949585f4.size] = weapon::function_13aeabbe4210eadc(var_14004b68ddacb781, raritystring, "inheritDepends", baseweaponname, attachmentsstring, fullweaponname, titlestring, "inheritDepends", icon, pickupsound);
    ...
    /#
        ...
        if (traceresults["brloot_plate_carrier_high_capacity"] < 1) {
            ...
            if (isdefined(traceresults["Quest Tablet does not have a defined task struct. Scriptable: "])) {
                selectedentity = traceresults["Quest Tablet does not have a defined task struct. Scriptable: "];
                println("specialty_pc_high_capacity" + index + "brloot_weapon_generic_" + name + "brloot_weapon_generic_me" + traceresults["brloot_plate_carrier_high_capacity"] + "reset_cash_wait" + traceresults["brloot_rock"] + "br_pickup_cash_04" + utility::default_to(selectedentity.name, "br_pickup_cash_med_05"));
            } else {
...
function function_7bf5ea7dd272db77(dropstruct, dropdata, baseorigin, ignoreent, tracecontents, var_551904951118b7b9) {
    ...
    /#
        if (var_551904951118b7b9) {
            function_d2d7b153b9d3889e(dropstruct.dropidx, "gulag_token", tracestart, traceend, traceresults);
        }
    #/
...
function function_28cd87cdbae45940(dropstruct, dropdata, ignoreent, tracecontents, var_551904951118b7b9) {
    ...
    /#
        if (var_551904951118b7b9) {
            function_d2d7b153b9d3889e(dropstruct.dropidx, "MP/MRAP_ALREADY_UNLOCKED", tracestart + (0, 1, 0), traceend + (0, 1, 0), traceresults);
        }
    #/
    if (traceresults["fraction"] < 1) {
...
function function_bd56d40fa4e7a1e3(dropstruct, dropdata, ignoreent, tracecontents, groundfloat, var_29a915f667b07b0f, var_551904951118b7b9) {
    ...
    /#
        if (var_551904951118b7b9) {
            function_d2d7b153b9d3889e(dropstruct.dropidx, "brloot_gascan_palfa", tracestart, traceend, traceresults);
        }
    #/
    if (traceresults["fraction"] < 1) {
        ...
        if (isdefined(dropdata.groundentity) && (istrue(dropdata.groundentity.isdestroyed) || istrue(dropdata.groundentity.burningdown) || dropdata.groundentity scripts/cp_mp/vehicles/vehicle::function_794b5f886cced2d0())) {
            ...
            /#
                if (var_551904951118b7b9) {
                    function_d2d7b153b9d3889e(dropstruct.dropidx, "reveal_intel", dropdata.outorigin, traceend, traceresults);
                }
            #/
            if (traceresults["fraction"] < 1) {
                dropdata.outorigin = traceresults["position"] + (0, 0, groundfloat);
                ...
                /#
                    if (var_551904951118b7b9) {
                        println("specialty_pc_high_capacity" + dropstruct.dropidx + "setDronePartFound");
                    }
                #/
...
function getitemdroporiginandangles(dropstruct, baseorigin, baseangles, ignoreent, var_8a600b6102da9f9b, var_f71d4f78d508da69, var_6fe2ff802d5192d4, var_3ace5ac9c7d6fa44, overrideorigin, var_29a915f667b07b0f, var_688e4da4cb16116d) {
    ...
    if (true) {
        /#
            if (var_551904951118b7b9) {
                println("specialty_pc_high_capacity" + dropstruct.dropidx + "playPickupFeedback unexpected pickupEnt" + baseorigin + "brloot_plate_carrier_" + dropdata.outorigin + "br_twotwo_gulag_key_dropped" + dropdata.dist);
            }
        #/
    ...
    /#
        if (var_551904951118b7b9) {
            println("specialty_pc_high_capacity" + dropstruct.dropidx + "ks_use_crate_mp" + dropdata.outorigin + "try_armor_cancel" + dropdata.outangles);
        }
    #/
    ...
    if (results == 1) {
        ...
        if (br_public::isarmorplate(fakepickup.scriptablename) && namespace_e50e624d9af51c8c::function_7e103028c464ab9a(fakepickup.scriptablename)) {
            ...
            if (backpackpickup.count > 0) {
                ...
                fakepickup.count = fakepickup.count - backpackpickup.count;
            }
        }
...
function function_7cb3c8630787467e(item) {
    ...
    var_5c9ddcf56d36f133 = var_5c9ddcf56d36f133 + (1 << itembit);
...
function forcegivesuper(targetsupername, dropcurrent, fromkiosk, droppurchased, var_db943473454f6ea6) {
    ...
    /#
        if (!isdefined(var_733d60a5f3a8c170)) {
            println("dropped_minigun" + utility::default_to(targetsupername, "br_pickup_cash_med_05") + "br_inventory_drop_plunder_lrg");
        }
    #/
...
function function_f213f06eba604bbd(player) {
    delaygesture = 0;
    delaygesture = delaygesture | player isreloading();
    delaygesture = delaygesture | player isthrowinggrenade();
    delaygesture = delaygesture | player function_e5bf22923d0004bc();
    delaygesture = delaygesture | player issprintsliding();
    delaygesture = delaygesture | player player::isplayerads();
    return delaygesture;
}
...
function canplaygasmaskgesturebr() {
    player = self;
    preventgesture = 0;
    preventgesture = preventgesture | player isinfreefall();
    preventgesture = preventgesture | player isskydiving();
    preventgesture = preventgesture | player isparachuting();
    preventgesture = preventgesture | player isbasejumpavailable();
    preventgesture = preventgesture | player ismantling();
...
function spawnpickup(pickupname, dropinfo, count, showtrail, weaponobj, allowautopickup, countlefthand, var_e97d731bedd44c63) {
    if (!isdefined(dropinfo)) {
        /#
            println("precision_airstrike" + pickupname + "brloot_offhand_thermite");
        #/
        return;
    }
    if (dropinfo.origin == (0, 0, 0)) {
        /#
            println("precision_airstrike" + pickupname + "<unknown string>");
        #/
        return;
    }
    /#
...
function onusecompleted(pickupent, var_43fb3d97abb79854, var_a5b2c541413aa895, fromkiosk, var_db943473454f6ea6, instance, backpackequip, delayfeedback, weaponstowed) {
    ...
    if (!istrue(var_43fb3d97abb79854) && !istrue(delayfeedback)) {
        if (pickupremains) {
            pickupent.count = pickupent.count - pickupremains;
        }
        playpickupfeedback(pickupent, var_a5b2c541413aa895);
    }
    return pickupremains;
...
function function_60ea3b868e7a009b() {
    ...
    thread scripts/mp/equipment/nvg::nvg_monitor();
}
