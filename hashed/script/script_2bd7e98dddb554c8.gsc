...
#namespace namespace_977a4b0265e5cfa9;

// Namespace namespace_977a4b0265e5cfa9 / namespace_8532defdbaede15a
// Params 0, eflags: 0x0
...
function main() {
    ...
    setsaveddvar(@"cg_defaultWindFrequencyScale", 0.25);
    setsaveddvar(@"cg_defaultWindAmplitudeScale", 15);
...
function function_b8e64b7ca251968b() {
    ...
    if (isdefined(level.var_b125f0083ff90b31)) {
        stop_wind(level.var_b125f0083ff90b31);
    }
}
...
function function_3e379519d32d703d() {
    ...
    thread namespace_165c742e346e899e::function_b92f94fee459c6b8();
}
