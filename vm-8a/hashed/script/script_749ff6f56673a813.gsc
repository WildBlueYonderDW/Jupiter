...
function private function_f65e637087bf650a(var_751df20fceaee5, var_985e82f034f67960, var_1790664d2cfa3432) {
    ...
    while (true) {
        ...
        /#
            iprintln("<dev string:x40b>" + var_751df20fceaee5.name + "<dev string:x429>" + distance(spawndata.origin, var_751df20fceaee5.var_55b9fdf7eacf9572.origin) + "<dev string:x42e>");
        #/
    }
...
function function_ef855ac387639af6(player) {
    ...
    /#
        player iprintlnbold("<dev string:x439>");
    #/
}
