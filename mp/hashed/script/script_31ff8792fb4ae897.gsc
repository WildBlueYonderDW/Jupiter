...
#namespace jup_spawner_zombie_base_abom_crawler_unstable_rift;

// Namespace jup_spawner_zombie_base_abom_crawler_unstable_rift / namespace_ea24010999cc79a3
// Params 0
// Checksum 0x0, Offset: 0x26e
// Size: 0x1e6
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_spawner_zombie_base_abom_crawler_unstable_rift" );
    ...
    self.zombieaisetting = "settings_zombie_base_abom_crawler_unstable_rift";
...
function precache()
{
    agent_type = "actor_jup_spawner_zombie_base_abom_crawler_unstable_rift";
