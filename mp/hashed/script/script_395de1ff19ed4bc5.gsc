...
function function_79d4df95607e117() {
    var_b1a2a3451f616beb = spawn("trigger_box", (3980, -5556, -232), 0, (2048, 2048, 1024), (2048, 2048, 1024) + (1, 1, 1));
    var_b1a2a3451f616beb.targetname = "OutOfBounds";
    level.outofboundstriggers[level.outofboundstriggers.size] = var_b1a2a3451f616beb;
}
