...
function private function_ad5c3711a54f6d7b(original_position, search_radius, var_c9b964bd35abf3a4, var_9633b54b4a5d18de, var_e4592b88c9fe6650, var_7f4854a36ffa1e4b) {
    ...
    selected_point = var_e4592b88c9fe6650 waittill("FindNearbySpawnPoint_DONE");
...
/#
    ...
    function private function_4be40ababbe96dc7(selected_position, var_4b64167e28d5ee78, var_b9f9b692fc3709e8, var_c9b964bd35abf3a4, duration) {
        ...
        debug_draw(var_b9f9b692fc3709e8, 8, var_44abc2142cbaf028, duration, "<dev string:x17d>", undefined, 0.5);
        debug_draw(function_114e5c055b13dacf(var_b9f9b692fc3709e8), 6, var_eb66e42880eb990b, duration, "<dev string:x192>", 0, 0.5);
        foreach (var_a61ac01523fe8fdb in var_4b64167e28d5ee78) {
            ...
            if (isdefined(var_cb568fc0f8e6c6e) && var_cb568fc0f8e6c6e["<dev string:x1ba>"] < 1) {
                sphere(var_cb568fc0f8e6c6e["<dev string:x1c3>"], 3, var_9017e37442714912, 0, int(duration));
            }
        }
    }
