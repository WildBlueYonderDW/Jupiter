#using character\c_jup_sp_hero_gaz_urban;
...
#namespace jup_ally_hero_kyle_cp;

// Namespace jup_ally_hero_kyle_cp / namespace_badfb910a51e71af
// Params 0, eflags: 0x0
// Checksum 0x0, Offset: 0x1d6
// Size: 0x1ac
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_ally_hero_kyle_cp" );
    self.health = 150;
    self.maxhealth = 150;
...
{
    return character\c_jup_sp_hero_gaz_urban::main();
}
...
function precache()
{
    agent_type = "actor_jup_ally_hero_kyle_cp";
    ...
    if ( !isdefined( level.agent_definition[ agent_type ] ) )
    {
        ...
        character\c_jup_sp_hero_gaz_urban::precache_cpmp();
    }
