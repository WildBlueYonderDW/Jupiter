...
function private onplayerconnected(params) {
    ...
    /#
        self.var_1d52051e15c4b0c5 = getdvarint(@"hash_59c18d87dd312e0b", 1);
    #/
...
// Size: 0x13
function private function_7f88b1f3490ef246(params) {
    function_2f5cbe081bc2430();
}
...
function private function_d23f4d7bfe21f9da() {
    ...
    if (isdefined(var_f99d56bcb582a8ba) && istrue(var_f99d56bcb582a8ba.var_f8e619cb980be7d3)) {
        logstring("[recon_points] OnSpawnReviveTrigger DisablePlayerUseForAllPlayers");
        level.revivetriggers[var_f99d56bcb582a8ba.guid] setscriptablepartstate("cyber_revive_icon", "unusable");
    }
}
...
// Size: 0x258
function private function_9f2f9718ee599902() {
        ...
        if (!self getbeingrevived()) {
            if (function_33a21b2ea282d115() < level.var_135fcaa8f9802c71) {
                if (!istrue(self.squadwiped)) {
                    namespace_58fb4f2e73fd41a0::setlowermessageomnvar("recon_points_respawn_disabled");
                } else {
                    logstring("[recon_points] respawn squadWiped !!! " + self.sessionteam + " " + self.var_ff97225579de16a + " " + self.name);
                    break;
                }
            } else {
                namespace_58fb4f2e73fd41a0::setlowermessageomnvar(function_79fec5974e6c9ddf());
                if (self usebuttonpressed()) {
                    var_bc1ce52af9e40e95 = 0;
                    var_dd906dc35c653c07 = 0.05;
                    ...
                    while (self usebuttonpressed() && self.sessionstate != "playing" && var_bc1ce52af9e40e95 < level.var_f638d0429eb0ffd6) {
                        function_be2a38379b60c50(var_bc1ce52af9e40e95 / level.var_f638d0429eb0ffd6);
                        var_bc1ce52af9e40e95 = var_bc1ce52af9e40e95 + var_dd906dc35c653c07;
                        wait(var_dd906dc35c653c07);
                    }
                    self.var_f8e619cb980be7d3 = undefined;
                    function_1516111d965f0f5(0);
                    function_be2a38379b60c50(0);
                    if (var_bc1ce52af9e40e95 >= level.var_f638d0429eb0ffd6) {
                        logstring("[recon_points] useTime  !!! " + var_bc1ce52af9e40e95);
                        break;
                    }
                    if (isdefined(level.revivetriggers[self.guid])) {
...
function private onplayerkilled(params) {
    if (istrue(level.var_91b26b191aee211d)) {
        thread function_9f2f9718ee599902();
    }
}
...
// Size: 0x8b
function private function_df4b133a2c53cb24(var_751df20fceaee5, var_ae579781d2b3fea1, var_80dcdaa2be651462) {
    if (isdefined(self.var_64891db3f3c85d57) && self.var_64891db3f3c85d57 != -1) {
        if (is_equal(self.var_64891db3f3c85d57, var_ae579781d2b3fea1)) {
            namespace_ede58c1e66c2c280::calloutmarkerping_removecallout(self.var_3c32c1f7963d00d);
            self.var_64891db3f3c85d57 = var_80dcdaa2be651462;
            self.var_3c32c1f7963d00d = namespace_ede58c1e66c2c280::calloutmarkerping_createcallout(11, var_751df20fceaee5.origin, var_80dcdaa2be651462);
...
// Size: 0xa4
function private function_10972832881180ee(var_751df20fceaee5, var_8042d0557aa6b5c6) {
    if (istrue(var_8042d0557aa6b5c6)) {
        namespace_5a22b6f3a56f7e9b::objective_playermask_addshowplayer(var_751df20fceaee5.var_454ad5dad8271c4d, self);
        namespace_5a22b6f3a56f7e9b::objective_playermask_hidefrom(var_751df20fceaee5.var_a6b0920eccdc04cd, self);
        function_df4b133a2c53cb24(var_751df20fceaee5, var_751df20fceaee5.var_a6b0920eccdc04cd, var_751df20fceaee5.var_454ad5dad8271c4d);
    } else {
        namespace_5a22b6f3a56f7e9b::objective_playermask_addshowplayer(var_751df20fceaee5.var_a6b0920eccdc04cd, self);
        namespace_5a22b6f3a56f7e9b::objective_playermask_hidefrom(var_751df20fceaee5.var_454ad5dad8271c4d, self);
        function_df4b133a2c53cb24(var_751df20fceaee5, var_751df20fceaee5.var_454ad5dad8271c4d, var_751df20fceaee5.var_a6b0920eccdc04cd);
    }
}
...
function private function_4f67cc94e9d23825(var_751df20fceaee5) {
    ...
    if (isdefined(var_751df20fceaee5.var_985e82f034f67960)) {
        ...
        namespace_5a22b6f3a56f7e9b::objective_playermask_hidefromall(var_751df20fceaee5.var_454ad5dad8271c4d);
        namespace_5a22b6f3a56f7e9b::objective_playermask_hidefromall(var_751df20fceaee5.var_a6b0920eccdc04cd);
    }
}
...
function private function_2f5cbe081bc2430() {
    ...
    foreach (player in teammates) {
        ...
        var_437fc350b49b05d8 = squadmemberindex * offset;
        amount = int(player function_33a21b2ea282d115());
        var_41445c1d24a2bc4b = amount << var_437fc350b49b05d8 | var_41445c1d24a2bc4b;
    }
    foreach (player in teammates) {
...
function private function_14debcad04282fbf(delta) {
    ...
    if (var_20d7ec5e9edb74a3 < var_41445c1d24a2bc4b && var_20d7ec5e9edb74a3 < level.var_10eebe39d476816e) {
        namespace_44abc05161e2e2cb::showsplash("recon_points_earned", undefined, undefined, undefined, undefined, "splash_list_jup_ob_pvpve");
    }
    ...
    if (level.var_b66406c81d84e91f[playerid] == level.var_10eebe39d476816e) {
        namespace_44abc05161e2e2cb::showsplash("recon_points_max", undefined, undefined, undefined, undefined, "splash_list_jup_ob_pvpve");
    }
    function_2f5cbe081bc2430();
}
...
function private function_777650b23d69e74e(event, params) {
    ...
    case #"hash_eea98455a74fc364":
        return function_82b8ecc89e50b1b4(params);
...
// Size: 0x90
function private function_82b8ecc89e50b1b4(params) {
    ...
    if (function_33a21b2ea282d115() < level.var_8571b4c6c544a92c) {
        namespace_44abc05161e2e2cb::showsplash("recon_points_insufficient", undefined, undefined, undefined, undefined, "splash_list_jup_ob_pvpve");
        return 0;
    }
...
function onAIKilled(params) {
    ...
    var_665a0099fb4fc6e1 = getteamdata(var_3b5afcfeed8fb9cf.team, "players");
    foreach (player in var_665a0099fb4fc6e1) {
        player thread function_777650b23d69e74e(#"hash_9b8264e950c01344");
    }
}
...
function private function_50ff57d0f4bd0d0e(player) {
    ...
    var_d5bf2472e7acab58 = level.var_31f34dcf808ad455 * level.var_31f34dcf808ad455;
    var_d9c6176b077a7891 = distance2dsquared(player.origin, self.origin);
    if (var_d9c6176b077a7891 > var_d5bf2472e7acab58) {
        return 1;
    }
    return 0;
}
...
function private function_14d4e08fe0b364e7() {
    if (namespace_6776e8e74ed64842::function_1f1b9a49f43638d0()) {
        return 1;
    }
    return 0;
}
...
function private function_ca9c0366894334e8() {
    ...
    if (var_56cbe00f8fc22d4b.size <= 0) {
        foreach (player in level.players) {
            player namespace_44abc05161e2e2cb::showsplash("recon_points_free_exfil_not_found", undefined, undefined, undefined, undefined, "splash_list_jup_ob_pvpve");
        }
        return;
    }
    ...
    foreach (player in level.players) {
        ...
        player namespace_44abc05161e2e2cb::showsplash("recon_points_free_exfil_activated", undefined, undefined, undefined, undefined, "splash_list_jup_ob_pvpve");
    }
...
function private function_c28fc02badb3bf98(var_cc371abb7f83dd1b, var_8cbf72799df0c438) {
    ...
    if (var_ee71204034f2c8d1 > 0) {
        ...
        foreach (player in level.players) {
            player namespace_44abc05161e2e2cb::showsplash("recon_points_free_exfil_coming", undefined, undefined, undefined, undefined, "splash_list_jup_ob_pvpve");
        }
    }
}
...
function private onexfilstart(var_751df20fceaee5) {
    namespace_5a22b6f3a56f7e9b::update_objective_icon(var_751df20fceaee5.var_a6b0920eccdc04cd, "ui_map_icon_extraction_enemy");
    foreach (player in level.players) {
...
// Size: 0x93
function private function_a360d23c76ca4ebf(var_751df20fceaee5) {
    namespace_5a22b6f3a56f7e9b::update_objective_icon(var_751df20fceaee5.var_a6b0920eccdc04cd, "ui_map_icon_extraction_recon_points_disabled");
    foreach (player in level.players) {
        player function_bc9f002d4decfa9e(var_751df20fceaee5);
    }
    /#
...
// Size: 0xa9
function private function_7b7d449978e92e60(var_93a0836a10e99c34, var_394466c2ddb208cb) {
    target = namespace_ede58c1e66c2c280::function_b6cb97b6f81f0fd2(var_93a0836a10e99c34, var_394466c2ddb208cb);
    params = spawnstruct();
    ...
    if (isdefined(target)) {
        ...
        if (var_93bc7962739fd49e != -1) {
            self.var_3c32c1f7963d00d = var_394466c2ddb208cb;
            self.var_64891db3f3c85d57 = var_93bc7962739fd49e;
            thread function_54f1ae7e02711fc9();
        }
    }
}
...
function private function_2950b8b7b06664d7(params) {
    ...
    level callback::add("on_exfil_reset", &function_a360d23c76ca4ebf);
...
function private function_7d5272871e474c76() {
    ...
    self.var_454ad5dad8271c4d = function_3472777904abc5b8("ui_map_icon_extraction_recon_points");
    self.var_a6b0920eccdc04cd = function_3472777904abc5b8("ui_map_icon_extraction_recon_points_disabled");
    foreach (player in level.players) {
...
// Size: 0xba
function private function_3472777904abc5b8(var_a465314411ea4812) {
    var_852282c1570ab0f3 = namespace_5a22b6f3a56f7e9b::requestobjectiveid(0);
    namespace_5a22b6f3a56f7e9b::objective_add_objective(var_852282c1570ab0f3, "active");
    namespace_5a22b6f3a56f7e9b::function_bf66c6833e867284(var_852282c1570ab0f3, function_1b78dd27be5b243());
    namespace_5a22b6f3a56f7e9b::function_d7e3c4a08682c1b9(var_852282c1570ab0f3, 0);
    namespace_5a22b6f3a56f7e9b::objective_set_play_intro(var_852282c1570ab0f3, 0);
    namespace_5a22b6f3a56f7e9b::objective_set_play_outro(var_852282c1570ab0f3, 0);
    namespace_5a22b6f3a56f7e9b::function_2946e9eb07acb3f1(var_852282c1570ab0f3, "SHARED_HINTSTRINGS/EXFIL");
    namespace_5a22b6f3a56f7e9b::update_objective_icon(var_852282c1570ab0f3, var_a465314411ea4812);
    namespace_5a22b6f3a56f7e9b::update_objective_setbackground(var_852282c1570ab0f3, 1);
    namespace_5a22b6f3a56f7e9b::update_objective_setzoffset(var_852282c1570ab0f3, 60);
    namespace_5a22b6f3a56f7e9b::function_c3c6bff089dfdd34(var_852282c1570ab0f3, "icon_regular");
    namespace_5a22b6f3a56f7e9b::update_objective_ownerteam(var_852282c1570ab0f3, "neutral");
    namespace_5a22b6f3a56f7e9b::update_objective_position(var_852282c1570ab0f3, self.origin);
    namespace_5a22b6f3a56f7e9b::function_98ba077848896a3(var_852282c1570ab0f3, 0);
    namespace_5a22b6f3a56f7e9b::objective_playermask_hidefromall(var_852282c1570ab0f3);
...
// Size: 0xf
function private function_8b1a7bcc86e73c2e() {
    /#
