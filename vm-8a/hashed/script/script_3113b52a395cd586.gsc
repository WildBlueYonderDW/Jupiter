...
function private function_de3bba90c47cfcf2(hintentity) {
    ...
    while (true) {
        player = hintentity waittill("trigger_progress");
        if (!isdefined(hintentity.tool_user)) {
            ...
            if (isdefined(toolsettings) && hintentity function_ee3c484dddf76a86(player, toolsettings)) {
                ...
                useresult = hintentity waittill("use_finished");
                if (istrue(useresult)) {
...
/#
    ...
    function private function_c1c6eddd67bf7457(player, weapon, var_2feb0814d8b653e0) {
        ...
        return [var_2feb0814d8b653e0, "<dev string:x55>", "<dev string:x55>", "<dev string:x55>"];
    }
    ...
    function private function_7084e044e0ba070a() {
        ...
        tabletitle = "<dev string:x5d>";
        var_cd8110645a9a2632 = ["<dev string:x69>", "<dev string:x76>", "<dev string:x81>", "<dev string:x91>"];
        var_871bdbc7e5abb341 = [];
        var_871bdbc7e5abb341[0] = function_c1c6eddd67bf7457(player, player getcurrentweapon(), "<dev string:xb3>");
        var_871bdbc7e5abb341[1] = function_c1c6eddd67bf7457(player, player getcurrentmonitoredweaponswitchweapon(), "<dev string:xc4>");
        var_871bdbc7e5abb341[2] = function_c1c6eddd67bf7457(player, player gethighpriorityweapon(), "<dev string:xea>");
        ...
        debugtext = "<dev string:x100>" + player isanymonitoredweaponswitchinprogress();
