...
// Namespace namespace_7a90ea0792cd0054 / scripts\cp\cp_enemy_sentry_turret
// Params 2, eflags: 0x0
    ...
    if (isdefined(self.attackerdata)) {
        foreach (player in level.players) {
            ...
            if (isdefined(self.attackerdata[player.guid]) && isdefined(self.attackerdata[player.guid].damage)) {
                ...
                if (bonusmagnitude >= 1) {
                    player thread namespace_5aac85eab99c40a::giverankxp(#"hash_749ea84d7c098477", namespace_5aac85eab99c40a::getscoreinfovalue(#"hash_749ea84d7c098477"));
                }
            }
        }
    }
