...
function function_8613a680f1ec0b46(victim, attacker, bundle, startpos) {
    ...
    var_67200d68ecd20418 = result == "timeout" && !istrue(function_f3bb4f4911a1beb2("player", "isInLastStand", self));
...
function function_bfc3ae90fa9569c9(attacker, bundle) {
    var_e2b6708ab0acbb38, weapon = self waittill("stop_tracker_grenade_thirdparty");
...
function function_ddaa4f3fe17cf7c1(victim) {
    ...
    result = victim waittill("tracker_projectile_result");
    if (istrue(result)) {
