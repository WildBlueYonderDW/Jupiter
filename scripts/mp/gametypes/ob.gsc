...
function function_db2c28c97a3d712a() {
    return getdvarint(@"hash_7661484c77058395", 0) || getdvarint(@"hash_596076b5ab54d511", 0) || getdvarint(@"hash_c385fef4df4638cb", 0) || getdvarint(@"hash_3a4e983e54a9ae7e", 0) || getdvarint(@"hash_ad8d5450e8812fde", 0) || getdvarint(@"hash_596074b5ab54d0ab", 0) || getdvarint(@"hash_f63771eb667cbc20", 0) || getdvarint(@"hash_59607ab5ab54dddd", 0);
}
...
/#
            ...
            if (int(getdvar(@"hash_a7493d6bda4d686b", 0)) == 1) {
                ...
                if (isdefined(enemies) && enemies.size > 0) {
                    foreach (enemy in enemies) {
                        ...
                        print3d(enemy.origin + (0, 0, 80), "<dev string:x5ff>" + var_815f2cee6f7f75cd + "<dev string:x5fa>" + maxarmor);
                    }
                }
            }
            waitframe();
    ...
    function function_ce34466b3cece887(params) {
        ...
        var_c7c6de07e094477d["<dev string:x8c7>"]["<dev string:x801>"] = "<dev string:x8f6>";
        var_c7c6de07e094477d["<dev string:x8c7>"]["<dev string:x832>"] = "<dev string:x920>";
        var_c7c6de07e094477d["<dev string:x8c7>"]["<dev string:x861>"] = "<dev string:x949>";
        var_c7c6de07e094477d["<dev string:x8c7>"]["<dev string:x894>"] = "<dev string:x974>";
        ...
        foreach (player in level.players) {
            name = isdefined(player.name) ? player.name : "<dev string:x9e6>";
            zombie_perks::function_33e402afcb6d2c04([name]);
            waitframe();
            if (!utility::is_equal(power_level, "<dev string:x9f1>")) {
                player armor::setArmorHealth(self.maxarmorhealth);
                waitframe();
                player armor::function_9c6e9a6643b6c9a6(1);
                waitframe();
                ...
                waitframe();
                player currency::function_3036cef61495210f("<dev string:xa03>", 10000);
                waitframe();
            }
            if (utility::is_equal(give_weapon, "<dev string:xa0e>") && !utility::is_equal("<dev string:x9d4>")) {
                ...
                item_bundle = getscriptbundle("<dev string:xa1c>" + item_entry);
            ...
            case #"hash_b76c1b30b726b92c": 
                ...
                break;
            case #"hash_40f74392d7695be8": 
                if (utility::is_equal(give_weapon, "<dev string:xa0e>")) {
                    fakeitem = spawnstruct();
                    var_d7732d0238eae9ff = weaponmaxammo(raygun_weapon);
                    item_bundle = getscriptbundle("<dev string:xa1c>" + var_7a072bf64e5a9686);
                    item_scriptable = item_bundle.scriptable;
                    fakeitem.count = common_item::function_7209c8cd4b2e3afd(var_d7732d0238eae9ff);
                    player common_item::function_7f6f62ba8dfd0da0(item_bundle, fakeitem);
                    wait 0.25;
    ...
    function function_85bb0f2f9de2f140(params) {
        ...
        foreach (player in level.players) {
            ...
            player setclientomnvar("<dev string:xa4f>", issuccessful);
            player setclientomnvar("<dev string:xa6c>", 1);
        }
    }
    ...
    function function_69cc0ae8201249ac() {
        foreach (player in level.players) {
            ...
            player setclientomnvar("<dev string:xa4f>", 0);
            player setclientomnvar("<dev string:xa6c>", 0);
        }
    }

    // Namespace ob / scripts\mp\gametypes\ob
    // Params 0, eflags: 0x0
    // Checksum 0x0, Offset: 0x93c8
    // Size: 0xdbf
    function ob_devgui() {
        ...
        waitframe();
        devgui::function_6e7290c8ee4f558b("<dev string:xa8d>");
        devgui::function_b23a59dfb4ca49a1("<dev string:xa9e>", "<dev string:xaaf>", &function_bfd214941fe81721, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:xac6>", "<dev string:xad7>", &function_bfd214941fe81721, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:xaee>", "<dev string:xb03>", &function_bfd214941fe81721, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:xb1d>", "<dev string:xb31>", &function_bfd214941fe81721, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:xb4a>", "<dev string:xb60>", &function_bfd214941fe81721, 0);
        devgui::function_fe953f000498048f();
        waitframe();
        devgui::function_6e7290c8ee4f558b("<dev string:xb7b>");
        devgui::function_a9a864379a098ad6("<dev string:xb88>", "<dev string:xb96>", &function_4dbb22600ebb3c58, 0);
        devgui::function_a9a864379a098ad6("<dev string:xba4>", "<dev string:xbb8>", &function_548326adbe72c4c3, 0);
        devgui::function_fe953f000498048f();
        waitframe();
        devgui::function_6e7290c8ee4f558b("<dev string:xbcc>");
        devgui::function_b23a59dfb4ca49a1("<dev string:xc03>", "<dev string:xc12>", &function_ce34466b3cece887, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:xc3f>", "<dev string:xc4f>", &function_ce34466b3cece887, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:xc7d>", "<dev string:xc8c>", &function_ce34466b3cece887, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:xcb9>", "<dev string:xcca>", &function_ce34466b3cece887, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:xcf9>", "<dev string:xd0a>", &function_ce34466b3cece887, 0);
        devgui::function_fe953f000498048f();
        devgui::function_6e7290c8ee4f558b("<dev string:xd39>");
        devgui::function_b23a59dfb4ca49a1("<dev string:xd64>", "<dev string:xd7a>", &function_ce34466b3cece887, 0);
        devgui::function_fe953f000498048f();
        devgui::function_6e7290c8ee4f558b("<dev string:xda0>");
        devgui::function_b23a59dfb4ca49a1("<dev string:xc03>", "<dev string:xdd7>", &function_ce34466b3cece887, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:xc3f>", "<dev string:xe03>", &function_ce34466b3cece887, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:xc7d>", "<dev string:xe30>", &function_ce34466b3cece887, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:xcb9>", "<dev string:xe5c>", &function_ce34466b3cece887, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:xcf9>", "<dev string:xe8a>", &function_ce34466b3cece887, 0);
        devgui::function_fe953f000498048f();
        devgui::function_6e7290c8ee4f558b("<dev string:xeb8>");
        devgui::function_b23a59dfb4ca49a1("<dev string:xd64>", "<dev string:xee3>", &function_ce34466b3cece887, 0);
        devgui::function_fe953f000498048f();
        devgui::function_6e7290c8ee4f558b("<dev string:xf08>");
        devgui::function_b23a59dfb4ca49a1("<dev string:xc03>", "<dev string:xf3f>", &function_ce34466b3cece887, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:xc3f>", "<dev string:xf6b>", &function_ce34466b3cece887, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:xc7d>", "<dev string:xf98>", &function_ce34466b3cece887, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:xcb9>", "<dev string:xfc4>", &function_ce34466b3cece887, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:xcf9>", "<dev string:xff2>", &function_ce34466b3cece887, 0);
        devgui::function_fe953f000498048f();
        devgui::function_6e7290c8ee4f558b("<dev string:x1020>");
        devgui::function_b23a59dfb4ca49a1("<dev string:xd64>", "<dev string:x104b>", &function_ce34466b3cece887, 0);
        devgui::function_fe953f000498048f();
        devgui::function_6e7290c8ee4f558b("<dev string:x1070>");
        devgui::function_b23a59dfb4ca49a1("<dev string:xc03>", "<dev string:x10a7>", &function_ce34466b3cece887, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:xc3f>", "<dev string:x10d5>", &function_ce34466b3cece887, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:xc7d>", "<dev string:x1104>", &function_ce34466b3cece887, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:xcb9>", "<dev string:x1132>", &function_ce34466b3cece887, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:xcf9>", "<dev string:x1162>", &function_ce34466b3cece887, 0);
        devgui::function_fe953f000498048f();
        devgui::function_6e7290c8ee4f558b("<dev string:x1192>");
        devgui::function_b23a59dfb4ca49a1("<dev string:xd64>", "<dev string:x11bd>", &function_ce34466b3cece887, 0);
        devgui::function_fe953f000498048f();
        devgui::function_6e7290c8ee4f558b("<dev string:x11e4>");
        devgui::function_b23a59dfb4ca49a1("<dev string:x120c>", "<dev string:x121b>", &function_ce34466b3cece887, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:xd64>", "<dev string:x1243>", &function_ce34466b3cece887, 0);
        devgui::function_fe953f000498048f();
        waitframe();
        if (getdvarint(@"hash_10f0811105fc2f93", 0)) {
            devgui::function_6e7290c8ee4f558b("<dev string:x1269>");
            devgui::function_b23a59dfb4ca49a1("<dev string:x1283>", "<dev string:x128e>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x12b1>", "<dev string:x12bc>", &common_item::function_f8162124bbb6ece3);
            devgui::function_fe953f000498048f();
            devgui::function_6e7290c8ee4f558b("<dev string:x12e7>");
            devgui::function_b23a59dfb4ca49a1("<dev string:x12fe>", "<dev string:x1314>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1334>", "<dev string:x1354>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x137e>", "<dev string:x1395>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x13c7>", "<dev string:x13da>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x140a>", "<dev string:x141d>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x144d>", "<dev string:x1462>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1494>", "<dev string:x14b2>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x14e1>", "<dev string:x14fd>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1527>", "<dev string:x1542>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x156b>", "<dev string:x1587>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x15b5>", "<dev string:x15d0>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x15fd>", "<dev string:x1616>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1654>", "<dev string:x1675>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x16bb>", "<dev string:x16d7>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1718>", "<dev string:x173c>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1785>", "<dev string:x179d>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x17da>", "<dev string:x17fa>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x183f>", "<dev string:x185e>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x18a2>", "<dev string:x18bb>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x18ee>", "<dev string:x1908>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x193c>", "<dev string:x194c>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x196e>", "<dev string:x197e>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x19a0>", "<dev string:x19b0>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x19d2>", "<dev string:x19e2>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1a04>", "<dev string:x1a1b>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1a52>", "<dev string:x1a72>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1ab4>", "<dev string:x1acb>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1b04>", "<dev string:x1b23>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1b64>", "<dev string:x1b7c>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1bb6>", "<dev string:x1bd6>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1c18>", "<dev string:x1c2f>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1c68>", "<dev string:x1c87>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1cc8>", "<dev string:x1ce6>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1d26>", "<dev string:x1d3c>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1d74>", "<dev string:x1d92>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1dd2>", "<dev string:x1de7>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1e1e>", "<dev string:x1e3b>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1e7a>", "<dev string:x1e92>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1ecc>", "<dev string:x1eec>", &common_item::function_f8162124bbb6ece3);
            devgui::function_fe953f000498048f();
            devgui::function_6e7290c8ee4f558b("<dev string:x1f2e>");
            devgui::function_b23a59dfb4ca49a1("<dev string:x1f49>", "<dev string:x1f54>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1f83>", "<dev string:x1f95>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1fc1>", "<dev string:x1fd1>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x1ffb>", "<dev string:x2008>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x202f>", "<dev string:x2040>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x206b>", "<dev string:x207f>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x20ab>", "<dev string:x20c1>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x20ef>", "<dev string:x2103>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x212f>", "<dev string:x2143>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x216f>", "<dev string:x2185>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x21b3>", "<dev string:x21c1>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x21e9>", "<dev string:x21f6>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x221d>", "<dev string:x2230>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x225c>", "<dev string:x226d>", &common_item::function_f8162124bbb6ece3);
            devgui::function_fe953f000498048f();
            devgui::function_6e7290c8ee4f558b("<dev string:x2298>");
            devgui::function_b23a59dfb4ca49a1("<dev string:x22b3>", "<dev string:x22be>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x22e4>", "<dev string:x22ef>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x2315>", "<dev string:x2323>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x234c>", "<dev string:x235c>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x2385>", "<dev string:x2394>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x23be>", "<dev string:x23cc>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x23f4>", "<dev string:x2410>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x2440>", "<dev string:x2452>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x2476>", "<dev string:x2489>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x24b7>", "<dev string:x24d0>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x2503>", "<dev string:x2510>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x2535>", "<dev string:x254d>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x257d>", "<dev string:x2594>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x25c3>", "<dev string:x25d5>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x25fe>", "<dev string:x260e>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x2639>", "<dev string:x2647>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x2670>", "<dev string:x267c>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x26a2>", "<dev string:x26a9>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x26cb>", "<dev string:x26df>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x2704>", "<dev string:x2712>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x273a>", "<dev string:x2752>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x2784>", "<dev string:x2794>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x27be>", "<dev string:x27cf>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x27fb>", "<dev string:x2805>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x282a>", "<dev string:x2837>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x285f>", "<dev string:x286a>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x2890>", "<dev string:x289a>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x28bf>", "<dev string:x28d4>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x28f6>", "<dev string:x2905>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x292f>", "<dev string:x2946>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x2973>", "<dev string:x2982>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x29ac>", "<dev string:x29ba>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x29e3>", "<dev string:x29fd>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x2a1f>", "<dev string:x2a28>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x2a4c>", "<dev string:x2a5a>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x2a7d>", "<dev string:x2a8a>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x2ab2>", "<dev string:x2ac2>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x2aed>", "<dev string:x2af7>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x2b1c>", "<dev string:x2b2e>", &common_item::function_f8162124bbb6ece3);
            devgui::function_fe953f000498048f();
            devgui::function_6e7290c8ee4f558b("<dev string:x2b57>");
            var_590e41714d712137 = getscriptbundle("<dev string:x2b74>" + "<dev string:x2b86>");
            if (isdefined(var_590e41714d712137)) {
                foreach (itementry in var_590e41714d712137.itementries) {
                    ...
                    devgui::function_b23a59dfb4ca49a1(itementry.itemspawnentry, "<dev string:x2ba1>" + itementry.itemspawnentry, &common_item::function_f8162124bbb6ece3);
                }
            }
            devgui::function_fe953f000498048f();
            devgui::function_6e7290c8ee4f558b("<dev string:x2bb0>");
            devgui::function_b23a59dfb4ca49a1("<dev string:x2bcf>", "<dev string:x2bda>", &common_item::function_f8162124bbb6ece3);
            devgui::function_b23a59dfb4ca49a1("<dev string:x2c01>", "<dev string:x2c08>", &common_item::function_f8162124bbb6ece3);
            devgui::function_fe953f000498048f();
        }
        devgui::function_6e7290c8ee4f558b("<dev string:x2c2c>");
        devgui::function_b23a59dfb4ca49a1("<dev string:x2c37>", "<dev string:x2c4a>", &function_85bb0f2f9de2f140, 0);
        devgui::function_b23a59dfb4ca49a1("<dev string:x2c5c>", "<dev string:x2c6f>", &function_85bb0f2f9de2f140, 0);
        devgui::function_a9a864379a098ad6("<dev string:x2c81>", "<dev string:x2c8e>", &function_69cc0ae8201249ac, 0);
        devgui::function_fe953f000498048f();
    }
...
function function_d6d378c8b68bc20b() {
    ...
    /#
        adddebugcommand("<dev string:x2ca4>");
    #/
}
...
function private initspawns() {
    ...
    for (i = 0; i < var_8ef757412d5dd1a8; i++) {
        ...
        if (squadspawnpoints.size > 0) {
            assertex(squadspawnpoints.size >= level.maxsquadsize, "<dev string:x2cac>" + level.maxsquadsize + "<dev string:x2cfc>" + squadspawnpoints.size + "<dev string:x2d09>");
...
function private getstartspawnpoint(player) {
    ...
    if (!isdefined(spawnpoint) && level.var_7a8e039103b51e0f.size) {
        ...
        if (isdefined(spawnpoint)) {
            println("<dev string:x2d0e>" + player.sessionsquadid + "<dev string:x2d52>" + player.var_3f78c6a0862f9e25 + "<dev string:x2d66>");
...
function private function_781ce82d9ee85375(player) {
    ...
    /#
        iprintlnbold("<dev string:x2d98>" + player.sessionsquadid + "<dev string:x2dd7>");
    #/
    return undefined;
}
...
function private obgetspawnpoint() {
    ...
    assertex(isdefined(spawnpoint), "<dev string:x2e0e>" + self.sessionsquadid + "<dev string:x2e35>" + self.var_3f78c6a0862f9e25);
    return spawnpoint;
}
...
// Namespace ob / scripts\mp\gametypes\ob
// Params 1, eflags: 0x0
// Checksum 0x0, Offset: 0xbc04
// Size: 0xfb
function toggle_third_person(override) {
    if (!isplayer(self)) {
        assertmsg("<dev string:x2e41>");
        return;
    }
...
function private function_db15e0482a87b0a8() {
    if (isdefined(self)) {
        return (istrue(self.var_28c033c3c5b37f1f) || istrue(self.hasgoldenammo) || isdefined(self.dog_companion) || istrue(self.var_8a13c2b607afaae7) || istrue(self.var_7724569d0029dd40) || istrue(self.var_737ac766fe3a46e0) || istrue(self.var_194cdb94551bc049));
    }
    return false;
}
    ...
    if (ob_exfil::function_9487b6b2ba44f9db(player)) {
        ...
        if (player function_db15e0482a87b0a8()) {
            ...
            if (isdefined(secondarylootid)) {
                ...
                secondarycomponents = function_5b51f5ce38593c70(isdefined(player.dog_companion), "jup_dog_whistle", secondarycomponents);
                ...
                secondarycomponents = function_5b51f5ce38593c70(player.var_7724569d0029dd40, "jup_warlord_chemist_mask", secondarycomponents);
                ...
                secondarycomponents = function_5b51f5ce38593c70(player.var_2c79bac674ce4c02, "jup_disciple_bottle", secondarycomponents);
...
function function_49a36aa578018249(player) {
    ...
    if (isdefined(var_20c658ecc13192f4) && var_20c658ecc13192f4 != 0) {
        assertmsg("<dev string:x2e6c>");
        player namespace_736197e4d378b91b::function_d5143d7900e7160a(2);
    }
    if (!maptomap) {
        for (backpackindex = 0; backpackindex < 10; backpackindex += 1) {
...
function function_19b0c4d24e6a74cb(deployedent, player, entitytype) {
    ...
    if (player.var_a138385e76eddf7a[entitytype] >= var_814a2c4ab1afd10d) {
        foreach (key, entinfo in player.deployedentities) {
            if (!isdefined(entinfo.ent)) {
                player.var_a138385e76eddf7a[entinfo.type] = player.var_a138385e76eddf7a[entinfo.type] - 1;
                level.var_a138385e76eddf7a[entinfo.type] = level.var_a138385e76eddf7a[entinfo.type] - 1;
    ...
    if (isdefined(var_4366d64f4ed77d76)) {
        ...
        player.var_a138385e76eddf7a[var_ff70f58d77c693f7] = player.var_a138385e76eddf7a[var_ff70f58d77c693f7] - 1;
        level.var_a138385e76eddf7a[var_ff70f58d77c693f7] = level.var_a138385e76eddf7a[var_ff70f58d77c693f7] - 1;
    ...
    player.var_a138385e76eddf7a[entitytype] = player.var_a138385e76eddf7a[entitytype] + 1;
    level.var_a138385e76eddf7a[entitytype] = level.var_a138385e76eddf7a[entitytype] + 1;
