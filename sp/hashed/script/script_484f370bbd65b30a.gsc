...
function function_64aa262d16ae7f08() {
    ...
    if (isdefined(var_e86b25000c0fb10e)) {
        ...
        var_8545c675abb1f796 = utility::spawn_model("misc_wm_grappling_gun_prison_v0");
        var_8545c675abb1f796 linktoplayerview(level.player, "tag_sling", (0, 0, 0), (0, 0, 0), 0);
        level.var_8545c675abb1f796 = var_8545c675abb1f796;
        wait 1.5;
        /#
...
function function_1ef6967993effd57() {
    ...
    if (isdefined(level.var_8545c675abb1f796)) {
        var_8545c675abb1f796 = level.var_8545c675abb1f796;
        var_8545c675abb1f796 unlinkfromplayerview(level.player);
        var_8545c675abb1f796 delete();
    }
...
function function_4d72aea895f54ad4() {
    ...
    thread function_9a5815022f6581d4();
}
...
// Size: 0xe
function function_9a5815022f6581d4() {
