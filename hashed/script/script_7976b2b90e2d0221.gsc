...
#using script_5ec4d9eb49d5a95a;
#using script_c2889dbfb411a02;
#using script_213c07da67d10e18;
#using scripts\mp\load.gsc;
#using scripts\common\create_script_utility.gsc;
#using script_50b1c259aaa5940c;
#using script_22225c61b3d5ba6a;
#using script_5e6c61131ca7155f;
#using script_32fc059215134990;
#using script_31e709a689baa631;
#using script_190790f6466f8a06;
...
// Namespace mp_jup_launchfacility / namespace_a072a37d78f27a95
// Params 0, eflags: 0x0
// Checksum 0x0, Offset: 0x1d77
// Size: 0x26a
function main() {
    namespace_cc8e5201512d1736::main();
    namespace_1056cd5f99ec1cd0::main();
    namespace_fd7f91c76d70ed1e::main();
    namespace_d7d87c46812c4227::main();
    scripts\mp\load::main();
    scripts\common\create_script_utility::initialize_create_script();
    level thread namespace_1d130fe9837b0fa8::main();
    level thread namespace_f0da7a69a538b1b2::main();
    level thread namespace_c5263becbfa5eac7::main();
    level thread namespace_1346a34c4677076c::main();
    namespace_a34a6fc22fd9eb21::function_b82404e40cca2415();
...
function function_82913d07328e5537() {
    level endon("game_ended");
    zone = level waittill("wm_zone_captured");
...
function function_8ac0af786a238752() {
    level endon("game_ended");
    tank = level waittill("escort_path_set");
    assert(isdefined(tank.checkpoints));
    level.var_d6978f2488db9962 = [];
    level.var_b88b549a97ae484a = [];
    foreach (i, checkpoint in tank.checkpoints) {
        foreach (side in ["attackers", "defenders"]) {
            ...
            if (isdefined(var_606e9637acb77372) && var_606e9637acb77372.size > 0) {
                level.var_d6978f2488db9962[i][side] = var_606e9637acb77372;
                level.var_b88b549a97ae484a[i][side] = getent("stage_" + i + "_" + side, "targetname");
                if (isdefined(level.var_b88b549a97ae484a[i][side])) {
                    level.var_b88b549a97ae484a[i][side].side = side;
                }
            }
        }
    }
...
function function_9aa340020fc22929() {
    ...
    foreach (i, checkpoint in self.checkpoints) {
        if (!isdefined(level.var_d6978f2488db9962[i])) {
            continue;
        }
        function_e7d2bd03a0c17f96(level.var_d6978f2488db9962[i], level.var_b88b549a97ae484a[i], i == 1);
...
function function_4e41bf0f45af388d(zone) {
    ...
    var_756fbd3a175f6cef = "attackers";
    var_cc2e11c7f298433 = "defenders";
    ...
    var_f2b3753e22a55135 = [[var_cc2e11c7f298433, "obj1_nag_def_launchfacility", &namespace_500f6f1bc37289b::function_b908e49a52805716, undefined, var_f00ee835cfdde317, 20, 8], [var_756fbd3a175f6cef, "obj1_nag_atk_launchfacility", &namespace_500f6f1bc37289b::function_c6d032c5630b1779, undefined, var_2b294986c82254b3, 20, 8], [var_756fbd3a175f6cef, "obj1_securing_a_atk", var_c450199ce7b0b007, zone.capture_zones[0], var_2b294986c82254b3], [var_756fbd3a175f6cef, "obj1_captured_a_atk", var_99716e712cb5d3e, zone.capture_zones[0], var_2b294986c82254b3], [var_cc2e11c7f298433, "obj1_losing_a_def", var_c450199ce7b0b007, zone.capture_zones[0], var_f00ee835cfdde317], [var_cc2e11c7f298433, "obj1_lost_a_def", var_99716e712cb5d3e, zone.capture_zones[0], var_f00ee835cfdde317], [var_756fbd3a175f6cef, "obj1_securing_b_atk", var_c450199ce7b0b007, zone.capture_zones[1], var_2b294986c82254b3], [var_756fbd3a175f6cef, "obj1_captured_b_atk", var_99716e712cb5d3e, zone.capture_zones[1], var_2b294986c82254b3], [var_cc2e11c7f298433, "obj1_losing_b_def", var_c450199ce7b0b007, zone.capture_zones[1], var_f00ee835cfdde317], [var_cc2e11c7f298433, "obj1_lost_b_def", var_99716e712cb5d3e, zone.capture_zones[1], var_f00ee835cfdde317], [var_756fbd3a175f6cef, "obj1_missile_launch_atk", "zone_1_missile_launched", undefined, var_2b294986c82254b3, 2, 2], [var_756fbd3a175f6cef, "obj1_atk_overtime_launchfacility", "obj_type_1_overtime_mp_jup_launchfacility", undefined, var_2b294986c82254b3], [var_cc2e11c7f298433, "obj1_def_overtime_launchfacility", "obj_type_1_overtime_mp_jup_launchfacility", undefined, var_f00ee835cfdde317]];
...
function function_a9229844e65e7b50() {
    ...
    assertex(isdefined(var_795e67d6e6be2a3c.var_85080a73a3121271), "<dev string:xf5>");
    while (true) {
        waitframe();
        foreach (player in level.players) {
            if (!istrue(player.var_9b713d24bdb6d97f) && (isalive(player) && player istouching(var_795e67d6e6be2a3c) || !isalive(player) && is_equal(player.team, game["defenders"]))) {
                player scripts\mp\compass::function_fb7bad834ce4b28c(var_795e67d6e6be2a3c.var_85080a73a3121271);
