...
/#
    ...
    function function_7b3bb02905678cfe() {
        ...
        while (true) {
            playerlist = level.players;
            thread namespace_446fc987a980892f::playevent("<dev string:xb7>", playerlist);
            ...
            wait waittime;
            thread namespace_446fc987a980892f::playevent("<dev string:xf6>", playerlist);
            printtoscreen2d(xpos, ypos, "<dev string:xf6>", color, scale, duration);
            wait waittime;
            thread namespace_446fc987a980892f::playevent("<dev string:x10a>", playerlist);
            ...
            wait waittime;
            thread namespace_446fc987a980892f::playevent("<dev string:x13b>", playerlist);
            printtoscreen2d(xpos, ypos, "<dev string:x13b>", color, scale, duration);
            wait waittime;
            thread namespace_446fc987a980892f::playevent("<dev string:x14e>", playerlist);
            ...
            wait waittime;
            thread namespace_446fc987a980892f::playevent("<dev string:x187>", playerlist);
            printtoscreen2d(xpos, ypos, "<dev string:x187>", color, scale, duration);
            wait waittime;
            thread namespace_446fc987a980892f::playevent("<dev string:x199>", playerlist);
            printtoscreen2d(xpos, ypos, "<dev string:x199>", color, scale, duration);
            scripts\mp\gametypes\br_gametype_dmz::showdmzsplash("<dev string:xcc>", level.players, "<dev string:xe7>");
            wait waittime;
            thread namespace_446fc987a980892f::playevent("<dev string:x1b4>", playerlist);
            printtoscreen2d(xpos, ypos, "<dev string:x1b4>", color, scale, duration);
            wait waittime;
            thread namespace_446fc987a980892f::playevent("<dev string:x1d4>", playerlist);
    ...
    function function_7273b2652941f86a() {
        ...
        while (true) {
            ...
            thread namespace_446fc987a980892f::playevent("<dev string:x14e>", level.players);
            wait waittime;
