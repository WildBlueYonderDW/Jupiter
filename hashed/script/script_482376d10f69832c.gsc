...
function spawn_contract_reward_rift(activityinstance, var_e0a0dc78cd0e70f3, var_5edef452e5fc2cd7) {
    ...
    /#
        var_88a08b25571f4a24 = activity_rewards::function_1edea59f189f9a02(activityinstance, "REV_OB_DEFEND_MERCS", "ob_jup_items_reward_loot_schematic_yellow");
        if (!var_88a08b25571f4a24) {
            reward_cache::function_1c5f030d48fdff4c("<unknown string>" + namespace_4fda5d7358015a06::function_a4748b32a824c79c(activityinstance) + "<unknown string>" + "ob_jup_items_reward_loot_schematic_yellow" + "<unknown string>" + "<unknown string>" + "<unknown string>" + "<unknown string>");
        }
    #/
...
function function_dc1a9b9610b44060(var_e10194ca6271ac0a, reward_instance) {
    for (timer = 15; timer > 0; timer = timer - 1) {
        foreach (player in reward_instance.var_cc4e306d6425c182) {
            /#
...
function function_b3c1e8c1d1b05b20(center_origin, n_radius, var_cd00b21daa6ae0b4) {
    ...
    for (i = 0; i < 360; i = i + 20) {
        ...
        if (isdefined(pos_on_navmesh)) {
            bsight = scripts/engine/trace::ray_trace_passed(center_origin + var_5ac1024b00cecc71, pos_on_navmesh + var_5ac1024b00cecc71, self.var_6c29f2fdb0054bbe);
            if (istrue(bsight)) {
...
function function_de2062aa7eaf5617(params) {
    /#
        ...
        scripts/common/devgui::function_b23a59dfb4ca49a1("<unknown string>", "<unknown string>", &function_891f5abdda30f2cb, 1);
...
function function_cdd311c6e43e2ca3() {
    /#
        if (getdvarint(@"hash_387419b90066e4b5", 0)) {
            wait(6);
            scripts/common/devgui::function_6e7290c8ee4f558b("<unknown string>");
            scripts/common/devgui::function_b23a59dfb4ca49a1("<unknown string>" + self.name, "<unknown string>" + self.name, &function_cdffe21a96903d57, 1);
            scripts/common/devgui::function_fe953f000498048f();
            scripts/common/devgui::function_6e7290c8ee4f558b("<unknown string>");
            scripts/common/devgui::function_b23a59dfb4ca49a1("<unknown string>" + self.name, "<unknown string>" + self.name, &function_cdffe21a96903d57, 1);
            scripts/common/devgui::function_fe953f000498048f();
