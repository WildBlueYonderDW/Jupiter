...
function private priority_setByDormancyId(var_451a9d27d63c746b, priority) {
    ...
    assert(isdefined(var_451a9d27d63c746b), "<dev string:xa00>");
...
function private priority_removeByDormancyId(var_451a9d27d63c746b) {
    assert(isdefined(var_451a9d27d63c746b), "<dev string:xaba>");
    assert(isdefined(level.var_879053468f168806[var_451a9d27d63c746b]), "<dev string:xafd>" + var_451a9d27d63c746b);
...
// Namespace ai_mp_controller / namespace_bfef6903bca5845d
// Params 1, eflags: 0x4
// Checksum 0x0, Offset: 0x10fb0
// Size: 0x2c
function private function_4fc5b97f88757e83(armorPlateCount) {
    return function_edabf4238e9d70b5("brloot_armor_plate", namespace_38b993c4618e76cd::getlootidfromref("armor_plate"), "armor_plate", 1, armorPlateCount);
}
                ...
                if (isdefined(level.var_41670c1c65f3d3cf.poi[poiname])) {
                    if (!poiinfo.var_6ad2d5385a612cd5[poiname].outlined) {
                        ...
                        foreach (agent in function_7e3f22e620f3f71e(poiname, "<dev string:xe91>")) {
                            if (isalive(agent)) {
                                var_4430b08d5a2d47bf = "<dev string:x10af>";
                                ...
                                id = scripts\mp\utility\outline::outlineenableforall(agent, var_4430b08d5a2d47bf, "<dev string:x111a>");
        ...
        while (true) {
            ...
            if (getdvarint(@"hash_88ae422170005010", 0) > 0) {
                if (istrue(level.var_289df80e1ded586f)) {
                    ...
                    if (isdefined(player)) {
                        origin = function_61cbc488b27a6e61(player.origin);
                        level thread namespace_bfef6903bca5845d::function_77acc10c4823dd8a(2, origin, "<dev string:xe2f>", "<dev string:xf97>", "<dev string:xe46>", undefined, player.team);
                    }
                }
            ...
            if (getdvarint(@"hash_7882eb2f0ed5ba94", 0) > 0) {
                if (istrue(level.var_289df80e1ded586f)) {
                    ...
                    if (isdefined(player)) {
                        origin = function_61cbc488b27a6e61(player.origin);
                        level thread namespace_bfef6903bca5845d::function_77acc10c4823dd8a(5, origin, "<dev string:xe2f>", "<dev string:xf97>", "<dev string:xe46>", undefined, team);
                    }
                }
