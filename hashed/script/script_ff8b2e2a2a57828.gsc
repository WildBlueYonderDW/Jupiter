...
function function_8ff0eb9963fb04f9() {
    ...
    var_835c750a6ae79b63 = utility::make_weapon("jup_jp12_pi_mike93_sp", ["jup_jp12_pi_mike93_mag_30_9mm", "breacher_pi_01", "jup_jp12_pi_mike93_trigger", "laserpstl_hip01"]);
    level.player utility::give_weapon(var_835c750a6ae79b63);
...
// Size: 0x100
function function_bcb165cdaab9108a() {
    self endon("death");
    self.animname = "generic";
    set_pacifist(1);
...
function function_2d0687f499cc3295() {
    ...
    for (i = 0; i < level.ai_hideout_sfo_interior_1.size; i++) {
        var_be12e0030ac87dfd = level.ai_hideout_sfo_interior_1[i];
        nd_start = var_52b4ab89758c004b[i];
        var_be12e0030ac87dfd forceteleport(nd_start.origin, nd_start.angles);
    }
...
function function_297b8c42f0cd844f() {
    ...
    foreach (var_be12e0030ac87dfd in level.var_c5c98481cf154b0f) {
        var_be12e0030ac87dfd set_movement_speed(178);
    }
    ...
    if (isdefined(level.ai_hideout_sfo_interior_1)) {
        foreach (var_be12e0030ac87dfd in level.ai_hideout_sfo_interior_1) {
            var_be12e0030ac87dfd demeanor_override("combat");
        }
    }
...
function function_6eba453eebbd5964() {
    ...
    foreach (var_be12e0030ac87dfd in level.ai_hideout_sfo_interior_1) {
        if (isdefined(var_be12e0030ac87dfd.script_noteworthy) && var_be12e0030ac87dfd.script_noteworthy == "hideoutally04") {
            var_be12e0030ac87dfd delete();
        }
    }
}
...
function function_1dd827966f49f75a() {
    ...
    foreach (var_be12e0030ac87dfd in level.ai_hideout_sfo_interior_1) {
        ...
        var_be12e0030ac87dfd demeanor_override("cqb");
        var_be12e0030ac87dfd reset_gunpose();
    }
}
...
function function_f285fd7f0e1251fd() {
    ...
    var_e96573032a773830 = getent("trg_hideout_sidehall_kill_enemies", "targetname");
    var_e96573032a773830 waittill("trigger");
...
function function_95d3b75d974927ea() {
    ...
    if (isdefined(self.script_noteworthy)) {
        if (self.script_noteworthy == "escalator_shooter_1") {
            function_f8e2cbc7dcc8a9ca();
        }
        if (self.script_noteworthy == "escalator_shooter_2") {
            function_f8e2cac7dcc8a797();
        }
    }
...
// Size: 0x5a
function function_f8e2cbc7dcc8a9ca() {
...
// Size: 0x69
function function_f8e2cac7dcc8a797() {
    level endon("flg_hideout_escalators_notice_player");
    set_fixednode_true();
    wait 1;
...
// Size: 0x18f
function function_296962e0e44b3990() {
    namespace_fc0114e844f0b4c::function_3c4b810d62d1f03f();
...
function function_eb66c89c1f99f182() {
    ...
    level thread function_b66290830e323514();
...
function hideout_finale_stairway_guy_floor_2() {
    ...
    var_77df62651507e1fb = getnode("n_shotgun_hide_node", "targetname");
    ...
    hideout_finale_stairway_guy_floor_2 setgoalnode(var_77df62651507e1fb);
...
function function_70926173b60fce4a() {
    ...
    level.ai_hideout_sfo_interior_1 = array_removedead_or_dying(level.ai_hideout_sfo_interior_1, 1);
    foreach (var_be12e0030ac87dfd in level.ai_hideout_sfo_interior_1) {
        var_be12e0030ac87dfd clear_colors();
        var_be12e0030ac87dfd clear_force_color();
        var_be12e0030ac87dfd set_fixednode_true();
    }
...
function function_96aa4213b2b53934(var_5ef8efbbee012729) {
    ...
    self waittill("death");
    namespace_223959d3e5206cfb::detachallweaponmodels();
    if (var_5ef8efbbee012729 == 1) {
...
function function_d16344accb85972c() {
    ...
    foreach (var_be12e0030ac87dfd in var_2028491b720b89d1) {
        switch (var_be12e0030ac87dfd.name) {
        case #"hash_156ffa4f8b089876":
        case #"hash_e9e6926c847ca2cd": 
            break;
        default: 
            if (isdefined(var_be12e0030ac87dfd.magic_bullet_shield)) {
                var_be12e0030ac87dfd stop_magic_bullet_shield();
            }
            var_be12e0030ac87dfd delete();
            break;
        }
...
function function_5ff5bbe55d13626c() {
    ...
    while (true) {
        ...
        if (weapon.basename == "smoke") {
            ...
            grenadeorigin = grenade waittill("explode");
