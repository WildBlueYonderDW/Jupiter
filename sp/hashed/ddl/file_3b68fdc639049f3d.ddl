...
struct root {
    ...
    int32 team_score;
    // offset: 0x180, bitSize: 0x15080(0x2a10B)
    Player player[8];
    // offset: 0x15200, bitSize: 0x8(0x1B)
    byte totalNumOfQuestPieces;
    // offset: 0x15208, bitSize: 0x10(0x2B)
    short deathCount;
    // offset: 0x15218, bitSize: 0x18(0x3B)
    bit questPieces[24];
    // offset: 0x15230, bitSize: 0x4
    bit playOutroVideo[4];
    // offset: 0x15234, bitSize: 0x1
    bit isPublicMatch;
    // offset: 0x15235, bitSize: 0x3
    pad __pad[3];
}

// bitSize: 0x2a10, members: 18
struct Player {
    ...
    // offset: 0x88, bitSize: 0x1360(0x26cB)
    uint32 killsPerWeapon[155];
    // offset: 0x13e8, bitSize: 0x20(0x4B)
    int32 xuidHigh;
    // offset: 0x1408, bitSize: 0x20(0x4B)
    int32 xuidLow;
    // offset: 0x1428, bitSize: 0x10(0x2B)
    short dropped_to_last_stand;
    // offset: 0x1438, bitSize: 0x10(0x2B)
    short entering_afterlife_arcade;
    // offset: 0x1448, bitSize: 0x10(0x2B)
    short prestige;
    // offset: 0x1458, bitSize: 0x20(0x4B)
    uint32 DeadliestWeaponKills;
    // offset: 0x1478, bitSize: 0x170(0x2eB)
    char username[46];
    // offset: 0x15e8, bitSize: 0x1360(0x26cB)
    int32 headShots[155];
    // offset: 0x2948, bitSize: 0xc8(0x19B)
