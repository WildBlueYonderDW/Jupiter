...
function function_24f4b903cdc204c2() {
    ...
    var_4a6b881c2be5ded6 = getdvarint(@"hash_f2e808f1292f667a", default_to(bundle.var_f93950bf65512abc, 800));
    var_9fa86a6e425bd129 = default_to(bundle.var_57427c73099989cb, 0.5);
    var_3a50363cc9a1d533 = var_4a6b881c2be5ded6 * var_4a6b881c2be5ded6;
    owner = self.owner;
    while (true) {
        if (!isdefined(self)) {
