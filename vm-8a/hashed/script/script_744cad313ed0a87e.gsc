...
function init() {
    ...
    /#
        ...
        if (level.mapname == "<dev string:x1c>" || level.mapname == "<dev string:x2c>" || level.mapname == "<dev string:x40>") {
...
function function_401ab3dde070adde() {
    ...
    foreach (zoneindex in level.var_d295f7b9a28a5a53) {
        ...
        println("<dev string:x57>" + zoneindex + "<dev string:x61>" + zonename + "<dev string:x65>" + zonebounds.midpoint);
        fortress = undefined;
        poiname = undefined;
        ...
        if (isdefined(fortress)) {
            ...
            /#
                namespace_d1a9ca87d78d9813::function_9533653868e59fb6("<dev string:x68>", fortress.var_6a9a1aeeaa7c25df, undefined, undefined, undefined, undefined, poiname, fortress.origin);
            #/
        }
    }
}
    ...
    /#
        if (istrue(level.var_796c2a6da634b24)) {
            if (!istrue(level.var_1b2f85b0ae4ac35a)) {
                ...
                return "<dev string:x71>";
            } else {
                level.var_1b2f85b0ae4ac35a = 0;
                return "<dev string:x76>";
            }
        }
        tier = getdvar(@"hash_783c94fc1fa40619", "<dev string:x71>");
    #/
...
function function_3af1473d439d8c32(proximitytrigger, var_9399bf62b66519d1) {
    assertex(isdefined(proximitytrigger), "Volume based activity mission trigger must be defined!");
    triggerowner = self;
    level endon("game_ended");
    proximitytrigger endon("deleted");
    ...
    assertex(resolutions > 0, "Trigger needs a sample resolution!");
    while (true) {
        wait resolutions;
        foreach (playerentnum, touchent in proximitytrigger.touchents) {
            ...
            assertex(isdefined(proximitytrigger.var_3551befc72f03b2d[playerentnum]), "Proximity ent does not have a last touch time!");
            currenttime = gettime();
...
/#
    ...
    function function_de1bd18e889bf4cf() {
        level endon("<dev string:x7c>");
        while (!scripts\mp\flags::gameflagexists("<dev string:x87>")) {
            waitframe();
        }
        scripts\mp\flags::gameflagwait("<dev string:x87>");
        while (true) {
    ...
    function function_595371fc4dfe389e() {
        ...
        if (level.var_5d89e32b0b1d5e91) {
            ...
            var_b7e45754fc79e080 = getstructarray("<dev string:x68>", "<dev string:x95>");
            assertex(isdefined(var_b7e45754fc79e080), "<dev string:xa0>");
            level.buildingslist.var_b7e45754fc79e080 = var_b7e45754fc79e080;
            if (level.buildingslist.size <= 0) {
                assertex(isdefined(level.buildingslist), "<dev string:xc1>");
            ...
            while (true) {
                if (isdefined(level.buildingslist.var_b7e45754fc79e080)) {
                    foreach (building in level.buildingslist.var_b7e45754fc79e080) {
                        ...
                        if (istrue(building.var_5dfdfd9369ac6229) && building.targetname == "<dev string:x68>") {
                            ...
                            if (isdefined(building.details)) {
                                ...
                                debugstar(building.origin + (0, 0, building.buildingnumber * 15 + 2500), (0.9, 0.45, 0.16), 1, "<dev string:x117>", 8);
                            }
                            continue;
                        }
                        if (building.targetname == "<dev string:x68>") {
                            ...
                            debugstar(building.origin + (0, 0, building.buildingnumber * 15 + 1500), (0, 0.53, 1), 1, "<dev string:x130>", 8);
                        }
                    }
                }
                waitframe();
    ...
    function function_5edce2f3bff589aa() {
        ...
        foreach (building in level.buildingslist.var_b7e45754fc79e080) {
            ...
            building.details = building.targetname + "<dev string:x14b>" + building.buildingnumber + "<dev string:x14d>" + building.origin + "<dev string:x14d>" + building.script_noteworthy;
            println(building.targetname + "<dev string:x14b>" + buildingnumber + "<dev string:x14d>" + building.origin + "<dev string:x14d>" + building.script_noteworthy);
            buildingnumber++;
        }
        println("<dev string:xfc>");
    ...
    function function_2e05a3e6a13f7f41() {
        level.var_a26603334c1c6a92 = getdvar(@"hash_cdeb1ca71e6be198", "<dev string:x151>");
        level.var_9ae90712d17712c9 = getdvar(@"hash_b35fcff8546c9263", "<dev string:x18c>");
        level.var_6ff106c0b1a35216 = getdvar(@"hash_6d1915e851755f48", "<dev string:x1cf>");
        level.var_b058b2f92388e765 = getdvar(@"hash_13bcb7740a523cb3", "<dev string:x20b>");
        ...
        var_d83669c828e2321f = getdvar(@"hash_5b99e4cd7a9e446", "<dev string:x29c>");
        var_bd14353e6a3cf288 = openfile(var_d83669c828e2321f, "<dev string:x2bf>");
        var_9b0694d51cc06f60 = "<dev string:x2c5>";
        var_9b0694d51cc06f60 += "<dev string:x310>";
        fprintln(var_bd14353e6a3cf288, var_9b0694d51cc06f60);
        var_9b0694d51cc06f60 = "<dev string:x327>";
        foreach (poi in poinames) {
            if (isdefined(hotzones.blacksites[poi]) && hotzones.blacksites[poi].size > 0) {
                var_9b0694d51cc06f60 += "<dev string:x328>";
                foreach (hotzone in hotzones.blacksites[poi]) {
                    var_9b0694d51cc06f60 += function_a2d65f1e8991513f(hotzone, 1);
                }
                var_9b0694d51cc06f60 += "<dev string:x332>";
                fprintln(var_bd14353e6a3cf288, var_9b0694d51cc06f60);
                var_9b0694d51cc06f60 = "<dev string:x327>";
            }
        }
        var_9b0694d51cc06f60 += "<dev string:x332>";
        var_9b0694d51cc06f60 += "<dev string:x334>";
        fprintln(var_bd14353e6a3cf288, var_9b0694d51cc06f60);
        var_9b0694d51cc06f60 = "<dev string:x327>";
        foreach (poi in poinames) {
    ...
    function function_a2d65f1e8991513f(hotzonename, isblacksite) {
        var_b6f0e58e86c6362c = "<dev string:x34b>" + hotzonename + "<dev string:x351>";
        if (isblacksite) {
            var_b6f0e58e86c6362c += level.var_6ff106c0b1a35216 + "<dev string:x35c>" + level.var_b058b2f92388e765 + "<dev string:x35e>";
        } else {
            var_b6f0e58e86c6362c += level.var_a26603334c1c6a92 + "<dev string:x35c>" + level.var_9ae90712d17712c9 + "<dev string:x35e>";
        }
