...
function private function_92b52877803f326a() {
    var_e2818ad39a3341b4 = vehomn_getleveldataforvehicle("veh_jup_space_shipment_transport", 1);
...
function private function_31f42ad9450cb938(spawndata, faildata) {
    ...
    var_e2818ad39a3341b4 = scripts\cp_mp\vehicles\vehicle_collision::vehicle_collision_getleveldataforvehicle("veh_jup_space_shipment_transport", 1);
    var_e2818ad39a3341b4.handleeventcallback = &function_8c08b5b97a81fb61;
    return vehicle;
}
...
function function_8c08b5b97a81fb61(vehicle1, vehicle2, position, normal, normalspeed) {
    if (vehicle1 function_d93ec4635290febd() == "veh_jup_space_shipment_transport") {
        var_ccb2631df87b482a = vehicle2;
    } else if (vehicle2 function_d93ec4635290febd() == "veh_jup_space_shipment_transport") {
        var_ccb2631df87b482a = vehicle1;
    } else {
        return;
    }
    if (!isdefined(var_ccb2631df87b482a) || !var_ccb2631df87b482a isvehicle()) {
        return;
    }
    if (isdefined(var_ccb2631df87b482a.targetname) && var_ccb2631df87b482a.targetname == "dmz_ai_chopper") {
        function_f3bb4f4911a1beb2("veh9_mil_air_heli_hind_physics_limbo", "explode");
        return;
    }
    if (isdefined(var_ccb2631df87b482a.targetname) && var_ccb2631df87b482a.targetname == "veh9_blima") {
        var_ccb2631df87b482a dodamage(10000000, position);
        if (isdefined(var_ccb2631df87b482a.var_187d78ed694289ab)) {
            function_f3bb4f4911a1beb2("ai_heli_reinforce", "release_path", var_ccb2631df87b482a.var_187d78ed694289ab);
        }
        return;
    }
    var_5eb0207ec5e4a0a9 = getdvarfloat(@"hash_aa027fbc10a93855", 0.1) * 1000;
    if (isdefined(var_ccb2631df87b482a.var_3abb0e413fb97b63) && gettime() - var_ccb2631df87b482a.var_3abb0e413fb97b63 < var_5eb0207ec5e4a0a9) {
        return;
    }
    impulsestrength = getdvarint(@"hash_eaab71fc906a7125", 600);
    var_18733544e2015df = vectornormalize(var_ccb2631df87b482a.origin - position);
    var_ccb2631df87b482a function_e0201404a8b6f664(var_18733544e2015df, impulsestrength);
    var_ccb2631df87b482a.var_3abb0e413fb97b63 = gettime();
}
