...
#namespace c_jup_sp_enemy_pmc_grunt_04;

// Namespace c_jup_sp_enemy_pmc_grunt_04 / character\c_jup_sp_enemy_pmc_grunt_04
// Params 0, eflags: 0x5
// Checksum 0x0, Offset: 0xc9
// Size: 0x9a
function private autoexec init()
{
    character = #"c_jup_sp_enemy_pmc_grunt_04";
...
function main()
{
    ...
    self setmodel( "body_c_jup_sp_enemy_pmc_grunt_04" );
...
{
    precache();
    precachemodel( "body_c_jup_sp_enemy_pmc_grunt_04" );
