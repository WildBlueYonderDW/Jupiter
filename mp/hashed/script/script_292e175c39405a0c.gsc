...
#namespace jup_spawner_zombie_disciple_s3_rr_unlock;

// Namespace jup_spawner_zombie_disciple_s3_rr_unlock / namespace_1c9fadcd71d36044
// Params 0, eflags: 0x0
// Checksum 0x0, Offset: 0x1e5
// Size: 0x173
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_spawner_zombie_disciple_s3_rr_unlock" );
    ...
    self.zombieaisetting = "settings_zombie_disciple_s3_rr_unlock";
...
function precache()
{
    agent_type = "actor_jup_spawner_zombie_disciple_s3_rr_unlock";
    ...
    params.zombieaisetting = "settings_zombie_disciple_s3_rr_unlock";
