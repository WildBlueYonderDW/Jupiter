...
// Size: 0x1e7
function main() {
    self.var_9d26ac1e325367ce = function_2336488258354fbc(#"aitype", %"jup_spawner_zombie_base_armored_heavy");
...
function precache() {
    ...
    if (!isdefined(level.agent_definition[agent_type])) {
        ...
        namespace_1dc23cd576899370::function_8168fbf6282d398b();
    }
    ...
    params.var_570908460ede5c13 = "settings_zombie_base_armored_heavy";
