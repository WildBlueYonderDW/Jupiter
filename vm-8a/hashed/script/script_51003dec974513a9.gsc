...
function private function_89c75ea3b9bff392() {
    ...
    /#
        function_470882fae4167198("<dev string:x3d>", head_pos);
    #/
}
...
function private function_363dbe4e6642291(mobile_spawner, var_69e3e4c4a13b7d1) {
    ...
    foreach (target in targets) {
        if (target.team != self.team) {
            ...
            /#
                function_470882fae4167198("<dev string:x5d>" + var_ec46e8a0004279b0, target.origin + (0, 0, 70));
            #/
        }
    }
}
...
/#
    ...
    function function_1dc954d715878eee() {
        devgui::function_6e7290c8ee4f558b("<dev string:x67>");
        devgui::function_a9a864379a098ad6("<dev string:x83>", "<dev string:x98>", &function_2467e628b86f2234);
        devgui::function_a9a864379a098ad6("<dev string:xad>", "<dev string:xc2>", &function_8ac0ad159685698f);
    ...
    function private function_2467e628b86f2234() {
        deathworm = zombie_utils::function_6d1fbda4b8524ef2(level.players[0].origin, undefined, "<dev string:xd7>");
        if (!isdefined(deathworm)) {
            return;
        }
        deathworm function_3e89eb3d8e3f1811("<dev string:xe8>", 1);
    }
    ...
    function private function_8ac0ad159685698f() {
        devgui::function_2fb888667001fc39("<dev string:xfa>", @"hash_4407d608d4a28905");
    }
    ...
    function private function_470882fae4167198(text, pos) {
        if (function_af06517ad8334a70()) {
            ...
            print3d(pos, "<dev string:x119>" + text, (1, 0, 0));
        }
    }
