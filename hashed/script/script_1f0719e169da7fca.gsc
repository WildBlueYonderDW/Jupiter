...
#namespace namespace_cca37790f8c298bb;

// Namespace namespace_cca37790f8c298bb / namespace_abbbdacdbe0b9258
// Params 0, eflags: 0x0
...
// Size: 0x111
function function_d108c22e1bc35518() {
...
function function_7461930061f9770f() {
    ...
    var_20b57d2c106f7944 = getentarray("white_wall_flicker_spots2", "targetname");
    foreach (light in spots) {
        foreach (lights in var_20b57d2c106f7944) {
...
function function_d2072b05e3481e8d() {
    ...
    var_20b57d2c106f7944 = getentarray("red_wall_flicker_spots2", "targetname");
    foreach (light in spots) {
        foreach (lights in var_20b57d2c106f7944) {
            light setlightintensity(0);
            lights setlightintensity(0);
