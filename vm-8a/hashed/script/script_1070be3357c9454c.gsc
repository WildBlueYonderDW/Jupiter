...
/#
    ...
    function function_7fb26d53f97b4152() {
        level notify("<dev string:x28>");
        level endon("<dev string:x28>");
        while (true) {
            waitframe();
            foreach (player in level.players) {
                print3d(player.origin + (0, 0, 60), isdefined(player function_2a4ecac859ca54d7()) ? player function_2a4ecac859ca54d7() : "<dev string:x3b>", undefined, undefined, 0.5, undefined, 1);
            }
        }
    }
    ...
    function function_c66a86ff03679ba6() {
        ...
        foreach (player in level.players) {
            println("<dev string:x75>" + player getentitynumber() + "<dev string:x7e>" + player.var_a8dab01d882b1e9f + "<dev string:x8e>" + (isdefined(player function_2a4ecac859ca54d7()) ? player function_2a4ecac859ca54d7() : "<dev string:x3b>"));
        }
    }
