...
/#
    ...
    function function_a436c573abc56a6a() {
        ...
        println("<dev string:x83c>" + level.var_4e85625f13c359ab.var_1aa0d8c830908356);
    ...
    function function_8f4bec208d29321a() {
        ...
        agent = namespace_bfef6903bca5845d::ai_mp_requestspawnagent(aitype, (0, 0, 0), (0, 0, 0), "<dev string:x93f>", "<dev string:x949>", "<dev string:x956>");
