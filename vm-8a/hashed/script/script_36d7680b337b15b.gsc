...
function private function_ee486eaddde6fd68() {
    ...
    while (gettime() < var_20624047a42925e0) {
        if (isdefined(self.var_544ffa1d219d6810)) {
            if (!function_e82696e7b59178f3(self.var_544ffa1d219d6810.origin)) {
                ...
                /#
                    bite_print("<dev string:x27>", self.var_544ffa1d219d6810.origin);
                #/
            }
        }
        ...
        /#
            if (function_2113bc484dd870c2()) {
                head_pos = self gettagorigin("<dev string:x3f>");
                line(self.origin, head_pos, (1, 0, 0));
                bite_print("<dev string:x46>" + distance2d(self.origin, head_pos), head_pos);
            }
        #/
        waitframe();
    }
    ...
    /#
        bite_print("<dev string:x59>" + self.var_cadb0f258ae78683);
    #/
        ...
        if (isdefined(self.var_3f4dee1c560fc063)) {
            ...
            /#
                if (function_2113bc484dd870c2()) {
                    ...
                    bite_print("<dev string:x94>", self.var_3f4dee1c560fc063);
                }
            #/
...
function melee_impact(var_f238c840934e431e, damage_radius, max_damage) {
    ...
    foreach (target in targets) {
        ...
        /#
            bite_print("<dev string:xa0>" + var_bb94b44258598dce, target.origin + (0, 0, 70));
        #/
    }
    ...
    /#
        if (function_2113bc484dd870c2()) {
            ...
            bite_print("<dev string:xb7>" + targets.size + "<dev string:xbc>", head_pos);
...
/#
    ...
    function function_c321972f4a10279a() {
        function_6e7290c8ee4f558b("<dev string:xc5>");
        function_a9a864379a098ad6("<dev string:xe1>", "<dev string:xf2>", &function_38699ca6e633d4e);
        function_a9a864379a098ad6("<dev string:x103>", "<dev string:x114>", &function_790ff4ccb7f11b99);
    ...
    function private function_38699ca6e633d4e() {
        worm = function_6d1fbda4b8524ef2(level.players[0].origin, undefined, "<dev string:x125>");
        if (!isdefined(worm)) {
            return;
        }
        worm function_3e89eb3d8e3f1811("<dev string:x136>", 1);
    }
    ...
    function private function_790ff4ccb7f11b99() {
        function_2fb888667001fc39("<dev string:x144>", @"hash_4c15f2ff8e7fd1bf");
    }
    ...
    function private bite_print(text, pos) {
        if (function_2113bc484dd870c2()) {
            ...
            print3d(pos, "<dev string:x15f>" + text, (1, 0, 0));
        }
    }
