...
#namespace jup_spawner_zombie_mimic_s3_rr;

// Namespace jup_spawner_zombie_mimic_s3_rr / namespace_99fafac53eca675d
// Params 0
// Checksum 0x0, Offset: 0x245
// Size: 0x1e8
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_spawner_zombie_mimic_s3_rr" );
    self.var_534e788bc498be9f = getscriptbundle( %"hash_bbd04b11d72d07f" );
    ...
    self.zombieaisetting = "settings_zombie_mimic_s3_rr";
    scripts\common\ai_settings::function_7b25d1c42e7f75be( "aisettings_zombie_mimic" );
...
function precache()
{
    agent_type = "actor_jup_spawner_zombie_mimic_s3_rr";
    ...
    if ( !isdefined( level.agent_definition[ agent_type ] ) )
    {
        ...
        level.agent_definition[ agent_type ][ "subclass" ] = getscriptbundle( %"hash_bbd04b11d72d07f" );
        namespace_1ac250022ed4afe1::precache_cpmp();
    }
    ...
    params.zombieaisetting = "settings_zombie_mimic_s3_rr";
