    ...
    function function_1efa739f9e55871f() {
        ...
        while (true) {
            if (getdvarint(@"hash_b85b66dbdc0853f9", 0) == 1) {
                ...
                agents = namespace_bfef6903bca5845d::function_6214774e8e021663(1, level.players[0].origin, "<dev string:x26f>", "<dev string:x27b>", "<dev string:x28d>", undefined, team, poiname, 256, 257);
            ...
            if (getdvarint(@"hash_b85b66dbdc0853f9", 0) == 3) {
                agents = namespace_bfef6903bca5845d::function_353fecd1549f5f42(level.players[0].origin, 50000, level.players[0].team, 100, "<dev string:x29f>", undefined, undefined, 1);
                setdevdvar(@"hash_b85b66dbdc0853f9", 0);
            }
