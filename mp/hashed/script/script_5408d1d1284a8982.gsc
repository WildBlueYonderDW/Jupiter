...
#namespace jup_enemy_mp_sniper_tier2_pmc;

// Namespace jup_enemy_mp_sniper_tier2_pmc / namespace_e4ee351a0e9f2bd4
// Params 0
// Checksum 0x0, Offset: 0x266
// Size: 0x1e0
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_mp_sniper_tier2_pmc" );
    ...
    primaryweaponhash = "jup_jp13_sn_svictor, [ none, none, none, none, none, none ], none, none";
...
function precache()
{
    agent_type = "actor_jup_enemy_mp_sniper_tier2_pmc";
    ...
    if ( !isdefined( level.agent_definition[ agent_type ] ) )
    {
        ...
        namespace_c2c8822e11a9a165::precache_cpmp();
        namespace_97037b2df17cf240::precache_cpmp();
        namespace_a3c5b42dfa33719b::precache_cpmp();
        namespace_7a33ad2ddc71d6f6::precache_cpmp();
    }
...
function setup_weapons()
{
    ...
    {
        level.var_67b54180a55f70e1[ primaryweaponhash ] = scripts\mp\class::function_e83615f8a92e4378( "jup_jp13_sn_svictor", [ "none", "none", "none", "none", "none", "none" ], "none", "none" );
    }
