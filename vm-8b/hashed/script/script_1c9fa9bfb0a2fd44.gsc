...
function function_aa30a0b07502a038(teamname) {
    ...
    rewards = function_d212a5e7a40d7c8d("intel", teamname, self.var_265cf6f9f157ad08, self);
...
function intel_start() {
    ...
    function_c4abd8bfac50b27d(teamname, iconposition, self);
    uploadstruct function_c4abd8bfac50b27d(teamname, iconposition, self);
...
// Size: 0x9e
function function_c4abd8bfac50b27d(teamname, pos, contract) {
    if (isdefined(self.objidnum) && self.objidnum != -1) {
        ...
        namespace_1eb3c4e0e28fac71::function_32c0b4da728d15f0(self.objidnum, contract);
    }
}
