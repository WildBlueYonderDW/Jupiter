...
function create_player_rig(animname, spawnpos, spawnang, uav_tower) {
    ...
    if (isdefined(uav_tower) && isdefined(uav_tower.linkedparent)) {
        ...
        if (isdefined(parent.velocity)) {
            ...
            traceresult = scripts/engine/trace::capsule_trace(point_start, point_end, 10, 72, undefined, self);
...
function function_858af52a8e277a68(towerstruct, identifier, var_73aa4684ecff09e9) {
    ...
    /#
        if (issharedfuncdefined("laptop_closed", "HINT_NOICON")) {
            [[ getsharedfunc("laptop_closed", "HINT_NOICON") ]]("players", "ui_dmz_uav_tower_screen", undefined, "crouch", undefined, undefined, towerstruct.poi, towerstruct.origin);
        }
    #/
    return scriptable;
}
...
function function_a301051f63fbbff9(instance, part, state, player, var_a5b2c541413aa895, usestring, streakinfo, players) {
    ...
    if (issharedfuncdefined("game", "getSquadmates")) {
        ...
        if (level.var_9f740c9281d0c7f4) {
            ...
            team_players = scripts/mp/utility/teams::getteamdata(player.team, "players");
...
function UAVTowerDisableForTime(data) {
    ...
    if (!isdefined(self.temptrigger)) {
        ...
        scripts/mp/utility/trigger::makeenterexittrigger(self.temptrigger, &function_2a4470bcf739b0e3, &playerExitUAVTowerDisabled);
    }
...
function function_83565380b036f12d() {
    /#
        ...
        waitframe();
        scripts/common/devgui::function_6e7290c8ee4f558b("uav_tower_activated");
        scripts/common/devgui::function_b2159fbbd7ac094e("activated_alarm_tell", @"hash_1583aa42d0c9d90a");
        scripts/common/devgui::function_b2159fbbd7ac094e("dmz_uav_tower_enter", @"hash_1583aa42d0c9d90a");
        scripts/common/devgui::function_b2159fbbd7ac094e("<unknown string>", @"hash_c658346ed64f29db");
        scripts/common/devgui::function_b2159fbbd7ac094e("<unknown string>", @"hash_158fdc0be6244136");
        scripts/common/devgui::function_b2159fbbd7ac094e("<unknown string>", @"hash_ce4d8222d33e9051");
        scripts/common/devgui::function_b2159fbbd7ac094e("<unknown string>", @"hash_710ff2c3b923a971");
    ...
    /#
        ...
        while (true) {
            if (getdvarint(@"hash_1583aa42d0c9d90a", 0)) {
                ...
                namespace_446fc987a980892f::playevent("<unknown string>", level.players);
