...
/#
    ...
    function function_7e3a130c966df56a() {
        while (true) {
            if (getdvar(@"hash_b3f9138f359b1d5d", "<dev string:x3e>") != "<dev string:x3e>") {
                dest = function_cb7a8125ea9acdce(getdvar(@"hash_b3f9138f359b1d5d", "<dev string:x3e>"));
                foreach (player in level.players) {
                    player namespace_b1453e6e8267c3ce::function_dc8998400a3eb807(dest);
                }
                setdvar(@"hash_b3f9138f359b1d5d", "<dev string:x3e>");
            }
            waitframe();
        }
    }
