...
#namespace jup_ob_schematic_soldier_buddy_3;

// Namespace jup_ob_schematic_soldier_buddy_3 / namespace_e8bb5f7e7ce6b0c3
// Params 0
// Checksum 0x0, Offset: 0x2a2
// Size: 0x1c9
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_ob_schematic_soldier_buddy_3" );
    self.var_534e788bc498be9f = getscriptbundle( %"hash_57d7fdea117bc1d8" );
...
function precache()
{
    agent_type = "actor_jup_ob_schematic_soldier_buddy_3";
    ...
    if ( !isdefined( level.agent_definition[ agent_type ] ) )
    {
        ...
        level.agent_definition[ agent_type ][ "subclass" ] = getscriptbundle( %"hash_57d7fdea117bc1d8" );
