...
/#
    ...
    function function_fbe5042fffaeeaf3()
    {
        if ( !isdefined( level.areaswaps ) )
        {
            foreach ( swapname, swapstates in level.areaswaps )
            {
                ...
                foreach ( state in swapstates )
                {
                    scripts\common\devgui::add_devgui_command( "<dev string:x291>" + toupper( state ), "<dev string:x292>" + swapname + "<dev string:x2a9>" + state + "<dev string:x2ab>" );
                }
        ...
        scripts\common\devgui::add_devgui_command( "<dev string:x2ae>", "<dev string:x2c3>" );
        scripts\common\devgui::function_fe953f000498048f();
    ...
    function private function_e1bb615381fe4ac2()
    {
        ...
        while ( true )
        {
            ...
            [ swapname, swapstate ] = strtok( getdvar( @"hash_a88eeef4e8ac164", "<dev string:x291>" ), "<dev string:x2a9>" );
