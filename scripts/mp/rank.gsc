            ...
            if (isdefined(objweapon)) {
                if (scripts/mp/weaponrank::weaponshouldgetxp(objweapon)) {
                    if (istrue(level.var_d45cbfd4ecd2662c)) {
                        ...
                        weapon_xp = weapon_xp * scripts/mp/weaponrank::getweaponrankxpmultipliertotal(objweapon);
...
function function_b560222a9aa3c942() {
    ...
    if (getdvarint(hashcat(@"hash_d98c82b5a26dc973", gametype, "_rank_xp_rs_enabled"), 0) == 1) {
        ...
        if (var_d44fd609866efce4 > 0) {
            ...
            for (scalingindex = 1; scalingindex <= var_d44fd609866efce4; scalingindex = scalingindex + 1) {
                scaling = spawnstruct();
    ...
    if (getdvarint(hashcat(@"hash_d98c82b5a26dc973", gametype, "_weapon_xp_rs_enabled"), 0) == 1) {
        ...
        if (var_de4ef628cc84d98e > 0) {
            ...
            for (scalingindex = 1; scalingindex <= var_de4ef628cc84d98e; scalingindex = scalingindex + 1) {
                scaling = spawnstruct();
...
function function_e9d048bc036717fa(originalvalue, applybonus, objweapon) {
    ...
    if (isdefined(level.var_d81e28e42da9de5e) && matchtimems > level.var_fdf6d27641357fd7 && var_f38005d4b8f0ab05 > level.var_7b8d4c36ba6edcec) {
        ...
        scaledrankxp = scaledrankxp * (scaling.scalar + scaling.var_2b53305b09e9ca11 * var_18667df3ced7535b / scaling.var_8d91cd3e5ba96b9c);
        /#
    ...
    if (applybonus) {
        scaledrankxp = scaledrankxp * getrankxpmultipliertotal();
    }
    if (isdefined(objweapon)) {
        var_2e1e3cce9930d323 = var_2e1e3cce9930d323 * scripts/mp/weaponrank::getweaponrankxpmultipliertotal(objweapon);
    } else {
    ...
    /#
        if (getdvarint(@"hash_4098c270c1841328", 0) == 1) {
            ...
            if (isdefined(level.var_d81e28e42da9de5e)) {
                iprintln("<unknown string>" + "<unknown string>" + originalvalue + "<unknown string>" + scaledrankxp / getrankxpmultipliertotal() + "<unknown string>" + scaledrankxp + "<unknown string>" + self.pers["", but that xp modifier has not been added."]["<unknown string>"]);
            }
            if (isdefined(level.var_2b6ac783e47905d8)) {
                iprintln("<unknown string>" + "<unknown string>" + originalvalue + "<unknown string>" + var_2e1e3cce9930d323 / scripts/mp/weaponrank::getweaponrankxpmultipliertotal(objweapon) + "<unknown string>" + var_2e1e3cce9930d323 + "<unknown string>" + self.pers["", but that xp modifier has not been added."]["<unknown string>"]);
            }
        }
    #/
...
function updaterank(oldxp) {
    ...
    /#
        println("<unknown string>" + self.name + "<unknown string>" + var_e6633fe0fb633e52 + "<unknown string>" + var_7a8cd849f0dbf2c7 + "<unknown string>" + oldxp + "<unknown string>" + getrankxp() + "<unknown string>");
    #/
...
function incrankxp(amount, objweapon, weapon_xp, type, var_158745de00c72d3e, var_b01aca3236595958, forceimmediate) {
    ...
    if (weapon_xp > 0) {
        ...
        if (isdefined(var_cf27bc26b98940ab)) {
            ...
            /#
                println("<unknown string>" + function_3c8848a3a11b2553(#"weapon_loot_id") + "<unknown string>" + weaponlootid + "<unknown string>" + function_3c8848a3a11b2553(eventname));
            #/
        }
    }
    ...
    if (operatorxp > 0) {
        ...
        if (isdefined(var_cf27bc26b98940ab)) {
            ...
            /#
                println("<unknown string>" + function_3c8848a3a11b2553(#"hash_8fba2fc976d0515e") + "<unknown string>" + operatorid + "<unknown string>" + function_3c8848a3a11b2553(eventname));
            #/
        }
    }
    if (clanXP > 0) {
