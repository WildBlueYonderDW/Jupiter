...
function function_d7c5900c7d5bb0db(deathdata) {
    ...
    return function_a952714a4c2f5c6f(deathdata.attacker, deathdata.objweapon, deathdata.meansofdeath, deathdata.hitloc, deathdata.inflictor, deathdata.damageflags);
}
...
function private function_6cb98faa9ea83774() {
    if (isdefined(self.operatorcustomization) && isdefined(self.operatorcustomization.skinref)) {
        if (function_73e183e02834309d(self.operatorcustomization.skinref) && self.operatorcustomization.skinref == %"jup_mp_fall_skin") {
            return true;
        }
...
function private function_2cfb11425a235d64() {
    if (function_d9e5f7620d3a396d() || function_6cb98faa9ea83774()) {
        return true;
    }
    return false;
}
...
function function_9cd3304c60f28813() {
    ...
    while (true) {
        victim = self waittill("execution_begin");
