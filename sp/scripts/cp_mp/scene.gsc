...
function private function_6dad63edc3390487( alignmentinfo, shotindex )
{
    ...
    if ( shotanimations.size != 0 )
    {
        ...
        /#
            function_ce4b6d4d859ede39( var_214d924f4e137244, "<dev string:x72>" + function_3c8848a3a11b2553( getanimname( animasset ) ), entity.origin, entity.angles );
        #/
        
        /#
            function_ce4b6d4d859ede39( var_214d924f4e137244, "<dev string:x7f>" + function_3c8848a3a11b2553( getanimname( animasset ) ), alignmentinfo.origin, alignmentinfo.angles );
        #/
    }
}
...
function private function_d28a53b100cbdda7( var_214d924f4e137244, shotindex, animindex, notifystring, alignmentinfo, animasset, var_866b3a3066122e39, blendtime, blendcurve, lerptime, var_7c6075e90a7b0fa )
{
    ...
    var_214d924f4e137244 function_549578bb9e3f4f78( alignmentinfo, animasset, var_7c6075e90a7b0fa, lerptime, var_866b3a3066122e39 );
    var_214d924f4e137244 function_bdfc45b799d27532( animasset );
