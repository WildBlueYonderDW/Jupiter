...
#namespace namespace_f1d41f3b033d04b7;

// Namespace namespace_f1d41f3b033d04b7 / scripts\cp\cp_mapselect
// Params 0, eflags: 0x0
...
function set_uav_radarstrength(player) {
    var_67b1a4ec977a1c68 = getuavstrengthmax();
    player.radarstrength = var_67b1a4ec977a1c68;
}
