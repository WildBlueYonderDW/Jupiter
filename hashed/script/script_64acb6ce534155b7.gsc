...
function inittablets() {
    ...
    foreach (type in level.contractmanager.contractdata) {
        ...
        totalcontracts = totalcontracts + tablets.size;
        if (tablets.size) {
            ...
            foreach (data in level.contractmanager.contractdata) {
                ...
                if (getdvarint(dvar, 0)) {
                    ...
                    foreach (teamdata in level.teamdata) {
                        if (istrue(teamdata["<unknown string>"].size > 0)) {
                            if (isdefined(level.contractmanager) && isdefined(level.contractmanager.var_b6fae9c9655c73bf)) {
                                if (isdefined(level.contractmanager.var_b6fae9c9655c73bf[teamdata["<unknown string>"][0].team])) {
                                    continue;
                                }
                            }
                            if (teamdata["<unknown string>"][0].team != level.players[0].team) {
...
function function_22671614e8f79513(player, contractref) {
    /#
        ...
        newtablet.task [[ level.contractmanager.var_766f9de01948c219[contractref].funcs["<unknown string>"] ]]();
    #/
}
