...
function function_49cab10caac7c6cd() {
    ...
    /#
        thread function_326cc1213268415a("<dev string:x2c>", 3);
    #/
}
...
function walkstep() {
    /#
        thread function_326cc1213268415a("<dev string:x47>", 3);
    #/
    ...
    /#
        thread function_326cc1213268415a("<dev string:x4c>", 3);
    #/
}
...
function function_b5799765f0103e33() {
    /#
        thread function_326cc1213268415a("<dev string:x60>", 3);
    #/
    ...
    /#
        thread function_326cc1213268415a("<dev string:x79>", 3);
    #/
}
...
function function_91b5b282cb2b18fc(positionid) {
    /#
        thread function_326cc1213268415a("<dev string:x96>", 3);
    #/
    ...
    /#
        thread function_326cc1213268415a("<dev string:xa7>", 3);
    #/
}
...
function function_931dc024b9a4425d() {
    /#
        thread function_326cc1213268415a("<dev string:xc7>", 3);
    #/
    ...
    /#
        thread function_326cc1213268415a("<dev string:xda>", 3);
    #/
}
...
function function_6c00d659b72888bf() {
    ...
    /#
        thread function_326cc1213268415a("<dev string:xf8>", 3);
    #/
}
...
function function_4b422fdc1b596ef9() {
    ...
    /#
        thread function_326cc1213268415a("<dev string:x127>", 3);
    #/
}
...
function function_b6001ea887635de4(var_ded14ae1ea8c4446) {
    /#
        thread function_326cc1213268415a("<dev string:x143>", 3);
    #/
    ...
    /#
        thread function_326cc1213268415a("<dev string:x153>", 3);
    #/
}
...
function reloadstep() {
    /#
        thread function_326cc1213268415a("<dev string:x161>", 3);
    #/
    ...
    /#
        thread function_326cc1213268415a("<dev string:x16f>", 3);
    #/
}
...
function function_8ab6a96b2278d5cf() {
    /#
        thread function_326cc1213268415a("<dev string:x17f>", 3);
    #/
    ...
    /#
        thread function_326cc1213268415a("<dev string:x189>", 3);
    #/
}
...
function function_ed36379da3790cba() {
    /#
        thread function_326cc1213268415a("<dev string:x1a1>", 3);
    #/
    ...
    /#
        thread function_326cc1213268415a("<dev string:x1bd>", 3);
    #/
}
...
function killwithads(var_ded14ae1ea8c4446) {
    /#
        thread function_326cc1213268415a("<dev string:x1ca>", 3);
    #/
    ...
    /#
        thread function_326cc1213268415a("<dev string:x218>", 3);
    #/
}
...
function function_7931a9f93d82dd27() {
    /#
        thread function_326cc1213268415a("<dev string:x22f>", 3);
    #/
    ...
    /#
        thread function_326cc1213268415a("<dev string:x245>", 3);
    #/
}
...
function combatstep(var_ded14ae1ea8c4446) {
    /#
        thread function_326cc1213268415a("<dev string:x257>", 3);
    #/
    ...
    /#
        thread function_326cc1213268415a("<dev string:x264>", 3);
    #/
}
...
function function_ab5ab2886323a8a5() {
    /#
        thread function_326cc1213268415a("<dev string:x27a>", 20);
    #/
    if (isdefined(level.allybot)) {
    ...
    if (isdefined(stepdata.function) && function_a791a878e9049670(stepdata.id)) {
        /#
            if (isdefined(stepdata.isoverride) && stepdata.isoverride) {
                thread function_326cc1213268415a("<dev string:x291>" + stepdata.id + "<dev string:x29e>", 1, 10, 120);
            } else {
                thread function_326cc1213268415a("<dev string:x291>" + stepdata.id, 1, 10, 120);
            }
        #/
