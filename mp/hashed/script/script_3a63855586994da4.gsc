...
#namespace jup_spawner_zombie_disciple_s3_rr_quest;

// Namespace jup_spawner_zombie_disciple_s3_rr_quest / namespace_fd1b216af0ae03fa
// Params 0
// Checksum 0x0, Offset: 0x1e3
// Size: 0x173
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_spawner_zombie_disciple_s3_rr_quest" );
    ...
    self.zombieaisetting = "settings_zombie_disciple_s3_rr_quest";
...
function precache()
{
    agent_type = "actor_jup_spawner_zombie_disciple_s3_rr_quest";
    ...
    params.zombieaisetting = "settings_zombie_disciple_s3_rr_quest";
