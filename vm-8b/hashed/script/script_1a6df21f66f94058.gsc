...
function function_b37d2b03ee8dfe69() {
    ...
    while (true) {
        ...
        wasdestroyed = self waittill("drone_destroyed");
...
function function_57f4dbf6fd0f87cb() {
    ...
    self endon("death");
    while (true) {
        var_95ac049b4af7cea1 = self waittill("trigger_destroyed");
    ...
    while (true) {
        if (self.bisincombat) {
            ...
            if (isdefined(self.enemy) && isdefined(self.grenadeweapon) && self cansee(self.enemy)) {
                ...
                var_ae2c36d7eba93746 = self.enemy.origin + (0, 0, heightoffset);
                namespace_14d36171baccf528::function_ae99616202575e39(var_ae2c36d7eba93746, grenadetype, undefined, 0);
...
function function_5c459133d355fcd3() {
    foreach (activityinstance in level.ob.var_7dd4780d4e4bff4d) {
        if (activityinstance.trigger_volumes.size > 0 && issubstr(activityinstance.varianttag, "CHEMIST")) {
            var_6d8721f8505c06ce = activityinstance;
            break;
        }
    }
    if (isdefined(var_6d8721f8505c06ce)) {
        var_6d8721f8505c06ce.var_83116f41aad4fc96 = [];
        foreach (volume in var_6d8721f8505c06ce.trigger_volumes) {
            if (volume.script_noteworthy == "chemist_vision_trigger") {
                var_6d8721f8505c06ce.var_83116f41aad4fc96[var_6d8721f8505c06ce.var_83116f41aad4fc96.size] = volume;
                var_6d8721f8505c06ce thread function_92582fd8a73a2383(volume);
            }
        }
    }
}
...
function function_92582fd8a73a2383(volume) {
    ...
    volume endon("death");
    while (true) {
        enteringentity = volume waittill("trigger");
...
function function_b85c41554955b2eb(instance) {
    ...
    while (true) {
        ent = self waittill("entering_chemist_interior_trigger");
