...
function molotov_init_pool_mask() {
    ...
    for (statebit = var_e42c4a59211c25aa; (statebit & (1 | 2)) > 0; statebit = statebit << 1) {
        for (typebit = var_a56ffa08fd7c6e21; (typebit & (4 | 8 | 16)) > 0; typebit = typebit << 1) {
            for (orientbit = var_880b6bd9b71c4abc; (orientbit & (32 | 64 | 128)) > 0; orientbit = orientbit << 1) {
