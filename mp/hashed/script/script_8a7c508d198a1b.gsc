...
#namespace jup_ob_enemy_basic_specialforce_rainmaker_bodyguard;

// Namespace jup_ob_enemy_basic_specialforce_rainmaker_bodyguard / namespace_d4849c596c15216d
// Params 0
// Checksum 0x0, Offset: 0x238
// Size: 0x1c9
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_ob_enemy_basic_specialforce_rainmaker_bodyguard" );
    ...
    primaryweaponhash = "iw9_ar_akilo74, [ grip_angled13, reflex03_tall ], none, none";
...
function precache()
{
    agent_type = "actor_jup_ob_enemy_basic_specialforce_rainmaker_bodyguard";
...
function setup_weapons()
{
    ...
    {
        level.var_67b54180a55f70e1[ primaryweaponhash ] = scripts\mp\class::function_e83615f8a92e4378( "iw9_ar_akilo74", [ "grip_angled13", "reflex03_tall" ], "none", "none" );
    }
