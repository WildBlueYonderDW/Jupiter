...
function private function_5a0bc132b2dd3f65() {
    ...
    while (true) {
        notification, pingindex, optionalarg = pingowner waittill("luinotifyserver");
...
function function_a1d53ca27932b96d(notification, pingindex, optionalarg) {
    ...
    if (isdefined(pingindex)) {
        logmessage = logmessage + " | pingIndex: " + pingindex;
    }
    if (isdefined(optionalarg)) {
        logmessage = logmessage + " | optionalArg: " + optionalarg;
    }
    ...
    pingowner notify("calloutmarkerping_notifyhandled", notification);
}
...
function calloutmarkerpingvo_getcalloutaliasstringworld(pingindex) {
    player = self;
    if (!scripts/cp_mp/utility/game_utility::isbrstylegametype() && getgametype() != "ob") {
        return #"hash_950a284047c4c938";
    }
...
function calloutmarkerping_watchwhenobjectivedeleted(pingindex, gscobjectiveid) {
    ...
    self endon("predictiveCalloutClear_" + pingindex);
    while (true) {
        deletedobjectiveid = level waittill("Objective_Delete");
...
function calloutmarkerping_removevehiclecalloutonspecialconditions(pingindex, calloutvehicleentity) {
    ...
    while (true) {
        ...
        if (var_12b40880a002e52) {
            ...
            var_4ced3a2a73d90ee6 = var_4ced3a2a73d90ee6 + tick;
...
function function_c35cbd50adbcd4fd() {
    /#
        ...
        waitframe();
        scripts/common/devgui::function_6e7290c8ee4f558b("Remove Callout ID Notify ( removed ) | pingIndex: ");
        scripts/common/devgui::function_b2159fbbd7ac094e("Watch Scriptable Death | pingIndex: ", @"hash_abc406da71abacd3");
