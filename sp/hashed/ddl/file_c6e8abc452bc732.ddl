...
struct root {
    ...
    // offset: 0x18e0, bitSize: 0x8(0x1B)
    Team victor;
    // offset: 0x18e8, bitSize: 0x300(0x60B)
    int32 alliesRoundScore[24];
    // offset: 0x1be8, bitSize: 0x300(0x60B)
    int32 axisRoundScore[24];
    // offset: 0x1ee8, bitSize: 0x20(0x4B)
    int32 serverScriptCalcTimeTotal;
    // offset: 0x1f08, bitSize: 0x8(0x1B)
    byte globalPlayerXpModifier;
    // offset: 0x1f10, bitSize: 0x10(0x2B)
    short lifeCount;
    // offset: 0x1f20, bitSize: 0x10(0x2B)
    short gameEventCount;
    // offset: 0x1f30, bitSize: 0x20(0x4B)
