...
function function_161a9b230a5d1a5e(player, var_83212420e39bdbc2) {
    ...
    if (scripts\mp\utility\player::isinlaststand(player)) {
        player namespace_1d863a7bbc05fc52::finishreviveplayer("self_revive_success", player);
    }
...
// Size: 0x81
function function_a44817e31981b6f1(var_751df20fceaee5) {
    /#
...
// Size: 0x13
function function_a740433902d7fab1(var_751df20fceaee5) {
...
function function_edff661c569fa3bc(player) {
    ...
    for (backpackindex = 0; backpackindex < player function_1b35b10884bd8d67(); backpackindex += 1) {
