...
function private function_138dc2e6ae3e968b() {
    ...
    for (var_fa6a5e0ea277e5a6 = 0; gettime() < var_76ef1958db146de && var_fa6a5e0ea277e5a6 < var_45b42d8d38a439e1; var_fa6a5e0ea277e5a6 = var_fa6a5e0ea277e5a6 + 1) {
    ...
    while (isdefined(self)) {
        ...
        if (speedsqr > var_d982f1610183c2e1) {
            ...
            if (knockdowndata.velocityoffset > 0) {
                ...
                knockdown_pos = knockdown_pos + vel_norm * knockdowndata.velocityoffset;
            }
            /#
            #/
