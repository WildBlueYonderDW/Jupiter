...
function init() {
    ...
    /#
        ...
        function_a2fe753948998c89("<dev string:x32>", "<dev string:x43>");
        function_a2fe753948998c89("<dev string:x70>", "<dev string:x84>");
        function_a9a864379a098ad6("<dev string:xb5>", "<dev string:xdb>", &function_60fccb021222ec4c, 1);
...
/#
    ...
    function function_60fccb021222ec4c() {
        var_eb5dfd5a5629cdcf = namespace_e23f629a8349dfaf::function_e7b6474ebd683537("<dev string:xee>", "<dev string:x100>");
        var_e1922afab23ca6c6 = namespace_e23f629a8349dfaf::function_e7b6474ebd683537("<dev string:xee>", "<dev string:x113>");
        while (true) {
            foreach (player in level.players) {
                if (player ent_flag("<dev string:x12a>")) {
                    cylinder(player.origin, player.origin + (0, 0, 72), var_eb5dfd5a5629cdcf, (1, 0, 0));
                    continue;
                }
                if (player ent_flag("<dev string:x142>")) {
                    cylinder(player.origin, player.origin + (0, 0, 72), var_eb5dfd5a5629cdcf, (1, 0, 0));
                    cylinder(player.origin, player.origin + (0, 0, 72), var_e1922afab23ca6c6, (0.5, 0, 1));
                    printtoscreen2d(325, 250, "<dev string:x155>" + var_eb5dfd5a5629cdcf, (1, 0, 0), 2);
                    printtoscreen2d(325, 300, "<dev string:x167>" + var_e1922afab23ca6c6, (0.5, 0, 1), 2);
                }
            }
            waitframe();
        }
