...
function private function_4258c140bef4fdab(remainingusecount, maxusecount, var_2bb24aa5b6557593) {
    ...
    infoarray = infoarray | remainingusecount << 0;
    infoarray = infoarray | maxusecount << 4;
    infoarray = infoarray | var_2bb24aa5b6557593 << 8;
...
function private function_c1c6eddd67bf7457(player, weapon, var_2feb0814d8b653e0) {
    /#
        ...
        return [var_2feb0814d8b653e0, "<unknown string>", "<unknown string>", "<unknown string>"];
    #/
}
...
function private function_7084e044e0ba070a() {
    /#
        ...
        debugposy = debugposy + tablesize[1];
        debugtext = "<unknown string>" + player isanymonitoredweaponswitchinprogress();
