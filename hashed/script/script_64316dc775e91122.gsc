    ...
    /#
        ...
        while (true) {
            foreach (s_pap in level.var_28967913115d1fa3) {
                ...
                print3d(v_position - var_39239d1f90650b * 2, "<unknown string>" + default_to(s_pap.script_power, "<unknown string>"), (0, 1, 0), 1, 0.25);
                ...
                foreach (player in level.players) {
                    if (isdefined(player.s_pap_machine)) {
                        print3d(player.origin, player.name + "<unknown string>" + player.s_pap_machine.name, (0, 1, 0), 1, 0.25);
                    }
                }
            }
            waitframe();
