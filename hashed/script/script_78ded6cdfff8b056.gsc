...
function function_7dcdb0119cb801c6() {
    ...
    callback::function_e7fddda1f0b46b5e(self.var_ae3ea15396b65c1f) callback::add("on_is_crawling_changed", &function_16dad04a21a0f9cf);
}
...
function init_pain() {
    ...
    level.var_53e3d9850cd60ff8 = function_53c4c53197386572(level.var_53e3d9850cd60ff8, gettime());
}
...
function private on_damaged(params) {
    ...
    if (function_adb7b3f940cde3b5(params.var_2eb474020f9d509)) {
    ...
    if (function_69fce24aa7cec254(params.shitloc)) {
        stagger();
    } else if (gettime() > self.var_38f29f59521de99a) {
        if (function_8153209a5ebfc684(params.shitloc) && self.var_2379db736392918f > self.var_8f2185fcccf61bdb) {
            stagger();
        } else if (self.var_2379db736392918f > self.var_87ece69176942e3c) {
            stagger();
        }
    }
}
...
// Size: 0x4a
function private function_69fce24aa7cec254(location) {
    switch (location) {
