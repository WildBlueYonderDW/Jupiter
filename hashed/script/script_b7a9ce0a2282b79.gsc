...
function function_ddbc94f52a1947b5(player, lootid) {
    extractedStashItems = scripts/mp/utility/teams::getteamdata(player.team, "extractedStashItems");
    extractedStashItems[lootid] = 1;
    scripts/mp/utility/teams::setteamdata(player.team, "extractedStashItems", extractedStashItems);
}
...
function function_33366ade5697aa38(player) {
    ...
    for (backpackindex = 0; backpackindex < 11; backpackindex++) {
        ...
        /#
            println("<unknown string>" + backpackindex + "<unknown string>" + lootid + "<unknown string>" + ref + "<unknown string>" + lootid);
            println("<unknown string>" + backpackindex + "<unknown string>" + lootid + "<unknown string>" + ref + "<unknown string>" + quantity);
        #/
    }
}
...
function bankcash(player) {
    ...
    if (balancespace > 0) {
        ...
        plundercount = plundercount - intobalance;
    }
...
function function_e64d9a42c66018c9(player) {
    /#
        ...
        lethalinstance = player function_644ed519cac9722b(1, 2);
        println("<unknown string>" + lethalinstance.lootid);
        tacticalinstance = player function_644ed519cac9722b(1, 3);
        println("<unknown string>" + tacticalinstance.lootid);
        var_bed94c5e8ba6c57e = player function_644ed519cac9722b(1, 4);
        println("<unknown string>" + var_bed94c5e8ba6c57e.lootid);
        killstreakinstance = player function_644ed519cac9722b(65535, 0);
        println("<unknown string>" + killstreakinstance.lootid);
        var_dc62a204e1921a99 = player function_644ed519cac9722b(65535, 4);
        println("<unknown string>" + var_dc62a204e1921a99.lootid);
        backpackinstance = player function_644ed519cac9722b(65535, 1);
        println("<unknown string>" + backpackinstance.lootid);
        var_ea074533d9558d3d = player function_644ed519cac9722b(65535, 3);
        ...
        for (backpackindex = 1; backpackindex <= 12; backpackindex++) {
            backpackinstance = player function_644ed519cac9722b(2, backpackindex);
            println("<unknown string>" + backpackindex + "<unknown string>" + backpackinstance.lootid);
        }
    #/
}
...
function function_c563bbc48f1dd3d2(player) {
    ...
    while (true) {
        ...
        primaryinstance = player function_644ed519cac9722b(1, 0);
        /#
            player.var_6f7281f031b30320[0] setdevtext(function_181f84b6e516d4e6(primaryinstance, "<unknown string>"));
        #/
        player.var_6f7281f031b30320[0] setpoint("TOPLEFT", "TOPLEFT", 250, 30);
        player.var_6f7281f031b30320[0] clearalltextafterhudelem();
        secondaryinstance = player function_644ed519cac9722b(1, 1);
        /#
            player.var_6f7281f031b30320[1] setdevtext(function_181f84b6e516d4e6(secondaryinstance, "<unknown string>"));
        #/
        ...
        tacticalinstance = player function_644ed519cac9722b(1, 3);
        /#
            player.var_6f7281f031b30320[3] setdevtext(function_e29c498dd636939a(lethalinstance, "<unknown string>") + "<unknown string>" + function_e29c498dd636939a(tacticalinstance, "<unknown string>"));
        #/
        ...
        killstreakinstance = player function_644ed519cac9722b(65535, 0);
        /#
            player.var_6f7281f031b30320[4] setdevtext(function_e29c498dd636939a(var_bed94c5e8ba6c57e, "<unknown string>") + "<unknown string>" + function_e29c498dd636939a(killstreakinstance, "<unknown string>"));
        #/
        ...
        var_ea074533d9558d3d = player function_644ed519cac9722b(65535, 3);
        /#
            player.var_6f7281f031b30320[5] setdevtext(function_e29c498dd636939a(var_dc62a204e1921a99, "<unknown string>") + "<unknown string>" + function_e29c498dd636939a(backpackinstance, "<unknown string>") + "<unknown string>" + function_e29c498dd636939a(var_ea074533d9558d3d, "<unknown string>") + "<unknown string>" + function_e29c498dd636939a(var_2ac478345313402, "<unknown string>"));
        #/
...
function function_72fe945f29c8bce6(instance) {
    /#
        println("<unknown string>" + instance.instanceid);
        if (isdefined(instance.metadata)) {
