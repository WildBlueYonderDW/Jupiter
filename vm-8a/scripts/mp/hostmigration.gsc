...
function callback_hostmigration() {
    ...
    if (level.gameended) {
        println("<dev string:x1c>" + gettime() + "<dev string:x38>");
        return;
    }
...
function hostmigrationtimerthink_internal() {
    ...
    println("<dev string:x7b>" + hostmigrationname(self) + "<dev string:x9c>" + self.hostmigrationcontrolsfrozen);
...
function hostmigrationtimerthink() {
    ...
    println("<dev string:xc1>" + hostmigrationname(self) + "<dev string:x9c>" + self.hostmigrationcontrolsfrozen);
