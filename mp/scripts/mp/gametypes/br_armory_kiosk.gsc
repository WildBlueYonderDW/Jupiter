...
function function_1a1709943670772a() {
    ...
    hiddenkiosks = [];
    foreach (armorykiosk in level.br_armory_kiosk.scriptables) {
        var_e4e4ae4481958d2e = !isdefined(armorykiosk.deconeffectcount) && exclusion_zones::function_de57b9616f575a63(armorykiosk.origin, 0, 0) == -1 && !namespace_bbc79db4c3949a5c::isPointInMultiCircleDanger(armorykiosk.origin, level.var_53c0fa66001cff52);
        if (istrue(armorykiosk.visible)) {
            if (var_e4e4ae4481958d2e) {
