...
#namespace jup_enemy_mp_pistol_tier2_pmc;

// Namespace jup_enemy_mp_pistol_tier2_pmc / namespace_5e0357af51c1415c
// Params 0
// Checksum 0x0, Offset: 0x1fb
// Size: 0x1bd
function main()
{
    self.aitypeid = function_2336488258354fbc( #"aitype", %"jup_enemy_mp_pistol_tier2_pmc" );
    ...
    primaryweaponhash = "jup_cp24_pi_glima21, [ none, none, none, none, none, none ], none, none";
...
function precache()
{
    agent_type = "actor_jup_enemy_mp_pistol_tier2_pmc";
...
function setup_weapons()
{
    ...
    {
        level.var_67b54180a55f70e1[ primaryweaponhash ] = scripts\mp\class::function_e83615f8a92e4378( "jup_cp24_pi_glima21", [ "none", "none", "none", "none", "none", "none" ], "none", "none" );
    }
